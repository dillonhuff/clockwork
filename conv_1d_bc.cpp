...
// write_write
//	M_write_4
inline void M_write_write_bundle_write(hw_uint<32> & /* width = 32*/write_write, M_write_4_cache& M_write_4_delay) {
...
inline void write(HWStream<hw_uint<32>  >& in, M_write_4_cache& M_write_4, int root, int p) {
	// Consume: in
...
inline void compute_out(T_read0_0_cache& T_read0_0, HWStream<hw_uint<32>  >& out, int root, int c) {
	// Consume: T
