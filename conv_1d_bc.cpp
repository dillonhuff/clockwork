...
inline void read0(M_write_4_cache& M_write_4, T_read0_0_cache& T_read0_0, int root, int c) {
	...
	// Possible ports...
		// T_read0_0
	T_read0_write_bundle_write(M_min_lp_c_c__9_rp__value, T_read0_0 /* output src_delay */);
}

inline void write(HWStream<hw_uint<32> >& /* num ports = 1 */in, M_write_4_cache& M_write_4, int root, int p) {
	// Consume: in
...
inline void compute_out(T_read0_0_cache& T_read0_0, HWStream<hw_uint<32> >& /* num ports = 1 */out, int root, int c) {
	// Consume: T
