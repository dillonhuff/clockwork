...
// write_write
//	M_write_2
inline void M_write_write_bundle_write(hw_uint<32> & /* width = 32*/write_write, M_write_2_cache& M_write_2_delay) {
...
inline void write(HWStream<hw_uint<32>  >& in, M_write_2_cache& M_write_2, int root, int p) {
	// Consume: in
