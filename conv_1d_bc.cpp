...
struct M_write_6_to_M_read0_3_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in M_write_6_to_M_read0_3_cache: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in M_write_6_to_M_read0_4_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in M_write_6_to_M_read0_5_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct M_cache {
  M_write_6_to_M_read0_3_cache bank_M_write_6_to_M_read0_3;
  M_write_6_to_M_read0_4_cache bank_M_write_6_to_M_read0_4;
  M_write_6_to_M_read0_5_cache bank_M_write_6_to_M_read0_5;
};



inline void M_write_6_write(hw_uint<32> & M_write_6, M_cache& M, int root, int p) {
  M.bank_M_write_6_to_M_read0_3.push(M_write_6);
  M.bank_M_write_6_to_M_read0_4.push(M_write_6);
  M.bank_M_write_6_to_M_read0_5.push(M_write_6);
}
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in T_read0_2_to_T_compute_out_1_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct T_cache {
  T_read0_2_to_T_compute_out_1_cache bank_T_read0_2_to_T_compute_out_1;
};



inline void T_read0_2_write(hw_uint<96>& T_read0_2, T_cache& T, int root, int c) {
  T.bank_T_read0_2_to_T_compute_out_1.push(T_read0_2);
}
