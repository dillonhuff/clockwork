...
inline void M_write_2_write(hw_uint<32> & M_write_2, M_cache& M) {
...
inline void M_write_write_bundle_write(hw_uint<32>& write_write, M_cache& M) {
	...
	M_write_2_write(M_write_2_res, M);
}
...
inline void T_read0_4_write(hw_uint<96>& T_read0_4, T_cache& T) {
...
inline void T_read0_write_bundle_write(hw_uint<96>& read0_write, T_cache& T) {
	...
	T_read0_4_write(T_read0_4_res, T);
}
