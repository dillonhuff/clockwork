...
struct M_write_2_to_M_read0_5_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in M_write_2_to_M_read0_5: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in M_write_2_to_M_read0_6: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in M_write_2_to_M_read0_7: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct M_cache {
  M_write_2_to_M_read0_5_cache M_write_2_to_M_read0_5;
  M_write_2_to_M_read0_6_cache M_write_2_to_M_read0_6;
  M_write_2_to_M_read0_7_cache M_write_2_to_M_read0_7;
};



inline void M_write_2_write(hw_uint<32> & M_write_2, M_cache& M, int root, int p) {
  M.M_write_2_to_M_read0_5.push(M_write_2);
  M.M_write_2_to_M_read0_6.push(M_write_2);
  M.M_write_2_to_M_read0_7.push(M_write_2);
}
...
inline hw_uint<32>  M_read0_5_select(M_cache& M, int root, int c) {
  ...
  // M_read0_5 read pattern: { read0[root = 0, c] -> M[c] : 0 <= c <= 9 }
	auto value_M_write_2 = M.M_write_2_to_M_read0_5.peek(/* Needs general delay string */ (root == 0 && c >= 0 && 7 - c >= 0) ? (2) : (-8 + c == 0 && root == 0) ? (1) : 0);
...
inline hw_uint<32>  M_read0_6_select(M_cache& M, int root, int c) {
  ...
  // M_read0_6 read pattern: { read0[root = 0, c] -> M[1 + c] : 0 <= c <= 8; read0[root = 0, c = 9] -> M[9] }
	auto value_M_write_2 = M.M_write_2_to_M_read0_6.peek(/* Needs general delay string */ (root == 0 && c >= 0 && 7 - c >= 0) ? (1) : 0);
	return value_M_write_2;
}
...
inline hw_uint<32>  M_read0_7_select(M_cache& M, int root, int c) {
  ...
  // M_read0_7 read pattern: { read0[root = 0, c] -> M[9] : 8 <= c <= 9; read0[root = 0, c] -> M[2 + c] : 0 <= c <= 7 }
	auto value_M_write_2 = M.M_write_2_to_M_read0_7.peek_0();
	return value_M_write_2;
}
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in T_read0_4_to_T_compute_out_1: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct T_cache {
  T_read0_4_to_T_compute_out_1_cache T_read0_4_to_T_compute_out_1;
};



inline void T_read0_4_write(hw_uint<96>& T_read0_4, T_cache& T, int root, int c) {
  T.T_read0_4_to_T_compute_out_1.push(T_read0_4);
}
...
inline hw_uint<96> T_compute_out_1_select(T_cache& T, int root, int c) {
  ...
  // T_compute_out_1 read pattern: { compute_out[root = 0, c] -> T[c] : 0 <= c <= 9 }
	auto value_T_read0_4 = T.T_read0_4_to_T_compute_out_1.peek_0();
