...
struct M_cache {
  M_write_4_to_M_read0_1_cache M_write_4_to_M_read0_1_cache;
  M_write_4_to_M_read0_2_cache M_write_4_to_M_read0_2_cache;
  M_write_4_to_M_read0_3_cache M_write_4_to_M_read0_3_cache;
};



inline void M_write_4_write(hw_uint<32> & M_write_4, M_cache& M, int root, int p) {
  M.M_write_4_to_M_read0_1_cache.push(M_write_4);
  M.M_write_4_to_M_read0_2_cache.push(M_write_4);
  M.M_write_4_to_M_read0_3_cache.push(M_write_4);
}
...
inline hw_uint<32>  M_read0_1_select(M_cache& M, int root, int c) {
  ...
  // M_read0_1 read pattern: { read0[root = 0, c] -> M[c] : 0 <= c <= 9 }
	auto value_M_write_4 = M.M_write_4_to_M_read0_1_cache.peek(/* Needs general delay string */ (root == 0 && c >= 0 && 7 - c >= 0) ? (2) : (-8 + c == 0 && root == 0) ? (1) : 0);
...
inline hw_uint<32>  M_read0_2_select(M_cache& M, int root, int c) {
  ...
  // M_read0_2 read pattern: { read0[root = 0, c] -> M[1 + c] : 0 <= c <= 8; read0[root = 0, c = 9] -> M[9] }
	auto value_M_write_4 = M.M_write_4_to_M_read0_2_cache.peek(/* Needs general delay string */ (root == 0 && c >= 0 && 7 - c >= 0) ? (1) : 0);
	return value_M_write_4;
}
...
inline hw_uint<32>  M_read0_3_select(M_cache& M, int root, int c) {
  ...
  // M_read0_3 read pattern: { read0[root = 0, c] -> M[9] : 8 <= c <= 9; read0[root = 0, c] -> M[2 + c] : 0 <= c <= 7 }
	auto value_M_write_4 = M.M_write_4_to_M_read0_3_cache.peek_0();
	return value_M_write_4;
}
...
struct T_cache {
  T_read0_0_to_T_compute_out_7_cache T_read0_0_to_T_compute_out_7_cache;
};



inline void T_read0_0_write(hw_uint<96>& T_read0_0, T_cache& T, int root, int c) {
  T.T_read0_0_to_T_compute_out_7_cache.push(T_read0_0);
}
...
inline hw_uint<96> T_compute_out_7_select(T_cache& T, int root, int c) {
  ...
  // T_compute_out_7 read pattern: { compute_out[root = 0, c] -> T[c] : 0 <= c <= 9 }
	auto value_T_read0_0 = T.T_read0_0_to_T_compute_out_7_cache.peek_0();
