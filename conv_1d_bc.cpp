...
// Operation logic
inline void compute_out(T_read0_4_cache& T_read0_4, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out, int root, int c) {
	// Consume: T
...
inline void write(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in, M_write_2_cache& M_write_2, int root, int p) {
	// Consume: in
