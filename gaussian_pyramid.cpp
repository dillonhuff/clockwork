...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3_cache {
	// RAM Box: {[0, 12], [0, 12]}
	// Capacity: 39
	// # of read delays: 39
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6);
}
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2);
}
...
// Driver function
void gaussian_pyramid(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */I_blr_ds_blr_ds_out, int num_epochs) {
...
void gaussian_pyramid(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */I_blr_ds_blr_ds_out) {
  ...
  gaussian_pyramid(in, I_blr_ds_blr_ds_out, 1);
}
#ifdef __VIVADO_SYNTH__
...
static void read_store_I_from_in_read(hw_uint<32>* input, HWStream<hw_uint<32> >& v, const int size) {
  ...
  for (int i = 0; i < store_I_from_in_read_num_transfers*size; i++) {
...
static void write_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  for (int i = 0; i < store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write_num_transfers*size; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
  }
