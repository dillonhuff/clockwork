...
struct I_store_I_from_in_12_merged_banks_9_cache {
  ...
  hw_uint<32>  I_store_I_from_in_12_merged_banks_9_store[1024];

#else
  hw_uint<32> * I_store_I_from_in_12_merged_banks_9_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_store_I_from_in_12_merged_banks_9_store[(d0 + d1*32)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_store_I_from_in_12_merged_banks_9_store[(d0 + d1*32)] = value;
  }
...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_cache {
	// RAM Box: {[0, 12], [0, 12]}
	// Capacity: 39
	// # of read delays: 39
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_store[169];

#else
  hw_uint<32> * I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_store[(d0 + d1*13)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_store[(d0 + d1*13)] = value;
  }
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_1.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14);
}
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_store[36];

#else
  hw_uint<32> * I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_store[(d0 + d1*6)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_store[(d0 + d1*6)] = value;
  }
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0);
}
