...
inline hw_uint<32>  I_blr_I_blr_ds_id0_1_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // I_blr_I_blr_ds_id0_1 read pattern: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> I_blr[2I_blr_ds_r, 2I_blr_ds_c] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
	auto value_I_blr_I_blr_conv_3_30_4 = I_blr.I_blr_I_blr_conv_3_30_4_merged_banks_1.peek_0();
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache {
	// Capacity: 12
	// # of read delays: 12
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2);
}
