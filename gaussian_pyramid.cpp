...
struct I_store_I_from_in_4_merged_banks_9_cache {
	// RAM Box: {[0, 31], [0, 31]}
	// Capacity: 67
	// # of read delays: 9
	hw_uint<32>  f0;
...
struct I_cache {
  I_store_I_from_in_4_merged_banks_9_cache I_store_I_from_in_4_merged_banks_9;
};



inline void I_store_I_from_in_4_write(hw_uint<32> & I_store_I_from_in_4, I_cache& I, int root, int pr, int pc, int dynamic_address) {
  I.I_store_I_from_in_4_merged_banks_9.push(I_store_I_from_in_4);
}

inline hw_uint<32>  I_I_blr_conv_3_30_10_select(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_10 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  ...
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_34();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_11 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: { I_blr_conv_3_30[root, I_blr_r, I_blr_c] -> 33 : root = 0 and 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_33();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_I_blr_conv_3_30_12_select(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_12 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  ...
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_32();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_13 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: { I_blr_conv_3_30[root, I_blr_r, I_blr_c] -> 2 : root = 0 and 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_2();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_14 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: { I_blr_conv_3_30[root, I_blr_r, I_blr_c] -> 1 : root = 0 and 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_1();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_15 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: {  }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_0();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_I_blr_conv_3_30_7_select(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_7 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: { I_blr_conv_3_30[root, I_blr_r, I_blr_c] -> 66 : root = 0 and 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_66();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_I_blr_conv_3_30_8_select(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_8 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: { I_blr_conv_3_30[root, I_blr_r, I_blr_c] -> 65 : root = 0 and 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_65();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_I_blr_conv_3_30_9_select(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_9 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  ...
  auto value_I_store_I_from_in_4 = I.I_store_I_from_in_4_merged_banks_9.peek_64();
  return value_I_store_I_from_in_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline hw_uint<288> I_I_blr_conv_3_30_read_bundle_read(I_cache& I, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
  // # of ports in bundle: 9
	...
	hw_uint<288> result;
	hw_uint<32>  I_I_blr_conv_3_30_7_res = I_I_blr_conv_3_30_7_select(I, root, I_blr_r, I_blr_c, dynamic_address);
	set_at<0, 288>(result, I_I_blr_conv_3_30_7_res);
	hw_uint<32>  I_I_blr_conv_3_30_8_res = I_I_blr_conv_3_30_8_select(I, root, I_blr_r, I_blr_c, dynamic_address);
	set_at<32, 288>(result, I_I_blr_conv_3_30_8_res);
	hw_uint<32>  I_I_blr_conv_3_30_9_res = I_I_blr_conv_3_30_9_select(I, root, I_blr_r, I_blr_c, dynamic_address);
	set_at<64, 288>(result, I_I_blr_conv_3_30_9_res);
	hw_uint<32>  I_I_blr_conv_3_30_10_res = I_I_blr_conv_3_30_10_select(I, root, I_blr_r, I_blr_c, dynamic_address);
...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_cache& I, int root, int pr, int pc, int dynamic_address) {
	...
	I_store_I_from_in_4_write(I_store_I_from_in_4_res, I, root, pr, pc, dynamic_address);
}

#include "hw_classes.h"

struct I_blr_I_blr_conv_3_30_6_merged_banks_1_cache {
	// RAM Box: {[0, 29], [0, 29]}
	// Capacity: 1
	// # of read delays: 1
	fifo<hw_uint<32> , 1> f;
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_6_merged_banks_1_cache I_blr_I_blr_conv_3_30_6_merged_banks_1;
};



inline void I_blr_I_blr_conv_3_30_6_write(hw_uint<32> & I_blr_I_blr_conv_3_30_6, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
  I_blr.I_blr_I_blr_conv_3_30_6_merged_banks_1.push(I_blr_I_blr_conv_3_30_6);
}

inline hw_uint<32>  I_blr_I_blr_ds_id0_1_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  // DD fold: {  }
  auto value_I_blr_I_blr_conv_3_30_6 = I_blr.I_blr_I_blr_conv_3_30_6_merged_banks_1.peek(/* one reader or all rams */ 0);
...
inline void I_blr_I_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_conv_3_30_write, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c, int dynamic_address) {
	...
	I_blr_I_blr_conv_3_30_6_write(I_blr_I_blr_conv_3_30_6_res, I_blr, root, I_blr_r, I_blr_c, dynamic_address);
}
...
inline hw_uint<32> I_blr_I_blr_ds_id0_read_bundle_read(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<32> result;
	hw_uint<32>  I_blr_I_blr_ds_id0_1_res = I_blr_I_blr_ds_id0_1_select(I_blr, root, I_blr_ds_r, I_blr_ds_c, dynamic_address);
...
struct I_blr_ds_I_blr_ds_id0_0_merged_banks_9_cache {
	// RAM Box: {[0, 14], [0, 14]}
	// Capacity: 33
	// # of read delays: 9
	hw_uint<32>  f0;
...
struct I_blr_ds_cache {
  I_blr_ds_I_blr_ds_id0_0_merged_banks_9_cache I_blr_ds_I_blr_ds_id0_0_merged_banks_9;
};



inline void I_blr_ds_I_blr_ds_id0_0_write(hw_uint<32> & I_blr_ds_I_blr_ds_id0_0, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c, int dynamic_address) {
  I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.push(I_blr_ds_I_blr_ds_id0_0);
}

inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_19_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_32();
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_20_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_31();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_21_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_30();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_22_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_17();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_23_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_16();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_24_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_15();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_25_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_2();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_26_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_1();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_27_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
  // DD fold: {  }
  auto value_I_blr_ds_I_blr_ds_id0_0 = I_blr_ds.I_blr_ds_I_blr_ds_id0_0_merged_banks_9.peek_0();
  return value_I_blr_ds_I_blr_ds_id0_0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_ds_blr_r = " << I_blr_ds_blr_r  << " I_blr_ds_blr_c = " << I_blr_ds_blr_c  << endl;
	assert(false);
...
inline hw_uint<288> I_blr_ds_I_blr_ds_blr_conv_3_30_read_bundle_read(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
  // # of ports in bundle: 9
	...
	hw_uint<288> result;
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_19_res = I_blr_ds_I_blr_ds_blr_conv_3_30_19_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<0, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_19_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_20_res = I_blr_ds_I_blr_ds_blr_conv_3_30_20_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<32, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_20_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_21_res = I_blr_ds_I_blr_ds_blr_conv_3_30_21_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<64, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_21_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_22_res = I_blr_ds_I_blr_ds_blr_conv_3_30_22_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<96, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_22_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_23_res = I_blr_ds_I_blr_ds_blr_conv_3_30_23_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<128, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_23_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_24_res = I_blr_ds_I_blr_ds_blr_conv_3_30_24_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<160, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_24_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_25_res = I_blr_ds_I_blr_ds_blr_conv_3_30_25_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<192, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_25_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_26_res = I_blr_ds_I_blr_ds_blr_conv_3_30_26_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
	set_at<224, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_26_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_27_res = I_blr_ds_I_blr_ds_blr_conv_3_30_27_select(I_blr_ds, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
...
inline void I_blr_ds_I_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_id0_write, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c, int dynamic_address) {
	...
	I_blr_ds_I_blr_ds_id0_0_write(I_blr_ds_I_blr_ds_id0_0_res, I_blr_ds, root, I_blr_ds_r, I_blr_ds_c, dynamic_address);
}
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_17_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_17;
};



inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_17.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18);
}

inline hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_17_select(I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_ds_blr_conv_3_30_write, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c, int dynamic_address) {
	...
	I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_write(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_res, I_blr_ds_blr, root, I_blr_ds_blr_r, I_blr_ds_blr_c, dynamic_address);
}
...
inline hw_uint<32> I_blr_ds_blr_I_blr_ds_blr_ds_id0_read_bundle_read(I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_17_res = I_blr_ds_blr_I_blr_ds_blr_ds_id0_17_select(I_blr_ds_blr, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c, dynamic_address);
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3;
};



inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c, int dynamic_address) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16);
}
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c, int dynamic_address) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_write(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_res, I_blr_ds_blr_ds, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c, dynamic_address);
}
