...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_27_cache {
	...
	// # of read delays: 39
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_27_store[169];

#else
  hw_uint<32> * I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_27_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_27_store[(d0 + d1*13)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_27_store[(d0 + d1*13)] = value;
  }
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_cache {
	...
	// # of read delays: 12
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_store[36];

#else
  hw_uint<32> * I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_store[(d0 + d1*6)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_5_store[(d0 + d1*6)] = value;
  }
