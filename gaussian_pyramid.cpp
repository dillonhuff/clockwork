...
// Always 0
//	is optimizable constant: 0
	int value_I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14 = I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_delay.peek_0();
	  ...
	  for (int c1 = 0; c1 <= 31; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 >= 16 && c0 <= 30 && c1 >= 16 && c1 <= 30) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_16, I_blr_ds_I_blr_ds_id0_0, 0, c0 - 16, c1 - 16);
	        if (c0 >= 18 && c1 >= 18) {
