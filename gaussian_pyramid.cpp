...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_27.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_12);
}
