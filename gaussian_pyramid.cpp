...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_13 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_14 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_15 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_16 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_17 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_18 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_19 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_20 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_I_blr_conv_3_30_21 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Read schedule : { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> [2 + I_blr_r, 2 + I_blr_c, 1] : 0 <= I_blr_r <= 29 and 0 <= I_blr_c <= 29 }
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: {  }
...
struct I_blr_I_blr_conv_3_30_12_merged_banks_1_cache {
	// RAM Box: {[0, 29], [0, 29]}
	// Capacity: 1
	// # of read delays: 1
	fifo<hw_uint<32> , 1> f;
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_12_merged_banks_1_cache I_blr_I_blr_conv_3_30_12_merged_banks_1;
};
...
inline void I_blr_I_blr_conv_3_30_12_write(hw_uint<32> & I_blr_I_blr_conv_3_30_12, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  I_blr.I_blr_I_blr_conv_3_30_12_merged_banks_1.push(I_blr_I_blr_conv_3_30_12);
}
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_1_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // DD fold: {  }
  auto value_I_blr_I_blr_conv_3_30_12 = I_blr.I_blr_I_blr_conv_3_30_12_merged_banks_1.peek(/* one reader or all rams */ 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_10 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[2 + I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_11 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[2 + I_blr_ds_blr_r, 2 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_3 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[I_blr_ds_blr_r, I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_4 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_5 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[I_blr_ds_blr_r, 2 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_6 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_7 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_8 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, 2 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_I_blr_ds_blr_conv_3_30_9 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[2 + I_blr_ds_blr_r, I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Read schedule : { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> [6 + 2I_blr_ds_blr_r, 6 + 2I_blr_ds_blr_c, 3] : 0 <= I_blr_ds_blr_r <= 12 and 0 <= I_blr_ds_blr_c <= 12 }
  // Write schedule: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> [2 + 2I_blr_ds_r, 2 + 2I_blr_ds_c, 2] : 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_23_cache {
	// RAM Box: {[0, 12], [0, 12]}
	// Capacity: 39
	// # of read delays: 39
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_23_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_23;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_23.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_2);
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // I_blr_ds_blr_I_blr_ds_blr_ds_id0_23 read pattern: { I_blr_ds_blr_ds_id0[root = 0, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c] -> I_blr_ds_blr[2I_blr_ds_blr_ds_r, 2I_blr_ds_blr_ds_c] : 0 <= I_blr_ds_blr_ds_r <= 5 and 0 <= I_blr_ds_blr_ds_c <= 5 }
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22);
}
...
inline void I_blr_ds_id0(I_blr_cache& I_blr, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c) {
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "I_blr_ds_id0_I_blr," << root<< "," << I_blr_ds_r<< "," << I_blr_ds_c<< "," <<  I_blr_2_m_I_blr_ds_r_c__2_m_I_blr_ds_c_value << endl;
#endif //__VIVADO_SYNTH__
  ...
  *global_debug_handle << "I_blr_ds_id0," << (1*root + 0) << ", " << I_blr_ds_r<< "," << I_blr_ds_c<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
inline void I_blr_ds_blr_conv_3_30(I_blr_ds_cache& I_blr_ds, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  *global_debug_handle << "I_blr_ds_blr_conv_3_30_I_blr_ds," << root<< "," << I_blr_ds_blr_r<< "," << I_blr_ds_blr_c<< "," <<  I_blr_ds_I_blr_ds_blr_r__p__0_c__I_blr_ds_blr_c__p__0_value << endl;
  ...
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "I_blr_ds_blr_conv_3_30," << (1*root + 0) << ", " << I_blr_ds_blr_r<< "," << I_blr_ds_blr_c<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
inline void I_blr_conv_3_30(I_cache& I, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  ...
  *global_debug_handle << "I_blr_conv_3_30_I," << root<< "," << I_blr_r<< "," << I_blr_c<< "," <<  I_I_blr_r__p__0_c__I_blr_c__p__0_value << endl;
  ...
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "I_blr_conv_3_30," << (1*root + 0) << ", " << I_blr_r<< "," << I_blr_c<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "I_blr_ds_blr_ds_id0_I_blr_ds_blr," << root<< "," << I_blr_ds_blr_ds_r<< "," << I_blr_ds_blr_ds_c<< "," <<  I_blr_ds_blr_2_m_I_blr_ds_blr_ds_r_c__2_m_I_blr_ds_blr_ds_c_value << endl;
#endif //__VIVADO_SYNTH__
  ...
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "I_blr_ds_blr_ds_id0," << (1*root + 0) << ", " << I_blr_ds_blr_ds_r<< "," << I_blr_ds_blr_ds_c<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_I_blr_ds_blr_ds," << root<< "," << I_blr_ds_blr_ds_out_r<< "," << I_blr_ds_blr_ds_out_c<< "," <<  I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  hw_uint<32> debug_I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value(I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value);
  hw_uint<32> debug_I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value_lane_0;
  set_at<0, 32, 32>(debug_I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value_lane_0, debug_I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value.extract<0, 31>());
  *global_debug_handle << "store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds," << (1*root + 0) << ", " << I_blr_ds_blr_ds_out_r<< "," << I_blr_ds_blr_ds_out_c<< "," <<  debug_I_blr_ds_blr_ds_I_blr_ds_blr_ds_out_r_c__I_blr_ds_blr_ds_out_c_value_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
#ifndef __VIVADO_SYNTH__
  hw_uint<32> debug_in_pr_c__pc_value(in_pr_c__pc_value);
  hw_uint<32> debug_in_pr_c__pc_value_lane_0;
  set_at<0, 32, 32>(debug_in_pr_c__pc_value_lane_0, debug_in_pr_c__pc_value.extract<0, 31>());
  *global_debug_handle << "store_I_from_in," << (1*root + 0) << ", " << pr<< "," << pc<< "," <<  debug_in_pr_c__pc_value_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
#pragma HLS INTERFACE m_axi port = store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write offset = slave bundle = gmem
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  read_input(store_I_from_in_read, store_I_from_in_read_channel, size);

  gaussian_pyramid(store_I_from_in_read_channel, store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write_channel);

  write_output(store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write, store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_write_channel, size);
}
