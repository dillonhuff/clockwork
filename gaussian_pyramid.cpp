...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (64) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((35 + I_blurred_c)) : 0));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (32) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((3 + I_blurred_c)) : 0));
	return value_I_store_I_from_in_16;
}
...
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek_0();
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_1();
...
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_0();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_32();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_31();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_17();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_16();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek_2();
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}
	...
	for (int c0 = 0; c0 <= 31; c0 += 1)
	  for (int c1 = 0; c1 <= 31; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 % 2 == 0 && c1 % 2 == 0) {
	        I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_18, 0, (c0 / 2) - 1, (c1 / 2) - 1);
	        if (c0 >= 6 && c1 >= 6)
	          I_blurred_downsampled_blurred_conv_3_30(I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, 0, (c0 / 2) - 3, (c1 / 2) - 3);
	      }
	      if (c0 >= 11 && c0 <= 26 && c1 >= 11 && c1 <= 26 && (c0 + 1) % 3 == 0 && (c1 + 1) % 3 == 0)
	        I_blurred_downsampled_blurred_downsampled_id0(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12, 0, (c0 - 11) / 3, (c1 - 11) / 3);
	      if (c0 % 2 == 0 && c1 % 2 == 0) {
	        store_I_blurred_downsampled_out_from_I_blurred_downsampled(I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_out, 0, (c0 / 2) - 1, (c1 / 2) - 1);
