...
struct I_blr_I_blr_conv_3_30_10_merged_banks_1_cache {
	// RAM Box: {[0, 29], [0, 29]}
	// Capacity: 1
	// # of read delays: 1
	fifo<hw_uint<32> , 1> f;
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_10_merged_banks_1_cache I_blr_I_blr_conv_3_30_10_merged_banks_1;
};
...
inline void I_blr_I_blr_conv_3_30_10_write(hw_uint<32> & I_blr_I_blr_conv_3_30_10, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  I_blr.I_blr_I_blr_conv_3_30_10_merged_banks_1.push(I_blr_I_blr_conv_3_30_10);
}
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_21_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // DD fold: {  }
  auto value_I_blr_I_blr_conv_3_30_10 = I_blr.I_blr_I_blr_conv_3_30_10_merged_banks_1.peek(/* one reader or all rams */ 0);
