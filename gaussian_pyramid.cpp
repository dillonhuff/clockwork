...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_7_cache {
	...
	// # of read delays: 39
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_7_store[169];

#else
  hw_uint<32> * I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_7_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_7_store[(d0 + d1*13)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_7_store[(d0 + d1*13)] = value;
  }
