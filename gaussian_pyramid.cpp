...
// Always 0
//	is optimizable constant: 0
	int value_I_blr_I_blr_conv_3_30_14 = I_blr_I_blr_conv_3_30_14_delay.peek_0();
	  ...
	  for (int c1 = 0; c1 <= 31; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 >= 11 && c0 <= 26 && c1 >= 11 && c1 <= 26 && (c0 + 1) % 3 == 0 && (c1 + 1) % 3 == 0)
	        I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_26, 0, (c0 - 11) / 3, (c1 - 11) / 3);
