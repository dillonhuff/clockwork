...
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_66();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_65();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_64();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_34();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_33();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_32();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_2();
	return value_I_store_I_from_in_22;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_1();
	return value_I_store_I_from_in_22;
}
...
//	is optimizable constant: 0
	hw_uint<32>  value_I_store_I_from_in_22 = I_store_I_from_in_22_delay.peek_0();
	return value_I_store_I_from_in_22;
}
...
// Always 0
//	is optimizable constant: 0
	hw_uint<32>  value_I_blr_I_blr_conv_3_30_0 = I_blr_I_blr_conv_3_30_0_delay.peek_0();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_32();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_31();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_30();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_17();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_16();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_15();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_2();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_1();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
// Always 0
//	is optimizable constant: 0
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_20 = I_blr_ds_I_blr_ds_id0_20_delay.peek_0();
	return value_I_blr_ds_I_blr_ds_id0_20;
}
...
void gaussian_pyramid(HWStream<hw_uint<32>  >& in, HWStream<hw_uint<32> >& I_blr_ds_blr_ds_out) {
	...
	for (int c0 = 0; c0 <= 31; c0 += 1)
	  for (int c1 = 0; c1 <= 31; c1 += 1) {
	    store_I_from_in(in, I_store_I_from_in_22, 0, c0, c1);
	    if (c0 >= 2 && c1 >= 2) {
	      I_blr_conv_3_30(I_store_I_from_in_22, I_blr_I_blr_conv_3_30_0, 0, c0 - 2, c1 - 2);
	      if (c0 % 2 == 0 && c1 % 2 == 0) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_0, I_blr_ds_I_blr_ds_id0_20, 0, (c0 / 2) - 1, (c1 / 2) - 1);
	        if (c0 >= 6 && c1 >= 6)
	          I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_20, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10, 0, (c0 / 2) - 3, (c1 / 2) - 3);
	      }
	      if (c0 >= 11 && c0 <= 26 && c1 >= 11 && c1 <= 26 && (c0 + 1) % 3 == 0 && (c1 + 1) % 3 == 0)
	        I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, 0, (c0 - 11) / 3, (c1 - 11) / 3);
	      if (c0 >= 16 && c0 <= 26 && c1 >= 16 && c1 <= 26 && c0 % 2 == 0 && c1 % 2 == 0)
	        store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, I_blr_ds_blr_ds_out, 0, (c0 / 2) - 8, (c1 / 2) - 8);
	    }
	  }
