...
struct I_blr_ds_I_blr_ds_id0_16_merged_banks_9_cache {
	...
	// # of read delays: 9
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_I_blr_ds_id0_16_merged_banks_9_store[225];

#else
  hw_uint<32> * I_blr_ds_I_blr_ds_id0_16_merged_banks_9_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_I_blr_ds_id0_16_merged_banks_9_store[(d0 + d1*15)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_I_blr_ds_id0_16_merged_banks_9_store[(d0 + d1*15)] = value;
  }
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_blr_ds_I_blr_ds_id0_16_merged_banks_9: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_cache {
	...
	// # of read delays: 39
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_store[169];

#else
  hw_uint<32> * I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_store[(d0 + d1*13)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_store[(d0 + d1*13)] = value;
  }
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache {
	...
	// # of read delays: 12
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_store[36];

#else
  hw_uint<32> * I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_store[(d0 + d1*6)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_store[(d0 + d1*6)] = value;
  }
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14);
}
