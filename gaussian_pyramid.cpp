...
struct I_store_I_from_in_6_merged_banks_9_cache {
	// RAM Box: {[0, 31], [0, 31]}
	// Capacity: 67
	// # of read delays: 9
	hw_uint<32>  f0;
...
struct I_cache {
  I_store_I_from_in_6_merged_banks_9_cache I_store_I_from_in_6_merged_banks_9;
};



inline void I_store_I_from_in_6_write(hw_uint<32> & I_store_I_from_in_6, I_cache& I, int root, int pr, int pc) {
  I.I_store_I_from_in_6_merged_banks_9.push(I_store_I_from_in_6);
}
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_66();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_65();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_64();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_34();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_33();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_32();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_2();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_1();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
#pragma HLS dependence variable=I inter false
  ...
  // Write schedule: { store_I_from_in[root = 0, pr, pc] -> [pr, pc, 0] : 0 <= pr <= 31 and 0 <= pc <= 31 }
  // DD fold: {  }
  auto value_I_store_I_from_in_6 = I.I_store_I_from_in_6_merged_banks_9.peek_0();
  return value_I_store_I_from_in_6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " I_blr_r = " << I_blr_r  << " I_blr_c = " << I_blr_c  << endl;
	assert(false);
...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_cache& I, int root, int pr, int pc) {
	hw_uint<32>  I_store_I_from_in_6_res = store_I_from_in_write.extract<0, 31>();
	I_store_I_from_in_6_write(I_store_I_from_in_6_res, I, root, pr, pc);
}
...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_5_cache {
	// RAM Box: {[0, 12], [0, 12]}
	// Capacity: 39
	// # of read delays: 39
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_5_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_5;
};



inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_5.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8);
}
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_ds_blr_conv_3_30_write, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	...
	I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_write(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_8_res, I_blr_ds_blr, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
}
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_3.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4);
}
