...
struct I_store_I_from_in_2_merged_banks_9_cache {
  ...
  hw_uint<32>  I_store_I_from_in_2_merged_banks_9_store[1024];

#else
  hw_uint<32> * I_store_I_from_in_2_merged_banks_9_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_store_I_from_in_2_merged_banks_9_store[(d0 + d1*32)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_store_I_from_in_2_merged_banks_9_store[(d0 + d1*32)] = value;
  }
...
struct I_blr_I_blr_conv_3_30_4_merged_banks_1_cache {
	...
	// # of read delays: 1
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_I_blr_conv_3_30_4_merged_banks_1_store[900];

#else
  hw_uint<32> * I_blr_I_blr_conv_3_30_4_merged_banks_1_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_I_blr_conv_3_30_4_merged_banks_1_store[(d0 + d1*30)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_I_blr_conv_3_30_4_merged_banks_1_store[(d0 + d1*30)] = value;
  }
