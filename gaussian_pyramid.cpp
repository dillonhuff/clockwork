	...
	for (int c0 = 0; c0 <= 31; c0 += 1)
	  for (int c1 = 0; c1 <= 31; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 % 2 == 0 && c1 % 2 == 0) {
	        I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_12, 0, (c0 / 2) - 1, (c1 / 2) - 1);
	        if (c0 >= 6 && c1 >= 6)
	          I_blurred_downsampled_blurred_conv_3_30(I_blurred_downsampled_I_blurred_downsampled_id0_12, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, 0, (c0 / 2) - 3, (c1 / 2) - 3);
	      }
	      if (c0 >= 11 && c0 <= 26 && c1 >= 11 && c1 <= 26 && (c0 + 1) % 3 == 0 && (c1 + 1) % 3 == 0)
	        I_blurred_downsampled_blurred_downsampled_id0(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_14, 0, (c0 - 11) / 3, (c1 - 11) / 3);
	      if (c0 % 2 == 0 && c1 % 2 == 0) {
