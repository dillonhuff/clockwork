...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_cache {
	...
	// # of read delays: 39
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_store[169];

#else
  hw_uint<32> * I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_store[(d0 + d1*13)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_store[(d0 + d1*13)] = value;
  }
...
struct I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_cache {
	// RAM Box: {[0, 5], [0, 5]}
	// Capacity: 12
	// # of read delays: 12
#ifdef __VIVADO_SYNTH__
  hw_uint<32>  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_store[36];

#else
  hw_uint<32> * I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_store;
#endif // __VIVADO_SYNTH__
  hw_uint<32>  read(int d0, int d1) {    return I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_store[(d0 + d1*6)];  }

  void write(hw_uint<32> & value, int d0, int d1) {
    I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_store[(d0 + d1*6)] = value;
  }
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_23.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10);
}
