...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_to_I_blr_ds_blr_I_blr_ds_blr_ds_id0_3: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_blr_ds_blr_ds_cache {
  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15;
};
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_to_I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2);
}
