...
hw_uint<128>  jacobi2d_compute_unrolled_4(hw_uint<448>& t1) {
  ...
  // Need offset: 2, 0
  set_at<128, 160, 32>(lane_1_t1, t1.extract<256, 287>());
  auto result_1 = jacobi2d_compute(lane_1_t1);
  set_at<32, 128, 32>(whole_result, result_1);
  hw_uint<160> lane_2_t1;
  // Need offset: 1, 0
  set_at<0, 160, 32>(lane_2_t1, t1.extract<160, 191>());
  // Need offset: 2, -1
  set_at<32, 160, 32>(lane_2_t1, t1.extract<224, 255>());
  // Need offset: 2, 0
  set_at<64, 160, 32>(lane_2_t1, t1.extract<256, 287>());
  // Need offset: 2, 1
  set_at<96, 160, 32>(lane_2_t1, t1.extract<288, 319>());
  // Need offset: 3, 0
  set_at<128, 160, 32>(lane_2_t1, t1.extract<352, 383>());
  auto result_2 = jacobi2d_compute(lane_2_t1);
  set_at<64, 128, 32>(whole_result, result_2);
  hw_uint<160> lane_3_t1;
  // Need offset: 2, 0
  set_at<0, 160, 32>(lane_3_t1, t1.extract<256, 287>());
  // Need offset: 3, -1
  set_at<32, 160, 32>(lane_3_t1, t1.extract<320, 351>());
  // Need offset: 3, 0
  set_at<64, 160, 32>(lane_3_t1, t1.extract<352, 383>());
  // Need offset: 3, 1
  set_at<96, 160, 32>(lane_3_t1, t1.extract<384, 415>());
  // Need offset: 4, 0
  set_at<128, 160, 32>(lane_3_t1, t1.extract<416, 447>());
