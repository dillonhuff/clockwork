#include "jacobi2d_unrolled_2_opt_kernel.h"
#include <iostream>
#include <fstream>
...
jacobi2d_unrolled_2_opt_kernel(y_res, f, u, num_transfers);
  write_results<bits_per_pixel>("soda_jacobi2d_unrolled_2_opt_regression_result.csv", y_res, nrows, ncols, transfer_cols);
  free(y_res);
}
