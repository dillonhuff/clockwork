...
#include "blur_xy_unrolled_1_opt_compute_units.h"
...
inline hw_uint<32>  blur_xy_unrolled_1_rd0_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=blurx inter false
#endif //__VIVADO_SYNTH__
  // blur_xy_unrolled_1_rd0 read pattern: { blur_xy_unrolled_1_update_0[d0, d1] -> blurx[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_unrolled_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_unrolled_1_update_0[d0, d1] -> 2 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<32>  blur_xy_unrolled_1_rd1_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=blurx inter false
#endif //__VIVADO_SYNTH__
  // blur_xy_unrolled_1_rd1 read pattern: { blur_xy_unrolled_1_update_0[d0, d1] -> blurx[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_unrolled_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_unrolled_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<32>  blur_xy_unrolled_1_rd2_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=blurx inter false
#endif //__VIVADO_SYNTH__
  // blur_xy_unrolled_1_rd2 read pattern: { blur_xy_unrolled_1_update_0[d0, d1] -> blurx[2 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_unrolled_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// # of bundles = 2
// blur_xy_unrolled_1_update_0_read
//	blur_xy_unrolled_1_rd0
//	blur_xy_unrolled_1_rd1
//	blur_xy_unrolled_1_rd2
inline hw_uint<96> blurx_blur_xy_unrolled_1_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1) {
  // # of ports in bundle: 3
	...
	hw_uint<96> result;
	hw_uint<32>  blur_xy_unrolled_1_rd0_res = blur_xy_unrolled_1_rd0_select(blurx, d0, d1);
	set_at<0, 96>(result, blur_xy_unrolled_1_rd0_res);
	hw_uint<32>  blur_xy_unrolled_1_rd1_res = blur_xy_unrolled_1_rd1_select(blurx, d0, d1);
	set_at<32, 96>(result, blur_xy_unrolled_1_rd1_res);
	hw_uint<32>  blur_xy_unrolled_1_rd2_res = blur_xy_unrolled_1_rd2_select(blurx, d0, d1);
	set_at<64, 96>(result, blur_xy_unrolled_1_rd2_res);
	return result;
}
...
inline hw_uint<96> input_blurx_update_0_read_bundle_read(input_cache& input, int d0, int d1) {
  // # of ports in bundle: 3
	...
	set_at<32, 96>(result, blurx_rd1_res);
	hw_uint<32>  blurx_rd2_res = blurx_rd2_select(input, d0, d1);
	set_at<64, 96>(result, blurx_rd2_res);
	return result;
}
...
// Operation logic
inline void input_update_0(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */input_arg, input_cache& input, int d0, int d1) {
	// Consume: input_arg
	auto input_arg_0_c__0_value = input_arg.read();
	auto compute_result = id(input_arg_0_c__0_value);
	// Produce: input
...
inline void blur_xy_unrolled_1_update_0(blurx_cache& blurx, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */blur_xy_unrolled_1, int d0, int d1) {
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_blur_xy_unrolled_1_update_0_read_bundle_read(blurx/* source_delay */, d0, d1);
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "blur_xy_unrolled_1_update_0_blurx," << d0<< "," << d1<< "," <<  blurx_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
	auto compute_result = blury_comp(blurx_0_c__0_value);
	// Produce: blur_xy_unrolled_1
	blur_xy_unrolled_1.write(compute_result);
#ifndef __VIVADO_SYNTH__
  hw_uint<32> debug_compute_result(compute_result);
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "blur_xy_unrolled_1_update_0," << (1*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
}
...
#endif //__VIVADO_SYNTH__
	auto compute_result = blurx_comp(input_0_c__0_value);
	// Produce: blurx
...
// Driver function
void blur_xy_unrolled_1_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */input_arg, HWStream<hw_uint<32> >& /* get_args num ports = 1 */blur_xy_unrolled_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("blur_xy_unrolled_1_opt_debug.csv");
...
#pragma HLS dependence variable=input inter false
	...
	blurx_update_0(input, blurx, c1, c0 - 2);
	      if (c1 >= 2)
	blur_xy_unrolled_1_update_0(blurx, blur_xy_unrolled_1, c1 - 2, c0 - 2);
	    }
	  }
