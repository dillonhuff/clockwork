...
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = t1_update_0_read_arg offset = slave bundle = gmem
#pragma HLS INTERFACE m_axi port = jacobi2d_unrolled_1_update_0_write_arg offset = slave bundle = gmem
#pragma HLS INTERFACE s_axilite port = t1_update_0_read_arg bundle = control
#pragma HLS INTERFACE s_axilite port = jacobi2d_unrolled_1_update_0_write_arg bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  //HWStream<hw_uint<32> > jacobi2d_unrolled_1;

  read_input(t1_update_0_read_arg, t1_arg, size);

  jacobi2d_unrolled_1_opt(t1_arg, jacobi2d_unrolled_1);

  write_output(jacobi2d_unrolled_1_update_0_write_arg, jacobi2d_unrolled_1, size);
}
}
