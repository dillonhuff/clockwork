...
int main() {
  ...
  // Loading input data
  // cmap    : { t1_update_0[root = 0, t1_0, t1_1] -> t1_arg[0, 0] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
  // read map: { t1_arg[0, 0] -> t1_update_0[root = 0, t1_0, t1_1] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
  // rng     : { t1_update_0[root = 0, t1_0, t1_1] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
