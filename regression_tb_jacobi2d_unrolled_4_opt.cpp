...
int main() {
  ...
  HWStream<hw_uint<128> > t1_comp_read;
  HWStream<hw_uint<128> > jacobi2d_unrolled_4_comp_write;


  // Loading input data
  // cmap    : { t1_comp[root = 0, t1_0, t1_1] -> t1_arg[0, 0] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
  // read map: { t1_arg[0, 0] -> t1_comp[root = 0, t1_0, t1_1] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
  // rng     : { t1_comp[root = 0, t1_0, t1_1] : -1 <= t1_0 <= 256 and -1 <= t1_1 <= 1024 }
  for (int i = 0; i < 264708; i++) {
    hw_uint<128> in_val;
  ...
  jacobi2d_unrolled_4_opt(t1_comp_read, jacobi2d_unrolled_4_comp_write);

  for (int i = 0; i < 262144; i++) {
    hw_uint<128> actual = jacobi2d_unrolled_4_comp_write.read();
