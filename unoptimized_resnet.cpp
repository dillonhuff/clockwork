...
inline void conv_stencil_op_hcompute_conv_stencil_1_6_write(hw_uint<16>& conv_stencil_op_hcompute_conv_stencil_1_6, conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
  conv_stencil.conv_stencil_all_inputs_to_all_outputs.write(conv_stencil_op_hcompute_conv_stencil_1_6, conv_s1_y - 0, conv_s1_x - 0, 4*conv_s1_oc - 0);
}

inline void conv_stencil_op_hcompute_conv_stencil_1_7_write(hw_uint<16>& conv_stencil_op_hcompute_conv_stencil_1_7, conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
  conv_stencil.conv_stencil_all_inputs_to_all_outputs.write(conv_stencil_op_hcompute_conv_stencil_1_7, conv_s1_y - 0, conv_s1_x - 0, 1 + 4*conv_s1_oc - 0);
}

inline void conv_stencil_op_hcompute_conv_stencil_1_8_write(hw_uint<16>& conv_stencil_op_hcompute_conv_stencil_1_8, conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
  conv_stencil.conv_stencil_all_inputs_to_all_outputs.write(conv_stencil_op_hcompute_conv_stencil_1_8, conv_s1_y - 0, conv_s1_x - 0, 2 + 4*conv_s1_oc - 0);
}

inline void conv_stencil_op_hcompute_conv_stencil_1_9_write(hw_uint<16>& conv_stencil_op_hcompute_conv_stencil_1_9, conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
  conv_stencil.conv_stencil_all_inputs_to_all_outputs.write(conv_stencil_op_hcompute_conv_stencil_1_9, conv_s1_y - 0, conv_s1_x - 0, 3 + 4*conv_s1_oc - 0);
}
...
inline hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_10_select(conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_op_hcompute_conv_stencil_1_10 read pattern: { op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> conv_stencil[conv_s1_y, conv_s1_x, 4conv_s1_oc] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3 }
  auto value_conv_stencil_op_hcompute_conv_stencil_1_6 = conv_stencil.conv_stencil_all_inputs_to_all_outputs.read(conv_s1_y - 0, conv_s1_x - 0, 4*conv_s1_oc - 0);
  return value_conv_stencil_op_hcompute_conv_stencil_1_6;
  return 0;
}

inline hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_15_select(conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_op_hcompute_conv_stencil_1_15 read pattern: { op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> conv_stencil[conv_s1_y, conv_s1_x, 1 + 4conv_s1_oc] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3 }
  auto value_conv_stencil_op_hcompute_conv_stencil_1_6 = conv_stencil.conv_stencil_all_inputs_to_all_outputs.read(conv_s1_y - 0, conv_s1_x - 0, 1 + 4*conv_s1_oc - 0);
  return value_conv_stencil_op_hcompute_conv_stencil_1_6;
  return 0;
}

inline hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_18_select(conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_op_hcompute_conv_stencil_1_18 read pattern: { op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> conv_stencil[conv_s1_y, conv_s1_x, 2 + 4conv_s1_oc] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3 }
  auto value_conv_stencil_op_hcompute_conv_stencil_1_6 = conv_stencil.conv_stencil_all_inputs_to_all_outputs.read(conv_s1_y - 0, conv_s1_x - 0, 2 + 4*conv_s1_oc - 0);
  return value_conv_stencil_op_hcompute_conv_stencil_1_6;
  return 0;
}

inline hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_21_select(conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_op_hcompute_conv_stencil_1_21 read pattern: { op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> conv_stencil[conv_s1_y, conv_s1_x, 3 + 4conv_s1_oc] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3 }
  auto value_conv_stencil_op_hcompute_conv_stencil_1_6 = conv_stencil.conv_stencil_all_inputs_to_all_outputs.read(conv_s1_y - 0, conv_s1_x - 0, 3 + 4*conv_s1_oc - 0);
  return value_conv_stencil_op_hcompute_conv_stencil_1_6;
  return 0;
}
...
inline hw_uint<16> conv_stencil_op_hcompute_hw_output_stencil_1_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_w, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  ...
  auto value_conv_stencil_op_hcompute_conv_stencil_1_6 = conv_stencil.conv_stencil_all_inputs_to_all_outputs.read(hw_output_s0_y_yi - 0, hw_output_s0_x_xi - 0, hw_output_s0_w - 0);
  return value_conv_stencil_op_hcompute_conv_stencil_1_6;
  return 0;
}
...
//	conv_stencil_op_hcompute_conv_stencil_1_10
//	conv_stencil_op_hcompute_conv_stencil_1_15
//	conv_stencil_op_hcompute_conv_stencil_1_18
//	conv_stencil_op_hcompute_conv_stencil_1_21
inline hw_uint<64> conv_stencil_op_hcompute_conv_stencil_1_read_bundle_read(conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
  // # of ports in bundle: 4
	...
	hw_uint<64> result;
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_10_res = conv_stencil_op_hcompute_conv_stencil_1_10_select(conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	set_at<0, 64>(result, conv_stencil_op_hcompute_conv_stencil_1_10_res);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_15_res = conv_stencil_op_hcompute_conv_stencil_1_15_select(conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	set_at<16, 64>(result, conv_stencil_op_hcompute_conv_stencil_1_15_res);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_18_res = conv_stencil_op_hcompute_conv_stencil_1_18_select(conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	set_at<32, 64>(result, conv_stencil_op_hcompute_conv_stencil_1_18_res);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_21_res = conv_stencil_op_hcompute_conv_stencil_1_21_select(conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	set_at<48, 64>(result, conv_stencil_op_hcompute_conv_stencil_1_21_res);
	return result;
}
...
//	conv_stencil_op_hcompute_conv_stencil_1_8
//	conv_stencil_op_hcompute_conv_stencil_1_9
inline void conv_stencil_op_hcompute_conv_stencil_1_write_bundle_write(hw_uint<64>& op_hcompute_conv_stencil_1_write, conv_stencil_cache& conv_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic, int dynamic_address) {
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_6_res = op_hcompute_conv_stencil_1_write.extract<0, 15>();
	conv_stencil_op_hcompute_conv_stencil_1_6_write(conv_stencil_op_hcompute_conv_stencil_1_6_res, conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_7_res = op_hcompute_conv_stencil_1_write.extract<16, 31>();
	conv_stencil_op_hcompute_conv_stencil_1_7_write(conv_stencil_op_hcompute_conv_stencil_1_7_res, conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_8_res = op_hcompute_conv_stencil_1_write.extract<32, 47>();
	conv_stencil_op_hcompute_conv_stencil_1_8_write(conv_stencil_op_hcompute_conv_stencil_1_8_res, conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
	hw_uint<16> conv_stencil_op_hcompute_conv_stencil_1_9_res = op_hcompute_conv_stencil_1_write.extract<48, 63>();
	conv_stencil_op_hcompute_conv_stencil_1_9_write(conv_stencil_op_hcompute_conv_stencil_1_9_res, conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, dynamic_address);
}
...
// Total re-use buffer capacity: 350208 bits
...
inline void op_hcompute_conv_stencil_1(conv_stencil_cache& conv_stencil, hw_input_stencil_cache& hw_input_stencil, hw_kernel_stencil_cache& hw_kernel_stencil, int root, int conv_s1_r_y, int conv_s1_r_x, int conv_s1_oc, int conv_s1_y, int conv_s1_x, int conv_s1_ic) {
  // Dynamic address computation

	// Consume: conv_stencil
	auto conv_stencil_conv_s1_y_c__conv_s1_x_c__conv_s1_oc_m_4_p_0_value = conv_stencil_op_hcompute_conv_stencil_1_read_bundle_read(conv_stencil/* source_delay */, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, 0);
	...
	auto compute_result = hcompute_conv_stencil_1(conv_stencil_conv_s1_y_c__conv_s1_x_c__conv_s1_oc_m_4_p_0_value, hw_input_stencil__lp_conv_s1_r_y__p__conv_s1_y_rp__c___lp_conv_s1_r_x__p__conv_s1_x_rp__c__0_p_conv_s1_ic_m_2_value, hw_kernel_stencil__lp_conv_s1_r_y_rp__c___lp_conv_s1_r_x_rp__c__0_p_conv_s1_oc_m_4_c__0_p_conv_s1_ic_m_2_value);
	// Produce: conv_stencil
	conv_stencil_op_hcompute_conv_stencil_1_write_bundle_write(/* arg names */compute_result, conv_stencil, root, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic, 0);
...
// schedule: { op_hcompute_conv_stencil[root = 0, conv_s0_w, conv_s0_y, conv_s0_x] -> [0, 0, 2, conv_s0_w, 0, conv_s0_y, 0, conv_s0_x, 0, 0, 0, 0, 0, 0, 0] : 0 <= conv_s0_w <= 15 and 0 <= conv_s0_y <= 27 and 0 <= conv_s0_x <= 27; op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> [0, 0, 3, conv_s1_r_y, 0, conv_s1_r_x, 0, conv_s1_oc, 0, conv_s1_y, 0, conv_s1_x, 0, conv_s1_ic, 0] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3; op_hcompute_hw_input_stencil[root = 0, hw_input_s0_y, hw_input_s0_x, hw_input_s0_z] -> [0, 0, 0, hw_input_s0_y, 0, hw_input_s0_x, 0, hw_input_s0_z, 0, 0, 0, 0, 0, 0, 0] : 0 <= hw_input_s0_y <= 31 and 0 <= hw_input_s0_x <= 31 and 0 <= hw_input_s0_z <= 7; op_hcompute_hw_output_stencil[root = 0, hw_output_s0_w, hw_output_s0_y_yi, hw_output_s0_x_xi] -> [0, 0, 4, hw_output_s0_w, 0, hw_output_s0_y_yi, 0, hw_output_s0_x_xi, 0, 0, 0, 0, 0, 0, 0] : 0 <= hw_output_s0_w <= 15 and 0 <= hw_output_s0_y_yi <= 27 and 0 <= hw_output_s0_x_xi <= 27; op_hcompute_hw_kernel_stencil[root = 0, hw_kernel_s0_y, hw_kernel_s0_x, hw_kernel_s0_w, hw_kernel_s0_z] -> [0, 0, 1, hw_kernel_s0_y, 0, hw_kernel_s0_x, 0, hw_kernel_s0_w, 0, hw_kernel_s0_z, 0, 0, 0, 0, 0] : 0 <= hw_kernel_s0_y <= 2 and 0 <= hw_kernel_s0_x <= 2 and 0 <= hw_kernel_s0_w <= 15 and 0 <= hw_kernel_s0_z <= 7 }
//   { op_hcompute_conv_stencil[root = 0, conv_s0_w, conv_s0_y, conv_s0_x] -> [0, 0, 2, conv_s0_w, 0, conv_s0_y, 0, conv_s0_x, 0, 0, 0, 0, 0, 0, 0] : 0 <= conv_s0_w <= 15 and 0 <= conv_s0_y <= 27 and 0 <= conv_s0_x <= 27 }
// Condition for op_hcompute_conv_stencil(((i14 == 0) && (i13 == 0) && (i12 == 0) && (i11 == 0) && (i10 == 0) && (i9 == 0) && (i8 == 0) && (i6 == 0) && (i4 == 0) && (-2 + i2 == 0) && (i1 == 0) && (i0 == 0) && (i3 >= 0) && (15 - i3 >= 0) && (i5 >= 0) && (27 - i5 >= 0) && (i7 >= 0) && (27 - i7 >= 0)))
//   { op_hcompute_conv_stencil_1[root = 0, conv_s1_r_y, conv_s1_r_x, conv_s1_oc, conv_s1_y, conv_s1_x, conv_s1_ic] -> [0, 0, 3, conv_s1_r_y, 0, conv_s1_r_x, 0, conv_s1_oc, 0, conv_s1_y, 0, conv_s1_x, 0, conv_s1_ic, 0] : 0 <= conv_s1_r_y <= 2 and 0 <= conv_s1_r_x <= 2 and 0 <= conv_s1_oc <= 3 and 0 <= conv_s1_y <= 27 and 0 <= conv_s1_x <= 27 and 0 <= conv_s1_ic <= 3 }
// Condition for op_hcompute_conv_stencil_1(((i14 == 0) && (i12 == 0) && (i10 == 0) && (i8 == 0) && (i6 == 0) && (i4 == 0) && (-3 + i2 == 0) && (i1 == 0) && (i0 == 0) && (i3 >= 0) && (2 - i3 >= 0) && (i5 >= 0) && (2 - i5 >= 0) && (i7 >= 0) && (3 - i7 >= 0) && (i9 >= 0) && (27 - i9 >= 0) && (i11 >= 0) && (27 - i11 >= 0) && (i13 >= 0) && (3 - i13 >= 0)))
//   { op_hcompute_hw_input_stencil[root = 0, hw_input_s0_y, hw_input_s0_x, hw_input_s0_z] -> [0, 0, 0, hw_input_s0_y, 0, hw_input_s0_x, 0, hw_input_s0_z, 0, 0, 0, 0, 0, 0, 0] : 0 <= hw_input_s0_y <= 31 and 0 <= hw_input_s0_x <= 31 and 0 <= hw_input_s0_z <= 7 }
// Condition for op_hcompute_hw_input_stencil(((i14 == 0) && (i13 == 0) && (i12 == 0) && (i11 == 0) && (i10 == 0) && (i9 == 0) && (i8 == 0) && (i6 == 0) && (i4 == 0) && (i2 == 0) && (i1 == 0) && (i0 == 0) && (i3 >= 0) && (31 - i3 >= 0) && (i5 >= 0) && (31 - i5 >= 0) && (i7 >= 0) && (7 - i7 >= 0)))
//   { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_w, hw_output_s0_y_yi, hw_output_s0_x_xi] -> [0, 0, 4, hw_output_s0_w, 0, hw_output_s0_y_yi, 0, hw_output_s0_x_xi, 0, 0, 0, 0, 0, 0, 0] : 0 <= hw_output_s0_w <= 15 and 0 <= hw_output_s0_y_yi <= 27 and 0 <= hw_output_s0_x_xi <= 27 }
// Condition for op_hcompute_hw_output_stencil(((i14 == 0) && (i13 == 0) && (i12 == 0) && (i11 == 0) && (i10 == 0) && (i9 == 0) && (i8 == 0) && (i6 == 0) && (i4 == 0) && (-4 + i2 == 0) && (i1 == 0) && (i0 == 0) && (i3 >= 0) && (15 - i3 >= 0) && (i5 >= 0) && (27 - i5 >= 0) && (i7 >= 0) && (27 - i7 >= 0)))
//   { op_hcompute_hw_kernel_stencil[root = 0, hw_kernel_s0_y, hw_kernel_s0_x, hw_kernel_s0_w, hw_kernel_s0_z] -> [0, 0, 1, hw_kernel_s0_y, 0, hw_kernel_s0_x, 0, hw_kernel_s0_w, 0, hw_kernel_s0_z, 0, 0, 0, 0, 0] : 0 <= hw_kernel_s0_y <= 2 and 0 <= hw_kernel_s0_x <= 2 and 0 <= hw_kernel_s0_w <= 15 and 0 <= hw_kernel_s0_z <= 7 }
// Condition for op_hcompute_hw_kernel_stencil(((i14 == 0) && (i13 == 0) && (i12 == 0) && (i11 == 0) && (i10 == 0) && (i8 == 0) && (i6 == 0) && (i4 == 0) && (-1 + i2 == 0) && (i1 == 0) && (i0 == 0) && (i3 >= 0) && (2 - i3 >= 0) && (i5 >= 0) && (2 - i5 >= 0) && (i7 >= 0) && (15 - i7 >= 0) && (i9 >= 0) && (7 - i9 >= 0)))
