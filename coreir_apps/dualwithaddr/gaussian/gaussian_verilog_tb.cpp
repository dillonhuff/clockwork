...
int main() {
  ofstream fout("regression_result_gaussian_verilog.txt");
  ...
  // Loading input data
  srand(1);
  // cmap    : { op_hcompute_hw_input_stencil[root = 0, hw_input_s0_y, hw_input_s0_x] -> input_copy_stencil[hw_input_s0_x, hw_input_s0_y] : 0 <= hw_input_s0_y <= 63 and 0 <= hw_input_s0_x <= 63 }
  // read map: { input_copy_stencil[i0, i1] -> op_hcompute_hw_input_stencil[root = 0, hw_input_s0_y = i1, hw_input_s0_x = i0] : 0 <= i0 <= 63 and 0 <= i1 <= 63 }
