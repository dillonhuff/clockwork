...
int main() {
  ...
  // read map: { hw_input_stencil[i0, i1, i2, i3] -> op_hcompute_hw_input_global_wrapper_stencil[root = 0, gb_tile = i3, hw_input_global_wrapper_s0_y = i0, hw_input_global_wrapper_s0_x = i1, hw_input_global_wrapper_s0_z = i2] : 0 <= i0 <= 29 and 0 <= i1 <= 29 and 0 <= i2 <= 7 and 0 <= i3 <= 3 }
  // rng     : { op_hcompute_hw_input_global_wrapper_stencil[root = 0, gb_tile, hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x, hw_input_global_wrapper_s0_z] : 0 <= gb_tile <= 3 and 0 <= hw_input_global_wrapper_s0_y <= 29 and 0 <= hw_input_global_wrapper_s0_x <= 29 and 0 <= hw_input_global_wrapper_s0_z <= 7 }
  // rng card: { 28800 }
  ...
  // read map: { hw_kernel_stencil[i0, i1, i2, i3, i4] -> op_hcompute_hw_kernel_global_wrapper_stencil[root = 0, gb_tile = i4, hw_kernel_global_wrapper_s0_y = i0, hw_kernel_global_wrapper_s0_x = i1, hw_kernel_global_wrapper_s0_w = i2, hw_kernel_global_wrapper_s0_z = i3] : 0 <= i0 <= 2 and 0 <= i1 <= 2 and 0 <= i2 <= 2 and 0 <= i3 <= 7 and 0 <= i4 <= 3 }
  // rng     : { op_hcompute_hw_kernel_global_wrapper_stencil[root = 0, gb_tile, hw_kernel_global_wrapper_s0_y, hw_kernel_global_wrapper_s0_x, hw_kernel_global_wrapper_s0_w, hw_kernel_global_wrapper_s0_z] : 0 <= gb_tile <= 3 and 0 <= hw_kernel_global_wrapper_s0_y <= 2 and 0 <= hw_kernel_global_wrapper_s0_x <= 2 and 0 <= hw_kernel_global_wrapper_s0_w <= 2 and 0 <= hw_kernel_global_wrapper_s0_z <= 7 }
  // rng card: { 864 }
  for (int i = 0; i < 864; i++) {
    hw_uint<16 > value;
    set_at<0, 16, 16>(value, rand() % 256);
