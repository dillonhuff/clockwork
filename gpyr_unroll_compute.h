...
hw_uint<16> hcompute_hw_in_global_wrapper_1_stencil(hw_uint<16>& hw_in_stencil) {
  uint16_t _hw_in_stencil_1 = (uint16_t) (hw_in_stencil.extract<0, 15>());

  return _hw_in_stencil_1;
}

hw_uint<16> hcompute_hw_in_global_wrapper_2_stencil(hw_uint<16>& hw_in_stencil) {
  uint16_t _hw_in_stencil_1 = (uint16_t) (hw_in_stencil.extract<0, 15>());

  return _hw_in_stencil_1;
}

hw_uint<16> hcompute_hw_in_global_wrapper_3_stencil(hw_uint<16>& hw_in_stencil) {
  uint16_t _hw_in_stencil_1 = (uint16_t) (hw_in_stencil.extract<0, 15>());
