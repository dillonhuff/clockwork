...
, int root, int br, int bc) {
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_130();
	return value_I_store_I_from_in_2;
}

inline hw_uint<32>  I_warped_0_conv_3_30_6_select(I_store_I_from_in_2_cache& I_store_I_from_in_2_delay
, int root, int br, int bc) {
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_129();
	return value_I_store_I_from_in_2;
}

inline hw_uint<32>  I_warped_0_conv_3_30_7_select(I_store_I_from_in_2_cache& I_store_I_from_in_2_delay
, int root, int br, int bc) {
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_128();
	return value_I_store_I_from_in_2;
}
...
, int root, int ur, int kr, int uc, int kc) {
	hw_uint<32>  value_warped_0_warped_0_conv_3_30_4 = warped_0_warped_0_conv_3_30_4_delay.peek((-1 + kr == 0 && root == 0 && ur >= 0 && 61 - ur >= 0 && uc >= 0 && 60 - uc >= 0 && kc >= 0 && 1 - kc >= 0) ? ((61 - uc)) : 0);
...
// Driver function
void warp_and_upsample(HWStream<hw_uint<32> >& /* get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* get_args num ports = 1 */out) {
