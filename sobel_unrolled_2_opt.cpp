...
struct img_cache {
  // Reader addrs...
    // { mag_x_update_0[d0, d1] -> img[-1 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[-1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[-1 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[1 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[1 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_x_update_0[d0, d1] -> img[2 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[-1 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[-1 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[2 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[2 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[1 + 2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[1 + 2d0, 1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { mag_y_update_0[d0, d1] -> img[2d0, -1 + d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
struct mag_x_cache {
  // Reader addrs...
    // { sobel_unrolled_2_update_0[d0, d1] -> mag_x[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { sobel_unrolled_2_update_0[d0, d1] -> mag_x[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // # of banks: 2
...
struct mag_y_cache {
  // Reader addrs...
    // { sobel_unrolled_2_update_0[d0, d1] -> mag_y[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // { sobel_unrolled_2_update_0[d0, d1] -> mag_y[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // # of banks: 2
...
inline void img_update_0(HWStream<hw_uint<64> >& /* buffer_args num ports = 2 */off_chip_img, img_cache& img, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = id_unrolled_2(off_chip_img_1_m_img_1__p__0_c__1_m_img_0__p__0_value);
	// Produce: img
...
inline void mag_y_update_0(img_cache& img, mag_y_cache& mag_y, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = sobel_my_unrolled_2(img_1_m_mag_y_1__p___m_1_c__1_m_mag_y_0__p___m_1_value);
	// Produce: mag_y
...
inline void mag_x_update_0(img_cache& img, mag_x_cache& mag_x, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = sobel_mx_unrolled_2(img_1_m_mag_x_1__p___m_1_c__1_m_mag_x_0__p___m_1_value);
	// Produce: mag_x
...
inline void sobel_unrolled_2_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<64> >& /* buffer_args num ports = 2 */sobel_unrolled_2, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: mag_x
	auto mag_x_1_m_sobel_unrolled_2_1__p__0_c__1_m_sobel_unrolled_2_0__p__0_value = mag_x_sobel_unrolled_2_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_1_m_sobel_unrolled_2_1__p__0_c__1_m_sobel_unrolled_2_0__p__0_value = mag_y_sobel_unrolled_2_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = mag_cu_unrolled_2(mag_x_1_m_sobel_unrolled_2_1__p__0_c__1_m_sobel_unrolled_2_0__p__0_value, mag_y_1_m_sobel_unrolled_2_1__p__0_c__1_m_sobel_unrolled_2_0__p__0_value);
...
// Condition for img_update_0(((((-1 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((960 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { sobel_unrolled_2_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
// Condition for sobel_unrolled_2_update_0(((((-4 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((960 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
// Condition for mag_y_update_0(((((-2 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((960 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
// Condition for mag_x_update_0(((((-3 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((960 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
...
#ifdef __VIVADO_SYNTH__
  // { img_update_0[root = 0, img_0, img_1] -> off_chip_img[img_1, img_0] : -1 <= img_0 <= 1080 and -1 <= img_1 <= 960 }
const int img_update_0_read_pipe0_num_transfers = 1040884;
  // { sobel_unrolled_2_update_0[root = 0, sobel_unrolled_2_0, sobel_unrolled_2_1] -> sobel_unrolled_2[sobel_unrolled_2_1, sobel_unrolled_2_0] : 0 <= sobel_unrolled_2_0 <= 1079 and 0 <= sobel_unrolled_2_1 <= 959 }
