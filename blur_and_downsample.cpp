	  ...
	  for (int c1 = 0; c1 <= 14; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 >= 7 && c0 <= 12 && c1 >= 7 && c1 <= 12) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_14, I_blr_ds_I_blr_ds_id0_12, 0, c0 - 7, c1 - 7);
	        if (c0 >= 9 && c1 >= 9) {
	          I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_12, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0, 0, c0 - 9, c1 - 9);
