...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_store_I_from_in_12 = I_store_I_from_in_12_delay.peek_31();
	return value_I_store_I_from_in_12;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_store_I_from_in_12 = I_store_I_from_in_12_delay.peek_30();
	return value_I_store_I_from_in_12;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_store_I_from_in_12 = I_store_I_from_in_12_delay.peek_17();
	return value_I_store_I_from_in_12;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_store_I_from_in_12 = I_store_I_from_in_12_delay.peek_16();
	return value_I_store_I_from_in_12;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_store_I_from_in_12 = I_store_I_from_in_12_delay.peek_15();
	return value_I_store_I_from_in_12;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_14();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_13();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_12();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_8();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_7();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_6();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
// Always 0
//	is optimizable constant: 0
	int value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds_I_blr_ds_id0_14_delay.peek_0();
	return value_I_blr_ds_I_blr_ds_id0_14;
}
	  ...
	  for (int c1 = 0; c1 <= 14; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 >= 7 && c0 <= 12 && c1 >= 7 && c1 <= 12) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_2, I_blr_ds_I_blr_ds_id0_14, 0, c0 - 7, c1 - 7);
	        if (c0 >= 9 && c1 >= 9) {
	          I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_14, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16, 0, c0 - 9, c1 - 9);
