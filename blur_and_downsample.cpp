...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_blr_I_blr_conv_3_30_0 = I_blr_I_blr_conv_3_30_0_delay.peek(((-5 + I_blr_ds_r == 0 && root == 0 && I_blr_ds_c >= 0 && 3 - I_blr_ds_c >= 0) ? ((5 - I_blr_ds_c)) : (-4 + I_blr_ds_c == 0 && -5 + I_blr_ds_r == 0 && root == 0) ? (1) : (root == 0 && I_blr_ds_r >= 0 && 3 - I_blr_ds_r >= 0 && I_blr_ds_c >= 0 && 5 - I_blr_ds_c >= 0) ? (((70 - 13 * I_blr_ds_r) - I_blr_ds_c)) : (-4 + I_blr_ds_r == 0 && root == 0 && I_blr_ds_c >= 0 && 5 - I_blr_ds_c >= 0) ? ((18 - I_blr_ds_c)) : 0));
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_14();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_13();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_12();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_8();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_7();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_6();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_2();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_1();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// Always 0
//	is optimizable constant: 0
	int value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds_I_blr_ds_id0_24_delay.peek_0();
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
// Always 0
//	is optimizable constant: 0
	int value_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12 = I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_delay.peek_0();
	  ...
	  for (int c1 = 0; c1 <= 14; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 >= 7 && c0 <= 12 && c1 >= 7 && c1 <= 12) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_0, I_blr_ds_I_blr_ds_id0_24, 0, c0 - 7, c1 - 7);
	        if (c0 >= 9 && c1 >= 9) {
	          I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_24, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12, 0, c0 - 9, c1 - 9);
