...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_14();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_13();
	return value_I_blr_ds_I_blr_ds_id0_12;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_12();
	return value_I_blr_ds_I_blr_ds_id0_12;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_8();
	return value_I_blr_ds_I_blr_ds_id0_12;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_7();
	return value_I_blr_ds_I_blr_ds_id0_12;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_12 = I_blr_ds_I_blr_ds_id0_12_delay.peek_6();
	return value_I_blr_ds_I_blr_ds_id0_12;
}
	  ...
	  for (int c1 = 0; c1 <= 14; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 <= 12 && c1 <= 12 && c0 % 2 == 0 && c1 % 2 == 0) {
	        ...
	        if (c0 >= 6 && c1 >= 6)
	          I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_12, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14, 0, (c0 / 2) - 3, (c1 / 2) - 3);
	      }
