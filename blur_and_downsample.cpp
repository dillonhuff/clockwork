...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_31();
	return value_I_store_I_from_in_2;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_30();
	return value_I_store_I_from_in_2;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_17();
	return value_I_store_I_from_in_2;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_16();
	return value_I_store_I_from_in_2;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_store_I_from_in_2 = I_store_I_from_in_2_delay.peek_15();
	return value_I_store_I_from_in_2;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_8();
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_7();
	return value_I_blr_ds_I_blr_ds_id0_4;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_6();
	return value_I_blr_ds_I_blr_ds_id0_4;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_14();
	return value_I_blr_ds_I_blr_ds_id0_4;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_13();
	return value_I_blr_ds_I_blr_ds_id0_4;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 1
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_4 = I_blr_ds_I_blr_ds_id0_4_delay.peek_12();
	return value_I_blr_ds_I_blr_ds_id0_4;
}
	  ...
	  for (int c1 = 0; c1 <= 14; c1 += 1) {
	    ...
	    if (c0 >= 2 && c1 >= 2) {
	      ...
	      if (c0 <= 12 && c1 <= 12 && c0 % 2 == 0 && c1 % 2 == 0) {
	        I_blr_ds_id0(I_blr_I_blr_conv_3_30_16, I_blr_ds_I_blr_ds_id0_4, 0, (c0 / 2) - 1, (c1 / 2) - 1);
	        if (c0 >= 6 && c1 >= 6)
	      ...
	      if (c0 >= 9 && c0 <= 12 && c1 >= 9 && c1 <= 12)
	        store_I_blr_ds_blr_out_from_I_blr_ds_blr(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6, I_blr_ds_blr_out, 0, c0 - 9, c1 - 9);
	    }
	  }
