...
inline hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_delay
...
inline hw_uint<32> I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_read_bundle_read(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_delay, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15_res = I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_15_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_delay, root, I_blr_ds_blr_ds_out_r, I_blr_ds_blr_ds_out_c);
