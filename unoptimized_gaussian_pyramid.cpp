...
inline void I_store_I_from_in_4_write(hw_uint<32> & I_store_I_from_in_4, I_cache& I) {
...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_cache& I) {
	...
	I_store_I_from_in_4_write(I_store_I_from_in_4_res, I);
}
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds) {
	I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16);
}
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_write(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_16_res, I_blr_ds_blr_ds);
}
