...
inline hw_uint<32>  I_I_blr_conv_3_30_3_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek(((1023 - 32 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_4_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
...
inline hw_uint<288> I_I_blr_conv_3_30_read_bundle_read(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay, int root, int I_blr_r, int I_blr_c) {
	hw_uint<288> result;
	hw_uint<32>  I_I_blr_conv_3_30_3_res = I_I_blr_conv_3_30_3_select(I_store_I_from_in_14_delay, root, I_blr_r, I_blr_c);
	set_at<0, 288>(result, I_I_blr_conv_3_30_3_res);
	hw_uint<32>  I_I_blr_conv_3_30_4_res = I_I_blr_conv_3_30_4_select(I_store_I_from_in_14_delay, root, I_blr_r, I_blr_c);
...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_store_I_from_in_14_cache& I_store_I_from_in_14_delay) {
	...
	I_store_I_from_in_14_write(I_store_I_from_in_14_res, I_store_I_from_in_14_delay);
}
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_delay) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_write(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_res, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_delay);
}
...
inline void I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(compute_result, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0);
}

inline void I_blr_conv_3_30(I_store_I_from_in_14_cache& I_store_I_from_in_14, I_blr_I_blr_conv_3_30_2_cache& I_blr_I_blr_conv_3_30_2, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
...
inline void store_I_from_in(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in, I_store_I_from_in_14_cache& I_store_I_from_in_14, int root, int pr, int pc) {
	// Consume: in
	auto in_pr_c__pc_value = in.read();
	// Produce: I
	I_store_I_from_in_write_bundle_write(in_pr_c__pc_value, I_store_I_from_in_14);
}
...
inline void store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */I_blr_ds_blr_ds_out, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_0;
	{
	  ...
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_14, I_blr_I_blr_conv_3_30_2, 0, c3, c5);
