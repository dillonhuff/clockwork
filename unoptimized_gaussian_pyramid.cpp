...
inline hw_uint<32>  I_I_blr_conv_3_30_15_select(I_store_I_from_in_26_cache& I_store_I_from_in_26_delay
...
inline hw_uint<32>  I_I_blr_conv_3_30_16_select(I_store_I_from_in_26_cache& I_store_I_from_in_26_delay
, int root, int I_blr_r, int I_blr_c) {
...
inline hw_uint<288> I_I_blr_conv_3_30_read_bundle_read(I_store_I_from_in_26_cache& I_store_I_from_in_26_delay, int root, int I_blr_r, int I_blr_c) {
	hw_uint<288> result;
	hw_uint<32>  I_I_blr_conv_3_30_15_res = I_I_blr_conv_3_30_15_select(I_store_I_from_in_26_delay, root, I_blr_r, I_blr_c);
	set_at<0, 288>(result, I_I_blr_conv_3_30_15_res);
	hw_uint<32>  I_I_blr_conv_3_30_16_res = I_I_blr_conv_3_30_16_select(I_store_I_from_in_26_delay, root, I_blr_r, I_blr_c);
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_13_select(I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14_delay
, int root, int I_blr_ds_r, int I_blr_ds_c) {
	hw_uint<32>  value_I_blr_I_blr_conv_3_30_14 = I_blr_I_blr_conv_3_30_14_delay.peek(((899 - 60 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
inline void I_blr_I_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_conv_3_30_write, I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14_delay) {
	...
	I_blr_I_blr_conv_3_30_14_write(I_blr_I_blr_conv_3_30_14_res, I_blr_I_blr_conv_3_30_14_delay);
}
...
inline hw_uint<32> I_blr_I_blr_ds_id0_read_bundle_read(I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14_delay, int root, int I_blr_ds_r, int I_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_I_blr_ds_id0_13_res = I_blr_I_blr_ds_id0_13_select(I_blr_I_blr_conv_3_30_14_delay, root, I_blr_ds_r, I_blr_ds_c);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_1_select(I_blr_ds_I_blr_ds_id0_12_cache& I_blr_ds_I_blr_ds_id0_12_delay
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_2_select(I_blr_ds_I_blr_ds_id0_12_cache& I_blr_ds_I_blr_ds_id0_12_delay
, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
...
inline hw_uint<288> I_blr_ds_I_blr_ds_blr_conv_3_30_read_bundle_read(I_blr_ds_I_blr_ds_id0_12_cache& I_blr_ds_I_blr_ds_id0_12_delay, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	hw_uint<288> result;
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_1_res = I_blr_ds_I_blr_ds_blr_conv_3_30_1_select(I_blr_ds_I_blr_ds_id0_12_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
	set_at<0, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_1_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_2_res = I_blr_ds_I_blr_ds_blr_conv_3_30_2_select(I_blr_ds_I_blr_ds_id0_12_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
...
inline hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_delay
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_delay) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_write(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_res, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_delay);
}
...
inline hw_uint<32> I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_read_bundle_read(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_delay, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_res = I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_delay, root, I_blr_ds_blr_ds_out_r, I_blr_ds_blr_ds_out_c);
...
inline void store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */I_blr_ds_blr_ds_out, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
...
inline void I_blr_ds_id0(I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14, I_blr_ds_I_blr_ds_id0_12_cache& I_blr_ds_I_blr_ds_id0_12, int root, int I_blr_ds_r, int I_blr_ds_c) {
	// Consume: I_blr
...
inline void I_blr_conv_3_30(I_store_I_from_in_26_cache& I_store_I_from_in_26, I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
	...
	// Produce: I_blr
	I_blr_I_blr_conv_3_30_write_bundle_write(compute_result, I_blr_I_blr_conv_3_30_14);
}
...
inline void I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(compute_result, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24);
}
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24;
	{
	  ...
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_26, I_blr_I_blr_conv_3_30_14, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blr_ds_id0(I_blr_I_blr_conv_3_30_14, I_blr_ds_I_blr_ds_id0_12, 0, c3, c5);
