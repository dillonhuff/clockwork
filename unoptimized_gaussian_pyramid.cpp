...
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((1023 - 32 * I_blr_r) - I_blr_c));
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((1022 - 32 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blr_r >= 0 && 29 - I_blr_r >= 0 && I_blr_c >= 0 && 28 - I_blr_c >= 0) ? (((1021 - 32 * I_blr_r) - I_blr_c)) : (-29 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 29 - I_blr_r >= 0) ? ((992 - 32 * I_blr_r)) : 0));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((991 - 32 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((990 - 32 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blr_r >= 0 && 29 - I_blr_r >= 0 && I_blr_c >= 0 && 28 - I_blr_c >= 0) ? (((989 - 32 * I_blr_r) - I_blr_c)) : (-29 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 29 - I_blr_r >= 0) ? ((960 - 32 * I_blr_r)) : 0));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blr_r >= 0 && 28 - I_blr_r >= 0 && I_blr_c >= 0 && 29 - I_blr_c >= 0) ? (((959 - 32 * I_blr_r) - I_blr_c)) : (-29 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 29 - I_blr_c >= 0) ? ((31 - I_blr_c)) : 0));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blr_r >= 0 && 28 - I_blr_r >= 0 && I_blr_c >= 0 && 29 - I_blr_c >= 0) ? (((958 - 32 * I_blr_r) - I_blr_c)) : (-29 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 29 - I_blr_c >= 0) ? ((30 - I_blr_c)) : 0));
	return value_I_store_I_from_in_16;
}
...
// 	is always true on iteration domain: 0
//	is optimizable constant: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blr_r >= 0 && 28 - I_blr_r >= 0 && I_blr_c >= 0 && 28 - I_blr_c >= 0) ? (((957 - 32 * I_blr_r) - I_blr_c)) : (-29 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 28 - I_blr_r >= 0) ? ((928 - 32 * I_blr_r)) : (-29 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 28 - I_blr_c >= 0) ? ((29 - I_blr_c)) : 0));
	return value_I_store_I_from_in_16;
}
