...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_store_I_from_in_16_cache& I_store_I_from_in_16_delay) {
	...
	I_store_I_from_in_16_write(I_store_I_from_in_16_res, I_store_I_from_in_16_delay);
}
...
inline void store_I_from_in(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in, I_store_I_from_in_16_cache& I_store_I_from_in_16, int root, int pr, int pc) {
	// Consume: in
	auto in_pr_c__pc_value = in.read();
	// Produce: I
	I_store_I_from_in_write_bundle_write(in_pr_c__pc_value, I_store_I_from_in_16);
}
