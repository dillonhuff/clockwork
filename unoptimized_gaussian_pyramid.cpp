...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_5_select(I_blr_ds_I_blr_ds_id0_26_cache& I_blr_ds_I_blr_ds_id0_26_delay
, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	hw_uint<32>  value_I_blr_ds_I_blr_ds_id0_26 = I_blr_ds_I_blr_ds_id0_26_delay.peek(((224 - 15 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_26;
}

inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_6_select(I_blr_ds_I_blr_ds_id0_26_cache& I_blr_ds_I_blr_ds_id0_26_delay
, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
...
inline hw_uint<288> I_blr_ds_I_blr_ds_blr_conv_3_30_read_bundle_read(I_blr_ds_I_blr_ds_id0_26_cache& I_blr_ds_I_blr_ds_id0_26_delay, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	hw_uint<288> result;
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_5_res = I_blr_ds_I_blr_ds_blr_conv_3_30_5_select(I_blr_ds_I_blr_ds_id0_26_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
	set_at<0, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_5_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_6_res = I_blr_ds_I_blr_ds_blr_conv_3_30_6_select(I_blr_ds_I_blr_ds_id0_26_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
...
inline void I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_26_cache& I_blr_ds_I_blr_ds_id0_26, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	// Consume: I_blr_ds
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2;
	{
	  ...
	  for (int c3 = 0; c3 <= 12; c3 += 1)
	    for (int c5 = 0; c5 <= 12; c5 += 1)
	      I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_26, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, 0, c3, c5);
