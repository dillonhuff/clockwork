...
inline hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay
...
inline hw_uint<32> I_blr_ds_blr_I_blr_ds_blr_ds_id0_read_bundle_read(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_res = I_blr_ds_blr_I_blr_ds_blr_ds_id0_15_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c);
...
inline void I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14;
	{
	  ...
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
