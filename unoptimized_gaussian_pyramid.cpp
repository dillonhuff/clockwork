...
inline void I_store_I_from_in_16_write(int& I_store_I_from_in_16, I_store_I_from_in_16_cache& I_store_I_from_in_16_delay) {
	I_store_I_from_in_16_delay.push(I_store_I_from_in_16);
}

inline int I_I_blurred_conv_3_30_21_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((1023 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_22_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((1022 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_23_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (((1021 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((992 - 32 * I_blurred_r)) : 0));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_24_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((991 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_25_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((990 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_26_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (((989 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((960 - 32 * I_blurred_r)) : 0));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_27_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 28 - I_blurred_r >= 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? (((959 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_r == 0 && root == 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? ((31 - I_blurred_c)) : 0));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_28_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_16 = I_store_I_from_in_16_delay.peek(((root == 0 && I_blurred_r >= 0 && 28 - I_blurred_r >= 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? (((958 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_r == 0 && root == 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? ((30 - I_blurred_c)) : 0));
	return value_I_store_I_from_in_16;
}

inline int I_I_blurred_conv_3_30_29_select(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay
, int root, int I_blurred_r, int I_blurred_c) {
// Pieces...
...
inline hw_uint<288> I_I_blurred_conv_3_30_read_bundle_read(I_store_I_from_in_16_cache& I_store_I_from_in_16_delay, int root, int I_blurred_r, int I_blurred_c) {
	hw_uint<288> result;
	int I_I_blurred_conv_3_30_21_res = I_I_blurred_conv_3_30_21_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<0, 288>(result, I_I_blurred_conv_3_30_21_res);
	int I_I_blurred_conv_3_30_22_res = I_I_blurred_conv_3_30_22_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<32, 288>(result, I_I_blurred_conv_3_30_22_res);
	int I_I_blurred_conv_3_30_23_res = I_I_blurred_conv_3_30_23_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<64, 288>(result, I_I_blurred_conv_3_30_23_res);
	int I_I_blurred_conv_3_30_24_res = I_I_blurred_conv_3_30_24_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<96, 288>(result, I_I_blurred_conv_3_30_24_res);
	int I_I_blurred_conv_3_30_25_res = I_I_blurred_conv_3_30_25_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<128, 288>(result, I_I_blurred_conv_3_30_25_res);
	int I_I_blurred_conv_3_30_26_res = I_I_blurred_conv_3_30_26_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<160, 288>(result, I_I_blurred_conv_3_30_26_res);
	int I_I_blurred_conv_3_30_27_res = I_I_blurred_conv_3_30_27_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<192, 288>(result, I_I_blurred_conv_3_30_27_res);
	int I_I_blurred_conv_3_30_28_res = I_I_blurred_conv_3_30_28_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
	set_at<224, 288>(result, I_I_blurred_conv_3_30_28_res);
	int I_I_blurred_conv_3_30_29_res = I_I_blurred_conv_3_30_29_select(I_store_I_from_in_16_delay, root, I_blurred_r, I_blurred_c);
...
inline void I_store_I_from_in_write_bundle_write(int& /* width = 32*/store_I_from_in_write, I_store_I_from_in_16_cache& I_store_I_from_in_16_delay) {
...
inline int I_blurred_I_blurred_downsampled_id0_19_select(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20_delay
...
// 	is always true on iteration domain: 1
	int value_I_blurred_I_blurred_conv_3_30_20 = I_blurred_I_blurred_conv_3_30_20_delay.peek(((899 - 60 * I_blurred_downsampled_r) - 2 * I_blurred_downsampled_c));
...
//	I_blurred_I_blurred_downsampled_id0_19
inline int I_blurred_I_blurred_downsampled_id0_read_bundle_read(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20_delay, int root, int I_blurred_downsampled_r, int I_blurred_downsampled_c) {
	int result;
	int I_blurred_I_blurred_downsampled_id0_19_res = I_blurred_I_blurred_downsampled_id0_19_select(I_blurred_I_blurred_conv_3_30_20_delay, root, I_blurred_downsampled_r, I_blurred_downsampled_c);
	set_at<0, 32>(result, I_blurred_I_blurred_downsampled_id0_19_res);
	return result;
}
...
struct I_blurred_downsampled_I_blurred_downsampled_id0_18_cache {
	// Capacity: 225
	fifo<int, 225> f;
	inline int peek(const int offset) {
...
inline void I_blurred_downsampled_I_blurred_downsampled_id0_18_write(int& I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay) {
	I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.push(I_blurred_downsampled_I_blurred_downsampled_id0_18);
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_10_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
...
// 	is always true on iteration domain: 0
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((root == 0 && I_blurred_downsampled_blurred_r >= 0 && 11 - I_blurred_downsampled_blurred_r >= 0 && I_blurred_downsampled_blurred_c >= 0 && 12 - I_blurred_downsampled_blurred_c >= 0) ? (((193 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c)) : (-12 + I_blurred_downsampled_blurred_r == 0 && root == 0 && I_blurred_downsampled_blurred_c >= 0 && 12 - I_blurred_downsampled_blurred_c >= 0) ? ((13 - I_blurred_downsampled_blurred_c)) : 0));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_11_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
...
inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_3_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((224 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_4_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
// { I_blurred_downsampled_blurred_conv_3_30[root = 0, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] : 0 <= I_blurred_downsampled_blurred_r <= 12 and 0 <= I_blurred_downsampled_blurred_c <= 12 } -> { I_blurred_downsampled_blurred_conv_3_30[root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] -> ((223 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c) }
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((223 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_5_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
...
// 	is always true on iteration domain: 0
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((root == 0 && I_blurred_downsampled_blurred_r >= 0 && 12 - I_blurred_downsampled_blurred_r >= 0 && I_blurred_downsampled_blurred_c >= 0 && 11 - I_blurred_downsampled_blurred_c >= 0) ? (((222 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c)) : (-12 + I_blurred_downsampled_blurred_c == 0 && root == 0 && I_blurred_downsampled_blurred_r >= 0 && 12 - I_blurred_downsampled_blurred_r >= 0) ? ((210 - 15 * I_blurred_downsampled_blurred_r)) : 0));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_6_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
// { I_blurred_downsampled_blurred_conv_3_30[root = 0, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] : 0 <= I_blurred_downsampled_blurred_r <= 12 and 0 <= I_blurred_downsampled_blurred_c <= 12 } -> { I_blurred_downsampled_blurred_conv_3_30[root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] -> ((209 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c) }
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((209 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_7_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
// { I_blurred_downsampled_blurred_conv_3_30[root = 0, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] : 0 <= I_blurred_downsampled_blurred_r <= 12 and 0 <= I_blurred_downsampled_blurred_c <= 12 } -> { I_blurred_downsampled_blurred_conv_3_30[root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c] -> ((208 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c) }
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_18 = I_blurred_downsampled_I_blurred_downsampled_id0_18_delay.peek(((208 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_18;
}

inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_8_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
...
inline int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_9_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
// Pieces...
...
inline int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_1_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay
...
inline hw_uint<288> I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_read_bundle_read(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
	hw_uint<288> result;
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_3_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_3_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<0, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_3_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_4_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_4_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<32, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_4_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_5_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_5_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<64, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_5_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_6_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_6_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<96, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_6_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_7_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_7_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<128, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_7_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_8_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_8_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<160, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_8_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_9_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_9_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<192, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_9_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_10_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_10_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<224, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_10_res);
	int I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_11_res = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_11_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
	set_at<256, 288>(result, I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_11_res);
	return result;
}

// I_blurred_downsampled_id0_write
//	I_blurred_downsampled_I_blurred_downsampled_id0_18
inline void I_blurred_downsampled_I_blurred_downsampled_id0_write_bundle_write(int& /* width = 32*/I_blurred_downsampled_id0_write, I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay) {
	I_blurred_downsampled_I_blurred_downsampled_id0_18_write(I_blurred_downsampled_id0_write, I_blurred_downsampled_I_blurred_downsampled_id0_18_delay);
}
...
inline int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_read_bundle_read(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, int root, int I_blurred_downsampled_out_r, int I_blurred_downsampled_out_c) {
	int result;
	int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_1_res = I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_1_select(I_blurred_downsampled_I_blurred_downsampled_id0_18_delay, root, I_blurred_downsampled_out_r, I_blurred_downsampled_out_c);
...
struct I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache {
	// Capacity: 169
	fifo<int, 169> f;
	inline int peek(const int offset) {
...
inline void I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_write(int& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay) {
	I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay.push(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2);
}

inline int I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_downsampled_id0_13_select(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2 = I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay.peek(((168 - 26 * I_blurred_downsampled_blurred_downsampled_r) - 2 * I_blurred_downsampled_blurred_downsampled_c));
	return value_I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2;
}

// Bundles...
// I_blurred_downsampled_blurred_conv_3_30_write
//	I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2
inline void I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_write_bundle_write(int& /* width = 32*/I_blurred_downsampled_blurred_conv_3_30_write, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay) {
	I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_write(I_blurred_downsampled_blurred_conv_3_30_write, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay);
}
...
inline int I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_downsampled_id0_read_bundle_read(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay, int root, int I_blurred_downsampled_blurred_downsampled_r, int I_blurred_downsampled_blurred_downsampled_c) {
	int result;
	int I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_downsampled_id0_13_res = I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_downsampled_id0_13_select(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_delay, root, I_blurred_downsampled_blurred_downsampled_r, I_blurred_downsampled_blurred_downsampled_c);
...
//	I_blurred_downsampled_blurred_downsampled_store_I_blurred_downsampled_blurred_downsampled_out_from_I_blurred_downsampled_blurred_downsampled_15
inline int I_blurred_downsampled_blurred_downsampled_store_I_blurred_downsampled_blurred_downsampled_out_from_I_blurred_downsampled_blurred_downsampled_read_bundle_read(I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12_cache& I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12_delay, int root, int I_blurred_downsampled_blurred_downsampled_out_r, int I_blurred_downsampled_blurred_downsampled_out_c) {
	int result;
	int I_blurred_downsampled_blurred_downsampled_store_I_blurred_downsampled_blurred_downsampled_out_from_I_blurred_downsampled_blurred_downsampled_15_res = I_blurred_downsampled_blurred_downsampled_store_I_blurred_downsampled_blurred_downsampled_out_from_I_blurred_downsampled_blurred_downsampled_15_select(I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12_delay, root, I_blurred_downsampled_blurred_downsampled_out_r, I_blurred_downsampled_blurred_downsampled_out_c);
	set_at<0, 32>(result, I_blurred_downsampled_blurred_downsampled_store_I_blurred_downsampled_blurred_downsampled_out_from_I_blurred_downsampled_blurred_downsampled_15_res);
	return result;
}
...
// Operation logic
inline void store_I_blurred_downsampled_out_from_I_blurred_downsampled(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18, HWStream<int>& I_blurred_downsampled_out, int root, int I_blurred_downsampled_out_r, int I_blurred_downsampled_out_c) {
	// Consume: I_blurred_downsampled
	auto I_blurred_downsampled_I_blurred_downsampled_out_r_c__I_blurred_downsampled_out_c_value = I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_read_bundle_read(I_blurred_downsampled_I_blurred_downsampled_id0_18/* source_delay */, root, I_blurred_downsampled_out_r, I_blurred_downsampled_out_c);
...
inline void I_blurred_downsampled_blurred_conv_3_30(I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, int root, int I_blurred_downsampled_blurred_r, int I_blurred_downsampled_blurred_c) {
	// Consume: I_blurred_downsampled
	auto I_blurred_downsampled_I_blurred_downsampled_blurred_r__p__0_c__I_blurred_downsampled_blurred_c__p__0_value = I_blurred_downsampled_I_blurred_downsampled_blurred_conv_3_30_read_bundle_read(I_blurred_downsampled_I_blurred_downsampled_id0_18/* source_delay */, root, I_blurred_downsampled_blurred_r, I_blurred_downsampled_blurred_c);
...
inline void store_I_from_in(HWStream<int>& in, I_store_I_from_in_16_cache& I_store_I_from_in_16, int root, int pr, int pc) {
	// Consume: in
...
inline void I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_18_cache& I_blurred_downsampled_I_blurred_downsampled_id0_18, int root, int I_blurred_downsampled_r, int I_blurred_downsampled_c) {
	// Consume: I_blurred
	...
	// Possible ports...
		// I_blurred_downsampled_I_blurred_downsampled_id0_18
	I_blurred_downsampled_I_blurred_downsampled_id0_write_bundle_write(compute_result, I_blurred_downsampled_I_blurred_downsampled_id0_18 /* output src_delay */);
}

inline void I_blurred_conv_3_30(I_store_I_from_in_16_cache& I_store_I_from_in_16, I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20, int root, int I_blurred_r, int I_blurred_c) {
	// Consume: I
	auto I_I_blurred_r__p__0_c__I_blurred_c__p__0_value = I_I_blurred_conv_3_30_read_bundle_read(I_store_I_from_in_16/* source_delay */, root, I_blurred_r, I_blurred_c);
	// Apply function: conv_3_3
...
void unoptimized_gaussian_pyramid(HWStream<int>& in, HWStream<int>& I_blurred_downsampled_blurred_downsampled_out, HWStream<int>& I_blurred_downsampled_out) {
	...
	I_blurred_downsampled_I_blurred_downsampled_id0_18_cache I_blurred_downsampled_I_blurred_downsampled_id0_18;
	I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2_cache I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2;
	I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12_cache I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12;
	{
	  for (int c3 = 0; c3 <= 31; c3 += 1)
	    for (int c5 = 0; c5 <= 31; c5 += 1)
	      store_I_from_in(in, I_store_I_from_in_16, 0, c3, c5);
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blurred_conv_3_30(I_store_I_from_in_16, I_blurred_I_blurred_conv_3_30_20, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_18, 0, c3, c5);
	  for (int c3 = 0; c3 <= 12; c3 += 1)
	    for (int c5 = 0; c5 <= 12; c5 += 1)
	      I_blurred_downsampled_blurred_conv_3_30(I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blurred_downsampled_blurred_downsampled_id0(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_2, I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      store_I_blurred_downsampled_out_from_I_blurred_downsampled(I_blurred_downsampled_I_blurred_downsampled_id0_18, I_blurred_downsampled_out, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
