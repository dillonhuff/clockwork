...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((1023 - 32 * I_blurred_r) - I_blurred_c));
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((1022 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (((1021 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((992 - 32 * I_blurred_r)) : 0));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((991 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 1
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((990 - 32 * I_blurred_r) - I_blurred_c));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0 && I_blurred_c >= 0 && 28 - I_blurred_c >= 0) ? (((989 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_c == 0 && root == 0 && I_blurred_r >= 0 && 29 - I_blurred_r >= 0) ? ((960 - 32 * I_blurred_r)) : 0));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((root == 0 && I_blurred_r >= 0 && 28 - I_blurred_r >= 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? (((959 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_r == 0 && root == 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? ((31 - I_blurred_c)) : 0));
	return value_I_store_I_from_in_18;
}
...
// 	is always true on iteration domain: 0
	int value_I_store_I_from_in_18 = I_store_I_from_in_18_delay.peek(((root == 0 && I_blurred_r >= 0 && 28 - I_blurred_r >= 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? (((958 - 32 * I_blurred_r) - I_blurred_c)) : (-29 + I_blurred_r == 0 && root == 0 && I_blurred_c >= 0 && 29 - I_blurred_c >= 0) ? ((30 - I_blurred_c)) : 0));
	return value_I_store_I_from_in_18;
}
...
inline int I_blurred_I_blurred_downsampled_id0_11_select(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20_delay
...
inline int I_blurred_I_blurred_downsampled_id0_read_bundle_read(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20_delay, int root, int I_blurred_downsampled_r, int I_blurred_downsampled_c) {
	int result;
	int I_blurred_I_blurred_downsampled_id0_11_res = I_blurred_I_blurred_downsampled_id0_11_select(I_blurred_I_blurred_conv_3_30_20_delay, root, I_blurred_downsampled_r, I_blurred_downsampled_c);
...
inline int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_15_select(I_blurred_downsampled_I_blurred_downsampled_id0_10_cache& I_blurred_downsampled_I_blurred_downsampled_id0_10_delay
...
inline int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_read_bundle_read(I_blurred_downsampled_I_blurred_downsampled_id0_10_cache& I_blurred_downsampled_I_blurred_downsampled_id0_10_delay, int root, int I_blurred_downsampled_out_r, int I_blurred_downsampled_out_c) {
	int result;
	int I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_15_res = I_blurred_downsampled_store_I_blurred_downsampled_out_from_I_blurred_downsampled_15_select(I_blurred_downsampled_I_blurred_downsampled_id0_10_delay, root, I_blurred_downsampled_out_r, I_blurred_downsampled_out_c);
...
inline int I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_downsampled_id0_13_select(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_0_cache& I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_0_delay
...
inline void I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20_cache& I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_10_cache& I_blurred_downsampled_I_blurred_downsampled_id0_10, int root, int I_blurred_downsampled_r, int I_blurred_downsampled_c) {
	// Consume: I_blurred
	...
	I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12_cache I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12;
	{
	  for (int c3 = 0; c3 <= 31; c3 += 1)
	    for (int c5 = 0; c5 <= 31; c5 += 1)
	      store_I_from_in(in, I_store_I_from_in_18, 0, c3, c5);
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blurred_conv_3_30(I_store_I_from_in_18, I_blurred_I_blurred_conv_3_30_20, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_10, 0, c3, c5);
	  ...
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blurred_downsampled_blurred_downsampled_id0(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_0, I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_12, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
