...
inline hw_uint<32>  I_I_blr_conv_3_30_15_select(I_store_I_from_in_2_cache& I_store_I_from_in_2_delay
...
inline hw_uint<32>  I_I_blr_conv_3_30_16_select(I_store_I_from_in_2_cache& I_store_I_from_in_2_delay
, int root, int I_blr_r, int I_blr_c) {
// Pieces...
...
inline hw_uint<288> I_I_blr_conv_3_30_read_bundle_read(I_store_I_from_in_2_cache& I_store_I_from_in_2_delay, int root, int I_blr_r, int I_blr_c) {
	hw_uint<288> result;
	hw_uint<32>  I_I_blr_conv_3_30_15_res = I_I_blr_conv_3_30_15_select(I_store_I_from_in_2_delay, root, I_blr_r, I_blr_c);
	set_at<0, 288>(result, I_I_blr_conv_3_30_15_res);
	hw_uint<32>  I_I_blr_conv_3_30_16_res = I_I_blr_conv_3_30_16_select(I_store_I_from_in_2_delay, root, I_blr_r, I_blr_c);
...
inline hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_25_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay
...
inline hw_uint<32> I_blr_ds_blr_I_blr_ds_blr_ds_id0_read_bundle_read(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_25_res = I_blr_ds_blr_I_blr_ds_blr_ds_id0_25_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_delay, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c);
...
inline void I_blr_conv_3_30(I_store_I_from_in_2_cache& I_store_I_from_in_2, I_blr_I_blr_conv_3_30_14_cache& I_blr_I_blr_conv_3_30_14, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
...
inline void I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24;
	{
	  ...
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_2, I_blr_I_blr_conv_3_30_14, 0, c3, c5);
	  ...
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_4, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_24, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
