...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_0 = I_blurred_downsampled_I_blurred_downsampled_id0_0_delay.peek(((224 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_0;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_0 = I_blurred_downsampled_I_blurred_downsampled_id0_0_delay.peek(((223 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_0;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_0 = I_blurred_downsampled_I_blurred_downsampled_id0_0_delay.peek(((209 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_0;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_I_blurred_downsampled_id0_0 = I_blurred_downsampled_I_blurred_downsampled_id0_0_delay.peek(((208 - 15 * I_blurred_downsampled_blurred_r) - I_blurred_downsampled_blurred_c));
	return value_I_blurred_downsampled_I_blurred_downsampled_id0_0;
}
...
// 	is always true on iteration domain: 1
	int value_I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_4 = I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_4_delay.peek(((168 - 26 * I_blurred_downsampled_blurred_downsampled_r) - 2 * I_blurred_downsampled_blurred_downsampled_c));
	...
	I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_14_cache I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_14;
	{
	  ...
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blurred_downsampled_id0(I_blurred_I_blurred_conv_3_30_20, I_blurred_downsampled_I_blurred_downsampled_id0_0, 0, c3, c5);
	  for (int c3 = 0; c3 <= 12; c3 += 1)
	    for (int c5 = 0; c5 <= 12; c5 += 1)
	      I_blurred_downsampled_blurred_conv_3_30(I_blurred_downsampled_I_blurred_downsampled_id0_0, I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_4, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blurred_downsampled_blurred_downsampled_id0(I_blurred_downsampled_blurred_I_blurred_downsampled_blurred_conv_3_30_4, I_blurred_downsampled_blurred_downsampled_I_blurred_downsampled_blurred_downsampled_id0_14, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      store_I_blurred_downsampled_out_from_I_blurred_downsampled(I_blurred_downsampled_I_blurred_downsampled_id0_0, I_blurred_downsampled_out, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
