...
inline hw_uint<32>  I_I_blr_conv_3_30_26_select(I_store_I_from_in_4_cache& I_store_I_from_in_4_delay
, int root, int I_blr_r, int I_blr_c) {
// Pieces...
...
inline hw_uint<32>  I_I_blr_conv_3_30_27_select(I_store_I_from_in_4_cache& I_store_I_from_in_4_delay
, int root, int I_blr_r, int I_blr_c) {
// Pieces...
...
inline hw_uint<288> I_I_blr_conv_3_30_read_bundle_read(I_store_I_from_in_4_cache& I_store_I_from_in_4_delay, int root, int I_blr_r, int I_blr_c) {
	...
	hw_uint<32>  I_I_blr_conv_3_30_26_res = I_I_blr_conv_3_30_26_select(I_store_I_from_in_4_delay, root, I_blr_r, I_blr_c);
	set_at<224, 288>(result, I_I_blr_conv_3_30_26_res);
	hw_uint<32>  I_I_blr_conv_3_30_27_res = I_I_blr_conv_3_30_27_select(I_store_I_from_in_4_delay, root, I_blr_r, I_blr_c);
...
//	I_store_I_from_in_4
inline void I_store_I_from_in_write_bundle_write(hw_uint<32> & /* width = 32*/store_I_from_in_write, I_store_I_from_in_4_cache& I_store_I_from_in_4_delay) {
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 0
	int value_I_blr_I_blr_conv_3_30_18 = I_blr_I_blr_conv_3_30_18_delay.peek(((899 - 60 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
// 	is always true on iteration domain: 1
//	is optimizable constant: 0
	int value_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6 = I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_delay.peek(((168 - 26 * I_blr_ds_blr_ds_r) - 2 * I_blr_ds_blr_ds_c));
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32> & /* width = 32*/I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_delay) {
...
inline void I_blr_conv_3_30(I_store_I_from_in_4_cache& I_store_I_from_in_4, I_blr_I_blr_conv_3_30_18_cache& I_blr_I_blr_conv_3_30_18, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_2;
	{
	  ...
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_4, I_blr_I_blr_conv_3_30_18, 0, c3, c5);
