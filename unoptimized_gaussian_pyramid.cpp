...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32> & /* width = 32*/store_I_from_in_write, I_store_I_from_in_26_cache& I_store_I_from_in_26_delay) {
...
inline hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_delay
...
inline hw_uint<32> I_blr_ds_blr_I_blr_ds_blr_ds_id0_read_bundle_read(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_delay, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_res = I_blr_ds_blr_I_blr_ds_blr_ds_id0_11_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_delay, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c);
...
inline hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_delay
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32> & /* width = 32*/I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_delay) {
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_write(I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_delay);
}
...
inline hw_uint<32> I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_read_bundle_read(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_delay, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25_res = I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_25_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_delay, root, I_blr_ds_blr_ds_out_r, I_blr_ds_blr_ds_out_c);
...
inline void I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	...
	// Possible ports...
		// I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(compute_result, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10 /* output src_delay */);
}
...
inline void store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10, HWStream<hw_uint<32>  >& I_blr_ds_blr_ds_out, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10;
	{
	  ...
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blr_ds_blr_ds_id0(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_14, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_10, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
