...
inline hw_uint<32>  I_blr_I_blr_ds_id0_13_select(I_blr_I_blr_conv_3_30_18_cache& I_blr_I_blr_conv_3_30_18_delay
...
inline hw_uint<32> I_blr_I_blr_ds_id0_read_bundle_read(I_blr_I_blr_conv_3_30_18_cache& I_blr_I_blr_conv_3_30_18_delay, int root, int I_blr_ds_r, int I_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_I_blr_ds_id0_13_res = I_blr_I_blr_ds_id0_13_select(I_blr_I_blr_conv_3_30_18_delay, root, I_blr_ds_r, I_blr_ds_c);
...
inline hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_delay
...
inline hw_uint<32> I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_read_bundle_read(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_delay, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_res = I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_11_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_delay, root, I_blr_ds_blr_ds_out_r, I_blr_ds_blr_ds_out_c);
...
inline void I_blr_ds_id0(I_blr_I_blr_conv_3_30_18_cache& I_blr_I_blr_conv_3_30_18, I_blr_ds_I_blr_ds_id0_12_cache& I_blr_ds_I_blr_ds_id0_12, int root, int I_blr_ds_r, int I_blr_ds_c) {
	// Consume: I_blr
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_14;
	{
	  ...
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blr_ds_id0(I_blr_I_blr_conv_3_30_18, I_blr_ds_I_blr_ds_id0_12, 0, c3, c5);
