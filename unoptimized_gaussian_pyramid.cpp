...
inline void I_store_I_from_in_26_write(hw_uint<32> & I_store_I_from_in_26, I_cache& I) {
...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32>& store_I_from_in_write, I_cache& I) {
	...
	I_store_I_from_in_26_write(I_store_I_from_in_26_res, I);
}
...
inline void I_blr_I_blr_conv_3_30_0_write(hw_uint<32> & I_blr_I_blr_conv_3_30_0, I_blr_cache& I_blr) {
...
inline void I_blr_I_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_conv_3_30_write, I_blr_cache& I_blr) {
	...
	I_blr_I_blr_conv_3_30_0_write(I_blr_I_blr_conv_3_30_0_res, I_blr);
}
...
inline void I_blr_ds_I_blr_ds_id0_20_write(hw_uint<32> & I_blr_ds_I_blr_ds_id0_20, I_blr_ds_cache& I_blr_ds) {
...
inline void I_blr_ds_I_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_id0_write, I_blr_ds_cache& I_blr_ds) {
	...
	I_blr_ds_I_blr_ds_id0_20_write(I_blr_ds_I_blr_ds_id0_20_res, I_blr_ds);
}
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10, I_blr_ds_blr_cache& I_blr_ds_blr) {
	I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10);
}

inline hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_23_select(I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
  // qpd = { I_blr_ds_blr_ds_id0[root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c] -> ((168 - 26 * I_blr_ds_blr_ds_r) - 2 * I_blr_ds_blr_ds_c) : root = 0 and 0 <= I_blr_ds_blr_ds_r <= 5 and 0 <= I_blr_ds_blr_ds_c <= 5 }
	hw_uint<32>  value_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10 = I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10.peek(/* is one piece but not a number */((168 - 26 * I_blr_ds_blr_ds_r) - 2 * I_blr_ds_blr_ds_c));
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_ds_blr_conv_3_30_write, I_blr_ds_blr_cache& I_blr_ds_blr) {
	...
	I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10_write(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_10_res, I_blr_ds_blr);
}
...
inline hw_uint<32> I_blr_ds_blr_I_blr_ds_blr_ds_id0_read_bundle_read(I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_ds_r, int I_blr_ds_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_I_blr_ds_blr_ds_id0_23_res = I_blr_ds_blr_I_blr_ds_blr_ds_id0_23_select(I_blr_ds_blr, root, I_blr_ds_blr_ds_r, I_blr_ds_blr_ds_c);
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_write(hw_uint<32> & I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds) {
	I_blr_ds_blr_ds.I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22.push(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22);
}
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32>& I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_cache& I_blr_ds_blr_ds) {
	hw_uint<32>  I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_res = I_blr_ds_blr_ds_id0_write.extract<0, 31>();
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_write(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_22_res, I_blr_ds_blr_ds);
}
