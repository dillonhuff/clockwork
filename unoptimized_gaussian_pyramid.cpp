...
inline void I_blr_I_blr_conv_3_30_write_bundle_write(hw_uint<32> & /* width = 32*/I_blr_conv_3_30_write, I_blr_I_blr_conv_3_30_6_cache& I_blr_I_blr_conv_3_30_6_delay) {
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_26_select(I_blr_ds_I_blr_ds_id0_2_cache& I_blr_ds_I_blr_ds_id0_2_delay
, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_27_select(I_blr_ds_I_blr_ds_id0_2_cache& I_blr_ds_I_blr_ds_id0_2_delay
, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
...
inline hw_uint<288> I_blr_ds_I_blr_ds_blr_conv_3_30_read_bundle_read(I_blr_ds_I_blr_ds_id0_2_cache& I_blr_ds_I_blr_ds_id0_2_delay, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	...
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_26_res = I_blr_ds_I_blr_ds_blr_conv_3_30_26_select(I_blr_ds_I_blr_ds_id0_2_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
	set_at<224, 288>(result, I_blr_ds_I_blr_ds_blr_conv_3_30_26_res);
	hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_27_res = I_blr_ds_I_blr_ds_blr_conv_3_30_27_select(I_blr_ds_I_blr_ds_id0_2_delay, root, I_blr_ds_blr_r, I_blr_ds_blr_c);
...
inline hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_17_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_delay
...
inline void I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_write_bundle_write(hw_uint<32> & /* width = 32*/I_blr_ds_blr_ds_id0_write, I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_delay) {
...
inline hw_uint<32> I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_read_bundle_read(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_cache& I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_delay, int root, int I_blr_ds_blr_ds_out_r, int I_blr_ds_blr_ds_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_17_res = I_blr_ds_blr_ds_store_I_blr_ds_blr_ds_out_from_I_blr_ds_blr_ds_17_select(I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_delay, root, I_blr_ds_blr_ds_out_r, I_blr_ds_blr_ds_out_c);
...
inline void I_blr_conv_3_30(I_store_I_from_in_0_cache& I_store_I_from_in_0, I_blr_I_blr_conv_3_30_6_cache& I_blr_I_blr_conv_3_30_6, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
...
inline void I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_2_cache& I_blr_ds_I_blr_ds_id0_2, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
	// Consume: I_blr_ds
	...
	I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4_cache I_blr_ds_blr_ds_I_blr_ds_blr_ds_id0_4;
	{
	  ...
	  for (int c3 = 0; c3 <= 29; c3 += 1)
	    for (int c5 = 0; c5 <= 29; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_0, I_blr_I_blr_conv_3_30_6, 0, c3, c5);
	  for (int c3 = 0; c3 <= 14; c3 += 1)
	    for (int c5 = 0; c5 <= 14; c5 += 1)
	      I_blr_ds_id0(I_blr_I_blr_conv_3_30_6, I_blr_ds_I_blr_ds_id0_2, 0, c3, c5);
	  for (int c3 = 0; c3 <= 12; c3 += 1)
	    for (int c5 = 0; c5 <= 12; c5 += 1)
	      I_blr_ds_blr_conv_3_30(I_blr_ds_I_blr_ds_id0_2, I_blr_ds_blr_I_blr_ds_blr_conv_3_30_18, 0, c3, c5);
