...
inline hw_uint<32>  I_blr_I_blr_ds_id0_1_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  // qpd = { I_blr_ds_id0[root, I_blr_ds_r, I_blr_ds_c] -> ((899 - 60 * I_blr_ds_r) - 2 * I_blr_ds_c) : root = 0 and 0 <= I_blr_ds_r <= 14 and 0 <= I_blr_ds_c <= 14 }
	hw_uint<32>  value_I_blr_I_blr_conv_3_30_14 = I_blr.I_blr_I_blr_conv_3_30_14.peek(/* is one piece but not a number */((899 - 60 * I_blr_ds_r) - 2 * I_blr_ds_c));
