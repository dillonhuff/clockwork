...
struct mag_x_cache {
  // Reader addrs...
    // { sobel_unrolled_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
struct mag_y_cache {
  // Reader addrs...
    // { sobel_unrolled_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
inline void img_update_0(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */off_chip_img, img_cache& img, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = id_unrolled_1(off_chip_img_1_m_img_1__p__0_c__1_m_img_0__p__0_value);
	// Produce: img
...
inline void mag_y_update_0(img_cache& img, mag_y_cache& mag_y, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = sobel_my_unrolled_1(img_1_m_mag_y_1__p___m_1_c__1_m_mag_y_0__p___m_1_value);
	// Produce: mag_y
...
inline void mag_x_update_0(img_cache& img, mag_x_cache& mag_x, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = sobel_mx_unrolled_1(img_1_m_mag_x_1__p___m_1_c__1_m_mag_x_0__p___m_1_value);
	// Produce: mag_x
...
inline void sobel_unrolled_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */sobel_unrolled_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: mag_x
	auto mag_x_1_m_sobel_unrolled_1_1__p__0_c__1_m_sobel_unrolled_1_0__p__0_value = mag_x_sobel_unrolled_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_1_m_sobel_unrolled_1_1__p__0_c__1_m_sobel_unrolled_1_0__p__0_value = mag_y_sobel_unrolled_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = mag_cu_unrolled_1(mag_x_1_m_sobel_unrolled_1_1__p__0_c__1_m_sobel_unrolled_1_0__p__0_value, mag_y_1_m_sobel_unrolled_1_1__p__0_c__1_m_sobel_unrolled_1_0__p__0_value);
...
// Condition for sobel_unrolled_1_update_0(((((-4 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1920 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
...
const int img_update_0_read_pipe0_num_transfers = 2079604;
  // { sobel_unrolled_1_update_0[root = 0, sobel_unrolled_1_0, sobel_unrolled_1_1] -> sobel_unrolled_1[sobel_unrolled_1_1, sobel_unrolled_1_0] : 0 <= sobel_unrolled_1_0 <= 1079 and 0 <= sobel_unrolled_1_1 <= 1919 }
