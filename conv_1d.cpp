...
// Operation logic
inline void get_input(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in, M_get_input_0_cache& M_get_input_0, int root, int p) {
	// Consume: in
...
inline void compute_output(M_get_input_0_cache& M_get_input_0, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out, int root, int c) {
	// Consume: M
