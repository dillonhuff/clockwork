...
// Operation logic
inline void compute_output(M_get_input_4_cache& M_get_input_4, HWStream<hw_uint<32> >& /* num ports = 1 */out, int root, int c) {
	// Consume: M
...
inline void get_input(HWStream<hw_uint<32> >& /* num ports = 1 */in, M_get_input_4_cache& M_get_input_4, int root, int p) {
	// Consume: in
