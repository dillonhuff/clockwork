...
// get_input_write
//	M_get_input_4
inline void M_get_input_write_bundle_write(hw_uint<32> & /* width = 32*/get_input_write, M_get_input_4_cache& M_get_input_4_delay) {
...
// Operation logic
inline void compute_output(M_get_input_4_cache& M_get_input_4, HWStream<hw_uint<32>  >& out, int root, int c) {
	// Consume: M
...
inline void get_input(HWStream<hw_uint<32>  >& in, M_get_input_4_cache& M_get_input_4, int root, int p) {
	// Consume: in
