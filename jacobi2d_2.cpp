...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_10_select(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6_delay
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_9_select(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6_delay
, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14_delay
, int root, int d1, int d0) {
	// lexmax events: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> store_I_from_in_1[root' = 0, id1 = 1 + d1, id0 = -1 + d0] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	bool select_store_I_from_in_1 = ((/* constraint: { out_0_jacobi2d_compute0[root, d1, d0] : root = 0 } */
...
inline hw_uint<160> I_out_0_jacobi2d_compute0_read_bundle_read(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_0_jacobi2d_compute0_9_res = I_out_0_jacobi2d_compute0_9_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_0_jacobi2d_compute0_9_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_10_res = I_out_0_jacobi2d_compute0_10_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_0_jacobi2d_compute0_10_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_11_res = I_out_0_jacobi2d_compute0_11_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_0_jacobi2d_compute0_11_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_12_res = I_out_0_jacobi2d_compute0_12_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_0_jacobi2d_compute0_12_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_13_res = I_out_0_jacobi2d_compute0_13_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
...
inline hw_uint<160> I_out_1_jacobi2d_compute1_read_bundle_read(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_1_jacobi2d_compute1_1_res = I_out_1_jacobi2d_compute1_1_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_1_jacobi2d_compute1_1_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_2_res = I_out_1_jacobi2d_compute1_2_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_1_jacobi2d_compute1_2_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_3_res = I_out_1_jacobi2d_compute1_3_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_1_jacobi2d_compute1_3_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_4_res = I_out_1_jacobi2d_compute1_4_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_1_jacobi2d_compute1_4_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_5_res = I_out_1_jacobi2d_compute1_5_select(I_store_I_from_in_0_6_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
...
// Operation logic
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, HWStream<hw_uint<32>  >& out_1, int root, int d1, int d0) {
	// Consume: I
...
inline void store_I_from_in_0(HWStream<hw_uint<32>  >& in_0, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, int root, int id1, int id0) {
	// Consume: in_0
	...
	// Possible ports...
		// I_store_I_from_in_0_6
	I_store_I_from_in_0_write_bundle_write(in_0_id0_c__id1_value, I_store_I_from_in_0_6 /* output src_delay */);
}

inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, HWStream<hw_uint<32>  >& out_0, int root, int d1, int d0) {
	// Consume: I
...
inline void store_I_from_in_1(HWStream<hw_uint<32>  >& in_1, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, int root, int id1, int id0) {
	// Consume: in_1
