...
//	No key for: I_store_I_from_in_0_14
	// inpt: I_store_I_from_in_1_12
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_12 = I_store_I_from_in_1_12_delay.peek(((root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0 && -2 + d0 >= 0 && 14 - d0 >= 0) ? (32) : (-1 + d0 == 0 && root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0) ? (32) : 0));
...
//	No key for: I_store_I_from_in_0_14
	// inpt: I_store_I_from_in_1_12
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_12 = I_store_I_from_in_1_12_delay.peek(((root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0 && -2 + d0 >= 0 && 14 - d0 >= 0) ? (16) : (-1 + d0 == 0 && root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0) ? (16) : 0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_12; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_14
	// inpt: I_store_I_from_in_1_12
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_12 = I_store_I_from_in_1_12_delay.peek((0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_12; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_14
	// inpt: I_store_I_from_in_1_12
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_12 = I_store_I_from_in_1_12_delay.peek(((root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0 && -1 + d0 >= 0 && 14 - d0 >= 0) ? ((15 - d0)) : 0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_12; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_14
	// inpt: I_store_I_from_in_1_12
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_12 = I_store_I_from_in_1_12_delay.peek(((root == 0 && -1 + d1 >= 0 && 30 - d1 >= 0 && -1 + d0 >= 0 && 14 - d0 >= 0) ? ((16 - d0)) : 0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_12; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
inline hw_uint<160> I_out_0_jacobi2d_compute0_read_bundle_read(I_store_I_from_in_0_14_cache& I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_cache& I_store_I_from_in_1_12_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_0_jacobi2d_compute0_1_res = I_out_0_jacobi2d_compute0_1_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_0_jacobi2d_compute0_1_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_2_res = I_out_0_jacobi2d_compute0_2_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_0_jacobi2d_compute0_2_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_3_res = I_out_0_jacobi2d_compute0_3_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_0_jacobi2d_compute0_3_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_4_res = I_out_0_jacobi2d_compute0_4_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_0_jacobi2d_compute0_4_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_5_res = I_out_0_jacobi2d_compute0_5_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
...
inline hw_uint<160> I_out_1_jacobi2d_compute1_read_bundle_read(I_store_I_from_in_0_14_cache& I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_cache& I_store_I_from_in_1_12_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_1_jacobi2d_compute1_7_res = I_out_1_jacobi2d_compute1_7_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_1_jacobi2d_compute1_7_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_8_res = I_out_1_jacobi2d_compute1_8_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_1_jacobi2d_compute1_8_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_9_res = I_out_1_jacobi2d_compute1_9_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_1_jacobi2d_compute1_9_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_10_res = I_out_1_jacobi2d_compute1_10_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_1_jacobi2d_compute1_10_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_11_res = I_out_1_jacobi2d_compute1_11_select(I_store_I_from_in_0_14_delay, I_store_I_from_in_1_12_delay, root, d1, d0);
...
inline void I_store_I_from_in_1_write_bundle_write(hw_uint<32> & /* width = 32*/store_I_from_in_1_write, I_store_I_from_in_1_12_cache& I_store_I_from_in_1_12_delay) {
...
inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_14_cache& I_store_I_from_in_0_14, I_store_I_from_in_1_12_cache& I_store_I_from_in_1_12, HWStream<hw_uint<32>  >& out_0, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m_d0__m__1__p___m_1_c__d1__p__0_value = I_out_0_jacobi2d_compute0_read_bundle_read(I_store_I_from_in_0_14, I_store_I_from_in_1_12/* source_delay */, root, d1, d0);
...
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_14_cache& I_store_I_from_in_0_14, I_store_I_from_in_1_12_cache& I_store_I_from_in_1_12, HWStream<hw_uint<32>  >& out_1, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m__lp_d0_rp___p__1__m__1__p___m_1_c__d1__p__0_value = I_out_1_jacobi2d_compute1_read_bundle_read(I_store_I_from_in_0_14, I_store_I_from_in_1_12/* source_delay */, root, d1, d0);
	// Apply function: jacobi2d_compute
