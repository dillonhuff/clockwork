...
//	No key for: I_store_I_from_in_0_0
	...
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_8 = I_store_I_from_in_1_8_delay.peek_0();
...
//	No key for: I_store_I_from_in_0_0
	// inpt: I_store_I_from_in_1_8
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_8 = I_store_I_from_in_1_8_delay.peek_16();
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_0
	// inpt: I_store_I_from_in_1_8
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_8 = I_store_I_from_in_1_8_delay.peek_32();
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_0
	// inpt: I_store_I_from_in_1_8
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_8 = I_store_I_from_in_1_8_delay.peek((31 - d0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
//	No key for: I_store_I_from_in_0_0
	// inpt: I_store_I_from_in_1_8
	// k = store_I_from_in_1
	int value_I_store_I_from_in_1_8 = I_store_I_from_in_1_8_delay.peek((32 - d0));
	if (select_store_I_from_in_1) { return value_I_store_I_from_in_1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " d1 = " << d1  << " d0 = " << d0  << endl;
	assert(false);
	return 0;
...
// Operation logic
inline void store_I_from_in_0(HWStream<hw_uint<32> >& /* num ports = 1 */in_0, I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_0
...
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* num ports = 1 */out_1, int root, int d1, int d0) {
	// Consume: I
...
inline void store_I_from_in_1(HWStream<hw_uint<32> >& /* num ports = 1 */in_1, I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_1
...
inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* num ports = 1 */out_0, int root, int d1, int d0) {
	// Consume: I
