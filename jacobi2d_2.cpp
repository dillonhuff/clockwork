...
struct I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10_cache {
	// Capacity: 33
	// # of read delays: 15
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10: " << offset << endl;
...
struct I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13_cache {
	// Capacity: 33
	// # of read delays: 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10_cache I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10;
  I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13_cache I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13;
...
inline void I_store_I_from_in_0_6_write(hw_uint<32> & I_store_I_from_in_0_6, I_cache& I, int root, int id1, int id0) {
  I.I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10.push(I_store_I_from_in_0_6);
  I.I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13.push(I_store_I_from_in_0_6);
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_10_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_10 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_6 = I.I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_10.peek(/* is one piece but not a number */(15 - d0));
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_13_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_13 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-2 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_6 = I.I_store_I_from_in_0_6_to_I_out_0_jacobi2d_compute0_13.peek(/* is one piece but not a number */(16 - d0));
	return value_I_store_I_from_in_0_6;
}
