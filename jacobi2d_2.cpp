...
inline void I_store_I_from_in_0_12_write(hw_uint<32> & I_store_I_from_in_0_12, I_cache& I, int root, int id1, int id0) {
	I.I_store_I_from_in_0_12.push(I_store_I_from_in_0_12);
}
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_2_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_14 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12.peek(/* is one piece but not a number */(15 - d0));
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_5_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_14 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12.peek(/* is one piece but not a number */(16 - d0));
	return value_I_store_I_from_in_0_12;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_10_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_14 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12.peek_32();
	return value_I_store_I_from_in_0_12;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_7_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_14 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12.peek_0();
	return value_I_store_I_from_in_0_12;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_9_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_14 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12.peek_16();
	return value_I_store_I_from_in_0_12;
}
