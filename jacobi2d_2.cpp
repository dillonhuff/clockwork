...
struct I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_8: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_2: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_5: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11_cache I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11;
  I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_8_cache I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_8;
  ...
  I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_2_cache I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_2;
  I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_5_cache I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_5;
};



inline void I_store_I_from_in_0_12_write(hw_uint<32> & I_store_I_from_in_0_12, I_cache& I, int root, int id1, int id0) {
  I.I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11.push(I_store_I_from_in_0_12);
  I.I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_8.push(I_store_I_from_in_0_12);
...
inline void I_store_I_from_in_1_14_write(hw_uint<32> & I_store_I_from_in_1_14, I_cache& I, int root, int id1, int id0) {
  ...
  I.I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_2.push(I_store_I_from_in_1_14);
  I.I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_5.push(I_store_I_from_in_1_14);
}
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_11_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_11 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-2 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_11.peek(/* is one piece but not a number */(16 - d0));
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_8_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_8 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_12 = I.I_store_I_from_in_0_12_to_I_out_0_jacobi2d_compute0_8.peek(/* is one piece but not a number */(15 - d0));
	return value_I_store_I_from_in_0_12;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_2_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_2 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[1 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_1_14 = I.I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_2.peek(/* is one piece but not a number */(31 - d0));
	return value_I_store_I_from_in_1_14;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_5_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_5 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[-1 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_1_14 = I.I_store_I_from_in_1_14_to_I_out_1_jacobi2d_compute1_5.peek(/* is one piece but not a number */(32 - d0));
	return value_I_store_I_from_in_1_14;
}
