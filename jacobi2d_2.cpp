...
inline void store_I_from_in_0(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in_0, I_cache& I, int root, int id1, int id0) {
	...
	// Produce: I
	I_store_I_from_in_0_write_bundle_write(in_0_id0_c__id1_value, I.I_store_I_from_in_0_0);
}
...
inline void store_I_from_in_1(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in_1, I_cache& I, int root, int id1, int id0) {
	...
	// Produce: I
	I_store_I_from_in_1_write_bundle_write(in_1_id0_c__id1_value, I.I_store_I_from_in_1_2);
}

inline void out_0_jacobi2d_compute0(I_cache& I, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out_0, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m_d0__m__1__p__0_c__d1__p__1_value = I_out_0_jacobi2d_compute0_read_bundle_read(I.I_store_I_from_in_0_0, I.I_store_I_from_in_1_2/* source_delay */, root, d1, d0);
...
inline void out_1_jacobi2d_compute1(I_cache& I, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out_1, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m__lp_d0_rp___p__1__m__1__p__0_c__d1__p__1_value = I_out_1_jacobi2d_compute1_read_bundle_read(I.I_store_I_from_in_0_0, I.I_store_I_from_in_1_2/* source_delay */, root, d1, d0);
