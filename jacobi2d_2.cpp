...
struct I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10_cache {
	// Capacity: 33
	// # of read delays: 15
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10: " << offset << endl;
...
struct I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13_cache {
	// Capacity: 33
	// # of read delays: 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4_cache {
	// Capacity: 33
	// # of read delays: 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_7: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10_cache I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10;
  I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13_cache I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13;
  ...
  I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4_cache I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4;
  I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_7_cache I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_7;
};



inline void I_store_I_from_in_0_14_write(hw_uint<32> & I_store_I_from_in_0_14, I_cache& I, int root, int id1, int id0) {
  I.I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10.push(I_store_I_from_in_0_14);
  I.I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13.push(I_store_I_from_in_0_14);
...
inline void I_store_I_from_in_1_0_write(hw_uint<32> & I_store_I_from_in_1_0, I_cache& I, int root, int id1, int id0) {
  ...
  I.I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4.push(I_store_I_from_in_1_0);
  I.I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_7.push(I_store_I_from_in_1_0);
}
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_10_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_10 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_14 = I.I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_10.peek(/* is one piece but not a number */(31 - d0));
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_11_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_11 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-1 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_12_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_12 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-1 + 2d0, -1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_13_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_13 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-2 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_14 = I.I_store_I_from_in_0_14_to_I_out_0_jacobi2d_compute0_13.peek(/* is one piece but not a number */(32 - d0));
	return value_I_store_I_from_in_0_14;
}

inline hw_uint<32>  I_out_0_jacobi2d_compute0_9_select(I_cache& I, int root, int d1, int d0) {
	// lexmax events: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> store_I_from_in_1[root' = 0, id1 = 1 + d1, id0 = -1 + d0] : 0 < d1 <= 30 and 0 < d0 <= 14 }
  // I_out_0_jacobi2d_compute0_9 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-1 + 2d0, 1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_3_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_3 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[2d0, 1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_4_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_4 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[1 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_1_0 = I.I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_4.peek(/* is one piece but not a number */(15 - d0));
	return value_I_store_I_from_in_1_0;
}
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_5_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_5 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_6_select(I_cache& I, int root, int d1, int d0) {
	// lexmax events: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> store_I_from_in_0[root' = 0, id1 = -1 + d1, id0 = d0] : 0 < d1 <= 30 and 0 < d0 <= 14 }
  // I_out_1_jacobi2d_compute1_6 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[2d0, -1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
...
inline hw_uint<32>  I_out_1_jacobi2d_compute1_7_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_1_jacobi2d_compute1_7 read pattern: { out_1_jacobi2d_compute1[root = 0, d1, d0] -> I[-1 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_1_0 = I.I_store_I_from_in_1_0_to_I_out_1_jacobi2d_compute1_7.peek(/* is one piece but not a number */(16 - d0));
	return value_I_store_I_from_in_1_0;
}
