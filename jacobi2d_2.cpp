...
struct I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_15: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12_cache I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12;
  I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_15_cache I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_15;
...
inline void I_store_I_from_in_0_8_write(hw_uint<32> & I_store_I_from_in_0_8, I_cache& I, int root, int id1, int id0) {
  I.I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12.push(I_store_I_from_in_0_8);
  I.I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_15.push(I_store_I_from_in_0_8);
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_12_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_12 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_8 = I.I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_12.peek(/* is one piece but not a number */(31 - d0));
...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_15_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_0_jacobi2d_compute0_15 read pattern: { out_0_jacobi2d_compute0[root = 0, d1, d0] -> I[-2 + 2d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 14 }
	auto value_I_store_I_from_in_0_8 = I.I_store_I_from_in_0_8_to_I_out_0_jacobi2d_compute0_15.peek(/* is one piece but not a number */(32 - d0));
	return value_I_store_I_from_in_0_8;
}
