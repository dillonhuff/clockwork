...
struct I{
  I_store_I_from_in_0_6_cache I_store_I_from_in_0_6_delay;
...
, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_8 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_store_I_from_in_0_6 = I_store_I_from_in_0_6_delay.peek((15 - d0));
...
, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_8 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_store_I_from_in_0_6 = I_store_I_from_in_0_6_delay.peek((16 - d0));
	return value_I_store_I_from_in_0_6;
}
...
, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_8 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_store_I_from_in_0_6 = I_store_I_from_in_0_6_delay.peek_0();
	return value_I_store_I_from_in_0_6;
}
...
, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_8 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_store_I_from_in_0_6 = I_store_I_from_in_0_6_delay.peek_16();
	return value_I_store_I_from_in_0_6;
}
...
, int root, int d1, int d0) {
  ...
  // I_store_I_from_in_1_8 stores range: { I[i0, i1] : (1 + i0) mod 2 = 0 and 0 < i0 <= 31 and 0 <= i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_store_I_from_in_0_6 = I_store_I_from_in_0_6_delay.peek_32();
	return value_I_store_I_from_in_0_6;
}
...
inline void I_store_I_from_in_0_write_bundle_write(hw_uint<32>& store_I_from_in_0_write, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6_delay) {
	...
	I_store_I_from_in_0_6_write(I_store_I_from_in_0_6_res, I_store_I_from_in_0_6_delay);
}
...
// Operation logic
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out_1, int root, int d1, int d0) {
	// Consume: I
...
inline void store_I_from_in_0(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in_0, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_0
...
inline void store_I_from_in_1(HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in_1, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_1
...
inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out_0, int root, int d1, int d0) {
	// Consume: I
...
void jacobi2d_2(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in_0, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in_1, HWStream<hw_uint<32> >& /* get_args num ports = 1 */out_0, HWStream<hw_uint<32> >& /* get_args num ports = 1 */out_1) {
	...
	for (int c0 = 0; c0 <= 31; c0 += 1) {
	  for (int c2 = 1; c2 <= 16; c2 += 1) {
	    store_I_from_in_1(in_1, I_store_I_from_in_0_6, I_store_I_from_in_1_8, 0, c0, c2 - 1);
	    if (c0 >= 2 && c2 <= 14)
	      out_0_jacobi2d_compute0(I_store_I_from_in_0_6, I_store_I_from_in_1_8, out_0, 0, c0 - 1, c2);
	  }
	  for (int c2 = 0; c2 <= 15; c2 += 1) {
	    store_I_from_in_0(in_0, I_store_I_from_in_0_6, I_store_I_from_in_1_8, 0, c0, c2);
	    if (c0 >= 2 && c2 >= 1 && c2 <= 14)
	      out_1_jacobi2d_compute1(I_store_I_from_in_0_6, I_store_I_from_in_1_8, out_1, 0, c0 - 1, c2);
	  }
	}
