...
inline hw_uint<32>  I_out_0_jacobi2d_compute0_10_select(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0_delay
...
inline hw_uint<160> I_out_0_jacobi2d_compute0_read_bundle_read(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_0_jacobi2d_compute0_9_res = I_out_0_jacobi2d_compute0_9_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_0_jacobi2d_compute0_9_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_10_res = I_out_0_jacobi2d_compute0_10_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_0_jacobi2d_compute0_10_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_11_res = I_out_0_jacobi2d_compute0_11_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_0_jacobi2d_compute0_11_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_12_res = I_out_0_jacobi2d_compute0_12_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_0_jacobi2d_compute0_12_res);
	hw_uint<32>  I_out_0_jacobi2d_compute0_13_res = I_out_0_jacobi2d_compute0_13_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
...
inline hw_uint<160> I_out_1_jacobi2d_compute1_read_bundle_read(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14_delay, int root, int d1, int d0) {
	hw_uint<160> result;
	hw_uint<32>  I_out_1_jacobi2d_compute1_3_res = I_out_1_jacobi2d_compute1_3_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<0, 160>(result, I_out_1_jacobi2d_compute1_3_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_4_res = I_out_1_jacobi2d_compute1_4_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<32, 160>(result, I_out_1_jacobi2d_compute1_4_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_5_res = I_out_1_jacobi2d_compute1_5_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<64, 160>(result, I_out_1_jacobi2d_compute1_5_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_6_res = I_out_1_jacobi2d_compute1_6_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
	set_at<96, 160>(result, I_out_1_jacobi2d_compute1_6_res);
	hw_uint<32>  I_out_1_jacobi2d_compute1_7_res = I_out_1_jacobi2d_compute1_7_select(I_store_I_from_in_0_0_delay, I_store_I_from_in_1_14_delay, root, d1, d0);
...
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, HWStream<hw_uint<32>  >& out_1, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m__lp_d0_rp___p__1__m__1__p__0_c__d1__p__1_value = I_out_1_jacobi2d_compute1_read_bundle_read(I_store_I_from_in_0_0, I_store_I_from_in_1_14/* source_delay */, root, d1, d0);
...
inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_0_cache& I_store_I_from_in_0_0, I_store_I_from_in_1_14_cache& I_store_I_from_in_1_14, HWStream<hw_uint<32>  >& out_0, int root, int d1, int d0) {
	// Consume: I
	auto I_2_m_d0__m__1__p__0_c__d1__p__1_value = I_out_0_jacobi2d_compute0_read_bundle_read(I_store_I_from_in_0_0, I_store_I_from_in_1_14/* source_delay */, root, d1, d0);
	// Apply function: jacobi2d_compute
...
void jacobi2d_2(HWStream<hw_uint<32>  >& in_0, HWStream<hw_uint<32>  >& in_1, HWStream<hw_uint<32> >& out_0, HWStream<hw_uint<32> >& out_1) {
	...
	for (int c0 = 0; c0 <= 31; c0 += 1) {
	  for (int c2 = 1; c2 <= 16; c2 += 1) {
	    store_I_from_in_1(in_1, I_store_I_from_in_0_0, I_store_I_from_in_1_14, 0, c0, c2 - 1);
	    if (c0 >= 2 && c2 <= 14)
	      out_0_jacobi2d_compute0(I_store_I_from_in_0_0, I_store_I_from_in_1_14, out_0, 0, c0 - 1, c2);
	  }
	  for (int c2 = 0; c2 <= 15; c2 += 1) {
	    store_I_from_in_0(in_0, I_store_I_from_in_0_0, I_store_I_from_in_1_14, 0, c0, c2);
	    if (c0 >= 2 && c2 >= 1 && c2 <= 14)
	      out_1_jacobi2d_compute1(I_store_I_from_in_0_0, I_store_I_from_in_1_14, out_1, 0, c0 - 1, c2);
	  }
	}
