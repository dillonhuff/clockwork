...
// Operation logic
inline void out_0_jacobi2d_compute0(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* num ports = 1 */out_0, int root, int d1, int d0) {
	// Consume: I
...
inline void store_I_from_in_0(HWStream<hw_uint<32> >& /* num ports = 1 */in_0, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_0
...
inline void store_I_from_in_1(HWStream<hw_uint<32> >& /* num ports = 1 */in_1, I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, int root, int id1, int id0) {
	// Consume: in_1
...
inline void out_1_jacobi2d_compute1(I_store_I_from_in_0_6_cache& I_store_I_from_in_0_6, I_store_I_from_in_1_8_cache& I_store_I_from_in_1_8, HWStream<hw_uint<32> >& /* num ports = 1 */out_1, int root, int d1, int d0) {
	// Consume: I
