...
struct grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1_cache() {
...
struct grad_x_stencil_cache {
  // # of banks: 2
  grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1_cache grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1;
...
inline void grad_x_stencil_hcompute_grad_x_stencil_2_write(hw_uint<16>& grad_x_stencil_hcompute_grad_x_stencil_2, grad_x_stencil_cache& grad_x_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  grad_x_stencil.grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1.write(grad_x_stencil_hcompute_grad_x_stencil_2, (grad_x_s0_x - -2) * 1 + (grad_x_s0_y - -2) * 64);
...
inline hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_1_select(grad_x_stencil_cache& grad_x_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  ...
  auto value_grad_x_stencil_hcompute_grad_x_stencil_2 = grad_x_stencil.grad_x_stencil_hcompute_grad_x_stencil_2_to_grad_x_stencil_hcompute_lxx_stencil_1.read(/*ram type address*/ (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
...
struct grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32_cache() {
    free(RAM);
...
struct grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46_cache() {
    free(RAM);
...
struct grad_y_stencil_cache {
  // # of banks: 2
  grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32_cache grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32;
  grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46_cache grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46;
};
...
inline void grad_y_stencil_hcompute_grad_y_stencil_10_write(hw_uint<16>& grad_y_stencil_hcompute_grad_y_stencil_10, grad_y_stencil_cache& grad_y_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  grad_y_stencil.grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32.write(grad_y_stencil_hcompute_grad_y_stencil_10, (grad_y_s0_x - -2) * 1 + (grad_y_s0_y - -2) * 64);
  grad_y_stencil.grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46.write(grad_y_stencil_hcompute_grad_y_stencil_10, (grad_y_s0_x - -2) * 1 + (grad_y_s0_y - -2) * 64);
}
...
inline hw_uint<16> grad_y_stencil_hcompute_lxy_stencil_32_select(grad_y_stencil_cache& grad_y_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
  ...
  auto value_grad_y_stencil_hcompute_grad_y_stencil_10 = grad_y_stencil.grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lxy_stencil_32.read(/*ram type address*/ (lxy_s0_x - -2) * 1 + (lxy_s0_y - -2) * 64);
...
inline hw_uint<16> grad_y_stencil_hcompute_lyy_stencil_46_select(grad_y_stencil_cache& grad_y_stencil, int root, int lyy_s0_y, int lyy_s0_x, int dynamic_address) {
  ...
  auto value_grad_y_stencil_hcompute_grad_y_stencil_10 = grad_y_stencil.grad_y_stencil_hcompute_grad_y_stencil_10_to_grad_y_stencil_hcompute_lyy_stencil_46.read(/*ram type address*/ (lyy_s0_x - -2) * 1 + (lyy_s0_y - -2) * 64);
  return value_grad_y_stencil_hcompute_grad_y_stencil_10;
  return 0;
}
...
struct lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60_cache {
	// RAM Box: {[-1, 59], [-1, 59]}
	// Capacity: 3721
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[3721];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3721);
  }
  ~lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60_cache() {
    free(RAM);
...
struct lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20_cache {
	// RAM Box: {[-1, 59], [-1, 59]}
	// Capacity: 3721
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[3721];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3721);
  }
  ~lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20_cache() {
    free(RAM);
...
struct lgxx_stencil_cache {
  // # of banks: 2
  lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60_cache lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60;
  lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20_cache lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20;
};



inline void lgxx_stencil_hcompute_lgxx_stencil_1_19_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_1_19, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60.write(lgxx_stencil_hcompute_lgxx_stencil_1_19, (lgxx_s1_x - -1) * 1 + (lgxx_s1_y - -1) * 61);
}
...
inline void lgxx_stencil_hcompute_lgxx_stencil_9_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_9, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20.write(lgxx_stencil_hcompute_lgxx_stencil_9, (lgxx_s0_x - -1) * 1 + (lgxx_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgxx_stencil_hcompute_cim_stencil_60_select(lgxx_stencil_cache& lgxx_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_1_19 = lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_1_19_to_lgxx_stencil_hcompute_cim_stencil_60.read(/*ram type address*/ (cim_s0_x - -1) * 1 + (cim_s0_y - -1) * 61);
  return value_lgxx_stencil_hcompute_lgxx_stencil_1_19;
  return 0;
}

inline hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_20_select(lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lgxx_stencil_hcompute_lgxx_stencil_1_20 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lgxx_stencil[lgxx_s1_x, lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lgxx_stencil_hcompute_lgxx_stencil_9 = lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_9_to_lgxx_stencil_hcompute_lgxx_stencil_1_20.read(/*ram type address*/ (lgxx_s1_x - -1) * 1 + (lgxx_s1_y - -1) * 61);
...
//	lgxx_stencil_hcompute_lgxx_stencil_1_20
inline hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_read_bundle_read(lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_20_res = lgxx_stencil_hcompute_lgxx_stencil_1_20_select(lgxx_stencil, root, lgxx_s1_y, lgxx_s1_x, dynamic_address);
	set_at<0, 16>(result, lgxx_stencil_hcompute_lgxx_stencil_1_20_res);
	return result;
}
...
inline void lgxx_stencil_hcompute_lgxx_stencil_1_write_bundle_write(hw_uint<16>& hcompute_lgxx_stencil_1_write, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
	hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_19_res = hcompute_lgxx_stencil_1_write.extract<0, 15>();
	lgxx_stencil_hcompute_lgxx_stencil_1_19_write(lgxx_stencil_hcompute_lgxx_stencil_1_19_res, lgxx_stencil, root, lgxx_s1_y, lgxx_s1_x, dynamic_address);
}
...
struct lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35_cache {
	// RAM Box: {[-1, 59], [-1, 59]}
	// Capacity: 3721
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[3721];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3721);
  }
  ~lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35_cache() {
    free(RAM);
...
struct lgxy_stencil_cache {
  ...
  lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35_cache lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35;
};
...
inline void lgxy_stencil_hcompute_lgxy_stencil_33_write(hw_uint<16>& lgxy_stencil_hcompute_lgxy_stencil_33, lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s0_y, int lgxy_s0_x, int dynamic_address) {
  lgxy_stencil.lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35.write(lgxy_stencil_hcompute_lgxy_stencil_33, (lgxy_s0_x - -1) * 1 + (lgxy_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgxy_stencil_hcompute_lgxy_stencil_1_35_select(lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lgxy_stencil_hcompute_lgxy_stencil_33 = lgxy_stencil.lgxy_stencil_hcompute_lgxy_stencil_33_to_lgxy_stencil_hcompute_lgxy_stencil_1_35.read(/*ram type address*/ (lgxy_s1_x - -1) * 1 + (lgxy_s1_y - -1) * 61);
  return value_lgxy_stencil_hcompute_lgxy_stencil_33;
  return 0;
}
...
struct lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49_cache {
	// RAM Box: {[-1, 59], [-1, 59]}
	// Capacity: 3721
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[3721];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3721);
  }
  ~lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49_cache() {
    free(RAM);
...
struct lgyy_stencil_cache {
  ...
  lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49_cache lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49;
};
...
inline void lgyy_stencil_hcompute_lgyy_stencil_47_write(hw_uint<16>& lgyy_stencil_hcompute_lgyy_stencil_47, lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s0_y, int lgyy_s0_x, int dynamic_address) {
  lgyy_stencil.lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49.write(lgyy_stencil_hcompute_lgyy_stencil_47, (lgyy_s0_x - -1) * 1 + (lgyy_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgyy_stencil_hcompute_lgyy_stencil_1_49_select(lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lgyy_stencil_hcompute_lgyy_stencil_47 = lgyy_stencil.lgyy_stencil_hcompute_lgyy_stencil_47_to_lgyy_stencil_hcompute_lgyy_stencil_1_49.read(/*ram type address*/ (lgyy_s1_x - -1) * 1 + (lgyy_s1_y - -1) * 61);
  return value_lgyy_stencil_hcompute_lgyy_stencil_47;
  return 0;
}
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28_cache() {
    free(RAM);
...
struct lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29_cache {
	// RAM Box: {[-2, 61], [-2, 61]}
	// Capacity: 4096
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4096];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4096);
  }
  ~lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29_cache() {
    free(RAM);
...
struct lxx_stencil_cache {
  // # of banks: 9
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28;
  lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29_cache lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29;
};
...
inline void lxx_stencil_hcompute_lxx_stencil_0_write(hw_uint<16>& lxx_stencil_hcompute_lxx_stencil_0, lxx_stencil_cache& lxx_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29.write(lxx_stencil_hcompute_lxx_stencil_0, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_21_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_21.read(/*ram type address*/ (-1 + lgxx_s1_x - -2) * 1 + (-1 + lgxx_s1_y - -2) * 64);
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_22_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_22.read(/*ram type address*/ (lgxx_s1_x - -2) * 1 + (-1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_23 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[1 + lgxx_s1_x, -1 + lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_23.read(/*ram type address*/ (1 + lgxx_s1_x - -2) * 1 + (-1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_24 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[-1 + lgxx_s1_x, lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_24.read(/*ram type address*/ (-1 + lgxx_s1_x - -2) * 1 + (lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_25 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[lgxx_s1_x, lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_25.read(/*ram type address*/ (lgxx_s1_x - -2) * 1 + (lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_26 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[1 + lgxx_s1_x, lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_26.read(/*ram type address*/ (1 + lgxx_s1_x - -2) * 1 + (lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_27_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_27.read(/*ram type address*/ (-1 + lgxx_s1_x - -2) * 1 + (1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_28 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[1 + lgxx_s1_x, 1 + lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_28.read(/*ram type address*/ (1 + lgxx_s1_x - -2) * 1 + (1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lxx_stencil_hcompute_lgxx_stencil_1_29 read pattern: { hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lxx_stencil[lgxx_s1_x, 1 + lgxx_s1_y] : -1 <= lgxx_s1_y <= 59 and -1 <= lgxx_s1_x <= 59 }
  auto value_lxx_stencil_hcompute_lxx_stencil_0 = lxx_stencil.lxx_stencil_hcompute_lxx_stencil_0_to_lxx_stencil_hcompute_lgxx_stencil_1_29.read(/*ram type address*/ (lgxx_s1_x - -2) * 1 + (1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_0;
  return 0;
}
...
inline hw_uint<144> lxx_stencil_hcompute_lgxx_stencil_1_read_bundle_read(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  // # of ports in bundle: 9
	...
	set_at<0, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_21_res);
	...
	set_at<16, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_22_res);
	...
	set_at<32, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_23_res);
	...
	set_at<48, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_24_res);
	...
	set_at<64, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_25_res);
	...
	set_at<80, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_26_res);
	...
	set_at<96, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_27_res);
	...
	set_at<112, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_28_res);
	...
	set_at<128, 144>(result, lxx_stencil_hcompute_lgxx_stencil_1_29_res);
	return result;
}
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3_cache() {
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15_cache() {
    free(RAM);
...
struct padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16_cache {
	// RAM Box: {[-3, 63], [-3, 63]}
	// Capacity: 4489
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[4489];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*4489);
  }
  ~padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16_cache() {
    free(RAM);
...
struct padded16_stencil_cache {
  // # of banks: 12
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15;
  padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16_cache padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16;
};



inline void padded16_stencil_hcompute_padded16_stencil_17_write(hw_uint<16>& padded16_stencil_hcompute_padded16_stencil_17, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
  padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16.write(padded16_stencil_hcompute_padded16_stencil_17, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_3_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_3.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (-1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_4_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_4.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_5_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_5.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_6_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_6.read(/*ram type address*/ (-1 + grad_x_s0_x - -3) * 1 + (-1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_7_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_7.read(/*ram type address*/ (-1 + grad_x_s0_x - -3) * 1 + (grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_8_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_x_stencil_8.read(/*ram type address*/ (-1 + grad_x_s0_x - -3) * 1 + (1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_11_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_11.read(/*ram type address*/ (-1 + grad_y_s0_x - -3) * 1 + (-1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_12_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_12.read(/*ram type address*/ (grad_y_s0_x - -3) * 1 + (-1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_13_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_13.read(/*ram type address*/ (1 + grad_y_s0_x - -3) * 1 + (-1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_14_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_14.read(/*ram type address*/ (-1 + grad_y_s0_x - -3) * 1 + (1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_15_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_15.read(/*ram type address*/ (1 + grad_y_s0_x - -3) * 1 + (1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_16_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_17 = padded16_stencil.padded16_stencil_hcompute_padded16_stencil_17_to_padded16_stencil_hcompute_grad_y_stencil_16.read(/*ram type address*/ (grad_y_s0_x - -3) * 1 + (1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_17;
  return 0;
}
...
//	padded16_stencil_hcompute_padded16_stencil_17
inline void padded16_stencil_hcompute_padded16_stencil_write_bundle_write(hw_uint<16>& hcompute_padded16_stencil_write, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
	hw_uint<16> padded16_stencil_hcompute_padded16_stencil_17_res = hcompute_padded16_stencil_write.extract<0, 15>();
	padded16_stencil_hcompute_padded16_stencil_17_write(padded16_stencil_hcompute_padded16_stencil_17_res, padded16_stencil, root, padded16_s0_y, padded16_s0_x, dynamic_address);
}
