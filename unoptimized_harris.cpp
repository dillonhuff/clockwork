...
inline void grad_x_stencil_hcompute_grad_x_stencil_36_write(hw_uint<16>& grad_x_stencil_hcompute_grad_x_stencil_36, grad_x_stencil_cache& grad_x_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.write(grad_x_stencil_hcompute_grad_x_stencil_36, (grad_x_s0_x - -2) * 1 + (grad_x_s0_y - -2) * 64);
}

inline hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_33_select(grad_x_stencil_cache& grad_x_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_stencil_hcompute_lxx_stencil_33 read pattern: { hcompute_lxx_stencil[root = 0, lxx_s0_y, lxx_s0_x] -> grad_x_stencil[lxx_s0_x, lxx_s0_y] : -2 <= lxx_s0_y <= 61 and -2 <= lxx_s0_x <= 61 }
  auto value_grad_x_stencil_hcompute_grad_x_stencil_36 = grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
  return value_grad_x_stencil_hcompute_grad_x_stencil_36;
  return 0;
}

inline hw_uint<16> grad_x_stencil_hcompute_lxy_stencil_55_select(grad_x_stencil_cache& grad_x_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_stencil_hcompute_lxy_stencil_55 read pattern: { hcompute_lxy_stencil[root = 0, lxy_s0_y, lxy_s0_x] -> grad_x_stencil[lxy_s0_x, lxy_s0_y] : -2 <= lxy_s0_y <= 61 and -2 <= lxy_s0_x <= 61 }
  auto value_grad_x_stencil_hcompute_grad_x_stencil_36 = grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lxy_s0_x - -2) * 1 + (lxy_s0_y - -2) * 64);
  return value_grad_x_stencil_hcompute_grad_x_stencil_36;
  return 0;
}
...
//	grad_x_stencil_hcompute_grad_x_stencil_36
inline void grad_x_stencil_hcompute_grad_x_stencil_write_bundle_write(hw_uint<16>& hcompute_grad_x_stencil_write, grad_x_stencil_cache& grad_x_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
	hw_uint<16> grad_x_stencil_hcompute_grad_x_stencil_36_res = hcompute_grad_x_stencil_write.extract<0, 15>();
	grad_x_stencil_hcompute_grad_x_stencil_36_write(grad_x_stencil_hcompute_grad_x_stencil_36_res, grad_x_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
}

// hcompute_lxx_stencil_read
//	grad_x_stencil_hcompute_lxx_stencil_33
inline hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_read_bundle_read(grad_x_stencil_cache& grad_x_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_33_res = grad_x_stencil_hcompute_lxx_stencil_33_select(grad_x_stencil, root, lxx_s0_y, lxx_s0_x, dynamic_address);
	set_at<0, 16>(result, grad_x_stencil_hcompute_lxx_stencil_33_res);
	return result;
}

// hcompute_lxy_stencil_read
//	grad_x_stencil_hcompute_lxy_stencil_55
inline hw_uint<16> grad_x_stencil_hcompute_lxy_stencil_read_bundle_read(grad_x_stencil_cache& grad_x_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> grad_x_stencil_hcompute_lxy_stencil_55_res = grad_x_stencil_hcompute_lxy_stencil_55_select(grad_x_stencil, root, lxy_s0_y, lxy_s0_x, dynamic_address);
	set_at<0, 16>(result, grad_x_stencil_hcompute_lxy_stencil_55_res);
	return result;
}
...
inline void grad_y_stencil_hcompute_grad_y_stencil_25_write(hw_uint<16>& grad_y_stencil_hcompute_grad_y_stencil_25, grad_y_stencil_cache& grad_y_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  grad_y_stencil.grad_y_stencil_all_inputs_to_all_outputs.write(grad_y_stencil_hcompute_grad_y_stencil_25, (grad_y_s0_x - -2) * 1 + (grad_y_s0_y - -2) * 64);
}

inline hw_uint<16> grad_y_stencil_hcompute_lxy_stencil_56_select(grad_y_stencil_cache& grad_y_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_stencil_hcompute_lxy_stencil_56 read pattern: { hcompute_lxy_stencil[root = 0, lxy_s0_y, lxy_s0_x] -> grad_y_stencil[lxy_s0_x, lxy_s0_y] : -2 <= lxy_s0_y <= 61 and -2 <= lxy_s0_x <= 61 }
  auto value_grad_y_stencil_hcompute_grad_y_stencil_25 = grad_y_stencil.grad_y_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lxy_s0_x - -2) * 1 + (lxy_s0_y - -2) * 64);
  return value_grad_y_stencil_hcompute_grad_y_stencil_25;
  return 0;
}

inline hw_uint<16> grad_y_stencil_hcompute_lyy_stencil_12_select(grad_y_stencil_cache& grad_y_stencil, int root, int lyy_s0_y, int lyy_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_stencil_hcompute_lyy_stencil_12 read pattern: { hcompute_lyy_stencil[root = 0, lyy_s0_y, lyy_s0_x] -> grad_y_stencil[lyy_s0_x, lyy_s0_y] : -2 <= lyy_s0_y <= 61 and -2 <= lyy_s0_x <= 61 }
  auto value_grad_y_stencil_hcompute_grad_y_stencil_25 = grad_y_stencil.grad_y_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lyy_s0_x - -2) * 1 + (lyy_s0_y - -2) * 64);
  return value_grad_y_stencil_hcompute_grad_y_stencil_25;
  return 0;
}
...
//	grad_y_stencil_hcompute_grad_y_stencil_25
inline void grad_y_stencil_hcompute_grad_y_stencil_write_bundle_write(hw_uint<16>& hcompute_grad_y_stencil_write, grad_y_stencil_cache& grad_y_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
	hw_uint<16> grad_y_stencil_hcompute_grad_y_stencil_25_res = hcompute_grad_y_stencil_write.extract<0, 15>();
	grad_y_stencil_hcompute_grad_y_stencil_25_write(grad_y_stencil_hcompute_grad_y_stencil_25_res, grad_y_stencil, root, grad_y_s0_y, grad_y_s0_x, dynamic_address);
}

// hcompute_lxy_stencil_read
//	grad_y_stencil_hcompute_lxy_stencil_56
inline hw_uint<16> grad_y_stencil_hcompute_lxy_stencil_read_bundle_read(grad_y_stencil_cache& grad_y_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> grad_y_stencil_hcompute_lxy_stencil_56_res = grad_y_stencil_hcompute_lxy_stencil_56_select(grad_y_stencil, root, lxy_s0_y, lxy_s0_x, dynamic_address);
	set_at<0, 16>(result, grad_y_stencil_hcompute_lxy_stencil_56_res);
	return result;
}

// hcompute_lyy_stencil_read
//	grad_y_stencil_hcompute_lyy_stencil_12
inline hw_uint<16> grad_y_stencil_hcompute_lyy_stencil_read_bundle_read(grad_y_stencil_cache& grad_y_stencil, int root, int lyy_s0_y, int lyy_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> grad_y_stencil_hcompute_lyy_stencil_12_res = grad_y_stencil_hcompute_lyy_stencil_12_select(grad_y_stencil, root, lyy_s0_y, lyy_s0_x, dynamic_address);
	set_at<0, 16>(result, grad_y_stencil_hcompute_lyy_stencil_12_res);
	return result;
}
...
inline void lgxx_stencil_hcompute_lgxx_stencil_1_0_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_1_0, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.write(lgxx_stencil_hcompute_lgxx_stencil_1_0, (lgxx_s1_x - -1) * 1 + (lgxx_s1_y - -1) * 61);
}

inline void lgxx_stencil_hcompute_lgxx_stencil_24_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_24, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.write(lgxx_stencil_hcompute_lgxx_stencil_24, (lgxx_s0_x - -1) * 1 + (lgxx_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgxx_stencil_hcompute_cim_stencil_60_select(lgxx_stencil_cache& lgxx_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_1_0 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (cim_s0_x - -1) * 1 + (cim_s0_y - -1) * 61);
...
inline hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_1_select(lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_1_0 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxx_s1_x - -1) * 1 + (lgxx_s1_y - -1) * 61);
  return value_lgxx_stencil_hcompute_lgxx_stencil_1_0;
  return 0;
}
...
//	lgxx_stencil_hcompute_lgxx_stencil_24
inline void lgxx_stencil_hcompute_lgxx_stencil_write_bundle_write(hw_uint<16>& hcompute_lgxx_stencil_write, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
	hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_24_res = hcompute_lgxx_stencil_write.extract<0, 15>();
	lgxx_stencil_hcompute_lgxx_stencil_24_write(lgxx_stencil_hcompute_lgxx_stencil_24_res, lgxx_stencil, root, lgxx_s0_y, lgxx_s0_x, dynamic_address);
}
...
inline void lgxy_stencil_hcompute_lgxy_stencil_57_write(hw_uint<16>& lgxy_stencil_hcompute_lgxy_stencil_57, lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s0_y, int lgxy_s0_x, int dynamic_address) {
  lgxy_stencil.lgxy_stencil_all_inputs_to_all_outputs.write(lgxy_stencil_hcompute_lgxy_stencil_57, (lgxy_s0_x - -1) * 1 + (lgxy_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgxy_stencil_hcompute_cim_stencil_61_select(lgxy_stencil_cache& lgxy_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgxy_stencil_hcompute_lgxy_stencil_1_43 = lgxy_stencil.lgxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (cim_s0_x - -1) * 1 + (cim_s0_y - -1) * 61);
  return value_lgxy_stencil_hcompute_lgxy_stencil_1_43;
  return 0;
}
...
inline hw_uint<16> lgxy_stencil_hcompute_lgxy_stencil_1_44_select(lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lgxy_stencil_hcompute_lgxy_stencil_1_43 = lgxy_stencil.lgxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxy_s1_x - -1) * 1 + (lgxy_s1_y - -1) * 61);
  return value_lgxy_stencil_hcompute_lgxy_stencil_1_43;
  return 0;
}
...
//	lgxy_stencil_hcompute_lgxy_stencil_57
inline void lgxy_stencil_hcompute_lgxy_stencil_write_bundle_write(hw_uint<16>& hcompute_lgxy_stencil_write, lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s0_y, int lgxy_s0_x, int dynamic_address) {
	hw_uint<16> lgxy_stencil_hcompute_lgxy_stencil_57_res = hcompute_lgxy_stencil_write.extract<0, 15>();
	lgxy_stencil_hcompute_lgxy_stencil_57_write(lgxy_stencil_hcompute_lgxy_stencil_57_res, lgxy_stencil, root, lgxy_s0_y, lgxy_s0_x, dynamic_address);
}
...
inline void lgyy_stencil_hcompute_lgyy_stencil_1_13_write(hw_uint<16>& lgyy_stencil_hcompute_lgyy_stencil_1_13, lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.write(lgyy_stencil_hcompute_lgyy_stencil_1_13, (lgyy_s1_x - -1) * 1 + (lgyy_s1_y - -1) * 61);
}

inline void lgyy_stencil_hcompute_lgyy_stencil_58_write(hw_uint<16>& lgyy_stencil_hcompute_lgyy_stencil_58, lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s0_y, int lgyy_s0_x, int dynamic_address) {
  lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.write(lgyy_stencil_hcompute_lgyy_stencil_58, (lgyy_s0_x - -1) * 1 + (lgyy_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgyy_stencil_hcompute_cim_stencil_62_select(lgyy_stencil_cache& lgyy_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgyy_stencil_hcompute_lgyy_stencil_1_13 = lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (cim_s0_x - -1) * 1 + (cim_s0_y - -1) * 61);
...
inline hw_uint<16> lgyy_stencil_hcompute_lgyy_stencil_1_14_select(lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lgyy_stencil_hcompute_lgyy_stencil_1_13 = lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgyy_s1_x - -1) * 1 + (lgyy_s1_y - -1) * 61);
  return value_lgyy_stencil_hcompute_lgyy_stencil_1_13;
  return 0;
}
...
//	lgyy_stencil_hcompute_lgyy_stencil_58
inline void lgyy_stencil_hcompute_lgyy_stencil_write_bundle_write(hw_uint<16>& hcompute_lgyy_stencil_write, lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s0_y, int lgyy_s0_x, int dynamic_address) {
	hw_uint<16> lgyy_stencil_hcompute_lgyy_stencil_58_res = hcompute_lgyy_stencil_write.extract<0, 15>();
	lgyy_stencil_hcompute_lgyy_stencil_58_write(lgyy_stencil_hcompute_lgyy_stencil_58_res, lgyy_stencil, root, lgyy_s0_y, lgyy_s0_x, dynamic_address);
}
...
inline void lxx_stencil_hcompute_lxx_stencil_32_write(hw_uint<16>& lxx_stencil_hcompute_lxx_stencil_32, lxx_stencil_cache& lxx_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.write(lxx_stencil_hcompute_lxx_stencil_32, (lxx_s0_x - -2) * 1 + (lxx_s0_y - -2) * 64);
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_10_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_32 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxx_s1_x - -2) * 1 + (1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_32;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_2_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_32 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgxx_s1_x - -2) * 1 + (-1 + lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_32;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_5_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_32 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgxx_s1_x - -2) * 1 + (lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_32;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_6_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_32 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxx_s1_x - -2) * 1 + (lgxx_s1_y - -2) * 64);
  return value_lxx_stencil_hcompute_lxx_stencil_32;
  return 0;
}
...
//	lxx_stencil_hcompute_lxx_stencil_32
inline void lxx_stencil_hcompute_lxx_stencil_write_bundle_write(hw_uint<16>& hcompute_lxx_stencil_write, lxx_stencil_cache& lxx_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
	hw_uint<16> lxx_stencil_hcompute_lxx_stencil_32_res = hcompute_lxx_stencil_write.extract<0, 15>();
	lxx_stencil_hcompute_lxx_stencil_32_write(lxx_stencil_hcompute_lxx_stencil_32_res, lxx_stencil, root, lxx_s0_y, lxx_s0_x, dynamic_address);
}
...
inline void lxy_stencil_hcompute_lxy_stencil_54_write(hw_uint<16>& lxy_stencil_hcompute_lxy_stencil_54, lxy_stencil_cache& lxy_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
  lxy_stencil.lxy_stencil_all_inputs_to_all_outputs.write(lxy_stencil_hcompute_lxy_stencil_54, (lxy_s0_x - -2) * 1 + (lxy_s0_y - -2) * 64);
}
...
inline hw_uint<16> lxy_stencil_hcompute_lgxy_stencil_1_45_select(lxy_stencil_cache& lxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lxy_stencil_hcompute_lxy_stencil_54 = lxy_stencil.lxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgxy_s1_x - -2) * 1 + (-1 + lgxy_s1_y - -2) * 64);
  return value_lxy_stencil_hcompute_lxy_stencil_54;
  return 0;
}
...
inline hw_uint<16> lxy_stencil_hcompute_lgxy_stencil_1_46_select(lxy_stencil_cache& lxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lxy_stencil_hcompute_lxy_stencil_54 = lxy_stencil.lxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxy_s1_x - -2) * 1 + (-1 + lgxy_s1_y - -2) * 64);
  return value_lxy_stencil_hcompute_lxy_stencil_54;
  return 0;
}
...
inline hw_uint<16> lxy_stencil_hcompute_lgxy_stencil_1_48_select(lxy_stencil_cache& lxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lxy_stencil_hcompute_lxy_stencil_54 = lxy_stencil.lxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgxy_s1_x - -2) * 1 + (lgxy_s1_y - -2) * 64);
  return value_lxy_stencil_hcompute_lxy_stencil_54;
  return 0;
}
...
inline hw_uint<16> lxy_stencil_hcompute_lgxy_stencil_1_49_select(lxy_stencil_cache& lxy_stencil, int root, int lgxy_s1_y, int lgxy_s1_x, int dynamic_address) {
  ...
  auto value_lxy_stencil_hcompute_lxy_stencil_54 = lxy_stencil.lxy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgxy_s1_x - -2) * 1 + (lgxy_s1_y - -2) * 64);
  return value_lxy_stencil_hcompute_lxy_stencil_54;
  return 0;
}
...
//	lxy_stencil_hcompute_lxy_stencil_54
inline void lxy_stencil_hcompute_lxy_stencil_write_bundle_write(hw_uint<16>& hcompute_lxy_stencil_write, lxy_stencil_cache& lxy_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
	hw_uint<16> lxy_stencil_hcompute_lxy_stencil_54_res = hcompute_lxy_stencil_write.extract<0, 15>();
	lxy_stencil_hcompute_lxy_stencil_54_write(lxy_stencil_hcompute_lxy_stencil_54_res, lxy_stencil, root, lxy_s0_y, lxy_s0_x, dynamic_address);
}
...
inline void lyy_stencil_hcompute_lyy_stencil_11_write(hw_uint<16>& lyy_stencil_hcompute_lyy_stencil_11, lyy_stencil_cache& lyy_stencil, int root, int lyy_s0_y, int lyy_s0_x, int dynamic_address) {
  lyy_stencil.lyy_stencil_all_inputs_to_all_outputs.write(lyy_stencil_hcompute_lyy_stencil_11, (lyy_s0_x - -2) * 1 + (lyy_s0_y - -2) * 64);
}
...
inline hw_uint<16> lyy_stencil_hcompute_lgyy_stencil_1_15_select(lyy_stencil_cache& lyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lyy_stencil_hcompute_lyy_stencil_11 = lyy_stencil.lyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgyy_s1_x - -2) * 1 + (-1 + lgyy_s1_y - -2) * 64);
  return value_lyy_stencil_hcompute_lyy_stencil_11;
  return 0;
}
...
inline hw_uint<16> lyy_stencil_hcompute_lgyy_stencil_1_16_select(lyy_stencil_cache& lyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lyy_stencil_hcompute_lyy_stencil_11 = lyy_stencil.lyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgyy_s1_x - -2) * 1 + (-1 + lgyy_s1_y - -2) * 64);
  return value_lyy_stencil_hcompute_lyy_stencil_11;
  return 0;
}
...
inline hw_uint<16> lyy_stencil_hcompute_lgyy_stencil_1_18_select(lyy_stencil_cache& lyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lyy_stencil_hcompute_lyy_stencil_11 = lyy_stencil.lyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + lgyy_s1_x - -2) * 1 + (lgyy_s1_y - -2) * 64);
  return value_lyy_stencil_hcompute_lyy_stencil_11;
  return 0;
}
...
inline hw_uint<16> lyy_stencil_hcompute_lgyy_stencil_1_19_select(lyy_stencil_cache& lyy_stencil, int root, int lgyy_s1_y, int lgyy_s1_x, int dynamic_address) {
  ...
  auto value_lyy_stencil_hcompute_lyy_stencil_11 = lyy_stencil.lyy_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (lgyy_s1_x - -2) * 1 + (lgyy_s1_y - -2) * 64);
  return value_lyy_stencil_hcompute_lyy_stencil_11;
  return 0;
}
...
//	lyy_stencil_hcompute_lyy_stencil_11
inline void lyy_stencil_hcompute_lyy_stencil_write_bundle_write(hw_uint<16>& hcompute_lyy_stencil_write, lyy_stencil_cache& lyy_stencil, int root, int lyy_s0_y, int lyy_s0_x, int dynamic_address) {
	hw_uint<16> lyy_stencil_hcompute_lyy_stencil_11_res = hcompute_lyy_stencil_write.extract<0, 15>();
	lyy_stencil_hcompute_lyy_stencil_11_write(lyy_stencil_hcompute_lyy_stencil_11_res, lyy_stencil, root, lyy_s0_y, lyy_s0_x, dynamic_address);
}
...
inline void padded16_stencil_hcompute_padded16_stencil_34_write(hw_uint<16>& padded16_stencil_hcompute_padded16_stencil_34, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
  padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.write(padded16_stencil_hcompute_padded16_stencil_34, (padded16_s0_x - -3) * 1 + (padded16_s0_y - -3) * 67);
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_37_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_34 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (-1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_34;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_38 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[1 + grad_x_s0_x, 1 + grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_34 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (1 + grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_34;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_39 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[1 + grad_x_s0_x, grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_34 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (1 + grad_x_s0_x - -3) * 1 + (grad_x_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_34;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_26_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_34 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (-1 + grad_y_s0_x - -3) * 1 + (-1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_34;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_y_stencil_27 read pattern: { hcompute_grad_y_stencil[root = 0, grad_y_s0_y, grad_y_s0_x] -> padded16_stencil[grad_y_s0_x, -1 + grad_y_s0_y] : -2 <= grad_y_s0_y <= 61 and -2 <= grad_y_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_34 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (grad_y_s0_x - -3) * 1 + (-1 + grad_y_s0_y - -3) * 67);
  return value_padded16_stencil_hcompute_padded16_stencil_34;
  return 0;
}
...
inline hw_uint<96> padded16_stencil_hcompute_grad_x_stencil_read_bundle_read(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  // # of ports in bundle: 6
	...
	set_at<0, 96>(result, padded16_stencil_hcompute_grad_x_stencil_37_res);
	...
	set_at<16, 96>(result, padded16_stencil_hcompute_grad_x_stencil_38_res);
	...
	set_at<32, 96>(result, padded16_stencil_hcompute_grad_x_stencil_39_res);
	...
	set_at<48, 96>(result, padded16_stencil_hcompute_grad_x_stencil_40_res);
	...
	set_at<64, 96>(result, padded16_stencil_hcompute_grad_x_stencil_41_res);
	...
	set_at<80, 96>(result, padded16_stencil_hcompute_grad_x_stencil_42_res);
	return result;
}
...
inline hw_uint<96> padded16_stencil_hcompute_grad_y_stencil_read_bundle_read(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  // # of ports in bundle: 6
	...
	set_at<0, 96>(result, padded16_stencil_hcompute_grad_y_stencil_26_res);
	...
	set_at<16, 96>(result, padded16_stencil_hcompute_grad_y_stencil_27_res);
	...
	set_at<32, 96>(result, padded16_stencil_hcompute_grad_y_stencil_28_res);
	...
	set_at<48, 96>(result, padded16_stencil_hcompute_grad_y_stencil_29_res);
	...
	set_at<64, 96>(result, padded16_stencil_hcompute_grad_y_stencil_30_res);
	...
	set_at<80, 96>(result, padded16_stencil_hcompute_grad_y_stencil_31_res);
	return result;
}

// hcompute_padded16_stencil_write
//	padded16_stencil_hcompute_padded16_stencil_34
inline void padded16_stencil_hcompute_padded16_stencil_write_bundle_write(hw_uint<16>& hcompute_padded16_stencil_write, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
	hw_uint<16> padded16_stencil_hcompute_padded16_stencil_34_res = hcompute_padded16_stencil_write.extract<0, 15>();
	padded16_stencil_hcompute_padded16_stencil_34_write(padded16_stencil_hcompute_padded16_stencil_34_res, padded16_stencil, root, padded16_s0_y, padded16_s0_x, dynamic_address);
}
