...
inline void grad_x_stencil_hcompute_grad_x_stencil_14_write(hw_uint<16>& grad_x_stencil_hcompute_grad_x_stencil_14, grad_x_stencil_cache& grad_x_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.write(grad_x_stencil_hcompute_grad_x_stencil_14, grad_x_s0_x - -2, grad_x_s0_y - -2);
}

inline hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_12_select(grad_x_stencil_cache& grad_x_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_stencil_hcompute_lxx_stencil_12 read pattern: { hcompute_lxx_stencil[root = 0, lxx_s0_y, lxx_s0_x] -> grad_x_stencil[lxx_s0_x, lxx_s0_y] : -2 <= lxx_s0_y <= 61 and -2 <= lxx_s0_x <= 61 }
  auto value_grad_x_stencil_hcompute_grad_x_stencil_14 = grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.read(lxx_s0_x - -2, lxx_s0_y - -2);
  return value_grad_x_stencil_hcompute_grad_x_stencil_14;
  return 0;
}
...
inline hw_uint<16> grad_x_stencil_hcompute_lxy_stencil_31_select(grad_x_stencil_cache& grad_x_stencil, int root, int lxy_s0_y, int lxy_s0_x, int dynamic_address) {
  ...
  auto value_grad_x_stencil_hcompute_grad_x_stencil_14 = grad_x_stencil.grad_x_stencil_all_inputs_to_all_outputs.read(lxy_s0_x - -2, lxy_s0_y - -2);
  return value_grad_x_stencil_hcompute_grad_x_stencil_14;
  return 0;
}
...
//	grad_x_stencil_hcompute_grad_x_stencil_14
inline void grad_x_stencil_hcompute_grad_x_stencil_write_bundle_write(hw_uint<16>& hcompute_grad_x_stencil_write, grad_x_stencil_cache& grad_x_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
	hw_uint<16> grad_x_stencil_hcompute_grad_x_stencil_14_res = hcompute_grad_x_stencil_write.extract<0, 15>();
	grad_x_stencil_hcompute_grad_x_stencil_14_write(grad_x_stencil_hcompute_grad_x_stencil_14_res, grad_x_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
}

// hcompute_lxx_stencil_read
//	grad_x_stencil_hcompute_lxx_stencil_12
inline hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_read_bundle_read(grad_x_stencil_cache& grad_x_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> grad_x_stencil_hcompute_lxx_stencil_12_res = grad_x_stencil_hcompute_lxx_stencil_12_select(grad_x_stencil, root, lxx_s0_y, lxx_s0_x, dynamic_address);
	set_at<0, 16>(result, grad_x_stencil_hcompute_lxx_stencil_12_res);
	return result;
}
...
inline void lgxx_stencil_hcompute_lgxx_stencil_13_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_13, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.write(lgxx_stencil_hcompute_lgxx_stencil_13, lgxx_s0_x - -1, lgxx_s0_y - -1);
}
...
inline void lgxx_stencil_hcompute_lgxx_stencil_1_0_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_1_0, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.write(lgxx_stencil_hcompute_lgxx_stencil_1_0, lgxx_s1_x - -1, lgxx_s1_y - -1);
}
...
inline hw_uint<16> lgxx_stencil_hcompute_cim_stencil_60_select(lgxx_stencil_cache& lgxx_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_13 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(cim_s0_x - -1, cim_s0_y - -1);
  return value_lgxx_stencil_hcompute_lgxx_stencil_13;
  return 0;
}
...
inline hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_1_select(lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_13 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(lgxx_s1_x - -1, lgxx_s1_y - -1);
  return value_lgxx_stencil_hcompute_lgxx_stencil_13;
  return 0;
}
...
//	lgxx_stencil_hcompute_lgxx_stencil_13
inline void lgxx_stencil_hcompute_lgxx_stencil_write_bundle_write(hw_uint<16>& hcompute_lgxx_stencil_write, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
	hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_13_res = hcompute_lgxx_stencil_write.extract<0, 15>();
	lgxx_stencil_hcompute_lgxx_stencil_13_write(lgxx_stencil_hcompute_lgxx_stencil_13_res, lgxx_stencil, root, lgxx_s0_y, lgxx_s0_x, dynamic_address);
}
...
inline void lxx_stencil_hcompute_lxx_stencil_11_write(hw_uint<16>& lxx_stencil_hcompute_lxx_stencil_11, lxx_stencil_cache& lxx_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
  lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.write(lxx_stencil_hcompute_lxx_stencil_11, lxx_s0_x - -2, lxx_s0_y - -2);
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_10_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_11 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(lgxx_s1_x - -2, 1 + lgxx_s1_y - -2);
  return value_lxx_stencil_hcompute_lxx_stencil_11;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_2_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_11 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(-1 + lgxx_s1_x - -2, -1 + lgxx_s1_y - -2);
  return value_lxx_stencil_hcompute_lxx_stencil_11;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_5_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_11 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(-1 + lgxx_s1_x - -2, lgxx_s1_y - -2);
  return value_lxx_stencil_hcompute_lxx_stencil_11;
  return 0;
}
...
inline hw_uint<16> lxx_stencil_hcompute_lgxx_stencil_1_6_select(lxx_stencil_cache& lxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lxx_stencil_hcompute_lxx_stencil_11 = lxx_stencil.lxx_stencil_all_inputs_to_all_outputs.read(lgxx_s1_x - -2, lgxx_s1_y - -2);
  return value_lxx_stencil_hcompute_lxx_stencil_11;
  return 0;
}
...
//	lxx_stencil_hcompute_lxx_stencil_11
inline void lxx_stencil_hcompute_lxx_stencil_write_bundle_write(hw_uint<16>& hcompute_lxx_stencil_write, lxx_stencil_cache& lxx_stencil, int root, int lxx_s0_y, int lxx_s0_x, int dynamic_address) {
	hw_uint<16> lxx_stencil_hcompute_lxx_stencil_11_res = hcompute_lxx_stencil_write.extract<0, 15>();
	lxx_stencil_hcompute_lxx_stencil_11_write(lxx_stencil_hcompute_lxx_stencil_11_res, lxx_stencil, root, lxx_s0_y, lxx_s0_x, dynamic_address);
}
...
inline void padded16_stencil_hcompute_padded16_stencil_21_write(hw_uint<16>& padded16_stencil_hcompute_padded16_stencil_21, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
  padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.write(padded16_stencil_hcompute_padded16_stencil_21, padded16_s0_x - -3, padded16_s0_y - -3);
}

inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_15_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_15 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[1 + grad_x_s0_x, -1 + grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(1 + grad_x_s0_x - -3, -1 + grad_x_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}

inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_16_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_16 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[1 + grad_x_s0_x, 1 + grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(1 + grad_x_s0_x - -3, 1 + grad_x_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}

inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_17_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_17 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[1 + grad_x_s0_x, grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(1 + grad_x_s0_x - -3, grad_x_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}

inline hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_18_select(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_18 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[-1 + grad_x_s0_x, -1 + grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(-1 + grad_x_s0_x - -3, -1 + grad_x_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // padded16_stencil_hcompute_grad_x_stencil_19 read pattern: { hcompute_grad_x_stencil[root = 0, grad_x_s0_y, grad_x_s0_x] -> padded16_stencil[-1 + grad_x_s0_x, grad_x_s0_y] : -2 <= grad_x_s0_y <= 61 and -2 <= grad_x_s0_x <= 61 }
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(-1 + grad_x_s0_x - -3, grad_x_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_24_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(-1 + grad_y_s0_x - -3, -1 + grad_y_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}
...
inline hw_uint<16> padded16_stencil_hcompute_grad_y_stencil_25_select(padded16_stencil_cache& padded16_stencil, int root, int grad_y_s0_y, int grad_y_s0_x, int dynamic_address) {
  ...
  auto value_padded16_stencil_hcompute_padded16_stencil_21 = padded16_stencil.padded16_stencil_all_inputs_to_all_outputs.read(grad_y_s0_x - -3, -1 + grad_y_s0_y - -3);
  return value_padded16_stencil_hcompute_padded16_stencil_21;
  return 0;
}
...
//	padded16_stencil_hcompute_grad_x_stencil_15
//	padded16_stencil_hcompute_grad_x_stencil_16
//	padded16_stencil_hcompute_grad_x_stencil_17
//	padded16_stencil_hcompute_grad_x_stencil_18
...
inline hw_uint<96> padded16_stencil_hcompute_grad_x_stencil_read_bundle_read(padded16_stencil_cache& padded16_stencil, int root, int grad_x_s0_y, int grad_x_s0_x, int dynamic_address) {
  // # of ports in bundle: 6
	...
	hw_uint<96> result;
	hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_15_res = padded16_stencil_hcompute_grad_x_stencil_15_select(padded16_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
	set_at<0, 96>(result, padded16_stencil_hcompute_grad_x_stencil_15_res);
	hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_16_res = padded16_stencil_hcompute_grad_x_stencil_16_select(padded16_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
	set_at<16, 96>(result, padded16_stencil_hcompute_grad_x_stencil_16_res);
	hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_17_res = padded16_stencil_hcompute_grad_x_stencil_17_select(padded16_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
	set_at<32, 96>(result, padded16_stencil_hcompute_grad_x_stencil_17_res);
	hw_uint<16> padded16_stencil_hcompute_grad_x_stencil_18_res = padded16_stencil_hcompute_grad_x_stencil_18_select(padded16_stencil, root, grad_x_s0_y, grad_x_s0_x, dynamic_address);
	set_at<48, 96>(result, padded16_stencil_hcompute_grad_x_stencil_18_res);
	...
	set_at<64, 96>(result, padded16_stencil_hcompute_grad_x_stencil_19_res);
	...
	set_at<80, 96>(result, padded16_stencil_hcompute_grad_x_stencil_20_res);
	return result;
}
...
//	padded16_stencil_hcompute_padded16_stencil_21
inline void padded16_stencil_hcompute_padded16_stencil_write_bundle_write(hw_uint<16>& hcompute_padded16_stencil_write, padded16_stencil_cache& padded16_stencil, int root, int padded16_s0_y, int padded16_s0_x, int dynamic_address) {
	hw_uint<16> padded16_stencil_hcompute_padded16_stencil_21_res = hcompute_padded16_stencil_write.extract<0, 15>();
	padded16_stencil_hcompute_padded16_stencil_21_write(padded16_stencil_hcompute_padded16_stencil_21_res, padded16_stencil, root, padded16_s0_y, padded16_s0_x, dynamic_address);
}
