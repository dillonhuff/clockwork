...
inline void lgxx_stencil_op_hcompute_lgxx_stencil_11_write(hw_uint<16>& lgxx_stencil_op_hcompute_lgxx_stencil_11, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.write(lgxx_stencil_op_hcompute_lgxx_stencil_11, lgxx_s0_y - -1, lgxx_s0_x - -1);
}
...
inline hw_uint<16> lgxx_stencil_op_hcompute_cim_stencil_60_select(lgxx_stencil_cache& lgxx_stencil, int root, int cim_s0_y, int cim_s0_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_op_hcompute_lgxx_stencil_11 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(cim_s0_y - -1, cim_s0_x - -1);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lgxx_stencil_op_hcompute_lgxx_stencil_1_13 read pattern: { op_hcompute_lgxx_stencil_1[root = 0, lgxx_s1_y, lgxx_s1_x] -> lgxx_stencil[lgxx_s1_y, lgxx_s1_x] : -1 <= lgxx_s1_y <= 58 and -1 <= lgxx_s1_x <= 58 }
  auto value_lgxx_stencil_op_hcompute_lgxx_stencil_11 = lgxx_stencil.lgxx_stencil_all_inputs_to_all_outputs.read(lgxx_s1_y - -1, lgxx_s1_x - -1);
  return value_lgxx_stencil_op_hcompute_lgxx_stencil_11;
  return 0;
}
...
inline void lgxy_stencil_op_hcompute_lgxy_stencil_33_write(hw_uint<16>& lgxy_stencil_op_hcompute_lgxy_stencil_33, lgxy_stencil_cache& lgxy_stencil, int root, int lgxy_s0_y, int lgxy_s0_x, int dynamic_address) {
  lgxy_stencil.lgxy_stencil_all_inputs_to_all_outputs.write(lgxy_stencil_op_hcompute_lgxy_stencil_33, lgxy_s0_y - -1, lgxy_s0_x - -1);
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lgxy_stencil_op_hcompute_lgxy_stencil_1_35 read pattern: { op_hcompute_lgxy_stencil_1[root = 0, lgxy_s1_y, lgxy_s1_x] -> lgxy_stencil[lgxy_s1_y, lgxy_s1_x] : -1 <= lgxy_s1_y <= 58 and -1 <= lgxy_s1_x <= 58 }
  auto value_lgxy_stencil_op_hcompute_lgxy_stencil_1_34 = lgxy_stencil.lgxy_stencil_all_inputs_to_all_outputs.read(lgxy_s1_y - -1, lgxy_s1_x - -1);
  return value_lgxy_stencil_op_hcompute_lgxy_stencil_1_34;
  return 0;
}
...
inline void lgyy_stencil_op_hcompute_lgyy_stencil_47_write(hw_uint<16>& lgyy_stencil_op_hcompute_lgyy_stencil_47, lgyy_stencil_cache& lgyy_stencil, int root, int lgyy_s0_y, int lgyy_s0_x, int dynamic_address) {
  lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.write(lgyy_stencil_op_hcompute_lgyy_stencil_47, lgyy_s0_y - -1, lgyy_s0_x - -1);
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // lgyy_stencil_op_hcompute_lgyy_stencil_1_49 read pattern: { op_hcompute_lgyy_stencil_1[root = 0, lgyy_s1_y, lgyy_s1_x] -> lgyy_stencil[lgyy_s1_y, lgyy_s1_x] : -1 <= lgyy_s1_y <= 58 and -1 <= lgyy_s1_x <= 58 }
  auto value_lgyy_stencil_op_hcompute_lgyy_stencil_1_48 = lgyy_stencil.lgyy_stencil_all_inputs_to_all_outputs.read(lgyy_s1_y - -1, lgyy_s1_x - -1);
  return value_lgyy_stencil_op_hcompute_lgyy_stencil_1_48;
  return 0;
}
