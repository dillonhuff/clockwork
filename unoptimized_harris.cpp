...
struct lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13_cache {
	// RAM Box: {[-1, 59], [-1, 59]}
	// Capacity: 3721
#ifdef __VIVADO_SYNTH__
  hw_uint<16> RAM[3721];
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3721);
  }
  ~lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13_cache() {
    free(RAM);
...
struct lgxx_stencil_cache {
  ...
  lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13_cache lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13;
};
...
inline void lgxx_stencil_hcompute_lgxx_stencil_11_write(hw_uint<16>& lgxx_stencil_hcompute_lgxx_stencil_11, lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s0_y, int lgxx_s0_x, int dynamic_address) {
  lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13.write(lgxx_stencil_hcompute_lgxx_stencil_11, (lgxx_s0_x - -1) * 1 + (lgxx_s0_y - -1) * 61);
}
...
inline hw_uint<16> lgxx_stencil_hcompute_lgxx_stencil_1_13_select(lgxx_stencil_cache& lgxx_stencil, int root, int lgxx_s1_y, int lgxx_s1_x, int dynamic_address) {
  ...
  auto value_lgxx_stencil_hcompute_lgxx_stencil_11 = lgxx_stencil.lgxx_stencil_hcompute_lgxx_stencil_11_to_lgxx_stencil_hcompute_lgxx_stencil_1_13.read(/*ram type address*/ (lgxx_s1_x - -1) * 1 + (lgxx_s1_y - -1) * 61);
