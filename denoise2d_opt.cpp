...
struct diff_d_diff_d_update_0_write0_merged_banks_1_cache {
  ...
  hw_uint<32>  read() { return 0; }

  void read(hw_uint<32> & value) { }
...
inline hw_uint<32>  g_rd0_select(diff_d_cache& diff_d, int d0, int d1) {
	// lexmax events: { g_update_0[d0, d1] -> diff_d_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
  // g_rd0 read pattern: { g_update_0[d0, d1] -> diff_d[d0, d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
	auto value_diff_d_diff_d_update_0_write0 = diff_d.diff_d_diff_d_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  g_rd0_select(diff_l_cache& diff_l, int d0, int d1) {
	// lexmax events: { g_update_0[d0, d1] -> diff_l_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
  // g_rd0 read pattern: { g_update_0[d0, d1] -> diff_l[d0, d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
	auto value_diff_l_diff_l_update_0_write0 = diff_l.diff_l_diff_l_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  g_rd0_select(diff_qwe_cache& diff_qwe, int d0, int d1) {
	// lexmax events: { g_update_0[d0, d1] -> diff_qwe_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
  // g_rd0 read pattern: { g_update_0[d0, d1] -> diff_qwe[d0, d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
	auto value_diff_qwe_diff_qwe_update_0_write0 = diff_qwe.diff_qwe_diff_qwe_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  g_rd0_select(diff_r_cache& diff_r, int d0, int d1) {
	// lexmax events: { g_update_0[d0, d1] -> diff_r_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
  // g_rd0 read pattern: { g_update_0[d0, d1] -> diff_r[d0, d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
	auto value_diff_r_diff_r_update_0_write0 = diff_r.diff_r_diff_r_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  denoise2d_rd0_select(f_cache& f, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> f_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  r0_rd0_select(f_cache& f, int d0, int d1) {
	// lexmax events: { r0_update_0[d0, d1] -> f_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  denoise2d_rd0_select(g_cache& g, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> g_update_0[d0' = -1 + d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  denoise2d_rd1_select(g_cache& g, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> g_update_0[d0' = d0, d1' = -1 + d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  r1_rd0_select(r0_cache& r0, int d0, int d1) {
	// lexmax events: { r1_update_0[d0, d1] -> r0_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // r1_rd0 read pattern: { r1_update_0[d0, d1] -> r0[d0, d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
	auto value_r0_r0_update_0_write0 = r0.r0_r0_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  denoise2d_rd0_select(r1_cache& r1, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> r1_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // denoise2d_rd0 read pattern: { denoise2d_update_0[d0, d1] -> r1[d0, d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
	auto value_r1_r1_update_0_write0 = r1.r1_r1_update_0_write0_merged_banks_1.peek_0();
...
inline hw_uint<32>  denoise2d_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> u_update_0[d0' = -1 + d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  denoise2d_rd1_select(u_cache& u, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = -1 + d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  denoise2d_rd2_select(u_cache& u, int d0, int d1) {
	// lexmax events: { denoise2d_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<32>  diff_d_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_d_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_d_rd1_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_d_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = 1 + d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_l_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_l_update_0[d0, d1] -> u_update_0[d0' = -1 + d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_l_rd1_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_l_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_qwe_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_qwe_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = -1 + d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_qwe_rd1_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_qwe_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_r_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_r_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  diff_r_rd1_select(u_cache& u, int d0, int d1) {
	// lexmax events: { diff_r_update_0[d0, d1] -> u_update_0[d0' = 1 + d0, d1' = d1] : -1 <= d0 <= 30 and -1 <= d1 <= 30 }
...
inline hw_uint<32>  r0_rd0_select(u_cache& u, int d0, int d1) {
	// lexmax events: { r0_update_0[d0, d1] -> u_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
