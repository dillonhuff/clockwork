...
struct grad_x_grad_x_update_0_write1_to_harris_2_rd0_cache {
	// RAM Box: {[-1, -1], [0, 0]}
	// Capacity: 3
	// # of read delays: 2
  // 0, 2
...
struct grad_x_grad_x_update_0_write1_to_harris_2_rd2_cache {
	// RAM Box: {[1, 1], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct grad_x_grad_x_update_0_write0_to_harris_2_rd3_cache {
	// RAM Box: {[0, 0], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct grad_x_grad_x_update_0_write1_to_harris_2_rd4_cache {
	// RAM Box: {[1, 1], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct grad_x_grad_x_update_0_write0_to_harris_2_rd5_cache {
	// RAM Box: {[2, 2], [0, 0]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct grad_x_cache {
  // Reader addrs...
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[-1, 0] }
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[0, 0] }
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[1, 0] }
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[0, 0] }
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[1, 0] }
    // { harris_2_update_0[d0 = 0, d1 = 0] -> grad_x[2, 0] }
  // # of banks: 6
  grad_x_grad_x_update_0_write1_to_harris_2_rd0_cache grad_x_grad_x_update_0_write1_to_harris_2_rd0;
  grad_x_grad_x_update_0_write0_to_harris_2_rd1_cache grad_x_grad_x_update_0_write0_to_harris_2_rd1;
  grad_x_grad_x_update_0_write1_to_harris_2_rd2_cache grad_x_grad_x_update_0_write1_to_harris_2_rd2;
  grad_x_grad_x_update_0_write0_to_harris_2_rd3_cache grad_x_grad_x_update_0_write0_to_harris_2_rd3;
  grad_x_grad_x_update_0_write1_to_harris_2_rd4_cache grad_x_grad_x_update_0_write1_to_harris_2_rd4;
  grad_x_grad_x_update_0_write0_to_harris_2_rd5_cache grad_x_grad_x_update_0_write0_to_harris_2_rd5;
};
...
inline void grad_x_grad_x_update_0_write0_write(hw_uint<16>& grad_x_grad_x_update_0_write0, grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  grad_x.grad_x_grad_x_update_0_write0_to_harris_2_rd3.push(grad_x_grad_x_update_0_write0);
  grad_x.grad_x_grad_x_update_0_write0_to_harris_2_rd5.push(grad_x_grad_x_update_0_write0);
}
...
inline void grad_x_grad_x_update_0_write1_write(hw_uint<16>& grad_x_grad_x_update_0_write1, grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd0.push(grad_x_grad_x_update_0_write1);
  grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd2.push(grad_x_grad_x_update_0_write1);
  grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd4.push(grad_x_grad_x_update_0_write1);
}
...
inline hw_uint<16> harris_2_rd0_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  auto value_grad_x_grad_x_update_0_write1 = grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd0.peek(/* one reader or all rams */ 2);
...
inline hw_uint<16> harris_2_rd1_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
  // Write schedule: { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  auto value_grad_x_grad_x_update_0_write0 = grad_x.grad_x_grad_x_update_0_write0_to_harris_2_rd1.peek(/* one reader or all rams */ 1);
...
inline hw_uint<16> harris_2_rd2_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
  // Write schedule: { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  auto value_grad_x_grad_x_update_0_write1 = grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd2.peek(/* one reader or all rams */ 1);
  return value_grad_x_grad_x_update_0_write1;
  return 0;
}
...
inline hw_uint<16> harris_2_rd3_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
  // Write schedule: { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  auto value_grad_x_grad_x_update_0_write0 = grad_x.grad_x_grad_x_update_0_write0_to_harris_2_rd3.peek(/* one reader or all rams */ 1);
  return value_grad_x_grad_x_update_0_write0;
  return 0;
}
...
inline hw_uint<16> harris_2_rd4_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
  // Write schedule: { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  auto value_grad_x_grad_x_update_0_write1 = grad_x.grad_x_grad_x_update_0_write1_to_harris_2_rd4.peek(/* one reader or all rams */ 1);
  return value_grad_x_grad_x_update_0_write1;
  return 0;
}
...
inline hw_uint<16> harris_2_rd5_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
  // Write schedule: { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  auto value_grad_x_grad_x_update_0_write0 = grad_x.grad_x_grad_x_update_0_write0_to_harris_2_rd5.peek(/* one reader or all rams */ 0);
  return value_grad_x_grad_x_update_0_write0;
  return 0;
}
...
struct img_img_update_0_write1_to_grad_x_rd0_cache {
	// RAM Box: {[-3, 1], [0, 0]}
	// Capacity: 3
	// # of read delays: 2
  // 0, 2
...
struct img_img_update_0_write1_to_grad_x_rd2_cache {
	// RAM Box: {[-1, 3], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct img_img_update_0_write0_to_grad_x_rd3_cache {
	// RAM Box: {[-2, 2], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct img_img_update_0_write1_to_grad_x_rd4_cache {
	// RAM Box: {[-1, 3], [0, 0]}
	// Capacity: 2
	// # of read delays: 2
  // 0, 1
...
struct img_img_update_0_write0_to_grad_x_rd5_cache {
	// RAM Box: {[0, 4], [0, 0]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct img_cache {
  // Reader addrs...
    // { grad_x_update_0[d0, d1 = 0] -> img[-1 + 2d0, 0] : -1 <= d0 <= 1 }
    // { grad_x_update_0[d0, d1 = 0] -> img[2d0, 0] : -1 <= d0 <= 1 }
    // { grad_x_update_0[d0, d1 = 0] -> img[1 + 2d0, 0] : -1 <= d0 <= 1 }
    // { grad_x_update_0[d0, d1 = 0] -> img[2d0, 0] : -1 <= d0 <= 1 }
    // { grad_x_update_0[d0, d1 = 0] -> img[1 + 2d0, 0] : -1 <= d0 <= 1 }
    // { grad_x_update_0[d0, d1 = 0] -> img[2 + 2d0, 0] : -1 <= d0 <= 1 }
  // # of banks: 6
  img_img_update_0_write1_to_grad_x_rd0_cache img_img_update_0_write1_to_grad_x_rd0;
  img_img_update_0_write0_to_grad_x_rd1_cache img_img_update_0_write0_to_grad_x_rd1;
  img_img_update_0_write1_to_grad_x_rd2_cache img_img_update_0_write1_to_grad_x_rd2;
  img_img_update_0_write0_to_grad_x_rd3_cache img_img_update_0_write0_to_grad_x_rd3;
  img_img_update_0_write1_to_grad_x_rd4_cache img_img_update_0_write1_to_grad_x_rd4;
  img_img_update_0_write0_to_grad_x_rd5_cache img_img_update_0_write0_to_grad_x_rd5;
};
...
inline void img_img_update_0_write0_write(hw_uint<16>& img_img_update_0_write0, img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  img.img_img_update_0_write0_to_grad_x_rd3.push(img_img_update_0_write0);
  img.img_img_update_0_write0_to_grad_x_rd5.push(img_img_update_0_write0);
}
...
inline void img_img_update_0_write1_write(hw_uint<16>& img_img_update_0_write1, img_cache& img, int d0, int d1, int dynamic_address) {
  img.img_img_update_0_write1_to_grad_x_rd0.push(img_img_update_0_write1);
  img.img_img_update_0_write1_to_grad_x_rd2.push(img_img_update_0_write1);
  img.img_img_update_0_write1_to_grad_x_rd4.push(img_img_update_0_write1);
}
...
inline hw_uint<16> grad_x_rd0_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  auto value_img_img_update_0_write1 = img.img_img_update_0_write1_to_grad_x_rd0.peek(/* one reader or all rams */ 2);
...
inline hw_uint<16> grad_x_rd1_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  // Write schedule: { img_update_0[d0, d1 = 0] -> [0, d0, 1] : -2 <= d0 <= 2 }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_to_grad_x_rd1.peek(/* one reader or all rams */ 1);
...
inline hw_uint<16> grad_x_rd2_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  // Write schedule: { img_update_0[d0, d1 = 0] -> [0, d0, 1] : -2 <= d0 <= 2 }
  auto value_img_img_update_0_write1 = img.img_img_update_0_write1_to_grad_x_rd2.peek(/* one reader or all rams */ 1);
  return value_img_img_update_0_write1;
  return 0;
}
...
inline hw_uint<16> grad_x_rd3_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  // Write schedule: { img_update_0[d0, d1 = 0] -> [0, d0, 1] : -2 <= d0 <= 2 }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_to_grad_x_rd3.peek(/* one reader or all rams */ 1);
  return value_img_img_update_0_write0;
  return 0;
}
...
inline hw_uint<16> grad_x_rd4_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  // Write schedule: { img_update_0[d0, d1 = 0] -> [0, d0, 1] : -2 <= d0 <= 2 }
  auto value_img_img_update_0_write1 = img.img_img_update_0_write1_to_grad_x_rd4.peek(/* one reader or all rams */ 1);
  return value_img_img_update_0_write1;
  return 0;
}
...
inline hw_uint<16> grad_x_rd5_select(img_cache& img, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
  // Write schedule: { img_update_0[d0, d1 = 0] -> [0, d0, 1] : -2 <= d0 <= 2 }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_to_grad_x_rd5.peek(/* one reader or all rams */ 0);
  return value_img_img_update_0_write0;
  return 0;
}
...
inline void img_update_0(HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */img_oc, img_cache& img, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = img_generated_compute_unrolled_2(img_oc_1_m_img_1__p__0_c__1_m_img_0__p__0_value);
	// Produce: img
...
inline void grad_x_update_0(img_cache& img, grad_x_cache& grad_x, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = grad_x_generated_compute_unrolled_2(img_1_m_grad_x_1__p___m_1_c__1_m_grad_x_0__p__0_value);
	// Produce: grad_x
...
inline void harris_2_update_0(grad_x_cache& grad_x, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */harris_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto compute_result = harris_2_generated_compute_unrolled_2(grad_x_1_m_harris_2_1__p___m_1_c__1_m_harris_2_0__p__0_value);
	// Produce: harris_2
...
// Condition for img_update_0(((((-1 + 1*i2)) == 0) && (((1*i0)) == 0) && (((2 + 1*i1)) >= 0) && (((2 + -1*i1)) >= 0)))
//   { grad_x_update_0[d0, d1 = 0] -> [0, 1 + d0, 2] : -1 <= d0 <= 1 }
// Condition for grad_x_update_0(((((-2 + 1*i2)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((2 + -1*i1)) >= 0)))
//   { harris_2_update_0[d0 = 0, d1 = 0] -> [0, 2, 3] }
// Condition for harris_2_update_0(((((-3 + 1*i2)) == 0) && (((-2 + 1*i1)) == 0) && (((1*i0)) == 0)))
...
const int harris_2_update_0_write_pipe0_num_transfers = 1;
  // { img_update_0[root = 0, img_0 = 0, img_1] -> img_oc[img_1, 0] : -2 <= img_1 <= 2 }
