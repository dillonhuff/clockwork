...
#include "hw_classes.h"
  ...
  // bank_I_I_id0_8_to_I_out_0_blur_30_5
  // bank_I_I_id0_8_to_I_out_0_blur_30_6
  // bank_I_I_id0_8_to_I_out_0_blur_30_7
  // bank_I_I_id0_8_to_I_out_1_blur_31_1
  // bank_I_I_id0_8_to_I_out_1_blur_31_2
  // bank_I_I_id0_8_to_I_out_1_blur_31_3
  // bank_I_I_id1_10_to_I_out_0_blur_30_5
  // bank_I_I_id1_10_to_I_out_0_blur_30_6
  // bank_I_I_id1_10_to_I_out_0_blur_30_7
  // bank_I_I_id1_10_to_I_out_1_blur_31_1
  // bank_I_I_id1_10_to_I_out_1_blur_31_2
  // bank_I_I_id1_10_to_I_out_1_blur_31_3
...
inline hw_uint<16> I_out_0_blur_30_5_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id0_8 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
  ...
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_I_id0_8 = I.I_I_id0_8.peek_32();
...
inline hw_uint<16> I_out_0_blur_30_6_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_I_id0_8 = I.I_I_id0_8.peek_16();
	return value_I_I_id0_8;
}
...
inline hw_uint<16> I_out_0_blur_30_7_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
    // overlap with reads : {  }
	auto value_I_I_id0_8 = I.I_I_id0_8.peek_0();
	return value_I_I_id0_8;
}
