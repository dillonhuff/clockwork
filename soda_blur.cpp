...
// Operation logic
inline void I_id1(HWStream<hw_uint<16> >& in_1, I_I_id0_6_cache& I_I_id0_6, I_I_id1_0_cache& I_I_id1_0, int root, int ir, int ic) {
	// Consume: in_1
...
inline void out_1_blur_31(I_I_id0_6_cache& I_I_id0_6, I_I_id1_0_cache& I_I_id1_0, HWStream<hw_uint<16> >& out_1, int root, int xr, int xc) {
	// Consume: I
...
inline void I_id0(HWStream<hw_uint<16> >& in_0, I_I_id0_6_cache& I_I_id0_6, I_I_id1_0_cache& I_I_id1_0, int root, int ir, int ic) {
	// Consume: in_0
...
inline void out_0_blur_30(I_I_id0_6_cache& I_I_id0_6, I_I_id1_0_cache& I_I_id1_0, HWStream<hw_uint<16> >& out_0, int root, int xr, int xc) {
	// Consume: I
