...
struct I_I_id0_0_to_I_out_1_blur_31_8_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_1_blur_31_8_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_0_blur_30_3_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_0_blur_30_3_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_0_blur_30_4_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_0_blur_30_4_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_0_blur_30_5_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_0_blur_30_5_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_1_blur_31_7_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 32) capacity = 31
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_1_blur_31_7_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_1_blur_31_8_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 16) capacity = 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_1_blur_31_8_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_10_to_I_out_1_blur_31_9_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_to_I_out_1_blur_31_9_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_10_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
