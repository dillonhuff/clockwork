...
struct I_I_id0_6_to_I_out_1_blur_31_4_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_6_to_I_out_1_blur_31_4_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id0_6_to_I_out_1_blur_31_5_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_6_to_I_out_1_blur_31_5_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_0_blur_30_10_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_0_blur_30_10_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_0_blur_30_11_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_0_blur_30_11_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_0_blur_30_9_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_0_blur_30_9_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_3_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 32) capacity = 31
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_3_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_4_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 16) capacity = 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_4_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_5_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_5_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  ...
  I_I_id0_6_to_I_out_1_blur_31_4_cache bank_I_I_id0_6_to_I_out_1_blur_31_4;
  I_I_id0_6_to_I_out_1_blur_31_5_cache bank_I_I_id0_6_to_I_out_1_blur_31_5;
  I_I_id1_0_to_I_out_0_blur_30_10_cache bank_I_I_id1_0_to_I_out_0_blur_30_10;
  I_I_id1_0_to_I_out_0_blur_30_11_cache bank_I_I_id1_0_to_I_out_0_blur_30_11;
  I_I_id1_0_to_I_out_0_blur_30_9_cache bank_I_I_id1_0_to_I_out_0_blur_30_9;
  I_I_id1_0_to_I_out_1_blur_31_3_cache bank_I_I_id1_0_to_I_out_1_blur_31_3;
  I_I_id1_0_to_I_out_1_blur_31_4_cache bank_I_I_id1_0_to_I_out_1_blur_31_4;
  I_I_id1_0_to_I_out_1_blur_31_5_cache bank_I_I_id1_0_to_I_out_1_blur_31_5;
};
...
inline void I_I_id0_6_write(hw_uint<16>& I_I_id0_6, I_cache& I, int root, int ir, int ic) {
  ...
  I.bank_I_I_id0_6_to_I_out_1_blur_31_4.push(I_I_id0_6);
  I.bank_I_I_id0_6_to_I_out_1_blur_31_5.push(I_I_id0_6);
}

inline void I_I_id1_0_write(hw_uint<16>& I_I_id1_0, I_cache& I, int root, int ir, int ic) {
  I.bank_I_I_id1_0_to_I_out_0_blur_30_10.push(I_I_id1_0);
  I.bank_I_I_id1_0_to_I_out_0_blur_30_11.push(I_I_id1_0);
  I.bank_I_I_id1_0_to_I_out_0_blur_30_9.push(I_I_id1_0);
  I.bank_I_I_id1_0_to_I_out_1_blur_31_3.push(I_I_id1_0);
  I.bank_I_I_id1_0_to_I_out_1_blur_31_4.push(I_I_id1_0);
  I.bank_I_I_id1_0_to_I_out_1_blur_31_5.push(I_I_id1_0);
}
...
inline hw_uint<16> I_out_1_blur_31_3_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id1_0 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
	...
	auto value_I_I_id1_0 = I.bank_I_I_id1_0_to_I_out_1_blur_31_3.peek_32();
...
inline hw_uint<16> I_out_1_blur_31_4_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id1_0 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
	...
	auto value_I_I_id1_0 = I.bank_I_I_id1_0_to_I_out_1_blur_31_4.peek_16();
	return value_I_I_id1_0;
}
...
inline hw_uint<16> I_out_1_blur_31_5_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_I_id1_0 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
	...
	auto value_I_I_id1_0 = I.bank_I_I_id1_0_to_I_out_1_blur_31_5.peek_0();
	return value_I_I_id1_0;
}
...
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_cache& I, int root, int ir, int ic) {
	...
	I_I_id1_0_write(I_I_id1_0_res, I, root, ir, ic);
}
...
inline hw_uint<48> I_out_1_blur_31_read_bundle_read(I_cache& I, int root, int xr, int xc) {
	...
	set_at<0, 48>(result, I_out_1_blur_31_3_res);
	hw_uint<16> I_out_1_blur_31_4_res = I_out_1_blur_31_4_select(I, root, xr, xc);
	set_at<16, 48>(result, I_out_1_blur_31_4_res);
	hw_uint<16> I_out_1_blur_31_5_res = I_out_1_blur_31_5_select(I, root, xr, xc);
	set_at<32, 48>(result, I_out_1_blur_31_5_res);
	return result;
}
