...
inline hw_uint<16> I_out_1_blur_31_7_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_7read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
...
inline hw_uint<16> I_out_1_blur_31_8_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_8read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[1 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
...
inline hw_uint<16> I_out_1_blur_31_9_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_9read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[2 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_10 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
