...
inline hw_uint<16> I_out_0_blur_30_7_select(I_I_id0_4_cache& I_I_id0_4_delay
...
inline hw_uint<16> I_out_0_blur_30_8_select(I_I_id0_4_cache& I_I_id0_4_delay
, I_I_id1_10_cache& I_I_id1_10_delay
, int root, int xr, int xc) {
...
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_I_id1_10_cache& I_I_id1_10_delay) {
	...
	I_I_id1_10_write(I_I_id1_10_res, I_I_id1_10_delay);
}
...
inline hw_uint<48> I_out_0_blur_30_read_bundle_read(I_I_id0_4_cache& I_I_id0_4_delay, I_I_id1_10_cache& I_I_id1_10_delay, int root, int xr, int xc) {
	hw_uint<48> result;
	hw_uint<16> I_out_0_blur_30_7_res = I_out_0_blur_30_7_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
	set_at<0, 48>(result, I_out_0_blur_30_7_res);
	hw_uint<16> I_out_0_blur_30_8_res = I_out_0_blur_30_8_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
	set_at<16, 48>(result, I_out_0_blur_30_8_res);
	hw_uint<16> I_out_0_blur_30_9_res = I_out_0_blur_30_9_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
...
inline hw_uint<48> I_out_1_blur_31_read_bundle_read(I_I_id0_4_cache& I_I_id0_4_delay, I_I_id1_10_cache& I_I_id1_10_delay, int root, int xr, int xc) {
	hw_uint<48> result;
	hw_uint<16> I_out_1_blur_31_1_res = I_out_1_blur_31_1_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
	set_at<0, 48>(result, I_out_1_blur_31_1_res);
	hw_uint<16> I_out_1_blur_31_2_res = I_out_1_blur_31_2_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
	set_at<16, 48>(result, I_out_1_blur_31_2_res);
	hw_uint<16> I_out_1_blur_31_3_res = I_out_1_blur_31_3_select(I_I_id0_4_delay, I_I_id1_10_delay, root, xr, xc);
...
// Operation logic
inline void out_1_blur_31(I_I_id0_4_cache& I_I_id0_4, I_I_id1_10_cache& I_I_id1_10, HWStream<hw_uint<16> >& /* num ports = 1 */out_1, int root, int xr, int xc) {
	// Consume: I
...
inline void I_id0(HWStream<hw_uint<16> >& /* num ports = 1 */in_0, I_I_id0_4_cache& I_I_id0_4, I_I_id1_10_cache& I_I_id1_10, int root, int ir, int ic) {
	// Consume: in_0
...
inline void out_0_blur_30(I_I_id0_4_cache& I_I_id0_4, I_I_id1_10_cache& I_I_id1_10, HWStream<hw_uint<16> >& /* num ports = 1 */out_0, int root, int xr, int xc) {
	// Consume: I
...
inline void I_id1(HWStream<hw_uint<16> >& /* num ports = 1 */in_1, I_I_id0_4_cache& I_I_id0_4, I_I_id1_10_cache& I_I_id1_10, int root, int ir, int ic) {
	// Consume: in_1
	auto in_1_ir_c__ic_value = in_1.read();
	auto compute_result = id(in_1_ir_c__ic_value);
	// Produce: I
	I_I_id1_write_bundle_write(compute_result, I_I_id1_10);
}
