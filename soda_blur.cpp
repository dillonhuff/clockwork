...
inline hw_uint<16> I_out_0_blur_30_6_select(I_I_id0_10_cache& I_I_id0_10_delay
, I_I_id1_8_cache& I_I_id1_8_delay
, int root, int xr, int xc) {
...
inline hw_uint<16> I_out_1_blur_31_1_select(I_I_id0_10_cache& I_I_id0_10_delay
, I_I_id1_8_cache& I_I_id1_8_delay
, int root, int xr, int xc) {
...
//	No key for: I_I_id0_10
	// inpt: I_I_id1_8
	// k = I_id1
	int value_I_I_id1_8 = I_I_id1_8_delay.peek_32();
...
inline hw_uint<16> I_out_1_blur_31_2_select(I_I_id0_10_cache& I_I_id0_10_delay
, I_I_id1_8_cache& I_I_id1_8_delay
, int root, int xr, int xc) {
...
//	No key for: I_I_id0_10
	// inpt: I_I_id1_8
	// k = I_id1
	int value_I_I_id1_8 = I_I_id1_8_delay.peek_16();
	if (select_I_id1) { return value_I_I_id1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
	assert(false);
	return 0;
...
//	No key for: I_I_id0_10
	// inpt: I_I_id1_8
	// k = I_id1
	int value_I_I_id1_8 = I_I_id1_8_delay.peek_0();
	if (select_I_id1) { return value_I_I_id1_8; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
	assert(false);
	return 0;
...
// I_id1_write
//	I_I_id1_8
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_I_id1_8_cache& I_I_id1_8_delay) {
...
inline hw_uint<48> I_out_0_blur_30_read_bundle_read(I_I_id0_10_cache& I_I_id0_10_delay, I_I_id1_8_cache& I_I_id1_8_delay, int root, int xr, int xc) {
	hw_uint<48> result;
	hw_uint<16> I_out_0_blur_30_5_res = I_out_0_blur_30_5_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
	set_at<0, 48>(result, I_out_0_blur_30_5_res);
	hw_uint<16> I_out_0_blur_30_6_res = I_out_0_blur_30_6_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
	set_at<16, 48>(result, I_out_0_blur_30_6_res);
	hw_uint<16> I_out_0_blur_30_7_res = I_out_0_blur_30_7_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
...
inline hw_uint<48> I_out_1_blur_31_read_bundle_read(I_I_id0_10_cache& I_I_id0_10_delay, I_I_id1_8_cache& I_I_id1_8_delay, int root, int xr, int xc) {
	hw_uint<48> result;
	hw_uint<16> I_out_1_blur_31_1_res = I_out_1_blur_31_1_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
	set_at<0, 48>(result, I_out_1_blur_31_1_res);
	hw_uint<16> I_out_1_blur_31_2_res = I_out_1_blur_31_2_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
	set_at<16, 48>(result, I_out_1_blur_31_2_res);
	hw_uint<16> I_out_1_blur_31_3_res = I_out_1_blur_31_3_select(I_I_id0_10_delay, I_I_id1_8_delay, root, xr, xc);
