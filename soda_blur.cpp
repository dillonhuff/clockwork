...
inline void I_I_id0_4_write(hw_uint<16>& I_I_id0_4, I_cache& I) {
	I.I_I_id0_4.push(I_I_id0_4);
}

inline void I_I_id1_6_write(hw_uint<16>& I_I_id1_6, I_cache& I) {
...
inline hw_uint<16> I_out_0_blur_30_10_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_10read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[1 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  ...
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
	...
	auto value_I_I_id0_4 = I.I_I_id0_4.peek_16();
...
inline hw_uint<16> I_out_0_blur_30_11_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_11read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[2 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : (i1) mod 2 = 0 and 2 <= i0 <= 31 and 0 <= i1 <= 30 }
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_I_id0_4 = I.I_I_id0_4.peek_0();
	return value_I_I_id0_4;
}
...
inline hw_uint<16> I_out_0_blur_30_9_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_9read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 29 and 0 <= i1 <= 30 }
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
    // overlap with reads : { I[i0, i1] : false }
	auto value_I_I_id0_4 = I.I_I_id0_4.peek_32();
	return value_I_I_id0_4;
}
...
inline hw_uint<16> I_out_1_blur_31_1_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_1read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
...
inline hw_uint<16> I_out_1_blur_31_2_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_2read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[1 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
...
inline hw_uint<16> I_out_1_blur_31_3_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_3read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[2 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_I_id0_4 stores range: { I[i0, i1] : (i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 <= i1 <= 30 }
    // overlap with reads : { I[i0, i1] : false }
  // I_I_id1_6 stores range: { I[i0, i1] : (1 + i1) mod 2 = 0 and 0 <= i0 <= 31 and 0 < i1 <= 31 }
...
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_cache& I) {
	...
	I_I_id1_6_write(I_I_id1_6_res, I);
}
