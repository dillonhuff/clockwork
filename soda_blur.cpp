...
//	No key for: I_I_id0_0
	// inpt: I_I_id1_2
	// k = I_id1
	int value_I_I_id1_2 = I_I_id1_2_delay.peek_16();
...
//	No key for: I_I_id0_0
	// inpt: I_I_id1_2
	// k = I_id1
	int value_I_I_id1_2 = I_I_id1_2_delay.peek_0();
	if (select_I_id1) { return value_I_I_id1_2; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
	assert(false);
	return 0;
...
//	No key for: I_I_id0_0
	// inpt: I_I_id1_2
	// k = I_id1
	int value_I_I_id1_2 = I_I_id1_2_delay.peek_32();
	if (select_I_id1) { return value_I_I_id1_2; }
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
	assert(false);
	return 0;
...
// I_id1_write
//	I_I_id1_2
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_I_id1_2_cache& I_I_id1_2_delay) {
...
// Operation logic
inline void I_id0(HWStream<hw_uint<16> >& /* num ports = 1 */in_0, I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, int root, int ir, int ic) {
	// Consume: in_0
...
inline void I_id1(HWStream<hw_uint<16> >& /* num ports = 1 */in_1, I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, int root, int ir, int ic) {
	// Consume: in_1
...
inline void out_0_blur_30(I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, HWStream<hw_uint<16> >& /* num ports = 1 */out_0, int root, int xr, int xc) {
	// Consume: I
...
inline void out_1_blur_31(I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, HWStream<hw_uint<16> >& /* num ports = 1 */out_1, int root, int xr, int xc) {
	// Consume: I
	...
	I_I_id1_2_cache I_I_id1_2;
	{
	  for (int c1 = 0; c1 <= 31; c1 += 1)
	    for (int c2 = 0; c2 <= 15; c2 += 1) {
	      I_id0(in_0, I_I_id0_0, I_I_id1_2, 0, c1, c2);
	      if (c1 >= 2)
	        out_0_blur_30(I_I_id0_0, I_I_id1_2, out_0, 0, c1 - 2, c2);
	    }
	  for (int c1 = 0; c1 <= 31; c1 += 1)
	    for (int c2 = 0; c2 <= 15; c2 += 1) {
	      I_id1(in_1, I_I_id0_0, I_I_id1_2, 0, c1, c2);
	      if (c1 >= 2)
	        out_1_blur_31(I_I_id0_0, I_I_id1_2, out_1, 0, c1 - 2, c2);
	    }
	}
