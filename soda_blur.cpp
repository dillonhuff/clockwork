...
-1*xc + 15 >= 0));
	// inpt: I_I_id0_8
	int value_I_I_id0_8 = I_I_id0_8_delay.peek(((root == 0 && xr >= 0 && 29 - xr >= 0 && -1 + xc >= 0 && 14 - xc >= 0) ? (32) : (-15 + xc == 0 && root == 0 && xr >= 0 && 29 - xr >= 0) ? ((17 + xc)) : (xc == 0 && root == 0 && xr >= 0 && 29 - xr >= 0) ? (32) : 0));
...
-1*xc + 15 >= 0));
	// inpt: I_I_id0_8
	int value_I_I_id0_8 = I_I_id0_8_delay.peek(((root == 0 && xr >= 0 && 29 - xr >= 0 && -1 + xc >= 0 && 14 - xc >= 0) ? (16) : (-15 + xc == 0 && root == 0 && xr >= 0 && 29 - xr >= 0) ? ((1 + xc)) : (xc == 0 && root == 0 && xr >= 0 && 29 - xr >= 0) ? (16) : 0));
	if (select_I_id0) { return value_I_I_id0_8; }
	// inpt: I_I_id1_10
//	No key for: I_I_id1_10
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
...
-1*xc + 15 >= 0));
	// inpt: I_I_id0_8
	int value_I_I_id0_8 = I_I_id0_8_delay.peek((0));
	if (select_I_id0) { return value_I_I_id0_8; }
	// inpt: I_I_id1_10
//	No key for: I_I_id1_10
	cout << "Error: Unsupported offsets: " << " root = " << root  << " xr = " << xr  << " xc = " << xc  << endl;
...
// I_id0_write
//	I_I_id0_8
inline void I_I_id0_write_bundle_write(hw_uint<16>& /* width = 16*/I_id0_write, I_I_id0_8_cache& I_I_id0_8_delay) {
