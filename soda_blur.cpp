...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_10_to_I_out_0_blur_30_6: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_10_to_I_out_0_blur_30_7: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_8_to_I_out_1_blur_31_1: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_8_to_I_out_1_blur_31_2: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_8_to_I_out_1_blur_31_3: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  ...
  I_I_id0_10_to_I_out_0_blur_30_6_cache I_I_id0_10_to_I_out_0_blur_30_6;
  I_I_id0_10_to_I_out_0_blur_30_7_cache I_I_id0_10_to_I_out_0_blur_30_7;
  I_I_id1_8_to_I_out_1_blur_31_1_cache I_I_id1_8_to_I_out_1_blur_31_1;
  I_I_id1_8_to_I_out_1_blur_31_2_cache I_I_id1_8_to_I_out_1_blur_31_2;
  I_I_id1_8_to_I_out_1_blur_31_3_cache I_I_id1_8_to_I_out_1_blur_31_3;
};
...
inline void I_I_id0_10_write(hw_uint<16>& I_I_id0_10, I_cache& I, int root, int ir, int ic) {
  ...
  I.I_I_id0_10_to_I_out_0_blur_30_6.push(I_I_id0_10);
  I.I_I_id0_10_to_I_out_0_blur_30_7.push(I_I_id0_10);
}

inline void I_I_id1_8_write(hw_uint<16>& I_I_id1_8, I_cache& I, int root, int ir, int ic) {
  I.I_I_id1_8_to_I_out_1_blur_31_1.push(I_I_id1_8);
  I.I_I_id1_8_to_I_out_1_blur_31_2.push(I_I_id1_8);
  I.I_I_id1_8_to_I_out_1_blur_31_3.push(I_I_id1_8);
}
...
inline hw_uint<16> I_out_0_blur_30_5_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_5 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_5.peek_32();
...
inline hw_uint<16> I_out_0_blur_30_6_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_6 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[1 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_6.peek_16();
	return value_I_I_id0_10;
}
...
inline hw_uint<16> I_out_0_blur_30_7_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_7 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[2 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_7.peek_0();
	return value_I_I_id0_10;
}
...
inline hw_uint<16> I_out_1_blur_31_1_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_1 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_8 = I.I_I_id1_8_to_I_out_1_blur_31_1.peek_32();
...
inline hw_uint<16> I_out_1_blur_31_2_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_2 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[1 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_8 = I.I_I_id1_8_to_I_out_1_blur_31_2.peek_16();
	return value_I_I_id1_8;
}
...
inline hw_uint<16> I_out_1_blur_31_3_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_3 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[2 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_8 = I.I_I_id1_8_to_I_out_1_blur_31_3.peek_0();
	return value_I_I_id1_8;
}
