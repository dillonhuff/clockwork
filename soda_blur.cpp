...
struct I_cache {
  I_I_id0_6_to_I_out_0_blur_30_10_cache I_I_id0_6_to_I_out_0_blur_30_10_cache;
  I_I_id0_6_to_I_out_0_blur_30_11_cache I_I_id0_6_to_I_out_0_blur_30_11_cache;
  I_I_id0_6_to_I_out_0_blur_30_9_cache I_I_id0_6_to_I_out_0_blur_30_9_cache;
  I_I_id1_4_to_I_out_1_blur_31_1_cache I_I_id1_4_to_I_out_1_blur_31_1_cache;
  I_I_id1_4_to_I_out_1_blur_31_2_cache I_I_id1_4_to_I_out_1_blur_31_2_cache;
  I_I_id1_4_to_I_out_1_blur_31_3_cache I_I_id1_4_to_I_out_1_blur_31_3_cache;
};



inline void I_I_id0_6_write(hw_uint<16>& I_I_id0_6, I_cache& I, int root, int ir, int ic) {
  I.I_I_id0_6_to_I_out_0_blur_30_10_cache.push(I_I_id0_6);
  I.I_I_id0_6_to_I_out_0_blur_30_11_cache.push(I_I_id0_6);
  I.I_I_id0_6_to_I_out_0_blur_30_9_cache.push(I_I_id0_6);
}

inline void I_I_id1_4_write(hw_uint<16>& I_I_id1_4, I_cache& I, int root, int ir, int ic) {
  I.I_I_id1_4_to_I_out_1_blur_31_1_cache.push(I_I_id1_4);
  I.I_I_id1_4_to_I_out_1_blur_31_2_cache.push(I_I_id1_4);
  I.I_I_id1_4_to_I_out_1_blur_31_3_cache.push(I_I_id1_4);
}
...
inline hw_uint<16> I_out_0_blur_30_10_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_10 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[1 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_6 = I.I_I_id0_6_to_I_out_0_blur_30_10_cache.peek_16();
...
inline hw_uint<16> I_out_0_blur_30_11_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_11 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[2 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_6 = I.I_I_id0_6_to_I_out_0_blur_30_11_cache.peek_0();
	return value_I_I_id0_6;
}
...
inline hw_uint<16> I_out_0_blur_30_9_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_9 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_6 = I.I_I_id0_6_to_I_out_0_blur_30_9_cache.peek_32();
	return value_I_I_id0_6;
}
...
inline hw_uint<16> I_out_1_blur_31_1_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_1 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_4 = I.I_I_id1_4_to_I_out_1_blur_31_1_cache.peek_32();
...
inline hw_uint<16> I_out_1_blur_31_2_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_2 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[1 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_4 = I.I_I_id1_4_to_I_out_1_blur_31_2_cache.peek_16();
	return value_I_I_id1_4;
}
...
inline hw_uint<16> I_out_1_blur_31_3_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_3 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[2 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_4 = I.I_I_id1_4_to_I_out_1_blur_31_3_cache.peek_0();
	return value_I_I_id1_4;
}
