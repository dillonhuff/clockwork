...
struct I_I_id0_10_to_I_out_0_blur_30_3_cache {
	// Capacity: 33
	...
	inline hw_uint<16> peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_I_id0_10_to_I_out_0_blur_30_3: " << offset << endl;
...
struct I_I_id0_10_to_I_out_0_blur_30_4_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_10_to_I_out_0_blur_30_4: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_10_to_I_out_0_blur_30_5: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_7_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 32) capacity = 31
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_7: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_8_cache {
	// Capacity: 33
	// Parition [0, 1) capacity = 1
	fifo<hw_uint<16>, 1> f0;
	// Parition [1, 16) capacity = 15
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_8: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id1_0_to_I_out_1_blur_31_9_cache {
	// Capacity: 33
	// Parition [0, 0] capacity = 1
	fifo<hw_uint<16>, 1> f1;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id1_0_to_I_out_1_blur_31_9: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_I_id0_10_to_I_out_0_blur_30_3_cache I_I_id0_10_to_I_out_0_blur_30_3;
  I_I_id0_10_to_I_out_0_blur_30_4_cache I_I_id0_10_to_I_out_0_blur_30_4;
  I_I_id0_10_to_I_out_0_blur_30_5_cache I_I_id0_10_to_I_out_0_blur_30_5;
  I_I_id1_0_to_I_out_1_blur_31_7_cache I_I_id1_0_to_I_out_1_blur_31_7;
  I_I_id1_0_to_I_out_1_blur_31_8_cache I_I_id1_0_to_I_out_1_blur_31_8;
  I_I_id1_0_to_I_out_1_blur_31_9_cache I_I_id1_0_to_I_out_1_blur_31_9;
};



inline void I_I_id0_10_write(hw_uint<16>& I_I_id0_10, I_cache& I, int root, int ir, int ic) {
  I.I_I_id0_10_to_I_out_0_blur_30_3.push(I_I_id0_10);
  I.I_I_id0_10_to_I_out_0_blur_30_4.push(I_I_id0_10);
  I.I_I_id0_10_to_I_out_0_blur_30_5.push(I_I_id0_10);
}

inline void I_I_id1_0_write(hw_uint<16>& I_I_id1_0, I_cache& I, int root, int ir, int ic) {
  I.I_I_id1_0_to_I_out_1_blur_31_7.push(I_I_id1_0);
  I.I_I_id1_0_to_I_out_1_blur_31_8.push(I_I_id1_0);
  I.I_I_id1_0_to_I_out_1_blur_31_9.push(I_I_id1_0);
}
...
inline hw_uint<16> I_out_0_blur_30_3_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_3 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_3.peek_32();
...
inline hw_uint<16> I_out_0_blur_30_4_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_4 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[1 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_4.peek_16();
	return value_I_I_id0_10;
}
...
inline hw_uint<16> I_out_0_blur_30_5_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_0_blur_30_5 read pattern: { out_0_blur_30[root = 0, xr, xc] -> I[2 + xr, 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id0_10 = I.I_I_id0_10_to_I_out_0_blur_30_5.peek_0();
	return value_I_I_id0_10;
}
...
inline hw_uint<16> I_out_1_blur_31_7_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_7 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_0 = I.I_I_id1_0_to_I_out_1_blur_31_7.peek_32();
	return value_I_I_id1_0;
}

inline hw_uint<16> I_out_1_blur_31_8_select(I_cache& I, int root, int xr, int xc) {
	// lexmax events: { out_1_blur_31[root = 0, xr, xc] -> I_id1[root' = 0, ir = 1 + xr, ic = xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
  // I_out_1_blur_31_8 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[1 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_0 = I.I_I_id1_0_to_I_out_1_blur_31_8.peek_16();
	return value_I_I_id1_0;
}
...
inline hw_uint<16> I_out_1_blur_31_9_select(I_cache& I, int root, int xr, int xc) {
  ...
  // I_out_1_blur_31_9 read pattern: { out_1_blur_31[root = 0, xr, xc] -> I[2 + xr, 1 + 2xc] : 0 <= xr <= 29 and 0 <= xc <= 15 }
	auto value_I_I_id1_0 = I.I_I_id1_0_to_I_out_1_blur_31_9.peek_0();
	return value_I_I_id1_0;
}
...
inline hw_uint<48> I_out_1_blur_31_read_bundle_read(I_cache& I, int root, int xr, int xc) {
	...
	hw_uint<16> I_out_1_blur_31_8_res = I_out_1_blur_31_8_select(I, root, xr, xc);
