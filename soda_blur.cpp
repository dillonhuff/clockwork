...
inline void I_I_id1_write_bundle_write(hw_uint<16>& I_id1_write, I_I_id1_2_cache& I_I_id1_2_delay) {
	...
	I_I_id1_2_write(I_I_id1_2_res, I_I_id1_2_delay);
}
...
// Operation logic
inline void I_id0(HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */in_0, I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, int root, int ir, int ic) {
	// Consume: in_0
...
inline void I_id1(HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */in_1, I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, int root, int ir, int ic) {
	// Consume: in_1
	auto in_1_ir_c__ic_value = in_1.read();
	auto compute_result = id(in_1_ir_c__ic_value);
	// Produce: I
	I_I_id1_write_bundle_write(compute_result, I_I_id1_2);
}

inline void out_0_blur_30(I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */out_0, int root, int xr, int xc) {
	// Consume: I
...
inline void out_1_blur_31(I_I_id0_0_cache& I_I_id0_0, I_I_id1_2_cache& I_I_id1_2, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */out_1, int root, int xr, int xc) {
	// Consume: I
