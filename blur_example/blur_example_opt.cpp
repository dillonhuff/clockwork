...
inline hw_uint<16> blur_example_rd0_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blur_example_update_0[d0, d1] -> blurx_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Op overlap with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Common write op with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Overlap with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  ...
  // DD fold: { blur_example_update_0[d0, d1] -> 1 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_example_rd1_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blur_example_update_0[d0, d1] -> blurx_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Op overlap with blurx_blurx_update_0_write1: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Common write op with blurx_blurx_update_0_write1: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Overlap with blurx_blurx_update_0_write1: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_example_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  // DD fold: { blur_example_update_0[d0, d1] -> 1 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_example_rd2_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blur_example_update_0[d0, d1] -> blurx_update_0[d0' = 1 + d0, d1' = d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Op overlap with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Common write op with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
    // Overlap with blurx_blurx_update_0_write0: { blur_example_update_0[d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_example_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blurx_rd0_select(input_cache& input, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blurx_update_0[d0, d1] -> input_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Op overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Common write op with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blurx_rd1_select(input_cache& input, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blurx_update_0[d0, d1] -> input_update_0[d0' = d0, d1' = 1 + d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Op overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Common write op with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blurx_rd2_select(input_cache& input, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blurx_update_0[d0, d1] -> input_update_0[d0' = d0, d1' = 2 + d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Op overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Common write op with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Overlap with input_input_update_0_write0: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blurx_rd3_select(input_cache& input, int d0, int d1, int dynamic_address) {
  ...
  // Get lexmax events: { blurx_update_0[d0, d1] -> input_update_0[d0' = d0, d1' = d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Op overlap with input_input_update_0_write1: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Common write op with input_input_update_0_write1: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
    // Overlap with input_input_update_0_write1: { blurx_update_0[d0, d1] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 960 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> 1922 : 0 < d0 <= 959 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (962 + d0) : d0 = 960 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 1922 : d0 = 0 and 0 <= d1 <= 1079 }
...
inline void blur_example_update_0(blurx_cache& blurx, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */blur_example, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_blur_example_update_0_read_bundle_read(blurx/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = blur_example_generated_compute_unrolled_2(blurx_0_c__0_value);
...
// Condition for blur_example_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (960 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))

  /*
  // Schedules...
    // blur_example_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*3]
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 960) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      blur_example_update_0((c1 - 1) / 1, (c0 - 2) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((1 <= c1 && c1 <= 960) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      blur_example_update_0(blurx /* buf name */, blur_example, (c1 - 1) / 1, (c0 - 2) / 1);
	    }
...
#ifdef __VIVADO_SYNTH__
  // { blur_example_update_0[root = 0, blur_example_0, blur_example_1] -> blur_example[0, 0] : 0 <= blur_example_0 <= 959 and 0 <= blur_example_1 <= 1079 }
const int blur_example_update_0_write_num_transfers = 1036800;
...
static void write_blur_example_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
...
void blur_example_opt_accel(hw_uint<32>* input_update_0_read, hw_uint<32>* blur_example_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<32> > blur_example_update_0_write_channel;
