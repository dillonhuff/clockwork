...
struct I_I_id0_0_to_I_out_blur_30_3_cache {
	...
	inline hw_uint<16> peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_blur_30_3: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_blur_30_4: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_blur_30_5: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_I_id0_0_to_I_out_blur_30_3_cache I_I_id0_0_to_I_out_blur_30_3;
  I_I_id0_0_to_I_out_blur_30_4_cache I_I_id0_0_to_I_out_blur_30_4;
  I_I_id0_0_to_I_out_blur_30_5_cache I_I_id0_0_to_I_out_blur_30_5;
};



inline void I_I_id0_0_write(hw_uint<16>& I_I_id0_0, I_cache& I, int root, int id1, int id0) {
  I.I_I_id0_0_to_I_out_blur_30_3.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_blur_30_4.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_blur_30_5.push(I_I_id0_0);
}
...
inline hw_uint<16> I_out_blur_30_3_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_3 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_blur_30_3.peek_64();
...
inline hw_uint<16> I_out_blur_30_4_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_4 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, 1 + d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_blur_30_4.peek_32();
	return value_I_I_id0_0;
}
...
inline hw_uint<16> I_out_blur_30_5_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_5 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, 2 + d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_blur_30_5.peek_0();
	return value_I_I_id0_0;
}
