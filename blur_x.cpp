...
inline hw_uint<16> I_out_blur_30_1_select(I_cache& I, int root, int d1, int d0, int dynamic_address) {
  ...
  // Get lexmax events: { out_blur_30[root = 0, d1, d0] -> I_id0[root' = 0, id1 = d1, id0 = d0] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
    // Op overlap with I_I_id0_4: { out_blur_30[root = 0, d1, d0] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
    // Common write op with I_I_id0_4: { out_blur_30[root = 0, d1, d0] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
    // Overlap with I_I_id0_4: { out_blur_30[root = 0, d1, d0] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
