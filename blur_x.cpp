...
struct I_I_id0_4_to_I_out_blur_30_1_cache {
	// Capacity: 65
	// # of read delays: 2
	// read delays: 0, 64
	...
	inline hw_uint<16> peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_I_id0_4_to_I_out_blur_30_1: " << offset << endl;
...
struct I_I_id0_4_to_I_out_blur_30_2_cache {
	// Capacity: 65
	// # of read delays: 2
	// read delays: 0, 32
	// Parition [0, 1) capacity = 1
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_4_to_I_out_blur_30_2: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_I_id0_4_to_I_out_blur_30_3_cache {
	// Capacity: 65
	// # of read delays: 2
	// read delays: 0, 0
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_4_to_I_out_blur_30_3: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_I_id0_4_to_I_out_blur_30_1_cache I_I_id0_4_to_I_out_blur_30_1;
  I_I_id0_4_to_I_out_blur_30_2_cache I_I_id0_4_to_I_out_blur_30_2;
  I_I_id0_4_to_I_out_blur_30_3_cache I_I_id0_4_to_I_out_blur_30_3;
};



inline void I_I_id0_4_write(hw_uint<16>& I_I_id0_4, I_cache& I, int root, int id1, int id0) {
  I.I_I_id0_4_to_I_out_blur_30_1.push(I_I_id0_4);
  I.I_I_id0_4_to_I_out_blur_30_2.push(I_I_id0_4);
  I.I_I_id0_4_to_I_out_blur_30_3.push(I_I_id0_4);
}
...
inline hw_uint<16> I_out_blur_30_1_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_1 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_4 = I.I_I_id0_4_to_I_out_blur_30_1.peek_64();
...
inline hw_uint<16> I_out_blur_30_2_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_2 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, 1 + d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_4 = I.I_I_id0_4_to_I_out_blur_30_2.peek_32();
	return value_I_I_id0_4;
}
...
inline hw_uint<16> I_out_blur_30_3_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_blur_30_3 read pattern: { out_blur_30[root = 0, d1, d0] -> I[d0, 2 + d1] : 0 <= d1 <= 5 and 0 <= d0 <= 31 }
	auto value_I_I_id0_4 = I.I_I_id0_4_to_I_out_blur_30_3.peek_0();
	return value_I_I_id0_4;
}
