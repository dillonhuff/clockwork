...
void compile_for_garnet_single_port_mem(prog& prg, string dir, bool gen_smt_stream, bool config_gen_only, bool multi_level_mem, bool use_dse_compute, bool for_metamapper, string dse_compute_filename, bool energy_model=false);
