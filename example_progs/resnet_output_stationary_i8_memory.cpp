...
prog resnet_output_stationary_i8() {
  prog prg;
  prg.compute_unit_file = "resnet_output_stationary_i8_compute.h";
  prg.name = "resnet_output_stationary_i8";
...
////producing output_glb.stencil
  ...
  auto output_glb_s0_y_y_glb = output_glb_s0_w_w_glb->add_loop("output_glb_s0_y_y_glb", 0, 4);
  auto output_glb_s0_x_x_glb = output_glb_s0_y_y_glb->add_loop("output_glb_s0_x_x_glb", 0, 4);
////producing output_cgra.stencil
  auto output_cgra_s0_y = output_glb_s0_x_x_glb->add_loop("output_cgra_s0_y", 0, 14);
  auto output_cgra_s0_x = output_cgra_s0_y->add_loop("output_cgra_s0_x", 0, 14);
  auto output_cgra_s0_w_w_cgra = output_cgra_s0_x->add_loop("output_cgra_s0_w_w_cgra", 0, 8);
...
////producing input_cgra.stencil
  auto input_cgra_s0_y = output_glb_s0_x_x_glb->add_loop("input_cgra_s0_y", 0, 16);
...
//store is: input_cgra.stencil(input_cgra_s0_z_z_cgra, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(input_cgra_s0_z_z_cgra, ((output_glb_s0_x_x_glb*28) + input_cgra_s0_x), ((output_glb_s0_y_y_glb*28) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "((output_glb_s0_x_x_glb*14) + input_cgra_s0_x)", "input_cgra_s0_z_z_cgra");
...
//consuming output_cgra.stencil
  auto output_glb_s0_y_y_cgra = output_glb_s0_x_x_glb->add_loop("output_glb_s0_y_y_cgra", 0, 14);
