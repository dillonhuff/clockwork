...
////producing hw_input_global_wrapper.stencil
  ...
  hw_input_global_wrapper_s0_y->coarse_grain_loop_tag();
...
////producing conv1.stencil
  ...
  conv1_s0_y->coarse_grain_loop_tag();
...
//store is: conv1.stencil(conv1_s0_x, conv1_s0_y) = (uint16)0
  ...
  conv1_s1_y->coarse_grain_loop_tag();
...
//  conv1_shift_s0_y->coarse_grain_loop_tag();
...
////producing conv2.stencil
  ...
  conv2_s0_y->coarse_grain_loop_tag();
...
//store is: conv2.stencil(conv2_s0_x, conv2_s0_y) = (uint16)0
  ...
  conv2_s1_y->coarse_grain_loop_tag();
