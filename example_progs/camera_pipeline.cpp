...
//consuming denoised$1.stencil
////producing b_b.stencil
  auto b_b_s0_y = prg.add_loop("b_b_s0_y", -1, 96);
  auto b_b_s0_x = b_b_s0_y->add_loop("b_b_s0_x", 0, 129);
...
//consuming b_b.stencil
////producing g_gb.stencil
  auto g_gb_s0_y = prg.add_loop("g_gb_s0_y", -1, 97);
  auto g_gb_s0_x = g_gb_s0_y->add_loop("g_gb_s0_x", -1, 129);
...
//consuming g_gr.stencil
////producing g_b.stencil
  auto g_b_s0_y = prg.add_loop("g_b_s0_y", -1, 96);
  auto g_b_s0_x = g_b_s0_y->add_loop("g_b_s0_x", 0, 129);
...
//store is: g_b.stencil(g_b_s0_x, (g_b_s0_y + 1)) = select((absd(g_gb.stencil(g_b_s0_x, (g_b_s0_y + 1)), g_gb.stencil((g_b_s0_x + 1), (g_b_s0_y + 1))) < absd(g_gr.stencil((g_b_s0_x + 1), (g_b_s0_y + 2)), g_gr.stencil((g_b_s0_x + 1), (g_b_s0_y + 1)))), ((g_gb.stencil(g_b_s0_x, (g_b_s0_y + 1)) + g_gb.stencil((g_b_s0_x + 1), (g_b_s0_y + 1)))/(uint16)2), ((g_gr.stencil((g_b_s0_x + 1), (g_b_s0_y + 2)) + g_gr.stencil((g_b_s0_x + 1), (g_b_s0_y + 1)))/(uint16)2))
  auto hcompute_g_b_stencil = g_b_s0_x->add_op("op_hcompute_g_b_stencil");
  hcompute_g_b_stencil->add_function("hcompute_g_b_stencil");
  hcompute_g_b_stencil->add_load("g_gb_stencil", "(g_b_s0_y + 1)", "g_b_s0_x");
  hcompute_g_b_stencil->add_load("g_gb_stencil", "(g_b_s0_y + 1)", "(g_b_s0_x + 1)");
  hcompute_g_b_stencil->add_load("g_gr_stencil", "(g_b_s0_y + 2)", "(g_b_s0_x + 1)");
  hcompute_g_b_stencil->add_load("g_gr_stencil", "(g_b_s0_y + 1)", "(g_b_s0_x + 1)");
  prg.buffer_port_widths["g_b_stencil"] = 16;
  hcompute_g_b_stencil->add_store("g_b_stencil", "(g_b_s0_y + 1)", "g_b_s0_x");

//consuming g_b.stencil
////producing b_gb.stencil
  auto b_gb_s0_y = prg.add_loop("b_gb_s0_y", 0, 96);
  auto b_gb_s0_x = b_gb_s0_y->add_loop("b_gb_s0_x", 0, 128);
...
//consuming b_gb.stencil
////producing b_gr.stencil
  auto b_gr_s0_y = prg.add_loop("b_gr_s0_y", 0, 96);
  auto b_gr_s0_x = b_gr_s0_y->add_loop("b_gr_s0_x", 0, 128);
...
//consuming b_gr.stencil
////producing g_r.stencil
  auto g_r_s0_y = prg.add_loop("g_r_s0_y", 0, 97);
  auto g_r_s0_x = g_r_s0_y->add_loop("g_r_s0_x", -1, 128);
...
//store is: g_r.stencil((g_r_s0_x + 1), g_r_s0_y) = select((absd(g_gr.stencil((g_r_s0_x + 2), (g_r_s0_y + 1)), g_gr.stencil((g_r_s0_x + 1), (g_r_s0_y + 1))) < absd(g_gb.stencil((g_r_s0_x + 1), g_r_s0_y), g_gb.stencil((g_r_s0_x + 1), (g_r_s0_y + 1)))), ((g_gr.stencil((g_r_s0_x + 2), (g_r_s0_y + 1)) + g_gr.stencil((g_r_s0_x + 1), (g_r_s0_y + 1)))/(uint16)2), ((g_gb.stencil((g_r_s0_x + 1), g_r_s0_y) + g_gb.stencil((g_r_s0_x + 1), (g_r_s0_y + 1)))/(uint16)2))
  auto hcompute_g_r_stencil = g_r_s0_x->add_op("op_hcompute_g_r_stencil");
  hcompute_g_r_stencil->add_function("hcompute_g_r_stencil");
  hcompute_g_r_stencil->add_load("g_gb_stencil", "g_r_s0_y", "(g_r_s0_x + 1)");
  hcompute_g_r_stencil->add_load("g_gb_stencil", "(g_r_s0_y + 1)", "(g_r_s0_x + 1)");
  hcompute_g_r_stencil->add_load("g_gr_stencil", "(g_r_s0_y + 1)", "(g_r_s0_x + 2)");
  hcompute_g_r_stencil->add_load("g_gr_stencil", "(g_r_s0_y + 1)", "(g_r_s0_x + 1)");
  prg.buffer_port_widths["g_r_stencil"] = 16;
  hcompute_g_r_stencil->add_store("g_r_stencil", "g_r_s0_y", "(g_r_s0_x + 1)");

//consuming g_r.stencil
////producing b_r.stencil
  auto b_r_s0_y = prg.add_loop("b_r_s0_y", 0, 96);
  auto b_r_s0_x = b_r_s0_y->add_loop("b_r_s0_x", 0, 128);
...
//consuming b_r.stencil
////producing r_r.stencil
  auto r_r_s0_y = prg.add_loop("r_r_s0_y", 0, 97);
  auto r_r_s0_x = r_r_s0_y->add_loop("r_r_s0_x", -1, 128);
...
//consuming r_r.stencil
////producing r_b.stencil
  auto r_b_s0_y = prg.add_loop("r_b_s0_y", 0, 96);
  auto r_b_s0_x = r_b_s0_y->add_loop("r_b_s0_x", 0, 128);
...
//consuming r_b.stencil
////producing r_gb.stencil
  auto r_gb_s0_y = prg.add_loop("r_gb_s0_y", 0, 96);
  auto r_gb_s0_x = r_gb_s0_y->add_loop("r_gb_s0_x", 0, 128);
...
//consuming r_gb.stencil
////producing r_gr.stencil
  auto r_gr_s0_y = prg.add_loop("r_gr_s0_y", 0, 96);
  auto r_gr_s0_x = r_gr_s0_y->add_loop("r_gr_s0_x", 0, 128);
