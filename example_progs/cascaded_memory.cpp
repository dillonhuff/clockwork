...
prog cascaded() {
  prog prg;
  prg.compute_unit_file = "cascaded_compute.h";
  prg.name = "cascaded";
...
//store is: conv1.stencil(conv1_s1_x, conv1_s1_y) = (hw_input_global_wrapper.stencil(conv1_s1_x, conv1_s1_y) + (conv1.stencil(conv1_s1_x, conv1_s1_y) + ((hw_input_global_wrapper.stencil((conv1_s1_x + 1), conv1_s1_y)*(uint16)2) + (hw_input_global_wrapper.stencil((conv1_s1_x + 2), conv1_s1_y) + ((hw_input_global_wrapper.stencil(conv1_s1_x, (conv1_s1_y + 1))*(uint16)2) + ((hw_input_global_wrapper.stencil((conv1_s1_x + 1), (conv1_s1_y + 1))*(uint16)4) + ((hw_input_global_wrapper.stencil((conv1_s1_x + 2), (conv1_s1_y + 1))*(uint16)2) + (hw_input_global_wrapper.stencil(conv1_s1_x, (conv1_s1_y + 2)) + (hw_input_global_wrapper.stencil((conv1_s1_x + 2), (conv1_s1_y + 2)) + (hw_input_global_wrapper.stencil((conv1_s1_x + 1), (conv1_s1_y + 2))*(uint16)2))))))))))
  ...
  hcompute_conv1_stencil_1->add_function("hcompute_conv2_stencil_1");
...
////producing conv1_shift.stencil
  auto conv1_shift_s0_y = prg.add_loop("conv1_shift_s0_y", 0, 62);
  auto conv1_shift_s0_x = conv1_shift_s0_y->add_loop("conv1_shift_s0_x", 0, 62);

//store is: conv1_shift.stencil(conv1_shift_s0_x, conv1_shift_s0_y) = (conv1.stencil(conv1_shift_s0_x, conv1_shift_s0_y)/(uint16)16)
  auto hcompute_conv1_shift_stencil = conv1_shift_s0_x->add_op("op_hcompute_conv1_shift_stencil");
  hcompute_conv1_shift_stencil->add_function("hcompute_conv1_shift_stencil");
  hcompute_conv1_shift_stencil->add_load("conv1_stencil", "conv1_shift_s0_y", "conv1_shift_s0_x");
  prg.buffer_port_widths["conv1_shift_stencil"] = 16;
  hcompute_conv1_shift_stencil->add_store("conv1_shift_stencil", "conv1_shift_s0_y", "conv1_shift_s0_x");

//consuming conv1_shift.stencil
...
//store is: conv2.stencil(conv2_s1_x, conv2_s1_y) = (conv1_shift.stencil(conv2_s1_x, conv2_s1_y) + (conv2.stencil(conv2_s1_x, conv2_s1_y) + ((conv1_shift.stencil((conv2_s1_x + 1), conv2_s1_y)*(uint16)2) + (conv1_shift.stencil((conv2_s1_x + 2), conv2_s1_y) + ((conv1_shift.stencil(conv2_s1_x, (conv2_s1_y + 1))*(uint16)2) + ((conv1_shift.stencil((conv2_s1_x + 1), (conv2_s1_y + 1))*(uint16)4) + ((conv1_shift.stencil((conv2_s1_x + 2), (conv2_s1_y + 1))*(uint16)2) + (conv1_shift.stencil(conv2_s1_x, (conv2_s1_y + 2)) + (conv1_shift.stencil((conv2_s1_x + 2), (conv2_s1_y + 2)) + (conv1_shift.stencil((conv2_s1_x + 1), (conv2_s1_y + 2))*(uint16)2))))))))))
  ...
  //auto hcompute_conv2_stencil_1 = conv2_s1_x->add_op("op_hcompute_conv1_stencil_1");
  hcompute_conv2_stencil_1->add_function("hcompute_conv2_stencil_1");
  //hcompute_conv2_stencil_1->add_function("hcompute_conv1_stencil_1");
  hcompute_conv2_stencil_1->add_load("conv2_stencil", "conv2_s1_y", "conv2_s1_x");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "conv2_s1_y", "conv2_s1_x");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "conv2_s1_y", "(conv2_s1_x + 1)");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "conv2_s1_y", "(conv2_s1_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 1)", "conv2_s1_x");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 1)", "(conv2_s1_x + 1)");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 1)", "(conv2_s1_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 2)", "conv2_s1_x");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 2)", "(conv2_s1_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv1_shift_stencil", "(conv2_s1_y + 2)", "(conv2_s1_x + 1)");
  hcompute_conv2_stencil_1->add_store("conv2_stencil", "conv2_s1_y", "conv2_s1_x");

//consuming conv2.stencil
  auto hw_output_s0_y_xo = prg.add_loop("hw_output_s0_y_xo", 0, 60);
  auto hw_output_s0_x_xi = hw_output_s0_y_xo->add_loop("hw_output_s0_x_xi", 0, 60);

//store is: hw_output.stencil(hw_output_s0_x_xi, hw_output_s0_y_xo) = (conv2.stencil(hw_output_s0_x_xi, hw_output_s0_y_xo)/(uint16)16)
  auto hcompute_hw_output_stencil = hw_output_s0_x_xi->add_op("op_hcompute_hw_output_stencil");
  hcompute_hw_output_stencil->add_function("hcompute_hw_output_stencil");
  hcompute_hw_output_stencil->add_load("conv2_stencil", "hw_output_s0_y_xo", "hw_output_s0_x_xi");
  hcompute_hw_output_stencil->add_store("hw_output_stencil", "hw_output_s0_y_xo", "hw_output_s0_x_xi");
