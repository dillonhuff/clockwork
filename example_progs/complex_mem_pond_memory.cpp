...
////producing input_cgra.stencil
  ...
  auto input_cgra_s0_zz = input_cgra_s0_z->add_loop("input_cgra_s0_zz", 0, 4);
...
////producing kernel_cgra.stencil
  ...
  auto kernel_cgra_s0_w = kernel_cgra_s0_x->add_loop("kernel_cgra_s0_w", 0, 4);
  auto kernel_cgra_s0_ww = kernel_cgra_s0_w->add_loop("kernel_cgra_s0_ww", 0, 3);
  auto kernel_cgra_s0_z = kernel_cgra_s0_ww->add_loop("kernel_cgra_s0_z", 0, 4);
  auto kernel_cgra_s0_zz = kernel_cgra_s0_z->add_loop("kernel_cgra_s0_zz", 0, 4);
...
//store is: kernel_cgra.stencil(kernel_cgra_s0_z, kernel_cgra_s0_w, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_host.stencil(kernel_cgra_s0_z, kernel_cgra_s0_w, kernel_cgra_s0_x, kernel_cgra_s0_y)
  ...
  hcompute_kernel_cgra_stencil->add_load("kernel_host_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w*3 + kernel_cgra_s0_ww", "kernel_cgra_s0_z*4+kernel_cgra_s0_zz");
  prg.buffer_port_widths["kernel_cgra_stencil"] = 16;
  hcompute_kernel_cgra_stencil->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w", "kernel_cgra_s0_ww", "kernel_cgra_s0_z", "kernel_cgra_s0_zz");
...
////producing output_pond.stencil
  auto output_pond_s0_w_w_unroll = output_cgra_s0_w_w->add_loop("output_pond_s0_w_w_unroll", 0, 3);
...
////producing input_pond.stencil
  auto input_pond_s0_z = output_cgra_s0_w_w->add_loop("input_pond_s0_z", 0, 4);
  ...
  auto input_pond_s0_zz = input_pond_s0_x->add_loop("input_pond_s0_zz", 0, 4);
...
////producing kernel_pond.stencil
  auto kernel_pond_s0_z = output_cgra_s0_w_w->add_loop("kernel_pond_s0_z", 0, 4);
  ...
  auto kernel_pond_s0_zz = kernel_pond_s0_w_w_cgra->add_loop("kernel_pond_s0_zz", 0, 4);
...
//store is: kernel_pond.stencil(kernel_pond_s0_zz, kernel_pond_s0_z, kernel_pond_s0_w_w_cgra, kernel_pond_s0_x, kernel_pond_s0_y) = kernel_cgra.stencil(((kernel_pond_s0_z*4) + kernel_pond_s0_zz), ((output_cgra_s0_w_w*3) + kernel_pond_s0_w_w_cgra), kernel_pond_s0_x, kernel_pond_s0_y)
  ...
  hcompute_kernel_pond_stencil->add_load("kernel_cgra_stencil", "kernel_pond_s0_y", "kernel_pond_s0_x", "output_cgra_s0_w_w "," kernel_pond_s0_w_w_cgra", "kernel_pond_s0_z", " kernel_pond_s0_zz");
...
//consuming kernel_pond.stencil
  auto output_pond_s1_r_z = output_cgra_s0_w_w->add_loop("output_pond_s1_r_z", 0, 4);
...
//store is: output_pond.stencil(0, 0, 0) = ((kernel_pond.stencil(0, output_pond_s1_r_z, 0, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(0, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(1, output_pond_s1_r_z, 0, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(1, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(2, output_pond_s1_r_z, 0, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(2, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + (output_pond.stencil(0, 0, 0) + (kernel_pond.stencil(3, output_pond_s1_r_z, 0, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(3, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y))))))
  ...
  hcompute_output_pond_stencil_1->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "0");
  hcompute_output_pond_stencil_1->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_1->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_1->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "3");
  hcompute_output_pond_stencil_1->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "0", "output_pond_s1_r_z", "0");
  hcompute_output_pond_stencil_1->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "0", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_1->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "0", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_1->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "0", "output_pond_s1_r_z", "3");
...
//store is: output_pond.stencil(0, 0, 1) = ((kernel_pond.stencil(0, output_pond_s1_r_z, 1, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(0, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(1, output_pond_s1_r_z, 1, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(1, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(2, output_pond_s1_r_z, 1, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(2, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + (output_pond.stencil(0, 0, 1) + (kernel_pond.stencil(3, output_pond_s1_r_z, 1, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(3, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y))))))
  ...
  hcompute_output_pond_stencil_2->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "0");
  hcompute_output_pond_stencil_2->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_2->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_2->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "3");
  hcompute_output_pond_stencil_2->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "1", "output_pond_s1_r_z", "0");
  hcompute_output_pond_stencil_2->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "1", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_2->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "1", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_2->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "1", "output_pond_s1_r_z", "3");
...
//store is: output_pond.stencil(0, 0, 2) = ((kernel_pond.stencil(0, output_pond_s1_r_z, 2, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(0, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(1, output_pond_s1_r_z, 2, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(1, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + ((kernel_pond.stencil(2, output_pond_s1_r_z, 2, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(2, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y)) + (output_pond.stencil(0, 0, 2) + (kernel_pond.stencil(3, output_pond_s1_r_z, 2, output_pond_s1_r_x, output_pond_s1_r_y)*input_pond.stencil(3, output_pond_s1_r_z, output_pond_s1_r_x, output_pond_s1_r_y))))))
  ...
  hcompute_output_pond_stencil_3->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_3->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_3->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "3");
  hcompute_output_pond_stencil_3->add_load("input_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "output_pond_s1_r_z", "0");
  hcompute_output_pond_stencil_3->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "2", "output_pond_s1_r_z", "1");
  hcompute_output_pond_stencil_3->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "2", "output_pond_s1_r_z", "2");
  hcompute_output_pond_stencil_3->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "2", "output_pond_s1_r_z", "3");
  hcompute_output_pond_stencil_3->add_load("kernel_pond_stencil", "output_pond_s1_r_y", "output_pond_s1_r_x", "2", "output_pond_s1_r_z", "0");
...
//store is: output_cgra.stencil(output_cgra_s0_x, output_cgra_s0_y, (output_cgra_s0_w_w*3)) = output_pond.stencil(0, 0, 0)
  ...
  hcompute_output_cgra_stencil->add_store("output_cgra_stencil", "(output_cgra_s0_w_w*3)", "output_cgra_s0_y", "output_cgra_s0_x");
...
//store is: output_cgra.stencil(output_cgra_s0_x, output_cgra_s0_y, ((output_cgra_s0_w_w*3) + 1)) = output_pond.stencil(0, 0, 1)
  ...
  hcompute_output_cgra_stencil_1->add_store("output_cgra_stencil", "((output_cgra_s0_w_w*3) + 1)", "output_cgra_s0_y", "output_cgra_s0_x");
...
//store is: output_cgra.stencil(output_cgra_s0_x, output_cgra_s0_y, ((output_cgra_s0_w_w*3) + 2)) = output_pond.stencil(0, 0, 2)
  ...
  hcompute_output_cgra_stencil_2->add_store("output_cgra_stencil", "((output_cgra_s0_w_w*3) + 2)", "output_cgra_s0_y", "output_cgra_s0_x");

//consuming output_cgra.stencil
  auto hw_output_s0_w = prg.add_loop("hw_output_s0_w", 0, 12);
