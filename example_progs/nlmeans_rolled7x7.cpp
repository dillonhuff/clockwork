...
prog nlmeans_rolled_7x7() {
  prog prg;
  prg.compute_unit_file = "nlmeans_rolled_7x7_compute.h";
  prg.name = "nlmeans_rolled_7x7";

// Stencil<uint16_t, 3, 44, 44> &hw_input_stencil = arg_0;
...
////producing hw_input_global_wrapper.stencil
  auto hw_input_global_wrapper_s0_y = prg.add_loop("hw_input_global_wrapper_s0_y", -6, 38);
  auto hw_input_global_wrapper_s0_x = hw_input_global_wrapper_s0_y->add_loop("hw_input_global_wrapper_s0_x", -6, 38);
...
////producing d.stencil
  auto d_s0_y = prg.add_loop("d_s0_y", -3, 35);
  auto d_s0_x = d_s0_y->add_loop("d_s0_x", -3, 35);
...
//store is: d.stencil((d_s0_dx + 3), (d_s0_dy + 3), (d_s0_x + 3), (d_s0_y + 3)) = 0.000000h
  ...
  auto d_s1_y = prg.add_loop("d_s1_y", -3, 35);
  auto d_s1_x = d_s1_y->add_loop("d_s1_x", -3, 35);
...
////producing blur_d_y.stencil
  ...
  auto blur_d_y_s0_x = blur_d_y_s0_y->add_loop("blur_d_y_s0_x", -3, 35);
...
//store is: blur_d_y.stencil((blur_d_y_s0_dx + 3), (blur_d_y_s0_dy + 3), (blur_d_y_s0_x + 3), blur_d_y_s0_y) = 0.000000h
  ...
  auto blur_d_y_s1_x = blur_d_y_s1_y->add_loop("blur_d_y_s1_x", -3, 35);
...
//store is: non_local_means_sum.stencil(non_local_means_sum_s0_x_3, non_local_means_sum_s0_y_3, 3) = 0.000000h
  ...
  auto non_local_means_sum_s1_s_dom_y = non_local_means_sum_s1_x->add_loop("non_local_means_sum_s1_s_dom_y", -3, 4);
...
//store is: non_local_means_sum.stencil(non_local_means_sum_s1_x, non_local_means_sum_s1_y, 0) = (non_local_means_sum.stencil(non_local_means_sum_s1_x, non_local_means_sum_s1_y, 0) + (exp_bf16((blur_d.stencil((non_local_means_sum_s1_s_dom_x + 3), (non_local_means_sum_s1_s_dom_y + 3), non_local_means_sum_s1_x, non_local_means_sum_s1_y)*-1.414062h))*hw_input_global_wrapper.stencil(0, ((non_local_means_sum_s1_s_dom_x + non_local_means_sum_s1_x) + 6), ((non_local_means_sum_s1_s_dom_y + non_local_means_sum_s1_y) + 6))))
  ...
  hcompute_non_local_means_sum_stencil_4->add_load("blur_d_stencil", "non_local_means_sum_s1_y", "non_local_means_sum_s1_x", "(non_local_means_sum_s1_s_dom_y + 3)", "(non_local_means_sum_s1_s_dom_x + 3)");
  ...
  auto non_local_means_sum_s1_s_dom_y_1 = non_local_means_sum_s1_x_1->add_loop("non_local_means_sum_s1_s_dom_y_1", -3, 4);
  auto non_local_means_sum_s1_s_dom_x_1 = non_local_means_sum_s1_s_dom_y_1->add_loop("non_local_means_sum_s1_s_dom_x_1", -3, 4);

//store is: non_local_means_sum.stencil(non_local_means_sum_s1_x_1, non_local_means_sum_s1_y_1, 1) = (non_local_means_sum.stencil(non_local_means_sum_s1_x_1, non_local_means_sum_s1_y_1, 1) + (exp_bf16((blur_d.stencil((non_local_means_sum_s1_s_dom_x_1 + 3), (non_local_means_sum_s1_s_dom_y_1 + 3), non_local_means_sum_s1_x_1, non_local_means_sum_s1_y_1)*-1.414062h))*hw_input_global_wrapper.stencil(1, ((non_local_means_sum_s1_s_dom_x_1 + non_local_means_sum_s1_x_1) + 6), ((non_local_means_sum_s1_s_dom_y_1 + non_local_means_sum_s1_y_1) + 6))))
  ...
  hcompute_non_local_means_sum_stencil_5->add_load("blur_d_stencil", "non_local_means_sum_s1_y_1", "non_local_means_sum_s1_x_1", "(non_local_means_sum_s1_s_dom_y_1 + 3)", "(non_local_means_sum_s1_s_dom_x_1 + 3)");
  hcompute_non_local_means_sum_stencil_5->add_load("hw_input_global_wrapper_stencil", "((non_local_means_sum_s1_s_dom_y_1 + non_local_means_sum_s1_y_1) + 6)", "((non_local_means_sum_s1_s_dom_x_1 + non_local_means_sum_s1_x_1) + 6)", "1");
...
//store is: non_local_means_sum.stencil(non_local_means_sum_s1_x_2, non_local_means_sum_s1_y_2, 2) = (non_local_means_sum.stencil(non_local_means_sum_s1_x_2, non_local_means_sum_s1_y_2, 2) + (exp_bf16((blur_d.stencil((non_local_means_sum_s1_s_dom_x_2 + 3), (non_local_means_sum_s1_s_dom_y_2 + 3), non_local_means_sum_s1_x_2, non_local_means_sum_s1_y_2)*-1.414062h))*hw_input_global_wrapper.stencil(2, ((non_local_means_sum_s1_s_dom_x_2 + non_local_means_sum_s1_x_2) + 6), ((non_local_means_sum_s1_s_dom_y_2 + non_local_means_sum_s1_y_2) + 6))))
  ...
  hcompute_non_local_means_sum_stencil_6->add_load("blur_d_stencil", "non_local_means_sum_s1_y_2", "non_local_means_sum_s1_x_2", "(non_local_means_sum_s1_s_dom_y_2 + 3)", "(non_local_means_sum_s1_s_dom_x_2 + 3)");
  hcompute_non_local_means_sum_stencil_6->add_load("hw_input_global_wrapper_stencil", "((non_local_means_sum_s1_s_dom_y_2 + non_local_means_sum_s1_y_2) + 6)", "((non_local_means_sum_s1_s_dom_x_2 + non_local_means_sum_s1_x_2) + 6)", "2");
  ...
  auto non_local_means_sum_s1_s_dom_y_3 = non_local_means_sum_s1_x_3->add_loop("non_local_means_sum_s1_s_dom_y_3", -3, 4);
  auto non_local_means_sum_s1_s_dom_x_3 = non_local_means_sum_s1_s_dom_y_3->add_loop("non_local_means_sum_s1_s_dom_x_3", -3, 4);
...
//store is: non_local_means_sum.stencil(non_local_means_sum_s1_x_3, non_local_means_sum_s1_y_3, 3) = (non_local_means_sum.stencil(non_local_means_sum_s1_x_3, non_local_means_sum_s1_y_3, 3) + exp_bf16((blur_d.stencil((non_local_means_sum_s1_s_dom_x_3 + 3), (non_local_means_sum_s1_s_dom_y_3 + 3), non_local_means_sum_s1_x_3, non_local_means_sum_s1_y_3)*-1.414062h)))
  ...
  hcompute_non_local_means_sum_stencil_7->add_load("blur_d_stencil", "non_local_means_sum_s1_y_3", "non_local_means_sum_s1_x_3", "(non_local_means_sum_s1_s_dom_y_3 + 3)", "(non_local_means_sum_s1_s_dom_x_3 + 3)");
