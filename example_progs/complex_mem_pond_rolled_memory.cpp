...
////producing input_pond.stencil
  auto input_pond_s0_z = output_cgra_s0_w->add_loop("input_pond_s0_z", 0, 8);
...
////producing kernel_pond.stencil
  auto kernel_pond_s0_z = output_cgra_s0_w->add_loop("kernel_pond_s0_z", 0, 8);
...
//consuming kernel_pond.stencil
  auto output_pond_s1_r_z = output_cgra_s0_w->add_loop("output_pond_s1_r_z", 0, 8);
...
//store is: output_cgra.stencil(output_cgra_s0_x, output_cgra_s0_y, output_cgra_s0_w) = output_pond.stencil(0, 0, 2)
  ...
  hcompute_output_cgra_stencil->add_store("output_cgra_stencil", "output_cgra_s0_w", "output_cgra_s0_y", "output_cgra_s0_x");
