...
prog conv_rolled() {
  prog prg;
  prg.compute_unit_file = "conv_rolled_compute.h";
  prg.name = "conv_rolled";
...
////producing hw_input_global_wrapper.stencil
  auto hw_input_global_wrapper_s0_y = prg.add_loop("hw_input_global_wrapper_s0_y", 0, 12);
  auto hw_input_global_wrapper_s0_x = hw_input_global_wrapper_s0_y->add_loop("hw_input_global_wrapper_s0_x", 0, 12);
...
////producing conv.stencil
  ...
  auto conv_s0_x = conv_s0_y->add_loop("conv_s0_x", 0, 10);
...
//store is: conv.stencil(conv_s0_x, conv_s0_y) = (uint16)0
  ...
  auto conv_s1_y = prg.add_loop("conv_s1_y", 0, 10);
  auto conv_s1_r_y = conv_s1_y->add_loop("conv_s1_r_y", 0, 3);
  auto conv_s1_x = conv_s1_r_y->add_loop("conv_s1_x", 0, 10);
...
//consuming conv.stencil
  auto hw_output_s0_y_yi = prg.add_loop("hw_output_s0_y_yi", 0, 10);
  auto hw_output_s0_x_xi = hw_output_s0_y_yi->add_loop("hw_output_s0_x_xi", 0, 10);
