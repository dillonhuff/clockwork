...
// Stencil<int16_t, 16, 9, 9> &input_host_stencil = arg_0;
...
// Stencil<int16_t, 16, 7, 7> &hw_output_stencil = arg_2;
...
////producing kernel_glb.stencil
  ...
  auto kernel_glb_s0_z_z = kernel_glb_s0_w->add_loop("kernel_glb_s0_z_z", 0, 16);
...
//store is: kernel_glb.stencil(kernel_glb_s0_z_z, kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil(kernel_glb_s0_z_z, kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  ...
  hcompute_kernel_glb_stencil->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "kernel_glb_s0_z_z");
  prg.buffer_port_widths["kernel_glb_stencil"] = 16;
  hcompute_kernel_glb_stencil->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "kernel_glb_s0_z_z");
...
//store is: input_cgra.stencil(input_cgra_s0_z_z_cgra_z_cgra, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + input_cgra_s0_z_z_cgra_z_cgra), input_cgra_s0_x, input_cgra_s0_y)
  ...
  hcompute_input_cgra_stencil->add_load("input_glb_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + input_cgra_s0_z_z_cgra_z_cgra)");
  prg.buffer_port_widths["input_cgra_stencil"] = 16;
  hcompute_input_cgra_stencil->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "input_cgra_s0_z_z_cgra_z_cgra");
...
////producing kernel_cgra.stencil
  ...
  auto kernel_cgra_s0_z_z_cgra_z_cgra = kernel_cgra_s0_w_w_cgra->add_loop("kernel_cgra_s0_z_z_cgra_z_cgra", 0, 8);
...
//store is: kernel_cgra.stencil(kernel_cgra_s0_z_z_cgra_z_cgra, kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + kernel_cgra_s0_z_z_cgra_z_cgra), ((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra), kernel_cgra_s0_x, kernel_cgra_s0_y)
  ...
  hcompute_kernel_cgra_stencil->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra)", "((output_cgra_s1_r_z_rz_glb*8) + kernel_cgra_s0_z_z_cgra_z_cgra)");
  prg.buffer_port_widths["kernel_cgra_stencil"] = 16;
  hcompute_kernel_cgra_stencil->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "kernel_cgra_s0_z_z_cgra_z_cgra");
...
//store is: output_glb.stencil(((output_glb_s0_w_w_glb*8) + output_glb_s0_w_w_cgra_w_cgra), output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra) = output_cgra.stencil(output_glb_s0_w_w_cgra_w_cgra, output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil->add_load("output_cgra_stencil", "output_glb_s0_y_y_cgra", "output_glb_s0_x_x_cgra", "output_glb_s0_w_w_cgra_w_cgra");
  prg.buffer_port_widths["output_glb_stencil"] = 16;
  hcompute_output_glb_stencil->add_store("output_glb_stencil", "output_glb_s0_y_y_cgra", "output_glb_s0_x_x_cgra", "((output_glb_s0_w_w_glb*8) + output_glb_s0_w_w_cgra_w_cgra)");
...
// in_img=7 pad=1 ksize=3 stride=1 n_ic=16 n_oc=16 k_ic=8 k_oc=8
