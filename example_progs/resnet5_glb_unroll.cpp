...
prog resnet5_glb_unroll() {
  prog prg;
  prg.compute_unit_file = "resnet5_glb_unroll_compute.h";
  prg.name = "resnet5_glb_unroll";

// Stencil<int16_t, 16, 15, 15> &input_host_stencil = arg_0;
  prg.add_input("input_host_stencil");
  prg.buffer_port_widths["input_host_stencil"] = 16;
// Stencil<int16_t, 16, 64, 3, 3> &kernel_host_stencil = arg_1;
  prg.add_input("kernel_host_stencil");
  prg.buffer_port_widths["kernel_host_stencil"] = 16;
// Stencil<int16_t, 64, 7, 7> &hw_output_stencil = arg_2;
  prg.add_output("hw_output_stencil");
  prg.buffer_port_widths["hw_output_stencil"] = 16;

////producing input_glb.stencil
  auto input_glb_s0_y = prg.add_loop("input_glb_s0_y", 0, 15);
  auto input_glb_s0_x = input_glb_s0_y->add_loop("input_glb_s0_x", 0, 15);
...
//store is: input_glb.stencil((input_glb_s0_z_z*2), input_glb_s0_x, input_glb_s0_y) = input_host.stencil((input_glb_s0_z_z*2), input_glb_s0_x, input_glb_s0_y)
  ...
  hcompute_input_glb_stencil->add_load("input_host_stencil", "input_glb_s0_y", "input_glb_s0_x", "(input_glb_s0_z_z*2)");
  prg.buffer_port_widths["input_glb_stencil"] = 16;
  hcompute_input_glb_stencil->add_store("input_glb_stencil", "input_glb_s0_y", "input_glb_s0_x", "(input_glb_s0_z_z*2)");
...
//store is: input_glb.stencil(((input_glb_s0_z_z*2) + 1), input_glb_s0_x, input_glb_s0_y) = input_host.stencil(((input_glb_s0_z_z*2) + 1), input_glb_s0_x, input_glb_s0_y)
  ...
  hcompute_input_glb_stencil_1->add_load("input_host_stencil", "input_glb_s0_y", "input_glb_s0_x", "((input_glb_s0_z_z*2) + 1)");
  hcompute_input_glb_stencil_1->add_store("input_glb_stencil", "input_glb_s0_y", "input_glb_s0_x", "((input_glb_s0_z_z*2) + 1)");
...
////producing kernel_glb.stencil
  ...
  auto kernel_glb_s0_z_z = kernel_glb_s0_w->add_loop("kernel_glb_s0_z_z", 0, 8);
...
//store is: kernel_glb.stencil((kernel_glb_s0_z_z*2), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil((kernel_glb_s0_z_z*2), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  ...
  hcompute_kernel_glb_stencil->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "(kernel_glb_s0_z_z*2)");
  prg.buffer_port_widths["kernel_glb_stencil"] = 16;
  hcompute_kernel_glb_stencil->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "(kernel_glb_s0_z_z*2)");
...
//store is: kernel_glb.stencil(((kernel_glb_s0_z_z*2) + 1), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil(((kernel_glb_s0_z_z*2) + 1), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  ...
  hcompute_kernel_glb_stencil_1->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*2) + 1)");
  hcompute_kernel_glb_stencil_1->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*2) + 1)");

//consuming kernel_glb.stencil
////producing output_glb.stencil
////producing output_cgra.stencil
  auto output_cgra_s0_y = prg.add_loop("output_cgra_s0_y", 0, 7);
...
//store is: output_cgra.stencil(((output_cgra_s0_w_w*8) + 7), output_cgra_s0_x, output_cgra_s0_y) = (int16)0
  ...
  auto output_cgra_s1_r_z_rz_glb = prg.add_loop("output_cgra_s1_r_z_rz_glb", 0, 2);
////producing input_cgra.stencil
  auto input_cgra_s0_y = output_cgra_s1_r_z_rz_glb->add_loop("input_cgra_s0_y", 0, 15);
  auto input_cgra_s0_x = input_cgra_s0_y->add_loop("input_cgra_s0_x", 0, 15);
  auto input_cgra_s0_z_z_cgra_z_cgra = input_cgra_s0_x->add_loop("input_cgra_s0_z_z_cgra_z_cgra", 0, 4);
...
//store is: input_cgra.stencil((input_cgra_s0_z_z_cgra_z_cgra*2), input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil((((output_cgra_s1_r_z_rz_glb*4) + input_cgra_s0_z_z_cgra_z_cgra)*2), input_cgra_s0_x, input_cgra_s0_y)
  ...
  hcompute_input_cgra_stencil->add_load("input_glb_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "(((output_cgra_s1_r_z_rz_glb*4) + input_cgra_s0_z_z_cgra_z_cgra)*2)");
  prg.buffer_port_widths["input_cgra_stencil"] = 16;
  hcompute_input_cgra_stencil->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "(input_cgra_s0_z_z_cgra_z_cgra*2)");
...
//store is: input_cgra.stencil(((input_cgra_s0_z_z_cgra_z_cgra*2) + 1), input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((((output_cgra_s1_r_z_rz_glb*4) + input_cgra_s0_z_z_cgra_z_cgra)*2) + 1), input_cgra_s0_x, input_cgra_s0_y)
  ...
  hcompute_input_cgra_stencil_1->add_load("input_glb_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "((((output_cgra_s1_r_z_rz_glb*4) + input_cgra_s0_z_z_cgra_z_cgra)*2) + 1)");
  hcompute_input_cgra_stencil_1->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "((input_cgra_s0_z_z_cgra_z_cgra*2) + 1)");
...
////producing kernel_cgra.stencil
  ...
  auto kernel_cgra_s0_w_w_cgra = kernel_cgra_s0_x->add_loop("kernel_cgra_s0_w_w_cgra", 0, 64);
  auto kernel_cgra_s0_z_z_cgra_z_cgra = kernel_cgra_s0_w_w_cgra->add_loop("kernel_cgra_s0_z_z_cgra_z_cgra", 0, 4);
...
//store is: kernel_cgra.stencil((kernel_cgra_s0_z_z_cgra_z_cgra*2), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil((((output_cgra_s1_r_z_rz_glb*4) + kernel_cgra_s0_z_z_cgra_z_cgra)*2), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y)
  ...
  hcompute_kernel_cgra_stencil->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "(((output_cgra_s1_r_z_rz_glb*4) + kernel_cgra_s0_z_z_cgra_z_cgra)*2)");
  prg.buffer_port_widths["kernel_cgra_stencil"] = 16;
  hcompute_kernel_cgra_stencil->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "(kernel_cgra_s0_z_z_cgra_z_cgra*2)");
...
//store is: kernel_cgra.stencil(((kernel_cgra_s0_z_z_cgra_z_cgra*2) + 1), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil(((((output_cgra_s1_r_z_rz_glb*4) + kernel_cgra_s0_z_z_cgra_z_cgra)*2) + 1), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y)
  ...
  hcompute_kernel_cgra_stencil_1->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "((((output_cgra_s1_r_z_rz_glb*4) + kernel_cgra_s0_z_z_cgra_z_cgra)*2) + 1)");
  hcompute_kernel_cgra_stencil_1->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "((kernel_cgra_s0_z_z_cgra_z_cgra*2) + 1)");
...
//consuming output_cgra.stencil
  auto output_glb_s0_y_y_cgra = prg.add_loop("output_glb_s0_y_y_cgra", 0, 7);
  auto output_glb_s0_x_x_cgra = output_glb_s0_y_y_cgra->add_loop("output_glb_s0_x_x_cgra", 0, 7);
  auto output_glb_s0_w_w_cgra = output_glb_s0_x_x_cgra->add_loop("output_glb_s0_w_w_cgra", 0, 64);
...
//store is: output_glb.stencil(output_glb_s0_w_w_cgra, output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra) = output_cgra.stencil(output_glb_s0_w_w_cgra, output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil->add_store("output_glb_stencil", "output_glb_s0_y_y_cgra", "output_glb_s0_x_x_cgra", "output_glb_s0_w_w_cgra");
...
// in_img=14 pad=1 ksize=3 stride=2 n_ic=16 n_oc=64 k_ic=8 k_oc=8 m_ic=1 m_oc=8
