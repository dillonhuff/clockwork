...
prog unsharp_large() {
  prog prg;
  prg.compute_unit_file = "unsharp_large_compute.h";
  prg.name = "unsharp_large";

// Stencil<uint16_t, 3, 2904, 2506> &hw_input_stencil = arg_1;
  prg.add_input("hw_input_stencil");
  prg.buffer_port_widths["hw_input_stencil"] = 16;
// Stencil<int16_t, 3, 1512, 2500> &hw_output_global_wrapper_stencil = arg_3;
...
////producing hw_input_global_wrapper.glb.stencil
  ...
  auto hw_input_global_wrapper_s0_x_x = hw_input_global_wrapper_s0_y->add_loop("hw_input_global_wrapper_s0_x_x", 0, 132);
...
////producing hw_input_global_wrapper_global_wrapper.stencil
  ...
  auto hw_input_global_wrapper_global_wrapper_s0_x_x = hw_input_global_wrapper_global_wrapper_s0_y->add_loop("hw_input_global_wrapper_global_wrapper_s0_x_x", 0, 132);
...
////producing gray.stencil
  ...
  auto gray_s0_x_x = gray_s0_y->add_loop("gray_s0_x_x", 0, 132);
...
////producing reciprocal.stencil
  ...
  auto reciprocal_s0_x_x = reciprocal_s0_y->add_loop("reciprocal_s0_x_x", 0, 126);
...
////producing blur_unnormalized.stencil
  ...
  auto blur_unnormalized_s0_x_x = blur_unnormalized_s0_y->add_loop("blur_unnormalized_s0_x_x", 0, 126);
...
//store is: blur_unnormalized.stencil(blur_unnormalized_s0_x_x, blur_unnormalized_s0_y) = (uint16)0
  ...
  auto blur_unnormalized_s1_x_x = blur_unnormalized_s1_y->add_loop("blur_unnormalized_s1_x_x", 0, 126);
...
////producing sharpen.stencil
  ...
  auto sharpen_s0_x_x = sharpen_s0_y->add_loop("sharpen_s0_x_x", 0, 126);
...
////producing ratio.stencil
  ...
  auto ratio_s0_x_x = ratio_s0_y->add_loop("ratio_s0_x_x", 0, 126);
...
//consuming ratio.stencil
  ...
  auto hw_output_s0_x_xi_xi = hw_output_s0_y_yi->add_loop("hw_output_s0_x_xi_xi", 0, 126);
...
//consuming hw_output.glb.stencil
  ...
  auto hw_output_global_wrapper_s0_x_xi_xi = hw_output_global_wrapper_s0_y_yi->add_loop("hw_output_global_wrapper_s0_x_xi_xi", 0, 126);
...
prog unsharp_isscc() {
  prog prg;
  prg.compute_unit_file = "unsharp_isscc_compute.h";
  prg.name = "unsharp_isscc";
...
////producing reciprocal.stencil
  ...
  auto reciprocal_s0_x_x = reciprocal_s0_y->add_loop("reciprocal_s0_x_x", 0, 66);
...
////producing blur_unnormalized.stencil
  ...
  auto blur_unnormalized_s0_x_x = blur_unnormalized_s0_y->add_loop("blur_unnormalized_s0_x_x", 0, 66);
...
//store is: blur_unnormalized.stencil(blur_unnormalized_s0_x_x, blur_unnormalized_s0_y) = (uint16)0
  ...
  auto blur_unnormalized_s1_x_x = blur_unnormalized_s1_y->add_loop("blur_unnormalized_s1_x_x", 0, 66);
...
////producing sharpen.stencil
  ...
  auto sharpen_s0_x_x = sharpen_s0_y->add_loop("sharpen_s0_x_x", 0, 66);
...
////producing ratio.stencil
  ...
  auto ratio_s0_x_x = ratio_s0_y->add_loop("ratio_s0_x_x", 0, 66);
