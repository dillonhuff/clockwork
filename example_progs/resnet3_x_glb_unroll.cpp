...
prog resnet3_x_glb_unroll() {
  prog prg;
  prg.compute_unit_file = "resnet3_x_glb_unroll_compute.h";
  prg.name = "resnet3_x_glb_unroll";
...
// Stencil<int16_t, 16, 16, 3, 3> &kernel_host_stencil = arg_1;
  prg.add_input("kernel_host_stencil");
  prg.buffer_port_widths["kernel_host_stencil"] = 16;
// Stencil<int16_t, 16, 28, 28> &hw_output_stencil = arg_2;
...
////producing input_glb.stencil
  ...
  auto input_glb_s0_z_z = input_glb_s0_x->add_loop("input_glb_s0_z_z", 0, 2);
...
////producing kernel_glb.stencil
  ...
  auto kernel_glb_s0_z_z = kernel_glb_s0_w->add_loop("kernel_glb_s0_z_z", 0, 4);
...
//store is: kernel_glb.stencil((kernel_glb_s0_z_z*4), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil((kernel_glb_s0_z_z*4), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  ...
  hcompute_kernel_glb_stencil->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "(kernel_glb_s0_z_z*4)");
  prg.buffer_port_widths["kernel_glb_stencil"] = 16;
  hcompute_kernel_glb_stencil->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "(kernel_glb_s0_z_z*4)");
...
//store is: kernel_glb.stencil(((kernel_glb_s0_z_z*4) + 1), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil(((kernel_glb_s0_z_z*4) + 1), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  auto hcompute_kernel_glb_stencil_1 = kernel_glb_s0_z_z->add_op("op_hcompute_kernel_glb_stencil_1");
  hcompute_kernel_glb_stencil_1->add_function("hcompute_kernel_glb_stencil_1");
  hcompute_kernel_glb_stencil_1->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 1)");
  hcompute_kernel_glb_stencil_1->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 1)");
...
//store is: kernel_glb.stencil(((kernel_glb_s0_z_z*4) + 2), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil(((kernel_glb_s0_z_z*4) + 2), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  auto hcompute_kernel_glb_stencil_2 = kernel_glb_s0_z_z->add_op("op_hcompute_kernel_glb_stencil_2");
  hcompute_kernel_glb_stencil_2->add_function("hcompute_kernel_glb_stencil_2");
  hcompute_kernel_glb_stencil_2->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 2)");
  hcompute_kernel_glb_stencil_2->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 2)");
...
//store is: kernel_glb.stencil(((kernel_glb_s0_z_z*4) + 3), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y) = kernel_host.stencil(((kernel_glb_s0_z_z*4) + 3), kernel_glb_s0_w, kernel_glb_s0_x, kernel_glb_s0_y)
  auto hcompute_kernel_glb_stencil_3 = kernel_glb_s0_z_z->add_op("op_hcompute_kernel_glb_stencil_3");
  hcompute_kernel_glb_stencil_3->add_function("hcompute_kernel_glb_stencil_3");
  hcompute_kernel_glb_stencil_3->add_load("kernel_host_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 3)");
  hcompute_kernel_glb_stencil_3->add_store("kernel_glb_stencil", "kernel_glb_s0_y", "kernel_glb_s0_x", "kernel_glb_s0_w", "((kernel_glb_s0_z_z*4) + 3)");
...
//store is: input_cgra.stencil(0, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil((output_cgra_s1_r_z_rz_glb*8), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "(output_cgra_s1_r_z_rz_glb*8)");
...
//store is: input_cgra.stencil(1, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 1), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_1->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 1)");
  hcompute_input_cgra_stencil_1->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "1");

//store is: input_cgra.stencil(2, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 2), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_2->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 2)");
  hcompute_input_cgra_stencil_2->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "2");

//store is: input_cgra.stencil(3, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 3), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_3->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 3)");
  hcompute_input_cgra_stencil_3->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "3");

//store is: input_cgra.stencil(4, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 4), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_4->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 4)");
  hcompute_input_cgra_stencil_4->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "4");

//store is: input_cgra.stencil(5, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 5), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_5->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 5)");
  hcompute_input_cgra_stencil_5->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "5");

//store is: input_cgra.stencil(6, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 6), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_6->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 6)");
  hcompute_input_cgra_stencil_6->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "6");

//store is: input_cgra.stencil(7, input_cgra_s0_x, input_cgra_s0_y) = input_glb.stencil(((output_cgra_s1_r_z_rz_glb*8) + 7), input_cgra_s0_x, ((output_glb_s0_y_y_glb*14) + input_cgra_s0_y))
  ...
  hcompute_input_cgra_stencil_7->add_load("input_glb_stencil", "((output_glb_s0_y_y_glb*14) + input_cgra_s0_y)", "input_cgra_s0_x", "((output_cgra_s1_r_z_rz_glb*8) + 7)");
  hcompute_input_cgra_stencil_7->add_store("input_cgra_stencil", "input_cgra_s0_y", "input_cgra_s0_x", "7");
...
////producing kernel_cgra.stencil
  ...
  auto kernel_cgra_s0_z_z_cgra_z_cgra = kernel_cgra_s0_w_w_cgra->add_loop("kernel_cgra_s0_z_z_cgra_z_cgra", 0, 2);
...
//store is: kernel_cgra.stencil((kernel_cgra_s0_z_z_cgra_z_cgra*4), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4), ((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra), kernel_cgra_s0_x, kernel_cgra_s0_y)
  auto hcompute_kernel_cgra_stencil = kernel_cgra_s0_z_z_cgra_z_cgra->add_op("op_hcompute_kernel_cgra_stencil");
  hcompute_kernel_cgra_stencil->add_function("hcompute_kernel_cgra_stencil");
  hcompute_kernel_cgra_stencil->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra)", "(((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4)");
  prg.buffer_port_widths["kernel_cgra_stencil"] = 16;
  hcompute_kernel_cgra_stencil->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "(kernel_cgra_s0_z_z_cgra_z_cgra*4)");
...
//store is: kernel_cgra.stencil(((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 1), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil(((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 1), ((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra), kernel_cgra_s0_x, kernel_cgra_s0_y)
  auto hcompute_kernel_cgra_stencil_1 = kernel_cgra_s0_z_z_cgra_z_cgra->add_op("op_hcompute_kernel_cgra_stencil_1");
  hcompute_kernel_cgra_stencil_1->add_function("hcompute_kernel_cgra_stencil_1");
  hcompute_kernel_cgra_stencil_1->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra)", "((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 1)");
  hcompute_kernel_cgra_stencil_1->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 1)");
...
//store is: kernel_cgra.stencil(((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 2), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil(((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 2), ((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra), kernel_cgra_s0_x, kernel_cgra_s0_y)
  auto hcompute_kernel_cgra_stencil_2 = kernel_cgra_s0_z_z_cgra_z_cgra->add_op("op_hcompute_kernel_cgra_stencil_2");
  hcompute_kernel_cgra_stencil_2->add_function("hcompute_kernel_cgra_stencil_2");
  hcompute_kernel_cgra_stencil_2->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra)", "((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 2)");
  hcompute_kernel_cgra_stencil_2->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 2)");
...
//store is: kernel_cgra.stencil(((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 3), kernel_cgra_s0_w_w_cgra, kernel_cgra_s0_x, kernel_cgra_s0_y) = kernel_glb.stencil(((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 3), ((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra), kernel_cgra_s0_x, kernel_cgra_s0_y)
  auto hcompute_kernel_cgra_stencil_3 = kernel_cgra_s0_z_z_cgra_z_cgra->add_op("op_hcompute_kernel_cgra_stencil_3");
  hcompute_kernel_cgra_stencil_3->add_function("hcompute_kernel_cgra_stencil_3");
  hcompute_kernel_cgra_stencil_3->add_load("kernel_glb_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "((output_glb_s0_w_w_glb*8) + kernel_cgra_s0_w_w_cgra)", "((((output_cgra_s1_r_z_rz_glb*2) + kernel_cgra_s0_z_z_cgra_z_cgra)*4) + 3)");
  hcompute_kernel_cgra_stencil_3->add_store("kernel_cgra_stencil", "kernel_cgra_s0_y", "kernel_cgra_s0_x", "kernel_cgra_s0_w_w_cgra", "((kernel_cgra_s0_z_z_cgra_z_cgra*4) + 3)");
...
//consuming output_cgra.stencil
  ...
  auto output_glb_s0_w_w_cgra_w_cgra = output_glb_s0_x_x_cgra->add_loop("output_glb_s0_w_w_cgra_w_cgra", 0, 2);
...
//store is: output_glb.stencil((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4), output_glb_s0_x_x_cgra, ((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)) = output_cgra.stencil((output_glb_s0_w_w_cgra_w_cgra*4), output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil->add_store("output_glb_stencil", "((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)", "output_glb_s0_x_x_cgra", "(((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4)");
...
//store is: output_glb.stencil(((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 1), output_glb_s0_x_x_cgra, ((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)) = output_cgra.stencil(((output_glb_s0_w_w_cgra_w_cgra*4) + 1), output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil_1->add_store("output_glb_stencil", "((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)", "output_glb_s0_x_x_cgra", "((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 1)");
...
//store is: output_glb.stencil(((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 2), output_glb_s0_x_x_cgra, ((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)) = output_cgra.stencil(((output_glb_s0_w_w_cgra_w_cgra*4) + 2), output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil_2->add_store("output_glb_stencil", "((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)", "output_glb_s0_x_x_cgra", "((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 2)");
...
//store is: output_glb.stencil(((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 3), output_glb_s0_x_x_cgra, ((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)) = output_cgra.stencil(((output_glb_s0_w_w_cgra_w_cgra*4) + 3), output_glb_s0_x_x_cgra, output_glb_s0_y_y_cgra)
  ...
  hcompute_output_glb_stencil_3->add_store("output_glb_stencil", "((output_glb_s0_y_y_glb*14) + output_glb_s0_y_y_cgra)", "output_glb_s0_x_x_cgra", "((((output_glb_s0_w_w_glb*2) + output_glb_s0_w_w_cgra_w_cgra)*4) + 3)");
