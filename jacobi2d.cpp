...
struct I_I_id0_0_to_I_out_jacobi2d_compute0_3_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_3: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_4: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_5: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_6: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_7: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
struct I_cache {
  I_I_id0_0_to_I_out_jacobi2d_compute0_3_cache I_I_id0_0_to_I_out_jacobi2d_compute0_3;
  I_I_id0_0_to_I_out_jacobi2d_compute0_4_cache I_I_id0_0_to_I_out_jacobi2d_compute0_4;
  I_I_id0_0_to_I_out_jacobi2d_compute0_5_cache I_I_id0_0_to_I_out_jacobi2d_compute0_5;
  I_I_id0_0_to_I_out_jacobi2d_compute0_6_cache I_I_id0_0_to_I_out_jacobi2d_compute0_6;
  I_I_id0_0_to_I_out_jacobi2d_compute0_7_cache I_I_id0_0_to_I_out_jacobi2d_compute0_7;
};



inline void I_I_id0_0_write(hw_uint<32> & I_I_id0_0, I_cache& I, int root, int id1, int id0) {
  I.I_I_id0_0_to_I_out_jacobi2d_compute0_3.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_jacobi2d_compute0_4.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_jacobi2d_compute0_5.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_jacobi2d_compute0_6.push(I_I_id0_0);
  I.I_I_id0_0_to_I_out_jacobi2d_compute0_7.push(I_I_id0_0);
}
...
inline hw_uint<32>  I_out_jacobi2d_compute0_3_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_jacobi2d_compute0_3 read pattern: { out_jacobi2d_compute0[root = 0, d1, d0] -> I[d0, 1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 30 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_jacobi2d_compute0_3.peek_0();
...
inline hw_uint<32>  I_out_jacobi2d_compute0_4_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_jacobi2d_compute0_4 read pattern: { out_jacobi2d_compute0[root = 0, d1, d0] -> I[1 + d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 30 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_jacobi2d_compute0_4.peek_31();
	return value_I_I_id0_0;
}
...
inline hw_uint<32>  I_out_jacobi2d_compute0_5_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_jacobi2d_compute0_5 read pattern: { out_jacobi2d_compute0[root = 0, d1, d0] -> I[d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 30 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_jacobi2d_compute0_5.peek_32();
	return value_I_I_id0_0;
}
...
inline hw_uint<32>  I_out_jacobi2d_compute0_6_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_jacobi2d_compute0_6 read pattern: { out_jacobi2d_compute0[root = 0, d1, d0] -> I[d0, -1 + d1] : 0 < d1 <= 30 and 0 < d0 <= 30 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_jacobi2d_compute0_6.peek_64();
	return value_I_I_id0_0;
}
...
inline hw_uint<32>  I_out_jacobi2d_compute0_7_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_out_jacobi2d_compute0_7 read pattern: { out_jacobi2d_compute0[root = 0, d1, d0] -> I[-1 + d0, d1] : 0 < d1 <= 30 and 0 < d0 <= 30 }
	auto value_I_I_id0_0 = I.I_I_id0_0_to_I_out_jacobi2d_compute0_7.peek_33();
	return value_I_I_id0_0;
}
