...
// Operation logic
inline void out_jacobi2d_compute0(I_I_id0_6_cache& I_I_id0_6, HWStream<hw_uint<32> >& /* num ports = 1 */out, int root, int d1, int d0) {
	// Consume: I
...
inline void I_id0(HWStream<hw_uint<32> >& /* num ports = 1 */in, I_I_id0_6_cache& I_I_id0_6, int root, int id1, int id0) {
	// Consume: in
...
// Driver function
void jacobi2d(HWStream<hw_uint<32> >& /* num ports = 1 */in, HWStream<hw_uint<32> >& /* num ports = 1 */out) {
