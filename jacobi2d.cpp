...
struct I_I_id0_0_to_I_out_jacobi2d_compute0_3_cache {
	...
	inline hw_uint<32>  peek(const int offset) {
		...
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_3_cache: " << offset << endl;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_4_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_5_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_6_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
#ifndef __VIVADO_SYNTH__
		cout << "Error: Unsupported offset in I_I_id0_0_to_I_out_jacobi2d_compute0_7_cache: " << offset << endl;
#endif // __VIVADO_SYNTH__
		assert(false);
		return 0;
...
inline hw_uint<32>  I_out_jacobi2d_compute0_3_select(I_cache& I, int root, int d1, int d0) {
  ...
  // I_I_id0_0 stores range: { I[i0, i1] : 0 <= i0 <= 31 and 0 <= i1 <= 31 }
