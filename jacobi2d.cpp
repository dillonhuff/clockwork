...
// Operation logic
inline void I_id0(HWStream<hw_uint<32> >& /* num ports = 1 */in, I_I_id0_0_cache& I_I_id0_0, int root, int id1, int id0) {
	// Consume: in
...
inline void out_jacobi2d_compute0(I_I_id0_0_cache& I_I_id0_0, HWStream<hw_uint<32> >& /* num ports = 1 */out, int root, int d1, int d0) {
	// Consume: I
