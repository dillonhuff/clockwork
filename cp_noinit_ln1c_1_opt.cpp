...
struct demosaic_diff_cache {
  // Reader addrs...
    // { cp_noinit_ln1c_1_update_0[d0, d1] -> demosaic_diff[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
inline void cp_noinit_ln1c_1_update_0(demosaic_diff_cache& demosaic_diff, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */cp_noinit_ln1c_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto demosaic_diff_1_m_cp_noinit_ln1c_1_1__p__0_c__1_m_cp_noinit_ln1c_1_0__p__0_value = demosaic_diff_cp_noinit_ln1c_1_update_0_read_bundle_read(demosaic_diff/* source_delay */, d0, d1, 0);

#ifndef __SYNTHESIS__
#endif //__SYNTHESIS__

	auto compute_result = cp_noinit_ln1c_1_generated_compute_unrolled_1(demosaic_diff_1_m_cp_noinit_ln1c_1_1__p__0_c__1_m_cp_noinit_ln1c_1_0__p__0_value);
...
// Condition for cp_noinit_ln1c_1_update_0(((((-11 + 1*i2)) == 0) && (((-5 + 1*i1)) >= 0) && (((1924 + -1*i1)) >= 0) && (((-5 + 1*i0)) >= 0) && (((1084 + -1*i0)) >= 0)))
...
#ifdef __SYNTHESIS__
  // { cp_noinit_ln1c_1_update_0[root = 0, cp_noinit_ln1c_1_0, cp_noinit_ln1c_1_1] -> cp_noinit_ln1c_1[cp_noinit_ln1c_1_1, cp_noinit_ln1c_1_0] : 0 <= cp_noinit_ln1c_1_0 <= 1079 and 0 <= cp_noinit_ln1c_1_1 <= 1919 }
