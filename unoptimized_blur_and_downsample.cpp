...
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek(((224 - 15 * I_blr_r) - I_blr_c));
...
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek(((223 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_19_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek((root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((222 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((210 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_20_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek(((209 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_21_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek(((208 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_22_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek((root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((207 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((195 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_23_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek((root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((194 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((14 - I_blr_c)) : 0);
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_24_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek((root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((193 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((13 - I_blr_c)) : 0);
	return value_I_store_I_from_in_14;
}

inline hw_uint<32>  I_I_blr_conv_3_30_25_select(I_store_I_from_in_14_cache& I_store_I_from_in_14_delay
, int root, int I_blr_r, int I_blr_c) {
	hw_uint<32>  value_I_store_I_from_in_14 = I_store_I_from_in_14_delay.peek((root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((192 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0) ? ((180 - 15 * I_blr_r)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? ((12 - I_blr_c)) : 0);
	return value_I_store_I_from_in_14;
}
	...
	I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0;
	{
	  ...
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blr_ds_id0(I_blr_I_blr_conv_3_30_16, I_blr_ds_I_blr_ds_id0_10, 0, c3, c5);
