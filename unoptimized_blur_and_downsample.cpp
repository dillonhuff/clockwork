...
inline hw_uint<32>  I_I_blr_conv_3_30_10_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_10 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_10_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((207 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((195 - 15 * I_blr_r)) : 0);
...
inline hw_uint<32>  I_I_blr_conv_3_30_11_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_11 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_11_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((194 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((14 - I_blr_c)) : 0);
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_12_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_12 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_12_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((193 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((13 - I_blr_c)) : 0);
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_13_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_13 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_13_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((192 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0) ? ((180 - 15 * I_blr_r)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? ((12 - I_blr_c)) : 0);
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_5_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_5 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_5_cache.peek(/* is one piece but not a number */((224 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_6_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_6 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_6_cache.peek(/* is one piece but not a number */((223 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_7_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_7 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_7_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((222 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((210 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_8_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_8 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_8_cache.peek(/* is one piece but not a number */((209 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_2;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_9_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_9 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
	auto value_I_store_I_from_in_2 = I.I_store_I_from_in_2_to_I_I_blr_conv_3_30_9_cache.peek(/* is one piece but not a number */((208 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_2;
}
...
struct I_blr_I_blr_conv_3_30_4_to_I_blr_I_blr_ds_id0_15_cache {
	// Capacity: 169
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_4_to_I_blr_I_blr_ds_id0_15_cache I_blr_I_blr_conv_3_30_4_to_I_blr_I_blr_ds_id0_15_cache;
};
...
inline void I_blr_I_blr_conv_3_30_4_write(hw_uint<32> & I_blr_I_blr_conv_3_30_4, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  I_blr.I_blr_I_blr_conv_3_30_4_to_I_blr_I_blr_ds_id0_15_cache.push(I_blr_I_blr_conv_3_30_4);
}
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_15_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // I_blr_I_blr_ds_id0_15 read pattern: { I_blr_ds_id0[root = 0, I_blr_ds_r, I_blr_ds_c] -> I_blr[2I_blr_ds_r, 2I_blr_ds_c] : 0 <= I_blr_ds_r <= 5 and 0 <= I_blr_ds_c <= 5 }
	auto value_I_blr_I_blr_conv_3_30_4 = I_blr.I_blr_I_blr_conv_3_30_4_to_I_blr_I_blr_ds_id0_15_cache.peek(/* is one piece but not a number */((168 - 26 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
struct I_blr_ds_cache {
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_22_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_22_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_23_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_23_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_24_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_24_cache;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_25_cache I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_25_cache;
};
...
inline void I_blr_ds_I_blr_ds_id0_14_write(hw_uint<32> & I_blr_ds_I_blr_ds_id0_14, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c) {
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_22_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_23_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_24_cache.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_25_cache.push(I_blr_ds_I_blr_ds_id0_14);
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_17_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_17 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[I_blr_ds_blr_r, I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache.peek(/* is one piece but not a number */((35 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_18_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_18 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache.peek(/* is one piece but not a number */((34 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_20_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_20 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache.peek(/* is one piece but not a number */((29 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_21_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_21 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache.peek(/* is one piece but not a number */((28 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_22_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_22 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[1 + I_blr_ds_blr_r, 2 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_22_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 2 - I_blr_ds_blr_c >= 0) ? (((27 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_c == 0 && root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0) ? ((24 - 6 * I_blr_ds_blr_r)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_24_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_24 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[2 + I_blr_ds_blr_r, 1 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_24_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 2 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 3 - I_blr_ds_blr_c >= 0) ? (((22 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_r == 0 && root == 0 && I_blr_ds_blr_c >= 0 && 3 - I_blr_ds_blr_c >= 0) ? ((4 - I_blr_ds_blr_c)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_25_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_blr_conv_3_30_25 read pattern: { I_blr_ds_blr_conv_3_30[root = 0, I_blr_ds_blr_r, I_blr_ds_blr_c] -> I_blr_ds[2 + I_blr_ds_blr_r, 2 + I_blr_ds_blr_c] : 0 <= I_blr_ds_blr_r <= 3 and 0 <= I_blr_ds_blr_c <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_25_cache.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 2 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 2 - I_blr_ds_blr_c >= 0) ? (((21 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_c == 0 && root == 0 && I_blr_ds_blr_r >= 0 && 2 - I_blr_ds_blr_r >= 0) ? ((18 - 6 * I_blr_ds_blr_r)) : (-3 + I_blr_ds_blr_r == 0 && root == 0 && I_blr_ds_blr_c >= 0 && 2 - I_blr_ds_blr_c >= 0) ? ((3 - I_blr_ds_blr_c)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_1_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_1_cache;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_1_cache.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_16);
}
