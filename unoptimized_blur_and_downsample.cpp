...
inline void I_store_I_from_in_write_bundle_write(hw_uint<32> & /* width = 32*/store_I_from_in_write, I_store_I_from_in_24_cache& I_store_I_from_in_24_delay) {
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_23_select(I_blr_I_blr_conv_3_30_12_cache& I_blr_I_blr_conv_3_30_12_delay
, int root, int I_blr_ds_r, int I_blr_ds_c) {
	hw_uint<32>  value_I_blr_I_blr_conv_3_30_12 = I_blr_I_blr_conv_3_30_12_delay.peek(((168 - 26 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
inline hw_uint<32> I_blr_I_blr_ds_id0_read_bundle_read(I_blr_I_blr_conv_3_30_12_cache& I_blr_I_blr_conv_3_30_12_delay, int root, int I_blr_ds_r, int I_blr_ds_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_I_blr_ds_id0_23_res = I_blr_I_blr_ds_id0_23_select(I_blr_I_blr_conv_3_30_12_delay, root, I_blr_ds_r, I_blr_ds_c);
...
inline hw_uint<32>  I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_delay
...
inline hw_uint<32> I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_read_bundle_read(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_delay, int root, int I_blr_ds_blr_out_r, int I_blr_ds_blr_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11_res = I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_delay, root, I_blr_ds_blr_out_r, I_blr_ds_blr_out_c);
...
inline void I_blr_conv_3_30(I_store_I_from_in_24_cache& I_store_I_from_in_24, I_blr_I_blr_conv_3_30_12_cache& I_blr_I_blr_conv_3_30_12, int root, int I_blr_r, int I_blr_c) {
	// Consume: I
...
inline void I_blr_ds_id0(I_blr_I_blr_conv_3_30_12_cache& I_blr_I_blr_conv_3_30_12, I_blr_ds_I_blr_ds_id0_22_cache& I_blr_ds_I_blr_ds_id0_22, int root, int I_blr_ds_r, int I_blr_ds_c) {
	// Consume: I_blr
	...
	I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_cache I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0;
	{
	  ...
	  for (int c3 = 0; c3 <= 12; c3 += 1)
	    for (int c5 = 0; c5 <= 12; c5 += 1)
	      I_blr_conv_3_30(I_store_I_from_in_24, I_blr_I_blr_conv_3_30_12, 0, c3, c5);
	  for (int c3 = 0; c3 <= 5; c3 += 1)
	    for (int c5 = 0; c5 <= 5; c5 += 1)
	      I_blr_ds_id0(I_blr_I_blr_conv_3_30_12, I_blr_ds_I_blr_ds_id0_22, 0, c3, c5);
