...
struct I_store_I_from_in_0_to_I_I_blr_conv_3_30_3_cache {
	// Capacity: 225
	fifo<hw_uint<32> , 225> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(224 - offset);
...
struct I_store_I_from_in_0_to_I_I_blr_conv_3_30_4_cache {
	// Capacity: 225
	fifo<hw_uint<32> , 225> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(224 - offset);
...
struct I_cache {
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_10_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_10;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_11_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_11;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_3_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_3;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_4_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_4;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_5_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_5;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_6_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_6;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_7_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_7;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_8_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_8;
  I_store_I_from_in_0_to_I_I_blr_conv_3_30_9_cache bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_9;
};



inline void I_store_I_from_in_0_write(hw_uint<32> & I_store_I_from_in_0, I_cache& I, int root, int pr, int pc) {
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_10.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_11.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_3.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_4.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_5.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_6.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_7.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_8.push(I_store_I_from_in_0);
  I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_9.push(I_store_I_from_in_0);
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_10_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_10 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 2 <= i0 <= 14 and 0 < i1 <= 13 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_10.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((193 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((13 - I_blr_c)) : 0);
...
inline hw_uint<32>  I_I_blr_conv_3_30_11_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_11 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 2 <= i0 <= 14 and 2 <= i1 <= 14 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_11.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((192 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0) ? ((180 - 15 * I_blr_r)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? ((12 - I_blr_c)) : 0);
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_3_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_3 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 <= i0 <= 12 and 0 <= i1 <= 12 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_3.peek(/* is one piece but not a number */((224 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_4_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_4 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 <= i0 <= 12 and 0 < i1 <= 13 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_4.peek(/* is one piece but not a number */((223 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_5_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_5 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 <= i0 <= 12 and 2 <= i1 <= 14 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_5.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((222 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((210 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_6_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_6 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 < i0 <= 13 and 0 <= i1 <= 12 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_6.peek(/* is one piece but not a number */((209 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_7_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_7 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 1 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 < i0 <= 13 and 0 < i1 <= 13 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_7.peek(/* is one piece but not a number */((208 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_8_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_8 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[1 + I_blr_r, 2 + I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 0 < i0 <= 13 and 2 <= i1 <= 14 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_8.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((207 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((195 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_0;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_9_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_I_blr_conv_3_30_9 read pattern: { I_blr_conv_3_30[root = 0, I_blr_r, I_blr_c] -> I[2 + I_blr_r, I_blr_c] : 0 <= I_blr_r <= 12 and 0 <= I_blr_c <= 12 }
  // I_store_I_from_in_0 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
    // overlap with reads : { I[i0, i1] : 2 <= i0 <= 14 and 0 <= i1 <= 12 }
	auto value_I_store_I_from_in_0 = I.bank_I_store_I_from_in_0_to_I_I_blr_conv_3_30_9.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((194 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((14 - I_blr_c)) : 0);
	return value_I_store_I_from_in_0;
}
...
struct I_blr_I_blr_conv_3_30_2_to_I_blr_I_blr_ds_id0_25_cache {
	// Capacity: 169
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_2_to_I_blr_I_blr_ds_id0_25_cache bank_I_blr_I_blr_conv_3_30_2_to_I_blr_I_blr_ds_id0_25;
};



inline void I_blr_I_blr_conv_3_30_2_write(hw_uint<32> & I_blr_I_blr_conv_3_30_2, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  I_blr.bank_I_blr_I_blr_conv_3_30_2_to_I_blr_I_blr_ds_id0_25.push(I_blr_I_blr_conv_3_30_2);
}
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_25_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // I_blr_I_blr_conv_3_30_2 stores range: { I_blr[i0, i1] : 0 <= i0 <= 12 and 0 <= i1 <= 12 }
    // overlap with reads : { I_blr[i0, i1] : (i0) mod 2 = 0 and (i1) mod 2 = 0 and 0 <= i0 <= 10 and 0 <= i1 <= 10 }
	auto value_I_blr_I_blr_conv_3_30_2 = I_blr.bank_I_blr_I_blr_conv_3_30_2_to_I_blr_I_blr_ds_id0_25.peek(/* is one piece but not a number */((168 - 26 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
inline void I_blr_I_blr_conv_3_30_write_bundle_write(hw_uint<32>& I_blr_conv_3_30_write, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
	...
	I_blr_I_blr_conv_3_30_2_write(I_blr_I_blr_conv_3_30_2_res, I_blr, root, I_blr_r, I_blr_c);
}
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_13_cache {
	// Capacity: 36
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_14_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_15_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_16_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_cache {
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_13_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_13;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_14_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_14;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_15_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_15;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_16_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_16;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20;
  I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21_cache bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21;
};
...
inline void I_blr_ds_I_blr_ds_id0_24_write(hw_uint<32> & I_blr_ds_I_blr_ds_id0_24, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c) {
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_13.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_14.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_15.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_16.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_20.push(I_blr_ds_I_blr_ds_id0_24);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_21.push(I_blr_ds_I_blr_ds_id0_24);
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_13_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
    // overlap with reads : { I_blr_ds[i0, i1] : 0 <= i0 <= 3 and 0 <= i1 <= 3 }
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_13.peek(/* is one piece but not a number */((35 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_14_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_14.peek(/* is one piece but not a number */((34 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_15_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_15.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 2 - I_blr_ds_blr_c >= 0) ? (((33 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_c == 0 && root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0) ? ((30 - 6 * I_blr_ds_blr_r)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_16_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_16.peek(/* is one piece but not a number */((29 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_17_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_17.peek(/* is one piece but not a number */((28 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_18_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_18.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 2 - I_blr_ds_blr_c >= 0) ? (((27 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_c == 0 && root == 0 && I_blr_ds_blr_r >= 0 && 3 - I_blr_ds_blr_r >= 0) ? ((24 - 6 * I_blr_ds_blr_r)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_19_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_24 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_24 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_24_to_I_blr_ds_I_blr_ds_blr_conv_3_30_19.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_r >= 0 && 2 - I_blr_ds_blr_r >= 0 && I_blr_ds_blr_c >= 0 && 3 - I_blr_ds_blr_c >= 0) ? (((23 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c)) : (-3 + I_blr_ds_blr_r == 0 && root == 0 && I_blr_ds_blr_c >= 0 && 3 - I_blr_ds_blr_c >= 0) ? ((5 - I_blr_ds_blr_c)) : 0);
	return value_I_blr_ds_I_blr_ds_id0_24;
}
...
struct I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_23_cache {
	// Capacity: 16
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_23_cache bank_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_23;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.bank_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_23.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_12);
}
