...
struct I_store_I_from_in_12_to_I_I_blr_conv_3_30_24_cache {
	// Capacity: 225
	fifo<hw_uint<32> , 225> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(224 - offset);
...
struct I_store_I_from_in_12_to_I_I_blr_conv_3_30_25_cache {
	// Capacity: 225
	fifo<hw_uint<32> , 225> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(224 - offset);
...
struct I_cache {
  ...
  I_store_I_from_in_12_to_I_I_blr_conv_3_30_24_cache bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_24;
  I_store_I_from_in_12_to_I_I_blr_conv_3_30_25_cache bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_25;
};
...
inline void I_store_I_from_in_12_write(hw_uint<32> & I_store_I_from_in_12, I_cache& I, int root, int pr, int pc) {
  ...
  I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_24.push(I_store_I_from_in_12);
  I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_25.push(I_store_I_from_in_12);
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_17_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_17.peek(/* is one piece but not a number */((224 - 15 * I_blr_r) - I_blr_c));
...
inline hw_uint<32>  I_I_blr_conv_3_30_18_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_18.peek(/* is one piece but not a number */((223 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_19_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_19.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((222 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((210 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_20_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_20.peek(/* is one piece but not a number */((209 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_21_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_21.peek(/* is one piece but not a number */((208 - 15 * I_blr_r) - I_blr_c));
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_22_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_22.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((207 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 12 - I_blr_r >= 0) ? ((195 - 15 * I_blr_r)) : 0);
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_23_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_23.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((194 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((14 - I_blr_c)) : 0);
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_24_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_24.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? (((193 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 12 - I_blr_c >= 0) ? ((13 - I_blr_c)) : 0);
	return value_I_store_I_from_in_12;
}
...
inline hw_uint<32>  I_I_blr_conv_3_30_25_select(I_cache& I, int root, int I_blr_r, int I_blr_c) {
  ...
  // I_store_I_from_in_12 stores range: { I[i0, i1] : 0 <= i0 <= 14 and 0 <= i1 <= 14 }
	...
	auto value_I_store_I_from_in_12 = I.bank_I_store_I_from_in_12_to_I_I_blr_conv_3_30_25.peek(/* Needs general delay string */ (root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? (((192 - 15 * I_blr_r) - I_blr_c)) : (-12 + I_blr_c == 0 && root == 0 && I_blr_r >= 0 && 11 - I_blr_r >= 0) ? ((180 - 15 * I_blr_r)) : (-12 + I_blr_r == 0 && root == 0 && I_blr_c >= 0 && 11 - I_blr_c >= 0) ? ((12 - I_blr_c)) : 0);
	return value_I_store_I_from_in_12;
}
...
struct I_blr_cache {
  I_blr_I_blr_conv_3_30_16_to_I_blr_I_blr_ds_id0_15_cache bank_I_blr_I_blr_conv_3_30_16_to_I_blr_I_blr_ds_id0_15;
};
...
inline void I_blr_I_blr_conv_3_30_16_write(hw_uint<32> & I_blr_I_blr_conv_3_30_16, I_blr_cache& I_blr, int root, int I_blr_r, int I_blr_c) {
  I_blr.bank_I_blr_I_blr_conv_3_30_16_to_I_blr_I_blr_ds_id0_15.push(I_blr_I_blr_conv_3_30_16);
}
...
inline hw_uint<32>  I_blr_I_blr_ds_id0_15_select(I_blr_cache& I_blr, int root, int I_blr_ds_r, int I_blr_ds_c) {
  ...
  // I_blr_I_blr_conv_3_30_16 stores range: { I_blr[i0, i1] : 0 <= i0 <= 12 and 0 <= i1 <= 12 }
    // overlap with reads : { I_blr[i0, i1] : (i0) mod 2 = 0 and (i1) mod 2 = 0 and 0 <= i0 <= 10 and 0 <= i1 <= 10 }
	auto value_I_blr_I_blr_conv_3_30_16 = I_blr.bank_I_blr_I_blr_conv_3_30_16_to_I_blr_I_blr_ds_id0_15.peek(/* is one piece but not a number */((168 - 26 * I_blr_ds_r) - 2 * I_blr_ds_c));
...
struct I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_1_cache {
	// Capacity: 36
...
struct I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_2_cache {
	// Capacity: 36
	fifo<hw_uint<32> , 36> f;
	inline hw_uint<32>  peek(const int offset) {
    return f.peek(35 - offset);
...
struct I_blr_ds_cache {
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_1_cache bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_1;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_2_cache bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_2;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_3_cache bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_3;
  I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_4_cache bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_4;
...
inline void I_blr_ds_I_blr_ds_id0_14_write(hw_uint<32> & I_blr_ds_I_blr_ds_id0_14, I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_r, int I_blr_ds_c) {
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_1.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_2.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_3.push(I_blr_ds_I_blr_ds_id0_14);
  I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_4.push(I_blr_ds_I_blr_ds_id0_14);
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_1_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_14 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_1.peek(/* is one piece but not a number */((35 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_2_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_14 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_2.peek(/* is one piece but not a number */((34 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_4_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_14 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_4.peek(/* is one piece but not a number */((29 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
inline hw_uint<32>  I_blr_ds_I_blr_ds_blr_conv_3_30_5_select(I_blr_ds_cache& I_blr_ds, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  ...
  // I_blr_ds_I_blr_ds_id0_14 stores range: { I_blr_ds[i0, i1] : 0 <= i0 <= 5 and 0 <= i1 <= 5 }
	...
	auto value_I_blr_ds_I_blr_ds_id0_14 = I_blr_ds.bank_I_blr_ds_I_blr_ds_id0_14_to_I_blr_ds_I_blr_ds_blr_conv_3_30_5.peek(/* is one piece but not a number */((28 - 6 * I_blr_ds_blr_r) - I_blr_ds_blr_c));
	return value_I_blr_ds_I_blr_ds_id0_14;
}
...
struct I_blr_ds_blr_cache {
  I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11_cache bank_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11;
};
...
inline void I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_write(hw_uint<32> & I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0, I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_r, int I_blr_ds_blr_c) {
  I_blr_ds_blr.bank_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11.push(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0);
}
...
inline hw_uint<32>  I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11_select(I_blr_ds_blr_cache& I_blr_ds_blr, int root, int I_blr_ds_blr_out_r, int I_blr_ds_blr_out_c) {
  ...
  // I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0 stores range: { I_blr_ds_blr[i0, i1] : 0 <= i0 <= 3 and 0 <= i1 <= 3 }
	...
	auto value_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0 = I_blr_ds_blr.bank_I_blr_ds_blr_I_blr_ds_blr_conv_3_30_0_to_I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_11.peek(/* Needs general delay string */ (root == 0 && I_blr_ds_blr_out_r >= 0 && 2 - I_blr_ds_blr_out_r >= 0 && I_blr_ds_blr_out_c >= 0 && 2 - I_blr_ds_blr_out_c >= 0) ? (((15 - 4 * I_blr_ds_blr_out_r) - I_blr_ds_blr_out_c)) : (-3 + I_blr_ds_blr_out_c == 0 && root == 0 && I_blr_ds_blr_out_r >= 0 && 2 - I_blr_ds_blr_out_r >= 0) ? ((12 - 4 * I_blr_ds_blr_out_r)) : (-3 + I_blr_ds_blr_out_r == 0 && root == 0 && I_blr_ds_blr_out_c >= 0 && 2 - I_blr_ds_blr_out_c >= 0) ? ((3 - I_blr_ds_blr_out_c)) : 0);
