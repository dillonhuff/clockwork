...
inline hw_uint<32>  I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_5_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_delay
...
inline hw_uint<32> I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_read_bundle_read(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_cache& I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_delay, int root, int I_blr_ds_blr_out_r, int I_blr_ds_blr_out_c) {
	hw_uint<32> result;
	hw_uint<32>  I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_5_res = I_blr_ds_blr_store_I_blr_ds_blr_out_from_I_blr_ds_blr_5_select(I_blr_ds_blr_I_blr_ds_blr_conv_3_30_6_delay, root, I_blr_ds_blr_out_r, I_blr_ds_blr_out_c);
