...
struct in_gauss_ds_3_cache {
  // Reader addrs...
    // { gp_fpga_16_update_0[d0, d1] -> in_gauss_ds_3[2d0, d1] : 0 <= d0 <= 119 and 0 <= d1 <= 134 }
    // { gp_fpga_16_update_0[d0, d1] -> in_gauss_ds_3[1 + 2d0, d1] : 0 <= d0 <= 119 and 0 <= d1 <= 134 }
  // # of banks: 2
...
inline void gp_fpga_16_update_0(in_gauss_ds_3_cache& in_gauss_ds_3, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */gp_fpga_16, int d0, int d1) {
  // Dynamic address computation
	...
	auto in_gauss_ds_3_1_m_gp_fpga_16_1__p__0_c__1_m_gp_fpga_16_0__p__0_value = in_gauss_ds_3_gp_fpga_16_update_0_read_bundle_read(in_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __SYNTHESIS__
#endif //__SYNTHESIS__

	auto compute_result = id_unrolled_2(in_gauss_ds_3_1_m_gp_fpga_16_1__p__0_c__1_m_gp_fpga_16_0__p__0_value);
	// Produce: gp_fpga_16
...
// Condition for gp_fpga_16_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-8 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((122 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
...
#ifdef __SYNTHESIS__
  // { gp_fpga_16_update_0[root = 0, gp_fpga_16_0, gp_fpga_16_1] -> gp_fpga_16[gp_fpga_16_1, gp_fpga_16_0] : 0 <= gp_fpga_16_0 <= 134 and 0 <= gp_fpga_16_1 <= 119 }
