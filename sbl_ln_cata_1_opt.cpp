...
#endif //__SYNTHESIS__
// compute file: sbl_ln_cata_1_opt_compute_units.h
#include "sbl_ln_cata_1_opt_compute_units.h"
...
struct mag_x_mag_x_update_0_write0_to_sbl_ln_cata_1_rd0_cache {
...
struct mag_x_cache {
  // Reader addrs...
    // { sbl_ln_cata_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
  mag_x_mag_x_update_0_write0_to_sbl_ln_cata_1_rd0_cache mag_x_mag_x_update_0_write0_to_sbl_ln_cata_1_rd0;
};
...
inline void mag_x_mag_x_update_0_write0_write(hw_uint<16>& mag_x_mag_x_update_0_write0, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write0_to_sbl_ln_cata_1_rd0.push(mag_x_mag_x_update_0_write0);
}

inline hw_uint<16> sbl_ln_cata_1_rd0_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __SYTHESIS__
#endif //__SYNTHESIS__
  // sbl_ln_cata_1_rd0 read pattern: { sbl_ln_cata_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl_ln_cata_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write0 = mag_x.mag_x_mag_x_update_0_write0_to_sbl_ln_cata_1_rd0.peek(/* one reader or all rams */ 0);
...
// sbl_ln_cata_1_update_0_read
//	sbl_ln_cata_1_rd0
inline hw_uint<16> mag_x_sbl_ln_cata_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // sbl_ln_cata_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl_ln_cata_1_rd0_res = sbl_ln_cata_1_rd0_select(mag_x, d0, d1, dynamic_address);
	set_at<0, 16>(result, sbl_ln_cata_1_rd0_res);
	return result;
}

struct mag_y_mag_y_update_0_write0_to_sbl_ln_cata_1_rd0_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_cache {
  // Reader addrs...
    // { sbl_ln_cata_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
  mag_y_mag_y_update_0_write0_to_sbl_ln_cata_1_rd0_cache mag_y_mag_y_update_0_write0_to_sbl_ln_cata_1_rd0;
};
...
inline void mag_y_mag_y_update_0_write0_write(hw_uint<16>& mag_y_mag_y_update_0_write0, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write0_to_sbl_ln_cata_1_rd0.push(mag_y_mag_y_update_0_write0);
}

inline hw_uint<16> sbl_ln_cata_1_rd0_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __SYTHESIS__
#endif //__SYNTHESIS__
  // sbl_ln_cata_1_rd0 read pattern: { sbl_ln_cata_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl_ln_cata_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write0 = mag_y.mag_y_mag_y_update_0_write0_to_sbl_ln_cata_1_rd0.peek(/* one reader or all rams */ 0);
...
// sbl_ln_cata_1_update_0_read
//	sbl_ln_cata_1_rd0
inline hw_uint<16> mag_y_sbl_ln_cata_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // sbl_ln_cata_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl_ln_cata_1_rd0_res = sbl_ln_cata_1_rd0_select(mag_y, d0, d1, dynamic_address);
	set_at<0, 16>(result, sbl_ln_cata_1_rd0_res);
	return result;
}
...
inline void sbl_ln_cata_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sbl_ln_cata_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: mag_x
	auto mag_x_1_m_sbl_ln_cata_1_1__p__0_c__1_m_sbl_ln_cata_1_0__p__0_value = mag_x_sbl_ln_cata_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __SYNTHESIS__
#endif //__SYNTHESIS__

	// Consume: mag_y
	auto mag_y_1_m_sbl_ln_cata_1_1__p__0_c__1_m_sbl_ln_cata_1_0__p__0_value = mag_y_sbl_ln_cata_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __SYNTHESIS__
#endif //__SYNTHESIS__

	auto compute_result = sbl_ln_cata_1_generated_compute_unrolled_1(mag_x_1_m_sbl_ln_cata_1_1__p__0_c__1_m_sbl_ln_cata_1_0__p__0_value, mag_y_1_m_sbl_ln_cata_1_1__p__0_c__1_m_sbl_ln_cata_1_0__p__0_value);
	// Produce: sbl_ln_cata_1
	sbl_ln_cata_1.write(compute_result);
...
// Driver function
void sbl_ln_cata_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl_ln_cata_1) {

#ifndef __SYNTHESIS__
  ofstream debug_file("sbl_ln_cata_1_opt_debug.csv");
...
// schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 1920 and -1 <= d1 <= 1080; sbl_ln_cata_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
//   { sbl_ln_cata_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for sbl_ln_cata_1_update_0(((((-4 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1920 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
...
// Condition for mag_x_update_0(((((-3 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1920 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
	  ...
	  // Schedules...
	    ...
	    // sbl_ln_cata_1_update_0 -> [1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*4]
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
	      sbl_ln_cata_1_update_0(mag_x /* buf name */, mag_y /* buf name */, sbl_ln_cata_1, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void sbl_ln_cata_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl_ln_cata_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    sbl_ln_cata_1_opt(off_chip_img, sbl_ln_cata_1);
  }
}
#ifdef __SYNTHESIS__
...
const int img_update_0_read_pipe0_num_transfers = 2079604;
  // { sbl_ln_cata_1_update_0[root = 0, sbl_ln_cata_1_0, sbl_ln_cata_1_1] -> sbl_ln_cata_1[sbl_ln_cata_1_1, sbl_ln_cata_1_0] : 0 <= sbl_ln_cata_1_0 <= 1079 and 0 <= sbl_ln_cata_1_1 <= 1919 }
const int sbl_ln_cata_1_update_0_write_pipe0_num_transfers = 2073600;


extern "C" {

void sbl_ln_cata_1_opt_accel(hw_uint<16>* img_update_0_read_pipe0, hw_uint<16>* sbl_ln_cata_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sbl_ln_cata_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = sbl_ln_cata_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > sbl_ln_cata_1_update_0_write_pipe0_channel;

  burst_read<16>(img_update_0_read_pipe0, img_update_0_read_pipe0_channel, img_update_0_read_pipe0_num_transfers*30);

  sbl_ln_cata_1_opt_wrapper(img_update_0_read_pipe0_channel, sbl_ln_cata_1_update_0_write_pipe0_channel, size);

  burst_write<16>(sbl_ln_cata_1_update_0_write_pipe0, sbl_ln_cata_1_update_0_write_pipe0_channel, sbl_ln_cata_1_update_0_write_pipe0_num_transfers*30);
}

}
extern "C" {

void sbl_ln_cata_1_opt_rdai(HWStream<hw_uint<16> >& img_update_0_read_pipe0, HWStream<hw_uint<16> >&  sbl_ln_cata_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = img_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = sbl_ln_cata_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  sbl_ln_cata_1_opt(img_update_0_read_pipe0, sbl_ln_cata_1_update_0_write_pipe0);
