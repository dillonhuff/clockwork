...
#include "mp_8_opt_compute_units.h"
...
inline hw_uint<32>  mp_8_rd0_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd0 read pattern: { mp_8_update_0[d0, d1, d2] -> in[8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd1_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd1 read pattern: { mp_8_update_0[d0, d1, d2] -> in[8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd10_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd10 read pattern: { mp_8_update_0[d0, d1, d2] -> in[5 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd11_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd11 read pattern: { mp_8_update_0[d0, d1, d2] -> in[5 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd12_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd12 read pattern: { mp_8_update_0[d0, d1, d2] -> in[6 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd13_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd13 read pattern: { mp_8_update_0[d0, d1, d2] -> in[6 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd14_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd14 read pattern: { mp_8_update_0[d0, d1, d2] -> in[7 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd15_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd15 read pattern: { mp_8_update_0[d0, d1, d2] -> in[7 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd2_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd2 read pattern: { mp_8_update_0[d0, d1, d2] -> in[1 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd3_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd3 read pattern: { mp_8_update_0[d0, d1, d2] -> in[1 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd4_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd4 read pattern: { mp_8_update_0[d0, d1, d2] -> in[2 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd5_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd5 read pattern: { mp_8_update_0[d0, d1, d2] -> in[2 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd6_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd6 read pattern: { mp_8_update_0[d0, d1, d2] -> in[3 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd7_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd7 read pattern: { mp_8_update_0[d0, d1, d2] -> in[3 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
inline hw_uint<32>  mp_8_rd8_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd8 read pattern: { mp_8_update_0[d0, d1, d2] -> in[4 + 8d0, 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: { mp_8_update_0[d0, d1, d2] -> 16 : 0 < d0 <= 14 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> (1 + d0) : d0 = 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31; mp_8_update_0[d0, d1, d2] -> 16 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  mp_8_rd9_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp_8_rd9 read pattern: { mp_8_update_0[d0, d1, d2] -> in[4 + 8d0, 1 + 2d1, d2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Read schedule : { mp_8_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 15 and 0 <= d1 <= 63 and 0 <= d2 <= 31 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 15 and 0 <= d1 <= 127 and 0 <= d2 <= 31 }
  // DD fold: {  }
...
//	mp_8_rd14
//	mp_8_rd15
inline hw_uint<512> in_mp_8_update_0_read_bundle_read(in_cache& in, int d0, int d1, int d2) {
  // # of ports in bundle: 16
	...
	hw_uint<512> result;
	hw_uint<32>  mp_8_rd0_res = mp_8_rd0_select(in, d0, d1, d2);
	set_at<0, 512>(result, mp_8_rd0_res);
	hw_uint<32>  mp_8_rd1_res = mp_8_rd1_select(in, d0, d1, d2);
	set_at<32, 512>(result, mp_8_rd1_res);
	hw_uint<32>  mp_8_rd2_res = mp_8_rd2_select(in, d0, d1, d2);
	set_at<64, 512>(result, mp_8_rd2_res);
	hw_uint<32>  mp_8_rd3_res = mp_8_rd3_select(in, d0, d1, d2);
	set_at<96, 512>(result, mp_8_rd3_res);
	hw_uint<32>  mp_8_rd4_res = mp_8_rd4_select(in, d0, d1, d2);
	set_at<128, 512>(result, mp_8_rd4_res);
	hw_uint<32>  mp_8_rd5_res = mp_8_rd5_select(in, d0, d1, d2);
	set_at<160, 512>(result, mp_8_rd5_res);
	hw_uint<32>  mp_8_rd6_res = mp_8_rd6_select(in, d0, d1, d2);
	set_at<192, 512>(result, mp_8_rd6_res);
	hw_uint<32>  mp_8_rd7_res = mp_8_rd7_select(in, d0, d1, d2);
	set_at<224, 512>(result, mp_8_rd7_res);
	hw_uint<32>  mp_8_rd8_res = mp_8_rd8_select(in, d0, d1, d2);
	set_at<256, 512>(result, mp_8_rd8_res);
	hw_uint<32>  mp_8_rd9_res = mp_8_rd9_select(in, d0, d1, d2);
	set_at<288, 512>(result, mp_8_rd9_res);
	hw_uint<32>  mp_8_rd10_res = mp_8_rd10_select(in, d0, d1, d2);
	set_at<320, 512>(result, mp_8_rd10_res);
	hw_uint<32>  mp_8_rd11_res = mp_8_rd11_select(in, d0, d1, d2);
	set_at<352, 512>(result, mp_8_rd11_res);
	hw_uint<32>  mp_8_rd12_res = mp_8_rd12_select(in, d0, d1, d2);
	set_at<384, 512>(result, mp_8_rd12_res);
	hw_uint<32>  mp_8_rd13_res = mp_8_rd13_select(in, d0, d1, d2);
	set_at<416, 512>(result, mp_8_rd13_res);
	hw_uint<32>  mp_8_rd14_res = mp_8_rd14_select(in, d0, d1, d2);
	set_at<448, 512>(result, mp_8_rd14_res);
	hw_uint<32>  mp_8_rd15_res = mp_8_rd15_select(in, d0, d1, d2);
	set_at<480, 512>(result, mp_8_rd15_res);
	return result;
}
...
// Driver function
void mp_8_opt(HWStream<hw_uint<256> >& /* get_args num ports = 8 */in_oc, HWStream<hw_uint<128> >& /* get_args num ports = 4 */mp_8, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("mp_8_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // mp_8_update_0 -> [1*d2*1*1 + 1*0,1*d1*1*2 + 1*1,1*d0*1*1 + 1*0,1*2]
	...
	#pragma HLS pipeline II=1
	      ...
	      if ((0 <= c2 && c2 <= 15) && ((c2 - 0) % 1 == 0) && (0 <= c1 && c1 <= 127) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 31) && ((c0 - 0) % 1 == 0)) {
	in_update_0(in_oc, in, (c2 - 0) / 1, (c1 - 0) / 1, (c0 - 0) / 1);
	      }
	
	      if ((0 <= c2 && c2 <= 15) && ((c2 - 0) % 1 == 0) && (1 <= c1 && c1 <= 127) && ((c1 - 1) % 2 == 0) && (0 <= c0 && c0 <= 31) && ((c0 - 0) % 1 == 0)) {
	mp_8_update_0(in, mp_8, (c2 - 0) / 1, (c1 - 1) / 2, (c0 - 0) / 1);
	      }
...
void mp_8_opt(HWStream<hw_uint<256> >& /* get_args num ports = 8 */in_oc, HWStream<hw_uint<128> >& /* get_args num ports = 4 */mp_8) {

  mp_8_opt(in_oc, mp_8, 1);
}
#ifdef __VIVADO_SYNTH__
#include "mp_8_opt.h"

const int in_update_0_read_num_transfers = 65536;
const int mp_8_update_0_write_num_transfers = 32768;
...
static void write_mp_8_update_0_write(hw_uint<128>* output, HWStream<hw_uint<128> >& v, const int size) {
  hw_uint<128> burst_reg;
  int num_transfers = mp_8_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void mp_8_opt_accel(hw_uint<256>* in_update_0_read, hw_uint<128>* mp_8_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = mp_8_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = mp_8_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<256> > in_update_0_read_channel;
  static HWStream<hw_uint<128> > mp_8_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  mp_8_opt(in_update_0_read_channel, mp_8_update_0_write_channel, size);

  write_mp_8_update_0_write(mp_8_update_0_write, mp_8_update_0_write_channel, size);
}
