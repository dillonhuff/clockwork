...
hw_uint<512>  id_unrolled_32(hw_uint<512>& in_off_chip) {
  ...
  // in_gauss_blur_1_update_0 unroll factor: 32
hw_uint<512>  reduce_gauss_unrolled_32(hw_uint<4608>& in) {
  hw_uint<512> whole_result;
  ...
  hw_uint<144> lane_16_in;
  set_at<0, 144, 144>(lane_16_in, in.extract<2304, 2447>());
  auto result_16 = reduce_gauss(lane_16_in);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<144> lane_17_in;
  set_at<0, 144, 144>(lane_17_in, in.extract<2448, 2591>());
  auto result_17 = reduce_gauss(lane_17_in);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<144> lane_18_in;
  set_at<0, 144, 144>(lane_18_in, in.extract<2592, 2735>());
  auto result_18 = reduce_gauss(lane_18_in);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<144> lane_19_in;
  set_at<0, 144, 144>(lane_19_in, in.extract<2736, 2879>());
  auto result_19 = reduce_gauss(lane_19_in);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<144> lane_20_in;
  set_at<0, 144, 144>(lane_20_in, in.extract<2880, 3023>());
  auto result_20 = reduce_gauss(lane_20_in);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<144> lane_21_in;
  set_at<0, 144, 144>(lane_21_in, in.extract<3024, 3167>());
  auto result_21 = reduce_gauss(lane_21_in);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<144> lane_22_in;
  set_at<0, 144, 144>(lane_22_in, in.extract<3168, 3311>());
  auto result_22 = reduce_gauss(lane_22_in);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<144> lane_23_in;
  set_at<0, 144, 144>(lane_23_in, in.extract<3312, 3455>());
  auto result_23 = reduce_gauss(lane_23_in);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<144> lane_24_in;
  set_at<0, 144, 144>(lane_24_in, in.extract<3456, 3599>());
  auto result_24 = reduce_gauss(lane_24_in);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<144> lane_25_in;
  set_at<0, 144, 144>(lane_25_in, in.extract<3600, 3743>());
  auto result_25 = reduce_gauss(lane_25_in);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<144> lane_26_in;
  set_at<0, 144, 144>(lane_26_in, in.extract<3744, 3887>());
  auto result_26 = reduce_gauss(lane_26_in);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<144> lane_27_in;
  set_at<0, 144, 144>(lane_27_in, in.extract<3888, 4031>());
  auto result_27 = reduce_gauss(lane_27_in);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<144> lane_28_in;
  set_at<0, 144, 144>(lane_28_in, in.extract<4032, 4175>());
  auto result_28 = reduce_gauss(lane_28_in);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<144> lane_29_in;
  set_at<0, 144, 144>(lane_29_in, in.extract<4176, 4319>());
  auto result_29 = reduce_gauss(lane_29_in);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<144> lane_30_in;
  set_at<0, 144, 144>(lane_30_in, in.extract<4320, 4463>());
  auto result_30 = reduce_gauss(lane_30_in);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<144> lane_31_in;
  set_at<0, 144, 144>(lane_31_in, in.extract<4464, 4607>());
  auto result_31 = reduce_gauss(lane_31_in);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // in_gauss_ds_1_update_0 unroll factor: 16
hw_uint<256>  id_unrolled_16(hw_uint<256>& in_gauss_blur_1) {
  ...
  hw_uint<16> lane_8_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_8_in_gauss_blur_1, in_gauss_blur_1.extract<128, 143>());
  auto result_8 = id(lane_8_in_gauss_blur_1);
  set_at<128, 256, 16>(whole_result, result_8);

  hw_uint<16> lane_9_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_9_in_gauss_blur_1, in_gauss_blur_1.extract<144, 159>());
  auto result_9 = id(lane_9_in_gauss_blur_1);
  set_at<144, 256, 16>(whole_result, result_9);

  hw_uint<16> lane_10_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_10_in_gauss_blur_1, in_gauss_blur_1.extract<160, 175>());
  auto result_10 = id(lane_10_in_gauss_blur_1);
  set_at<160, 256, 16>(whole_result, result_10);

  hw_uint<16> lane_11_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_11_in_gauss_blur_1, in_gauss_blur_1.extract<176, 191>());
  auto result_11 = id(lane_11_in_gauss_blur_1);
  set_at<176, 256, 16>(whole_result, result_11);

  hw_uint<16> lane_12_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_12_in_gauss_blur_1, in_gauss_blur_1.extract<192, 207>());
  auto result_12 = id(lane_12_in_gauss_blur_1);
  set_at<192, 256, 16>(whole_result, result_12);

  hw_uint<16> lane_13_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_13_in_gauss_blur_1, in_gauss_blur_1.extract<208, 223>());
  auto result_13 = id(lane_13_in_gauss_blur_1);
  set_at<208, 256, 16>(whole_result, result_13);

  hw_uint<16> lane_14_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_14_in_gauss_blur_1, in_gauss_blur_1.extract<224, 239>());
  auto result_14 = id(lane_14_in_gauss_blur_1);
  set_at<224, 256, 16>(whole_result, result_14);

  hw_uint<16> lane_15_in_gauss_blur_1;
  set_at<0, 16, 16>(lane_15_in_gauss_blur_1, in_gauss_blur_1.extract<240, 255>());
  auto result_15 = id(lane_15_in_gauss_blur_1);
  set_at<240, 256, 16>(whole_result, result_15);
  return whole_result;
}

  // in_gauss_blur_2_update_0 unroll factor: 16
hw_uint<256>  reduce_gauss_unrolled_16(hw_uint<2304>& in_gauss_ds_1) {
  hw_uint<256> whole_result;
  ...
  hw_uint<144> lane_8_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_8_in_gauss_ds_1, in_gauss_ds_1.extract<1152, 1295>());
  auto result_8 = reduce_gauss(lane_8_in_gauss_ds_1);
  set_at<128, 256, 16>(whole_result, result_8);

  hw_uint<144> lane_9_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_9_in_gauss_ds_1, in_gauss_ds_1.extract<1296, 1439>());
  auto result_9 = reduce_gauss(lane_9_in_gauss_ds_1);
  set_at<144, 256, 16>(whole_result, result_9);

  hw_uint<144> lane_10_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_10_in_gauss_ds_1, in_gauss_ds_1.extract<1440, 1583>());
  auto result_10 = reduce_gauss(lane_10_in_gauss_ds_1);
  set_at<160, 256, 16>(whole_result, result_10);

  hw_uint<144> lane_11_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_11_in_gauss_ds_1, in_gauss_ds_1.extract<1584, 1727>());
  auto result_11 = reduce_gauss(lane_11_in_gauss_ds_1);
  set_at<176, 256, 16>(whole_result, result_11);

  hw_uint<144> lane_12_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_12_in_gauss_ds_1, in_gauss_ds_1.extract<1728, 1871>());
  auto result_12 = reduce_gauss(lane_12_in_gauss_ds_1);
  set_at<192, 256, 16>(whole_result, result_12);

  hw_uint<144> lane_13_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_13_in_gauss_ds_1, in_gauss_ds_1.extract<1872, 2015>());
  auto result_13 = reduce_gauss(lane_13_in_gauss_ds_1);
  set_at<208, 256, 16>(whole_result, result_13);

  hw_uint<144> lane_14_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_14_in_gauss_ds_1, in_gauss_ds_1.extract<2016, 2159>());
  auto result_14 = reduce_gauss(lane_14_in_gauss_ds_1);
  set_at<224, 256, 16>(whole_result, result_14);

  hw_uint<144> lane_15_in_gauss_ds_1;
  set_at<0, 144, 144>(lane_15_in_gauss_ds_1, in_gauss_ds_1.extract<2160, 2303>());
  auto result_15 = reduce_gauss(lane_15_in_gauss_ds_1);
  set_at<240, 256, 16>(whole_result, result_15);
  return whole_result;
}

  // in_gauss_ds_2_update_0 unroll factor: 8
hw_uint<128>  id_unrolled_8(hw_uint<128>& in_gauss_blur_2) {
  ...
  hw_uint<16> lane_4_in_gauss_blur_2;
  set_at<0, 16, 16>(lane_4_in_gauss_blur_2, in_gauss_blur_2.extract<64, 79>());
  auto result_4 = id(lane_4_in_gauss_blur_2);
  set_at<64, 128, 16>(whole_result, result_4);

  hw_uint<16> lane_5_in_gauss_blur_2;
  set_at<0, 16, 16>(lane_5_in_gauss_blur_2, in_gauss_blur_2.extract<80, 95>());
  auto result_5 = id(lane_5_in_gauss_blur_2);
  set_at<80, 128, 16>(whole_result, result_5);

  hw_uint<16> lane_6_in_gauss_blur_2;
  set_at<0, 16, 16>(lane_6_in_gauss_blur_2, in_gauss_blur_2.extract<96, 111>());
  auto result_6 = id(lane_6_in_gauss_blur_2);
  set_at<96, 128, 16>(whole_result, result_6);

  hw_uint<16> lane_7_in_gauss_blur_2;
  set_at<0, 16, 16>(lane_7_in_gauss_blur_2, in_gauss_blur_2.extract<112, 127>());
  auto result_7 = id(lane_7_in_gauss_blur_2);
  set_at<112, 128, 16>(whole_result, result_7);
  return whole_result;
}

  // in_gauss_blur_3_update_0 unroll factor: 8
hw_uint<128>  reduce_gauss_unrolled_8(hw_uint<1152>& in_gauss_ds_2) {
  hw_uint<128> whole_result;
  ...
  hw_uint<144> lane_4_in_gauss_ds_2;
  set_at<0, 144, 144>(lane_4_in_gauss_ds_2, in_gauss_ds_2.extract<576, 719>());
  auto result_4 = reduce_gauss(lane_4_in_gauss_ds_2);
  set_at<64, 128, 16>(whole_result, result_4);

  hw_uint<144> lane_5_in_gauss_ds_2;
  set_at<0, 144, 144>(lane_5_in_gauss_ds_2, in_gauss_ds_2.extract<720, 863>());
  auto result_5 = reduce_gauss(lane_5_in_gauss_ds_2);
  set_at<80, 128, 16>(whole_result, result_5);

  hw_uint<144> lane_6_in_gauss_ds_2;
  set_at<0, 144, 144>(lane_6_in_gauss_ds_2, in_gauss_ds_2.extract<864, 1007>());
  auto result_6 = reduce_gauss(lane_6_in_gauss_ds_2);
  set_at<96, 128, 16>(whole_result, result_6);

  hw_uint<144> lane_7_in_gauss_ds_2;
  set_at<0, 144, 144>(lane_7_in_gauss_ds_2, in_gauss_ds_2.extract<1008, 1151>());
  auto result_7 = reduce_gauss(lane_7_in_gauss_ds_2);
  set_at<112, 128, 16>(whole_result, result_7);
  return whole_result;
}

  // in_gauss_ds_3_update_0 unroll factor: 4
hw_uint<64>  id_unrolled_4(hw_uint<64>& in_gauss_blur_3) {
  ...
  hw_uint<16> lane_2_in_gauss_blur_3;
  set_at<0, 16, 16>(lane_2_in_gauss_blur_3, in_gauss_blur_3.extract<32, 47>());
  auto result_2 = id(lane_2_in_gauss_blur_3);
  set_at<32, 64, 16>(whole_result, result_2);

  hw_uint<16> lane_3_in_gauss_blur_3;
  set_at<0, 16, 16>(lane_3_in_gauss_blur_3, in_gauss_blur_3.extract<48, 63>());
  auto result_3 = id(lane_3_in_gauss_blur_3);
