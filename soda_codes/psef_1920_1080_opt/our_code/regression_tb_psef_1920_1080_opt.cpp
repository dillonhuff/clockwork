...
int main() {
  ofstream in_pix("input_pixels_regression_result_psef_1920_1080_opt.txt");
  ofstream fout("regression_result_psef_1920_1080_opt.txt");
  ...
  psef_1920_1080_opt(in_update_0_read, psef_1920_1080_update_0_write);
