...
int main() {
  ofstream in_pix("input_pixels_regression_result_cp_add_20_nopipe_1_opt.txt");
  ofstream fout("regression_result_cp_add_20_nopipe_1_opt.txt");
  HWStream<hw_uint<16> > raw_update_0_read;
  HWStream<hw_uint<16> > cp_add_20_nopipe_1_update_0_write;
  ...
  cp_add_20_nopipe_1_opt(raw_update_0_read, cp_add_20_nopipe_1_update_0_write);

  for (int i = 0; i < 2073600; i++) {
    hw_uint<16> actual = cp_add_20_nopipe_1_update_0_write.read();
