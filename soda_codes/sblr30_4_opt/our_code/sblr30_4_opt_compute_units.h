...
hw_uint<16> sblr30_4_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<64>  mag_x_generated_compute_unrolled_4(hw_uint<384>& img) {
  ...
  // sblr30_4_update_0 unroll factor: 4
hw_uint<64>  sblr30_4_generated_compute_unrolled_4(hw_uint<64>& mag_x, hw_uint<64>& mag_y) {
  hw_uint<64> whole_result;
  ...
  auto result_0 = sblr30_4_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 64, 16>(whole_result, result_0);
  ...
  auto result_1 = sblr30_4_generated_compute(lane_1_mag_x, lane_1_mag_y);
  set_at<16, 64, 16>(whole_result, result_1);
  ...
  auto result_2 = sblr30_4_generated_compute(lane_2_mag_x, lane_2_mag_y);
  set_at<32, 64, 16>(whole_result, result_2);
  ...
  auto result_3 = sblr30_4_generated_compute(lane_3_mag_x, lane_3_mag_y);
  set_at<48, 64, 16>(whole_result, result_3);
  return whole_result;
}
