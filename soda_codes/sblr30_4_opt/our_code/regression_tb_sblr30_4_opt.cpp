...
int main() {
  ofstream in_pix("input_pixels_regression_result_sblr30_4_opt.txt");
  ofstream fout("regression_result_sblr30_4_opt.txt");
  HWStream<hw_uint<64> > img_update_0_read;
  HWStream<hw_uint<64> > sblr30_4_update_0_write;
  ...
  sblr30_4_opt(img_update_0_read, sblr30_4_update_0_write);

  for (int i = 0; i < 518400; i++) {
    hw_uint<64> actual = sblr30_4_update_0_write.read();
