...
// compute file: ef_sm_opt_compute_units.h
#include "ef_sm_opt_compute_units.h"
...
inline hw_uint<16> bright_gauss_blur_1_rd0_select(bright_cache& bright, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_cache& bright, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 43] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_bright_bright_update_0_write0 = bright.bright_bright_update_0_write0_merged_banks_11.peek_3856();
  return value_bright_bright_update_0_write0;
  return 0;
...
inline hw_uint<16> bright_gauss_ds_1_rd0_select(bright_gauss_blur_1_cache& bright_gauss_blur_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_gauss_ds_2_rd0_select(bright_gauss_blur_2_cache& bright_gauss_blur_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
...
inline hw_uint<16> bright_gauss_ds_3_rd0_select(bright_gauss_blur_3_cache& bright_gauss_blur_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
...
inline hw_uint<16> bright_gauss_blur_2_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  auto value_bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0 = bright_gauss_ds_1.bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0_merged_banks_10.peek_1928();
  return value_bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0;
  return 0;
...
inline hw_uint<16> bright_laplace_us_0_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 40] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_gauss_blur_3_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_us_1_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_us_2_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> fused_level_3_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> fused_level_0_rd0_select(bright_laplace_diff_0_cache& bright_laplace_diff_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 47] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 43] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> fused_level_1_rd0_select(bright_laplace_diff_1_cache& bright_laplace_diff_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> fused_level_2_rd0_select(bright_laplace_diff_2_cache& bright_laplace_diff_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 45] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_laplace_us_0_cache& bright_laplace_us_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 43] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 40] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_laplace_us_1_cache& bright_laplace_us_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_laplace_us_2_cache& bright_laplace_us_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> bright_weights_normed_rd0_select(bright_weights_cache& bright_weights, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd0_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_1_rd0_select(bright_weights_normed_gauss_blur_1_cache& bright_weights_normed_gauss_blur_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 20] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_2_rd0_select(bright_weights_normed_gauss_blur_2_cache& bright_weights_normed_gauss_blur_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 27] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 21] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_3_rd0_select(bright_weights_normed_gauss_blur_3_cache& bright_weights_normed_gauss_blur_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 37] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 28] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_2_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 21] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 20] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_3_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 28] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 27] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> fused_level_3_rd0_select(bright_weights_normed_gauss_ds_3_cache& bright_weights_normed_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 37] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> dark_gauss_blur_1_rd0_select(dark_cache& dark, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_cache& dark, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 36] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_dark_dark_update_0_write0 = dark.dark_dark_update_0_write0_merged_banks_11.peek_3856();
  return value_dark_dark_update_0_write0;
  return 0;
...
inline hw_uint<16> dark_gauss_ds_1_rd0_select(dark_gauss_blur_1_cache& dark_gauss_blur_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_gauss_ds_2_rd0_select(dark_gauss_blur_2_cache& dark_gauss_blur_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 12] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
...
inline hw_uint<16> dark_gauss_ds_3_rd0_select(dark_gauss_blur_3_cache& dark_gauss_blur_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 26] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 19] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
...
inline hw_uint<16> dark_gauss_blur_2_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 12] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 35] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  auto value_dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0 = dark_gauss_ds_1.dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0_merged_banks_10.peek_1928();
  return value_dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0;
  return 0;
...
inline hw_uint<16> dark_laplace_us_0_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 33] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_gauss_blur_3_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 19] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_us_1_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 32] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_us_2_rd0_select(dark_gauss_ds_3_cache& dark_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 31] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 26] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> fused_level_0_rd0_select(dark_laplace_diff_0_cache& dark_laplace_diff_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 47] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 36] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> fused_level_1_rd0_select(dark_laplace_diff_1_cache& dark_laplace_diff_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 35] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> fused_level_2_rd0_select(dark_laplace_diff_2_cache& dark_laplace_diff_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 45] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_laplace_us_0_cache& dark_laplace_us_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 36] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 33] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_laplace_us_1_cache& dark_laplace_us_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 35] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 32] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_laplace_us_2_cache& dark_laplace_us_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 31] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd0_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_1_rd0_select(dark_weights_normed_gauss_blur_1_cache& dark_weights_normed_gauss_blur_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_2_rd0_select(dark_weights_normed_gauss_blur_2_cache& dark_weights_normed_gauss_blur_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_3_rd0_select(dark_weights_normed_gauss_blur_3_cache& dark_weights_normed_gauss_blur_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_2_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_3_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> fused_level_3_rd0_select(dark_weights_normed_gauss_ds_3_cache& dark_weights_normed_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
struct final_merged_0_final_merged_0_update_0_write0_to_ef_sm_rd0_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_cache {
  // # of banks: 1
  final_merged_0_final_merged_0_update_0_write0_to_ef_sm_rd0_cache final_merged_0_final_merged_0_update_0_write0_to_ef_sm_rd0;
};
...
inline void final_merged_0_final_merged_0_update_0_write0_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write0, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_sm_rd0.push(final_merged_0_final_merged_0_update_0_write0);
}

inline hw_uint<16> ef_sm_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_sm_rd0 read pattern: { ef_sm_update_0[d0, d1] -> final_merged_0[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_sm_update_0[d0, d1] -> [14 + d1, 14 + d0, 51] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 50] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write0 = final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_sm_rd0.peek(/* one reader or all rams */ 0);
...
// ef_sm_update_0_read
//	ef_sm_rd0
inline hw_uint<16> final_merged_0_ef_sm_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ef_sm_rd0

	hw_uint<16> result;
	hw_uint<16> ef_sm_rd0_res = ef_sm_rd0_select(final_merged_0, d0, d1, dynamic_address);
	set_at<0, 16>(result, ef_sm_rd0_res);
	return result;
}
...
inline hw_uint<16> final_merged_0_rd0_select(final_merged_1_cache& final_merged_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 50] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 14 + 2d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> final_merged_1_rd0_select(final_merged_2_cache& final_merged_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 14 + 2d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> final_merged_0_rd0_select(fused_level_0_cache& fused_level_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 50] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { fused_level_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 47] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> final_merged_1_rd0_select(fused_level_1_cache& fused_level_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 14 + 2d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_2_cache& fused_level_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 45] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_3_cache& fused_level_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
// Total re-use buffer capacity: 1004528 bits
...
inline void ef_sm_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ef_sm, int d0, int d1) {
  // Dynamic address computation

	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_ef_sm_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1, 0);
...
// Driver function
void ef_sm_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_sm) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ef_sm_opt_debug.csv");
...
// schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 35] : 0 <= d0 <= 959 and 0 <= d1 <= 539; dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542; bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540; bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 20] : 0 <= d0 <= 962 and 0 <= d1 <= 542; in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; ef_sm_update_0[d0, d1] -> [14 + d1, 14 + d0, 51] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 26] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 33] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; fused_level_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 47] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 28] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 43] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 12] : 0 <= d0 <= 960 and 0 <= d1 <= 540; bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 40] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 36] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539; bright_weights_update_0[d0, d1] -> [d1, d0, 5] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084; dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084; dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268; final_merged_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 269; dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 32] : 0 <= d0 <= 959 and 0 <= d1 <= 539; final_merged_1_update_0[d0, d1] -> [14 + 2d1, 14 + 2d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 539; dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 19] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 27] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_weights_update_0[d0, d1] -> [d1, d0, 4] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540; dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134; bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542; bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 21] : 0 <= d0 <= 960 and 0 <= d1 <= 540; bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084; dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084; bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 37] : 0 <= d0 <= 239 and 0 <= d1 <= 134; fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270; final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 50] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539; bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542; fused_level_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 45] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086; dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 269; fused_level_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 539; bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 31] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
//   { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for dark_weights_normed_update_0(((-6 + i2 == 0) && (i1 >= 0) && (1926 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 35] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for dark_laplace_diff_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-35 + i2 == 0) && (-6 + i1 >= 0) && (1924 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
// Condition for dark_weights_normed_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-16 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
// Condition for bright_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-15 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 20] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
// Condition for bright_weights_normed_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-20 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for in_update_0(((-1 + i2 == 0) && (i1 >= 0) && (1926 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { ef_sm_update_0[d0, d1] -> [14 + d1, 14 + d0, 51] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ef_sm_update_0(((-51 + i2 == 0) && (-14 + i1 >= 0) && (1933 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
//   { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 26] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for dark_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-2 - i1 + 8*floord(2 + i1, 8) == 0) && (-26 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 33] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_us_0_update_0(((-33 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { fused_level_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 47] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for fused_level_0_update_0(((-47 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for bright_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-23 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 28] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for bright_weights_normed_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-28 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 43] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_diff_0_update_0(((-43 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 12] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
// Condition for dark_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-12 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for bright_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-38 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 40] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_us_0_update_0(((-40 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 2 + d0, 36] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_diff_0_update_0(((-36 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for bright_laplace_us_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-39 + i2 == 0) && (-6 + i1 >= 0) && (1924 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
...
//   { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for dark_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-18 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for dark_weights_normed_gauss_blur_1_update_0(((-10 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for dark_gauss_blur_1_update_0(((-7 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for dark_weights_normed_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-25 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for final_merged_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-48 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 32] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for dark_laplace_us_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-32 + i2 == 0) && (-6 + i1 >= 0) && (1924 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 14 + 2d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for final_merged_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-49 + i2 == 0) && (-14 + i1 >= 0) && (1932 - i1 >= 0) && (-14 + i0 >= 0) && (1092 - i0 >= 0)))
//   { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 19] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for dark_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-19 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 27] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for bright_weights_normed_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-27 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
...
//   { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
// Condition for dark_weights_normed_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-17 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for dark_weights_normed_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-2 - i1 + 8*floord(2 + i1, 8) == 0) && (-30 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
// Condition for bright_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-14 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 21] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
// Condition for bright_weights_normed_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-21 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for bright_weights_normed_gauss_blur_1_update_0(((-13 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for dark_update_0(((-2 + i2 == 0) && (i1 >= 0) && (1926 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for bright_gauss_blur_1_update_0(((-9 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for bright_weights_normed_update_0(((-8 + i2 == 0) && (i1 >= 0) && (1926 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for bright_laplace_diff_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-41 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 37] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for bright_weights_normed_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-2 - i1 + 8*floord(2 + i1, 8) == 0) && (-37 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 44] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for fused_level_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-2 - i1 + 8*floord(2 + i1, 8) == 0) && (-44 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for dark_weights_normed_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-24 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 50] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for final_merged_0_update_0(((-50 + i2 == 0) && (-14 + i1 >= 0) && (1933 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
//   { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for bright_laplace_diff_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-42 + i2 == 0) && (-6 + i1 >= 0) && (1924 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 14 + 8d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for bright_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-2 - i1 + 8*floord(2 + i1, 8) == 0) && (-29 + i2 == 0) && (-14 + i1 >= 0) && (1926 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 2 + 2d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
// Condition for dark_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-11 + i2 == 0) && (-2 + i1 >= 0) && (1926 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 45] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for fused_level_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-45 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for bright_update_0(((-3 + i2 == 0) && (i1 >= 0) && (1926 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for dark_laplace_diff_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-34 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 6 + 2d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
// Condition for fused_level_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-46 + i2 == 0) && (-6 + i1 >= 0) && (1924 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 6 + 4d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for bright_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-22 + i2 == 0) && (-6 + i1 >= 0) && (1926 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 14 + 4d0, 31] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for dark_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-31 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
	...
	for (int c0 = 0; c0 <= 1093; c0 += 1)
	  for (int c1 = 0; c1 <= 1933; c1 += 1) {
	    if (c0 <= 1086 && c1 <= 1926) {
	      ...
	      dark_weights_normed_update_0(dark_weights /* buf name */, dark_weights_normed, c1, c0);
	      if (c0 >= 2 && c1 >= 2)
	        dark_gauss_blur_1_update_0(dark /* buf name */, dark_gauss_blur_1, c1 - 2, c0 - 2);
	      bright_weights_normed_update_0(bright_weights /* buf name */, bright_weights_normed, c1, c0);
	      if (c0 >= 2 && c1 >= 2) {
	    ...
	    if (c0 >= 14 && c1 >= 14) {
	      ...
	      ef_sm_update_0(final_merged_0 /* buf name */, ef_sm, c1 - 14, c0 - 14);
	    }
	  }
...
void ef_sm_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_sm, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ef_sm_opt(in_off_chip, ef_sm);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ef_sm_update_0[root = 0, ef_sm_0, ef_sm_1] -> ef_sm[0, 0] : 0 <= ef_sm_0 <= 1919 and 0 <= ef_sm_1 <= 1079 }
const int ef_sm_update_0_write_pipe0_num_transfers = 2073600;
...
void ef_sm_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ef_sm_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ef_sm_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ef_sm_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ef_sm_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ef_sm_opt_wrapper(in_update_0_read_pipe0_channel, ef_sm_update_0_write_pipe0_channel, size);

  burst_write<16>(ef_sm_update_0_write_pipe0, ef_sm_update_0_write_pipe0_channel, ef_sm_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ef_sm_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ef_sm_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ef_sm_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ef_sm_opt(in_update_0_read_pipe0, ef_sm_update_0_write_pipe0);
