...
// compute file: bxy_noinit_p220_2_opt_compute_units.h
#include "bxy_noinit_p220_2_opt_compute_units.h"
...
inline hw_uint<16> bxy_noinit_p220_2_rd0_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd0 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_noinit_p220_2_rd1_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd1 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_noinit_p220_2_rd2_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd2 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[2 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_noinit_p220_2_rd3_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd3 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write1 = blurx.blurx_blurx_update_0_write1_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write1;
...
inline hw_uint<16> bxy_noinit_p220_2_rd4_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd4 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[2 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write0 = blurx.blurx_blurx_update_0_write0_merged_banks_3.peek_0();
  return value_blurx_blurx_update_0_write0;
...
inline hw_uint<16> bxy_noinit_p220_2_rd5_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_noinit_p220_2_rd5 read pattern: { bxy_noinit_p220_2_update_0[d0, d1] -> blurx[3 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
...
// bxy_noinit_p220_2_update_0_read
//	bxy_noinit_p220_2_rd0
//	bxy_noinit_p220_2_rd1
//	bxy_noinit_p220_2_rd2
//	bxy_noinit_p220_2_rd3
//	bxy_noinit_p220_2_rd4
//	bxy_noinit_p220_2_rd5
inline hw_uint<96> blurx_bxy_noinit_p220_2_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 6
	...
	hw_uint<96> result;
	hw_uint<16> bxy_noinit_p220_2_rd0_res = bxy_noinit_p220_2_rd0_select(blurx, d0, d1, dynamic_address);
	set_at<0, 96>(result, bxy_noinit_p220_2_rd0_res);
	hw_uint<16> bxy_noinit_p220_2_rd1_res = bxy_noinit_p220_2_rd1_select(blurx, d0, d1, dynamic_address);
	set_at<16, 96>(result, bxy_noinit_p220_2_rd1_res);
	hw_uint<16> bxy_noinit_p220_2_rd2_res = bxy_noinit_p220_2_rd2_select(blurx, d0, d1, dynamic_address);
	set_at<32, 96>(result, bxy_noinit_p220_2_rd2_res);
	hw_uint<16> bxy_noinit_p220_2_rd3_res = bxy_noinit_p220_2_rd3_select(blurx, d0, d1, dynamic_address);
	set_at<48, 96>(result, bxy_noinit_p220_2_rd3_res);
	hw_uint<16> bxy_noinit_p220_2_rd4_res = bxy_noinit_p220_2_rd4_select(blurx, d0, d1, dynamic_address);
	set_at<64, 96>(result, bxy_noinit_p220_2_rd4_res);
	hw_uint<16> bxy_noinit_p220_2_rd5_res = bxy_noinit_p220_2_rd5_select(blurx, d0, d1, dynamic_address);
	set_at<80, 96>(result, bxy_noinit_p220_2_rd5_res);
	return result;
}
...
inline void bxy_noinit_p220_2_update_0(blurx_cache& blurx, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */bxy_noinit_p220_2, int d0, int d1) {
  // Dynamic address computation

	// Consume: blurx
	auto blurx_0_c__0_value = blurx_bxy_noinit_p220_2_update_0_read_bundle_read(blurx/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = bxy_noinit_p220_2_generated_compute_unrolled_2(blurx_0_c__0_value);
	// Produce: bxy_noinit_p220_2
	bxy_noinit_p220_2.write(compute_result);
...
// Driver function
void bxy_noinit_p220_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */input_arg, HWStream<hw_uint<32> >& /* get_args num ports = 2 */bxy_noinit_p220_2) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("bxy_noinit_p220_2_opt_debug.csv");
...
// schedule: { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079; input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 960 and 0 <= d1 <= 1081; blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 960 and 0 <= d1 <= 1079 }
//   { bxy_noinit_p220_2_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
// Condition for bxy_noinit_p220_2_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (960 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
...
// Condition for blurx_update_0(((-2 + i2 == 0) && (i1 >= 0) && (960 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
  ...
  // Schedules...
    ...
    // bxy_noinit_p220_2_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*3]
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 960) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      bxy_noinit_p220_2_update_0((c1 - 1) / 1, (c0 - 2) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((1 <= c1 && c1 <= 960) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      bxy_noinit_p220_2_update_0(blurx /* buf name */, bxy_noinit_p220_2, (c1 - 1) / 1, (c0 - 2) / 1);
	    }
...
void bxy_noinit_p220_2_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 2 */input_arg, HWStream<hw_uint<32> >& /* get_args num ports = 2 */bxy_noinit_p220_2, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    bxy_noinit_p220_2_opt(input_arg, bxy_noinit_p220_2);
  }
}
#ifdef __VIVADO_SYNTH__
  // { bxy_noinit_p220_2_update_0[root = 0, bxy_noinit_p220_2_0, bxy_noinit_p220_2_1] -> bxy_noinit_p220_2[0, 0] : 0 <= bxy_noinit_p220_2_0 <= 959 and 0 <= bxy_noinit_p220_2_1 <= 1079 }
const int bxy_noinit_p220_2_update_0_write_pipe0_num_transfers = 1036800;
...
void bxy_noinit_p220_2_opt_accel(hw_uint<32>* input_update_0_read_pipe0, hw_uint<32>* bxy_noinit_p220_2_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = input_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = bxy_noinit_p220_2_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = input_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = bxy_noinit_p220_2_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<32> > bxy_noinit_p220_2_update_0_write_pipe0_channel;

  burst_read<32>(input_update_0_read_pipe0, input_update_0_read_pipe0_channel, input_update_0_read_pipe0_num_transfers*size);

  bxy_noinit_p220_2_opt_wrapper(input_update_0_read_pipe0_channel, bxy_noinit_p220_2_update_0_write_pipe0_channel, size);

  burst_write<32>(bxy_noinit_p220_2_update_0_write_pipe0, bxy_noinit_p220_2_update_0_write_pipe0_channel, bxy_noinit_p220_2_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void bxy_noinit_p220_2_opt_rdai(HWStream<hw_uint<32> >& input_update_0_read_pipe0, HWStream<hw_uint<32> >&  bxy_noinit_p220_2_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = input_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = bxy_noinit_p220_2_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  bxy_noinit_p220_2_opt(input_update_0_read_pipe0, bxy_noinit_p220_2_update_0_write_pipe0);
