...
hw_uint<32> gp_in0_326_cu295(hw_uint<32*9>& gp_in0_2_buf16) {
  ...
  set_at<0, 32, 32>(return_value296, res_avg31);
...
hw_uint<32> gp_in0_218_cu301(hw_uint<32*9>& gp_in0_1_buf8) {
  ...
  set_at<0, 32, 32>(return_value302, res_avg23);
