...
int main() {
  ...
  strided_conv_kernel(hw_output_stencil, input_copy_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_strided_conv_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
