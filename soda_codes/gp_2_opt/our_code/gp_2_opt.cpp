...
#include "gp_2_opt_compute_units.h"
...
struct in_in_update_0_write0_merged_banks_6_cache {
	...
	hw_uint<16> f0;
	hw_uint<16> f2;
	fifo<hw_uint<16>, 38> f3;
	hw_uint<16> f4;
	hw_uint<16> f6;
	fifo<hw_uint<16>, 38> f7;
	hw_uint<16> f8;
	hw_uint<16> f10;
...
inline hw_uint<16> level_0_rd0_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 81 : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_81();
...
inline hw_uint<16> level_0_rd1_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 41 : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_41();
  return value_in_in_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> level_0_rd3_select(in_cache& in, int d0, int d1) {
  ...
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 81 : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_3.peek_81();
...
inline hw_uint<16> level_0_rd4_select(in_cache& in, int d0, int d1) {
  ...
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 41 : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_3.peek_41();
  return value_in_in_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> level_0_rd6_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 80 : 0 <= d0 <= 37 and 0 <= d1 <= 38; level_0_update_0[d0, d1] -> (42 + d0) : d0 = 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_80();
  return value_in_in_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> level_0_rd7_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 39 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 40 : 0 <= d0 <= 37 and 0 <= d1 <= 38; level_0_update_0[d0, d1] -> (2 + d0) : d0 = 38 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_40();
  return value_in_in_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> level_1_rd0_select(level_0_cache& level_0, int d0, int d1) {
  ...
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 18 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 38 and 0 <= d1 <= 38 }
...
inline hw_uint<16> level_2_rd0_select(level_1_cache& level_1, int d0, int d1) {
  ...
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 8 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 18 and 0 <= d1 <= 18 }
...
inline hw_uint<16> level_3_rd0_select(level_2_cache& level_2, int d0, int d1) {
  ...
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 3 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 8 and 0 <= d1 <= 8 }
...
inline hw_uint<16> gp_2_rd0_select(level_3_cache& level_3, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_2_rd0 read pattern: { gp_2_update_0[d0, d1] -> level_3[d0, d1] : 0 <= d0 <= 3 and 0 <= d1 <= 3 }
  // Read schedule : { gp_2_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 6] : 0 <= d0 <= 3 and 0 <= d1 <= 3 }
  // Write schedule: { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 3 and 0 <= d1 <= 3 }
  // DD fold: {  }
...
// gp_2_update_0_read
//	gp_2_rd0
inline hw_uint<16> level_3_gp_2_update_0_read_bundle_read(level_3_cache& level_3, int d0, int d1) {
  // # of ports in bundle: 1
    // gp_2_rd0

	hw_uint<16> result;
	hw_uint<16> gp_2_rd0_res = gp_2_rd0_select(level_3, d0, d1);
	set_at<0, 16>(result, gp_2_rd0_res);
	return result;
}
...
// Driver function
void gp_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp_2, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("gp_2_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((0 <= c1 && c1 <= 39) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 78) && ((c0 - 0) % 1 == 0)) {
	in_update_0(in_off_chip, in, (c1 - 0) / 1, (c0 - 0) / 1);
	    }
	
	    if ((1 <= c1 && c1 <= 39) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 78) && ((c0 - 2) % 2 == 0)) {
	level_0_update_0(in, level_0, (c1 - 1) / 1, (c0 - 2) / 2);
	    }
	
	    if ((3 <= c1 && c1 <= 39) && ((c1 - 3) % 2 == 0) && (6 <= c0 && c0 <= 78) && ((c0 - 6) % 4 == 0)) {
	level_1_update_0(level_0, level_1, (c1 - 3) / 2, (c0 - 6) / 4);
	    }
	
	    if ((7 <= c1 && c1 <= 39) && ((c1 - 7) % 4 == 0) && (14 <= c0 && c0 <= 78) && ((c0 - 14) % 8 == 0)) {
	level_2_update_0(level_1, level_2, (c1 - 7) / 4, (c0 - 14) / 8);
	    }
	
	    if ((15 <= c1 && c1 <= 39) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 78) && ((c0 - 30) % 16 == 0)) {
	level_3_update_0(level_2, level_3, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
	
	    if ((15 <= c1 && c1 <= 39) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 78) && ((c0 - 30) % 16 == 0)) {
	gp_2_update_0(level_3, gp_2, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
...
void gp_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp_2) {

  gp_2_opt(in_off_chip, gp_2, 1);
}
#ifdef __VIVADO_SYNTH__
#include "gp_2_opt.h"
...
void gp_2_opt_accel(hw_uint<32>* in_update_0_read, hw_uint<16>* gp_2_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp_2_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = gp_2_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<32> > in_update_0_read_channel;
  static HWStream<hw_uint<16> > gp_2_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  gp_2_opt(in_update_0_read_channel, gp_2_update_0_write_channel, size);

  write_gp_2_update_0_write(gp_2_update_0_write, gp_2_update_0_write_channel, size);
}
