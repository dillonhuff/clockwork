...
// Driver function
void sbl_ur_8_opt(HWStream<hw_uint<128> >& /* get_args num ports = 8 */off_chip_img, HWStream<hw_uint<128> >& /* get_args num ports = 8 */sbl_ur_8, uint64_t num_epochs) {
...
void sbl_ur_8_opt(HWStream<hw_uint<128> >& /* get_args num ports = 8 */off_chip_img, HWStream<hw_uint<128> >& /* get_args num ports = 8 */sbl_ur_8) {
  ...
  sbl_ur_8_opt(off_chip_img, sbl_ur_8, 1);
}
#ifdef __VIVADO_SYNTH__
...
void sbl_ur_8_opt_accel(hw_uint<128>* img_update_0_read, hw_uint<128>* sbl_ur_8_update_0_write, const uint64_t size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  sbl_ur_8_opt(img_update_0_read_channel, sbl_ur_8_update_0_write_channel, size);
