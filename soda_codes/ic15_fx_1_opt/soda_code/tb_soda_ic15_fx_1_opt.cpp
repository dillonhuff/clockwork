// AUTO GEN SODA TB
#include "ic15_fx_1_opt_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  ic15_fx_1_opt_kernel(ic15_fx_1, in_off_chip, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_ic15_fx_1_opt_regression_result.csv", ic15_fx_1, nrows, ncols, transfer_cols);
  free(in_off_chip);
  free(ic15_fx_1);
}
