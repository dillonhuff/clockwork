...
// compute file: ic15_fx_1_opt_compute_units.h
#include "ic15_fx_1_opt_compute_units.h"
...
struct stg14_stg14_update_0_write0_to_ic15_fx_1_rd0_cache {
...
struct stg14_cache {
  // # of banks: 1
  stg14_stg14_update_0_write0_to_ic15_fx_1_rd0_cache stg14_stg14_update_0_write0_to_ic15_fx_1_rd0;
};
...
inline void stg14_stg14_update_0_write0_write(hw_uint<16>& stg14_stg14_update_0_write0, stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  stg14.stg14_stg14_update_0_write0_to_ic15_fx_1_rd0.push(stg14_stg14_update_0_write0);
}

inline hw_uint<16> ic15_fx_1_rd0_select(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ic15_fx_1_rd0 read pattern: { ic15_fx_1_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ic15_fx_1_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg14_stg14_update_0_write0 = stg14.stg14_stg14_update_0_write0_to_ic15_fx_1_rd0.peek(/* one reader or all rams */ 0);
  return value_stg14_stg14_update_0_write0;
  return 0;
}

// # of bundles = 2
// ic15_fx_1_update_0_read
//	ic15_fx_1_rd0
inline hw_uint<16> stg14_ic15_fx_1_update_0_read_bundle_read(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ic15_fx_1_rd0

	hw_uint<16> result;
	hw_uint<16> ic15_fx_1_rd0_res = ic15_fx_1_rd0_select(stg14, d0, d1, dynamic_address);
	set_at<0, 16>(result, ic15_fx_1_rd0_res);
	return result;
}
...
inline void ic15_fx_1_update_0(stg14_cache& stg14, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ic15_fx_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg14
	auto stg14_0_c__0_value = stg14_ic15_fx_1_update_0_read_bundle_read(stg14/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = ic15_fx_1_generated_compute_unrolled_1(stg14_0_c__0_value);
	// Produce: ic15_fx_1
	ic15_fx_1.write(compute_result);
...
// Driver function
void ic15_fx_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ic15_fx_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ic15_fx_1_opt_debug.csv");
...
//   { ic15_fx_1_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ic15_fx_1_update_0(((-17 + i2 == 0) && (-15 + i1 >= 0) && (1934 - i1 >= 0) && (-15 + i0 >= 0) && (1094 - i0 >= 0)))
...
// Condition for stg14_update_0(((-16 + i2 == 0) && (-15 + i1 >= 0) && (1934 - i1 >= 0) && (-15 + i0 >= 0) && (1094 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // ic15_fx_1_update_0 -> [1*d1*1*1 + 1*15,1*d0*1*1 + 1*15,1*17]
...
#pragma HLS pipeline II=1
    ...
    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
      ic15_fx_1_update_0((c1 - 15) / 1, (c0 - 15) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
	      ic15_fx_1_update_0(stg14 /* buf name */, ic15_fx_1, (c1 - 15) / 1, (c0 - 15) / 1);
	    }
...
void ic15_fx_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ic15_fx_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ic15_fx_1_opt(in_off_chip, ic15_fx_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ic15_fx_1_update_0[root = 0, ic15_fx_1_0, ic15_fx_1_1] -> ic15_fx_1[0, 0] : 0 <= ic15_fx_1_0 <= 1919 and 0 <= ic15_fx_1_1 <= 1079 }
const int ic15_fx_1_update_0_write_pipe0_num_transfers = 2073600;
...
void ic15_fx_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ic15_fx_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ic15_fx_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ic15_fx_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ic15_fx_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ic15_fx_1_opt_wrapper(in_update_0_read_pipe0_channel, ic15_fx_1_update_0_write_pipe0_channel, size);

  burst_write<16>(ic15_fx_1_update_0_write_pipe0, ic15_fx_1_update_0_write_pipe0_channel, ic15_fx_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ic15_fx_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ic15_fx_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ic15_fx_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ic15_fx_1_opt(in_update_0_read_pipe0, ic15_fx_1_update_0_write_pipe0);
