...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > cp9_32_1_merged747_write_channel;
  // In lanes = 32
  ...
  cp9_32_opt(raw_1_merged717_read_channel, cp9_32_1_merged747_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      auto packed_val = cp9_32_1_merged747_write_channel.read();
  ...
  output.save_image("./images/cp9_32_opt_bmp_out.bmp");
}
