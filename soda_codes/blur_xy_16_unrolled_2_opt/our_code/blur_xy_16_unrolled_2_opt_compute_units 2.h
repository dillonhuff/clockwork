...
hw_uint<16> blur_xy_16_unrolled_2_generated_compute(hw_uint<16*3> blurx) {
...
hw_uint<32>  blurx_generated_compute_unrolled_2(hw_uint<96>& input) {
  ...
  // blur_xy_16_unrolled_2_update_0 unroll factor: 2
hw_uint<32>  blur_xy_16_unrolled_2_generated_compute_unrolled_2(hw_uint<64>& blurx) {
  hw_uint<32> whole_result;
  ...
  auto result_0 = blur_xy_16_unrolled_2_generated_compute(lane_0_blurx);
  set_at<0, 32, 16>(whole_result, result_0);
  ...
  auto result_1 = blur_xy_16_unrolled_2_generated_compute(lane_1_blurx);
  set_at<16, 32, 16>(whole_result, result_1);
  return whole_result;
}
