...
// compute file: cp_32_opt_compute_units.h
#include "cp_32_opt_compute_units.h"
...
struct demosaic_diff_demosaic_diff_update_0_write0_to_cp_32_rd0_cache {
	// RAM Box: {[0, 1079], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct demosaic_diff_cache {
  // Reader addrs...
    // { cp_32_update_0[d0, d1] -> demosaic_diff[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
  demosaic_diff_demosaic_diff_update_0_write0_to_cp_32_rd0_cache demosaic_diff_demosaic_diff_update_0_write0_to_cp_32_rd0;
};
...
inline void demosaic_diff_demosaic_diff_update_0_write0_write(hw_uint<16>& demosaic_diff_demosaic_diff_update_0_write0, demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
  demosaic_diff.demosaic_diff_demosaic_diff_update_0_write0_to_cp_32_rd0.push(demosaic_diff_demosaic_diff_update_0_write0);
}

inline hw_uint<16> cp_32_rd0_select(demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // cp_32_rd0 read pattern: { cp_32_update_0[d0, d1] -> demosaic_diff[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { cp_32_update_0[d0, d1] -> [5 + d1, 5 + d0, 11] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { demosaic_diff_update_0[d0, d1] -> [5 + d1, 5 + d0, 10] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  auto value_demosaic_diff_demosaic_diff_update_0_write0 = demosaic_diff.demosaic_diff_demosaic_diff_update_0_write0_to_cp_32_rd0.peek(/* one reader or all rams */ 0);
...
// cp_32_update_0_read
//	cp_32_rd0
inline hw_uint<16> demosaic_diff_cp_32_update_0_read_bundle_read(demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // cp_32_rd0

	hw_uint<16> result;
	hw_uint<16> cp_32_rd0_res = cp_32_rd0_select(demosaic_diff, d0, d1, dynamic_address);
	set_at<0, 16>(result, cp_32_rd0_res);
	return result;
}
...
inline void cp_32_update_0(demosaic_diff_cache& demosaic_diff, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */cp_32, int d0, int d1) {
  // Dynamic address computation

	// Consume: demosaic_diff
	auto demosaic_diff_1_m_cp_32_1__p__0_c__1_m_cp_32_0__p__0_value = demosaic_diff_cp_32_update_0_read_bundle_read(demosaic_diff/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = cp_32_generated_compute_unrolled_1(demosaic_diff_1_m_cp_32_1__p__0_c__1_m_cp_32_0__p__0_value);
	// Produce: cp_32
	cp_32.write(compute_result);
...
// Driver function
void cp_32_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_32) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("cp_32_opt_debug.csv");
...
//   { cp_32_update_0[d0, d1] -> [5 + d1, 5 + d0, 11] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for cp_32_update_0(((((-11 + 1*i2)) == 0) && (((-5 + 1*i1)) >= 0) && (((1084 + -1*i1)) >= 0) && (((-5 + 1*i0)) >= 0) && (((1084 + -1*i0)) >= 0)))
...
// Condition for denoiseb_update_0(((((-2 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1084 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1084 + -1*i0)) >= 0)))
	...
	#pragma HLS pipeline II=1
	      ...
	      // { [i0, i1] : i0 >= 5 and i1 >= 5 }
	        ...
	        // { [i0, i1] : -5 + i1 >= 0 }
	      if ((((((-5 + 1*i0)) >= 0) && (((-5 + 1*i1)) >= 0)))) {
	        cp_32_update_0(demosaic_diff /* buf name */, cp_32, ((-5 + 1*i1)), ((-5 + 1*i0)));
	      }
	    }
	  }
...
void cp_32_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_32, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    cp_32_opt(raw_oc, cp_32);
  }
}
#ifdef __VIVADO_SYNTH__
  // { cp_32_update_0[root = 0, cp_32_0, cp_32_1] -> cp_32[cp_32_1, cp_32_0] : 0 <= cp_32_0 <= 1079 and 0 <= cp_32_1 <= 1079 }
const int cp_32_update_0_write_pipe0_num_transfers = 1166400;
...
void cp_32_opt_accel(hw_uint<16>* raw_update_0_read_pipe0, hw_uint<16>* cp_32_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = raw_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = cp_32_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = raw_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = cp_32_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > cp_32_update_0_write_pipe0_channel;

  burst_read<16>(raw_update_0_read_pipe0, raw_update_0_read_pipe0_channel, raw_update_0_read_pipe0_num_transfers*size);

  cp_32_opt_wrapper(raw_update_0_read_pipe0_channel, cp_32_update_0_write_pipe0_channel, size);

  burst_write<16>(cp_32_update_0_write_pipe0, cp_32_update_0_write_pipe0_channel, cp_32_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void cp_32_opt_rdai(HWStream<hw_uint<16> >& raw_update_0_read_pipe0, HWStream<hw_uint<16> >&  cp_32_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = raw_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = cp_32_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  cp_32_opt(raw_update_0_read_pipe0, cp_32_update_0_write_pipe0);
