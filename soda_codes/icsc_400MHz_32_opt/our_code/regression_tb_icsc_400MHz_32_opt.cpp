#include <fstream>
#include "icsc_400MHz_32_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_icsc_400MHz_32_opt.txt");
  ofstream fout("regression_result_icsc_400MHz_32_opt.txt");
  HWStream<hw_uint<512> > in_update_0_read;
  HWStream<hw_uint<512> > icsc_400MHz_32_update_0_write;
  ...
  icsc_400MHz_32_opt(in_update_0_read, icsc_400MHz_32_update_0_write);

  for (int i = 0; i < 64800; i++) {
    hw_uint<512> actual = icsc_400MHz_32_update_0_write.read();
