...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > asadd320_update_0_write_channel;
  // In lanes = 32
  for (int r = 0; r < 540; r++) {
  ...
  asadd320_opt(in_off_chip0_update_0_read_channel, asadd320_update_0_write_channel);
  bitmap_image output(1920, 540);
  for (int r = 0; r < 540; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = asadd320_update_0_write_channel.read();
  ...
  output.save_image("./images/asadd320_opt_bmp_out.bmp");
}
