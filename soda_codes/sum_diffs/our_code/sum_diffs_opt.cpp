...
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=magval inter false
#endif //__VIVADO_SYNTH__
...
#endif //__VIVADO_SYNTH__
	auto compute_result = mag_dn2_unrolled_1(diff_qwe_0_c__0_value, diff_d_0_c__0_value, diff_l_0_c__0_value, diff_r_0_c__0_value);
	// Produce: magval
...
#pragma HLS dependence variable=u inter false
	...
	magval_update_0(diff_qwe, diff_d, diff_l, diff_r, magval, c1 - 1, c0 - 1);
	f_update_0(f_off_chip, f, c1 - 1, c0 - 1);
	sum_diffs_update_0(magval, f, sum_diffs, c1 - 1, c0 - 1);
	    }
	  }
