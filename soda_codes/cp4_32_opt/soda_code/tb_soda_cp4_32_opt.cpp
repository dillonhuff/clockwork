...
int main() {
  ...
  cp4_32_opt_kernel(cp4_32, raw_oc, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_cp4_32_opt_regression_result.csv", cp4_32, nrows, ncols, transfer_cols);
  free(raw_oc);
  free(cp4_32);
}
