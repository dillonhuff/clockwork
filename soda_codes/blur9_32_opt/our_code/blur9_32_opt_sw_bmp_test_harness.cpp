...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > blur9_32_1_merged203_write_channel;
  // In lanes = 32
  ...
  blur9_32_opt(input_1_merged197_read_channel, blur9_32_1_merged203_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      auto packed_val = blur9_32_1_merged203_write_channel.read();
  ...
  output.save_image("./images/blur9_32_opt_bmp_out.bmp");
}
