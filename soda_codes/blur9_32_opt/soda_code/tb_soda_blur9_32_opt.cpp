...
int main() {
  ...
  blur9_32_opt_kernel(blur9_32, input_arg, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_blur9_32_opt_regression_result.csv", blur9_32, nrows, ncols, transfer_cols);
  free(input_arg);
  free(blur9_32);
}
