...
inline hw_uint<16> sobel_16_stage_x_unrolled_1_rd0_select(mag_x_cache& mag_x, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=mag_x inter false
#endif //__VIVADO_SYNTH__
  // sobel_16_stage_x_unrolled_1_rd0 read pattern: { sobel_16_stage_x_unrolled_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // Read schedule : { sobel_16_stage_x_unrolled_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
inline hw_uint<16> mag_x_sobel_16_stage_x_unrolled_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1) {
  // # of ports in bundle: 1
    // sobel_16_stage_x_unrolled_1_rd0

	hw_uint<16> result;
	hw_uint<16> sobel_16_stage_x_unrolled_1_rd0_res = sobel_16_stage_x_unrolled_1_rd0_select(mag_x, d0, d1);
	set_at<0, 16>(result, sobel_16_stage_x_unrolled_1_rd0_res);
	return result;
}
...
inline hw_uint<16> sobel_16_stage_x_unrolled_1_rd0_select(mag_y_cache& mag_y, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#pragma HLS dependence variable=mag_y inter false
#endif //__VIVADO_SYNTH__
  // sobel_16_stage_x_unrolled_1_rd0 read pattern: { sobel_16_stage_x_unrolled_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // Read schedule : { sobel_16_stage_x_unrolled_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
// sobel_16_stage_x_unrolled_1_update_0_read
//	sobel_16_stage_x_unrolled_1_rd0
inline hw_uint<16> mag_y_sobel_16_stage_x_unrolled_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1) {
  // # of ports in bundle: 1
    // sobel_16_stage_x_unrolled_1_rd0

	hw_uint<16> result;
	hw_uint<16> sobel_16_stage_x_unrolled_1_rd0_res = sobel_16_stage_x_unrolled_1_rd0_select(mag_y, d0, d1);
	set_at<0, 16>(result, sobel_16_stage_x_unrolled_1_rd0_res);
	return result;
}
...
// Operation logic
inline void sobel_16_stage_x_unrolled_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sobel_16_stage_x_unrolled_1, int d0, int d1) {
	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sobel_16_stage_x_unrolled_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1);
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sobel_16_stage_x_unrolled_1_update_0_mag_x," << d0<< "," << d1<< "," <<  mag_x_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sobel_16_stage_x_unrolled_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1);
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sobel_16_stage_x_unrolled_1_update_0_mag_y," << d0<< "," << d1<< "," <<  mag_y_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
	auto compute_result = sobel_16_stage_x_unrolled_1_generated_compute_unrolled_1(mag_x_0_c__0_value, mag_y_0_c__0_value);
...
#pragma HLS dependence variable=mag_y inter false
	...
	sobel_16_stage_x_unrolled_1_update_0(mag_x, mag_y, sobel_16_stage_x_unrolled_1, c1 - 1, c0 - 1);
	    }
	  }
