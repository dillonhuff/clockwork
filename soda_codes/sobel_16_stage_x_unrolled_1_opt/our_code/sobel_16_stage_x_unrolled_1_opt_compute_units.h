...
hw_uint<16> sobel_16_stage_x_unrolled_1_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<16>  sobel_16_stage_x_unrolled_1_generated_compute_unrolled_1(hw_uint<16>& mag_x, hw_uint<16>& mag_y) {
  hw_uint<16> whole_result;
  ...
  auto result_0 = sobel_16_stage_x_unrolled_1_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
