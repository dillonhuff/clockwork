...
int main() {
  ...
  sobel_16_stage_x_unrolled_1_opt_kernel(sobel_16_stage_x_unrolled_1, off_chip_img, transfer_cols);
  write_results<bits_per_pixel>("soda_sobel_16_stage_x_unrolled_1_opt_regression_result.csv", sobel_16_stage_x_unrolled_1, nrows, ncols, num_transfers);
  free(off_chip_img);
