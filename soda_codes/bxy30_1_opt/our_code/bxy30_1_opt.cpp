...
#include "bxy30_1_opt_compute_units.h"
...
inline hw_uint<16> bxy30_1_rd0_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy30_1_rd0 read pattern: { bxy30_1_update_0[d0, d1] -> blurx[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy30_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: { bxy30_1_update_0[d0, d1] -> 2 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy30_1_rd1_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy30_1_rd1 read pattern: { bxy30_1_update_0[d0, d1] -> blurx[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy30_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: { bxy30_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy30_1_rd2_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy30_1_rd2 read pattern: { bxy30_1_update_0[d0, d1] -> blurx[2 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy30_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// bxy30_1_update_0_read
//	bxy30_1_rd0
//	bxy30_1_rd1
//	bxy30_1_rd2
inline hw_uint<48> blurx_bxy30_1_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1) {
  // # of ports in bundle: 3
	...
	hw_uint<48> result;
	hw_uint<16> bxy30_1_rd0_res = bxy30_1_rd0_select(blurx, d0, d1);
	set_at<0, 48>(result, bxy30_1_rd0_res);
	hw_uint<16> bxy30_1_rd1_res = bxy30_1_rd1_select(blurx, d0, d1);
	set_at<16, 48>(result, bxy30_1_rd1_res);
	hw_uint<16> bxy30_1_rd2_res = bxy30_1_rd2_select(blurx, d0, d1);
	set_at<32, 48>(result, bxy30_1_rd2_res);
	return result;
}
...
inline void bxy30_1_update_0(blurx_cache& blurx, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */bxy30_1, int d0, int d1) {
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_bxy30_1_update_0_read_bundle_read(blurx/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "bxy30_1_update_0_blurx," << d0<< "," << d1<< "," <<  blurx_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = bxy30_1_generated_compute_unrolled_1(blurx_0_c__0_value);
	// Produce: bxy30_1
	bxy30_1.write(compute_result);

#ifndef __VIVADO_SYNTH__
  hw_uint<16> debug_compute_result(compute_result);
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "bxy30_1_update_0," << (1*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__

}

// Driver function
void bxy30_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */input_arg, HWStream<hw_uint<16> >& /* get_args num ports = 1 */bxy30_1, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("bxy30_1_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < 30; epoch++) {
	  // Schedules...
	    ...
	    // bxy30_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*3]
	...
	bxy30_1_update_0(blurx, bxy30_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
...
void bxy30_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */input_arg, HWStream<hw_uint<16> >& /* get_args num ports = 1 */bxy30_1) {

  bxy30_1_opt(input_arg, bxy30_1, 1);
}
#ifdef __VIVADO_SYNTH__
#include "bxy30_1_opt.h"

const int bxy30_1_update_0_write_num_transfers = 2073600;
...
static void write_bxy30_1_update_0_write(hw_uint<16>* output, HWStream<hw_uint<16> >& v, const int size) {
  hw_uint<16> burst_reg;
  int num_transfers = bxy30_1_update_0_write_num_transfers*30;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void bxy30_1_opt_accel(hw_uint<16>* input_update_0_read, hw_uint<16>* bxy30_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = input_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = bxy30_1_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = input_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = bxy30_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<16> > input_update_0_read_channel;
  static HWStream<hw_uint<16> > bxy30_1_update_0_write_channel;

  read_input_update_0_read(input_update_0_read, input_update_0_read_channel, size);

  bxy30_1_opt(input_update_0_read_channel, bxy30_1_update_0_write_channel, size);

  write_bxy30_1_update_0_write(bxy30_1_update_0_write, bxy30_1_update_0_write_channel, size);
}
