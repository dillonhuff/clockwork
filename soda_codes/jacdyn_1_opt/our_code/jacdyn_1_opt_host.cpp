...
int main(int argc, char **argv) {
  ...
  total_size_bytes += jacdyn_1_update_0_write_pipe0_size_bytes;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > jacdyn_1_update_0_write_pipe0(jacdyn_1_update_0_write_pipe0_size_bytes);
  ...
  OCL_CHECK(err, cl::Buffer jacdyn_1_update_0_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, jacdyn_1_update_0_write_pipe0_size_bytes, jacdyn_1_update_0_write_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, jacdyn_1_update_0_write_pipe0_ocl_buf));
...
{
    std::ofstream regression_result("jacdyn_1_update_0_write_pipe0_accel_result.csv");
    for (int i = 0; i < jacdyn_1_update_0_write_pipe0_DATA_SIZE; i++) {
