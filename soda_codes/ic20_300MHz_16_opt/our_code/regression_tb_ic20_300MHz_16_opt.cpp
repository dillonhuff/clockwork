#include <fstream>
#include "ic20_300MHz_16_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_ic20_300MHz_16_opt.txt");
  ofstream fout("regression_result_ic20_300MHz_16_opt.txt");
  HWStream<hw_uint<256> > in_update_0_read;
  HWStream<hw_uint<256> > ic20_300MHz_16_update_0_write;


  // Loading input data
  // cmap    : { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : -20 <= in_0 <= 139 and 0 <= in_1 <= 1099 }
  // read map: { in_off_chip[0, 0] -> in_update_0[root = 0, in_0, in_1] : -20 <= in_0 <= 139 and 0 <= in_1 <= 1099 }
  // rng     : { in_update_0[root = 0, in_0, in_1] : -20 <= in_0 <= 139 and 0 <= in_1 <= 1099 }
  ...
  ic20_300MHz_16_opt(in_update_0_read, ic20_300MHz_16_update_0_write);

  for (int i = 0; i < 129600; i++) {
    hw_uint<256> actual = ic20_300MHz_16_update_0_write.read();
