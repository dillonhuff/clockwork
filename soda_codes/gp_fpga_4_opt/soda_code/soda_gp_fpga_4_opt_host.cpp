...
int main(int argc, char **argv) {
  ...
  const int gp_fpga_4_update_0_write_DATA_SIZE = num_epochs*2108780;
  ...
  const int in_update_0_read_DATA_SIZE = num_epochs*2108780;
  ...
  uint64_t transfer_size = num_epochs*(2108780 / 4);
