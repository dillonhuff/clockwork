...
#include <fstream>
#include <vector>
#include "out0_out1_opt.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<512> > in0_update_0_read_channel;
  HWStream<hw_uint<512> > in1_update_0_read_channel;
  HWStream<hw_uint<512> > out0_update_0_write_channel;
  HWStream<hw_uint<512> > out1_update_0_write_channel;
  // In lanes = 32
  ...
  bitmap_image output(1088, 1920);
  for (int r = 0; r < 1920; r++) {
    for (int cl = 0; cl < 1088 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = out0_update_0_write_channel.read();
  ...
  output.save_image("./images/out0_out1_opt_bmp_out.bmp");
}
