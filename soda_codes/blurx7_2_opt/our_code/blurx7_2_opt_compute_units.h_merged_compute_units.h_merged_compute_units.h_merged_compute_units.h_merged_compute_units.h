#include "blurx7_2_opt_compute_units.h_merged_compute_units.h_merged_compute_units.h_merged_compute_units.h"
...
hw_uint<32> input_1_cu10(hw_uint<16*2>& input_arg) {
  ...
  set_at<0, 32, 16>(return_value11, res_input_update_0_sm0_02);
  set_at<16, 32, 16>(return_value11, res_input_update_0_sm0_14);
  return return_value11;

}

hw_uint<32> blurx7_2_1_cu13(hw_uint<16*6>& input) {
  ...
  auto res_blurx7_2_update_0_sm1_06 = blurx7_2_generated_compute_unrolled_1(input_lane_2_pack);
  ...
  auto res_blurx7_2_update_0_sm1_18 = blurx7_2_generated_compute_unrolled_1(input_lane_5_pack);
  hw_uint<32 > return_value14;
  set_at<0, 32, 16>(return_value14, res_blurx7_2_update_0_sm1_06);
  set_at<16, 32, 16>(return_value14, res_blurx7_2_update_0_sm1_18);
