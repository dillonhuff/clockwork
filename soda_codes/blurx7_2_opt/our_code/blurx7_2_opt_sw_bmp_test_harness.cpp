...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<32> > blurx7_2_1_merged15_write_channel;
  // In lanes = 2
  ...
  blurx7_2_opt(input_1_merged12_read_channel, blurx7_2_1_merged15_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 2; cl++) {
      auto packed_val = blurx7_2_1_merged15_write_channel.read();
  ...
  output.save_image("./images/blurx7_2_opt_bmp_out.bmp");
}
