// AUTO GEN SODA TB
#include "pyr_blndd512_ii1_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  pyr_blndd512_ii1_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_pyr_blndd512_ii1_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
