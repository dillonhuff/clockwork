...
// compute file: cp_noinit_ln_1_opt_compute_units.h
#include "cp_noinit_ln_1_opt_compute_units.h"
...
struct demosaic_diff_demosaic_diff_update_0_write0_to_cp_noinit_ln_1_rd0_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct demosaic_diff_cache {
  // # of banks: 1
  demosaic_diff_demosaic_diff_update_0_write0_to_cp_noinit_ln_1_rd0_cache demosaic_diff_demosaic_diff_update_0_write0_to_cp_noinit_ln_1_rd0;
};
...
inline void demosaic_diff_demosaic_diff_update_0_write0_write(hw_uint<16>& demosaic_diff_demosaic_diff_update_0_write0, demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
  demosaic_diff.demosaic_diff_demosaic_diff_update_0_write0_to_cp_noinit_ln_1_rd0.push(demosaic_diff_demosaic_diff_update_0_write0);
}

inline hw_uint<16> cp_noinit_ln_1_rd0_select(demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // cp_noinit_ln_1_rd0 read pattern: { cp_noinit_ln_1_update_0[d0, d1] -> demosaic_diff[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { cp_noinit_ln_1_update_0[d0, d1] -> [5 + d1, 5 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { demosaic_diff_update_0[d0, d1] -> [5 + d1, 5 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_demosaic_diff_demosaic_diff_update_0_write0 = demosaic_diff.demosaic_diff_demosaic_diff_update_0_write0_to_cp_noinit_ln_1_rd0.peek(/* one reader or all rams */ 0);
  return value_demosaic_diff_demosaic_diff_update_0_write0;
  return 0;
}

// # of bundles = 2
// cp_noinit_ln_1_update_0_read
//	cp_noinit_ln_1_rd0
inline hw_uint<16> demosaic_diff_cp_noinit_ln_1_update_0_read_bundle_read(demosaic_diff_cache& demosaic_diff, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // cp_noinit_ln_1_rd0

	hw_uint<16> result;
	hw_uint<16> cp_noinit_ln_1_rd0_res = cp_noinit_ln_1_rd0_select(demosaic_diff, d0, d1, dynamic_address);
	set_at<0, 16>(result, cp_noinit_ln_1_rd0_res);
	return result;
}
...
inline void cp_noinit_ln_1_update_0(demosaic_diff_cache& demosaic_diff, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */cp_noinit_ln_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: demosaic_diff
	auto demosaic_diff_0_c__0_value = demosaic_diff_cp_noinit_ln_1_update_0_read_bundle_read(demosaic_diff/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = cp_noinit_ln_1_generated_compute_unrolled_1(demosaic_diff_0_c__0_value);
	// Produce: cp_noinit_ln_1
	cp_noinit_ln_1.write(compute_result);
...
// Driver function
void cp_noinit_ln_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_noinit_ln_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("cp_noinit_ln_1_opt_debug.csv");
...
//   { cp_noinit_ln_1_update_0[d0, d1] -> [5 + d1, 5 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for cp_noinit_ln_1_update_0(((-11 + i2 == 0) && (-5 + i1 >= 0) && (1924 - i1 >= 0) && (-5 + i0 >= 0) && (1084 - i0 >= 0)))
...
// Condition for denoiseb_update_0(((-2 + i2 == 0) && (-1 + i1 >= 0) && (1924 - i1 >= 0) && (-1 + i0 >= 0) && (1084 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // cp_noinit_ln_1_update_0 -> [1*d1*1*1 + 1*5,1*d0*1*1 + 1*5,1*11]
...
#pragma HLS pipeline II=1
    ...
    if ((5 <= c1 && c1 <= 1924) && ((c1 - 5) % 1 == 0) && (5 <= c0 && c0 <= 1084) && ((c0 - 5) % 1 == 0)) {
      cp_noinit_ln_1_update_0((c1 - 5) / 1, (c0 - 5) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((5 <= c1 && c1 <= 1924) && ((c1 - 5) % 1 == 0) && (5 <= c0 && c0 <= 1084) && ((c0 - 5) % 1 == 0)) {
	      cp_noinit_ln_1_update_0(demosaic_diff /* buf name */, cp_noinit_ln_1, (c1 - 5) / 1, (c0 - 5) / 1);
	    }
...
void cp_noinit_ln_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_noinit_ln_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    cp_noinit_ln_1_opt(raw_oc, cp_noinit_ln_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { cp_noinit_ln_1_update_0[root = 0, cp_noinit_ln_1_0, cp_noinit_ln_1_1] -> cp_noinit_ln_1[0, 0] : 0 <= cp_noinit_ln_1_0 <= 1919 and 0 <= cp_noinit_ln_1_1 <= 1079 }
const int cp_noinit_ln_1_update_0_write_pipe0_num_transfers = 2073600;
...
void cp_noinit_ln_1_opt_accel(hw_uint<16>* raw_update_0_read_pipe0, hw_uint<16>* cp_noinit_ln_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = raw_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = cp_noinit_ln_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = raw_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = cp_noinit_ln_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > cp_noinit_ln_1_update_0_write_pipe0_channel;

  burst_read<16>(raw_update_0_read_pipe0, raw_update_0_read_pipe0_channel, raw_update_0_read_pipe0_num_transfers*30);

  cp_noinit_ln_1_opt_wrapper(raw_update_0_read_pipe0_channel, cp_noinit_ln_1_update_0_write_pipe0_channel, size);

  burst_write<16>(cp_noinit_ln_1_update_0_write_pipe0, cp_noinit_ln_1_update_0_write_pipe0_channel, cp_noinit_ln_1_update_0_write_pipe0_num_transfers*30);
}

}
extern "C" {

void cp_noinit_ln_1_opt_rdai(HWStream<hw_uint<16> >& raw_update_0_read_pipe0, HWStream<hw_uint<16> >&  cp_noinit_ln_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = raw_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = cp_noinit_ln_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  cp_noinit_ln_1_opt(raw_update_0_read_pipe0, cp_noinit_ln_1_update_0_write_pipe0);
