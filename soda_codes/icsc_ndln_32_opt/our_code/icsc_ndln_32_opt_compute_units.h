...
hw_uint<16> stg10_generated_compute(hw_uint<16*4> stg9) {
  return uint16_t(((uint16_t(stg9.get<16, 2>()) + uint16_t(stg9.get<16, 3>())) + (uint16_t(stg9.get<16, 1>()) + (uint16_t(stg9.get<16, 0>()) + uint16_t(stg9.get<16, 2>())))));
}

hw_uint<16> stg11_generated_compute(hw_uint<16*4> stg10) {
  return uint16_t(((uint16_t(stg10.get<16, 2>()) + uint16_t(stg10.get<16, 3>())) + (uint16_t(stg10.get<16, 1>()) + (uint16_t(stg10.get<16, 0>()) + uint16_t(stg10.get<16, 2>())))));
}

hw_uint<16> stg12_generated_compute(hw_uint<16*4> stg11) {
  return uint16_t(((uint16_t(stg11.get<16, 2>()) + uint16_t(stg11.get<16, 3>())) + (uint16_t(stg11.get<16, 1>()) + (uint16_t(stg11.get<16, 0>()) + uint16_t(stg11.get<16, 2>())))));
}

hw_uint<16> stg13_generated_compute(hw_uint<16*4> stg12) {
  return uint16_t(((uint16_t(stg12.get<16, 2>()) + uint16_t(stg12.get<16, 3>())) + (uint16_t(stg12.get<16, 1>()) + (uint16_t(stg12.get<16, 0>()) + uint16_t(stg12.get<16, 2>())))));
}

hw_uint<16> stg14_generated_compute(hw_uint<16*4> stg13) {
  return uint16_t(((uint16_t(stg13.get<16, 2>()) + uint16_t(stg13.get<16, 3>())) + (uint16_t(stg13.get<16, 1>()) + (uint16_t(stg13.get<16, 0>()) + uint16_t(stg13.get<16, 2>())))));
}

hw_uint<16> stg15_generated_compute(hw_uint<16*4> stg14) {
  return uint16_t(((uint16_t(stg14.get<16, 2>()) + uint16_t(stg14.get<16, 3>())) + (uint16_t(stg14.get<16, 1>()) + (uint16_t(stg14.get<16, 0>()) + uint16_t(stg14.get<16, 2>())))));
}

hw_uint<16> stg16_generated_compute(hw_uint<16*4> stg15) {
  return uint16_t(((uint16_t(stg15.get<16, 2>()) + uint16_t(stg15.get<16, 3>())) + (uint16_t(stg15.get<16, 1>()) + (uint16_t(stg15.get<16, 0>()) + uint16_t(stg15.get<16, 2>())))));
}

hw_uint<16> stg17_generated_compute(hw_uint<16*4> stg16) {
  return uint16_t(((uint16_t(stg16.get<16, 2>()) + uint16_t(stg16.get<16, 3>())) + (uint16_t(stg16.get<16, 1>()) + (uint16_t(stg16.get<16, 0>()) + uint16_t(stg16.get<16, 2>())))));
}

hw_uint<16> stg18_generated_compute(hw_uint<16*4> stg17) {
  return uint16_t(((uint16_t(stg17.get<16, 2>()) + uint16_t(stg17.get<16, 3>())) + (uint16_t(stg17.get<16, 1>()) + (uint16_t(stg17.get<16, 0>()) + uint16_t(stg17.get<16, 2>())))));
}

hw_uint<16> stg19_generated_compute(hw_uint<16*4> stg18) {
  return uint16_t(((uint16_t(stg18.get<16, 2>()) + uint16_t(stg18.get<16, 3>())) + (uint16_t(stg18.get<16, 1>()) + (uint16_t(stg18.get<16, 0>()) + uint16_t(stg18.get<16, 2>())))));
}

hw_uint<16> icsc_ndln_32_generated_compute(hw_uint<16*1> stg19) {
...
hw_uint<512>  stg11_generated_compute_unrolled_32(hw_uint<2048>& stg10) {
  ...
  // stg12_update_0 unroll factor: 32
hw_uint<512>  stg12_generated_compute_unrolled_32(hw_uint<2048>& stg11) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg11;
  set_at<0, 64, 64>(lane_16_stg11, stg11.extract<1024, 1087>());
  auto result_16 = stg12_generated_compute(lane_16_stg11);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg11;
  set_at<0, 64, 64>(lane_17_stg11, stg11.extract<1088, 1151>());
  auto result_17 = stg12_generated_compute(lane_17_stg11);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg11;
  set_at<0, 64, 64>(lane_18_stg11, stg11.extract<1152, 1215>());
  auto result_18 = stg12_generated_compute(lane_18_stg11);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg11;
  set_at<0, 64, 64>(lane_19_stg11, stg11.extract<1216, 1279>());
  auto result_19 = stg12_generated_compute(lane_19_stg11);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg11;
  set_at<0, 64, 64>(lane_20_stg11, stg11.extract<1280, 1343>());
  auto result_20 = stg12_generated_compute(lane_20_stg11);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg11;
  set_at<0, 64, 64>(lane_21_stg11, stg11.extract<1344, 1407>());
  auto result_21 = stg12_generated_compute(lane_21_stg11);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg11;
  set_at<0, 64, 64>(lane_22_stg11, stg11.extract<1408, 1471>());
  auto result_22 = stg12_generated_compute(lane_22_stg11);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg11;
  set_at<0, 64, 64>(lane_23_stg11, stg11.extract<1472, 1535>());
  auto result_23 = stg12_generated_compute(lane_23_stg11);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg11;
  set_at<0, 64, 64>(lane_24_stg11, stg11.extract<1536, 1599>());
  auto result_24 = stg12_generated_compute(lane_24_stg11);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg11;
  set_at<0, 64, 64>(lane_25_stg11, stg11.extract<1600, 1663>());
  auto result_25 = stg12_generated_compute(lane_25_stg11);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg11;
  set_at<0, 64, 64>(lane_26_stg11, stg11.extract<1664, 1727>());
  auto result_26 = stg12_generated_compute(lane_26_stg11);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg11;
  set_at<0, 64, 64>(lane_27_stg11, stg11.extract<1728, 1791>());
  auto result_27 = stg12_generated_compute(lane_27_stg11);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg11;
  set_at<0, 64, 64>(lane_28_stg11, stg11.extract<1792, 1855>());
  auto result_28 = stg12_generated_compute(lane_28_stg11);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg11;
  set_at<0, 64, 64>(lane_29_stg11, stg11.extract<1856, 1919>());
  auto result_29 = stg12_generated_compute(lane_29_stg11);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg11;
  set_at<0, 64, 64>(lane_30_stg11, stg11.extract<1920, 1983>());
  auto result_30 = stg12_generated_compute(lane_30_stg11);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg11;
  set_at<0, 64, 64>(lane_31_stg11, stg11.extract<1984, 2047>());
  auto result_31 = stg12_generated_compute(lane_31_stg11);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg13_update_0 unroll factor: 32
hw_uint<512>  stg13_generated_compute_unrolled_32(hw_uint<2048>& stg12) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg12;
  set_at<0, 64, 64>(lane_16_stg12, stg12.extract<1024, 1087>());
  auto result_16 = stg13_generated_compute(lane_16_stg12);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg12;
  set_at<0, 64, 64>(lane_17_stg12, stg12.extract<1088, 1151>());
  auto result_17 = stg13_generated_compute(lane_17_stg12);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg12;
  set_at<0, 64, 64>(lane_18_stg12, stg12.extract<1152, 1215>());
  auto result_18 = stg13_generated_compute(lane_18_stg12);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg12;
  set_at<0, 64, 64>(lane_19_stg12, stg12.extract<1216, 1279>());
  auto result_19 = stg13_generated_compute(lane_19_stg12);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg12;
  set_at<0, 64, 64>(lane_20_stg12, stg12.extract<1280, 1343>());
  auto result_20 = stg13_generated_compute(lane_20_stg12);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg12;
  set_at<0, 64, 64>(lane_21_stg12, stg12.extract<1344, 1407>());
  auto result_21 = stg13_generated_compute(lane_21_stg12);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg12;
  set_at<0, 64, 64>(lane_22_stg12, stg12.extract<1408, 1471>());
  auto result_22 = stg13_generated_compute(lane_22_stg12);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg12;
  set_at<0, 64, 64>(lane_23_stg12, stg12.extract<1472, 1535>());
  auto result_23 = stg13_generated_compute(lane_23_stg12);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg12;
  set_at<0, 64, 64>(lane_24_stg12, stg12.extract<1536, 1599>());
  auto result_24 = stg13_generated_compute(lane_24_stg12);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg12;
  set_at<0, 64, 64>(lane_25_stg12, stg12.extract<1600, 1663>());
  auto result_25 = stg13_generated_compute(lane_25_stg12);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg12;
  set_at<0, 64, 64>(lane_26_stg12, stg12.extract<1664, 1727>());
  auto result_26 = stg13_generated_compute(lane_26_stg12);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg12;
  set_at<0, 64, 64>(lane_27_stg12, stg12.extract<1728, 1791>());
  auto result_27 = stg13_generated_compute(lane_27_stg12);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg12;
  set_at<0, 64, 64>(lane_28_stg12, stg12.extract<1792, 1855>());
  auto result_28 = stg13_generated_compute(lane_28_stg12);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg12;
  set_at<0, 64, 64>(lane_29_stg12, stg12.extract<1856, 1919>());
  auto result_29 = stg13_generated_compute(lane_29_stg12);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg12;
  set_at<0, 64, 64>(lane_30_stg12, stg12.extract<1920, 1983>());
  auto result_30 = stg13_generated_compute(lane_30_stg12);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg12;
  set_at<0, 64, 64>(lane_31_stg12, stg12.extract<1984, 2047>());
  auto result_31 = stg13_generated_compute(lane_31_stg12);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg14_update_0 unroll factor: 32
hw_uint<512>  stg14_generated_compute_unrolled_32(hw_uint<2048>& stg13) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg13;
  set_at<0, 64, 64>(lane_16_stg13, stg13.extract<1024, 1087>());
  auto result_16 = stg14_generated_compute(lane_16_stg13);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg13;
  set_at<0, 64, 64>(lane_17_stg13, stg13.extract<1088, 1151>());
  auto result_17 = stg14_generated_compute(lane_17_stg13);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg13;
  set_at<0, 64, 64>(lane_18_stg13, stg13.extract<1152, 1215>());
  auto result_18 = stg14_generated_compute(lane_18_stg13);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg13;
  set_at<0, 64, 64>(lane_19_stg13, stg13.extract<1216, 1279>());
  auto result_19 = stg14_generated_compute(lane_19_stg13);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg13;
  set_at<0, 64, 64>(lane_20_stg13, stg13.extract<1280, 1343>());
  auto result_20 = stg14_generated_compute(lane_20_stg13);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg13;
  set_at<0, 64, 64>(lane_21_stg13, stg13.extract<1344, 1407>());
  auto result_21 = stg14_generated_compute(lane_21_stg13);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg13;
  set_at<0, 64, 64>(lane_22_stg13, stg13.extract<1408, 1471>());
  auto result_22 = stg14_generated_compute(lane_22_stg13);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg13;
  set_at<0, 64, 64>(lane_23_stg13, stg13.extract<1472, 1535>());
  auto result_23 = stg14_generated_compute(lane_23_stg13);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg13;
  set_at<0, 64, 64>(lane_24_stg13, stg13.extract<1536, 1599>());
  auto result_24 = stg14_generated_compute(lane_24_stg13);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg13;
  set_at<0, 64, 64>(lane_25_stg13, stg13.extract<1600, 1663>());
  auto result_25 = stg14_generated_compute(lane_25_stg13);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg13;
  set_at<0, 64, 64>(lane_26_stg13, stg13.extract<1664, 1727>());
  auto result_26 = stg14_generated_compute(lane_26_stg13);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg13;
  set_at<0, 64, 64>(lane_27_stg13, stg13.extract<1728, 1791>());
  auto result_27 = stg14_generated_compute(lane_27_stg13);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg13;
  set_at<0, 64, 64>(lane_28_stg13, stg13.extract<1792, 1855>());
  auto result_28 = stg14_generated_compute(lane_28_stg13);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg13;
  set_at<0, 64, 64>(lane_29_stg13, stg13.extract<1856, 1919>());
  auto result_29 = stg14_generated_compute(lane_29_stg13);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg13;
  set_at<0, 64, 64>(lane_30_stg13, stg13.extract<1920, 1983>());
  auto result_30 = stg14_generated_compute(lane_30_stg13);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg13;
  set_at<0, 64, 64>(lane_31_stg13, stg13.extract<1984, 2047>());
  auto result_31 = stg14_generated_compute(lane_31_stg13);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg15_update_0 unroll factor: 32
hw_uint<512>  stg15_generated_compute_unrolled_32(hw_uint<2048>& stg14) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg14;
  set_at<0, 64, 64>(lane_16_stg14, stg14.extract<1024, 1087>());
  auto result_16 = stg15_generated_compute(lane_16_stg14);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg14;
  set_at<0, 64, 64>(lane_17_stg14, stg14.extract<1088, 1151>());
  auto result_17 = stg15_generated_compute(lane_17_stg14);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg14;
  set_at<0, 64, 64>(lane_18_stg14, stg14.extract<1152, 1215>());
  auto result_18 = stg15_generated_compute(lane_18_stg14);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg14;
  set_at<0, 64, 64>(lane_19_stg14, stg14.extract<1216, 1279>());
  auto result_19 = stg15_generated_compute(lane_19_stg14);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg14;
  set_at<0, 64, 64>(lane_20_stg14, stg14.extract<1280, 1343>());
  auto result_20 = stg15_generated_compute(lane_20_stg14);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg14;
  set_at<0, 64, 64>(lane_21_stg14, stg14.extract<1344, 1407>());
  auto result_21 = stg15_generated_compute(lane_21_stg14);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg14;
  set_at<0, 64, 64>(lane_22_stg14, stg14.extract<1408, 1471>());
  auto result_22 = stg15_generated_compute(lane_22_stg14);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg14;
  set_at<0, 64, 64>(lane_23_stg14, stg14.extract<1472, 1535>());
  auto result_23 = stg15_generated_compute(lane_23_stg14);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg14;
  set_at<0, 64, 64>(lane_24_stg14, stg14.extract<1536, 1599>());
  auto result_24 = stg15_generated_compute(lane_24_stg14);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg14;
  set_at<0, 64, 64>(lane_25_stg14, stg14.extract<1600, 1663>());
  auto result_25 = stg15_generated_compute(lane_25_stg14);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg14;
  set_at<0, 64, 64>(lane_26_stg14, stg14.extract<1664, 1727>());
  auto result_26 = stg15_generated_compute(lane_26_stg14);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg14;
  set_at<0, 64, 64>(lane_27_stg14, stg14.extract<1728, 1791>());
  auto result_27 = stg15_generated_compute(lane_27_stg14);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg14;
  set_at<0, 64, 64>(lane_28_stg14, stg14.extract<1792, 1855>());
  auto result_28 = stg15_generated_compute(lane_28_stg14);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg14;
  set_at<0, 64, 64>(lane_29_stg14, stg14.extract<1856, 1919>());
  auto result_29 = stg15_generated_compute(lane_29_stg14);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg14;
  set_at<0, 64, 64>(lane_30_stg14, stg14.extract<1920, 1983>());
  auto result_30 = stg15_generated_compute(lane_30_stg14);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg14;
  set_at<0, 64, 64>(lane_31_stg14, stg14.extract<1984, 2047>());
  auto result_31 = stg15_generated_compute(lane_31_stg14);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg16_update_0 unroll factor: 32
hw_uint<512>  stg16_generated_compute_unrolled_32(hw_uint<2048>& stg15) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg15;
  set_at<0, 64, 64>(lane_16_stg15, stg15.extract<1024, 1087>());
  auto result_16 = stg16_generated_compute(lane_16_stg15);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg15;
  set_at<0, 64, 64>(lane_17_stg15, stg15.extract<1088, 1151>());
  auto result_17 = stg16_generated_compute(lane_17_stg15);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg15;
  set_at<0, 64, 64>(lane_18_stg15, stg15.extract<1152, 1215>());
  auto result_18 = stg16_generated_compute(lane_18_stg15);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg15;
  set_at<0, 64, 64>(lane_19_stg15, stg15.extract<1216, 1279>());
  auto result_19 = stg16_generated_compute(lane_19_stg15);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg15;
  set_at<0, 64, 64>(lane_20_stg15, stg15.extract<1280, 1343>());
  auto result_20 = stg16_generated_compute(lane_20_stg15);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg15;
  set_at<0, 64, 64>(lane_21_stg15, stg15.extract<1344, 1407>());
  auto result_21 = stg16_generated_compute(lane_21_stg15);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg15;
  set_at<0, 64, 64>(lane_22_stg15, stg15.extract<1408, 1471>());
  auto result_22 = stg16_generated_compute(lane_22_stg15);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg15;
  set_at<0, 64, 64>(lane_23_stg15, stg15.extract<1472, 1535>());
  auto result_23 = stg16_generated_compute(lane_23_stg15);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg15;
  set_at<0, 64, 64>(lane_24_stg15, stg15.extract<1536, 1599>());
  auto result_24 = stg16_generated_compute(lane_24_stg15);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg15;
  set_at<0, 64, 64>(lane_25_stg15, stg15.extract<1600, 1663>());
  auto result_25 = stg16_generated_compute(lane_25_stg15);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg15;
  set_at<0, 64, 64>(lane_26_stg15, stg15.extract<1664, 1727>());
  auto result_26 = stg16_generated_compute(lane_26_stg15);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg15;
  set_at<0, 64, 64>(lane_27_stg15, stg15.extract<1728, 1791>());
  auto result_27 = stg16_generated_compute(lane_27_stg15);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg15;
  set_at<0, 64, 64>(lane_28_stg15, stg15.extract<1792, 1855>());
  auto result_28 = stg16_generated_compute(lane_28_stg15);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg15;
  set_at<0, 64, 64>(lane_29_stg15, stg15.extract<1856, 1919>());
  auto result_29 = stg16_generated_compute(lane_29_stg15);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg15;
  set_at<0, 64, 64>(lane_30_stg15, stg15.extract<1920, 1983>());
  auto result_30 = stg16_generated_compute(lane_30_stg15);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg15;
  set_at<0, 64, 64>(lane_31_stg15, stg15.extract<1984, 2047>());
  auto result_31 = stg16_generated_compute(lane_31_stg15);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg17_update_0 unroll factor: 32
hw_uint<512>  stg17_generated_compute_unrolled_32(hw_uint<2048>& stg16) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg16;
  set_at<0, 64, 64>(lane_16_stg16, stg16.extract<1024, 1087>());
  auto result_16 = stg17_generated_compute(lane_16_stg16);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg16;
  set_at<0, 64, 64>(lane_17_stg16, stg16.extract<1088, 1151>());
  auto result_17 = stg17_generated_compute(lane_17_stg16);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg16;
  set_at<0, 64, 64>(lane_18_stg16, stg16.extract<1152, 1215>());
  auto result_18 = stg17_generated_compute(lane_18_stg16);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg16;
  set_at<0, 64, 64>(lane_19_stg16, stg16.extract<1216, 1279>());
  auto result_19 = stg17_generated_compute(lane_19_stg16);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg16;
  set_at<0, 64, 64>(lane_20_stg16, stg16.extract<1280, 1343>());
  auto result_20 = stg17_generated_compute(lane_20_stg16);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg16;
  set_at<0, 64, 64>(lane_21_stg16, stg16.extract<1344, 1407>());
  auto result_21 = stg17_generated_compute(lane_21_stg16);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg16;
  set_at<0, 64, 64>(lane_22_stg16, stg16.extract<1408, 1471>());
  auto result_22 = stg17_generated_compute(lane_22_stg16);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg16;
  set_at<0, 64, 64>(lane_23_stg16, stg16.extract<1472, 1535>());
  auto result_23 = stg17_generated_compute(lane_23_stg16);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg16;
  set_at<0, 64, 64>(lane_24_stg16, stg16.extract<1536, 1599>());
  auto result_24 = stg17_generated_compute(lane_24_stg16);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg16;
  set_at<0, 64, 64>(lane_25_stg16, stg16.extract<1600, 1663>());
  auto result_25 = stg17_generated_compute(lane_25_stg16);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg16;
  set_at<0, 64, 64>(lane_26_stg16, stg16.extract<1664, 1727>());
  auto result_26 = stg17_generated_compute(lane_26_stg16);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg16;
  set_at<0, 64, 64>(lane_27_stg16, stg16.extract<1728, 1791>());
  auto result_27 = stg17_generated_compute(lane_27_stg16);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg16;
  set_at<0, 64, 64>(lane_28_stg16, stg16.extract<1792, 1855>());
  auto result_28 = stg17_generated_compute(lane_28_stg16);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg16;
  set_at<0, 64, 64>(lane_29_stg16, stg16.extract<1856, 1919>());
  auto result_29 = stg17_generated_compute(lane_29_stg16);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg16;
  set_at<0, 64, 64>(lane_30_stg16, stg16.extract<1920, 1983>());
  auto result_30 = stg17_generated_compute(lane_30_stg16);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg16;
  set_at<0, 64, 64>(lane_31_stg16, stg16.extract<1984, 2047>());
  auto result_31 = stg17_generated_compute(lane_31_stg16);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg18_update_0 unroll factor: 32
hw_uint<512>  stg18_generated_compute_unrolled_32(hw_uint<2048>& stg17) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg17;
  set_at<0, 64, 64>(lane_16_stg17, stg17.extract<1024, 1087>());
  auto result_16 = stg18_generated_compute(lane_16_stg17);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg17;
  set_at<0, 64, 64>(lane_17_stg17, stg17.extract<1088, 1151>());
  auto result_17 = stg18_generated_compute(lane_17_stg17);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg17;
  set_at<0, 64, 64>(lane_18_stg17, stg17.extract<1152, 1215>());
  auto result_18 = stg18_generated_compute(lane_18_stg17);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg17;
  set_at<0, 64, 64>(lane_19_stg17, stg17.extract<1216, 1279>());
  auto result_19 = stg18_generated_compute(lane_19_stg17);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg17;
  set_at<0, 64, 64>(lane_20_stg17, stg17.extract<1280, 1343>());
  auto result_20 = stg18_generated_compute(lane_20_stg17);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg17;
  set_at<0, 64, 64>(lane_21_stg17, stg17.extract<1344, 1407>());
  auto result_21 = stg18_generated_compute(lane_21_stg17);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg17;
  set_at<0, 64, 64>(lane_22_stg17, stg17.extract<1408, 1471>());
  auto result_22 = stg18_generated_compute(lane_22_stg17);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg17;
  set_at<0, 64, 64>(lane_23_stg17, stg17.extract<1472, 1535>());
  auto result_23 = stg18_generated_compute(lane_23_stg17);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg17;
  set_at<0, 64, 64>(lane_24_stg17, stg17.extract<1536, 1599>());
  auto result_24 = stg18_generated_compute(lane_24_stg17);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg17;
  set_at<0, 64, 64>(lane_25_stg17, stg17.extract<1600, 1663>());
  auto result_25 = stg18_generated_compute(lane_25_stg17);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg17;
  set_at<0, 64, 64>(lane_26_stg17, stg17.extract<1664, 1727>());
  auto result_26 = stg18_generated_compute(lane_26_stg17);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg17;
  set_at<0, 64, 64>(lane_27_stg17, stg17.extract<1728, 1791>());
  auto result_27 = stg18_generated_compute(lane_27_stg17);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg17;
  set_at<0, 64, 64>(lane_28_stg17, stg17.extract<1792, 1855>());
  auto result_28 = stg18_generated_compute(lane_28_stg17);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg17;
  set_at<0, 64, 64>(lane_29_stg17, stg17.extract<1856, 1919>());
  auto result_29 = stg18_generated_compute(lane_29_stg17);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg17;
  set_at<0, 64, 64>(lane_30_stg17, stg17.extract<1920, 1983>());
  auto result_30 = stg18_generated_compute(lane_30_stg17);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg17;
  set_at<0, 64, 64>(lane_31_stg17, stg17.extract<1984, 2047>());
  auto result_31 = stg18_generated_compute(lane_31_stg17);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // stg19_update_0 unroll factor: 32
hw_uint<512>  stg19_generated_compute_unrolled_32(hw_uint<2048>& stg18) {
  hw_uint<512> whole_result;
  ...
  hw_uint<64> lane_16_stg18;
  set_at<0, 64, 64>(lane_16_stg18, stg18.extract<1024, 1087>());
  auto result_16 = stg19_generated_compute(lane_16_stg18);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<64> lane_17_stg18;
  set_at<0, 64, 64>(lane_17_stg18, stg18.extract<1088, 1151>());
  auto result_17 = stg19_generated_compute(lane_17_stg18);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<64> lane_18_stg18;
  set_at<0, 64, 64>(lane_18_stg18, stg18.extract<1152, 1215>());
  auto result_18 = stg19_generated_compute(lane_18_stg18);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<64> lane_19_stg18;
  set_at<0, 64, 64>(lane_19_stg18, stg18.extract<1216, 1279>());
  auto result_19 = stg19_generated_compute(lane_19_stg18);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<64> lane_20_stg18;
  set_at<0, 64, 64>(lane_20_stg18, stg18.extract<1280, 1343>());
  auto result_20 = stg19_generated_compute(lane_20_stg18);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<64> lane_21_stg18;
  set_at<0, 64, 64>(lane_21_stg18, stg18.extract<1344, 1407>());
  auto result_21 = stg19_generated_compute(lane_21_stg18);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<64> lane_22_stg18;
  set_at<0, 64, 64>(lane_22_stg18, stg18.extract<1408, 1471>());
  auto result_22 = stg19_generated_compute(lane_22_stg18);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<64> lane_23_stg18;
  set_at<0, 64, 64>(lane_23_stg18, stg18.extract<1472, 1535>());
  auto result_23 = stg19_generated_compute(lane_23_stg18);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<64> lane_24_stg18;
  set_at<0, 64, 64>(lane_24_stg18, stg18.extract<1536, 1599>());
  auto result_24 = stg19_generated_compute(lane_24_stg18);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<64> lane_25_stg18;
  set_at<0, 64, 64>(lane_25_stg18, stg18.extract<1600, 1663>());
  auto result_25 = stg19_generated_compute(lane_25_stg18);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<64> lane_26_stg18;
  set_at<0, 64, 64>(lane_26_stg18, stg18.extract<1664, 1727>());
  auto result_26 = stg19_generated_compute(lane_26_stg18);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<64> lane_27_stg18;
  set_at<0, 64, 64>(lane_27_stg18, stg18.extract<1728, 1791>());
  auto result_27 = stg19_generated_compute(lane_27_stg18);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<64> lane_28_stg18;
  set_at<0, 64, 64>(lane_28_stg18, stg18.extract<1792, 1855>());
  auto result_28 = stg19_generated_compute(lane_28_stg18);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<64> lane_29_stg18;
  set_at<0, 64, 64>(lane_29_stg18, stg18.extract<1856, 1919>());
  auto result_29 = stg19_generated_compute(lane_29_stg18);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<64> lane_30_stg18;
  set_at<0, 64, 64>(lane_30_stg18, stg18.extract<1920, 1983>());
  auto result_30 = stg19_generated_compute(lane_30_stg18);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<64> lane_31_stg18;
  set_at<0, 64, 64>(lane_31_stg18, stg18.extract<1984, 2047>());
  auto result_31 = stg19_generated_compute(lane_31_stg18);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}

  // icsc_ndln_32_update_0 unroll factor: 32
hw_uint<512>  icsc_ndln_32_generated_compute_unrolled_32(hw_uint<512>& stg19) {
  hw_uint<512> whole_result;

  hw_uint<16> lane_0_stg19;
  set_at<0, 16, 16>(lane_0_stg19, stg19.extract<0, 15>());
  auto result_0 = icsc_ndln_32_generated_compute(lane_0_stg19);
  set_at<0, 512, 16>(whole_result, result_0);

  hw_uint<16> lane_1_stg19;
  set_at<0, 16, 16>(lane_1_stg19, stg19.extract<16, 31>());
  auto result_1 = icsc_ndln_32_generated_compute(lane_1_stg19);
  set_at<16, 512, 16>(whole_result, result_1);

  hw_uint<16> lane_2_stg19;
  set_at<0, 16, 16>(lane_2_stg19, stg19.extract<32, 47>());
  auto result_2 = icsc_ndln_32_generated_compute(lane_2_stg19);
  set_at<32, 512, 16>(whole_result, result_2);

  hw_uint<16> lane_3_stg19;
  set_at<0, 16, 16>(lane_3_stg19, stg19.extract<48, 63>());
  auto result_3 = icsc_ndln_32_generated_compute(lane_3_stg19);
  set_at<48, 512, 16>(whole_result, result_3);

  hw_uint<16> lane_4_stg19;
  set_at<0, 16, 16>(lane_4_stg19, stg19.extract<64, 79>());
  auto result_4 = icsc_ndln_32_generated_compute(lane_4_stg19);
  set_at<64, 512, 16>(whole_result, result_4);

  hw_uint<16> lane_5_stg19;
  set_at<0, 16, 16>(lane_5_stg19, stg19.extract<80, 95>());
  auto result_5 = icsc_ndln_32_generated_compute(lane_5_stg19);
  set_at<80, 512, 16>(whole_result, result_5);

  hw_uint<16> lane_6_stg19;
  set_at<0, 16, 16>(lane_6_stg19, stg19.extract<96, 111>());
  auto result_6 = icsc_ndln_32_generated_compute(lane_6_stg19);
  set_at<96, 512, 16>(whole_result, result_6);

  hw_uint<16> lane_7_stg19;
  set_at<0, 16, 16>(lane_7_stg19, stg19.extract<112, 127>());
  auto result_7 = icsc_ndln_32_generated_compute(lane_7_stg19);
  set_at<112, 512, 16>(whole_result, result_7);

  hw_uint<16> lane_8_stg19;
  set_at<0, 16, 16>(lane_8_stg19, stg19.extract<128, 143>());
  auto result_8 = icsc_ndln_32_generated_compute(lane_8_stg19);
  set_at<128, 512, 16>(whole_result, result_8);

  hw_uint<16> lane_9_stg19;
  set_at<0, 16, 16>(lane_9_stg19, stg19.extract<144, 159>());
  auto result_9 = icsc_ndln_32_generated_compute(lane_9_stg19);
  set_at<144, 512, 16>(whole_result, result_9);

  hw_uint<16> lane_10_stg19;
  set_at<0, 16, 16>(lane_10_stg19, stg19.extract<160, 175>());
  auto result_10 = icsc_ndln_32_generated_compute(lane_10_stg19);
  set_at<160, 512, 16>(whole_result, result_10);

  hw_uint<16> lane_11_stg19;
  set_at<0, 16, 16>(lane_11_stg19, stg19.extract<176, 191>());
  auto result_11 = icsc_ndln_32_generated_compute(lane_11_stg19);
  set_at<176, 512, 16>(whole_result, result_11);

  hw_uint<16> lane_12_stg19;
  set_at<0, 16, 16>(lane_12_stg19, stg19.extract<192, 207>());
  auto result_12 = icsc_ndln_32_generated_compute(lane_12_stg19);
  set_at<192, 512, 16>(whole_result, result_12);

  hw_uint<16> lane_13_stg19;
  set_at<0, 16, 16>(lane_13_stg19, stg19.extract<208, 223>());
  auto result_13 = icsc_ndln_32_generated_compute(lane_13_stg19);
  set_at<208, 512, 16>(whole_result, result_13);

  hw_uint<16> lane_14_stg19;
  set_at<0, 16, 16>(lane_14_stg19, stg19.extract<224, 239>());
  auto result_14 = icsc_ndln_32_generated_compute(lane_14_stg19);
  set_at<224, 512, 16>(whole_result, result_14);

  hw_uint<16> lane_15_stg19;
  set_at<0, 16, 16>(lane_15_stg19, stg19.extract<240, 255>());
  auto result_15 = icsc_ndln_32_generated_compute(lane_15_stg19);
  set_at<240, 512, 16>(whole_result, result_15);

  hw_uint<16> lane_16_stg19;
  set_at<0, 16, 16>(lane_16_stg19, stg19.extract<256, 271>());
  auto result_16 = icsc_ndln_32_generated_compute(lane_16_stg19);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<16> lane_17_stg19;
  set_at<0, 16, 16>(lane_17_stg19, stg19.extract<272, 287>());
  auto result_17 = icsc_ndln_32_generated_compute(lane_17_stg19);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<16> lane_18_stg19;
  set_at<0, 16, 16>(lane_18_stg19, stg19.extract<288, 303>());
  auto result_18 = icsc_ndln_32_generated_compute(lane_18_stg19);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<16> lane_19_stg19;
  set_at<0, 16, 16>(lane_19_stg19, stg19.extract<304, 319>());
  auto result_19 = icsc_ndln_32_generated_compute(lane_19_stg19);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<16> lane_20_stg19;
  set_at<0, 16, 16>(lane_20_stg19, stg19.extract<320, 335>());
  auto result_20 = icsc_ndln_32_generated_compute(lane_20_stg19);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<16> lane_21_stg19;
  set_at<0, 16, 16>(lane_21_stg19, stg19.extract<336, 351>());
  auto result_21 = icsc_ndln_32_generated_compute(lane_21_stg19);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<16> lane_22_stg19;
  set_at<0, 16, 16>(lane_22_stg19, stg19.extract<352, 367>());
  auto result_22 = icsc_ndln_32_generated_compute(lane_22_stg19);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<16> lane_23_stg19;
  set_at<0, 16, 16>(lane_23_stg19, stg19.extract<368, 383>());
  auto result_23 = icsc_ndln_32_generated_compute(lane_23_stg19);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<16> lane_24_stg19;
  set_at<0, 16, 16>(lane_24_stg19, stg19.extract<384, 399>());
  auto result_24 = icsc_ndln_32_generated_compute(lane_24_stg19);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<16> lane_25_stg19;
  set_at<0, 16, 16>(lane_25_stg19, stg19.extract<400, 415>());
  auto result_25 = icsc_ndln_32_generated_compute(lane_25_stg19);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<16> lane_26_stg19;
  set_at<0, 16, 16>(lane_26_stg19, stg19.extract<416, 431>());
  auto result_26 = icsc_ndln_32_generated_compute(lane_26_stg19);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<16> lane_27_stg19;
  set_at<0, 16, 16>(lane_27_stg19, stg19.extract<432, 447>());
  auto result_27 = icsc_ndln_32_generated_compute(lane_27_stg19);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<16> lane_28_stg19;
  set_at<0, 16, 16>(lane_28_stg19, stg19.extract<448, 463>());
  auto result_28 = icsc_ndln_32_generated_compute(lane_28_stg19);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<16> lane_29_stg19;
  set_at<0, 16, 16>(lane_29_stg19, stg19.extract<464, 479>());
  auto result_29 = icsc_ndln_32_generated_compute(lane_29_stg19);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<16> lane_30_stg19;
  set_at<0, 16, 16>(lane_30_stg19, stg19.extract<480, 495>());
  auto result_30 = icsc_ndln_32_generated_compute(lane_30_stg19);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<16> lane_31_stg19;
  set_at<0, 16, 16>(lane_31_stg19, stg19.extract<496, 511>());
  auto result_31 = icsc_ndln_32_generated_compute(lane_31_stg19);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}
