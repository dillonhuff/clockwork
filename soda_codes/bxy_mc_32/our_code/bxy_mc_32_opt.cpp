...
// compute file: bxy_mc_32_opt_compute_units.h
#include "bxy_mc_32_opt_compute_units.h"
...
inline hw_uint<16> bxy_mc_32_rd0_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd0 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd1_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd1 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[1 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd10_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd10 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[4 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd11_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd11 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[5 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd12_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd12 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[4 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write4 = blurx.blurx_blurx_update_0_write4_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write4;
...
inline hw_uint<16> bxy_mc_32_rd13_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd13 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[5 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write5 = blurx.blurx_blurx_update_0_write5_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write5;
...
inline hw_uint<16> bxy_mc_32_rd14_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd14 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[6 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd15_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd15 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[5 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write5 = blurx.blurx_blurx_update_0_write5_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write5;
...
inline hw_uint<16> bxy_mc_32_rd16_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd16 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[6 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write6 = blurx.blurx_blurx_update_0_write6_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write6;
...
inline hw_uint<16> bxy_mc_32_rd17_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd17 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[7 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd18_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd18 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[6 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write6 = blurx.blurx_blurx_update_0_write6_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write6;
...
inline hw_uint<16> bxy_mc_32_rd19_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd19 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[7 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write7 = blurx.blurx_blurx_update_0_write7_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write7;
...
inline hw_uint<16> bxy_mc_32_rd2_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd2 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[2 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd20_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd20 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[8 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd21_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd21 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[7 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write7 = blurx.blurx_blurx_update_0_write7_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write7;
...
inline hw_uint<16> bxy_mc_32_rd22_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd22 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[8 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write8 = blurx.blurx_blurx_update_0_write8_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write8;
...
inline hw_uint<16> bxy_mc_32_rd23_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd23 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[9 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd24_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd24 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[8 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write8 = blurx.blurx_blurx_update_0_write8_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write8;
...
inline hw_uint<16> bxy_mc_32_rd25_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd25 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[9 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write9 = blurx.blurx_blurx_update_0_write9_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write9;
...
inline hw_uint<16> bxy_mc_32_rd26_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd26 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[10 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd27_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd27 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[9 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write9 = blurx.blurx_blurx_update_0_write9_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write9;
...
inline hw_uint<16> bxy_mc_32_rd28_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd28 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[10 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write10 = blurx.blurx_blurx_update_0_write10_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write10;
...
inline hw_uint<16> bxy_mc_32_rd29_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd29 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[11 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd3_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd3 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[1 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write1 = blurx.blurx_blurx_update_0_write1_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write1;
...
inline hw_uint<16> bxy_mc_32_rd30_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd30 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[10 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write10 = blurx.blurx_blurx_update_0_write10_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write10;
...
inline hw_uint<16> bxy_mc_32_rd31_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd31 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[11 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write11 = blurx.blurx_blurx_update_0_write11_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write11;
...
inline hw_uint<16> bxy_mc_32_rd32_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd32 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[12 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd33_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd33 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[11 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write11 = blurx.blurx_blurx_update_0_write11_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write11;
...
inline hw_uint<16> bxy_mc_32_rd34_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd34 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[12 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write12 = blurx.blurx_blurx_update_0_write12_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write12;
...
inline hw_uint<16> bxy_mc_32_rd35_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd35 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[13 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd36_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd36 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[12 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write12 = blurx.blurx_blurx_update_0_write12_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write12;
...
inline hw_uint<16> bxy_mc_32_rd37_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd37 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[13 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write13 = blurx.blurx_blurx_update_0_write13_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write13;
...
inline hw_uint<16> bxy_mc_32_rd38_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd38 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[14 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd39_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd39 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[13 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write13 = blurx.blurx_blurx_update_0_write13_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write13;
...
inline hw_uint<16> bxy_mc_32_rd4_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd4 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[2 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write2 = blurx.blurx_blurx_update_0_write2_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write2;
...
inline hw_uint<16> bxy_mc_32_rd40_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd40 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[14 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write14 = blurx.blurx_blurx_update_0_write14_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write14;
...
inline hw_uint<16> bxy_mc_32_rd41_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd41 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[15 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd42_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd42 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[14 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write14 = blurx.blurx_blurx_update_0_write14_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write14;
...
inline hw_uint<16> bxy_mc_32_rd43_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd43 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[15 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write15 = blurx.blurx_blurx_update_0_write15_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write15;
...
inline hw_uint<16> bxy_mc_32_rd44_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd44 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[16 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd45_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd45 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[15 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write15 = blurx.blurx_blurx_update_0_write15_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write15;
...
inline hw_uint<16> bxy_mc_32_rd46_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd46 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[16 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write16 = blurx.blurx_blurx_update_0_write16_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write16;
...
inline hw_uint<16> bxy_mc_32_rd47_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd47 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[17 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd48_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd48 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[16 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write16 = blurx.blurx_blurx_update_0_write16_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write16;
...
inline hw_uint<16> bxy_mc_32_rd49_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd49 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[17 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write17 = blurx.blurx_blurx_update_0_write17_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write17;
...
inline hw_uint<16> bxy_mc_32_rd5_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd5 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[3 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd50_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd50 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[18 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd51_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd51 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[17 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write17 = blurx.blurx_blurx_update_0_write17_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write17;
...
inline hw_uint<16> bxy_mc_32_rd52_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd52 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[18 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write18 = blurx.blurx_blurx_update_0_write18_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write18;
...
inline hw_uint<16> bxy_mc_32_rd53_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd53 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[19 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd54_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd54 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[18 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write18 = blurx.blurx_blurx_update_0_write18_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write18;
...
inline hw_uint<16> bxy_mc_32_rd55_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd55 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[19 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write19 = blurx.blurx_blurx_update_0_write19_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write19;
...
inline hw_uint<16> bxy_mc_32_rd56_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd56 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[20 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd57_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd57 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[19 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write19 = blurx.blurx_blurx_update_0_write19_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write19;
...
inline hw_uint<16> bxy_mc_32_rd58_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd58 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[20 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write20 = blurx.blurx_blurx_update_0_write20_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write20;
...
inline hw_uint<16> bxy_mc_32_rd59_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd59 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[21 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd6_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd6 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[2 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write2 = blurx.blurx_blurx_update_0_write2_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write2;
...
inline hw_uint<16> bxy_mc_32_rd60_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd60 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[20 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write20 = blurx.blurx_blurx_update_0_write20_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write20;
...
inline hw_uint<16> bxy_mc_32_rd61_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd61 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[21 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write21 = blurx.blurx_blurx_update_0_write21_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write21;
...
inline hw_uint<16> bxy_mc_32_rd62_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd62 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[22 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd63_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd63 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[21 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write21 = blurx.blurx_blurx_update_0_write21_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write21;
...
inline hw_uint<16> bxy_mc_32_rd64_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd64 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[22 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write22 = blurx.blurx_blurx_update_0_write22_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write22;
...
inline hw_uint<16> bxy_mc_32_rd65_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd65 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[23 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd66_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd66 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[22 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write22 = blurx.blurx_blurx_update_0_write22_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write22;
...
inline hw_uint<16> bxy_mc_32_rd67_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd67 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[23 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write23 = blurx.blurx_blurx_update_0_write23_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write23;
...
inline hw_uint<16> bxy_mc_32_rd68_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd68 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[24 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd69_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd69 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[23 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write23 = blurx.blurx_blurx_update_0_write23_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write23;
...
inline hw_uint<16> bxy_mc_32_rd7_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd7 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[3 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write3 = blurx.blurx_blurx_update_0_write3_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write3;
...
inline hw_uint<16> bxy_mc_32_rd70_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd70 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[24 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write24 = blurx.blurx_blurx_update_0_write24_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write24;
...
inline hw_uint<16> bxy_mc_32_rd71_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd71 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[25 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd72_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd72 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[24 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write24 = blurx.blurx_blurx_update_0_write24_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write24;
...
inline hw_uint<16> bxy_mc_32_rd73_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd73 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[25 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write25 = blurx.blurx_blurx_update_0_write25_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write25;
...
inline hw_uint<16> bxy_mc_32_rd74_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd74 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[26 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd75_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd75 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[25 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write25 = blurx.blurx_blurx_update_0_write25_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write25;
...
inline hw_uint<16> bxy_mc_32_rd76_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd76 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[26 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write26 = blurx.blurx_blurx_update_0_write26_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write26;
...
inline hw_uint<16> bxy_mc_32_rd77_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd77 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[27 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd78_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd78 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[26 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write26 = blurx.blurx_blurx_update_0_write26_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write26;
...
inline hw_uint<16> bxy_mc_32_rd79_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd79 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[27 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write27 = blurx.blurx_blurx_update_0_write27_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write27;
...
inline hw_uint<16> bxy_mc_32_rd8_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd8 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[4 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write4 = blurx.blurx_blurx_update_0_write4_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write4;
...
inline hw_uint<16> bxy_mc_32_rd80_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd80 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[28 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd81_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd81 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[27 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write27 = blurx.blurx_blurx_update_0_write27_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write27;
...
inline hw_uint<16> bxy_mc_32_rd82_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd82 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[28 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write28 = blurx.blurx_blurx_update_0_write28_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write28;
...
inline hw_uint<16> bxy_mc_32_rd83_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd83 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[29 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd84_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd84 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[28 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write28 = blurx.blurx_blurx_update_0_write28_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write28;
...
inline hw_uint<16> bxy_mc_32_rd85_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd85 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[29 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write29 = blurx.blurx_blurx_update_0_write29_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write29;
...
inline hw_uint<16> bxy_mc_32_rd86_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd86 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[30 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd87_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd87 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[29 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write29 = blurx.blurx_blurx_update_0_write29_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write29;
...
inline hw_uint<16> bxy_mc_32_rd88_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd88 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[30 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write30 = blurx.blurx_blurx_update_0_write30_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write30;
...
inline hw_uint<16> bxy_mc_32_rd89_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd89 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[31 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd9_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd9 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[3 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write3 = blurx.blurx_blurx_update_0_write3_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write3;
...
inline hw_uint<16> bxy_mc_32_rd90_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd90 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[30 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write30 = blurx.blurx_blurx_update_0_write30_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write30;
...
inline hw_uint<16> bxy_mc_32_rd91_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd91 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[31 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write31 = blurx.blurx_blurx_update_0_write31_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write31;
...
inline hw_uint<16> bxy_mc_32_rd92_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd92 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[32 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> bxy_mc_32_rd93_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd93 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[31 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write31 = blurx.blurx_blurx_update_0_write31_merged_banks_3.peek_1();
  return value_blurx_blurx_update_0_write31;
...
inline hw_uint<16> bxy_mc_32_rd94_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd94 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[32 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write0 = blurx.blurx_blurx_update_0_write0_merged_banks_3.peek_0();
  return value_blurx_blurx_update_0_write0;
...
inline hw_uint<16> bxy_mc_32_rd95_select(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_mc_32_rd95 read pattern: { bxy_mc_32_update_0[d0, d1] -> blurx[33 + 32d0, d1] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079 }
...
//	bxy_mc_32_rd94
//	bxy_mc_32_rd95
inline hw_uint<1536> blurx_bxy_mc_32_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 96
	...
	hw_uint<1536> result;
	hw_uint<16> bxy_mc_32_rd0_res = bxy_mc_32_rd0_select(blurx, d0, d1, dynamic_address);
	set_at<0, 1536>(result, bxy_mc_32_rd0_res);
	hw_uint<16> bxy_mc_32_rd1_res = bxy_mc_32_rd1_select(blurx, d0, d1, dynamic_address);
	set_at<16, 1536>(result, bxy_mc_32_rd1_res);
	hw_uint<16> bxy_mc_32_rd2_res = bxy_mc_32_rd2_select(blurx, d0, d1, dynamic_address);
	set_at<32, 1536>(result, bxy_mc_32_rd2_res);
	hw_uint<16> bxy_mc_32_rd3_res = bxy_mc_32_rd3_select(blurx, d0, d1, dynamic_address);
	set_at<48, 1536>(result, bxy_mc_32_rd3_res);
	hw_uint<16> bxy_mc_32_rd4_res = bxy_mc_32_rd4_select(blurx, d0, d1, dynamic_address);
	set_at<64, 1536>(result, bxy_mc_32_rd4_res);
	hw_uint<16> bxy_mc_32_rd5_res = bxy_mc_32_rd5_select(blurx, d0, d1, dynamic_address);
	set_at<80, 1536>(result, bxy_mc_32_rd5_res);
	hw_uint<16> bxy_mc_32_rd6_res = bxy_mc_32_rd6_select(blurx, d0, d1, dynamic_address);
	set_at<96, 1536>(result, bxy_mc_32_rd6_res);
	hw_uint<16> bxy_mc_32_rd7_res = bxy_mc_32_rd7_select(blurx, d0, d1, dynamic_address);
	set_at<112, 1536>(result, bxy_mc_32_rd7_res);
	hw_uint<16> bxy_mc_32_rd8_res = bxy_mc_32_rd8_select(blurx, d0, d1, dynamic_address);
	set_at<128, 1536>(result, bxy_mc_32_rd8_res);
	hw_uint<16> bxy_mc_32_rd9_res = bxy_mc_32_rd9_select(blurx, d0, d1, dynamic_address);
	set_at<144, 1536>(result, bxy_mc_32_rd9_res);
	hw_uint<16> bxy_mc_32_rd10_res = bxy_mc_32_rd10_select(blurx, d0, d1, dynamic_address);
	set_at<160, 1536>(result, bxy_mc_32_rd10_res);
	hw_uint<16> bxy_mc_32_rd11_res = bxy_mc_32_rd11_select(blurx, d0, d1, dynamic_address);
	set_at<176, 1536>(result, bxy_mc_32_rd11_res);
	hw_uint<16> bxy_mc_32_rd12_res = bxy_mc_32_rd12_select(blurx, d0, d1, dynamic_address);
	set_at<192, 1536>(result, bxy_mc_32_rd12_res);
	hw_uint<16> bxy_mc_32_rd13_res = bxy_mc_32_rd13_select(blurx, d0, d1, dynamic_address);
	set_at<208, 1536>(result, bxy_mc_32_rd13_res);
	hw_uint<16> bxy_mc_32_rd14_res = bxy_mc_32_rd14_select(blurx, d0, d1, dynamic_address);
	set_at<224, 1536>(result, bxy_mc_32_rd14_res);
	hw_uint<16> bxy_mc_32_rd15_res = bxy_mc_32_rd15_select(blurx, d0, d1, dynamic_address);
	set_at<240, 1536>(result, bxy_mc_32_rd15_res);
	hw_uint<16> bxy_mc_32_rd16_res = bxy_mc_32_rd16_select(blurx, d0, d1, dynamic_address);
	set_at<256, 1536>(result, bxy_mc_32_rd16_res);
	hw_uint<16> bxy_mc_32_rd17_res = bxy_mc_32_rd17_select(blurx, d0, d1, dynamic_address);
	set_at<272, 1536>(result, bxy_mc_32_rd17_res);
	hw_uint<16> bxy_mc_32_rd18_res = bxy_mc_32_rd18_select(blurx, d0, d1, dynamic_address);
	set_at<288, 1536>(result, bxy_mc_32_rd18_res);
	hw_uint<16> bxy_mc_32_rd19_res = bxy_mc_32_rd19_select(blurx, d0, d1, dynamic_address);
	set_at<304, 1536>(result, bxy_mc_32_rd19_res);
	hw_uint<16> bxy_mc_32_rd20_res = bxy_mc_32_rd20_select(blurx, d0, d1, dynamic_address);
	set_at<320, 1536>(result, bxy_mc_32_rd20_res);
	hw_uint<16> bxy_mc_32_rd21_res = bxy_mc_32_rd21_select(blurx, d0, d1, dynamic_address);
	set_at<336, 1536>(result, bxy_mc_32_rd21_res);
	hw_uint<16> bxy_mc_32_rd22_res = bxy_mc_32_rd22_select(blurx, d0, d1, dynamic_address);
	set_at<352, 1536>(result, bxy_mc_32_rd22_res);
	hw_uint<16> bxy_mc_32_rd23_res = bxy_mc_32_rd23_select(blurx, d0, d1, dynamic_address);
	set_at<368, 1536>(result, bxy_mc_32_rd23_res);
	hw_uint<16> bxy_mc_32_rd24_res = bxy_mc_32_rd24_select(blurx, d0, d1, dynamic_address);
	set_at<384, 1536>(result, bxy_mc_32_rd24_res);
	hw_uint<16> bxy_mc_32_rd25_res = bxy_mc_32_rd25_select(blurx, d0, d1, dynamic_address);
	set_at<400, 1536>(result, bxy_mc_32_rd25_res);
	hw_uint<16> bxy_mc_32_rd26_res = bxy_mc_32_rd26_select(blurx, d0, d1, dynamic_address);
	set_at<416, 1536>(result, bxy_mc_32_rd26_res);
	hw_uint<16> bxy_mc_32_rd27_res = bxy_mc_32_rd27_select(blurx, d0, d1, dynamic_address);
	set_at<432, 1536>(result, bxy_mc_32_rd27_res);
	hw_uint<16> bxy_mc_32_rd28_res = bxy_mc_32_rd28_select(blurx, d0, d1, dynamic_address);
	set_at<448, 1536>(result, bxy_mc_32_rd28_res);
	hw_uint<16> bxy_mc_32_rd29_res = bxy_mc_32_rd29_select(blurx, d0, d1, dynamic_address);
	set_at<464, 1536>(result, bxy_mc_32_rd29_res);
	hw_uint<16> bxy_mc_32_rd30_res = bxy_mc_32_rd30_select(blurx, d0, d1, dynamic_address);
	set_at<480, 1536>(result, bxy_mc_32_rd30_res);
	hw_uint<16> bxy_mc_32_rd31_res = bxy_mc_32_rd31_select(blurx, d0, d1, dynamic_address);
	set_at<496, 1536>(result, bxy_mc_32_rd31_res);
	hw_uint<16> bxy_mc_32_rd32_res = bxy_mc_32_rd32_select(blurx, d0, d1, dynamic_address);
	set_at<512, 1536>(result, bxy_mc_32_rd32_res);
	hw_uint<16> bxy_mc_32_rd33_res = bxy_mc_32_rd33_select(blurx, d0, d1, dynamic_address);
	set_at<528, 1536>(result, bxy_mc_32_rd33_res);
	hw_uint<16> bxy_mc_32_rd34_res = bxy_mc_32_rd34_select(blurx, d0, d1, dynamic_address);
	set_at<544, 1536>(result, bxy_mc_32_rd34_res);
	hw_uint<16> bxy_mc_32_rd35_res = bxy_mc_32_rd35_select(blurx, d0, d1, dynamic_address);
	set_at<560, 1536>(result, bxy_mc_32_rd35_res);
	hw_uint<16> bxy_mc_32_rd36_res = bxy_mc_32_rd36_select(blurx, d0, d1, dynamic_address);
	set_at<576, 1536>(result, bxy_mc_32_rd36_res);
	hw_uint<16> bxy_mc_32_rd37_res = bxy_mc_32_rd37_select(blurx, d0, d1, dynamic_address);
	set_at<592, 1536>(result, bxy_mc_32_rd37_res);
	hw_uint<16> bxy_mc_32_rd38_res = bxy_mc_32_rd38_select(blurx, d0, d1, dynamic_address);
	set_at<608, 1536>(result, bxy_mc_32_rd38_res);
	hw_uint<16> bxy_mc_32_rd39_res = bxy_mc_32_rd39_select(blurx, d0, d1, dynamic_address);
	set_at<624, 1536>(result, bxy_mc_32_rd39_res);
	hw_uint<16> bxy_mc_32_rd40_res = bxy_mc_32_rd40_select(blurx, d0, d1, dynamic_address);
	set_at<640, 1536>(result, bxy_mc_32_rd40_res);
	hw_uint<16> bxy_mc_32_rd41_res = bxy_mc_32_rd41_select(blurx, d0, d1, dynamic_address);
	set_at<656, 1536>(result, bxy_mc_32_rd41_res);
	hw_uint<16> bxy_mc_32_rd42_res = bxy_mc_32_rd42_select(blurx, d0, d1, dynamic_address);
	set_at<672, 1536>(result, bxy_mc_32_rd42_res);
	hw_uint<16> bxy_mc_32_rd43_res = bxy_mc_32_rd43_select(blurx, d0, d1, dynamic_address);
	set_at<688, 1536>(result, bxy_mc_32_rd43_res);
	hw_uint<16> bxy_mc_32_rd44_res = bxy_mc_32_rd44_select(blurx, d0, d1, dynamic_address);
	set_at<704, 1536>(result, bxy_mc_32_rd44_res);
	hw_uint<16> bxy_mc_32_rd45_res = bxy_mc_32_rd45_select(blurx, d0, d1, dynamic_address);
	set_at<720, 1536>(result, bxy_mc_32_rd45_res);
	hw_uint<16> bxy_mc_32_rd46_res = bxy_mc_32_rd46_select(blurx, d0, d1, dynamic_address);
	set_at<736, 1536>(result, bxy_mc_32_rd46_res);
	hw_uint<16> bxy_mc_32_rd47_res = bxy_mc_32_rd47_select(blurx, d0, d1, dynamic_address);
	set_at<752, 1536>(result, bxy_mc_32_rd47_res);
	hw_uint<16> bxy_mc_32_rd48_res = bxy_mc_32_rd48_select(blurx, d0, d1, dynamic_address);
	set_at<768, 1536>(result, bxy_mc_32_rd48_res);
	hw_uint<16> bxy_mc_32_rd49_res = bxy_mc_32_rd49_select(blurx, d0, d1, dynamic_address);
	set_at<784, 1536>(result, bxy_mc_32_rd49_res);
	hw_uint<16> bxy_mc_32_rd50_res = bxy_mc_32_rd50_select(blurx, d0, d1, dynamic_address);
	set_at<800, 1536>(result, bxy_mc_32_rd50_res);
	hw_uint<16> bxy_mc_32_rd51_res = bxy_mc_32_rd51_select(blurx, d0, d1, dynamic_address);
	set_at<816, 1536>(result, bxy_mc_32_rd51_res);
	hw_uint<16> bxy_mc_32_rd52_res = bxy_mc_32_rd52_select(blurx, d0, d1, dynamic_address);
	set_at<832, 1536>(result, bxy_mc_32_rd52_res);
	hw_uint<16> bxy_mc_32_rd53_res = bxy_mc_32_rd53_select(blurx, d0, d1, dynamic_address);
	set_at<848, 1536>(result, bxy_mc_32_rd53_res);
	hw_uint<16> bxy_mc_32_rd54_res = bxy_mc_32_rd54_select(blurx, d0, d1, dynamic_address);
	set_at<864, 1536>(result, bxy_mc_32_rd54_res);
	hw_uint<16> bxy_mc_32_rd55_res = bxy_mc_32_rd55_select(blurx, d0, d1, dynamic_address);
	set_at<880, 1536>(result, bxy_mc_32_rd55_res);
	hw_uint<16> bxy_mc_32_rd56_res = bxy_mc_32_rd56_select(blurx, d0, d1, dynamic_address);
	set_at<896, 1536>(result, bxy_mc_32_rd56_res);
	hw_uint<16> bxy_mc_32_rd57_res = bxy_mc_32_rd57_select(blurx, d0, d1, dynamic_address);
	set_at<912, 1536>(result, bxy_mc_32_rd57_res);
	hw_uint<16> bxy_mc_32_rd58_res = bxy_mc_32_rd58_select(blurx, d0, d1, dynamic_address);
	set_at<928, 1536>(result, bxy_mc_32_rd58_res);
	hw_uint<16> bxy_mc_32_rd59_res = bxy_mc_32_rd59_select(blurx, d0, d1, dynamic_address);
	set_at<944, 1536>(result, bxy_mc_32_rd59_res);
	hw_uint<16> bxy_mc_32_rd60_res = bxy_mc_32_rd60_select(blurx, d0, d1, dynamic_address);
	set_at<960, 1536>(result, bxy_mc_32_rd60_res);
	hw_uint<16> bxy_mc_32_rd61_res = bxy_mc_32_rd61_select(blurx, d0, d1, dynamic_address);
	set_at<976, 1536>(result, bxy_mc_32_rd61_res);
	hw_uint<16> bxy_mc_32_rd62_res = bxy_mc_32_rd62_select(blurx, d0, d1, dynamic_address);
	set_at<992, 1536>(result, bxy_mc_32_rd62_res);
	hw_uint<16> bxy_mc_32_rd63_res = bxy_mc_32_rd63_select(blurx, d0, d1, dynamic_address);
	set_at<1008, 1536>(result, bxy_mc_32_rd63_res);
	hw_uint<16> bxy_mc_32_rd64_res = bxy_mc_32_rd64_select(blurx, d0, d1, dynamic_address);
	set_at<1024, 1536>(result, bxy_mc_32_rd64_res);
	hw_uint<16> bxy_mc_32_rd65_res = bxy_mc_32_rd65_select(blurx, d0, d1, dynamic_address);
	set_at<1040, 1536>(result, bxy_mc_32_rd65_res);
	hw_uint<16> bxy_mc_32_rd66_res = bxy_mc_32_rd66_select(blurx, d0, d1, dynamic_address);
	set_at<1056, 1536>(result, bxy_mc_32_rd66_res);
	hw_uint<16> bxy_mc_32_rd67_res = bxy_mc_32_rd67_select(blurx, d0, d1, dynamic_address);
	set_at<1072, 1536>(result, bxy_mc_32_rd67_res);
	hw_uint<16> bxy_mc_32_rd68_res = bxy_mc_32_rd68_select(blurx, d0, d1, dynamic_address);
	set_at<1088, 1536>(result, bxy_mc_32_rd68_res);
	hw_uint<16> bxy_mc_32_rd69_res = bxy_mc_32_rd69_select(blurx, d0, d1, dynamic_address);
	set_at<1104, 1536>(result, bxy_mc_32_rd69_res);
	hw_uint<16> bxy_mc_32_rd70_res = bxy_mc_32_rd70_select(blurx, d0, d1, dynamic_address);
	set_at<1120, 1536>(result, bxy_mc_32_rd70_res);
	hw_uint<16> bxy_mc_32_rd71_res = bxy_mc_32_rd71_select(blurx, d0, d1, dynamic_address);
	set_at<1136, 1536>(result, bxy_mc_32_rd71_res);
	hw_uint<16> bxy_mc_32_rd72_res = bxy_mc_32_rd72_select(blurx, d0, d1, dynamic_address);
	set_at<1152, 1536>(result, bxy_mc_32_rd72_res);
	hw_uint<16> bxy_mc_32_rd73_res = bxy_mc_32_rd73_select(blurx, d0, d1, dynamic_address);
	set_at<1168, 1536>(result, bxy_mc_32_rd73_res);
	hw_uint<16> bxy_mc_32_rd74_res = bxy_mc_32_rd74_select(blurx, d0, d1, dynamic_address);
	set_at<1184, 1536>(result, bxy_mc_32_rd74_res);
	hw_uint<16> bxy_mc_32_rd75_res = bxy_mc_32_rd75_select(blurx, d0, d1, dynamic_address);
	set_at<1200, 1536>(result, bxy_mc_32_rd75_res);
	hw_uint<16> bxy_mc_32_rd76_res = bxy_mc_32_rd76_select(blurx, d0, d1, dynamic_address);
	set_at<1216, 1536>(result, bxy_mc_32_rd76_res);
	hw_uint<16> bxy_mc_32_rd77_res = bxy_mc_32_rd77_select(blurx, d0, d1, dynamic_address);
	set_at<1232, 1536>(result, bxy_mc_32_rd77_res);
	hw_uint<16> bxy_mc_32_rd78_res = bxy_mc_32_rd78_select(blurx, d0, d1, dynamic_address);
	set_at<1248, 1536>(result, bxy_mc_32_rd78_res);
	hw_uint<16> bxy_mc_32_rd79_res = bxy_mc_32_rd79_select(blurx, d0, d1, dynamic_address);
	set_at<1264, 1536>(result, bxy_mc_32_rd79_res);
	hw_uint<16> bxy_mc_32_rd80_res = bxy_mc_32_rd80_select(blurx, d0, d1, dynamic_address);
	set_at<1280, 1536>(result, bxy_mc_32_rd80_res);
	hw_uint<16> bxy_mc_32_rd81_res = bxy_mc_32_rd81_select(blurx, d0, d1, dynamic_address);
	set_at<1296, 1536>(result, bxy_mc_32_rd81_res);
	hw_uint<16> bxy_mc_32_rd82_res = bxy_mc_32_rd82_select(blurx, d0, d1, dynamic_address);
	set_at<1312, 1536>(result, bxy_mc_32_rd82_res);
	hw_uint<16> bxy_mc_32_rd83_res = bxy_mc_32_rd83_select(blurx, d0, d1, dynamic_address);
	set_at<1328, 1536>(result, bxy_mc_32_rd83_res);
	hw_uint<16> bxy_mc_32_rd84_res = bxy_mc_32_rd84_select(blurx, d0, d1, dynamic_address);
	set_at<1344, 1536>(result, bxy_mc_32_rd84_res);
	hw_uint<16> bxy_mc_32_rd85_res = bxy_mc_32_rd85_select(blurx, d0, d1, dynamic_address);
	set_at<1360, 1536>(result, bxy_mc_32_rd85_res);
	hw_uint<16> bxy_mc_32_rd86_res = bxy_mc_32_rd86_select(blurx, d0, d1, dynamic_address);
	set_at<1376, 1536>(result, bxy_mc_32_rd86_res);
	hw_uint<16> bxy_mc_32_rd87_res = bxy_mc_32_rd87_select(blurx, d0, d1, dynamic_address);
	set_at<1392, 1536>(result, bxy_mc_32_rd87_res);
	hw_uint<16> bxy_mc_32_rd88_res = bxy_mc_32_rd88_select(blurx, d0, d1, dynamic_address);
	set_at<1408, 1536>(result, bxy_mc_32_rd88_res);
	hw_uint<16> bxy_mc_32_rd89_res = bxy_mc_32_rd89_select(blurx, d0, d1, dynamic_address);
	set_at<1424, 1536>(result, bxy_mc_32_rd89_res);
	hw_uint<16> bxy_mc_32_rd90_res = bxy_mc_32_rd90_select(blurx, d0, d1, dynamic_address);
	set_at<1440, 1536>(result, bxy_mc_32_rd90_res);
	hw_uint<16> bxy_mc_32_rd91_res = bxy_mc_32_rd91_select(blurx, d0, d1, dynamic_address);
	set_at<1456, 1536>(result, bxy_mc_32_rd91_res);
	hw_uint<16> bxy_mc_32_rd92_res = bxy_mc_32_rd92_select(blurx, d0, d1, dynamic_address);
	set_at<1472, 1536>(result, bxy_mc_32_rd92_res);
	hw_uint<16> bxy_mc_32_rd93_res = bxy_mc_32_rd93_select(blurx, d0, d1, dynamic_address);
	set_at<1488, 1536>(result, bxy_mc_32_rd93_res);
	hw_uint<16> bxy_mc_32_rd94_res = bxy_mc_32_rd94_select(blurx, d0, d1, dynamic_address);
	set_at<1504, 1536>(result, bxy_mc_32_rd94_res);
	hw_uint<16> bxy_mc_32_rd95_res = bxy_mc_32_rd95_select(blurx, d0, d1, dynamic_address);
	set_at<1520, 1536>(result, bxy_mc_32_rd95_res);
	return result;
}
...
inline void bxy_mc_32_update_0(blurx_cache& blurx, HWStream<hw_uint<512> >& /* buffer_args num ports = 32 */bxy_mc_32, int d0, int d1) {
  // Dynamic address computation

	// Consume: blurx
	auto blurx_0_c__0_value = blurx_bxy_mc_32_update_0_read_bundle_read(blurx/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = bxy_mc_32_generated_compute_unrolled_32(blurx_0_c__0_value);
	// Produce: bxy_mc_32
	bxy_mc_32.write(compute_result);
...
#ifndef __VIVADO_SYNTH__
  ofstream debug_file("bxy_mc_32_opt_debug.csv");
...
// schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 60 and 0 <= d1 <= 1079; input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 60 and 0 <= d1 <= 1081; bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
...
//   { bxy_mc_32_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 59 and 0 <= d1 <= 1079 }
// Condition for bxy_mc_32_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (60 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))

  /*
for (int c0 = 0; c0 <= 1081; c0 += 1)
  for (int c1 = 0; c1 <= 60; c1 += 1) {
    input_update_0(c1, c0);
    if (c0 >= 2) {
      blurx_update_0(c1, c0 - 2);
      if (c1 >= 1)
        bxy_mc_32_update_0(c1 - 1, c0 - 2);
    }
  }
	...
	for (int c0 = 0; c0 <= 1081; c0 += 1)
	  for (int c1 = 0; c1 <= 60; c1 += 1) {
	    ...
	    if (c0 >= 2) {
	      ...
	      if (c1 >= 1)
	        bxy_mc_32_update_0(blurx /* buf name */, bxy_mc_32, c1 - 1, c0 - 2);
	    }
	  }
...
#ifdef __VIVADO_SYNTH__
  // { bxy_mc_32_update_0[root = 0, bxy_mc_32_0, bxy_mc_32_1] -> bxy_mc_32[0, 0] : 0 <= bxy_mc_32_0 <= 59 and 0 <= bxy_mc_32_1 <= 1079 }
const int bxy_mc_32_update_0_write_num_transfers = 64800;
...
static void write_bxy_mc_32_update_0_write(hw_uint<512>* output, HWStream<hw_uint<512> >& v, const int size) {
  hw_uint<512> burst_reg;
  int num_transfers = bxy_mc_32_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void bxy_mc_32_opt_accel(hw_uint<512>* input_update_0_read, hw_uint<512>* bxy_mc_32_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = input_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = bxy_mc_32_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = input_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = bxy_mc_32_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<512> > input_update_0_read_channel;
  static HWStream<hw_uint<512> > bxy_mc_32_update_0_write_channel;
  ...
  write_bxy_mc_32_update_0_write(bxy_mc_32_update_0_write, bxy_mc_32_update_0_write_channel, size);
}
