...
#include <fstream>
#include <vector>
#include "bxy_mc_32_opt.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<512> > input_update_0_read_channel;
  HWStream<hw_uint<512> > bxy_mc_32_update_0_write_channel;
  // In lanes = 32
  for (int r = 0; r < 1082; r++) {
    for (int cl = 0; cl < 1952 / 32; cl++) {
      hw_uint<512> packed;
      {
      int c = 32*cl + 0;
  ...
  bxy_mc_32_opt(input_update_0_read_channel, bxy_mc_32_update_0_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = bxy_mc_32_update_0_write_channel.read();
  ...
  output.save_image("./images/bxy_mc_32_opt_bmp_out.bmp");
}
