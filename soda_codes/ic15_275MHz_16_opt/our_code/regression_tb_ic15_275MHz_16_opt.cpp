#include <fstream>
#include "ic15_275MHz_16_opt.h"
#include "clockwork_standard_compute_units.h"

int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_ic15_275MHz_16_opt.txt");
  ofstream fout("regression_result_ic15_275MHz_16_opt.txt");
  HWStream<hw_uint<256> > in_update_0_read;
  HWStream<hw_uint<256> > ic15_275MHz_16_update_0_write;
  ...
  ic15_275MHz_16_opt(in_update_0_read, ic15_275MHz_16_update_0_write);

  for (int i = 0; i < 129600; i++) {
    hw_uint<256> actual = ic15_275MHz_16_update_0_write.read();
