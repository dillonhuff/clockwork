...
int main() {
  ...
  jac4_16_opt_kernel(jac4_16, in_off_chip, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_jac4_16_opt_regression_result.csv", jac4_16, nrows, ncols, transfer_cols);
  free(in_off_chip);
  free(jac4_16);
}
