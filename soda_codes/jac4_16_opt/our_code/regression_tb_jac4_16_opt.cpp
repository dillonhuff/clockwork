...
int main() {
  srand(234);
  ofstream fout("regression_result_jac4_16_opt.txt");
  HWStream<hw_uint<16 > > in_off_chip;
  HWStream<hw_uint<16 > > jac4_16;
