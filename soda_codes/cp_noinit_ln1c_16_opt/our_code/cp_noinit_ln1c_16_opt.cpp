...
inline void cp_noinit_ln1c_16_update_0(demosaic_diff_cache& demosaic_diff, HWStream<hw_uint<256> >& /* buffer_args num ports = 16 */cp_noinit_ln1c_16, int d0, int d1) {
  // Dynamic address computation
	...
	auto demosaic_diff_0_c__0_value = demosaic_diff_cp_noinit_ln1c_16_update_0_read_bundle_read(demosaic_diff/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = cp_noinit_ln1c_16_generated_compute_unrolled_16(demosaic_diff_0_c__0_value);
...
// Condition for cp_noinit_ln1c_16_update_0(((-11 + i2 == 0) && (-3 + i1 >= 0) && (122 - i1 >= 0) && (-5 + i0 >= 0) && (1084 - i0 >= 0)))
...
#pragma HLS pipeline II=1
    ...
    if ((3 <= c1 && c1 <= 122) && ((c1 - 3) % 1 == 0) && (5 <= c0 && c0 <= 1084) && ((c0 - 5) % 1 == 0)) {
      cp_noinit_ln1c_16_update_0((c1 - 3) / 1, (c0 - 5) / 1);
    }
...
#ifdef __VIVADO_SYNTH__
  // { cp_noinit_ln1c_16_update_0[root = 0, cp_noinit_ln1c_16_0, cp_noinit_ln1c_16_1] -> cp_noinit_ln1c_16[0, 0] : 0 <= cp_noinit_ln1c_16_0 <= 119 and 0 <= cp_noinit_ln1c_16_1 <= 1079 }
