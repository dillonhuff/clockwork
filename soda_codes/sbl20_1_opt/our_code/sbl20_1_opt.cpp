...
// compute file: sbl20_1_opt_compute_units.h
#include "sbl20_1_opt_compute_units.h"
...
struct mag_x_mag_x_update_0_write0_to_sbl20_1_rd0_cache {
...
struct mag_x_cache {
  // # of banks: 1
  mag_x_mag_x_update_0_write0_to_sbl20_1_rd0_cache mag_x_mag_x_update_0_write0_to_sbl20_1_rd0;
};
...
inline void mag_x_mag_x_update_0_write0_write(hw_uint<16>& mag_x_mag_x_update_0_write0, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write0_to_sbl20_1_rd0.push(mag_x_mag_x_update_0_write0);
}

inline hw_uint<16> sbl20_1_rd0_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_1_rd0 read pattern: { sbl20_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write0 = mag_x.mag_x_mag_x_update_0_write0_to_sbl20_1_rd0.peek(/* one reader or all rams */ 0);
...
// sbl20_1_update_0_read
//	sbl20_1_rd0
inline hw_uint<16> mag_x_sbl20_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // sbl20_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl20_1_rd0_res = sbl20_1_rd0_select(mag_x, d0, d1, dynamic_address);
	set_at<0, 16>(result, sbl20_1_rd0_res);
	return result;
}

#include "hw_classes.h"

struct mag_y_mag_y_update_0_write0_to_sbl20_1_rd0_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_cache {
  // # of banks: 1
  mag_y_mag_y_update_0_write0_to_sbl20_1_rd0_cache mag_y_mag_y_update_0_write0_to_sbl20_1_rd0;
};
...
inline void mag_y_mag_y_update_0_write0_write(hw_uint<16>& mag_y_mag_y_update_0_write0, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write0_to_sbl20_1_rd0.push(mag_y_mag_y_update_0_write0);
}

inline hw_uint<16> sbl20_1_rd0_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_1_rd0 read pattern: { sbl20_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write0 = mag_y.mag_y_mag_y_update_0_write0_to_sbl20_1_rd0.peek(/* one reader or all rams */ 0);
...
// sbl20_1_update_0_read
//	sbl20_1_rd0
inline hw_uint<16> mag_y_sbl20_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // sbl20_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl20_1_rd0_res = sbl20_1_rd0_select(mag_y, d0, d1, dynamic_address);
	set_at<0, 16>(result, sbl20_1_rd0_res);
	return result;
}
...
inline void sbl20_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sbl20_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sbl20_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sbl20_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = sbl20_1_generated_compute_unrolled_1(mag_x_0_c__0_value, mag_y_0_c__0_value);
	// Produce: sbl20_1
	sbl20_1.write(compute_result);
...
#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sbl20_1_opt_debug.csv");
...
// schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 1920 and -1 <= d1 <= 1080; mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; sbl20_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
//   { sbl20_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for sbl20_1_update_0(((-4 + i2 == 0) && (-1 + i1 >= 0) && (1920 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
...
// Condition for mag_x_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (1920 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
  ...
  // Schedules...
    ...
    // sbl20_1_update_0 -> [1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*4]
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
      sbl20_1_update_0((c1 - 1) / 1, (c0 - 1) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
	      sbl20_1_update_0(mag_x /* buf name */, mag_y /* buf name */, sbl20_1, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void sbl20_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl20_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    sbl20_1_opt(off_chip_img, sbl20_1);
  }
}
#ifdef __VIVADO_SYNTH__
...
const int img_update_0_read_pipe0_num_transfers = 2079604;
  // { sbl20_1_update_0[root = 0, sbl20_1_0, sbl20_1_1] -> sbl20_1[0, 0] : 0 <= sbl20_1_0 <= 1919 and 0 <= sbl20_1_1 <= 1079 }
const int sbl20_1_update_0_write_pipe0_num_transfers = 2073600;


extern "C" {

void sbl20_1_opt_accel(hw_uint<16>* img_update_0_read_pipe0, hw_uint<16>* sbl20_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sbl20_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = sbl20_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > sbl20_1_update_0_write_pipe0_channel;

  burst_read<16>(img_update_0_read_pipe0, img_update_0_read_pipe0_channel, img_update_0_read_pipe0_num_transfers*30);

  sbl20_1_opt_wrapper(img_update_0_read_pipe0_channel, sbl20_1_update_0_write_pipe0_channel, size);

  burst_write<16>(sbl20_1_update_0_write_pipe0, sbl20_1_update_0_write_pipe0_channel, sbl20_1_update_0_write_pipe0_num_transfers*30);
}

}
extern "C" {

void sbl20_1_opt_rdai(HWStream<hw_uint<16> >& img_update_0_read_pipe0, HWStream<hw_uint<16> >&  sbl20_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = img_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = sbl20_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  sbl20_1_opt(img_update_0_read_pipe0, sbl20_1_update_0_write_pipe0);
