...
int main(int argc, char **argv) {
  ...
  const int gp64x64_4_update_0_write_DATA_SIZE = num_epochs*4096;
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, gp64x64_4_update_0_write_ocl_buf));
...
nsduration = end - start;
  OCL_CHECK(err, err = q.enqueueMigrateMemObjects({gp64x64_4_update_0_write_ocl_buf}, CL_MIGRATE_MEM_OBJECT_HOST));
