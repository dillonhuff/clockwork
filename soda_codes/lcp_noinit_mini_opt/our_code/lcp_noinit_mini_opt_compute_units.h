...
hw_uint<16> demosaic_diff_generated_compute(hw_uint<16*1> demosaic_by) {
  return uint16_t((uint16_t(demosaic_by.get<16, 0>()) + 1));
}

hw_uint<16> lcp_noinit_mini_generated_compute(hw_uint<16*1> demosaic_diff) {
...
hw_uint<16>  demosaic_diff_generated_compute_unrolled_1(hw_uint<16>& demosaic_by) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_demosaic_by;
  set_at<0, 16, 16>(lane_0_demosaic_by, demosaic_by.extract<0, 15>());
  auto result_0 = demosaic_diff_generated_compute(lane_0_demosaic_by);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}

  // lcp_noinit_mini_update_0 unroll factor: 1
hw_uint<16>  lcp_noinit_mini_generated_compute_unrolled_1(hw_uint<16>& demosaic_diff) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_demosaic_diff;
  set_at<0, 16, 16>(lane_0_demosaic_diff, demosaic_diff.extract<0, 15>());
  auto result_0 = lcp_noinit_mini_generated_compute(lane_0_demosaic_diff);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
