...
int main() {
  ...
  // Loading input data
  // cmap    : { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : 0 <= in_0 <= 963 and 0 <= in_1 <= 1926 }
  // read map: { in_off_chip[0, 0] -> in_update_0[root = 0, in_0, in_1] : 0 <= in_0 <= 963 and 0 <= in_1 <= 1926 }
  // rng     : { in_update_0[root = 0, in_0, in_1] : 0 <= in_0 <= 963 and 0 <= in_1 <= 1926 }
  for (int i = 0; i < 1857628; i++) {
    hw_uint<32> in_val;
