...
int main() {
  ofstream in_pix("input_pixels_regression_result_heat3ds_1_16_opt.txt");
  ofstream fout("regression_result_heat3ds_1_16_opt.txt");
  HWStream<hw_uint<512> > in_cc_update_0_read;
  HWStream<hw_uint<512> > heat3ds_1_16_update_0_write;


  // Loading input data
  // cmap    : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] -> in[0, 0] : -1 <= in_cc_0 <= 2 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 32 }
  // read map: { in[0, 0] -> in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -1 <= in_cc_0 <= 2 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 32 }
  // rng     : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -1 <= in_cc_0 <= 2 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 32 }
  ...
  heat3ds_1_16_opt(in_cc_update_0_read, heat3ds_1_16_update_0_write);

  for (int i = 0; i < 2048; i++) {
    hw_uint<512> actual = heat3ds_1_16_update_0_write.read();
