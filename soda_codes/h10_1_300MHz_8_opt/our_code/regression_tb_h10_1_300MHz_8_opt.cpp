...
int main() {
  ofstream in_pix("input_pixels_regression_result_h10_1_300MHz_8_opt.txt");
  ofstream fout("regression_result_h10_1_300MHz_8_opt.txt");
  HWStream<hw_uint<256> > in_cc_update_0_read;
  HWStream<hw_uint<256> > h10_1_300MHz_8_update_0_write;


  // Loading input data
  // cmap    : { in_cc_update_0[root = 0, in_cc_0, in_cc_1] -> in[0, 0] : -10 <= in_cc_0 <= 137 and -10 <= in_cc_1 <= 1033 }
  // read map: { in[0, 0] -> in_cc_update_0[root = 0, in_cc_0, in_cc_1] : -10 <= in_cc_0 <= 137 and -10 <= in_cc_1 <= 1033 }
  // rng     : { in_cc_update_0[root = 0, in_cc_0, in_cc_1] : -10 <= in_cc_0 <= 137 and -10 <= in_cc_1 <= 1033 }
  for (int i = 0; i < 154512; i++) {
    hw_uint<256> in_val;
  ...
  h10_1_300MHz_8_opt(in_cc_update_0_read, h10_1_300MHz_8_update_0_write);

  for (int i = 0; i < 131072; i++) {
    hw_uint<256> actual = h10_1_300MHz_8_update_0_write.read();
