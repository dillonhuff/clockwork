...
#include "psef22_4_opt_compute_units.h"
...
inline hw_uint<16> psef22_4_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef22_4_rd0 read pattern: { psef22_4_update_0[d0, d1] -> final_merged_0[4d0, d1] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Read schedule : { psef22_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
...
inline hw_uint<16> psef22_4_rd1_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef22_4_rd1 read pattern: { psef22_4_update_0[d0, d1] -> final_merged_0[1 + 4d0, d1] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Read schedule : { psef22_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // DD fold: {  }
...
inline hw_uint<16> psef22_4_rd2_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef22_4_rd2 read pattern: { psef22_4_update_0[d0, d1] -> final_merged_0[2 + 4d0, d1] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Read schedule : { psef22_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // DD fold: {  }
...
inline hw_uint<16> psef22_4_rd3_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef22_4_rd3 read pattern: { psef22_4_update_0[d0, d1] -> final_merged_0[3 + 4d0, d1] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Read schedule : { psef22_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 312 and 0 <= d1 <= 1249 }
  // DD fold: {  }
...
// psef22_4_update_0_read
//	psef22_4_rd0
//	psef22_4_rd1
//	psef22_4_rd2
//	psef22_4_rd3
inline hw_uint<64> final_merged_0_psef22_4_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1) {
  // # of ports in bundle: 4
    // psef22_4_rd0
    // psef22_4_rd1
    // psef22_4_rd2
	...
	hw_uint<64> result;
	hw_uint<16> psef22_4_rd0_res = psef22_4_rd0_select(final_merged_0, d0, d1);
	set_at<0, 64>(result, psef22_4_rd0_res);
	hw_uint<16> psef22_4_rd1_res = psef22_4_rd1_select(final_merged_0, d0, d1);
	set_at<16, 64>(result, psef22_4_rd1_res);
	hw_uint<16> psef22_4_rd2_res = psef22_4_rd2_select(final_merged_0, d0, d1);
	set_at<32, 64>(result, psef22_4_rd2_res);
	hw_uint<16> psef22_4_rd3_res = psef22_4_rd3_select(final_merged_0, d0, d1);
	set_at<48, 64>(result, psef22_4_rd3_res);
	return result;
}
...
inline void psef22_4_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<64> >& /* buffer_args num ports = 4 */psef22_4, int d0, int d1) {
	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_psef22_4_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1);
...
// Driver function
void psef22_4_opt(HWStream<hw_uint<64> >& /* get_args num ports = 4 */in_off_chip, HWStream<hw_uint<64> >& /* get_args num ports = 4 */psef22_4, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("psef22_4_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // psef22_4_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*4,1*52]
	...
	final_merged_0_update_0(final_merged_1, fused_level_0, final_merged_0, (c1 - 4) / 1, (c0 - 14) / 1);
	    ...
	    if ((4 <= c1 && c1 <= 316) && ((c1 - 4) % 1 == 0) && (14 <= c0 && c0 <= 1263) && ((c0 - 14) % 1 == 0)) {
	psef22_4_update_0(final_merged_0, psef22_4, (c1 - 4) / 1, (c0 - 14) / 1);
	    }
...
void psef22_4_opt(HWStream<hw_uint<64> >& /* get_args num ports = 4 */in_off_chip, HWStream<hw_uint<64> >& /* get_args num ports = 4 */psef22_4) {

  psef22_4_opt(in_off_chip, psef22_4, 1);
}
#ifdef __VIVADO_SYNTH__
#include "psef22_4_opt.h"

const int in_update_0_read_num_transfers = 400371;
const int psef22_4_update_0_write_num_transfers = 391250;
...
static void write_psef22_4_update_0_write(hw_uint<64>* output, HWStream<hw_uint<64> >& v, const int size) {
  hw_uint<64> burst_reg;
  int num_transfers = psef22_4_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void psef22_4_opt_accel(hw_uint<64>* in_update_0_read, hw_uint<64>* psef22_4_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = psef22_4_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = psef22_4_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<64> > in_update_0_read_channel;
  static HWStream<hw_uint<64> > psef22_4_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  psef22_4_opt(in_update_0_read_channel, psef22_4_update_0_write_channel, size);

  write_psef22_4_update_0_write(psef22_4_update_0_write, psef22_4_update_0_write_channel, size);
}
