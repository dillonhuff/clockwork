...
#include "sbl_1_opt_compute_units.h"
...
inline hw_uint<16> sbl_1_rd0_select(mag_x_cache& mag_x, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl_1_rd0 read pattern: { sbl_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// sbl_1_update_0_read
//	sbl_1_rd0
inline hw_uint<16> mag_x_sbl_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1) {
  // # of ports in bundle: 1
    // sbl_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl_1_rd0_res = sbl_1_rd0_select(mag_x, d0, d1);
	set_at<0, 16>(result, sbl_1_rd0_res);
	return result;
}
...
inline hw_uint<16> sbl_1_rd0_select(mag_y_cache& mag_y, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl_1_rd0 read pattern: { sbl_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// sbl_1_update_0_read
//	sbl_1_rd0
inline hw_uint<16> mag_y_sbl_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1) {
  // # of ports in bundle: 1
    // sbl_1_rd0

	hw_uint<16> result;
	hw_uint<16> sbl_1_rd0_res = sbl_1_rd0_select(mag_y, d0, d1);
	set_at<0, 16>(result, sbl_1_rd0_res);
	return result;
}
...
// Operation logic
inline void sbl_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sbl_1, int d0, int d1) {
	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sbl_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sbl_1_update_0_mag_x," << d0<< "," << d1<< "," <<  mag_x_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sbl_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sbl_1_update_0_mag_y," << d0<< "," << d1<< "," <<  mag_y_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = sbl_1_generated_compute_unrolled_1(mag_x_0_c__0_value, mag_y_0_c__0_value);
	// Produce: sbl_1
	sbl_1.write(compute_result);
  ...
  *global_debug_handle << "sbl_1_update_0," << (1*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
// Driver function
void sbl_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl_1, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sbl_1_opt_debug.csv");
...
>>>>>>> 78b8261654c2bf3f375d798875a3cc9a6bcf54b8
	...
	mag_x_update_0(img, mag_x, (c1 - 1) / 1, (c0 - 1) / 1);
	    ...
	    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
	sbl_1_update_0(mag_x, mag_y, sbl_1, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void sbl_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl_1) {
  ...
  sbl_1_opt(off_chip_img, sbl_1, 1);
}
#ifdef __VIVADO_SYNTH__
#include "sbl_1_opt.h"

const int img_update_0_read_num_transfers = 2079604;
const int sbl_1_update_0_write_num_transfers = 2073600;
...
=======
  int num_transfers = sbl_1_update_0_write_num_transfers*30;
...
void sbl_1_opt_accel(hw_uint<16>* img_update_0_read, hw_uint<16>* sbl_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sbl_1_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = sbl_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<16> > img_update_0_read_channel;
  static HWStream<hw_uint<16> > sbl_1_update_0_write_channel;

  read_img_update_0_read(img_update_0_read, img_update_0_read_channel, size);

  sbl_1_opt(img_update_0_read_channel, sbl_1_update_0_write_channel, size);

  write_sbl_1_update_0_write(sbl_1_update_0_write, sbl_1_update_0_write_channel, size);
}
