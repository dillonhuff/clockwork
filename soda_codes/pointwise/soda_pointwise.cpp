...
void Module0Func(
  ...
  /* input*/ hls::stream<Data<ap_uint<16>>>* dram_input_bank_1_fifo)
{
...
#pragma HLS pipeline II=1
    ...
    {
      ap_uint<16> dram_input_bank_1_buf;
      ...
      enable = enabled;
      WriteData(fifo_st_0, Reinterpret<uint16_t>(static_cast<ap_uint<16>>(dram_input_bank_1_buf(15, 0))), enabled);
    } // if not empty
  } // for module_0_epoch
} // Module0Func
void Module1Func(
...
void Module3Func(
  /*output*/ hls::stream<Data<ap_uint<16>>>* dram_pointwise_bank_1_fifo, 
  /* input*/ hls::stream<Data<uint16_t>>* fifo_ld_0)
{
...
#pragma HLS pipeline II=1
    ...
    {
      uint16_t fifo_ref_0;
      ap_uint<16> dram_pointwise_bank_1_buf;
      const bool fifo_ref_0_enable = ReadData(&fifo_ref_0, fifo_ld_0);
      const bool enabled = fifo_ref_0_enable;
      enable = enabled;
      dram_pointwise_bank_1_buf(15, 0) = Reinterpret<ap_uint<16>>(fifo_ref_0);
...
#pragma HLS interface s_axilite port=return bundle=control
  ...
  hls::stream<Data<ap_uint<16>>> bank_1_input_buf("bank_1_input_buf");
#pragma HLS stream variable=bank_1_input_buf depth=32
#pragma HLS data_pack variable=bank_1_input_buf
  hls::stream<Data<ap_uint<16>>> bank_1_pointwise_buf("bank_1_pointwise_buf");
...
#pragma HLS data_pack variable=from_super_source_to_input_offset_0
  hls::stream<Data<uint16_t>> from_input_offset_0_to_pointwise_pe_0("from_input_offset_0_to_pointwise_pe_0");
#pragma HLS stream variable=from_input_offset_0_to_pointwise_pe_0 depth=32
#pragma HLS data_pack variable=from_input_offset_0_to_pointwise_pe_0
...
#pragma HLS dataflow
  ...
  Module1Func(
    /*output*/ &from_input_offset_0_to_pointwise_pe_0, 
    /* input*/ &from_super_source_to_input_offset_0);
  Module2Func(
    /*output*/ &from_pointwise_pe_0_to_super_sink, 
    /* input*/ &from_input_offset_0_to_pointwise_pe_0);
  Module3Func(
