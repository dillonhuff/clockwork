...
inline hw_uint<16> hw_input_global_wrapper_stencil_op_hcompute_mult_stencil_3_select(hw_input_global_wrapper_stencil_cache& hw_input_global_wrapper_stencil, int root, int mult_s0_y, int mult_s0_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_mult_stencil[root = 0, mult_s0_y, mult_s0_x] -> [mult_s0_y, mult_s0_x, 1] : 0 <= mult_s0_y <= 63 and 0 <= mult_s0_x <= 63 }
  // Write schedule: { op_hcompute_hw_input_global_wrapper_stencil[root = 0, hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x] -> [hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x, 0] : 0 <= hw_input_global_wrapper_s0_y <= 63 and 0 <= hw_input_global_wrapper_s0_x <= 63 }
...
inline hw_uint<16> mult_stencil_op_hcompute_hw_output_stencil_5_select(mult_stencil_cache& mult_stencil, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yi, hw_output_s0_x_xi] -> [hw_output_s0_y_yi, hw_output_s0_x_xi, 2] : 0 <= hw_output_s0_y_yi <= 63 and 0 <= hw_output_s0_x_xi <= 63 }
  // Write schedule: { op_hcompute_mult_stencil[root = 0, mult_s0_y, mult_s0_x] -> [mult_s0_y, mult_s0_x, 1] : 0 <= mult_s0_y <= 63 and 0 <= mult_s0_x <= 63 }
...
// schedule: { op_hcompute_mult_stencil[root = 0, mult_s0_y, mult_s0_x] -> [mult_s0_y, mult_s0_x, 1] : 0 <= mult_s0_y <= 63 and 0 <= mult_s0_x <= 63; op_hcompute_hw_input_global_wrapper_stencil[root = 0, hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x] -> [hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x, 0] : 0 <= hw_input_global_wrapper_s0_y <= 63 and 0 <= hw_input_global_wrapper_s0_x <= 63; op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yi, hw_output_s0_x_xi] -> [hw_output_s0_y_yi, hw_output_s0_x_xi, 2] : 0 <= hw_output_s0_y_yi <= 63 and 0 <= hw_output_s0_x_xi <= 63 }
//   { op_hcompute_mult_stencil[root = 0, mult_s0_y, mult_s0_x] -> [mult_s0_y, mult_s0_x, 1] : 0 <= mult_s0_y <= 63 and 0 <= mult_s0_x <= 63 }
// Condition for op_hcompute_mult_stencil(((-1 + i2 == 0) && (i0 >= 0) && (63 - i0 >= 0) && (i1 >= 0) && (63 - i1 >= 0)))
//   { op_hcompute_hw_input_global_wrapper_stencil[root = 0, hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x] -> [hw_input_global_wrapper_s0_y, hw_input_global_wrapper_s0_x, 0] : 0 <= hw_input_global_wrapper_s0_y <= 63 and 0 <= hw_input_global_wrapper_s0_x <= 63 }
// Condition for op_hcompute_hw_input_global_wrapper_stencil(((i2 == 0) && (i0 >= 0) && (63 - i0 >= 0) && (i1 >= 0) && (63 - i1 >= 0)))
//   { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yi, hw_output_s0_x_xi] -> [hw_output_s0_y_yi, hw_output_s0_x_xi, 2] : 0 <= hw_output_s0_y_yi <= 63 and 0 <= hw_output_s0_x_xi <= 63 }
