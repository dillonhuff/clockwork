...
#include <fstream>
#include <vector>
#include "three_channel_32_opt.h"
...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > three_channel_32_update_0_write_channel;
  // In lanes = 32
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      hw_uint<512> packed;
      {
      int c = 32*cl + 0;
  ...
  three_channel_32_opt(in0_update_0_read_channel, in1_update_0_read_channel, three_channel_32_update_0_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = three_channel_32_update_0_write_channel.read();
  ...
  output.save_image("./images/three_channel_32_opt_bmp_out.bmp");
}
