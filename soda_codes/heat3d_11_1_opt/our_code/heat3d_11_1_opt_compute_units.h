...
hw_uint<32> h3_8_generated_compute(hw_uint<32*7> h3_7) {
  return uint32_t(to_bits(((((((float)0.125) * to_float(h3_7.get<32, 6>())) + (((float)-0.125) * to_float(h3_7.get<32, 3>()))) + ((((float)0.125) * to_float(h3_7.get<32, 0>())) + ((((float)0.125) * to_float(h3_7.get<32, 5>())) + (((float)-0.125) * to_float(h3_7.get<32, 3>()))))) + (((((float)0.125) * to_float(h3_7.get<32, 1>())) + (((float)0.125) * to_float(h3_7.get<32, 4>()))) + ((((float)-0.125) * to_float(h3_7.get<32, 3>())) + ((((float)0.125) * to_float(h3_7.get<32, 2>())) + to_float(h3_7.get<32, 3>())))))));
}

hw_uint<32> h3_9_generated_compute(hw_uint<32*7> h3_8) {
  return uint32_t(to_bits(((((((float)0.125) * to_float(h3_8.get<32, 6>())) + (((float)-0.125) * to_float(h3_8.get<32, 3>()))) + ((((float)0.125) * to_float(h3_8.get<32, 0>())) + ((((float)0.125) * to_float(h3_8.get<32, 5>())) + (((float)-0.125) * to_float(h3_8.get<32, 3>()))))) + (((((float)0.125) * to_float(h3_8.get<32, 1>())) + (((float)0.125) * to_float(h3_8.get<32, 4>()))) + ((((float)-0.125) * to_float(h3_8.get<32, 3>())) + ((((float)0.125) * to_float(h3_8.get<32, 2>())) + to_float(h3_8.get<32, 3>())))))));
}

hw_uint<32> h3_10_generated_compute(hw_uint<32*7> h3_9) {
  return uint32_t(to_bits(((((((float)0.125) * to_float(h3_9.get<32, 6>())) + (((float)-0.125) * to_float(h3_9.get<32, 3>()))) + ((((float)0.125) * to_float(h3_9.get<32, 0>())) + ((((float)0.125) * to_float(h3_9.get<32, 5>())) + (((float)-0.125) * to_float(h3_9.get<32, 3>()))))) + (((((float)0.125) * to_float(h3_9.get<32, 1>())) + (((float)0.125) * to_float(h3_9.get<32, 4>()))) + ((((float)-0.125) * to_float(h3_9.get<32, 3>())) + ((((float)0.125) * to_float(h3_9.get<32, 2>())) + to_float(h3_9.get<32, 3>())))))));
}

hw_uint<32> heat3d_11_1_generated_compute(hw_uint<32*1> h3_10) {
  return uint32_t(to_bits(to_float(h3_10.get<32, 0>())));
}
...
hw_uint<32>  h3_7_generated_compute_unrolled_1(hw_uint<224>& h3_6) {
  ...
  // h3_8_update_0 unroll factor: 1
hw_uint<32>  h3_8_generated_compute_unrolled_1(hw_uint<224>& h3_7) {
  hw_uint<32> whole_result;

  hw_uint<224> lane_0_h3_7;
  set_at<0, 224, 224>(lane_0_h3_7, h3_7.extract<0, 223>());
  auto result_0 = h3_8_generated_compute(lane_0_h3_7);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}

  // h3_9_update_0 unroll factor: 1
hw_uint<32>  h3_9_generated_compute_unrolled_1(hw_uint<224>& h3_8) {
  hw_uint<32> whole_result;

  hw_uint<224> lane_0_h3_8;
  set_at<0, 224, 224>(lane_0_h3_8, h3_8.extract<0, 223>());
  auto result_0 = h3_9_generated_compute(lane_0_h3_8);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}

  // h3_10_update_0 unroll factor: 1
hw_uint<32>  h3_10_generated_compute_unrolled_1(hw_uint<224>& h3_9) {
  hw_uint<32> whole_result;

  hw_uint<224> lane_0_h3_9;
  set_at<0, 224, 224>(lane_0_h3_9, h3_9.extract<0, 223>());
  auto result_0 = h3_10_generated_compute(lane_0_h3_9);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}

  // heat3d_11_1_update_0 unroll factor: 1
hw_uint<32>  heat3d_11_1_generated_compute_unrolled_1(hw_uint<32>& h3_10) {
  hw_uint<32> whole_result;

  hw_uint<32> lane_0_h3_10;
  set_at<0, 32, 32>(lane_0_h3_10, h3_10.extract<0, 31>());
  auto result_0 = heat3d_11_1_generated_compute(lane_0_h3_10);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
