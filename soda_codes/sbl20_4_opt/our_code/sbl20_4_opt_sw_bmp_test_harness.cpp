...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<64> > sbl20_4_update_0_write_channel;
  // In lanes = 4
  ...
  sbl20_4_opt(img_update_0_read_channel, sbl20_4_update_0_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 4; cl++) {
      auto packed_val = sbl20_4_update_0_write_channel.read();
  ...
  output.save_image("./images/sbl20_4_opt_bmp_out.bmp");
}
