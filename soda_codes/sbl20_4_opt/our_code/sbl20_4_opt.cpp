...
// compute file: sbl20_4_opt_compute_units.h
#include "sbl20_4_opt_compute_units.h"
...
struct mag_x_mag_x_update_0_write0_to_sbl20_4_rd0_cache {
...
struct mag_x_mag_x_update_0_write1_to_sbl20_4_rd1_cache {
...
struct mag_x_mag_x_update_0_write2_to_sbl20_4_rd2_cache {
...
struct mag_x_mag_x_update_0_write3_to_sbl20_4_rd3_cache {
...
struct mag_x_cache {
  // # of banks: 4
  mag_x_mag_x_update_0_write0_to_sbl20_4_rd0_cache mag_x_mag_x_update_0_write0_to_sbl20_4_rd0;
  mag_x_mag_x_update_0_write1_to_sbl20_4_rd1_cache mag_x_mag_x_update_0_write1_to_sbl20_4_rd1;
  mag_x_mag_x_update_0_write2_to_sbl20_4_rd2_cache mag_x_mag_x_update_0_write2_to_sbl20_4_rd2;
  mag_x_mag_x_update_0_write3_to_sbl20_4_rd3_cache mag_x_mag_x_update_0_write3_to_sbl20_4_rd3;
};
...
inline void mag_x_mag_x_update_0_write0_write(hw_uint<16>& mag_x_mag_x_update_0_write0, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write0_to_sbl20_4_rd0.push(mag_x_mag_x_update_0_write0);
}
...
inline void mag_x_mag_x_update_0_write1_write(hw_uint<16>& mag_x_mag_x_update_0_write1, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write1_to_sbl20_4_rd1.push(mag_x_mag_x_update_0_write1);
}
...
inline void mag_x_mag_x_update_0_write2_write(hw_uint<16>& mag_x_mag_x_update_0_write2, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write2_to_sbl20_4_rd2.push(mag_x_mag_x_update_0_write2);
}
...
inline void mag_x_mag_x_update_0_write3_write(hw_uint<16>& mag_x_mag_x_update_0_write3, mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_write3_to_sbl20_4_rd3.push(mag_x_mag_x_update_0_write3);
}

inline hw_uint<16> sbl20_4_rd0_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd0 read pattern: { sbl20_4_update_0[d0, d1] -> mag_x[4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write0 = mag_x.mag_x_mag_x_update_0_write0_to_sbl20_4_rd0.peek(/* one reader or all rams */ 0);
  return value_mag_x_mag_x_update_0_write0;
  return 0;
}

inline hw_uint<16> sbl20_4_rd1_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd1 read pattern: { sbl20_4_update_0[d0, d1] -> mag_x[1 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write1 = mag_x.mag_x_mag_x_update_0_write1_to_sbl20_4_rd1.peek(/* one reader or all rams */ 0);
  return value_mag_x_mag_x_update_0_write1;
  return 0;
}

inline hw_uint<16> sbl20_4_rd2_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd2 read pattern: { sbl20_4_update_0[d0, d1] -> mag_x[2 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write2 = mag_x.mag_x_mag_x_update_0_write2_to_sbl20_4_rd2.peek(/* one reader or all rams */ 0);
  return value_mag_x_mag_x_update_0_write2;
  return 0;
}

inline hw_uint<16> sbl20_4_rd3_select(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd3 read pattern: { sbl20_4_update_0[d0, d1] -> mag_x[3 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_x_mag_x_update_0_write3 = mag_x.mag_x_mag_x_update_0_write3_to_sbl20_4_rd3.peek(/* one reader or all rams */ 0);
...
// sbl20_4_update_0_read
//	sbl20_4_rd0
//	sbl20_4_rd1
//	sbl20_4_rd2
//	sbl20_4_rd3
inline hw_uint<64> mag_x_sbl20_4_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 4
	...
	hw_uint<64> result;
	hw_uint<16> sbl20_4_rd0_res = sbl20_4_rd0_select(mag_x, d0, d1, dynamic_address);
	set_at<0, 64>(result, sbl20_4_rd0_res);
	hw_uint<16> sbl20_4_rd1_res = sbl20_4_rd1_select(mag_x, d0, d1, dynamic_address);
	set_at<16, 64>(result, sbl20_4_rd1_res);
	hw_uint<16> sbl20_4_rd2_res = sbl20_4_rd2_select(mag_x, d0, d1, dynamic_address);
	set_at<32, 64>(result, sbl20_4_rd2_res);
	hw_uint<16> sbl20_4_rd3_res = sbl20_4_rd3_select(mag_x, d0, d1, dynamic_address);
	set_at<48, 64>(result, sbl20_4_rd3_res);
	return result;
}

#include "hw_classes.h"

struct mag_y_mag_y_update_0_write0_to_sbl20_4_rd0_cache {
	// RAM Box: {[0, 1916], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_mag_y_update_0_write1_to_sbl20_4_rd1_cache {
	// RAM Box: {[1, 1917], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_mag_y_update_0_write2_to_sbl20_4_rd2_cache {
	// RAM Box: {[2, 1918], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_mag_y_update_0_write3_to_sbl20_4_rd3_cache {
	// RAM Box: {[3, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_cache {
  // # of banks: 4
  mag_y_mag_y_update_0_write0_to_sbl20_4_rd0_cache mag_y_mag_y_update_0_write0_to_sbl20_4_rd0;
  mag_y_mag_y_update_0_write1_to_sbl20_4_rd1_cache mag_y_mag_y_update_0_write1_to_sbl20_4_rd1;
  mag_y_mag_y_update_0_write2_to_sbl20_4_rd2_cache mag_y_mag_y_update_0_write2_to_sbl20_4_rd2;
  mag_y_mag_y_update_0_write3_to_sbl20_4_rd3_cache mag_y_mag_y_update_0_write3_to_sbl20_4_rd3;
};
...
inline void mag_y_mag_y_update_0_write0_write(hw_uint<16>& mag_y_mag_y_update_0_write0, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write0_to_sbl20_4_rd0.push(mag_y_mag_y_update_0_write0);
}
...
inline void mag_y_mag_y_update_0_write1_write(hw_uint<16>& mag_y_mag_y_update_0_write1, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write1_to_sbl20_4_rd1.push(mag_y_mag_y_update_0_write1);
}
...
inline void mag_y_mag_y_update_0_write2_write(hw_uint<16>& mag_y_mag_y_update_0_write2, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write2_to_sbl20_4_rd2.push(mag_y_mag_y_update_0_write2);
}
...
inline void mag_y_mag_y_update_0_write3_write(hw_uint<16>& mag_y_mag_y_update_0_write3, mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_write3_to_sbl20_4_rd3.push(mag_y_mag_y_update_0_write3);
}

inline hw_uint<16> sbl20_4_rd0_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd0 read pattern: { sbl20_4_update_0[d0, d1] -> mag_y[4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write0 = mag_y.mag_y_mag_y_update_0_write0_to_sbl20_4_rd0.peek(/* one reader or all rams */ 0);
  return value_mag_y_mag_y_update_0_write0;
  return 0;
}

inline hw_uint<16> sbl20_4_rd1_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd1 read pattern: { sbl20_4_update_0[d0, d1] -> mag_y[1 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write1 = mag_y.mag_y_mag_y_update_0_write1_to_sbl20_4_rd1.peek(/* one reader or all rams */ 0);
  return value_mag_y_mag_y_update_0_write1;
  return 0;
}

inline hw_uint<16> sbl20_4_rd2_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd2 read pattern: { sbl20_4_update_0[d0, d1] -> mag_y[2 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write2 = mag_y.mag_y_mag_y_update_0_write2_to_sbl20_4_rd2.peek(/* one reader or all rams */ 0);
  return value_mag_y_mag_y_update_0_write2;
  return 0;
}

inline hw_uint<16> sbl20_4_rd3_select(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sbl20_4_rd3 read pattern: { sbl20_4_update_0[d0, d1] -> mag_y[3 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_mag_y_mag_y_update_0_write3 = mag_y.mag_y_mag_y_update_0_write3_to_sbl20_4_rd3.peek(/* one reader or all rams */ 0);
...
//	sbl20_4_rd2
//	sbl20_4_rd3
inline hw_uint<64> mag_y_sbl20_4_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 4
    // sbl20_4_rd0
    // sbl20_4_rd1
    // sbl20_4_rd2
	...
	hw_uint<64> result;
	hw_uint<16> sbl20_4_rd0_res = sbl20_4_rd0_select(mag_y, d0, d1, dynamic_address);
	set_at<0, 64>(result, sbl20_4_rd0_res);
	hw_uint<16> sbl20_4_rd1_res = sbl20_4_rd1_select(mag_y, d0, d1, dynamic_address);
	set_at<16, 64>(result, sbl20_4_rd1_res);
	hw_uint<16> sbl20_4_rd2_res = sbl20_4_rd2_select(mag_y, d0, d1, dynamic_address);
	set_at<32, 64>(result, sbl20_4_rd2_res);
	hw_uint<16> sbl20_4_rd3_res = sbl20_4_rd3_select(mag_y, d0, d1, dynamic_address);
	set_at<48, 64>(result, sbl20_4_rd3_res);
	return result;
}

// Total re-use buffer capacity: 61776 bits


// Operation logic
inline void sbl20_4_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<64> >& /* buffer_args num ports = 4 */sbl20_4, int d0, int d1) {
  // Dynamic address computation

	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sbl20_4_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sbl20_4_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = sbl20_4_generated_compute_unrolled_4(mag_x_0_c__0_value, mag_y_0_c__0_value);
	// Produce: sbl20_4
	sbl20_4.write(compute_result);
...
// Driver function
void sbl20_4_opt(HWStream<hw_uint<64> >& /* get_args num ports = 4 */off_chip_img, HWStream<hw_uint<64> >& /* get_args num ports = 4 */sbl20_4) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sbl20_4_opt_debug.csv");
...
// schedule: { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 480 and -1 <= d1 <= 1080; mag_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; mag_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
//   { sbl20_4_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for sbl20_4_update_0(((-4 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
...
// Condition for mag_x_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
  ...
  // Schedules...
    ...
    // sbl20_4_update_0 -> [1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*4]
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 480) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
      sbl20_4_update_0((c1 - 1) / 1, (c0 - 1) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((1 <= c1 && c1 <= 480) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
	      sbl20_4_update_0(mag_x /* buf name */, mag_y /* buf name */, sbl20_4, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void sbl20_4_opt_wrapper(HWStream<hw_uint<64> >& /* get_args num ports = 4 */off_chip_img, HWStream<hw_uint<64> >& /* get_args num ports = 4 */sbl20_4, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    sbl20_4_opt(off_chip_img, sbl20_4);
  }
}
#ifdef __VIVADO_SYNTH__
...
const int img_update_0_read_pipe0_num_transfers = 521524;
  // { sbl20_4_update_0[root = 0, sbl20_4_0, sbl20_4_1] -> sbl20_4[0, 0] : 0 <= sbl20_4_0 <= 479 and 0 <= sbl20_4_1 <= 1079 }
const int sbl20_4_update_0_write_pipe0_num_transfers = 518400;


extern "C" {

void sbl20_4_opt_accel(hw_uint<64>* img_update_0_read_pipe0, hw_uint<64>* sbl20_4_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sbl20_4_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = sbl20_4_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<64> > sbl20_4_update_0_write_pipe0_channel;

  burst_read<64>(img_update_0_read_pipe0, img_update_0_read_pipe0_channel, img_update_0_read_pipe0_num_transfers*30);

  sbl20_4_opt_wrapper(img_update_0_read_pipe0_channel, sbl20_4_update_0_write_pipe0_channel, size);

  burst_write<64>(sbl20_4_update_0_write_pipe0, sbl20_4_update_0_write_pipe0_channel, sbl20_4_update_0_write_pipe0_num_transfers*30);
}

}
extern "C" {

void sbl20_4_opt_rdai(HWStream<hw_uint<64> >& img_update_0_read_pipe0, HWStream<hw_uint<64> >&  sbl20_4_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = img_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = sbl20_4_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  sbl20_4_opt(img_update_0_read_pipe0, sbl20_4_update_0_write_pipe0);
