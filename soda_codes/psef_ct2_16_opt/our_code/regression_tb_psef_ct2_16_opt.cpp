...
int main() {
  ofstream in_pix("input_pixels_regression_result_psef_ct2_16_opt.txt");
  ofstream fout("regression_result_psef_ct2_16_opt.txt");
  HWStream<hw_uint<256> > in_update_0_read;
  HWStream<hw_uint<256> > psef_ct2_16_update_0_write;
  ...
  psef_ct2_16_opt(in_update_0_read, psef_ct2_16_update_0_write);

  for (int i = 0; i < 129600; i++) {
    hw_uint<256> actual = psef_ct2_16_update_0_write.read();
