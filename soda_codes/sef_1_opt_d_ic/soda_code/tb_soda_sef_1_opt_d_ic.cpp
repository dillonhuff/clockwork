// AUTO GEN SODA TB
#include "sef_1_opt_d_ic_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  sef_1_opt_d_ic_kernel(sef_1, in_off_chip, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_sef_1_opt_d_ic_regression_result.csv", sef_1, nrows, ncols, transfer_cols);
  free(in_off_chip);
  free(sef_1);
}
