// AUTO GEN SODA TB
#include "jac9_1_opt_dis_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  jac9_1_opt_dis_kernel(jac9_1, in_off_chip, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_jac9_1_opt_dis_regression_result.csv", jac9_1, nrows, ncols, transfer_cols);
  free(in_off_chip);
  free(jac9_1);
}
