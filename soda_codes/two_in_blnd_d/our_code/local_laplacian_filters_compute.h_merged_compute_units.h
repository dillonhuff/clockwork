...
hw_uint<32> gp_in0_218_cu295(hw_uint<32*9>& gp_in0_1_buf8) {
  ...
  set_at<0, 32, 32>(return_value296, res_avg23);
  return return_value296;

}

hw_uint<32> gp_in0_110_cu298(hw_uint<32*9>& in0) {
  ...
  set_at<0, 32, 32>(return_value299, res_avg15);
  return return_value299;

}

hw_uint<32> gp_in1_158_cu301(hw_uint<32*9>& in1) {
  ...
  set_at<0, 32, 32>(return_value302, res_avg63);
...
hw_uint<32> gp_in1_266_cu307(hw_uint<32*9>& gp_in1_1_buf56) {
  ...
  set_at<0, 32, 32>(return_value308, res_avg71);
  return return_value308;

}

hw_uint<32> gp_in0_326_cu310(hw_uint<32*9>& gp_in0_2_buf16) {
  ...
  set_at<0, 32, 32>(return_value311, res_avg31);
