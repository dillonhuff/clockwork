// AUTO GEN SODA TB
#include "blurx7_1_opt_dis_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  blurx7_1_opt_dis_kernel(blurx7_1, input_arg, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_blurx7_1_opt_dis_regression_result.csv", blurx7_1, nrows, ncols, transfer_cols);
  free(input_arg);
  free(blurx7_1);
}
