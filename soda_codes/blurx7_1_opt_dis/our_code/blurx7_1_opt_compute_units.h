...
hw_uint<16> blurx7_1_generated_compute(hw_uint<16*3> input) {
...
hw_uint<16>  input_generated_compute_unrolled_1(hw_uint<16>& input_arg) {
  ...
  // blurx7_1_update_0 unroll factor: 1
hw_uint<16>  blurx7_1_generated_compute_unrolled_1(hw_uint<48>& input) {
  hw_uint<16> whole_result;

  hw_uint<48> lane_0_input;
  set_at<0, 48, 48>(lane_0_input, input.extract<0, 47>());
  auto result_0 = blurx7_1_generated_compute(lane_0_input);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
