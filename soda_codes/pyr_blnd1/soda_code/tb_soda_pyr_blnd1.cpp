...
int main() {
  ...
  pyr_blnd1_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_pyr_blnd1_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
