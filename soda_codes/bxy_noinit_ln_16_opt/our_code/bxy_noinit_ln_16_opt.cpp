...
inline void bxy_noinit_ln_16_update_0(blurx_cache& blurx, HWStream<hw_uint<256> >& /* buffer_args num ports = 16 */bxy_noinit_ln_16, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_bxy_noinit_ln_16_update_0_read_bundle_read(blurx/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = bxy_noinit_ln_16_generated_compute_unrolled_16(blurx_0_c__0_value);
...
// Condition for input_update_0(((-1 + i2 == 0) && (i1 >= 0) && (120 - i1 >= 0) && (i0 >= 0) && (1081 - i0 >= 0)))
//   { bxy_noinit_ln_16_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 119 and 0 <= d1 <= 1079 }
// Condition for bxy_noinit_ln_16_update_0(((-3 + i2 == 0) && (-1 + i1 >= 0) && (120 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 120 and 0 <= d1 <= 1079 }
// Condition for blurx_update_0(((-2 + i2 == 0) && (i1 >= 0) && (120 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 120) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      bxy_noinit_ln_16_update_0((c1 - 1) / 1, (c0 - 2) / 1);
    }
...
#ifdef __VIVADO_SYNTH__
  // { bxy_noinit_ln_16_update_0[root = 0, bxy_noinit_ln_16_0, bxy_noinit_ln_16_1] -> bxy_noinit_ln_16[0, 0] : 0 <= bxy_noinit_ln_16_0 <= 119 and 0 <= bxy_noinit_ln_16_1 <= 1079 }
const int bxy_noinit_ln_16_update_0_write_pipe0_num_transfers = 129600;
  // { input_update_0[root = 0, input_0, input_1] -> input_arg[0, 0] : 0 <= input_0 <= 120 and 0 <= input_1 <= 1081 }
