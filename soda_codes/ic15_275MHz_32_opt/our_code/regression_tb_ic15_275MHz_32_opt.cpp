#include <fstream>
#include "ic15_275MHz_32_opt.h"
#include "clockwork_standard_compute_units.h"

int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_ic15_275MHz_32_opt.txt");
  ofstream fout("regression_result_ic15_275MHz_32_opt.txt");
  HWStream<hw_uint<512> > in_update_0_read;
  HWStream<hw_uint<512> > ic15_275MHz_32_update_0_write;
  ...
  ic15_275MHz_32_opt(in_update_0_read, ic15_275MHz_32_update_0_write);

  for (int i = 0; i < 64800; i++) {
    hw_uint<512> actual = ic15_275MHz_32_update_0_write.read();
