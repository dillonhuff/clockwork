...
#include <fstream>
#include <vector>
#include "stencil_chain_dynamic_schedule.h"
...
int main(int argc, char **argv) {
  ...
  stencil_chain_dynamic_schedule(pw_math_in_oc03_read_channel, pw_math_stencil_59364367_write_channel);
  ...
  output.save_image("./images/stencil_chain_dynamic_schedule_bmp_out.bmp");
}
