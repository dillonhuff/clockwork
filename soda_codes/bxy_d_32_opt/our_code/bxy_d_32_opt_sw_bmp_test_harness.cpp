...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > bxy_d_32_1_merged479_write_channel;
  // In lanes = 32
  ...
  bxy_d_32_opt(input_1_merged473_read_channel, bxy_d_32_1_merged479_write_channel);
  bitmap_image output(1088, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1088 / 32; cl++) {
      auto packed_val = bxy_d_32_1_merged479_write_channel.read();
  ...
  output.save_image("./images/bxy_d_32_opt_bmp_out.bmp");
}
