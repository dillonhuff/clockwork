...
hw_uint<32> gp_in1_374_cu298(hw_uint<32*9>& gp_in1_2_buf64) {
  ...
  set_at<0, 32, 32>(return_value299, res_avg79);
...
hw_uint<32> gp_in0_110_cu304(hw_uint<32*9>& in0) {
  ...
  set_at<0, 32, 32>(return_value305, res_avg15);
...
hw_uint<32> gp_in1_266_cu310(hw_uint<32*9>& gp_in1_1_buf56) {
  ...
  set_at<0, 32, 32>(return_value311, res_avg71);
