...
inline void sbl_ln_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sbl_ln_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sbl_ln_1_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sbl_ln_1_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = sbl_ln_1_generated_compute_unrolled_1(mag_x_0_c__0_value, mag_y_0_c__0_value);
	// Produce: sbl_ln_1
...
// Condition for sbl_ln_1_update_0(((-4 + i2 == 0) && (-1 + i1 >= 0) && (1920 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
...
#pragma HLS pipeline II=1
    ...
    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
      sbl_ln_1_update_0((c1 - 1) / 1, (c0 - 1) / 1);
    }
...
const int img_update_0_read_pipe0_num_transfers = 2079604;
  // { sbl_ln_1_update_0[root = 0, sbl_ln_1_0, sbl_ln_1_1] -> sbl_ln_1[0, 0] : 0 <= sbl_ln_1_0 <= 1919 and 0 <= sbl_ln_1_1 <= 1079 }
