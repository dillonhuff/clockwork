...
hw_uint<16> sbl_ln_1_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<16>  mag_x_generated_compute_unrolled_1(hw_uint<96>& img) {
  ...
  // sbl_ln_1_update_0 unroll factor: 1
hw_uint<16>  sbl_ln_1_generated_compute_unrolled_1(hw_uint<16>& mag_x, hw_uint<16>& mag_y) {
  hw_uint<16> whole_result;
  ...
  auto result_0 = sbl_ln_1_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
