...
hw_uint<16> blur_xy_16_unrolled_4_generated_compute(hw_uint<16*3> blurx) {
...
hw_uint<64>  blurx_generated_compute_unrolled_4(hw_uint<192>& input) {
  ...
  // blur_xy_16_unrolled_4_update_0 unroll factor: 4
hw_uint<64>  blur_xy_16_unrolled_4_generated_compute_unrolled_4(hw_uint<96>& blurx) {
  hw_uint<64> whole_result;
  ...
  auto result_0 = blur_xy_16_unrolled_4_generated_compute(lane_0_blurx);
  set_at<0, 64, 16>(whole_result, result_0);
  ...
  auto result_1 = blur_xy_16_unrolled_4_generated_compute(lane_1_blurx);
  set_at<16, 64, 16>(whole_result, result_1);
  ...
  auto result_2 = blur_xy_16_unrolled_4_generated_compute(lane_2_blurx);
  set_at<32, 64, 16>(whole_result, result_2);
  ...
  auto result_3 = blur_xy_16_unrolled_4_generated_compute(lane_3_blurx);
  set_at<48, 64, 16>(whole_result, result_3);
  return whole_result;
}
