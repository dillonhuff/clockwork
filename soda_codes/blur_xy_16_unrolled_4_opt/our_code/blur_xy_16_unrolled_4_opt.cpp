...
#include "blur_xy_16_unrolled_4_opt_compute_units.h"
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd0_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd0 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_16_unrolled_4_update_0[d0, d1] -> 1 : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd1_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd1 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[1 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_16_unrolled_4_update_0[d0, d1] -> 1 : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd2_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd2 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[2 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_16_unrolled_4_update_0[d0, d1] -> 1 : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd3_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd3 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[3 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: { blur_xy_16_unrolled_4_update_0[d0, d1] -> 1 : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd4_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd4 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[4 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> blur_xy_16_unrolled_4_rd5_select(blurx_cache& blurx, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blur_xy_16_unrolled_4_rd5 read pattern: { blur_xy_16_unrolled_4_update_0[d0, d1] -> blurx[5 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { blur_xy_16_unrolled_4_update_0[d0, d1] -> [2 + d1, 1 + d0, 3] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, d0, 2] : 0 <= d0 <= 480 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// # of bundles = 2
// blur_xy_16_unrolled_4_update_0_read
//	blur_xy_16_unrolled_4_rd0
//	blur_xy_16_unrolled_4_rd1
//	blur_xy_16_unrolled_4_rd2
//	blur_xy_16_unrolled_4_rd3
//	blur_xy_16_unrolled_4_rd4
//	blur_xy_16_unrolled_4_rd5
inline hw_uint<96> blurx_blur_xy_16_unrolled_4_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1) {
  // # of ports in bundle: 6
	...
	hw_uint<96> result;
	hw_uint<16> blur_xy_16_unrolled_4_rd0_res = blur_xy_16_unrolled_4_rd0_select(blurx, d0, d1);
	set_at<0, 96>(result, blur_xy_16_unrolled_4_rd0_res);
	hw_uint<16> blur_xy_16_unrolled_4_rd1_res = blur_xy_16_unrolled_4_rd1_select(blurx, d0, d1);
	set_at<16, 96>(result, blur_xy_16_unrolled_4_rd1_res);
	hw_uint<16> blur_xy_16_unrolled_4_rd2_res = blur_xy_16_unrolled_4_rd2_select(blurx, d0, d1);
	set_at<32, 96>(result, blur_xy_16_unrolled_4_rd2_res);
	hw_uint<16> blur_xy_16_unrolled_4_rd3_res = blur_xy_16_unrolled_4_rd3_select(blurx, d0, d1);
	set_at<48, 96>(result, blur_xy_16_unrolled_4_rd3_res);
	hw_uint<16> blur_xy_16_unrolled_4_rd4_res = blur_xy_16_unrolled_4_rd4_select(blurx, d0, d1);
	set_at<64, 96>(result, blur_xy_16_unrolled_4_rd4_res);
	hw_uint<16> blur_xy_16_unrolled_4_rd5_res = blur_xy_16_unrolled_4_rd5_select(blurx, d0, d1);
	set_at<80, 96>(result, blur_xy_16_unrolled_4_rd5_res);
	return result;
}
...
inline void blur_xy_16_unrolled_4_update_0(blurx_cache& blurx, HWStream<hw_uint<64> >& /* buffer_args num ports = 4 */blur_xy_16_unrolled_4, int d0, int d1) {
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_blur_xy_16_unrolled_4_update_0_read_bundle_read(blurx/* source_delay */, d0, d1);
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "blur_xy_16_unrolled_4_update_0_blurx," << d0<< "," << d1<< "," <<  blurx_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
	auto compute_result = blur_xy_16_unrolled_4_generated_compute_unrolled_4(blurx_0_c__0_value);
	// Produce: blur_xy_16_unrolled_4
	blur_xy_16_unrolled_4.write(compute_result);
#ifndef __VIVADO_SYNTH__
  hw_uint<64> debug_compute_result(compute_result);
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  ...
  hw_uint<16> debug_compute_result_lane_3;
  set_at<0, 16, 16>(debug_compute_result_lane_3, debug_compute_result.extract<48, 63>());
  *global_debug_handle << "blur_xy_16_unrolled_4_update_0," << (4*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
  *global_debug_handle << "blur_xy_16_unrolled_4_update_0," << (4*d0 + 1) << ", " << d1<< "," <<  debug_compute_result_lane_1 << endl;
  *global_debug_handle << "blur_xy_16_unrolled_4_update_0," << (4*d0 + 2) << ", " << d1<< "," <<  debug_compute_result_lane_2 << endl;
  *global_debug_handle << "blur_xy_16_unrolled_4_update_0," << (4*d0 + 3) << ", " << d1<< "," <<  debug_compute_result_lane_3 << endl;
#endif //__VIVADO_SYNTH__
}

// Driver function
void blur_xy_16_unrolled_4_opt(HWStream<hw_uint<64> >& /* get_args num ports = 4 */input_arg, HWStream<hw_uint<64> >& /* get_args num ports = 4 */blur_xy_16_unrolled_4) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("blur_xy_16_unrolled_4_opt_debug.csv");
  ...
  input_cache input;
	...
	blur_xy_16_unrolled_4_update_0(blurx, blur_xy_16_unrolled_4, (c1 - 1) / 1, (c0 - 2) / 1);
	    }
...
#ifdef __VIVADO_SYNTH__
#include "blur_xy_16_unrolled_4_opt.h"

#define INPUT_SIZE 2081768
#define OUTPUT_SIZE 2073600

extern "C" {

static void read_input(hw_uint<64>* input, hls::stream<hw_uint<64>>& v, const int size) {
...
static void write_output(hw_uint<64>* output, hls::stream<hw_uint<64>>& v, const int size) {
...
#pragma HLS INTERFACE s_axilite port = blur_xy_16_unrolled_4_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static hls::stream<hw_uint<64>> input_arg_update_0_write_channel;
  static hls::stream<hw_uint<64>> blur_xy_16_unrolled_4_update_0_write_channel;

  read_input(input_arg_update_0_write, input_arg_update_0_write_channel, size);

  blur_xy_16_unrolled_4_opt(input_update_0_read_channel, blur_xy_16_unrolled_4_update_0_write_channel);

  write_output(blur_xy_16_unrolled_4_update_0_write, blur_xy_16_unrolled_4_update_0_write_channel, , size);
}
