...
hw_uint<16> sbl_8_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<128>  mag_x_generated_compute_unrolled_8(hw_uint<768>& img) {
  ...
  // sbl_8_update_0 unroll factor: 8
hw_uint<128>  sbl_8_generated_compute_unrolled_8(hw_uint<128>& mag_x, hw_uint<128>& mag_y) {
  hw_uint<128> whole_result;
  ...
  auto result_0 = sbl_8_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 128, 16>(whole_result, result_0);
  ...
  auto result_1 = sbl_8_generated_compute(lane_1_mag_x, lane_1_mag_y);
  set_at<16, 128, 16>(whole_result, result_1);
  ...
  auto result_2 = sbl_8_generated_compute(lane_2_mag_x, lane_2_mag_y);
  set_at<32, 128, 16>(whole_result, result_2);
  ...
  auto result_3 = sbl_8_generated_compute(lane_3_mag_x, lane_3_mag_y);
  set_at<48, 128, 16>(whole_result, result_3);
  ...
  auto result_4 = sbl_8_generated_compute(lane_4_mag_x, lane_4_mag_y);
  set_at<64, 128, 16>(whole_result, result_4);
  ...
  auto result_5 = sbl_8_generated_compute(lane_5_mag_x, lane_5_mag_y);
  set_at<80, 128, 16>(whole_result, result_5);
  ...
  auto result_6 = sbl_8_generated_compute(lane_6_mag_x, lane_6_mag_y);
  set_at<96, 128, 16>(whole_result, result_6);
  ...
  auto result_7 = sbl_8_generated_compute(lane_7_mag_x, lane_7_mag_y);
  set_at<112, 128, 16>(whole_result, result_7);
  return whole_result;
}
