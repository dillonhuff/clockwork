...
int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_heat3dla_8_8_opt.txt");
  ofstream fout("regression_result_heat3dla_8_8_opt.txt");
  HWStream<hw_uint<256> > in_cc_update_0_read;
  HWStream<hw_uint<256> > heat3dla_8_8_update_0_write;


  // Loading input data
  // cmap    : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] -> in[0, 0] : -8 <= in_cc_0 <= 23 and -8 <= in_cc_1 <= 135 and -8 <= in_cc_2 <= 39 }
  // read map: { in[0, 0] -> in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -8 <= in_cc_0 <= 23 and -8 <= in_cc_1 <= 135 and -8 <= in_cc_2 <= 39 }
  // rng     : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -8 <= in_cc_0 <= 23 and -8 <= in_cc_1 <= 135 and -8 <= in_cc_2 <= 39 }
  for (int i = 0; i < 221184; i++) {
    hw_uint<256> in_val;
  ...
  heat3dla_8_8_opt(in_cc_update_0_read, heat3dla_8_8_update_0_write);

  for (int i = 0; i < 65536; i++) {
    hw_uint<256> actual = heat3dla_8_8_update_0_write.read();
