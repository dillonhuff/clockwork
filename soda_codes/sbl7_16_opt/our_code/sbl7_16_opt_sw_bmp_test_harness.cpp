...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > sbl7_16_1_merged143_write_channel;
  // In lanes = 16
  ...
  sbl7_16_opt(img_1_merged134_read_channel, sbl7_16_1_merged143_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = sbl7_16_1_merged143_write_channel.read();
  ...
  output.save_image("./images/sbl7_16_opt_bmp_out.bmp");
}
