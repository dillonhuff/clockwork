...
// compute file: heat3ds_1_8_opt_compute_units.h
#include "heat3ds_1_8_opt_compute_units.h"

struct h3_0_h3_0_update_0_write0_to_heat3ds_1_8_rd0_cache {
	// RAM Box: {[0, 24], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write1_to_heat3ds_1_8_rd1_cache {
	// RAM Box: {[1, 25], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write2_to_heat3ds_1_8_rd2_cache {
	// RAM Box: {[2, 26], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write3_to_heat3ds_1_8_rd3_cache {
	// RAM Box: {[3, 27], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write4_to_heat3ds_1_8_rd4_cache {
	// RAM Box: {[4, 28], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write5_to_heat3ds_1_8_rd5_cache {
	// RAM Box: {[5, 29], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write6_to_heat3ds_1_8_rd6_cache {
	// RAM Box: {[6, 30], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_h3_0_update_0_write7_to_heat3ds_1_8_rd7_cache {
	// RAM Box: {[7, 31], [0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
	fifo<hw_uint<32> , 1> f;
...
struct h3_0_cache {
  // # of banks: 8
  h3_0_h3_0_update_0_write0_to_heat3ds_1_8_rd0_cache h3_0_h3_0_update_0_write0_to_heat3ds_1_8_rd0;
  h3_0_h3_0_update_0_write1_to_heat3ds_1_8_rd1_cache h3_0_h3_0_update_0_write1_to_heat3ds_1_8_rd1;
  h3_0_h3_0_update_0_write2_to_heat3ds_1_8_rd2_cache h3_0_h3_0_update_0_write2_to_heat3ds_1_8_rd2;
  h3_0_h3_0_update_0_write3_to_heat3ds_1_8_rd3_cache h3_0_h3_0_update_0_write3_to_heat3ds_1_8_rd3;
  h3_0_h3_0_update_0_write4_to_heat3ds_1_8_rd4_cache h3_0_h3_0_update_0_write4_to_heat3ds_1_8_rd4;
  h3_0_h3_0_update_0_write5_to_heat3ds_1_8_rd5_cache h3_0_h3_0_update_0_write5_to_heat3ds_1_8_rd5;
  h3_0_h3_0_update_0_write6_to_heat3ds_1_8_rd6_cache h3_0_h3_0_update_0_write6_to_heat3ds_1_8_rd6;
  h3_0_h3_0_update_0_write7_to_heat3ds_1_8_rd7_cache h3_0_h3_0_update_0_write7_to_heat3ds_1_8_rd7;
};
...
inline void h3_0_h3_0_update_0_write0_write(hw_uint<32> & h3_0_h3_0_update_0_write0, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write0_to_heat3ds_1_8_rd0.push(h3_0_h3_0_update_0_write0);
}
...
inline void h3_0_h3_0_update_0_write1_write(hw_uint<32> & h3_0_h3_0_update_0_write1, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write1_to_heat3ds_1_8_rd1.push(h3_0_h3_0_update_0_write1);
}
...
inline void h3_0_h3_0_update_0_write2_write(hw_uint<32> & h3_0_h3_0_update_0_write2, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write2_to_heat3ds_1_8_rd2.push(h3_0_h3_0_update_0_write2);
}
...
inline void h3_0_h3_0_update_0_write3_write(hw_uint<32> & h3_0_h3_0_update_0_write3, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write3_to_heat3ds_1_8_rd3.push(h3_0_h3_0_update_0_write3);
}
...
inline void h3_0_h3_0_update_0_write4_write(hw_uint<32> & h3_0_h3_0_update_0_write4, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write4_to_heat3ds_1_8_rd4.push(h3_0_h3_0_update_0_write4);
}
...
inline void h3_0_h3_0_update_0_write5_write(hw_uint<32> & h3_0_h3_0_update_0_write5, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write5_to_heat3ds_1_8_rd5.push(h3_0_h3_0_update_0_write5);
}
...
inline void h3_0_h3_0_update_0_write6_write(hw_uint<32> & h3_0_h3_0_update_0_write6, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write6_to_heat3ds_1_8_rd6.push(h3_0_h3_0_update_0_write6);
}
...
inline void h3_0_h3_0_update_0_write7_write(hw_uint<32> & h3_0_h3_0_update_0_write7, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write7_to_heat3ds_1_8_rd7.push(h3_0_h3_0_update_0_write7);
}

inline hw_uint<32>  heat3ds_1_8_rd0_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd0 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write0 = h3_0.h3_0_h3_0_update_0_write0_to_heat3ds_1_8_rd0.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write0;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd1_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd1 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[1 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write1 = h3_0.h3_0_h3_0_update_0_write1_to_heat3ds_1_8_rd1.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write1;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd2_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd2 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[2 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write2 = h3_0.h3_0_h3_0_update_0_write2_to_heat3ds_1_8_rd2.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write2;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd3_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd3 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[3 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write3 = h3_0.h3_0_h3_0_update_0_write3_to_heat3ds_1_8_rd3.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write3;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd4_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd4 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[4 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write4 = h3_0.h3_0_h3_0_update_0_write4_to_heat3ds_1_8_rd4.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write4;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd5_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd5 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[5 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write5 = h3_0.h3_0_h3_0_update_0_write5_to_heat3ds_1_8_rd5.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write5;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd6_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd6 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[6 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write6 = h3_0.h3_0_h3_0_update_0_write6_to_heat3ds_1_8_rd6.peek(/* one reader or all rams */ 0);
  return value_h3_0_h3_0_update_0_write6;
  return 0;
}

inline hw_uint<32>  heat3ds_1_8_rd7_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_8_rd7 read pattern: { heat3ds_1_8_update_0[d0, d1, d2] -> h3_0[7 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write7 = h3_0.h3_0_h3_0_update_0_write7_to_heat3ds_1_8_rd7.peek(/* one reader or all rams */ 0);
...
//	heat3ds_1_8_rd6
//	heat3ds_1_8_rd7
inline hw_uint<256> h3_0_heat3ds_1_8_update_0_read_bundle_read(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  // # of ports in bundle: 8
	...
	hw_uint<256> result;
	hw_uint<32>  heat3ds_1_8_rd0_res = heat3ds_1_8_rd0_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<0, 256>(result, heat3ds_1_8_rd0_res);
	hw_uint<32>  heat3ds_1_8_rd1_res = heat3ds_1_8_rd1_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<32, 256>(result, heat3ds_1_8_rd1_res);
	hw_uint<32>  heat3ds_1_8_rd2_res = heat3ds_1_8_rd2_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<64, 256>(result, heat3ds_1_8_rd2_res);
	hw_uint<32>  heat3ds_1_8_rd3_res = heat3ds_1_8_rd3_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<96, 256>(result, heat3ds_1_8_rd3_res);
	hw_uint<32>  heat3ds_1_8_rd4_res = heat3ds_1_8_rd4_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<128, 256>(result, heat3ds_1_8_rd4_res);
	hw_uint<32>  heat3ds_1_8_rd5_res = heat3ds_1_8_rd5_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<160, 256>(result, heat3ds_1_8_rd5_res);
	hw_uint<32>  heat3ds_1_8_rd6_res = heat3ds_1_8_rd6_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<192, 256>(result, heat3ds_1_8_rd6_res);
	hw_uint<32>  heat3ds_1_8_rd7_res = heat3ds_1_8_rd7_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<224, 256>(result, heat3ds_1_8_rd7_res);
	return result;
}

struct in_cc_in_cc_update_0_write0_merged_banks_7_cache {
	// RAM Box: {[0, 32], [-1, 31], [0, 31]}
	// Capacity: 416
	// # of read delays: 7
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd0 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[-1 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd1 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd10 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd11 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd12 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd13 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd14 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write1 = in_cc.in_cc_in_cc_update_0_write1_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write1;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd15 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd16 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd17 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write2 = in_cc.in_cc_in_cc_update_0_write2_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write2;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd18 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd19 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd2 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd20 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd21 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[2 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write2 = in_cc.in_cc_in_cc_update_0_write2_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write2;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd22 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd23 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd24 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write3 = in_cc.in_cc_in_cc_update_0_write3_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write3;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd25 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd26 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd27 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd28 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[3 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write3 = in_cc.in_cc_in_cc_update_0_write3_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write3;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd29 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd3 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd30 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd31 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write4 = in_cc.in_cc_in_cc_update_0_write4_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write4;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd32 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd33 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd34 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd35 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[4 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write4 = in_cc.in_cc_in_cc_update_0_write4_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write4;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd36 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd37 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd38 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write5 = in_cc.in_cc_in_cc_update_0_write5_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write5;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd39 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd4 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd40 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd41 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd42 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[5 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write5 = in_cc.in_cc_in_cc_update_0_write5_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write5;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd43 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd44 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd45 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write6 = in_cc.in_cc_in_cc_update_0_write6_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write6;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd46 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd47 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd48 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd49 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[6 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write6 = in_cc.in_cc_in_cc_update_0_write6_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write6;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd5 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd50 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd51 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd52 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write7 = in_cc.in_cc_in_cc_update_0_write7_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write7;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd53 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, d1, 1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd54 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[7 + 8d0, 1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd55 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd6 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write1 = in_cc.in_cc_in_cc_update_0_write1_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write1;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd7 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[8d0, d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
  auto value_in_cc_in_cc_update_0_write0 = in_cc.in_cc_in_cc_update_0_write0_merged_banks_7.peek_211();
  return value_in_cc_in_cc_update_0_write0;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd8 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, -1 + d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd9 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + 8d0, d1, -1 + d2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
// Operation logic
inline void heat3ds_1_8_update_0(h3_0_cache& h3_0, HWStream<hw_uint<256> >& /* buffer_args num ports = 8 */heat3ds_1_8, int d0, int d1, int d2) {
  // Dynamic address computation

	// Consume: h3_0
	auto h3_0_0_c__0_value = h3_0_heat3ds_1_8_update_0_read_bundle_read(h3_0/* source_delay */, d0, d1, d2, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = heat3ds_1_8_generated_compute_unrolled_8(h3_0_0_c__0_value);
	// Produce: heat3ds_1_8
	heat3ds_1_8.write(compute_result);
...
// Driver function
void heat3ds_1_8_opt(HWStream<hw_uint<256> >& /* get_args num ports = 8 */in, HWStream<hw_uint<256> >& /* get_args num ports = 8 */heat3ds_1_8) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("heat3ds_1_8_opt_debug.csv");
...
// schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31; in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32; heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
//   { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for h3_0_update_0(((-2 + i3 == 0) && (-1 + i2 >= 0) && (4 - i2 >= 0) && (-1 + i1 >= 0) && (32 - i1 >= 0) && (-1 + i0 >= 0) && (32 - i0 >= 0)))
//   { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 4 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
// Condition for in_cc_update_0(((-1 + i3 == 0) && (1 + i2 >= 0) && (4 - i2 >= 0) && (1 + i1 >= 0) && (32 - i1 >= 0) && (1 + i0 >= 0) && (32 - i0 >= 0)))
//   { heat3ds_1_8_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for heat3ds_1_8_update_0(((-3 + i3 == 0) && (-1 + i2 >= 0) && (4 - i2 >= 0) && (-1 + i1 >= 0) && (32 - i1 >= 0) && (-1 + i0 >= 0) && (32 - i0 >= 0)))

  /*
  // Schedules...
    // h3_0_update_0 -> [1*d2*1*1 + 1*1,1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*2]
    // heat3ds_1_8_update_0 -> [1*d2*1*1 + 1*1,1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*3]
...
#pragma HLS pipeline II=1
      ...
      if ((-1 <= c2 && c2 <= 4) && ((c2 - 0) % 1 == 0) && (-1 <= c1 && c1 <= 32) && ((c1 - 0) % 1 == 0) && (-1 <= c0 && c0 <= 32) && ((c0 - 0) % 1 == 0)) {
        in_cc_update_0((c2 - 0) / 1, (c1 - 0) / 1, (c0 - 0) / 1);
      }

      if ((1 <= c2 && c2 <= 4) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
        h3_0_update_0((c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
      }

      if ((1 <= c2 && c2 <= 4) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
        heat3ds_1_8_update_0((c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
      }
  ...
  */
	...
	#pragma HLS pipeline II=1
	      ...
	      if ((1 <= c2 && c2 <= 4) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
	        heat3ds_1_8_update_0(h3_0 /* buf name */, heat3ds_1_8, (c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
	      }
...
void heat3ds_1_8_opt_wrapper(HWStream<hw_uint<256> >& /* get_args num ports = 8 */in, HWStream<hw_uint<256> >& /* get_args num ports = 8 */heat3ds_1_8, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    heat3ds_1_8_opt(in, heat3ds_1_8);
  }
}
#ifdef __VIVADO_SYNTH__
  // { heat3ds_1_8_update_0[root = 0, heat3ds_1_8_0, heat3ds_1_8_1, heat3ds_1_8_2] -> heat3ds_1_8[0, 0] : 0 <= heat3ds_1_8_0 <= 3 and 0 <= heat3ds_1_8_1 <= 31 and 0 <= heat3ds_1_8_2 <= 31 }
const int heat3ds_1_8_update_0_write_pipe0_num_transfers = 4096;
  // { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] -> in[0, 0] : -1 <= in_cc_0 <= 4 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 32 }
const int in_cc_update_0_read_pipe0_num_transfers = 6936;


extern "C" {

void heat3ds_1_8_opt_accel(hw_uint<256>* in_cc_update_0_read_pipe0, hw_uint<256>* heat3ds_1_8_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_cc_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = heat3ds_1_8_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_cc_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = heat3ds_1_8_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<256> > heat3ds_1_8_update_0_write_pipe0_channel;

  burst_read<256>(in_cc_update_0_read_pipe0, in_cc_update_0_read_pipe0_channel, in_cc_update_0_read_pipe0_num_transfers*size);

  heat3ds_1_8_opt_wrapper(in_cc_update_0_read_pipe0_channel, heat3ds_1_8_update_0_write_pipe0_channel, size);

  burst_write<256>(heat3ds_1_8_update_0_write_pipe0, heat3ds_1_8_update_0_write_pipe0_channel, heat3ds_1_8_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void heat3ds_1_8_opt_rdai(HWStream<hw_uint<256> >& in_cc_update_0_read_pipe0, HWStream<hw_uint<256> >&  heat3ds_1_8_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_cc_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = heat3ds_1_8_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  heat3ds_1_8_opt(in_cc_update_0_read_pipe0, heat3ds_1_8_update_0_write_pipe0);
