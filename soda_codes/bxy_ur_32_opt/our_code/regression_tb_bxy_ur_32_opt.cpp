#include <fstream>
#include "bxy_ur_32_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_bxy_ur_32_opt.txt");
  ofstream fout("regression_result_bxy_ur_32_opt.txt");
  HWStream<hw_uint<512> > input_update_0_read;
  HWStream<hw_uint<512> > bxy_ur_32_update_0_write;


  // Loading input data
  // cmap    : { input_update_0[root = 0, input_0, input_1] -> input_arg[0, 0] : 0 <= input_0 <= 60 and 0 <= input_1 <= 1081 }
  // read map: { input_arg[0, 0] -> input_update_0[root = 0, input_0, input_1] : 0 <= input_0 <= 60 and 0 <= input_1 <= 1081 }
  // rng     : { input_update_0[root = 0, input_0, input_1] : 0 <= input_0 <= 60 and 0 <= input_1 <= 1081 }
  ...
  bxy_ur_32_opt(input_update_0_read, bxy_ur_32_update_0_write);

  for (int i = 0; i < 64800; i++) {
    hw_uint<512> actual = bxy_ur_32_update_0_write.read();
