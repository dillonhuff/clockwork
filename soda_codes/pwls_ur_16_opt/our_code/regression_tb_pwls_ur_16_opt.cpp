...
int main() {
  ofstream in_pix("input_pixels_regression_result_pwls_ur_16_opt.txt");
  ofstream fout("regression_result_pwls_ur_16_opt.txt");
  HWStream<hw_uint<256> > input_update_0_read;
  HWStream<hw_uint<256> > pwls_ur_16_update_0_write;
  ...
  pwls_ur_16_opt(input_update_0_read, pwls_ur_16_update_0_write);

  for (int i = 0; i < 129600; i++) {
    hw_uint<256> actual = pwls_ur_16_update_0_write.read();
