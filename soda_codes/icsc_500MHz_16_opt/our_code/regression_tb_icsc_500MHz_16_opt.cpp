#include <fstream>
#include "icsc_500MHz_16_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_icsc_500MHz_16_opt.txt");
  ofstream fout("regression_result_icsc_500MHz_16_opt.txt");
  HWStream<hw_uint<256> > in_update_0_read;
  HWStream<hw_uint<256> > icsc_500MHz_16_update_0_write;
  ...
  icsc_500MHz_16_opt(in_update_0_read, icsc_500MHz_16_update_0_write);

  for (int i = 0; i < 129600; i++) {
    hw_uint<256> actual = icsc_500MHz_16_update_0_write.read();
