...
hw_uint<16> sbl_ur_16_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<256>  mag_x_generated_compute_unrolled_16(hw_uint<1536>& img) {
  ...
  // sbl_ur_16_update_0 unroll factor: 16
hw_uint<256>  sbl_ur_16_generated_compute_unrolled_16(hw_uint<256>& mag_x, hw_uint<256>& mag_y) {
  hw_uint<256> whole_result;
  ...
  auto result_0 = sbl_ur_16_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 256, 16>(whole_result, result_0);
  ...
  auto result_1 = sbl_ur_16_generated_compute(lane_1_mag_x, lane_1_mag_y);
  set_at<16, 256, 16>(whole_result, result_1);
  ...
  auto result_2 = sbl_ur_16_generated_compute(lane_2_mag_x, lane_2_mag_y);
  set_at<32, 256, 16>(whole_result, result_2);
  ...
  auto result_3 = sbl_ur_16_generated_compute(lane_3_mag_x, lane_3_mag_y);
  set_at<48, 256, 16>(whole_result, result_3);
  ...
  auto result_4 = sbl_ur_16_generated_compute(lane_4_mag_x, lane_4_mag_y);
  set_at<64, 256, 16>(whole_result, result_4);
  ...
  auto result_5 = sbl_ur_16_generated_compute(lane_5_mag_x, lane_5_mag_y);
  set_at<80, 256, 16>(whole_result, result_5);
  ...
  auto result_6 = sbl_ur_16_generated_compute(lane_6_mag_x, lane_6_mag_y);
  set_at<96, 256, 16>(whole_result, result_6);
  ...
  auto result_7 = sbl_ur_16_generated_compute(lane_7_mag_x, lane_7_mag_y);
  set_at<112, 256, 16>(whole_result, result_7);
  ...
  auto result_8 = sbl_ur_16_generated_compute(lane_8_mag_x, lane_8_mag_y);
  set_at<128, 256, 16>(whole_result, result_8);
  ...
  auto result_9 = sbl_ur_16_generated_compute(lane_9_mag_x, lane_9_mag_y);
  set_at<144, 256, 16>(whole_result, result_9);
  ...
  auto result_10 = sbl_ur_16_generated_compute(lane_10_mag_x, lane_10_mag_y);
  set_at<160, 256, 16>(whole_result, result_10);
  ...
  auto result_11 = sbl_ur_16_generated_compute(lane_11_mag_x, lane_11_mag_y);
  set_at<176, 256, 16>(whole_result, result_11);
  ...
  auto result_12 = sbl_ur_16_generated_compute(lane_12_mag_x, lane_12_mag_y);
  set_at<192, 256, 16>(whole_result, result_12);
  ...
  auto result_13 = sbl_ur_16_generated_compute(lane_13_mag_x, lane_13_mag_y);
  set_at<208, 256, 16>(whole_result, result_13);
  ...
  auto result_14 = sbl_ur_16_generated_compute(lane_14_mag_x, lane_14_mag_y);
  set_at<224, 256, 16>(whole_result, result_14);
  ...
  auto result_15 = sbl_ur_16_generated_compute(lane_15_mag_x, lane_15_mag_y);
  set_at<240, 256, 16>(whole_result, result_15);
  return whole_result;
}
