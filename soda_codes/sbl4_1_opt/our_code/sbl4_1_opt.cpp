...
// compute file: sbl4_1_opt_compute_units.h_merged_compute_units.h_merged_compute_units.h_merged_compute_units.h_merged_compute_units.h
#include "sbl4_1_opt_compute_units.h_merged_compute_units.h_merged_compute_units.h_merged_compute_units.h_merged_compute_units.h"
...
struct mag_x_mag_x_update_0_sm2_08_10_to_mag_x_sbl4_1_update_0_sm3_010_1_cache {
...
struct mag_x_cache {
  // Reader addrs...
    // { sbl4_1_update_0_sm3_010[root = 0, sbl4_1_0, sbl4_1_1] -> mag_x[sbl4_1_1, sbl4_1_0] : 0 <= sbl4_1_0 <= 1079 and 0 <= sbl4_1_1 <= 1919 }
  // # of banks: 1
  mag_x_mag_x_update_0_sm2_08_10_to_mag_x_sbl4_1_update_0_sm3_010_1_cache mag_x_mag_x_update_0_sm2_08_10_to_mag_x_sbl4_1_update_0_sm3_010_1;
};
...
inline void mag_x_mag_x_update_0_sm2_08_10_write(hw_uint<16>& mag_x_mag_x_update_0_sm2_08_10, mag_x_cache& mag_x, int root, int mag_x_0, int mag_x_1, int dynamic_address) {
  mag_x.mag_x_mag_x_update_0_sm2_08_10_to_mag_x_sbl4_1_update_0_sm3_010_1.push(mag_x_mag_x_update_0_sm2_08_10);
}

inline hw_uint<16> mag_x_sbl4_1_update_0_sm3_010_1_select(mag_x_cache& mag_x, int root, int sbl4_1_0, int sbl4_1_1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mag_x_sbl4_1_update_0_sm3_010_1 read pattern: { sbl4_1_update_0_sm3_010[root = 0, sbl4_1_0, sbl4_1_1] -> mag_x[sbl4_1_1, sbl4_1_0] : 0 <= sbl4_1_0 <= 1079 and 0 <= sbl4_1_1 <= 1919 }
  // Read schedule : { sbl4_1_update_0_sm3_010[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919 }
  // Write schedule: { mag_x_update_0_sm2_08[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919 }
  auto value_mag_x_mag_x_update_0_sm2_08_10 = mag_x.mag_x_mag_x_update_0_sm2_08_10_to_mag_x_sbl4_1_update_0_sm3_010_1.peek(/* one reader or all rams */ 0);
...
// sbl4_1_update_0_sm3_010_read
//	mag_x_sbl4_1_update_0_sm3_010_1
inline hw_uint<16> mag_x_sbl4_1_update_0_sm3_010_read_bundle_read(mag_x_cache& mag_x, int root, int sbl4_1_0, int sbl4_1_1, int dynamic_address) {
  // # of ports in bundle: 1
    // mag_x_sbl4_1_update_0_sm3_010_1

	hw_uint<16> result;
	hw_uint<16> mag_x_sbl4_1_update_0_sm3_010_1_res = mag_x_sbl4_1_update_0_sm3_010_1_select(mag_x, root, sbl4_1_0, sbl4_1_1, dynamic_address);
	set_at<0, 16>(result, mag_x_sbl4_1_update_0_sm3_010_1_res);
	return result;
}

struct mag_y_mag_y_update_0_sm1_06_3_to_mag_y_sbl4_1_update_0_sm3_010_2_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct mag_y_cache {
  // Reader addrs...
    // { sbl4_1_update_0_sm3_010[root = 0, sbl4_1_0, sbl4_1_1] -> mag_y[sbl4_1_1, sbl4_1_0] : 0 <= sbl4_1_0 <= 1079 and 0 <= sbl4_1_1 <= 1919 }
  // # of banks: 1
  mag_y_mag_y_update_0_sm1_06_3_to_mag_y_sbl4_1_update_0_sm3_010_2_cache mag_y_mag_y_update_0_sm1_06_3_to_mag_y_sbl4_1_update_0_sm3_010_2;
};
...
inline void mag_y_mag_y_update_0_sm1_06_3_write(hw_uint<16>& mag_y_mag_y_update_0_sm1_06_3, mag_y_cache& mag_y, int root, int mag_y_0, int mag_y_1, int dynamic_address) {
  mag_y.mag_y_mag_y_update_0_sm1_06_3_to_mag_y_sbl4_1_update_0_sm3_010_2.push(mag_y_mag_y_update_0_sm1_06_3);
}

inline hw_uint<16> mag_y_sbl4_1_update_0_sm3_010_2_select(mag_y_cache& mag_y, int root, int sbl4_1_0, int sbl4_1_1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mag_y_sbl4_1_update_0_sm3_010_2 read pattern: { sbl4_1_update_0_sm3_010[root = 0, sbl4_1_0, sbl4_1_1] -> mag_y[sbl4_1_1, sbl4_1_0] : 0 <= sbl4_1_0 <= 1079 and 0 <= sbl4_1_1 <= 1919 }
  // Read schedule : { sbl4_1_update_0_sm3_010[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919 }
  // Write schedule: { mag_y_update_0_sm1_06[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 1] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919 }
  auto value_mag_y_mag_y_update_0_sm1_06_3 = mag_y.mag_y_mag_y_update_0_sm1_06_3_to_mag_y_sbl4_1_update_0_sm3_010_2.peek(/* one reader or all rams */ 0);
...
// sbl4_1_update_0_sm3_010_read
//	mag_y_sbl4_1_update_0_sm3_010_2
inline hw_uint<16> mag_y_sbl4_1_update_0_sm3_010_read_bundle_read(mag_y_cache& mag_y, int root, int sbl4_1_0, int sbl4_1_1, int dynamic_address) {
  // # of ports in bundle: 1
    // mag_y_sbl4_1_update_0_sm3_010_2

	hw_uint<16> result;
	hw_uint<16> mag_y_sbl4_1_update_0_sm3_010_2_res = mag_y_sbl4_1_update_0_sm3_010_2_select(mag_y, root, sbl4_1_0, sbl4_1_1, dynamic_address);
	set_at<0, 16>(result, mag_y_sbl4_1_update_0_sm3_010_2_res);
	return result;
}
...
inline void sbl4_1_update_0_sm3_010(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sbl4_1, int root, int sbl4_1_0, int sbl4_1_1) {
  // Dynamic address computation

	// Consume: mag_x
	auto mag_x_1_m__lp_1_m_sbl4_1_1__p__0_rp___p__0_p_0_c_____1_m_sbl4_1_0__p__0_p_0_value = mag_x_sbl4_1_update_0_sm3_010_read_bundle_read(mag_x/* source_delay */, root, sbl4_1_0, sbl4_1_1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_1_m__lp_1_m_sbl4_1_1__p__0_rp___p__0_p_0_c_____1_m_sbl4_1_0__p__0_p_0_value = mag_y_sbl4_1_update_0_sm3_010_read_bundle_read(mag_y/* source_delay */, root, sbl4_1_0, sbl4_1_1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = sbl4_1_generated_compute_unrolled_1(mag_x_1_m__lp_1_m_sbl4_1_1__p__0_rp___p__0_p_0_c_____1_m_sbl4_1_0__p__0_p_0_value, mag_y_1_m__lp_1_m_sbl4_1_1__p__0_rp___p__0_p_0_c_____1_m_sbl4_1_0__p__0_p_0_value);
	// Produce: sbl4_1
...
// Driver function
void sbl4_1_opt(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl4_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sbl4_1_opt_debug.csv");
...
// schedule: { sbl4_1_update_0_sm3_010[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919; mag_x_update_0_sm2_08[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919; mag_y_update_0_sm1_06[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 1] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919; img_update_0_sm0_04[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 1081 and 0 <= d2 <= 1921 }
//   { sbl4_1_update_0_sm3_010[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 1079 and 0 <= d2 <= 1919 }
// Condition for sbl4_1_update_0_sm3_010(((((-3 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
...
// Condition for img_update_0_sm0_04(((((1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : i1 >= 2 and i2 >= 2 }
	          ...
	          // { [i0, i1, i2] : -2 + i2 >= 0 }
	        if ((((((-2 + 1*i1)) >= 0) && (((-2 + 1*i2)) >= 0)))) {
	          sbl4_1_update_0_sm3_010(mag_x /* buf name */, mag_y /* buf name */, sbl4_1, 0, ((-2 + 1*i1)), ((-2 + 1*i2)));
	        }
	    }
	  }
...
void sbl4_1_opt_wrapper(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sbl4_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    sbl4_1_opt(off_chip_img, sbl4_1);
  }
}
#ifdef __VIVADO_SYNTH__
...
const int img_update_0_sm0_04_read_pipe0_num_transfers = 2079604;
  // { sbl4_1_update_0_sm3_010[root = 0, sbl4_1_0, sbl4_1_1] -> sbl4_1[sbl4_1_1, sbl4_1_0] : 0 <= sbl4_1_0 <= 1079 and 0 <= sbl4_1_1 <= 1919 }
const int sbl4_1_update_0_sm3_010_write_pipe0_num_transfers = 2073600;


extern "C" {

void sbl4_1_opt_accel(hw_uint<16>* img_update_0_sm0_04_read_pipe0, hw_uint<16>* sbl4_1_update_0_sm3_010_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_sm0_04_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sbl4_1_update_0_sm3_010_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_sm0_04_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = sbl4_1_update_0_sm3_010_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > sbl4_1_update_0_sm3_010_write_pipe0_channel;
  ...
  sbl4_1_opt_wrapper(img_update_0_sm0_04_read_pipe0_channel, sbl4_1_update_0_sm3_010_write_pipe0_channel, size);

  burst_write<16>(sbl4_1_update_0_sm3_010_write_pipe0, sbl4_1_update_0_sm3_010_write_pipe0_channel, sbl4_1_update_0_sm3_010_write_pipe0_num_transfers*size);
}

}
extern "C" {

void sbl4_1_opt_rdai(HWStream<hw_uint<16> >& img_update_0_sm0_04_read_pipe0, HWStream<hw_uint<16> >&  sbl4_1_update_0_sm3_010_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = img_update_0_sm0_04_read_pipe0
#pragma HLS INTERFACE axis register port = sbl4_1_update_0_sm3_010_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  sbl4_1_opt(img_update_0_sm0_04_read_pipe0, sbl4_1_update_0_sm3_010_write_pipe0);
