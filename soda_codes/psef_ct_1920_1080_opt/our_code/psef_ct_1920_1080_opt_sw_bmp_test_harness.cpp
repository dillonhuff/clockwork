...
#include <fstream>
#include <vector>
#include "psef_ct_1920_1080_opt.h"
...
int main(int argc, char **argv) {
  ...
  psef_ct_1920_1080_opt(in_update_0_read_channel, psef_ct_1920_1080_update_0_write_channel);
  ...
  output.save_image("./images/psef_ct_1920_1080_opt_bmp_out.bmp");
}
