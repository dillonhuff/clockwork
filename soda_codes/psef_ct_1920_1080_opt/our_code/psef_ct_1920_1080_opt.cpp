...
#include "psef_ct_1920_1080_opt_compute_units.h"
...
inline hw_uint<16> psef_ct_1920_1080_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
  ...
  // Read schedule : { psef_ct_1920_1080_update_0[d0, d1] -> [14 + d1, 14 + d0, 63] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// Driver function
void psef_ct_1920_1080_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */psef_ct_1920_1080, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("psef_ct_1920_1080_opt_debug.csv");
...
void psef_ct_1920_1080_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */psef_ct_1920_1080) {

  psef_ct_1920_1080_opt(in_off_chip, psef_ct_1920_1080, 1);
}
#ifdef __VIVADO_SYNTH__
...
void psef_ct_1920_1080_opt_accel(hw_uint<16>* in_update_0_read, hw_uint<16>* psef_ct_1920_1080_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  psef_ct_1920_1080_opt(in_update_0_read_channel, psef_ct_1920_1080_update_0_write_channel, size);
