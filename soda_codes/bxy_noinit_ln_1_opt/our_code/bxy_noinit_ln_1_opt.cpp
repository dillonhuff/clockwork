...
inline void bxy_noinit_ln_1_update_0(blurx_cache& blurx, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */bxy_noinit_ln_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: blurx
	auto blurx_0_c__0_value = blurx_bxy_noinit_ln_1_update_0_read_bundle_read(blurx/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = bxy_noinit_ln_1_generated_compute_unrolled_1(blurx_0_c__0_value);
...
// Condition for bxy_noinit_ln_1_update_0(((-3 + i2 == 0) && (-2 + i1 >= 0) && (1921 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
...
#pragma HLS pipeline II=1
    ...
    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      bxy_noinit_ln_1_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
...
#ifdef __VIVADO_SYNTH__
  // { bxy_noinit_ln_1_update_0[root = 0, bxy_noinit_ln_1_0, bxy_noinit_ln_1_1] -> bxy_noinit_ln_1[0, 0] : 0 <= bxy_noinit_ln_1_0 <= 1919 and 0 <= bxy_noinit_ln_1_1 <= 1079 }
