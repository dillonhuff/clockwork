...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<16> > blur4_1_update_0_sm18_027_write_channel;
  // In lanes = 1
  ...
  blur4_1_opt_d32(input_update_0_sm16_023_read_channel, blur4_1_update_0_sm18_027_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 1; cl++) {
      auto packed_val = blur4_1_update_0_sm18_027_write_channel.read();
  ...
  output.save_image("./images/blur4_1_opt_d32_bmp_out.bmp");
}
