...
hw_uint<32> h10_1_300MHz_2_generated_compute(hw_uint<32*1> h3_9) {
...
// Compute unit banks...
  // in_cc_update_0 unroll factor: 2
hw_uint<64>  in_cc_generated_compute_unrolled_2(hw_uint<64>& in) {
  ...
  // h3_0_update_0 unroll factor: 2
hw_uint<64>  h3_0_generated_compute_unrolled_2(hw_uint<320>& in_cc) {
  hw_uint<64> whole_result;
  ...
  // h3_1_update_0 unroll factor: 2
hw_uint<64>  h3_1_generated_compute_unrolled_2(hw_uint<320>& h3_0) {
  hw_uint<64> whole_result;
  ...
  // h3_2_update_0 unroll factor: 2
hw_uint<64>  h3_2_generated_compute_unrolled_2(hw_uint<320>& h3_1) {
  hw_uint<64> whole_result;
  ...
  // h3_3_update_0 unroll factor: 2
hw_uint<64>  h3_3_generated_compute_unrolled_2(hw_uint<320>& h3_2) {
  hw_uint<64> whole_result;
  ...
  // h3_4_update_0 unroll factor: 2
hw_uint<64>  h3_4_generated_compute_unrolled_2(hw_uint<320>& h3_3) {
  hw_uint<64> whole_result;
  ...
  // h3_5_update_0 unroll factor: 2
hw_uint<64>  h3_5_generated_compute_unrolled_2(hw_uint<320>& h3_4) {
  hw_uint<64> whole_result;
  ...
  // h3_6_update_0 unroll factor: 2
hw_uint<64>  h3_6_generated_compute_unrolled_2(hw_uint<320>& h3_5) {
  hw_uint<64> whole_result;
  ...
  // h3_7_update_0 unroll factor: 2
hw_uint<64>  h3_7_generated_compute_unrolled_2(hw_uint<320>& h3_6) {
  hw_uint<64> whole_result;
  ...
  // h3_8_update_0 unroll factor: 2
hw_uint<64>  h3_8_generated_compute_unrolled_2(hw_uint<320>& h3_7) {
  hw_uint<64> whole_result;
  ...
  // h3_9_update_0 unroll factor: 2
hw_uint<64>  h3_9_generated_compute_unrolled_2(hw_uint<320>& h3_8) {
  hw_uint<64> whole_result;
  ...
  // h10_1_300MHz_2_update_0 unroll factor: 2
hw_uint<64>  h10_1_300MHz_2_generated_compute_unrolled_2(hw_uint<64>& h3_9) {
  hw_uint<64> whole_result;

  hw_uint<32> lane_0_h3_9;
  set_at<0, 32, 32>(lane_0_h3_9, h3_9.extract<0, 31>());
  auto result_0 = h10_1_300MHz_2_generated_compute(lane_0_h3_9);
  set_at<0, 64, 32>(whole_result, result_0);

  hw_uint<32> lane_1_h3_9;
  set_at<0, 32, 32>(lane_1_h3_9, h3_9.extract<32, 63>());
  auto result_1 = h10_1_300MHz_2_generated_compute(lane_1_h3_9);
  set_at<32, 64, 32>(whole_result, result_1);
  return whole_result;
}
