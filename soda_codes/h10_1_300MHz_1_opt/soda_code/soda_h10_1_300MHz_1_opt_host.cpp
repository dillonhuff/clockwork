...
int main(int argc, char **argv) {
  ...
  const int h10_1_300MHz_1_update_0_write_pipe0_DATA_SIZE = num_epochs*1089936;
  const int h10_1_300MHz_1_update_0_write_BYTES_PER_PIXEL = 32 / 8;
  size_t h10_1_300MHz_1_update_0_write_size_bytes = h10_1_300MHz_1_update_0_write_BYTES_PER_PIXEL * h10_1_300MHz_1_update_0_write_pipe0_DATA_SIZE;

  total_size_bytes += h10_1_300MHz_1_update_0_write_size_bytes;
  total_size_bytes_written += h10_1_300MHz_1_update_0_write_size_bytes;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > h10_1_300MHz_1_update_0_write_pipe0(h10_1_300MHz_1_update_0_write_size_bytes);
  ...
  for (int i = 0; i < h10_1_300MHz_1_update_0_write_pipe0_DATA_SIZE; i++) {
    ((uint32_t*) (h10_1_300MHz_1_update_0_write_pipe0.data()))[i] = 0;
  }
  ...
  for (unsigned int i = 0; i < devices.size(); i++) {
    ...
    if (err != CL_SUCCESS) {
      ...
      OCL_CHECK(err, krnl_vector_add = cl::Kernel(program, "h10_1_300MHz_1_opt_kernel", &err));
      valid_device++;
      break;
    }
  }
  ...
  OCL_CHECK(err, cl::Buffer h10_1_300MHz_1_update_0_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, h10_1_300MHz_1_update_0_write_size_bytes, h10_1_300MHz_1_update_0_write_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(0, h10_1_300MHz_1_update_0_write_pipe0_ocl_buf));
...
nsduration = end - start;
  OCL_CHECK(err, err = q.enqueueMigrateMemObjects({h10_1_300MHz_1_update_0_write_pipe0_ocl_buf}, CL_MIGRATE_MEM_OBJECT_HOST));
  ...
  std::ofstream regression_result("h10_1_300MHz_1_update_0_write_accel_result.csv");
  for (int i = 0; i < h10_1_300MHz_1_update_0_write_pipe0_DATA_SIZE; i++) {
    regression_result << ((uint32_t*) (h10_1_300MHz_1_update_0_write_pipe0.data()))[i] << std::endl;
  }
