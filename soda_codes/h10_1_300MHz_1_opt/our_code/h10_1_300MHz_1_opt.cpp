...
// compute file: h10_1_300MHz_1_opt_compute_units.h
#include "h10_1_300MHz_1_opt_compute_units.h"
...
struct h3_9_h3_9_update_0_write0_to_h10_1_300MHz_1_rd0_cache {
...
struct h3_9_cache {
  // # of banks: 1
  h3_9_h3_9_update_0_write0_to_h10_1_300MHz_1_rd0_cache h3_9_h3_9_update_0_write0_to_h10_1_300MHz_1_rd0;
};
...
inline void h3_9_h3_9_update_0_write0_write(hw_uint<32> & h3_9_h3_9_update_0_write0, h3_9_cache& h3_9, int d0, int d1, int dynamic_address) {
  h3_9.h3_9_h3_9_update_0_write0_to_h10_1_300MHz_1_rd0.push(h3_9_h3_9_update_0_write0);
}

inline hw_uint<32>  h10_1_300MHz_1_rd0_select(h3_9_cache& h3_9, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h10_1_300MHz_1_rd0 read pattern: { h10_1_300MHz_1_update_0[d0, d1] -> h3_9[d0, d1] : 0 <= d0 <= 1023 and 0 <= d1 <= 1023 }
  // Read schedule : { h10_1_300MHz_1_update_0[d0, d1] -> [10 + d1, 10 + d0, 12] : 0 <= d0 <= 1023 and 0 <= d1 <= 1023 }
  // Write schedule: { h3_9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : 0 <= d0 <= 1023 and 0 <= d1 <= 1023 }
  auto value_h3_9_h3_9_update_0_write0 = h3_9.h3_9_h3_9_update_0_write0_to_h10_1_300MHz_1_rd0.peek(/* one reader or all rams */ 0);
  return value_h3_9_h3_9_update_0_write0;
  return 0;
}

// # of bundles = 2
// h10_1_300MHz_1_update_0_read
//	h10_1_300MHz_1_rd0
inline hw_uint<32> h3_9_h10_1_300MHz_1_update_0_read_bundle_read(h3_9_cache& h3_9, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // h10_1_300MHz_1_rd0

	hw_uint<32> result;
	hw_uint<32>  h10_1_300MHz_1_rd0_res = h10_1_300MHz_1_rd0_select(h3_9, d0, d1, dynamic_address);
	set_at<0, 32>(result, h10_1_300MHz_1_rd0_res);
	return result;
}
...
inline void h10_1_300MHz_1_update_0(h3_9_cache& h3_9, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */h10_1_300MHz_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: h3_9
	auto h3_9_0_c__0_value = h3_9_h10_1_300MHz_1_update_0_read_bundle_read(h3_9/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = h10_1_300MHz_1_generated_compute_unrolled_1(h3_9_0_c__0_value);
	// Produce: h10_1_300MHz_1
	h10_1_300MHz_1.write(compute_result);
...
// Driver function
void h10_1_300MHz_1_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* get_args num ports = 1 */h10_1_300MHz_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("h10_1_300MHz_1_opt_debug.csv");
...
//   { h10_1_300MHz_1_update_0[d0, d1] -> [10 + d1, 10 + d0, 12] : 0 <= d0 <= 1023 and 0 <= d1 <= 1023 }
// Condition for h10_1_300MHz_1_update_0(((-12 + i2 == 0) && (-10 + i1 >= 0) && (1033 - i1 >= 0) && (-10 + i0 >= 0) && (1033 - i0 >= 0)))
...
// Condition for h3_6_update_0(((-8 + i2 == 0) && (-4 + i1 >= 0) && (1033 - i1 >= 0) && (-4 + i0 >= 0) && (1033 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // h10_1_300MHz_1_update_0 -> [1*d1*1*1 + 1*10,1*d0*1*1 + 1*10,1*12]
...
#pragma HLS pipeline II=1
    ...
    if ((10 <= c1 && c1 <= 1033) && ((c1 - 10) % 1 == 0) && (10 <= c0 && c0 <= 1033) && ((c0 - 10) % 1 == 0)) {
      h10_1_300MHz_1_update_0((c1 - 10) / 1, (c0 - 10) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((10 <= c1 && c1 <= 1033) && ((c1 - 10) % 1 == 0) && (10 <= c0 && c0 <= 1033) && ((c0 - 10) % 1 == 0)) {
	      h10_1_300MHz_1_update_0(h3_9 /* buf name */, h10_1_300MHz_1, (c1 - 10) / 1, (c0 - 10) / 1);
	    }
...
void h10_1_300MHz_1_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* get_args num ports = 1 */h10_1_300MHz_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    h10_1_300MHz_1_opt(in, h10_1_300MHz_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { h10_1_300MHz_1_update_0[root = 0, h10_1_300MHz_1_0, h10_1_300MHz_1_1] -> h10_1_300MHz_1[0, 0] : 0 <= h10_1_300MHz_1_0 <= 1023 and 0 <= h10_1_300MHz_1_1 <= 1023 }
const int h10_1_300MHz_1_update_0_write_pipe0_num_transfers = 1048576;
...
void h10_1_300MHz_1_opt_accel(hw_uint<32>* in_cc_update_0_read_pipe0, hw_uint<32>* h10_1_300MHz_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_cc_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = h10_1_300MHz_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_cc_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = h10_1_300MHz_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<32> > h10_1_300MHz_1_update_0_write_pipe0_channel;

  burst_read<32>(in_cc_update_0_read_pipe0, in_cc_update_0_read_pipe0_channel, in_cc_update_0_read_pipe0_num_transfers*size);

  h10_1_300MHz_1_opt_wrapper(in_cc_update_0_read_pipe0_channel, h10_1_300MHz_1_update_0_write_pipe0_channel, size);

  burst_write<32>(h10_1_300MHz_1_update_0_write_pipe0, h10_1_300MHz_1_update_0_write_pipe0_channel, h10_1_300MHz_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void h10_1_300MHz_1_opt_rdai(HWStream<hw_uint<32> >& in_cc_update_0_read_pipe0, HWStream<hw_uint<32> >&  h10_1_300MHz_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_cc_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = h10_1_300MHz_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  h10_1_300MHz_1_opt(in_cc_update_0_read_pipe0, h10_1_300MHz_1_update_0_write_pipe0);
