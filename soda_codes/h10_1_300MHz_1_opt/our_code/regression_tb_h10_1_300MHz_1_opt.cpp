...
int main() {
  ofstream in_pix("input_pixels_regression_result_h10_1_300MHz_1_opt.txt");
  ofstream fout("regression_result_h10_1_300MHz_1_opt.txt");
  HWStream<hw_uint<32> > in_cc_update_0_read;
  HWStream<hw_uint<32> > h10_1_300MHz_1_update_0_write;
  ...
  h10_1_300MHz_1_opt(in_cc_update_0_read, h10_1_300MHz_1_update_0_write);

  for (int i = 0; i < 1048576; i++) {
    hw_uint<32> actual = h10_1_300MHz_1_update_0_write.read();
