...
hw_uint<32> h10_1_300MHz_1_generated_compute(hw_uint<32*1> h3_9) {
...
hw_uint<32>  h3_0_generated_compute_unrolled_1(hw_uint<160>& in_cc) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_1_generated_compute_unrolled_1(hw_uint<160>& h3_0) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_2_generated_compute_unrolled_1(hw_uint<160>& h3_1) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_3_generated_compute_unrolled_1(hw_uint<160>& h3_2) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_4_generated_compute_unrolled_1(hw_uint<160>& h3_3) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_5_generated_compute_unrolled_1(hw_uint<160>& h3_4) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_6_generated_compute_unrolled_1(hw_uint<160>& h3_5) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_7_generated_compute_unrolled_1(hw_uint<160>& h3_6) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_8_generated_compute_unrolled_1(hw_uint<160>& h3_7) {
  hw_uint<32> whole_result;
...
hw_uint<32>  h3_9_generated_compute_unrolled_1(hw_uint<160>& h3_8) {
  hw_uint<32> whole_result;
  ...
  // h10_1_300MHz_1_update_0 unroll factor: 1
hw_uint<32>  h10_1_300MHz_1_generated_compute_unrolled_1(hw_uint<32>& h3_9) {
  hw_uint<32> whole_result;

  hw_uint<32> lane_0_h3_9;
  set_at<0, 32, 32>(lane_0_h3_9, h3_9.extract<0, 31>());
  auto result_0 = h10_1_300MHz_1_generated_compute(lane_0_h3_9);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
