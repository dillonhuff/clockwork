...
inline void sobel_unrolled_8_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<256> >& /* buffer_args num ports = 8 */sobel_unrolled_8, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: mag_x
	auto mag_x_0_c__0_value = mag_x_sobel_unrolled_8_update_0_read_bundle_read(mag_x/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: mag_y
	auto mag_y_0_c__0_value = mag_y_sobel_unrolled_8_update_0_read_bundle_read(mag_y/* source_delay */, d0, d1, 0);
...
// Condition for sobel_unrolled_8_update_0(((-4 + i2 == 0) && (-1 + i1 >= 0) && (240 - i1 >= 0) && (-1 + i0 >= 0) && (1080 - i0 >= 0)))
...
for (int c0 = -1; c0 <= 1080; c0 += 1)
  for (int c1 = -1; c1 <= 240; c1 += 1) {
    ...
    if (c0 >= 1 && c1 >= 1) {
      ...
      sobel_unrolled_8_update_0(c1 - 1, c0 - 1);
    }
  }
...
const int img_update_0_read_pipe0_num_transfers = 261844;
  // { sobel_unrolled_8_update_0[root = 0, sobel_unrolled_8_0, sobel_unrolled_8_1] -> sobel_unrolled_8[0, 0] : 0 <= sobel_unrolled_8_0 <= 239 and 0 <= sobel_unrolled_8_1 <= 1079 }
