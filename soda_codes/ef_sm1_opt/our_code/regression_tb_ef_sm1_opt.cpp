#include <fstream>
#include "ef_sm1_opt.h"
#include "clockwork_standard_compute_units.h"

int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_ef_sm1_opt.txt");
  ofstream fout("regression_result_ef_sm1_opt.txt");
  HWStream<hw_uint<16> > in_update_0_read;
  HWStream<hw_uint<16> > ef_sm1_update_0_write;
  ...
  ef_sm1_opt(in_update_0_read, ef_sm1_update_0_write);

  for (int i = 0; i < 2073600; i++) {
    hw_uint<16> actual = ef_sm1_update_0_write.read();
