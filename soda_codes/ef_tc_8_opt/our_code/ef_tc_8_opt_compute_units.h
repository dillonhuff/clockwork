...
hw_uint<128>  exposure_weight_unrolled_8(hw_uint<128>& dark) {
  hw_uint<128> whole_result;
  ...
  // weight_sums_update_0 unroll factor: 8
hw_uint<128>  add_unrolled_8(hw_uint<128>& dark_weights, hw_uint<128>& bright_weights) {
  hw_uint<128> whole_result;
...
hw_uint<128>  f_divide_unrolled_8(hw_uint<128>& dark_weights, hw_uint<128>& weight_sums) {
  hw_uint<128> whole_result;
...
hw_uint<32>  merge_exposures_unrolled_2(hw_uint<32>& bright_laplace_diff_2, hw_uint<32>& dark_laplace_diff_2, hw_uint<32>& bright_weights_normed_gauss_ds_2, hw_uint<32>& dark_weights_normed_gauss_ds_2) {
  hw_uint<32> whole_result;
...
hw_uint<64>  merge_exposures_unrolled_4(hw_uint<64>& bright_laplace_diff_1, hw_uint<64>& dark_laplace_diff_1, hw_uint<64>& bright_weights_normed_gauss_ds_1, hw_uint<64>& dark_weights_normed_gauss_ds_1) {
  hw_uint<64> whole_result;
...
hw_uint<128>  merge_exposures_unrolled_8(hw_uint<128>& bright_laplace_diff_0, hw_uint<128>& dark_laplace_diff_0, hw_uint<128>& bright_weights_normed, hw_uint<128>& dark_weights_normed) {
  hw_uint<128> whole_result;
