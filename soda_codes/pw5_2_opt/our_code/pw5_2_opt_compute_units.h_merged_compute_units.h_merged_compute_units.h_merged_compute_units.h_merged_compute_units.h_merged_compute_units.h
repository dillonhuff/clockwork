...
hw_uint<64> t1_1_cu28(hw_uint<32*2>& t1_arg) {
  ...
  auto res_t1_update_0_sm8_114 = id_unrolled_1(t1_arg_lane_0_pack);

  hw_uint<32 > t1_arg_lane_1_pack;
  set_at<0, 32, 32>(t1_arg_lane_1_pack, t1_arg_lane_1);
  auto res_t1_update_0_sm8_012 = id_unrolled_1(t1_arg_lane_1_pack);
...
hw_uint<64> pw5_2_1_cu31(hw_uint<32*2>& t1_FIFO_buf4) {
  ...
  auto res_pw5_2_update_0_sm9_118 = id_unrolled_1(t1_FIFO_buf4_lane_0_pack);

  hw_uint<32 > t1_FIFO_buf4_lane_1_pack;
  set_at<0, 32, 32>(t1_FIFO_buf4_lane_1_pack, t1_FIFO_buf4_lane_1);
  auto res_pw5_2_update_0_sm9_016 = id_unrolled_1(t1_FIFO_buf4_lane_1_pack);
...
hw_uint<64> t1_to_gp_00_ld5_cu34(hw_uint<32*2>& t1_to_gp_00) {
  return t1_to_gp_00;
}

hw_uint<64> t1_ld1_cu36(hw_uint<32*2>& t1) {
  return t1;
}
