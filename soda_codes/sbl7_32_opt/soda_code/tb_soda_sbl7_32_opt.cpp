...
int main() {
  ...
  sbl7_32_opt_kernel(sbl7_32, off_chip_img, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_sbl7_32_opt_regression_result.csv", sbl7_32, nrows, ncols, transfer_cols);
  free(off_chip_img);
  free(sbl7_32);
}
