...
inline hw_uint<16> ef_fpga_2_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { ef_fpga_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
// Total re-use buffer capacity: 1050784 bits
...
//   { ef_fpga_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
// Condition for ef_fpga_2_update_0(((-52 + i2 == 0) && (-7 + i1 >= 0) && (966 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
...
// Condition for dark_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-1 - i1 + 2*floord(1 + i1, 2) == 0) && (-32 + i2 == 0) && (-7 + i1 >= 0) && (965 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
  ...
  // Schedules...
    ...
    // ef_fpga_2_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*7,1*52]
...
#pragma HLS pipeline II=1
    ...
    if ((7 <= c1 && c1 <= 966) && ((c1 - 7) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
      ef_fpga_2_update_0((c1 - 7) / 1, (c0 - 14) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((7 <= c1 && c1 <= 966) && ((c1 - 7) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
	      ef_fpga_2_update_0(final_merged_0 /* buf name */, ef_fpga_2, (c1 - 7) / 1, (c0 - 14) / 1);
	    }
