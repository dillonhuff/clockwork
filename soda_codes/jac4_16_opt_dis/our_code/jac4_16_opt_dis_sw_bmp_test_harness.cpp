...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > jac4_16_1_merged1859_write_channel;
  // In lanes = 16
  ...
  jac4_16_opt_dis(in_1_merged1811_read_channel, jac4_16_1_merged1859_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = jac4_16_1_merged1859_write_channel.read();
  ...
  output.save_image("./images/jac4_16_opt_dis_bmp_out.bmp");
}
