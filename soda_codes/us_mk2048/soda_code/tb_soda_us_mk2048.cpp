...
int main() {
  ...
  us_mk2048_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_us_mk2048_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
