...
int main(int argc, char **argv) {
  ...
  harris16_mini_naive(img_update_0_read_channel, harris16_mini_update_0_write_channel);
  ...
  output.save_image("./images/harris16_mini_naive_bmp_out.bmp");
}
