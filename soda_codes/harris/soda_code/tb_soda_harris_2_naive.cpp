// AUTO GEN SODA TB
#include "harris_2_naive_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  harris_2_naive_kernel(harris_2, img_oc, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_harris_2_naive_regression_result.csv", harris_2, nrows, ncols, transfer_cols);
  free(img_oc);
  free(harris_2);
}
