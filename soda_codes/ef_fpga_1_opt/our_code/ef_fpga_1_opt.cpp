...
struct final_merged_0_cache {
  // # of banks: 1
  final_merged_0_final_merged_0_update_0_write0_to_ef_fpga_1_rd0_cache final_merged_0_final_merged_0_update_0_write0_to_ef_fpga_1_rd0;
};
...
inline void final_merged_0_final_merged_0_update_0_write0_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write0, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_fpga_1_rd0.push(final_merged_0_final_merged_0_update_0_write0);
}

inline hw_uint<16> ef_fpga_1_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_fpga_1_rd0 read pattern: { ef_fpga_1_update_0[d0, d1] -> final_merged_0[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_fpga_1_update_0[d0, d1] -> [7 + d1, 7 + d0, 52] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 51] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write0 = final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_fpga_1_rd0.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write0;
  return 0;
}

// # of bundles = 2
// ef_fpga_1_update_0_read
//	ef_fpga_1_rd0
inline hw_uint<16> final_merged_0_ef_fpga_1_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ef_fpga_1_rd0

	hw_uint<16> result;
	hw_uint<16> ef_fpga_1_rd0_res = ef_fpga_1_rd0_select(final_merged_0, d0, d1, dynamic_address);
	set_at<0, 16>(result, ef_fpga_1_rd0_res);
	return result;
}
...
inline void ef_fpga_1_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ef_fpga_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_ef_fpga_1_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1, 0);
...
// Driver function
void ef_fpga_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_fpga_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ef_fpga_1_opt_debug.csv");
...
//   { ef_fpga_1_update_0[d0, d1] -> [7 + d1, 7 + d0, 52] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ef_fpga_1_update_0(((-52 + i2 == 0) && (-7 + i1 >= 0) && (1926 - i1 >= 0) && (-7 + i0 >= 0) && (1086 - i0 >= 0)))
...
// Condition for dark_laplace_us_2_update_0(((-1 - i0 + 4*floord(1 + i0, 4) == 0) && (-1 - i1 + 4*floord(1 + i1, 4) == 0) && (-32 + i2 == 0) && (-7 + i1 >= 0) && (1923 - i1 >= 0) && (-7 + i0 >= 0) && (1083 - i0 >= 0)))
  ...
  // Schedules...
    ...
    // ef_fpga_1_update_0 -> [1*d1*1*1 + 1*7,1*d0*1*1 + 1*7,1*52]
...
#pragma HLS pipeline II=1
    ...
    if ((7 <= c1 && c1 <= 1926) && ((c1 - 7) % 1 == 0) && (7 <= c0 && c0 <= 1086) && ((c0 - 7) % 1 == 0)) {
      ef_fpga_1_update_0((c1 - 7) / 1, (c0 - 7) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((7 <= c1 && c1 <= 1926) && ((c1 - 7) % 1 == 0) && (7 <= c0 && c0 <= 1086) && ((c0 - 7) % 1 == 0)) {
	      ef_fpga_1_update_0(final_merged_0 /* buf name */, ef_fpga_1, (c1 - 7) / 1, (c0 - 7) / 1);
	    }
...
void ef_fpga_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_fpga_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ef_fpga_1_opt(in_off_chip, ef_fpga_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ef_fpga_1_update_0[root = 0, ef_fpga_1_0, ef_fpga_1_1] -> ef_fpga_1[0, 0] : 0 <= ef_fpga_1_0 <= 1919 and 0 <= ef_fpga_1_1 <= 1079 }
const int ef_fpga_1_update_0_write_pipe0_num_transfers = 2073600;
...
void ef_fpga_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ef_fpga_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ef_fpga_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ef_fpga_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ef_fpga_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ef_fpga_1_opt_wrapper(in_update_0_read_pipe0_channel, ef_fpga_1_update_0_write_pipe0_channel, size);

  burst_write<16>(ef_fpga_1_update_0_write_pipe0, ef_fpga_1_update_0_write_pipe0_channel, ef_fpga_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ef_fpga_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ef_fpga_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ef_fpga_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ef_fpga_1_opt(in_update_0_read_pipe0, ef_fpga_1_update_0_write_pipe0);
