...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<16> > ef_fpga_1_update_0_write_channel;
  // In lanes = 1
  ...
  ef_fpga_1_opt(in_update_0_read_channel, ef_fpga_1_update_0_write_channel);
  ...
  output.save_image("./images/ef_fpga_1_opt_bmp_out.bmp");
}
