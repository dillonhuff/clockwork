...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sum_denoise2d_update_0_r1," << d0<< "," << d1<< "," <<  r1_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sum_denoise2d_update_0_f," << d0<< "," << d1<< "," <<  f_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sum_denoise2d_update_0_u," << d0<< "," << d1<< "," <<  u_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "sum_denoise2d_update_0_g," << d0<< "," << d1<< "," <<  g_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
  ...
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "sum_denoise2d_update_0," << (1*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__

}

// Driver function
void sum_denoise2d_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */f_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */u_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */sum_denoise2d, uint64_t num_epochs) {
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  sum_denoise2d_opt(f_update_0_read_channel, u_update_0_read_channel, sum_denoise2d_update_0_write_channel);

  write_output(sum_denoise2d_update_0_write, sum_denoise2d_update_0_write_channel, size);
}
