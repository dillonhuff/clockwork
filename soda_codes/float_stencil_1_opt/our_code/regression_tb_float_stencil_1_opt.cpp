...
int main() {
  ofstream in_pix("input_pixels_regression_result_float_stencil_1_opt.txt");
  ofstream fout("regression_result_float_stencil_1_opt.txt");
  HWStream<hw_uint<32> > in_cc_update_0_read;
  HWStream<hw_uint<32> > float_stencil_1_update_0_write;
  ...
  float_stencil_1_opt(in_cc_update_0_read, float_stencil_1_update_0_write);

  for (int i = 0; i < 1024; i++) {
    hw_uint<32> actual = float_stencil_1_update_0_write.read();
