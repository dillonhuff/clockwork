...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > sbl4_32_1_merged839_write_channel;
  // In lanes = 32
  ...
  sbl4_32_opt_dis(img_1_merged830_read_channel, sbl4_32_1_merged839_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      auto packed_val = sbl4_32_1_merged839_write_channel.read();
  ...
  output.save_image("./images/sbl4_32_opt_dis_bmp_out.bmp");
}
