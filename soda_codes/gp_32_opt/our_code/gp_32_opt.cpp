...
#include "gp_32_opt_compute_units.h"
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd0 read pattern: { level_0_update_0[d0, d1] -> in[32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd1 read pattern: { level_0_update_0[d0, d1] -> in[32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_7();
  return value_in_in_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd10 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd100 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write22 = in.in_in_update_0_write22_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd101 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd102 read pattern: { level_0_update_0[d0, d1] -> in[23 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write23 = in.in_in_update_0_write23_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd103 read pattern: { level_0_update_0[d0, d1] -> in[23 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write23 = in.in_in_update_0_write23_merged_banks_3.peek_7();
  return value_in_in_update_0_write23;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd104 read pattern: { level_0_update_0[d0, d1] -> in[23 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd105 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write24 = in.in_in_update_0_write24_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd106 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write24 = in.in_in_update_0_write24_merged_banks_6.peek_7();
  return value_in_in_update_0_write24;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd107 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd108 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write24 = in.in_in_update_0_write24_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd109 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write24 = in.in_in_update_0_write24_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd11 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd110 read pattern: { level_0_update_0[d0, d1] -> in[24 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write24 = in.in_in_update_0_write24_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd111 read pattern: { level_0_update_0[d0, d1] -> in[25 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write25 = in.in_in_update_0_write25_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd112 read pattern: { level_0_update_0[d0, d1] -> in[25 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write25 = in.in_in_update_0_write25_merged_banks_3.peek_7();
  return value_in_in_update_0_write25;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd113 read pattern: { level_0_update_0[d0, d1] -> in[25 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd114 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write26 = in.in_in_update_0_write26_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd115 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write26 = in.in_in_update_0_write26_merged_banks_6.peek_7();
  return value_in_in_update_0_write26;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd116 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd117 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write26 = in.in_in_update_0_write26_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd118 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write26 = in.in_in_update_0_write26_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd119 read pattern: { level_0_update_0[d0, d1] -> in[26 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write26 = in.in_in_update_0_write26_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd12 read pattern: { level_0_update_0[d0, d1] -> in[3 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd120 read pattern: { level_0_update_0[d0, d1] -> in[27 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write27 = in.in_in_update_0_write27_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd121 read pattern: { level_0_update_0[d0, d1] -> in[27 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write27 = in.in_in_update_0_write27_merged_banks_3.peek_7();
  return value_in_in_update_0_write27;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd122 read pattern: { level_0_update_0[d0, d1] -> in[27 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd123 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write28 = in.in_in_update_0_write28_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd124 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write28 = in.in_in_update_0_write28_merged_banks_6.peek_7();
  return value_in_in_update_0_write28;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd125 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd126 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write28 = in.in_in_update_0_write28_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd127 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write28 = in.in_in_update_0_write28_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd128 read pattern: { level_0_update_0[d0, d1] -> in[28 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write28 = in.in_in_update_0_write28_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd129 read pattern: { level_0_update_0[d0, d1] -> in[29 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write29 = in.in_in_update_0_write29_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd13 read pattern: { level_0_update_0[d0, d1] -> in[3 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write3 = in.in_in_update_0_write3_merged_banks_3.peek_7();
  return value_in_in_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd130 read pattern: { level_0_update_0[d0, d1] -> in[29 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write29 = in.in_in_update_0_write29_merged_banks_3.peek_7();
  return value_in_in_update_0_write29;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd131 read pattern: { level_0_update_0[d0, d1] -> in[29 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd132 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write30 = in.in_in_update_0_write30_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd133 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write30 = in.in_in_update_0_write30_merged_banks_6.peek_7();
  return value_in_in_update_0_write30;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd134 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd135 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write30 = in.in_in_update_0_write30_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd136 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write30 = in.in_in_update_0_write30_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd137 read pattern: { level_0_update_0[d0, d1] -> in[30 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write30 = in.in_in_update_0_write30_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd138 read pattern: { level_0_update_0[d0, d1] -> in[31 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write31 = in.in_in_update_0_write31_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd139 read pattern: { level_0_update_0[d0, d1] -> in[31 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write31 = in.in_in_update_0_write31_merged_banks_3.peek_7();
  return value_in_in_update_0_write31;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd14 read pattern: { level_0_update_0[d0, d1] -> in[3 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd140 read pattern: { level_0_update_0[d0, d1] -> in[31 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd141 read pattern: { level_0_update_0[d0, d1] -> in[32 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 12 : 0 <= d0 <= 3 and 0 <= d1 <= 38; level_0_update_0[d0, d1] -> (8 + d0) : d0 = 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd142 read pattern: { level_0_update_0[d0, d1] -> in[32 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 38; level_0_update_0[d0, d1] -> (2 + d0) : d0 = 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_6();
  return value_in_in_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd143 read pattern: { level_0_update_0[d0, d1] -> in[32 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd15 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd16 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_6.peek_7();
  return value_in_in_update_0_write4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd17 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd18 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd19 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd2 read pattern: { level_0_update_0[d0, d1] -> in[32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd20 read pattern: { level_0_update_0[d0, d1] -> in[4 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd21 read pattern: { level_0_update_0[d0, d1] -> in[5 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd22 read pattern: { level_0_update_0[d0, d1] -> in[5 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write5 = in.in_in_update_0_write5_merged_banks_3.peek_7();
  return value_in_in_update_0_write5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd23 read pattern: { level_0_update_0[d0, d1] -> in[5 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd24 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd25 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_6.peek_7();
  return value_in_in_update_0_write6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd26 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd27 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd28 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd29 read pattern: { level_0_update_0[d0, d1] -> in[6 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd3 read pattern: { level_0_update_0[d0, d1] -> in[1 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd30 read pattern: { level_0_update_0[d0, d1] -> in[7 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd31 read pattern: { level_0_update_0[d0, d1] -> in[7 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write7 = in.in_in_update_0_write7_merged_banks_3.peek_7();
  return value_in_in_update_0_write7;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd32 read pattern: { level_0_update_0[d0, d1] -> in[7 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd33 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write8 = in.in_in_update_0_write8_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd34 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write8 = in.in_in_update_0_write8_merged_banks_6.peek_7();
  return value_in_in_update_0_write8;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd35 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd36 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write8 = in.in_in_update_0_write8_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd37 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write8 = in.in_in_update_0_write8_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd38 read pattern: { level_0_update_0[d0, d1] -> in[8 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write8 = in.in_in_update_0_write8_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd39 read pattern: { level_0_update_0[d0, d1] -> in[9 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write9 = in.in_in_update_0_write9_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd4 read pattern: { level_0_update_0[d0, d1] -> in[1 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_3.peek_7();
  return value_in_in_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd40 read pattern: { level_0_update_0[d0, d1] -> in[9 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write9 = in.in_in_update_0_write9_merged_banks_3.peek_7();
  return value_in_in_update_0_write9;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd41 read pattern: { level_0_update_0[d0, d1] -> in[9 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd42 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write10 = in.in_in_update_0_write10_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd43 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write10 = in.in_in_update_0_write10_merged_banks_6.peek_7();
  return value_in_in_update_0_write10;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd44 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd45 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write10 = in.in_in_update_0_write10_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd46 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write10 = in.in_in_update_0_write10_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd47 read pattern: { level_0_update_0[d0, d1] -> in[10 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write10 = in.in_in_update_0_write10_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd48 read pattern: { level_0_update_0[d0, d1] -> in[11 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write11 = in.in_in_update_0_write11_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd49 read pattern: { level_0_update_0[d0, d1] -> in[11 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write11 = in.in_in_update_0_write11_merged_banks_3.peek_7();
  return value_in_in_update_0_write11;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd5 read pattern: { level_0_update_0[d0, d1] -> in[1 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd50 read pattern: { level_0_update_0[d0, d1] -> in[11 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd51 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write12 = in.in_in_update_0_write12_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd52 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write12 = in.in_in_update_0_write12_merged_banks_6.peek_7();
  return value_in_in_update_0_write12;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd53 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd54 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write12 = in.in_in_update_0_write12_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd55 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write12 = in.in_in_update_0_write12_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd56 read pattern: { level_0_update_0[d0, d1] -> in[12 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write12 = in.in_in_update_0_write12_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd57 read pattern: { level_0_update_0[d0, d1] -> in[13 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write13 = in.in_in_update_0_write13_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd58 read pattern: { level_0_update_0[d0, d1] -> in[13 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write13 = in.in_in_update_0_write13_merged_banks_3.peek_7();
  return value_in_in_update_0_write13;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd59 read pattern: { level_0_update_0[d0, d1] -> in[13 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd6 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd60 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write14 = in.in_in_update_0_write14_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd61 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write14 = in.in_in_update_0_write14_merged_banks_6.peek_7();
  return value_in_in_update_0_write14;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd62 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd63 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write14 = in.in_in_update_0_write14_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd64 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write14 = in.in_in_update_0_write14_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd65 read pattern: { level_0_update_0[d0, d1] -> in[14 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write14 = in.in_in_update_0_write14_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd66 read pattern: { level_0_update_0[d0, d1] -> in[15 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write15 = in.in_in_update_0_write15_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd67 read pattern: { level_0_update_0[d0, d1] -> in[15 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write15 = in.in_in_update_0_write15_merged_banks_3.peek_7();
  return value_in_in_update_0_write15;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd68 read pattern: { level_0_update_0[d0, d1] -> in[15 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd69 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write16 = in.in_in_update_0_write16_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd7 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd70 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write16 = in.in_in_update_0_write16_merged_banks_6.peek_7();
  return value_in_in_update_0_write16;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd71 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd72 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write16 = in.in_in_update_0_write16_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd73 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write16 = in.in_in_update_0_write16_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd74 read pattern: { level_0_update_0[d0, d1] -> in[16 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write16 = in.in_in_update_0_write16_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd75 read pattern: { level_0_update_0[d0, d1] -> in[17 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write17 = in.in_in_update_0_write17_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd76 read pattern: { level_0_update_0[d0, d1] -> in[17 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write17 = in.in_in_update_0_write17_merged_banks_3.peek_7();
  return value_in_in_update_0_write17;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd77 read pattern: { level_0_update_0[d0, d1] -> in[17 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd78 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write18 = in.in_in_update_0_write18_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd79 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write18 = in.in_in_update_0_write18_merged_banks_6.peek_7();
  return value_in_in_update_0_write18;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd8 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd80 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd81 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write18 = in.in_in_update_0_write18_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd82 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write18 = in.in_in_update_0_write18_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd83 read pattern: { level_0_update_0[d0, d1] -> in[18 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write18 = in.in_in_update_0_write18_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd84 read pattern: { level_0_update_0[d0, d1] -> in[19 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write19 = in.in_in_update_0_write19_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd85 read pattern: { level_0_update_0[d0, d1] -> in[19 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write19 = in.in_in_update_0_write19_merged_banks_3.peek_7();
  return value_in_in_update_0_write19;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd86 read pattern: { level_0_update_0[d0, d1] -> in[19 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd87 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write20 = in.in_in_update_0_write20_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd88 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write20 = in.in_in_update_0_write20_merged_banks_6.peek_7();
  return value_in_in_update_0_write20;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd89 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd9 read pattern: { level_0_update_0[d0, d1] -> in[2 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd90 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write20 = in.in_in_update_0_write20_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd91 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write20 = in.in_in_update_0_write20_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd92 read pattern: { level_0_update_0[d0, d1] -> in[20 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write20 = in.in_in_update_0_write20_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd93 read pattern: { level_0_update_0[d0, d1] -> in[21 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write21 = in.in_in_update_0_write21_merged_banks_3.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd94 read pattern: { level_0_update_0[d0, d1] -> in[21 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write21 = in.in_in_update_0_write21_merged_banks_3.peek_7();
  return value_in_in_update_0_write21;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd95 read pattern: { level_0_update_0[d0, d1] -> in[21 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd96 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write22 = in.in_in_update_0_write22_merged_banks_6.peek_13();
  return value_in_in_update_0_write22;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd97 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 1 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 7 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write22 = in.in_in_update_0_write22_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd98 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 2 + 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 1 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write22 = in.in_in_update_0_write22_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_0_rd99 read pattern: { level_0_update_0[d0, d1] -> in[22 + 32d0, 2d1] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 5 and 0 <= d1 <= 78 }
  // DD fold: { level_0_update_0[d0, d1] -> 13 : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  auto value_in_in_update_0_write22 = in.in_in_update_0_write22_merged_banks_6.peek_13();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd0 read pattern: { level_1_update_0[d0, d1] -> level_0[16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd1 read pattern: { level_1_update_0[d0, d1] -> level_0[16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write0 = level_0.level_0_level_0_update_0_write0_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd10 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write2 = level_0.level_0_level_0_update_0_write2_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd11 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd12 read pattern: { level_1_update_0[d0, d1] -> level_0[3 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write3 = level_0.level_0_level_0_update_0_write3_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd13 read pattern: { level_1_update_0[d0, d1] -> level_0[3 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write3 = level_0.level_0_level_0_update_0_write3_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd14 read pattern: { level_1_update_0[d0, d1] -> level_0[3 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd15 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write4 = level_0.level_0_level_0_update_0_write4_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd16 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write4 = level_0.level_0_level_0_update_0_write4_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd17 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd18 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write4 = level_0.level_0_level_0_update_0_write4_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd19 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write4 = level_0.level_0_level_0_update_0_write4_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd2 read pattern: { level_1_update_0[d0, d1] -> level_0[16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd20 read pattern: { level_1_update_0[d0, d1] -> level_0[4 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write4 = level_0.level_0_level_0_update_0_write4_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd21 read pattern: { level_1_update_0[d0, d1] -> level_0[5 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write5 = level_0.level_0_level_0_update_0_write5_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd22 read pattern: { level_1_update_0[d0, d1] -> level_0[5 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write5 = level_0.level_0_level_0_update_0_write5_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd23 read pattern: { level_1_update_0[d0, d1] -> level_0[5 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd24 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write6 = level_0.level_0_level_0_update_0_write6_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd25 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write6 = level_0.level_0_level_0_update_0_write6_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd26 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd27 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write6 = level_0.level_0_level_0_update_0_write6_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd28 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write6 = level_0.level_0_level_0_update_0_write6_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd29 read pattern: { level_1_update_0[d0, d1] -> level_0[6 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write6 = level_0.level_0_level_0_update_0_write6_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd3 read pattern: { level_1_update_0[d0, d1] -> level_0[1 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write1 = level_0.level_0_level_0_update_0_write1_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd30 read pattern: { level_1_update_0[d0, d1] -> level_0[7 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write7 = level_0.level_0_level_0_update_0_write7_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd31 read pattern: { level_1_update_0[d0, d1] -> level_0[7 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write7 = level_0.level_0_level_0_update_0_write7_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write7;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd32 read pattern: { level_1_update_0[d0, d1] -> level_0[7 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd33 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write8 = level_0.level_0_level_0_update_0_write8_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd34 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write8 = level_0.level_0_level_0_update_0_write8_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write8;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd35 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd36 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write8 = level_0.level_0_level_0_update_0_write8_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd37 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write8 = level_0.level_0_level_0_update_0_write8_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd38 read pattern: { level_1_update_0[d0, d1] -> level_0[8 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write8 = level_0.level_0_level_0_update_0_write8_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd39 read pattern: { level_1_update_0[d0, d1] -> level_0[9 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write9 = level_0.level_0_level_0_update_0_write9_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd4 read pattern: { level_1_update_0[d0, d1] -> level_0[1 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write1 = level_0.level_0_level_0_update_0_write1_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd40 read pattern: { level_1_update_0[d0, d1] -> level_0[9 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write9 = level_0.level_0_level_0_update_0_write9_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write9;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd41 read pattern: { level_1_update_0[d0, d1] -> level_0[9 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd42 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write10 = level_0.level_0_level_0_update_0_write10_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd43 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write10 = level_0.level_0_level_0_update_0_write10_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write10;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd44 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd45 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write10 = level_0.level_0_level_0_update_0_write10_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd46 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write10 = level_0.level_0_level_0_update_0_write10_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd47 read pattern: { level_1_update_0[d0, d1] -> level_0[10 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write10 = level_0.level_0_level_0_update_0_write10_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd48 read pattern: { level_1_update_0[d0, d1] -> level_0[11 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write11 = level_0.level_0_level_0_update_0_write11_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd49 read pattern: { level_1_update_0[d0, d1] -> level_0[11 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write11 = level_0.level_0_level_0_update_0_write11_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write11;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd5 read pattern: { level_1_update_0[d0, d1] -> level_0[1 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd50 read pattern: { level_1_update_0[d0, d1] -> level_0[11 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd51 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write12 = level_0.level_0_level_0_update_0_write12_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd52 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write12 = level_0.level_0_level_0_update_0_write12_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write12;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd53 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd54 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write12 = level_0.level_0_level_0_update_0_write12_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd55 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write12 = level_0.level_0_level_0_update_0_write12_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd56 read pattern: { level_1_update_0[d0, d1] -> level_0[12 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write12 = level_0.level_0_level_0_update_0_write12_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd57 read pattern: { level_1_update_0[d0, d1] -> level_0[13 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write13 = level_0.level_0_level_0_update_0_write13_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd58 read pattern: { level_1_update_0[d0, d1] -> level_0[13 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write13 = level_0.level_0_level_0_update_0_write13_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write13;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd59 read pattern: { level_1_update_0[d0, d1] -> level_0[13 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd6 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write2 = level_0.level_0_level_0_update_0_write2_merged_banks_6.peek_11();
  return value_level_0_level_0_update_0_write2;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd60 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write14 = level_0.level_0_level_0_update_0_write14_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd61 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write14 = level_0.level_0_level_0_update_0_write14_merged_banks_6.peek_6();
  return value_level_0_level_0_update_0_write14;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd62 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd63 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write14 = level_0.level_0_level_0_update_0_write14_merged_banks_6.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd64 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write14 = level_0.level_0_level_0_update_0_write14_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd65 read pattern: { level_1_update_0[d0, d1] -> level_0[14 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write14 = level_0.level_0_level_0_update_0_write14_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd66 read pattern: { level_1_update_0[d0, d1] -> level_0[15 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write15 = level_0.level_0_level_0_update_0_write15_merged_banks_3.peek_11();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd67 read pattern: { level_1_update_0[d0, d1] -> level_0[15 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write15 = level_0.level_0_level_0_update_0_write15_merged_banks_3.peek_6();
  return value_level_0_level_0_update_0_write15;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd68 read pattern: { level_1_update_0[d0, d1] -> level_0[15 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd69 read pattern: { level_1_update_0[d0, d1] -> level_0[16 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 10 : 0 <= d0 <= 2 and 0 <= d1 <= 18; level_1_update_0[d0, d1] -> (7 + d0) : d0 = 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write0 = level_0.level_0_level_0_update_0_write0_merged_banks_6.peek_10();
  return value_level_0_level_0_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd7 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 6 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write2 = level_0.level_0_level_0_update_0_write2_merged_banks_6.peek_6();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd70 read pattern: { level_1_update_0[d0, d1] -> level_0[16 + 16d0, 1 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 18; level_1_update_0[d0, d1] -> (2 + d0) : d0 = 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write0 = level_0.level_0_level_0_update_0_write0_merged_banks_6.peek_5();
  return value_level_0_level_0_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd71 read pattern: { level_1_update_0[d0, d1] -> level_0[16 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd8 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 2 + 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write2 = level_0.level_0_level_0_update_0_write2_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_1_rd9 read pattern: { level_1_update_0[d0, d1] -> level_0[2 + 16d0, 2d1] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 4 and 0 <= d1 <= 38 }
  // DD fold: { level_1_update_0[d0, d1] -> 11 : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  auto value_level_0_level_0_update_0_write2 = level_0.level_0_level_0_update_0_write2_merged_banks_6.peek_11();
...
struct level_1_level_1_update_0_write0_merged_banks_6_cache {
	...
	hw_uint<16> f0;
	hw_uint<16> f2;
	fifo<hw_uint<16>, 2> f3;
	hw_uint<16> f4;
	hw_uint<16> f6;
	fifo<hw_uint<16>, 2> f7;
	hw_uint<16> f8;
	hw_uint<16> f10;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd0 read pattern: { level_2_update_0[d0, d1] -> level_1[8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write0 = level_1.level_1_level_1_update_0_write0_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd1 read pattern: { level_2_update_0[d0, d1] -> level_1[8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write0 = level_1.level_1_level_1_update_0_write0_merged_banks_6.peek_5();
  return value_level_1_level_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd10 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write2 = level_1.level_1_level_1_update_0_write2_merged_banks_6.peek_5();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd11 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd12 read pattern: { level_2_update_0[d0, d1] -> level_1[3 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write3 = level_1.level_1_level_1_update_0_write3_merged_banks_3.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd13 read pattern: { level_2_update_0[d0, d1] -> level_1[3 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write3 = level_1.level_1_level_1_update_0_write3_merged_banks_3.peek_5();
  return value_level_1_level_1_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd14 read pattern: { level_2_update_0[d0, d1] -> level_1[3 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd15 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write4 = level_1.level_1_level_1_update_0_write4_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd16 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write4 = level_1.level_1_level_1_update_0_write4_merged_banks_6.peek_5();
  return value_level_1_level_1_update_0_write4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd17 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd18 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write4 = level_1.level_1_level_1_update_0_write4_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd19 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write4 = level_1.level_1_level_1_update_0_write4_merged_banks_6.peek_5();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd2 read pattern: { level_2_update_0[d0, d1] -> level_1[8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd20 read pattern: { level_2_update_0[d0, d1] -> level_1[4 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write4 = level_1.level_1_level_1_update_0_write4_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd21 read pattern: { level_2_update_0[d0, d1] -> level_1[5 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write5 = level_1.level_1_level_1_update_0_write5_merged_banks_3.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd22 read pattern: { level_2_update_0[d0, d1] -> level_1[5 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write5 = level_1.level_1_level_1_update_0_write5_merged_banks_3.peek_5();
  return value_level_1_level_1_update_0_write5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd23 read pattern: { level_2_update_0[d0, d1] -> level_1[5 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd24 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write6 = level_1.level_1_level_1_update_0_write6_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd25 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write6 = level_1.level_1_level_1_update_0_write6_merged_banks_6.peek_5();
  return value_level_1_level_1_update_0_write6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd26 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd27 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write6 = level_1.level_1_level_1_update_0_write6_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd28 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write6 = level_1.level_1_level_1_update_0_write6_merged_banks_6.peek_5();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd29 read pattern: { level_2_update_0[d0, d1] -> level_1[6 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write6 = level_1.level_1_level_1_update_0_write6_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd3 read pattern: { level_2_update_0[d0, d1] -> level_1[1 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write1 = level_1.level_1_level_1_update_0_write1_merged_banks_3.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd30 read pattern: { level_2_update_0[d0, d1] -> level_1[7 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write7 = level_1.level_1_level_1_update_0_write7_merged_banks_3.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd31 read pattern: { level_2_update_0[d0, d1] -> level_1[7 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write7 = level_1.level_1_level_1_update_0_write7_merged_banks_3.peek_5();
  return value_level_1_level_1_update_0_write7;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd32 read pattern: { level_2_update_0[d0, d1] -> level_1[7 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd33 read pattern: { level_2_update_0[d0, d1] -> level_1[8 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 8 : 0 <= d0 <= 1 and 0 <= d1 <= 8; level_2_update_0[d0, d1] -> (6 + d0) : d0 = 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write0 = level_1.level_1_level_1_update_0_write0_merged_banks_6.peek_8();
  return value_level_1_level_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd34 read pattern: { level_2_update_0[d0, d1] -> level_1[8 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 8; level_2_update_0[d0, d1] -> (2 + d0) : d0 = 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write0 = level_1.level_1_level_1_update_0_write0_merged_banks_6.peek_4();
  return value_level_1_level_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd35 read pattern: { level_2_update_0[d0, d1] -> level_1[8 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd4 read pattern: { level_2_update_0[d0, d1] -> level_1[1 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write1 = level_1.level_1_level_1_update_0_write1_merged_banks_3.peek_5();
  return value_level_1_level_1_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd5 read pattern: { level_2_update_0[d0, d1] -> level_1[1 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd6 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write2 = level_1.level_1_level_1_update_0_write2_merged_banks_6.peek_9();
  return value_level_1_level_1_update_0_write2;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd7 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 1 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 5 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write2 = level_1.level_1_level_1_update_0_write2_merged_banks_6.peek_5();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd8 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 2 + 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 1 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write2 = level_1.level_1_level_1_update_0_write2_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_2_rd9 read pattern: { level_2_update_0[d0, d1] -> level_1[2 + 8d0, 2d1] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 3] : 0 <= d0 <= 3 and 0 <= d1 <= 18 }
  // DD fold: { level_2_update_0[d0, d1] -> 9 : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  auto value_level_1_level_1_update_0_write2 = level_1.level_1_level_1_update_0_write2_merged_banks_6.peek_9();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd0 read pattern: { level_3_update_0[d0, d1] -> level_2[4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 7 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write0 = level_2.level_2_level_2_update_0_write0_merged_banks_6.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd1 read pattern: { level_3_update_0[d0, d1] -> level_2[4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write0 = level_2.level_2_level_2_update_0_write0_merged_banks_6.peek_4();
  return value_level_2_level_2_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd10 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write2 = level_2.level_2_level_2_update_0_write2_merged_banks_6.peek_4();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd11 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 1 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd12 read pattern: { level_3_update_0[d0, d1] -> level_2[3 + 4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 7 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write3 = level_2.level_2_level_2_update_0_write3_merged_banks_3.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd13 read pattern: { level_3_update_0[d0, d1] -> level_2[3 + 4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write3 = level_2.level_2_level_2_update_0_write3_merged_banks_3.peek_4();
  return value_level_2_level_2_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd14 read pattern: { level_3_update_0[d0, d1] -> level_2[3 + 4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 1 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd15 read pattern: { level_3_update_0[d0, d1] -> level_2[4 + 4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 6 : d0 = 0 and 0 <= d1 <= 3; level_3_update_0[d0, d1] -> (5 + d0) : d0 = 1 and 0 <= d1 <= 3 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd16 read pattern: { level_3_update_0[d0, d1] -> level_2[4 + 4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 3 : d0 = 0 and 0 <= d1 <= 3; level_3_update_0[d0, d1] -> (2 + d0) : d0 = 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write0 = level_2.level_2_level_2_update_0_write0_merged_banks_6.peek_3();
  return value_level_2_level_2_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd17 read pattern: { level_3_update_0[d0, d1] -> level_2[4 + 4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd2 read pattern: { level_3_update_0[d0, d1] -> level_2[4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 1 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd3 read pattern: { level_3_update_0[d0, d1] -> level_2[1 + 4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 7 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write1 = level_2.level_2_level_2_update_0_write1_merged_banks_3.peek_7();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd4 read pattern: { level_3_update_0[d0, d1] -> level_2[1 + 4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write1 = level_2.level_2_level_2_update_0_write1_merged_banks_3.peek_4();
  return value_level_2_level_2_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd5 read pattern: { level_3_update_0[d0, d1] -> level_2[1 + 4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 1 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd6 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 7 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write2 = level_2.level_2_level_2_update_0_write2_merged_banks_6.peek_7();
  return value_level_2_level_2_update_0_write2;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd7 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 1 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 4 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write2 = level_2.level_2_level_2_update_0_write2_merged_banks_6.peek_4();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd8 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 2 + 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 1 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write2 = level_2.level_2_level_2_update_0_write2_merged_banks_6.peek_1();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // level_3_rd9 read pattern: { level_3_update_0[d0, d1] -> level_2[2 + 4d0, 2d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 4] : 0 <= d0 <= 2 and 0 <= d1 <= 8 }
  // DD fold: { level_3_update_0[d0, d1] -> 7 : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  auto value_level_2_level_2_update_0_write2 = level_2.level_2_level_2_update_0_write2_merged_banks_6.peek_7();
...
inline hw_uint<16> gp_32_rd0_select(level_3_cache& level_3, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_32_rd0 read pattern: { gp_32_update_0[d0, d1] -> level_3[2d0, d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { gp_32_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 6] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // DD fold: {  }
...
inline hw_uint<16> gp_32_rd1_select(level_3_cache& level_3, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_32_rd1 read pattern: { gp_32_update_0[d0, d1] -> level_3[1 + 2d0, d1] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Read schedule : { gp_32_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 6] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // Write schedule: { level_3_update_0[d0, d1] -> [30 + 16d1, 4 + d0, 5] : 0 <= d0 <= 1 and 0 <= d1 <= 3 }
  // DD fold: {  }
...
//	gp_32_rd0
//	gp_32_rd1
inline hw_uint<32> level_3_gp_32_update_0_read_bundle_read(level_3_cache& level_3, int d0, int d1) {
  // # of ports in bundle: 2
    // gp_32_rd0
    // gp_32_rd1

	hw_uint<32> result;
	hw_uint<16> gp_32_rd0_res = gp_32_rd0_select(level_3, d0, d1);
	set_at<0, 32>(result, gp_32_rd0_res);
	hw_uint<16> gp_32_rd1_res = gp_32_rd1_select(level_3, d0, d1);
	set_at<16, 32>(result, gp_32_rd1_res);
	return result;
}
...
// Driver function
void gp_32_opt(HWStream<hw_uint<512> >& /* get_args num ports = 32 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */gp_32, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("gp_32_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    // gp_32_update_0 -> [1*d1*1*16 + 1*30,1*d0*1*1 + 1*4,1*6]
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((0 <= c1 && c1 <= 5) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 78) && ((c0 - 0) % 1 == 0)) {
	in_update_0(in_off_chip, in, (c1 - 0) / 1, (c0 - 0) / 1);
	    }
	
	    if ((1 <= c1 && c1 <= 5) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 78) && ((c0 - 2) % 2 == 0)) {
	level_0_update_0(in, level_0, (c1 - 1) / 1, (c0 - 2) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 5) && ((c1 - 2) % 1 == 0) && (6 <= c0 && c0 <= 78) && ((c0 - 6) % 4 == 0)) {
	level_1_update_0(level_0, level_1, (c1 - 2) / 1, (c0 - 6) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 5) && ((c1 - 3) % 1 == 0) && (14 <= c0 && c0 <= 78) && ((c0 - 14) % 8 == 0)) {
	level_2_update_0(level_1, level_2, (c1 - 3) / 1, (c0 - 14) / 8);
	    }
	
	    if ((4 <= c1 && c1 <= 5) && ((c1 - 4) % 1 == 0) && (30 <= c0 && c0 <= 78) && ((c0 - 30) % 16 == 0)) {
	level_3_update_0(level_2, level_3, (c1 - 4) / 1, (c0 - 30) / 16);
	    }
	
	    if ((4 <= c1 && c1 <= 5) && ((c1 - 4) % 1 == 0) && (30 <= c0 && c0 <= 78) && ((c0 - 30) % 16 == 0)) {
	gp_32_update_0(level_3, gp_32, (c1 - 4) / 1, (c0 - 30) / 16);
	    }
...
void gp_32_opt(HWStream<hw_uint<512> >& /* get_args num ports = 32 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */gp_32) {
  ...
  gp_32_opt(in_off_chip, gp_32, 1);
}
#ifdef __VIVADO_SYNTH__
#include "gp_32_opt.h"

const int gp_32_update_0_write_num_transfers = 8;
const int in_update_0_read_num_transfers = 474;
...
static void write_gp_32_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  int num_transfers = gp_32_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void gp_32_opt_accel(hw_uint<512>* in_update_0_read, hw_uint<32>* gp_32_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp_32_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = gp_32_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<512> > in_update_0_read_channel;
  static HWStream<hw_uint<32> > gp_32_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  gp_32_opt(in_update_0_read_channel, gp_32_update_0_write_channel, size);

  write_gp_32_update_0_write(gp_32_update_0_write, gp_32_update_0_write_channel, size);
}
