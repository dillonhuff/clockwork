#include <fstream>
#include "jac_d_32_opt.h"

int main() {
  srand(234);
  ofstream fout("regression_result_jac_d_32_opt.txt");
  HWStream<hw_uint<16 > > in_off_chip;
  HWStream<hw_uint<16 > > jac_d_32;
  ...
  jac_d_32_opt(in_off_chip, jac_d_32);
  for (int i = 0; i < 1166400; i++) {
    auto actual = jac_d_32.read();
