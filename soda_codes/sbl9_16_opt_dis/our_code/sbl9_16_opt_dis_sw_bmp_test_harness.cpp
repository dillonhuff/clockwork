...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > sbl9_16_1_merged455_write_channel;
  // In lanes = 16
  ...
  sbl9_16_opt_dis(img_1_merged446_read_channel, sbl9_16_1_merged455_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = sbl9_16_1_merged455_write_channel.read();
  ...
  output.save_image("./images/sbl9_16_opt_dis_bmp_out.bmp");
}
