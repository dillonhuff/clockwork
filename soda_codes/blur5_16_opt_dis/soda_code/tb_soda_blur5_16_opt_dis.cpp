// AUTO GEN SODA TB
#include "blur5_16_opt_dis_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  blur5_16_opt_dis_kernel(blur5_16, input_arg, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_blur5_16_opt_dis_regression_result.csv", blur5_16, nrows, ncols, transfer_cols);
  free(input_arg);
  free(blur5_16);
}
