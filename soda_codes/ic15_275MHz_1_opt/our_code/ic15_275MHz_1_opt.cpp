...
// compute file: ic15_275MHz_1_opt_compute_units.h
#include "ic15_275MHz_1_opt_compute_units.h"
...
struct stg14_stg14_update_0_write0_to_ic15_275MHz_1_rd0_cache {
...
struct stg14_cache {
  // # of banks: 1
  stg14_stg14_update_0_write0_to_ic15_275MHz_1_rd0_cache stg14_stg14_update_0_write0_to_ic15_275MHz_1_rd0;
};
...
inline void stg14_stg14_update_0_write0_write(hw_uint<16>& stg14_stg14_update_0_write0, stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  stg14.stg14_stg14_update_0_write0_to_ic15_275MHz_1_rd0.push(stg14_stg14_update_0_write0);
}

inline hw_uint<16> ic15_275MHz_1_rd0_select(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ic15_275MHz_1_rd0 read pattern: { ic15_275MHz_1_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ic15_275MHz_1_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg14_stg14_update_0_write0 = stg14.stg14_stg14_update_0_write0_to_ic15_275MHz_1_rd0.peek(/* one reader or all rams */ 0);
  return value_stg14_stg14_update_0_write0;
  return 0;
}

// # of bundles = 2
// ic15_275MHz_1_update_0_read
//	ic15_275MHz_1_rd0
inline hw_uint<16> stg14_ic15_275MHz_1_update_0_read_bundle_read(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ic15_275MHz_1_rd0

	hw_uint<16> result;
	hw_uint<16> ic15_275MHz_1_rd0_res = ic15_275MHz_1_rd0_select(stg14, d0, d1, dynamic_address);
	set_at<0, 16>(result, ic15_275MHz_1_rd0_res);
	return result;
}
...
inline void ic15_275MHz_1_update_0(stg14_cache& stg14, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ic15_275MHz_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg14
	auto stg14_0_c__0_value = stg14_ic15_275MHz_1_update_0_read_bundle_read(stg14/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = ic15_275MHz_1_generated_compute_unrolled_1(stg14_0_c__0_value);
	// Produce: ic15_275MHz_1
	ic15_275MHz_1.write(compute_result);
...
// Driver function
void ic15_275MHz_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ic15_275MHz_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ic15_275MHz_1_opt_debug.csv");
...
// schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086; stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085; stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082; stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080; stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088; stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084; stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090; ic15_275MHz_1_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091; stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087; stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083; stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089; stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093; stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081; stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092; in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094; stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
//   { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for stg7_update_0(((-9 + i2 == 0) && (-1 + i1 >= 0) && (1934 - i1 >= 0) && (-8 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
// Condition for stg8_update_0(((-10 + i2 == 0) && (-3 + i1 >= 0) && (1934 - i1 >= 0) && (-9 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
// Condition for stg11_update_0(((-13 + i2 == 0) && (-9 + i1 >= 0) && (1934 - i1 >= 0) && (-12 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
// Condition for stg13_update_0(((-15 + i2 == 0) && (-13 + i1 >= 0) && (1934 - i1 >= 0) && (-14 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
// Condition for stg5_update_0(((-7 + i2 == 0) && (3 + i1 >= 0) && (1934 - i1 >= 0) && (-6 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for stg9_update_0(((-11 + i2 == 0) && (-5 + i1 >= 0) && (1934 - i1 >= 0) && (-10 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
// Condition for stg3_update_0(((-5 + i2 == 0) && (7 + i1 >= 0) && (1934 - i1 >= 0) && (-4 + i0 >= 0) && (1094 - i0 >= 0)))
//   { ic15_275MHz_1_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ic15_275MHz_1_update_0(((-17 + i2 == 0) && (-15 + i1 >= 0) && (1934 - i1 >= 0) && (-15 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
// Condition for stg2_update_0(((-4 + i2 == 0) && (9 + i1 >= 0) && (1934 - i1 >= 0) && (-3 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
// Condition for stg6_update_0(((-8 + i2 == 0) && (1 + i1 >= 0) && (1934 - i1 >= 0) && (-7 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
// Condition for stg10_update_0(((-12 + i2 == 0) && (-7 + i1 >= 0) && (1934 - i1 >= 0) && (-11 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
// Condition for stg4_update_0(((-6 + i2 == 0) && (5 + i1 >= 0) && (1934 - i1 >= 0) && (-5 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
// Condition for stg0_update_0(((-2 + i2 == 0) && (13 + i1 >= 0) && (1934 - i1 >= 0) && (-1 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
// Condition for stg12_update_0(((-14 + i2 == 0) && (-11 + i1 >= 0) && (1934 - i1 >= 0) && (-13 + i0 >= 0) && (1094 - i0 >= 0)))
//   { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
// Condition for stg1_update_0(((-3 + i2 == 0) && (11 + i1 >= 0) && (1934 - i1 >= 0) && (-2 + i0 >= 0) && (1094 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
// Condition for in_update_0(((-1 + i2 == 0) && (15 + i1 >= 0) && (1934 - i1 >= 0) && (i0 >= 0) && (1094 - i0 >= 0)))
//   { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for stg14_update_0(((-16 + i2 == 0) && (-15 + i1 >= 0) && (1934 - i1 >= 0) && (-15 + i0 >= 0) && (1094 - i0 >= 0)))

  /*
  // Schedules...
    // ic15_275MHz_1_update_0 -> [1*d1*1*1 + 1*15,1*d0*1*1 + 1*15,1*17]
...
#pragma HLS pipeline II=1
    ...
    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
      ic15_275MHz_1_update_0((c1 - 15) / 1, (c0 - 15) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
	      ic15_275MHz_1_update_0(stg14 /* buf name */, ic15_275MHz_1, (c1 - 15) / 1, (c0 - 15) / 1);
	    }
...
void ic15_275MHz_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ic15_275MHz_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ic15_275MHz_1_opt(in_off_chip, ic15_275MHz_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ic15_275MHz_1_update_0[root = 0, ic15_275MHz_1_0, ic15_275MHz_1_1] -> ic15_275MHz_1[0, 0] : 0 <= ic15_275MHz_1_0 <= 1919 and 0 <= ic15_275MHz_1_1 <= 1079 }
const int ic15_275MHz_1_update_0_write_pipe0_num_transfers = 2073600;
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : -15 <= in_0 <= 1934 and 0 <= in_1 <= 1094 }
const int in_update_0_read_pipe0_num_transfers = 2135250;


extern "C" {

void ic15_275MHz_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ic15_275MHz_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ic15_275MHz_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ic15_275MHz_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ic15_275MHz_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ic15_275MHz_1_opt_wrapper(in_update_0_read_pipe0_channel, ic15_275MHz_1_update_0_write_pipe0_channel, size);

  burst_write<16>(ic15_275MHz_1_update_0_write_pipe0, ic15_275MHz_1_update_0_write_pipe0_channel, ic15_275MHz_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ic15_275MHz_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ic15_275MHz_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ic15_275MHz_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ic15_275MHz_1_opt(in_update_0_read_pipe0, ic15_275MHz_1_update_0_write_pipe0);
