// AUTO GEN SODA TB
#include "pyr_blnd2048c_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  pyr_blnd2048c_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_pyr_blnd2048c_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
