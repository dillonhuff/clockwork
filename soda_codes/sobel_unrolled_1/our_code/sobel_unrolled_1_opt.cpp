...
inline hw_uint<16> sobel_unrolled_1_rd0_select(mag_x_cache& mag_x, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
...
inline hw_uint<16> mag_x_sobel_unrolled_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1) {
  // # of ports in bundle: 1
    // sobel_unrolled_1_rd0

	hw_uint<16> result;
	hw_uint<16> sobel_unrolled_1_rd0_res = sobel_unrolled_1_rd0_select(mag_x, d0, d1);
	set_at<0, 16>(result, sobel_unrolled_1_rd0_res);
	return result;
}
...
inline hw_uint<16> sobel_unrolled_1_rd0_select(mag_y_cache& mag_y, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
...
// sobel_unrolled_1_update_0_read
//	sobel_unrolled_1_rd0
inline hw_uint<16> mag_y_sobel_unrolled_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1) {
  // # of ports in bundle: 1
    // sobel_unrolled_1_rd0

	hw_uint<16> result;
	hw_uint<16> sobel_unrolled_1_rd0_res = sobel_unrolled_1_rd0_select(mag_y, d0, d1);
	set_at<0, 16>(result, sobel_unrolled_1_rd0_res);
	return result;
}
...
inline void sobel_unrolled_1_update_0(mag_x_cache& mag_x, mag_y_cache& mag_y, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sobel_unrolled_1, int d0, int d1) {
	// Consume: mag_x
...
// Driver function
void sobel_unrolled_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sobel_unrolled_1) {
...
#pragma HLS dependence variable=mag_y inter false
	...
	sobel_unrolled_1_update_0(mag_x, mag_y, sobel_unrolled_1, c1 - 1, c0 - 1);
	    }
	  }
