...
int main() {
  ...
  for (int i = 0; i < 132004; i++) {
    hw_uint<512> in_val;
    in_pix << 16*i + 0 << endl;
    set_at<0*32, 512>(in_val, 16*i + 0);
    in_pix << 16*i + 1 << endl;
    set_at<1*32, 512>(in_val, 16*i + 1);
    in_pix << 16*i + 2 << endl;
    set_at<2*32, 512>(in_val, 16*i + 2);
    in_pix << 16*i + 3 << endl;
    set_at<3*32, 512>(in_val, 16*i + 3);
    in_pix << 16*i + 4 << endl;
    set_at<4*32, 512>(in_val, 16*i + 4);
    in_pix << 16*i + 5 << endl;
    set_at<5*32, 512>(in_val, 16*i + 5);
    in_pix << 16*i + 6 << endl;
    set_at<6*32, 512>(in_val, 16*i + 6);
    in_pix << 16*i + 7 << endl;
    set_at<7*32, 512>(in_val, 16*i + 7);
    in_pix << 16*i + 8 << endl;
    set_at<8*32, 512>(in_val, 16*i + 8);
    in_pix << 16*i + 9 << endl;
    set_at<9*32, 512>(in_val, 16*i + 9);
    in_pix << 16*i + 10 << endl;
    set_at<10*32, 512>(in_val, 16*i + 10);
    in_pix << 16*i + 11 << endl;
    set_at<11*32, 512>(in_val, 16*i + 11);
    in_pix << 16*i + 12 << endl;
    set_at<12*32, 512>(in_val, 16*i + 12);
    in_pix << 16*i + 13 << endl;
    set_at<13*32, 512>(in_val, 16*i + 13);
    in_pix << 16*i + 14 << endl;
    set_at<14*32, 512>(in_val, 16*i + 14);
    in_pix << 16*i + 15 << endl;
    set_at<15*32, 512>(in_val, 16*i + 15);
