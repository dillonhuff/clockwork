#include <fstream>
#include "psef23_8_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_psef23_8_opt.txt");
  ofstream fout("regression_result_psef23_8_opt.txt");
  HWStream<hw_uint<128> > in_update_0_read;
  HWStream<hw_uint<128> > psef23_8_update_0_write;
  ...
  psef23_8_opt(in_update_0_read, psef23_8_update_0_write);

  for (int i = 0; i < 259200; i++) {
    hw_uint<128> actual = psef23_8_update_0_write.read();
