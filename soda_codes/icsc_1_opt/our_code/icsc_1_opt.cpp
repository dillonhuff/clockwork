...
struct in_in_update_0_write0_to_icsc_1_rd0_cache {
...
struct in_cache {
  // # of banks: 1
  in_in_update_0_write0_to_icsc_1_rd0_cache in_in_update_0_write0_to_icsc_1_rd0;
};



inline void in_in_update_0_write0_write(hw_uint<16>& in_in_update_0_write0, in_cache& in, int d0, int d1, int dynamic_address) {
  in.in_in_update_0_write0_to_icsc_1_rd0.push(in_in_update_0_write0);
}

inline hw_uint<16> icsc_1_rd0_select(in_cache& in, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // icsc_1_rd0 read pattern: { icsc_1_update_0[d0, d1] -> in[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { icsc_1_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_to_icsc_1_rd0.peek(/* one reader or all rams */ 0);
...
//	icsc_1_rd0
inline hw_uint<16> in_icsc_1_update_0_read_bundle_read(in_cache& in, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // icsc_1_rd0

	hw_uint<16> result;
	hw_uint<16> icsc_1_rd0_res = icsc_1_rd0_select(in, d0, d1, dynamic_address);
...
inline void icsc_1_update_0(in_cache& in, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */icsc_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: in
	auto in_0_c__0_value = in_icsc_1_update_0_read_bundle_read(in/* source_delay */, d0, d1, 0);
...
// schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; icsc_1_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
//   { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for in_update_0(((-1 + i2 == 0) && (i1 >= 0) && (1919 - i1 >= 0) && (i0 >= 0) && (1079 - i0 >= 0)))
//   { icsc_1_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for icsc_1_update_0(((-2 + i2 == 0) && (i1 >= 0) && (1919 - i1 >= 0) && (i0 >= 0) && (1079 - i0 >= 0)))

  /*
  // Schedules...
    // icsc_1_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*2]
...
#pragma HLS pipeline II=1
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((0 <= c1 && c1 <= 1919) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 1079) && ((c0 - 0) % 1 == 0)) {
	      icsc_1_update_0(in /* buf name */, icsc_1, (c1 - 0) / 1, (c0 - 0) / 1);
	    }
