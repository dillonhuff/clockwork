...
hw_uint<16> icsc_1_generated_compute(hw_uint<16*1> in) {
...
hw_uint<16>  icsc_1_generated_compute_unrolled_1(hw_uint<16>& in) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_in;
  set_at<0, 16, 16>(lane_0_in, in.extract<0, 15>());
  auto result_0 = icsc_1_generated_compute(lane_0_in);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
