...
hw_uint<32> heat3d_1_1_generated_compute(hw_uint<32*1> h3_0) {
...
hw_uint<32>  h3_0_generated_compute_unrolled_1(hw_uint<224>& in_cc) {
  ...
  // heat3d_1_1_update_0 unroll factor: 1
hw_uint<32>  heat3d_1_1_generated_compute_unrolled_1(hw_uint<32>& h3_0) {
  hw_uint<32> whole_result;

  hw_uint<32> lane_0_h3_0;
  set_at<0, 32, 32>(lane_0_h3_0, h3_0.extract<0, 31>());
  auto result_0 = heat3d_1_1_generated_compute(lane_0_h3_0);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
