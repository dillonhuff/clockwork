...
int main() {
  ...
  // Loading input data
  // cmap    : { raw_update_0[root = 0, raw_0, raw_1] -> raw_oc[0, 0] : 0 <= raw_0 <= 103 and 0 <= raw_1 <= 103 }
  // read map: { raw_oc[0, 0] -> raw_update_0[root = 0, raw_0, raw_1] : 0 <= raw_0 <= 103 and 0 <= raw_1 <= 103 }
  // rng     : { raw_update_0[root = 0, raw_0, raw_1] : 0 <= raw_0 <= 103 and 0 <= raw_1 <= 103 }
