...
int main() {
  ...
  // Loading input data
  // cmap    : { raw_update_0[root = 0, raw_0, raw_1] -> raw_oc[0, 0] : -3 <= raw_0 <= 1924 and -3 <= raw_1 <= 34 }
  // read map: { raw_oc[0, 0] -> raw_update_0[root = 0, raw_0, raw_1] : -3 <= raw_0 <= 1924 and -3 <= raw_1 <= 34 }
  // rng     : { raw_update_0[root = 0, raw_0, raw_1] : -3 <= raw_0 <= 1924 and -3 <= raw_1 <= 34 }
  for (int i = 0; i < 73264; i++) {
    hw_uint<16> in_val;
