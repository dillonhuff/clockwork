...
int main(int argc, char **argv) {
  ...
  const int camera_mini_update_0_write_DATA_SIZE = num_epochs*1970176;
  ...
  const int raw_update_0_read_DATA_SIZE = num_epochs*1970176;
  ...
  uint64_t transfer_size = num_epochs*(1970176 / 1);
