...
hw_uint<16> harris_mini_generated_compute(hw_uint<16*1> det, hw_uint<16*1> trace) {
...
hw_uint<16>  harris_mini_generated_compute_unrolled_1(hw_uint<16>& det, hw_uint<16>& trace) {
  hw_uint<16> whole_result;
