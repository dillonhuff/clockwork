...
inline hw_uint<16> harris_mini_rd0_select(det_cache& det, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // harris_mini_rd0 read pattern: { harris_mini_update_0[d0, d1] -> det[d0, d1] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Read schedule : { harris_mini_update_0[d0, d1] -> [3 + d1, 3 + d0, 15] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { det_update_0[d0, d1] -> [3 + d1, 3 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
//	harris_mini_rd0
inline hw_uint<16> det_harris_mini_update_0_read_bundle_read(det_cache& det, int d0, int d1) {
  // # of ports in bundle: 1
    // harris_mini_rd0

	hw_uint<16> result;
	hw_uint<16> harris_mini_rd0_res = harris_mini_rd0_select(det, d0, d1);
	set_at<0, 16>(result, harris_mini_rd0_res);
	return result;
}
...
inline hw_uint<16> lxx_rd0_select(grad_x_cache& grad_x, int d0, int d1) {
  ...
  // Read schedule : { lxx_update_0[d0, d1] -> [1 + d1, 1 + d0, 6] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // DD fold: {  }
...
inline hw_uint<16> lxy_rd0_select(grad_x_cache& grad_x, int d0, int d1) {
  ...
  // Read schedule : { lxy_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // DD fold: {  }
  auto value_grad_x_grad_x_update_0_write0 = grad_x.grad_x_grad_x_update_0_write0_merged_banks_2.peek_0();
  return value_grad_x_grad_x_update_0_write0;
...
inline hw_uint<16> lxy_rd0_select(grad_y_cache& grad_y, int d0, int d1) {
  ...
  // Read schedule : { lxy_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // DD fold: {  }
...
inline hw_uint<16> lyy_rd0_select(grad_y_cache& grad_y, int d0, int d1) {
  ...
  // Read schedule : { lyy_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // DD fold: {  }
  auto value_grad_y_grad_y_update_0_write0 = grad_y.grad_y_grad_y_update_0_write0_merged_banks_2.peek_0();
  return value_grad_y_grad_y_update_0_write0;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd0 read pattern: { grad_x_update_0[d0, d1] -> img[-1 + d0, -1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_x_update_0[d0, d1] -> 74 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd1 read pattern: { grad_x_update_0[d0, d1] -> img[-1 + d0, d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_x_update_0[d0, d1] -> 38 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd2 read pattern: { grad_x_update_0[d0, d1] -> img[-1 + d0, 1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_x_update_0[d0, d1] -> 2 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd3 read pattern: { grad_x_update_0[d0, d1] -> img[1 + d0, -1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_x_update_0[d0, d1] -> 72 : 0 <= d0 <= 32 and 0 <= d1 <= 33; grad_x_update_0[d0, d1] -> (39 + d0) : d0 = 33 and 0 <= d1 <= 33 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd4 read pattern: { grad_x_update_0[d0, d1] -> img[1 + d0, d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_x_rd5 read pattern: { grad_x_update_0[d0, d1] -> img[1 + d0, 1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_rd0 read pattern: { grad_y_update_0[d0, d1] -> img[-1 + d0, -1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_y_update_0[d0, d1] -> 74 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_merged_banks_12.peek_74();
  return value_img_img_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
inline hw_uint<16> grad_y_rd1_select(img_cache& img, int d0, int d1) {
  ...
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_y_update_0[d0, d1] -> 2 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_merged_banks_12.peek_2();
  return value_img_img_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_rd2 read pattern: { grad_y_update_0[d0, d1] -> img[d0, -1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: { grad_y_update_0[d0, d1] -> 73 : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_rd3 read pattern: { grad_y_update_0[d0, d1] -> img[d0, 1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_rd4 read pattern: { grad_y_update_0[d0, d1] -> img[1 + d0, -1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // grad_y_rd5 read pattern: { grad_y_update_0[d0, d1] -> img[1 + d0, 1 + d1] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Read schedule : { grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
  // Write schedule: { img_update_0[d0, d1] -> [d1, d0, 1] : -1 <= d0 <= 34 and -1 <= d1 <= 34 }
  // DD fold: {  }
  auto value_img_img_update_0_write0 = img.img_img_update_0_write0_merged_banks_12.peek_0();
...
inline hw_uint<16> lgxx8_rd0_select(lgxx_cache& lgxx, int d0, int d1) {
  ...
  // Read schedule : { lgxx8_update_0[d0, d1] -> [3 + d1, 3 + d0, 12] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgxx_update_0[d0, d1] -> [3 + d1, 3 + d0, 9] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> det_rd0_select(lgxx8_cache& lgxx8, int d0, int d1) {
  ...
  // Read schedule : { det_update_0[d0, d1] -> [3 + d1, 3 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgxx8_update_0[d0, d1] -> [3 + d1, 3 + d0, 12] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> trace_rd0_select(lgxx8_cache& lgxx8, int d0, int d1) {
  ...
  // Read schedule : { trace_update_0[d0, d1] -> [3 + d1, 3 + d0, 14] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgxx8_update_0[d0, d1] -> [3 + d1, 3 + d0, 12] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
  auto value_lgxx8_lgxx8_update_0_write0 = lgxx8.lgxx8_lgxx8_update_0_write0_merged_banks_2.peek_0();
  return value_lgxx8_lgxx8_update_0_write0;
...
inline hw_uint<16> lgxy8_rd0_select(lgxy_cache& lgxy, int d0, int d1) {
  ...
  // Read schedule : { lgxy8_update_0[d0, d1] -> [3 + d1, 3 + d0, 11] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgxy_update_0[d0, d1] -> [3 + d1, 3 + d0, 8] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> det_rd0_select(lgxy8_cache& lgxy8, int d0, int d1) {
  ...
  // Read schedule : { det_update_0[d0, d1] -> [3 + d1, 3 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgxy8_update_0[d0, d1] -> [3 + d1, 3 + d0, 11] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> lgyy8_rd0_select(lgyy_cache& lgyy, int d0, int d1) {
  ...
  // Read schedule : { lgyy8_update_0[d0, d1] -> [3 + d1, 3 + d0, 10] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgyy_update_0[d0, d1] -> [3 + d1, 3 + d0, 7] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> det_rd0_select(lgyy8_cache& lgyy8, int d0, int d1) {
  ...
  // Read schedule : { det_update_0[d0, d1] -> [3 + d1, 3 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lgyy8_update_0[d0, d1] -> [3 + d1, 3 + d0, 10] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
inline hw_uint<16> lgxx_rd0_select(lxx_cache& lxx, int d0, int d1) {
  ...
  // Read schedule : { lgxx_update_0[d0, d1] -> [3 + d1, 3 + d0, 9] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lxx_update_0[d0, d1] -> [1 + d1, 1 + d0, 6] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
inline hw_uint<16> lgxy_rd0_select(lxy_cache& lxy, int d0, int d1) {
  ...
  // Read schedule : { lgxy_update_0[d0, d1] -> [3 + d1, 3 + d0, 8] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lxy_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
inline hw_uint<16> lgyy_rd0_select(lyy_cache& lyy, int d0, int d1) {
  ...
  // Read schedule : { lgyy_update_0[d0, d1] -> [3 + d1, 3 + d0, 7] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { lyy_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 33 and 0 <= d1 <= 33 }
...
inline hw_uint<16> harris_mini_rd0_select(trace_cache& trace, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // harris_mini_rd0 read pattern: { harris_mini_update_0[d0, d1] -> trace[d0, d1] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Read schedule : { harris_mini_update_0[d0, d1] -> [3 + d1, 3 + d0, 15] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // Write schedule: { trace_update_0[d0, d1] -> [3 + d1, 3 + d0, 14] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
  // DD fold: {  }
...
// harris_mini_update_0_read
//	harris_mini_rd0
inline hw_uint<16> trace_harris_mini_update_0_read_bundle_read(trace_cache& trace, int d0, int d1) {
  // # of ports in bundle: 1
    // harris_mini_rd0

	hw_uint<16> result;
	hw_uint<16> harris_mini_rd0_res = harris_mini_rd0_select(trace, d0, d1);
	set_at<0, 16>(result, harris_mini_rd0_res);
	return result;
}
...
inline void harris_mini_update_0(det_cache& det, trace_cache& trace, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */harris_mini, int d0, int d1) {
	// Consume: det
...
// Driver function
void harris_mini_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */harris_mini) {
  ...
  trace_cache trace;
	...
	for (int c0 = -1; c0 <= 34; c0++) {
	  for (int c1 = -1; c1 <= 34; c1++) {
	
	#ifdef __VIVADO_SYNTH__
	#pragma HLS pipeline II=1
	#endif // __VIVADO_SYNTH__
	
	    if ((-1 <= c1 && c1 <= 34) && ((c1 - 0) % 1 == 0) && (-1 <= c0 && c0 <= 34) && ((c0 - 0) % 1 == 0)) {
	img_update_0(img_oc, img, (c1 - 0) / 1, (c0 - 0) / 1);
	    }
	
	    if ((1 <= c1 && c1 <= 34) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 34) && ((c0 - 1) % 1 == 0)) {
	...
	lxx_update_0(grad_x, lxx, (c1 - 1) / 1, (c0 - 1) / 1);
	    ...
	    if ((3 <= c1 && c1 <= 34) && ((c1 - 3) % 1 == 0) && (3 <= c0 && c0 <= 34) && ((c0 - 3) % 1 == 0)) {
	...
	trace_update_0(lgxx8, lgyy8, trace, (c1 - 3) / 1, (c0 - 3) / 1);
	    ...
	    if ((3 <= c1 && c1 <= 34) && ((c1 - 3) % 1 == 0) && (3 <= c0 && c0 <= 34) && ((c0 - 3) % 1 == 0)) {
	harris_mini_update_0(det, trace, harris_mini, (c1 - 3) / 1, (c0 - 3) / 1);
	    }
...
void harris_mini_opt_accel(hw_uint<16>* img_update_0_read, hw_uint<16>* harris_mini_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > harris_mini_update_0_write_channel;
