...
// compute file: harris_mini_opt_compute_units.h
#include "harris_mini_opt_compute_units.h"

#include "hw_classes.h"

struct det_det_update_0_write0_to_harris_mini_rd0_cache {
	// RAM Box: {[0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct det_cache {
  // # of banks: 1
  det_det_update_0_write0_to_harris_mini_rd0_cache det_det_update_0_write0_to_harris_mini_rd0;
};



inline void det_det_update_0_write0_write(hw_uint<32> & det_det_update_0_write0, det_cache& det, int d0, int d1, int dynamic_address) {
  det.det_det_update_0_write0_to_harris_mini_rd0.push(det_det_update_0_write0);
}

inline hw_uint<32>  harris_mini_rd0_select(det_cache& det, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_det_det_update_0_write0 = det.det_det_update_0_write0_to_harris_mini_rd0.peek(/* one reader or all rams */ 0);
...
inline void det_det_update_0_write_bundle_write(hw_uint<32>& det_update_0_write, det_cache& det, int d0, int d1, int dynamic_address) {
...
// harris_mini_update_0_read
//	harris_mini_rd0
inline hw_uint<32> det_harris_mini_update_0_read_bundle_read(det_cache& det, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // harris_mini_rd0

	hw_uint<32> result;
	hw_uint<32>  harris_mini_rd0_res = harris_mini_rd0_select(det, d0, d1, dynamic_address);
	set_at<0, 32>(result, harris_mini_rd0_res);
	return result;
}
...
inline void grad_x_grad_x_update_0_write0_write(hw_uint<32> & grad_x_grad_x_update_0_write0, grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  grad_x.grad_x_grad_x_update_0_write0_merged_banks_2.push(grad_x_grad_x_update_0_write0);
}

inline hw_uint<32>  lxx_rd0_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lxy_rd0_select(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// lxx_update_0_read
//	lxx_rd0
inline hw_uint<32> grad_x_lxx_update_0_read_bundle_read(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lxx_rd0

	hw_uint<32> result;
	hw_uint<32>  lxx_rd0_res = lxx_rd0_select(grad_x, d0, d1, dynamic_address);
	set_at<0, 32>(result, lxx_rd0_res);
	return result;
}

// lxy_update_0_read
//	lxy_rd0
inline hw_uint<32> grad_x_lxy_update_0_read_bundle_read(grad_x_cache& grad_x, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lxy_rd0

	hw_uint<32> result;
	hw_uint<32>  lxy_rd0_res = lxy_rd0_select(grad_x, d0, d1, dynamic_address);
	set_at<0, 32>(result, lxy_rd0_res);
	return result;
}
...
inline void grad_y_grad_y_update_0_write0_write(hw_uint<32> & grad_y_grad_y_update_0_write0, grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
  grad_y.grad_y_grad_y_update_0_write0_merged_banks_2.push(grad_y_grad_y_update_0_write0);
}

inline hw_uint<32>  lxy_rd0_select(grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lyy_rd0_select(grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline void grad_y_grad_y_update_0_write_bundle_write(hw_uint<32>& grad_y_update_0_write, grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
...
// lxy_update_0_read
//	lxy_rd0
inline hw_uint<32> grad_y_lxy_update_0_read_bundle_read(grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lxy_rd0

	hw_uint<32> result;
	hw_uint<32>  lxy_rd0_res = lxy_rd0_select(grad_y, d0, d1, dynamic_address);
	set_at<0, 32>(result, lxy_rd0_res);
	return result;
}
...
// lyy_update_0_read
//	lyy_rd0
inline hw_uint<32> grad_y_lyy_update_0_read_bundle_read(grad_y_cache& grad_y, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lyy_rd0

	hw_uint<32> result;
	hw_uint<32>  lyy_rd0_res = lyy_rd0_select(grad_y, d0, d1, dynamic_address);
	set_at<0, 32>(result, lyy_rd0_res);
	return result;
}
...
inline hw_uint<32>  grad_x_rd0_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_x_rd1_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_x_rd2_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_x_rd3_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_x_rd4_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_x_rd5_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd0_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd1_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd2_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd3_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd4_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  grad_y_rd5_select(img_cache& img, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//	grad_x_rd4
//	grad_x_rd5
inline hw_uint<192> img_grad_x_update_0_read_bundle_read(img_cache& img, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 6
	...
	hw_uint<192> result;
	hw_uint<32>  grad_x_rd0_res = grad_x_rd0_select(img, d0, d1, dynamic_address);
	set_at<0, 192>(result, grad_x_rd0_res);
	hw_uint<32>  grad_x_rd1_res = grad_x_rd1_select(img, d0, d1, dynamic_address);
	set_at<32, 192>(result, grad_x_rd1_res);
	hw_uint<32>  grad_x_rd2_res = grad_x_rd2_select(img, d0, d1, dynamic_address);
	set_at<64, 192>(result, grad_x_rd2_res);
	hw_uint<32>  grad_x_rd3_res = grad_x_rd3_select(img, d0, d1, dynamic_address);
	set_at<96, 192>(result, grad_x_rd3_res);
	hw_uint<32>  grad_x_rd4_res = grad_x_rd4_select(img, d0, d1, dynamic_address);
	set_at<128, 192>(result, grad_x_rd4_res);
	hw_uint<32>  grad_x_rd5_res = grad_x_rd5_select(img, d0, d1, dynamic_address);
	set_at<160, 192>(result, grad_x_rd5_res);
	return result;
}
...
//	grad_y_rd4
//	grad_y_rd5
inline hw_uint<192> img_grad_y_update_0_read_bundle_read(img_cache& img, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 6
    // grad_y_rd0
    // grad_y_rd1
    // grad_y_rd2
	...
	hw_uint<192> result;
	hw_uint<32>  grad_y_rd0_res = grad_y_rd0_select(img, d0, d1, dynamic_address);
	set_at<0, 192>(result, grad_y_rd0_res);
	hw_uint<32>  grad_y_rd1_res = grad_y_rd1_select(img, d0, d1, dynamic_address);
	set_at<32, 192>(result, grad_y_rd1_res);
	hw_uint<32>  grad_y_rd2_res = grad_y_rd2_select(img, d0, d1, dynamic_address);
	set_at<64, 192>(result, grad_y_rd2_res);
	hw_uint<32>  grad_y_rd3_res = grad_y_rd3_select(img, d0, d1, dynamic_address);
	set_at<96, 192>(result, grad_y_rd3_res);
	hw_uint<32>  grad_y_rd4_res = grad_y_rd4_select(img, d0, d1, dynamic_address);
	set_at<128, 192>(result, grad_y_rd4_res);
	hw_uint<32>  grad_y_rd5_res = grad_y_rd5_select(img, d0, d1, dynamic_address);
	set_at<160, 192>(result, grad_y_rd5_res);
	return result;
}
...
inline void lgxx_lgxx_update_0_write0_write(hw_uint<32> & lgxx_lgxx_update_0_write0, lgxx_cache& lgxx, int d0, int d1, int dynamic_address) {
  lgxx.lgxx_lgxx_update_0_write0_to_lgxx8_rd0.push(lgxx_lgxx_update_0_write0);
}

inline hw_uint<32>  lgxx8_rd0_select(lgxx_cache& lgxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// lgxx8_update_0_read
//	lgxx8_rd0
inline hw_uint<32> lgxx_lgxx8_update_0_read_bundle_read(lgxx_cache& lgxx, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lgxx8_rd0

	hw_uint<32> result;
	hw_uint<32>  lgxx8_rd0_res = lgxx8_rd0_select(lgxx, d0, d1, dynamic_address);
	set_at<0, 32>(result, lgxx8_rd0_res);
	return result;
}

// lgxx_update_0_write
//	lgxx_lgxx_update_0_write0
inline void lgxx_lgxx_update_0_write_bundle_write(hw_uint<32>& lgxx_update_0_write, lgxx_cache& lgxx, int d0, int d1, int dynamic_address) {
...
inline void lgxx8_lgxx8_update_0_write0_write(hw_uint<32> & lgxx8_lgxx8_update_0_write0, lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
  lgxx8.lgxx8_lgxx8_update_0_write0_merged_banks_2.push(lgxx8_lgxx8_update_0_write0);
}

inline hw_uint<32>  det_rd0_select(lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  trace_rd0_select(lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// det_update_0_read
//	det_rd0
inline hw_uint<32> lgxx8_det_update_0_read_bundle_read(lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // det_rd0

	hw_uint<32> result;
	hw_uint<32>  det_rd0_res = det_rd0_select(lgxx8, d0, d1, dynamic_address);
	set_at<0, 32>(result, det_rd0_res);
	return result;
}

// lgxx8_update_0_write
//	lgxx8_lgxx8_update_0_write0
inline void lgxx8_lgxx8_update_0_write_bundle_write(hw_uint<32>& lgxx8_update_0_write, lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
...
// trace_update_0_read
//	trace_rd0
inline hw_uint<32> lgxx8_trace_update_0_read_bundle_read(lgxx8_cache& lgxx8, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // trace_rd0

	hw_uint<32> result;
	hw_uint<32>  trace_rd0_res = trace_rd0_select(lgxx8, d0, d1, dynamic_address);
	set_at<0, 32>(result, trace_rd0_res);
	return result;
}
...
inline void lgxy_lgxy_update_0_write0_write(hw_uint<32> & lgxy_lgxy_update_0_write0, lgxy_cache& lgxy, int d0, int d1, int dynamic_address) {
  lgxy.lgxy_lgxy_update_0_write0_to_lgxy8_rd0.push(lgxy_lgxy_update_0_write0);
}

inline hw_uint<32>  lgxy8_rd0_select(lgxy_cache& lgxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// lgxy8_update_0_read
//	lgxy8_rd0
inline hw_uint<32> lgxy_lgxy8_update_0_read_bundle_read(lgxy_cache& lgxy, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lgxy8_rd0

	hw_uint<32> result;
	hw_uint<32>  lgxy8_rd0_res = lgxy8_rd0_select(lgxy, d0, d1, dynamic_address);
	set_at<0, 32>(result, lgxy8_rd0_res);
	return result;
}

// lgxy_update_0_write
//	lgxy_lgxy_update_0_write0
inline void lgxy_lgxy_update_0_write_bundle_write(hw_uint<32>& lgxy_update_0_write, lgxy_cache& lgxy, int d0, int d1, int dynamic_address) {
...
inline void lgxy8_lgxy8_update_0_write0_write(hw_uint<32> & lgxy8_lgxy8_update_0_write0, lgxy8_cache& lgxy8, int d0, int d1, int dynamic_address) {
  lgxy8.lgxy8_lgxy8_update_0_write0_to_det_rd0.push(lgxy8_lgxy8_update_0_write0);
}

inline hw_uint<32>  det_rd0_select(lgxy8_cache& lgxy8, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// det_update_0_read
//	det_rd0
inline hw_uint<32> lgxy8_det_update_0_read_bundle_read(lgxy8_cache& lgxy8, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // det_rd0

	hw_uint<32> result;
	hw_uint<32>  det_rd0_res = det_rd0_select(lgxy8, d0, d1, dynamic_address);
	set_at<0, 32>(result, det_rd0_res);
	return result;
}
...
inline void lgxy8_lgxy8_update_0_write_bundle_write(hw_uint<32>& lgxy8_update_0_write, lgxy8_cache& lgxy8, int d0, int d1, int dynamic_address) {
...
inline void lgyy_lgyy_update_0_write0_write(hw_uint<32> & lgyy_lgyy_update_0_write0, lgyy_cache& lgyy, int d0, int d1, int dynamic_address) {
  lgyy.lgyy_lgyy_update_0_write0_to_lgyy8_rd0.push(lgyy_lgyy_update_0_write0);
}

inline hw_uint<32>  lgyy8_rd0_select(lgyy_cache& lgyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// lgyy8_update_0_read
//	lgyy8_rd0
inline hw_uint<32> lgyy_lgyy8_update_0_read_bundle_read(lgyy_cache& lgyy, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // lgyy8_rd0

	hw_uint<32> result;
	hw_uint<32>  lgyy8_rd0_res = lgyy8_rd0_select(lgyy, d0, d1, dynamic_address);
	set_at<0, 32>(result, lgyy8_rd0_res);
	return result;
}

// lgyy_update_0_write
//	lgyy_lgyy_update_0_write0
inline void lgyy_lgyy_update_0_write_bundle_write(hw_uint<32>& lgyy_update_0_write, lgyy_cache& lgyy, int d0, int d1, int dynamic_address) {
...
inline void lgyy8_lgyy8_update_0_write0_write(hw_uint<32> & lgyy8_lgyy8_update_0_write0, lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
  lgyy8.lgyy8_lgyy8_update_0_write0_merged_banks_2.push(lgyy8_lgyy8_update_0_write0);
}

inline hw_uint<32>  det_rd0_select(lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  trace_rd0_select(lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
// det_update_0_read
//	det_rd0
inline hw_uint<32> lgyy8_det_update_0_read_bundle_read(lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // det_rd0

	hw_uint<32> result;
	hw_uint<32>  det_rd0_res = det_rd0_select(lgyy8, d0, d1, dynamic_address);
	set_at<0, 32>(result, det_rd0_res);
	return result;
}
...
inline void lgyy8_lgyy8_update_0_write_bundle_write(hw_uint<32>& lgyy8_update_0_write, lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
...
// trace_update_0_read
//	trace_rd0
inline hw_uint<32> lgyy8_trace_update_0_read_bundle_read(lgyy8_cache& lgyy8, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // trace_rd0

	hw_uint<32> result;
	hw_uint<32>  trace_rd0_res = trace_rd0_select(lgyy8, d0, d1, dynamic_address);
	set_at<0, 32>(result, trace_rd0_res);
	return result;
}
...
inline void lxx_lxx_update_0_write0_write(hw_uint<32> & lxx_lxx_update_0_write0, lxx_cache& lxx, int d0, int d1, int dynamic_address) {
  lxx.lxx_lxx_update_0_write0_merged_banks_9.push(lxx_lxx_update_0_write0);
}

inline hw_uint<32>  lgxx_rd0_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd1_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd2_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd3_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd4_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd5_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd6_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd7_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxx_rd8_select(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//	lgxx_rd7
//	lgxx_rd8
inline hw_uint<288> lxx_lgxx_update_0_read_bundle_read(lxx_cache& lxx, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 9
	...
	hw_uint<288> result;
	hw_uint<32>  lgxx_rd0_res = lgxx_rd0_select(lxx, d0, d1, dynamic_address);
	set_at<0, 288>(result, lgxx_rd0_res);
	hw_uint<32>  lgxx_rd1_res = lgxx_rd1_select(lxx, d0, d1, dynamic_address);
	set_at<32, 288>(result, lgxx_rd1_res);
	hw_uint<32>  lgxx_rd2_res = lgxx_rd2_select(lxx, d0, d1, dynamic_address);
	set_at<64, 288>(result, lgxx_rd2_res);
	hw_uint<32>  lgxx_rd3_res = lgxx_rd3_select(lxx, d0, d1, dynamic_address);
	set_at<96, 288>(result, lgxx_rd3_res);
	hw_uint<32>  lgxx_rd4_res = lgxx_rd4_select(lxx, d0, d1, dynamic_address);
	set_at<128, 288>(result, lgxx_rd4_res);
	hw_uint<32>  lgxx_rd5_res = lgxx_rd5_select(lxx, d0, d1, dynamic_address);
	set_at<160, 288>(result, lgxx_rd5_res);
	hw_uint<32>  lgxx_rd6_res = lgxx_rd6_select(lxx, d0, d1, dynamic_address);
	set_at<192, 288>(result, lgxx_rd6_res);
	hw_uint<32>  lgxx_rd7_res = lgxx_rd7_select(lxx, d0, d1, dynamic_address);
	set_at<224, 288>(result, lgxx_rd7_res);
	hw_uint<32>  lgxx_rd8_res = lgxx_rd8_select(lxx, d0, d1, dynamic_address);
	set_at<256, 288>(result, lgxx_rd8_res);
	return result;
}

// lxx_update_0_write
//	lxx_lxx_update_0_write0
inline void lxx_lxx_update_0_write_bundle_write(hw_uint<32>& lxx_update_0_write, lxx_cache& lxx, int d0, int d1, int dynamic_address) {
...
inline void lxy_lxy_update_0_write0_write(hw_uint<32> & lxy_lxy_update_0_write0, lxy_cache& lxy, int d0, int d1, int dynamic_address) {
  lxy.lxy_lxy_update_0_write0_merged_banks_9.push(lxy_lxy_update_0_write0);
}

inline hw_uint<32>  lgxy_rd0_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd1_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd2_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd3_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd4_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd5_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd6_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd7_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgxy_rd8_select(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//	lgxy_rd7
//	lgxy_rd8
inline hw_uint<288> lxy_lgxy_update_0_read_bundle_read(lxy_cache& lxy, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 9
    // lgxy_rd0
    // lgxy_rd1
    // lgxy_rd2
	...
	hw_uint<288> result;
	hw_uint<32>  lgxy_rd0_res = lgxy_rd0_select(lxy, d0, d1, dynamic_address);
	set_at<0, 288>(result, lgxy_rd0_res);
	hw_uint<32>  lgxy_rd1_res = lgxy_rd1_select(lxy, d0, d1, dynamic_address);
	set_at<32, 288>(result, lgxy_rd1_res);
	hw_uint<32>  lgxy_rd2_res = lgxy_rd2_select(lxy, d0, d1, dynamic_address);
	set_at<64, 288>(result, lgxy_rd2_res);
	hw_uint<32>  lgxy_rd3_res = lgxy_rd3_select(lxy, d0, d1, dynamic_address);
	set_at<96, 288>(result, lgxy_rd3_res);
	hw_uint<32>  lgxy_rd4_res = lgxy_rd4_select(lxy, d0, d1, dynamic_address);
	set_at<128, 288>(result, lgxy_rd4_res);
	hw_uint<32>  lgxy_rd5_res = lgxy_rd5_select(lxy, d0, d1, dynamic_address);
	set_at<160, 288>(result, lgxy_rd5_res);
	hw_uint<32>  lgxy_rd6_res = lgxy_rd6_select(lxy, d0, d1, dynamic_address);
	set_at<192, 288>(result, lgxy_rd6_res);
	hw_uint<32>  lgxy_rd7_res = lgxy_rd7_select(lxy, d0, d1, dynamic_address);
	set_at<224, 288>(result, lgxy_rd7_res);
	hw_uint<32>  lgxy_rd8_res = lgxy_rd8_select(lxy, d0, d1, dynamic_address);
	set_at<256, 288>(result, lgxy_rd8_res);
	return result;
}

// lxy_update_0_write
//	lxy_lxy_update_0_write0
inline void lxy_lxy_update_0_write_bundle_write(hw_uint<32>& lxy_update_0_write, lxy_cache& lxy, int d0, int d1, int dynamic_address) {
...
inline void lyy_lyy_update_0_write0_write(hw_uint<32> & lyy_lyy_update_0_write0, lyy_cache& lyy, int d0, int d1, int dynamic_address) {
  lyy.lyy_lyy_update_0_write0_merged_banks_9.push(lyy_lyy_update_0_write0);
}

inline hw_uint<32>  lgyy_rd0_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd1_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd2_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd3_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd4_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd5_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd6_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd7_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
inline hw_uint<32>  lgyy_rd8_select(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//	lgyy_rd7
//	lgyy_rd8
inline hw_uint<288> lyy_lgyy_update_0_read_bundle_read(lyy_cache& lyy, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 9
    // lgyy_rd0
    // lgyy_rd1
    // lgyy_rd2
	...
	hw_uint<288> result;
	hw_uint<32>  lgyy_rd0_res = lgyy_rd0_select(lyy, d0, d1, dynamic_address);
	set_at<0, 288>(result, lgyy_rd0_res);
	hw_uint<32>  lgyy_rd1_res = lgyy_rd1_select(lyy, d0, d1, dynamic_address);
	set_at<32, 288>(result, lgyy_rd1_res);
	hw_uint<32>  lgyy_rd2_res = lgyy_rd2_select(lyy, d0, d1, dynamic_address);
	set_at<64, 288>(result, lgyy_rd2_res);
	hw_uint<32>  lgyy_rd3_res = lgyy_rd3_select(lyy, d0, d1, dynamic_address);
	set_at<96, 288>(result, lgyy_rd3_res);
	hw_uint<32>  lgyy_rd4_res = lgyy_rd4_select(lyy, d0, d1, dynamic_address);
	set_at<128, 288>(result, lgyy_rd4_res);
	hw_uint<32>  lgyy_rd5_res = lgyy_rd5_select(lyy, d0, d1, dynamic_address);
	set_at<160, 288>(result, lgyy_rd5_res);
	hw_uint<32>  lgyy_rd6_res = lgyy_rd6_select(lyy, d0, d1, dynamic_address);
	set_at<192, 288>(result, lgyy_rd6_res);
	hw_uint<32>  lgyy_rd7_res = lgyy_rd7_select(lyy, d0, d1, dynamic_address);
	set_at<224, 288>(result, lgyy_rd7_res);
	hw_uint<32>  lgyy_rd8_res = lgyy_rd8_select(lyy, d0, d1, dynamic_address);
	set_at<256, 288>(result, lgyy_rd8_res);
	return result;
}

// lyy_update_0_write
//	lyy_lyy_update_0_write0
inline void lyy_lyy_update_0_write_bundle_write(hw_uint<32>& lyy_update_0_write, lyy_cache& lyy, int d0, int d1, int dynamic_address) {
...
struct trace_trace_update_0_write0_to_harris_mini_rd0_cache {
	// RAM Box: {[0, 31], [0, 31]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct trace_cache {
  // # of banks: 1
  trace_trace_update_0_write0_to_harris_mini_rd0_cache trace_trace_update_0_write0_to_harris_mini_rd0;
};



inline void trace_trace_update_0_write0_write(hw_uint<32> & trace_trace_update_0_write0, trace_cache& trace, int d0, int d1, int dynamic_address) {
  trace.trace_trace_update_0_write0_to_harris_mini_rd0.push(trace_trace_update_0_write0);
}

inline hw_uint<32>  harris_mini_rd0_select(trace_cache& trace, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  ...
  auto value_trace_trace_update_0_write0 = trace.trace_trace_update_0_write0_to_harris_mini_rd0.peek(/* one reader or all rams */ 0);
...
// harris_mini_update_0_read
//	harris_mini_rd0
inline hw_uint<32> trace_harris_mini_update_0_read_bundle_read(trace_cache& trace, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // harris_mini_rd0

	hw_uint<32> result;
	hw_uint<32>  harris_mini_rd0_res = harris_mini_rd0_select(trace, d0, d1, dynamic_address);
	set_at<0, 32>(result, harris_mini_rd0_res);
	return result;
}
...
inline void trace_trace_update_0_write_bundle_write(hw_uint<32>& trace_update_0_write, trace_cache& trace, int d0, int d1, int dynamic_address) {
...
// Total re-use buffer capacity: 9088 bits
...
inline void lgyy_update_0(lyy_cache& lyy, lgyy_cache& lgyy, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: lyy
	auto lyy_0_c__0_value = lyy_lgyy_update_0_read_bundle_read(lyy/* source_delay */, d0, d1, 0);
...
inline void lgxy_update_0(lxy_cache& lxy, lgxy_cache& lgxy, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: lxy
	auto lxy_0_c__0_value = lxy_lgxy_update_0_read_bundle_read(lxy/* source_delay */, d0, d1, 0);
...
inline void lgxx_update_0(lxx_cache& lxx, lgxx_cache& lgxx, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: lxx
	auto lxx_0_c__0_value = lxx_lgxx_update_0_read_bundle_read(lxx/* source_delay */, d0, d1, 0);
...
inline void harris_mini_update_0(det_cache& det, trace_cache& trace, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */harris_mini, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: det
	auto det_0_c__0_value = det_harris_mini_update_0_read_bundle_read(det/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: trace
	auto trace_0_c__0_value = trace_harris_mini_update_0_read_bundle_read(trace/* source_delay */, d0, d1, 0);
...
// Driver function
void harris_mini_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */harris_mini) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("harris_mini_opt_debug.csv");
...
// schedule: { lgxx_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 31 and 0 <= d1 <= 31; lgyy8_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 31 and 0 <= d1 <= 31; grad_x_update_0[d0, d1] -> [1 + d1, 1 + d0, 3] : -1 <= d0 <= 32 and -1 <= d1 <= 32; lyy_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : -1 <= d0 <= 32 and -1 <= d1 <= 32; harris_mini_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 31 and 0 <= d1 <= 31; lgxy_update_0[d0, d1] -> [2 + d1, 2 + d0, 8] : 0 <= d0 <= 31 and 0 <= d1 <= 31; grad_y_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -1 <= d0 <= 32 and -1 <= d1 <= 32; lxx_update_0[d0, d1] -> [1 + d1, 1 + d0, 6] : -1 <= d0 <= 32 and -1 <= d1 <= 32; img_update_0[d0, d1] -> [d1, d0, 1] : -2 <= d0 <= 33 and -2 <= d1 <= 33; lgxx8_update_0[d0, d1] -> [2 + d1, 2 + d0, 12] : 0 <= d0 <= 31 and 0 <= d1 <= 31; trace_update_0[d0, d1] -> [2 + d1, 2 + d0, 14] : 0 <= d0 <= 31 and 0 <= d1 <= 31; lgyy_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 31 and 0 <= d1 <= 31; lxy_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : -1 <= d0 <= 32 and -1 <= d1 <= 32; det_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31; lgxy8_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
//   { lgxx_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgxx_update_0(((-9 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { lgyy8_update_0[d0, d1] -> [2 + d1, 2 + d0, 10] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgyy8_update_0(((-10 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
...
//   { harris_mini_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for harris_mini_update_0(((-15 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { lgxy_update_0[d0, d1] -> [2 + d1, 2 + d0, 8] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgxy_update_0(((-8 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
...
//   { lgxx8_update_0[d0, d1] -> [2 + d1, 2 + d0, 12] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgxx8_update_0(((-12 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { trace_update_0[d0, d1] -> [2 + d1, 2 + d0, 14] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for trace_update_0(((-14 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { lgyy_update_0[d0, d1] -> [2 + d1, 2 + d0, 7] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgyy_update_0(((-7 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { lxy_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : -1 <= d0 <= 32 and -1 <= d1 <= 32 }
// Condition for lxy_update_0(((-5 + i2 == 0) && (i1 >= 0) && (33 - i1 >= 0) && (i0 >= 0) && (33 - i0 >= 0)))
//   { det_update_0[d0, d1] -> [2 + d1, 2 + d0, 13] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for det_update_0(((-13 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
//   { lgxy8_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 31 and 0 <= d1 <= 31 }
// Condition for lgxy8_update_0(((-11 + i2 == 0) && (-2 + i1 >= 0) && (33 - i1 >= 0) && (-2 + i0 >= 0) && (33 - i0 >= 0)))
  ...
  for (int c1 = -2; c1 <= 33; c1 += 1) {
    ...
    if (c0 >= 0 && c1 >= 0) {
      ...
      if (c0 >= 2 && c1 >= 2) {
        ...
        harris_mini_update_0(c1 - 2, c0 - 2);
      }
    }
  }
	...
	for (int c0 = -2; c0 <= 33; c0 += 1)
	  for (int c1 = -2; c1 <= 33; c1 += 1) {
	    ...
	    if (c0 >= 0 && c1 >= 0) {
	      ...
	      if (c0 >= 2 && c1 >= 2) {
	        lgyy_update_0(lyy /* buf name */, lgyy, c1 - 2, c0 - 2);
	        lgxy_update_0(lxy /* buf name */, lgxy, c1 - 2, c0 - 2);
	        lgxx_update_0(lxx /* buf name */, lgxx, c1 - 2, c0 - 2);
	        ...
	        harris_mini_update_0(det /* buf name */, trace /* buf name */, harris_mini, c1 - 2, c0 - 2);
	      }
	    }
	  }
...
void harris_mini_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */harris_mini, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    harris_mini_opt(img_oc, harris_mini);
  }
}
#ifdef __VIVADO_SYNTH__
  // { harris_mini_update_0[root = 0, harris_mini_0, harris_mini_1] -> harris_mini[0, 0] : 0 <= harris_mini_0 <= 31 and 0 <= harris_mini_1 <= 31 }
const int harris_mini_update_0_write_pipe0_num_transfers = 1024;
...
void harris_mini_opt_accel(hw_uint<32>* img_update_0_read_pipe0, hw_uint<32>* harris_mini_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = harris_mini_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = harris_mini_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<32> > harris_mini_update_0_write_pipe0_channel;

  burst_read<32>(img_update_0_read_pipe0, img_update_0_read_pipe0_channel, img_update_0_read_pipe0_num_transfers*size);

  harris_mini_opt_wrapper(img_update_0_read_pipe0_channel, harris_mini_update_0_write_pipe0_channel, size);

  burst_write<32>(harris_mini_update_0_write_pipe0, harris_mini_update_0_write_pipe0_channel, harris_mini_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void harris_mini_opt_rdai(HWStream<hw_uint<32> >& img_update_0_read_pipe0, HWStream<hw_uint<32> >&  harris_mini_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = img_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = harris_mini_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  harris_mini_opt(img_update_0_read_pipe0, harris_mini_update_0_write_pipe0);
