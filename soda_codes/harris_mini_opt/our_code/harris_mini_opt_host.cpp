...
int main(int argc, char **argv) {
  ...
  const int harris_mini_update_0_write_DATA_SIZE = num_epochs*1024;
...
nsduration = end - start;
  OCL_CHECK(err, err = q.enqueueMigrateMemObjects({harris_mini_update_0_write_ocl_buf}, CL_MIGRATE_MEM_OBJECT_HOST));
