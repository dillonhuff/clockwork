// AUTO GEN SODA TB
#include "float_cpy_resource_s_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  float_cpy_resource_s_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_float_cpy_resource_s_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
