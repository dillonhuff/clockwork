...
inline void pw_math_A47(A_FIFO_buf24_cache& A_FIFO_buf24, Ac_cache& Ac, int d0, int d1, int d2) {
  // Dynamic address computation
	...
	auto compute_result = float_square(A_FIFO_buf24_pw_math_A46_c__pw_math_A45_value);
	// Produce: Ac
...
inline void pw_math_B1215(B_FIFO_buf40_cache& B_FIFO_buf40, Bc_cache& Bc, int d0, int d1, int d2) {
  // Dynamic address computation
	...
	auto compute_result = float_square(B_FIFO_buf40_pw_math_B1214_c__pw_math_B1213_value);
	// Produce: Bc
...
// Driver function
void float_cpy_resource_s(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("float_cpy_resource_s_debug.csv");
  global_debug_handle = &debug_file;
#endif //__VIVADO_SYNTH__
...
void float_cpy_resource_s_wrapper(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    float_cpy_resource_s(in, out);
  }
}
#ifdef __VIVADO_SYNTH__
...
void float_cpy_resource_s_accel(hw_uint<32>* pw_math_in03_read_pipe0, hw_uint<32>* pw_math_Bc1619_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  float_cpy_resource_s_wrapper(pw_math_in03_read_pipe0_channel, pw_math_Bc1619_write_pipe0_channel, size);
...
void float_cpy_resource_s_rdai(HWStream<hw_uint<32> >& pw_math_in03_read_pipe0, HWStream<hw_uint<32> >&  pw_math_Bc1619_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  float_cpy_resource_s(pw_math_in03_read_pipe0, pw_math_Bc1619_write_pipe0);
