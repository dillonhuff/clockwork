...
#include <fstream>
#include <vector>
#include "float_cpy_resource_s.h"
...
int main(int argc, char **argv) {
  ...
  float_cpy_resource_s(pw_math_in03_read_channel, pw_math_Bc1619_write_channel);
  ...
  output.save_image("./images/float_cpy_resource_s_bmp_out.bmp");
}
