...
hw_uint<16> icsc_8s_1_generated_compute(hw_uint<16*1> stg7) {
...
hw_uint<16>  stg7_generated_compute_unrolled_1(hw_uint<64>& stg6) {
  ...
  // icsc_8s_1_update_0 unroll factor: 1
hw_uint<16>  icsc_8s_1_generated_compute_unrolled_1(hw_uint<16>& stg7) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_stg7;
  set_at<0, 16, 16>(lane_0_stg7, stg7.extract<0, 15>());
  auto result_0 = icsc_8s_1_generated_compute(lane_0_stg7);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
