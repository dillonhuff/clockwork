...
// compute file: icsc_8s_1_opt_compute_units.h
#include "icsc_8s_1_opt_compute_units.h"
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd0 read pattern: { stg0_update_0[d0, d1] -> in[-1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1938();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd1 read pattern: { stg0_update_0[d0, d1] -> in[d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1937();
  return value_in_in_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd2 read pattern: { stg0_update_0[d0, d1] -> in[d0, 1 + d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd3 read pattern: { stg0_update_0[d0, d1] -> in[1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1936();
  return value_in_in_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd0 read pattern: { stg1_update_0[d0, d1] -> stg0[-1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1936();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd1 read pattern: { stg1_update_0[d0, d1] -> stg0[d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1935();
  return value_stg0_stg0_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd2 read pattern: { stg1_update_0[d0, d1] -> stg0[d0, 1 + d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd3 read pattern: { stg1_update_0[d0, d1] -> stg0[1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1934();
  return value_stg0_stg0_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd0 read pattern: { stg2_update_0[d0, d1] -> stg1[-1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1934();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd1 read pattern: { stg2_update_0[d0, d1] -> stg1[d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1933();
  return value_stg1_stg1_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd2 read pattern: { stg2_update_0[d0, d1] -> stg1[d0, 1 + d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd3 read pattern: { stg2_update_0[d0, d1] -> stg1[1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1932();
  return value_stg1_stg1_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd0 read pattern: { stg3_update_0[d0, d1] -> stg2[-1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1932();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd1 read pattern: { stg3_update_0[d0, d1] -> stg2[d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1931();
  return value_stg2_stg2_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd2 read pattern: { stg3_update_0[d0, d1] -> stg2[d0, 1 + d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd3 read pattern: { stg3_update_0[d0, d1] -> stg2[1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1930();
  return value_stg2_stg2_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd0 read pattern: { stg4_update_0[d0, d1] -> stg3[-1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1930();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd1 read pattern: { stg4_update_0[d0, d1] -> stg3[d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1929();
  return value_stg3_stg3_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd2 read pattern: { stg4_update_0[d0, d1] -> stg3[d0, 1 + d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd3 read pattern: { stg4_update_0[d0, d1] -> stg3[1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1928();
  return value_stg3_stg3_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd0 read pattern: { stg5_update_0[d0, d1] -> stg4[-1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1928();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd1 read pattern: { stg5_update_0[d0, d1] -> stg4[d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1927();
  return value_stg4_stg4_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd2 read pattern: { stg5_update_0[d0, d1] -> stg4[d0, 1 + d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd3 read pattern: { stg5_update_0[d0, d1] -> stg4[1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1926();
  return value_stg4_stg4_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd0 read pattern: { stg6_update_0[d0, d1] -> stg5[-1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1926();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd1 read pattern: { stg6_update_0[d0, d1] -> stg5[d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1925();
  return value_stg5_stg5_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd2 read pattern: { stg6_update_0[d0, d1] -> stg5[d0, 1 + d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd3 read pattern: { stg6_update_0[d0, d1] -> stg5[1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1924();
  return value_stg5_stg5_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd0 read pattern: { stg7_update_0[d0, d1] -> stg6[-1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1924();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd1 read pattern: { stg7_update_0[d0, d1] -> stg6[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1923();
  return value_stg6_stg6_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd2 read pattern: { stg7_update_0[d0, d1] -> stg6[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd3 read pattern: { stg7_update_0[d0, d1] -> stg6[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1922();
  return value_stg6_stg6_update_0_write0;
  return 0;
}
...
struct stg7_stg7_update_0_write0_to_icsc_8s_1_rd0_cache {
...
struct stg7_cache {
  // # of banks: 1
  stg7_stg7_update_0_write0_to_icsc_8s_1_rd0_cache stg7_stg7_update_0_write0_to_icsc_8s_1_rd0;
};
...
inline void stg7_stg7_update_0_write0_write(hw_uint<16>& stg7_stg7_update_0_write0, stg7_cache& stg7, int d0, int d1, int dynamic_address) {
  stg7.stg7_stg7_update_0_write0_to_icsc_8s_1_rd0.push(stg7_stg7_update_0_write0);
}

inline hw_uint<16> icsc_8s_1_rd0_select(stg7_cache& stg7, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // icsc_8s_1_rd0 read pattern: { icsc_8s_1_update_0[d0, d1] -> stg7[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { icsc_8s_1_update_0[d0, d1] -> [8 + d1, 8 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg7_stg7_update_0_write0 = stg7.stg7_stg7_update_0_write0_to_icsc_8s_1_rd0.peek(/* one reader or all rams */ 0);
  return value_stg7_stg7_update_0_write0;
  return 0;
}

// # of bundles = 2
// icsc_8s_1_update_0_read
//	icsc_8s_1_rd0
inline hw_uint<16> stg7_icsc_8s_1_update_0_read_bundle_read(stg7_cache& stg7, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // icsc_8s_1_rd0

	hw_uint<16> result;
	hw_uint<16> icsc_8s_1_rd0_res = icsc_8s_1_rd0_select(stg7, d0, d1, dynamic_address);
	set_at<0, 16>(result, icsc_8s_1_rd0_res);
	return result;
}
...
// Total re-use buffer capacity: 247168 bits
...
inline void icsc_8s_1_update_0(stg7_cache& stg7, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */icsc_8s_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg7
	auto stg7_0_c__0_value = stg7_icsc_8s_1_update_0_read_bundle_read(stg7/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = icsc_8s_1_generated_compute_unrolled_1(stg7_0_c__0_value);
	// Produce: icsc_8s_1
	icsc_8s_1.write(compute_result);
...
// Driver function
void icsc_8s_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */icsc_8s_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("icsc_8s_1_opt_debug.csv");
...
// schedule: { icsc_8s_1_update_0[d0, d1] -> [8 + d1, 8 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085; stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081; stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084; stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086; stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082; stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083; stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080; in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
//   { icsc_8s_1_update_0[d0, d1] -> [8 + d1, 8 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for icsc_8s_1_update_0(((-10 + i2 == 0) && (-8 + i1 >= 0) && (1927 - i1 >= 0) && (-8 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
// Condition for stg1_update_0(((-3 + i2 == 0) && (4 + i1 >= 0) && (1927 - i1 >= 0) && (-2 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
// Condition for stg5_update_0(((-7 + i2 == 0) && (-4 + i1 >= 0) && (1927 - i1 >= 0) && (-6 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for stg2_update_0(((-4 + i2 == 0) && (2 + i1 >= 0) && (1927 - i1 >= 0) && (-3 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for stg7_update_0(((-9 + i2 == 0) && (-8 + i1 >= 0) && (1927 - i1 >= 0) && (-8 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for stg0_update_0(((-2 + i2 == 0) && (6 + i1 >= 0) && (1927 - i1 >= 0) && (-1 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
// Condition for stg4_update_0(((-6 + i2 == 0) && (-2 + i1 >= 0) && (1927 - i1 >= 0) && (-5 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
// Condition for stg3_update_0(((-5 + i2 == 0) && (i1 >= 0) && (1927 - i1 >= 0) && (-4 + i0 >= 0) && (1087 - i0 >= 0)))
//   { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
// Condition for stg6_update_0(((-8 + i2 == 0) && (-6 + i1 >= 0) && (1927 - i1 >= 0) && (-7 + i0 >= 0) && (1087 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
// Condition for in_update_0(((-1 + i2 == 0) && (8 + i1 >= 0) && (1927 - i1 >= 0) && (i0 >= 0) && (1087 - i0 >= 0)))

  /*
  // Schedules...
    // icsc_8s_1_update_0 -> [1*d1*1*1 + 1*8,1*d0*1*1 + 1*8,1*10]
...
for (int c0 = 0; c0 <= 1087; c0++) {
  for (int c1 = -8; c1 <= 1927; c1++) {

#ifdef __VIVADO_SYNTH__
#pragma HLS pipeline II=1
#endif // __VIVADO_SYNTH__

    if ((-8 <= c1 && c1 <= 1927) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 1087) && ((c0 - 0) % 1 == 0)) {
      in_update_0((c1 - 0) / 1, (c0 - 0) / 1);
    }

    if ((-6 <= c1 && c1 <= 1927) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1087) && ((c0 - 1) % 1 == 0)) {
      stg0_update_0((c1 - 1) / 1, (c0 - 1) / 1);
    }

    if ((-4 <= c1 && c1 <= 1927) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1087) && ((c0 - 2) % 1 == 0)) {
      stg1_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }

    if ((-2 <= c1 && c1 <= 1927) && ((c1 - 3) % 1 == 0) && (3 <= c0 && c0 <= 1087) && ((c0 - 3) % 1 == 0)) {
      stg2_update_0((c1 - 3) / 1, (c0 - 3) / 1);
    }

    if ((0 <= c1 && c1 <= 1927) && ((c1 - 4) % 1 == 0) && (4 <= c0 && c0 <= 1087) && ((c0 - 4) % 1 == 0)) {
      stg3_update_0((c1 - 4) / 1, (c0 - 4) / 1);
    }

    if ((2 <= c1 && c1 <= 1927) && ((c1 - 5) % 1 == 0) && (5 <= c0 && c0 <= 1087) && ((c0 - 5) % 1 == 0)) {
      stg4_update_0((c1 - 5) / 1, (c0 - 5) / 1);
    }

    if ((4 <= c1 && c1 <= 1927) && ((c1 - 6) % 1 == 0) && (6 <= c0 && c0 <= 1087) && ((c0 - 6) % 1 == 0)) {
      stg5_update_0((c1 - 6) / 1, (c0 - 6) / 1);
    }

    if ((6 <= c1 && c1 <= 1927) && ((c1 - 7) % 1 == 0) && (7 <= c0 && c0 <= 1087) && ((c0 - 7) % 1 == 0)) {
      stg6_update_0((c1 - 7) / 1, (c0 - 7) / 1);
    }

    if ((8 <= c1 && c1 <= 1927) && ((c1 - 8) % 1 == 0) && (8 <= c0 && c0 <= 1087) && ((c0 - 8) % 1 == 0)) {
      stg7_update_0((c1 - 8) / 1, (c0 - 8) / 1);
    }

    if ((8 <= c1 && c1 <= 1927) && ((c1 - 8) % 1 == 0) && (8 <= c0 && c0 <= 1087) && ((c0 - 8) % 1 == 0)) {
      icsc_8s_1_update_0((c1 - 8) / 1, (c0 - 8) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((8 <= c1 && c1 <= 1927) && ((c1 - 8) % 1 == 0) && (8 <= c0 && c0 <= 1087) && ((c0 - 8) % 1 == 0)) {
	      icsc_8s_1_update_0(stg7 /* buf name */, icsc_8s_1, (c1 - 8) / 1, (c0 - 8) / 1);
	    }
...
void icsc_8s_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */icsc_8s_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    icsc_8s_1_opt(in_off_chip, icsc_8s_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { icsc_8s_1_update_0[root = 0, icsc_8s_1_0, icsc_8s_1_1] -> icsc_8s_1[0, 0] : 0 <= icsc_8s_1_0 <= 1919 and 0 <= icsc_8s_1_1 <= 1079 }
const int icsc_8s_1_update_0_write_pipe0_num_transfers = 2073600;
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : -8 <= in_0 <= 1927 and 0 <= in_1 <= 1087 }
const int in_update_0_read_pipe0_num_transfers = 2106368;


extern "C" {

void icsc_8s_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* icsc_8s_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = icsc_8s_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = icsc_8s_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > icsc_8s_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  icsc_8s_1_opt_wrapper(in_update_0_read_pipe0_channel, icsc_8s_1_update_0_write_pipe0_channel, size);

  burst_write<16>(icsc_8s_1_update_0_write_pipe0, icsc_8s_1_update_0_write_pipe0_channel, icsc_8s_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void icsc_8s_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  icsc_8s_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = icsc_8s_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  icsc_8s_1_opt(in_update_0_read_pipe0, icsc_8s_1_update_0_write_pipe0);
