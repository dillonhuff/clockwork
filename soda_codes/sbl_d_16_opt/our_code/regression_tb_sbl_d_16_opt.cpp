#include <fstream>
#include "sbl_d_16_opt.h"

int main() {
  srand(234);
  ofstream fout("regression_result_sbl_d_16_opt.txt");
  HWStream<hw_uint<16 > > off_chip_img;
  HWStream<hw_uint<16 > > sbl_d_16;
  ...
  sbl_d_16_opt(off_chip_img, sbl_d_16);
  for (int i = 0; i < 1166400; i++) {
    auto actual = sbl_d_16.read();
