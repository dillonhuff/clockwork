...
hw_uint<16> stg1_generated_compute(hw_uint<16*4> stg0) {
  return uint16_t(((uint16_t(stg0.get<16, 2>()) + uint16_t(stg0.get<16, 3>())) + (uint16_t(stg0.get<16, 1>()) + (uint16_t(stg0.get<16, 0>()) + uint16_t(stg0.get<16, 2>())))));
}

hw_uint<16> stg2_generated_compute(hw_uint<16*4> stg1) {
  return uint16_t(((uint16_t(stg1.get<16, 2>()) + uint16_t(stg1.get<16, 3>())) + (uint16_t(stg1.get<16, 1>()) + (uint16_t(stg1.get<16, 0>()) + uint16_t(stg1.get<16, 2>())))));
}

hw_uint<16> stg3_generated_compute(hw_uint<16*4> stg2) {
  return uint16_t(((uint16_t(stg2.get<16, 2>()) + uint16_t(stg2.get<16, 3>())) + (uint16_t(stg2.get<16, 1>()) + (uint16_t(stg2.get<16, 0>()) + uint16_t(stg2.get<16, 2>())))));
}

hw_uint<16> stg4_generated_compute(hw_uint<16*4> stg3) {
  return uint16_t(((uint16_t(stg3.get<16, 2>()) + uint16_t(stg3.get<16, 3>())) + (uint16_t(stg3.get<16, 1>()) + (uint16_t(stg3.get<16, 0>()) + uint16_t(stg3.get<16, 2>())))));
}

hw_uint<16> stg5_generated_compute(hw_uint<16*4> stg4) {
  return uint16_t(((uint16_t(stg4.get<16, 2>()) + uint16_t(stg4.get<16, 3>())) + (uint16_t(stg4.get<16, 1>()) + (uint16_t(stg4.get<16, 0>()) + uint16_t(stg4.get<16, 2>())))));
}

hw_uint<16> stg6_generated_compute(hw_uint<16*4> stg5) {
  return uint16_t(((uint16_t(stg5.get<16, 2>()) + uint16_t(stg5.get<16, 3>())) + (uint16_t(stg5.get<16, 1>()) + (uint16_t(stg5.get<16, 0>()) + uint16_t(stg5.get<16, 2>())))));
}

hw_uint<16> stg7_generated_compute(hw_uint<16*4> stg6) {
  return uint16_t(((uint16_t(stg6.get<16, 2>()) + uint16_t(stg6.get<16, 3>())) + (uint16_t(stg6.get<16, 1>()) + (uint16_t(stg6.get<16, 0>()) + uint16_t(stg6.get<16, 2>())))));
}

hw_uint<16> stg8_generated_compute(hw_uint<16*4> stg7) {
  return uint16_t(((uint16_t(stg7.get<16, 2>()) + uint16_t(stg7.get<16, 3>())) + (uint16_t(stg7.get<16, 1>()) + (uint16_t(stg7.get<16, 0>()) + uint16_t(stg7.get<16, 2>())))));
}

hw_uint<16> stg9_generated_compute(hw_uint<16*4> stg8) {
  return uint16_t(((uint16_t(stg8.get<16, 2>()) + uint16_t(stg8.get<16, 3>())) + (uint16_t(stg8.get<16, 1>()) + (uint16_t(stg8.get<16, 0>()) + uint16_t(stg8.get<16, 2>())))));
}

hw_uint<16> icsc_nd_32_generated_compute(hw_uint<16*1> stg9) {
...
hw_uint<512>  stg9_generated_compute_unrolled_32(hw_uint<2048>& stg8) {
  ...
  // icsc_nd_32_update_0 unroll factor: 32
hw_uint<512>  icsc_nd_32_generated_compute_unrolled_32(hw_uint<512>& stg9) {
  hw_uint<512> whole_result;

  hw_uint<16> lane_0_stg9;
  set_at<0, 16, 16>(lane_0_stg9, stg9.extract<0, 15>());
  auto result_0 = icsc_nd_32_generated_compute(lane_0_stg9);
  set_at<0, 512, 16>(whole_result, result_0);

  hw_uint<16> lane_1_stg9;
  set_at<0, 16, 16>(lane_1_stg9, stg9.extract<16, 31>());
  auto result_1 = icsc_nd_32_generated_compute(lane_1_stg9);
  set_at<16, 512, 16>(whole_result, result_1);

  hw_uint<16> lane_2_stg9;
  set_at<0, 16, 16>(lane_2_stg9, stg9.extract<32, 47>());
  auto result_2 = icsc_nd_32_generated_compute(lane_2_stg9);
  set_at<32, 512, 16>(whole_result, result_2);

  hw_uint<16> lane_3_stg9;
  set_at<0, 16, 16>(lane_3_stg9, stg9.extract<48, 63>());
  auto result_3 = icsc_nd_32_generated_compute(lane_3_stg9);
  set_at<48, 512, 16>(whole_result, result_3);

  hw_uint<16> lane_4_stg9;
  set_at<0, 16, 16>(lane_4_stg9, stg9.extract<64, 79>());
  auto result_4 = icsc_nd_32_generated_compute(lane_4_stg9);
  set_at<64, 512, 16>(whole_result, result_4);

  hw_uint<16> lane_5_stg9;
  set_at<0, 16, 16>(lane_5_stg9, stg9.extract<80, 95>());
  auto result_5 = icsc_nd_32_generated_compute(lane_5_stg9);
  set_at<80, 512, 16>(whole_result, result_5);

  hw_uint<16> lane_6_stg9;
  set_at<0, 16, 16>(lane_6_stg9, stg9.extract<96, 111>());
  auto result_6 = icsc_nd_32_generated_compute(lane_6_stg9);
  set_at<96, 512, 16>(whole_result, result_6);

  hw_uint<16> lane_7_stg9;
  set_at<0, 16, 16>(lane_7_stg9, stg9.extract<112, 127>());
  auto result_7 = icsc_nd_32_generated_compute(lane_7_stg9);
  set_at<112, 512, 16>(whole_result, result_7);

  hw_uint<16> lane_8_stg9;
  set_at<0, 16, 16>(lane_8_stg9, stg9.extract<128, 143>());
  auto result_8 = icsc_nd_32_generated_compute(lane_8_stg9);
  set_at<128, 512, 16>(whole_result, result_8);

  hw_uint<16> lane_9_stg9;
  set_at<0, 16, 16>(lane_9_stg9, stg9.extract<144, 159>());
  auto result_9 = icsc_nd_32_generated_compute(lane_9_stg9);
  set_at<144, 512, 16>(whole_result, result_9);

  hw_uint<16> lane_10_stg9;
  set_at<0, 16, 16>(lane_10_stg9, stg9.extract<160, 175>());
  auto result_10 = icsc_nd_32_generated_compute(lane_10_stg9);
  set_at<160, 512, 16>(whole_result, result_10);

  hw_uint<16> lane_11_stg9;
  set_at<0, 16, 16>(lane_11_stg9, stg9.extract<176, 191>());
  auto result_11 = icsc_nd_32_generated_compute(lane_11_stg9);
  set_at<176, 512, 16>(whole_result, result_11);

  hw_uint<16> lane_12_stg9;
  set_at<0, 16, 16>(lane_12_stg9, stg9.extract<192, 207>());
  auto result_12 = icsc_nd_32_generated_compute(lane_12_stg9);
  set_at<192, 512, 16>(whole_result, result_12);

  hw_uint<16> lane_13_stg9;
  set_at<0, 16, 16>(lane_13_stg9, stg9.extract<208, 223>());
  auto result_13 = icsc_nd_32_generated_compute(lane_13_stg9);
  set_at<208, 512, 16>(whole_result, result_13);

  hw_uint<16> lane_14_stg9;
  set_at<0, 16, 16>(lane_14_stg9, stg9.extract<224, 239>());
  auto result_14 = icsc_nd_32_generated_compute(lane_14_stg9);
  set_at<224, 512, 16>(whole_result, result_14);

  hw_uint<16> lane_15_stg9;
  set_at<0, 16, 16>(lane_15_stg9, stg9.extract<240, 255>());
  auto result_15 = icsc_nd_32_generated_compute(lane_15_stg9);
  set_at<240, 512, 16>(whole_result, result_15);

  hw_uint<16> lane_16_stg9;
  set_at<0, 16, 16>(lane_16_stg9, stg9.extract<256, 271>());
  auto result_16 = icsc_nd_32_generated_compute(lane_16_stg9);
  set_at<256, 512, 16>(whole_result, result_16);

  hw_uint<16> lane_17_stg9;
  set_at<0, 16, 16>(lane_17_stg9, stg9.extract<272, 287>());
  auto result_17 = icsc_nd_32_generated_compute(lane_17_stg9);
  set_at<272, 512, 16>(whole_result, result_17);

  hw_uint<16> lane_18_stg9;
  set_at<0, 16, 16>(lane_18_stg9, stg9.extract<288, 303>());
  auto result_18 = icsc_nd_32_generated_compute(lane_18_stg9);
  set_at<288, 512, 16>(whole_result, result_18);

  hw_uint<16> lane_19_stg9;
  set_at<0, 16, 16>(lane_19_stg9, stg9.extract<304, 319>());
  auto result_19 = icsc_nd_32_generated_compute(lane_19_stg9);
  set_at<304, 512, 16>(whole_result, result_19);

  hw_uint<16> lane_20_stg9;
  set_at<0, 16, 16>(lane_20_stg9, stg9.extract<320, 335>());
  auto result_20 = icsc_nd_32_generated_compute(lane_20_stg9);
  set_at<320, 512, 16>(whole_result, result_20);

  hw_uint<16> lane_21_stg9;
  set_at<0, 16, 16>(lane_21_stg9, stg9.extract<336, 351>());
  auto result_21 = icsc_nd_32_generated_compute(lane_21_stg9);
  set_at<336, 512, 16>(whole_result, result_21);

  hw_uint<16> lane_22_stg9;
  set_at<0, 16, 16>(lane_22_stg9, stg9.extract<352, 367>());
  auto result_22 = icsc_nd_32_generated_compute(lane_22_stg9);
  set_at<352, 512, 16>(whole_result, result_22);

  hw_uint<16> lane_23_stg9;
  set_at<0, 16, 16>(lane_23_stg9, stg9.extract<368, 383>());
  auto result_23 = icsc_nd_32_generated_compute(lane_23_stg9);
  set_at<368, 512, 16>(whole_result, result_23);

  hw_uint<16> lane_24_stg9;
  set_at<0, 16, 16>(lane_24_stg9, stg9.extract<384, 399>());
  auto result_24 = icsc_nd_32_generated_compute(lane_24_stg9);
  set_at<384, 512, 16>(whole_result, result_24);

  hw_uint<16> lane_25_stg9;
  set_at<0, 16, 16>(lane_25_stg9, stg9.extract<400, 415>());
  auto result_25 = icsc_nd_32_generated_compute(lane_25_stg9);
  set_at<400, 512, 16>(whole_result, result_25);

  hw_uint<16> lane_26_stg9;
  set_at<0, 16, 16>(lane_26_stg9, stg9.extract<416, 431>());
  auto result_26 = icsc_nd_32_generated_compute(lane_26_stg9);
  set_at<416, 512, 16>(whole_result, result_26);

  hw_uint<16> lane_27_stg9;
  set_at<0, 16, 16>(lane_27_stg9, stg9.extract<432, 447>());
  auto result_27 = icsc_nd_32_generated_compute(lane_27_stg9);
  set_at<432, 512, 16>(whole_result, result_27);

  hw_uint<16> lane_28_stg9;
  set_at<0, 16, 16>(lane_28_stg9, stg9.extract<448, 463>());
  auto result_28 = icsc_nd_32_generated_compute(lane_28_stg9);
  set_at<448, 512, 16>(whole_result, result_28);

  hw_uint<16> lane_29_stg9;
  set_at<0, 16, 16>(lane_29_stg9, stg9.extract<464, 479>());
  auto result_29 = icsc_nd_32_generated_compute(lane_29_stg9);
  set_at<464, 512, 16>(whole_result, result_29);

  hw_uint<16> lane_30_stg9;
  set_at<0, 16, 16>(lane_30_stg9, stg9.extract<480, 495>());
  auto result_30 = icsc_nd_32_generated_compute(lane_30_stg9);
  set_at<480, 512, 16>(whole_result, result_30);

  hw_uint<16> lane_31_stg9;
  set_at<0, 16, 16>(lane_31_stg9, stg9.extract<496, 511>());
  auto result_31 = icsc_nd_32_generated_compute(lane_31_stg9);
  set_at<496, 512, 16>(whole_result, result_31);
  return whole_result;
}
