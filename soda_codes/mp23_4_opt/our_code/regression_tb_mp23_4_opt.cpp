...
int main() {
  ofstream in_pix("input_pixels_regression_result_mp23_4_opt.txt");
  ofstream fout("regression_result_mp23_4_opt.txt");
  HWStream<hw_uint<128> > in_update_0_read;
  HWStream<hw_uint<64> > mp23_4_update_0_write;
  ...
  mp23_4_opt(in_update_0_read, mp23_4_update_0_write);

  for (int i = 0; i < 131072; i++) {
    hw_uint<64> actual = mp23_4_update_0_write.read();
