...
int main(int argc, char **argv) {
  ...
  const int mpr_32_32_update_0_write_BYTES_PER_PIXEL = 32 / 8;
  ...
  for (int i = 0; i < mpr_32_32_update_0_write_DATA_SIZE; i++) {
    ((uint32_t*) (mpr_32_32_update_0_write.data()))[i] = 0;
  }
...
nsduration = end - start;
  ...
  for (int i = 0; i < mpr_32_32_update_0_write_DATA_SIZE; i++) {
    regression_result << ((uint32_t*) (mpr_32_32_update_0_write.data()))[i] << std::endl;
  }
