...
hw_uint<16> sblr30_2_generated_compute(hw_uint<16*1> mag_x, hw_uint<16*1> mag_y) {
...
hw_uint<32>  mag_x_generated_compute_unrolled_2(hw_uint<192>& img) {
  ...
  // sblr30_2_update_0 unroll factor: 2
hw_uint<32>  sblr30_2_generated_compute_unrolled_2(hw_uint<32>& mag_x, hw_uint<32>& mag_y) {
  hw_uint<32> whole_result;
  ...
  auto result_0 = sblr30_2_generated_compute(lane_0_mag_x, lane_0_mag_y);
  set_at<0, 32, 16>(whole_result, result_0);
  ...
  auto result_1 = sblr30_2_generated_compute(lane_1_mag_x, lane_1_mag_y);
  set_at<16, 32, 16>(whole_result, result_1);
  return whole_result;
}
