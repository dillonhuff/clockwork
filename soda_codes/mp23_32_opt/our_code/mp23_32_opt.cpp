...
#include "mp23_32_opt_compute_units.h"
...
inline hw_uint<32>  mp23_32_rd0_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd0 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd1_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd1 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd10_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd10 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[5 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd11_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd11 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[5 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd12_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd12 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[6 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd13_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd13 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[6 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd14_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd14 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[7 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd15_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd15 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[7 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd16_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd16 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[8 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd17_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd17 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[8 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd18_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd18 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[9 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd19_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd19 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[9 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd2_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd2 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[1 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd20_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd20 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[10 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd21_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd21 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[10 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd22_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd22 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[11 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd23_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd23 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[11 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd24_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd24 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[12 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd25_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd25 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[12 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd26_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd26 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[13 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd27_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd27 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[13 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd28_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd28 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[14 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd29_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd29 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[14 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd3_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd3 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[1 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd30_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd30 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[15 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd31_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd31 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[15 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd32_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd32 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[16 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd33_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd33 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[16 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd34_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd34 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[17 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd35_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd35 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[17 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd36_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd36 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[18 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd37_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd37 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[18 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd38_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd38 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[19 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd39_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd39 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[19 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd4_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd4 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[2 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd40_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd40 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[20 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd41_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd41 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[20 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd42_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd42 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[21 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd43_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd43 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[21 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd44_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd44 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[22 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd45_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd45 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[22 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd46_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd46 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[23 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd47_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd47 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[23 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd48_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd48 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[24 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd49_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd49 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[24 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd5_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd5 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[2 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd50_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd50 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[25 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd51_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd51 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[25 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd52_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd52 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[26 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd53_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd53 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[26 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd54_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd54 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[27 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd55_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd55 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[27 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd56_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd56 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[28 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd57_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd57 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[28 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd58_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd58 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[29 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd59_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd59 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[29 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd6_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd6 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[3 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd60_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd60 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[30 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd61_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd61 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[30 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd62_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd62 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[31 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd63_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd63 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[31 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd7_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd7 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[3 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_32_rd8_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd8 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[4 + 32d0, 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_32_update_0[d0, d1, d2] -> 4 : 0 < d0 <= 2 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> (1 + d0) : d0 = 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_32_update_0[d0, d1, d2] -> 4 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_32_rd9_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_32_rd9 read pattern: { mp23_32_update_0[d0, d1, d2] -> in[4 + 32d0, 1 + 2d1, d2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_32_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 3 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 3 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
//	mp23_32_rd62
//	mp23_32_rd63
inline hw_uint<2048> in_mp23_32_update_0_read_bundle_read(in_cache& in, int d0, int d1, int d2) {
  // # of ports in bundle: 64
	...
	hw_uint<2048> result;
	hw_uint<32>  mp23_32_rd0_res = mp23_32_rd0_select(in, d0, d1, d2);
	set_at<0, 2048>(result, mp23_32_rd0_res);
	hw_uint<32>  mp23_32_rd1_res = mp23_32_rd1_select(in, d0, d1, d2);
	set_at<32, 2048>(result, mp23_32_rd1_res);
	hw_uint<32>  mp23_32_rd2_res = mp23_32_rd2_select(in, d0, d1, d2);
	set_at<64, 2048>(result, mp23_32_rd2_res);
	hw_uint<32>  mp23_32_rd3_res = mp23_32_rd3_select(in, d0, d1, d2);
	set_at<96, 2048>(result, mp23_32_rd3_res);
	hw_uint<32>  mp23_32_rd4_res = mp23_32_rd4_select(in, d0, d1, d2);
	set_at<128, 2048>(result, mp23_32_rd4_res);
	hw_uint<32>  mp23_32_rd5_res = mp23_32_rd5_select(in, d0, d1, d2);
	set_at<160, 2048>(result, mp23_32_rd5_res);
	hw_uint<32>  mp23_32_rd6_res = mp23_32_rd6_select(in, d0, d1, d2);
	set_at<192, 2048>(result, mp23_32_rd6_res);
	hw_uint<32>  mp23_32_rd7_res = mp23_32_rd7_select(in, d0, d1, d2);
	set_at<224, 2048>(result, mp23_32_rd7_res);
	hw_uint<32>  mp23_32_rd8_res = mp23_32_rd8_select(in, d0, d1, d2);
	set_at<256, 2048>(result, mp23_32_rd8_res);
	hw_uint<32>  mp23_32_rd9_res = mp23_32_rd9_select(in, d0, d1, d2);
	set_at<288, 2048>(result, mp23_32_rd9_res);
	hw_uint<32>  mp23_32_rd10_res = mp23_32_rd10_select(in, d0, d1, d2);
	set_at<320, 2048>(result, mp23_32_rd10_res);
	hw_uint<32>  mp23_32_rd11_res = mp23_32_rd11_select(in, d0, d1, d2);
	set_at<352, 2048>(result, mp23_32_rd11_res);
	hw_uint<32>  mp23_32_rd12_res = mp23_32_rd12_select(in, d0, d1, d2);
	set_at<384, 2048>(result, mp23_32_rd12_res);
	hw_uint<32>  mp23_32_rd13_res = mp23_32_rd13_select(in, d0, d1, d2);
	set_at<416, 2048>(result, mp23_32_rd13_res);
	hw_uint<32>  mp23_32_rd14_res = mp23_32_rd14_select(in, d0, d1, d2);
	set_at<448, 2048>(result, mp23_32_rd14_res);
	hw_uint<32>  mp23_32_rd15_res = mp23_32_rd15_select(in, d0, d1, d2);
	set_at<480, 2048>(result, mp23_32_rd15_res);
	hw_uint<32>  mp23_32_rd16_res = mp23_32_rd16_select(in, d0, d1, d2);
	set_at<512, 2048>(result, mp23_32_rd16_res);
	hw_uint<32>  mp23_32_rd17_res = mp23_32_rd17_select(in, d0, d1, d2);
	set_at<544, 2048>(result, mp23_32_rd17_res);
	hw_uint<32>  mp23_32_rd18_res = mp23_32_rd18_select(in, d0, d1, d2);
	set_at<576, 2048>(result, mp23_32_rd18_res);
	hw_uint<32>  mp23_32_rd19_res = mp23_32_rd19_select(in, d0, d1, d2);
	set_at<608, 2048>(result, mp23_32_rd19_res);
	hw_uint<32>  mp23_32_rd20_res = mp23_32_rd20_select(in, d0, d1, d2);
	set_at<640, 2048>(result, mp23_32_rd20_res);
	hw_uint<32>  mp23_32_rd21_res = mp23_32_rd21_select(in, d0, d1, d2);
	set_at<672, 2048>(result, mp23_32_rd21_res);
	hw_uint<32>  mp23_32_rd22_res = mp23_32_rd22_select(in, d0, d1, d2);
	set_at<704, 2048>(result, mp23_32_rd22_res);
	hw_uint<32>  mp23_32_rd23_res = mp23_32_rd23_select(in, d0, d1, d2);
	set_at<736, 2048>(result, mp23_32_rd23_res);
	hw_uint<32>  mp23_32_rd24_res = mp23_32_rd24_select(in, d0, d1, d2);
	set_at<768, 2048>(result, mp23_32_rd24_res);
	hw_uint<32>  mp23_32_rd25_res = mp23_32_rd25_select(in, d0, d1, d2);
	set_at<800, 2048>(result, mp23_32_rd25_res);
	hw_uint<32>  mp23_32_rd26_res = mp23_32_rd26_select(in, d0, d1, d2);
	set_at<832, 2048>(result, mp23_32_rd26_res);
	hw_uint<32>  mp23_32_rd27_res = mp23_32_rd27_select(in, d0, d1, d2);
	set_at<864, 2048>(result, mp23_32_rd27_res);
	hw_uint<32>  mp23_32_rd28_res = mp23_32_rd28_select(in, d0, d1, d2);
	set_at<896, 2048>(result, mp23_32_rd28_res);
	hw_uint<32>  mp23_32_rd29_res = mp23_32_rd29_select(in, d0, d1, d2);
	set_at<928, 2048>(result, mp23_32_rd29_res);
	hw_uint<32>  mp23_32_rd30_res = mp23_32_rd30_select(in, d0, d1, d2);
	set_at<960, 2048>(result, mp23_32_rd30_res);
	hw_uint<32>  mp23_32_rd31_res = mp23_32_rd31_select(in, d0, d1, d2);
	set_at<992, 2048>(result, mp23_32_rd31_res);
	hw_uint<32>  mp23_32_rd32_res = mp23_32_rd32_select(in, d0, d1, d2);
	set_at<1024, 2048>(result, mp23_32_rd32_res);
	hw_uint<32>  mp23_32_rd33_res = mp23_32_rd33_select(in, d0, d1, d2);
	set_at<1056, 2048>(result, mp23_32_rd33_res);
	hw_uint<32>  mp23_32_rd34_res = mp23_32_rd34_select(in, d0, d1, d2);
	set_at<1088, 2048>(result, mp23_32_rd34_res);
	hw_uint<32>  mp23_32_rd35_res = mp23_32_rd35_select(in, d0, d1, d2);
	set_at<1120, 2048>(result, mp23_32_rd35_res);
	hw_uint<32>  mp23_32_rd36_res = mp23_32_rd36_select(in, d0, d1, d2);
	set_at<1152, 2048>(result, mp23_32_rd36_res);
	hw_uint<32>  mp23_32_rd37_res = mp23_32_rd37_select(in, d0, d1, d2);
	set_at<1184, 2048>(result, mp23_32_rd37_res);
	hw_uint<32>  mp23_32_rd38_res = mp23_32_rd38_select(in, d0, d1, d2);
	set_at<1216, 2048>(result, mp23_32_rd38_res);
	hw_uint<32>  mp23_32_rd39_res = mp23_32_rd39_select(in, d0, d1, d2);
	set_at<1248, 2048>(result, mp23_32_rd39_res);
	hw_uint<32>  mp23_32_rd40_res = mp23_32_rd40_select(in, d0, d1, d2);
	set_at<1280, 2048>(result, mp23_32_rd40_res);
	hw_uint<32>  mp23_32_rd41_res = mp23_32_rd41_select(in, d0, d1, d2);
	set_at<1312, 2048>(result, mp23_32_rd41_res);
	hw_uint<32>  mp23_32_rd42_res = mp23_32_rd42_select(in, d0, d1, d2);
	set_at<1344, 2048>(result, mp23_32_rd42_res);
	hw_uint<32>  mp23_32_rd43_res = mp23_32_rd43_select(in, d0, d1, d2);
	set_at<1376, 2048>(result, mp23_32_rd43_res);
	hw_uint<32>  mp23_32_rd44_res = mp23_32_rd44_select(in, d0, d1, d2);
	set_at<1408, 2048>(result, mp23_32_rd44_res);
	hw_uint<32>  mp23_32_rd45_res = mp23_32_rd45_select(in, d0, d1, d2);
	set_at<1440, 2048>(result, mp23_32_rd45_res);
	hw_uint<32>  mp23_32_rd46_res = mp23_32_rd46_select(in, d0, d1, d2);
	set_at<1472, 2048>(result, mp23_32_rd46_res);
	hw_uint<32>  mp23_32_rd47_res = mp23_32_rd47_select(in, d0, d1, d2);
	set_at<1504, 2048>(result, mp23_32_rd47_res);
	hw_uint<32>  mp23_32_rd48_res = mp23_32_rd48_select(in, d0, d1, d2);
	set_at<1536, 2048>(result, mp23_32_rd48_res);
	hw_uint<32>  mp23_32_rd49_res = mp23_32_rd49_select(in, d0, d1, d2);
	set_at<1568, 2048>(result, mp23_32_rd49_res);
	hw_uint<32>  mp23_32_rd50_res = mp23_32_rd50_select(in, d0, d1, d2);
	set_at<1600, 2048>(result, mp23_32_rd50_res);
	hw_uint<32>  mp23_32_rd51_res = mp23_32_rd51_select(in, d0, d1, d2);
	set_at<1632, 2048>(result, mp23_32_rd51_res);
	hw_uint<32>  mp23_32_rd52_res = mp23_32_rd52_select(in, d0, d1, d2);
	set_at<1664, 2048>(result, mp23_32_rd52_res);
	hw_uint<32>  mp23_32_rd53_res = mp23_32_rd53_select(in, d0, d1, d2);
	set_at<1696, 2048>(result, mp23_32_rd53_res);
	hw_uint<32>  mp23_32_rd54_res = mp23_32_rd54_select(in, d0, d1, d2);
	set_at<1728, 2048>(result, mp23_32_rd54_res);
	hw_uint<32>  mp23_32_rd55_res = mp23_32_rd55_select(in, d0, d1, d2);
	set_at<1760, 2048>(result, mp23_32_rd55_res);
	hw_uint<32>  mp23_32_rd56_res = mp23_32_rd56_select(in, d0, d1, d2);
	set_at<1792, 2048>(result, mp23_32_rd56_res);
	hw_uint<32>  mp23_32_rd57_res = mp23_32_rd57_select(in, d0, d1, d2);
	set_at<1824, 2048>(result, mp23_32_rd57_res);
	hw_uint<32>  mp23_32_rd58_res = mp23_32_rd58_select(in, d0, d1, d2);
	set_at<1856, 2048>(result, mp23_32_rd58_res);
	hw_uint<32>  mp23_32_rd59_res = mp23_32_rd59_select(in, d0, d1, d2);
	set_at<1888, 2048>(result, mp23_32_rd59_res);
	hw_uint<32>  mp23_32_rd60_res = mp23_32_rd60_select(in, d0, d1, d2);
	set_at<1920, 2048>(result, mp23_32_rd60_res);
	hw_uint<32>  mp23_32_rd61_res = mp23_32_rd61_select(in, d0, d1, d2);
	set_at<1952, 2048>(result, mp23_32_rd61_res);
	hw_uint<32>  mp23_32_rd62_res = mp23_32_rd62_select(in, d0, d1, d2);
	set_at<1984, 2048>(result, mp23_32_rd62_res);
	hw_uint<32>  mp23_32_rd63_res = mp23_32_rd63_select(in, d0, d1, d2);
	set_at<2016, 2048>(result, mp23_32_rd63_res);
	return result;
}
...
// Driver function
void mp23_32_opt(HWStream<hw_uint<1024> >& /* get_args num ports = 32 */in_oc, HWStream<hw_uint<512> >& /* get_args num ports = 16 */mp23_32, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("mp23_32_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // mp23_32_update_0 -> [1*d2*1*1 + 1*0,1*d1*1*2 + 1*1,1*d0*1*1 + 1*0,1*2]
	...
	mp23_32_update_0(in, mp23_32, (c2 - 0) / 1, (c1 - 1) / 2, (c0 - 0) / 1);
	      }
...
void mp23_32_opt(HWStream<hw_uint<1024> >& /* get_args num ports = 32 */in_oc, HWStream<hw_uint<512> >& /* get_args num ports = 16 */mp23_32) {

  mp23_32_opt(in_oc, mp23_32, 1);
}
#ifdef __VIVADO_SYNTH__
#include "mp23_32_opt.h"

const int in_update_0_read_num_transfers = 32768;
const int mp23_32_update_0_write_num_transfers = 16384;
...
static void write_mp23_32_update_0_write(hw_uint<512>* output, HWStream<hw_uint<512> >& v, const int size) {
  hw_uint<512> burst_reg;
  int num_transfers = mp23_32_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void mp23_32_opt_accel(hw_uint<1024>* in_update_0_read, hw_uint<512>* mp23_32_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = mp23_32_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = mp23_32_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<1024> > in_update_0_read_channel;
  static HWStream<hw_uint<512> > mp23_32_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  mp23_32_opt(in_update_0_read_channel, mp23_32_update_0_write_channel, size);

  write_mp23_32_update_0_write(mp23_32_update_0_write, mp23_32_update_0_write_channel, size);
}
