...
int main() {
  ofstream in_pix("input_pixels_regression_result_mp23_32_opt.txt");
  ofstream fout("regression_result_mp23_32_opt.txt");
  HWStream<hw_uint<1024> > in_update_0_read;
  HWStream<hw_uint<512> > mp23_32_update_0_write;
  ...
  mp23_32_opt(in_update_0_read, mp23_32_update_0_write);

  for (int i = 0; i < 16384; i++) {
    hw_uint<512> actual = mp23_32_update_0_write.read();
