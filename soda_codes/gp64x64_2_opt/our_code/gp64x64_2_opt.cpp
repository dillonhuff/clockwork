...
inline hw_uint<16> level_0_rd1_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  // DD fold: { level_0_update_0[d0, d1] -> 521 : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
...
inline hw_uint<16> level_0_rd6_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  // DD fold: { level_0_update_0[d0, d1] -> 1040 : 0 <= d0 <= 517 and 0 <= d1 <= 518; level_0_update_0[d0, d1] -> (522 + d0) : d0 = 518 and 0 <= d1 <= 518 }
...
inline hw_uint<16> level_0_rd7_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  // DD fold: { level_0_update_0[d0, d1] -> 520 : 0 <= d0 <= 517 and 0 <= d1 <= 518; level_0_update_0[d0, d1] -> (2 + d0) : d0 = 518 and 0 <= d1 <= 518 }
...
inline hw_uint<16> gp64x64_2_rd0_select(level_3_cache& level_3, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//	gp64x64_2_rd0
inline hw_uint<16> level_3_gp64x64_2_update_0_read_bundle_read(level_3_cache& level_3, int d0, int d1) {
  // # of ports in bundle: 1
    // gp64x64_2_rd0

	hw_uint<16> result;
	hw_uint<16> gp64x64_2_rd0_res = gp64x64_2_rd0_select(level_3, d0, d1);
...
inline void gp64x64_2_update_0(level_3_cache& level_3, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */gp64x64_2, int d0, int d1) {
	// Consume: level_3
	auto level_3_0_c__0_value = level_3_gp64x64_2_update_0_read_bundle_read(level_3/* source_delay */, d0, d1);
...
// Driver function
void gp64x64_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp64x64_2, int num_epochs) {
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	...
	level_1_update_0(level_0, level_1, (c1 - 3) / 2, (c0 - 6) / 4);
	    }
	
	    if ((7 <= c1 && c1 <= 519) && ((c1 - 7) % 4 == 0) && (14 <= c0 && c0 <= 1038) && ((c0 - 14) % 8 == 0)) {
	level_2_update_0(level_1, level_2, (c1 - 7) / 4, (c0 - 14) / 8);
	    }
	
	    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
	level_3_update_0(level_2, level_3, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
	
	    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
	gp64x64_2_update_0(level_3, gp64x64_2, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
...
void gp64x64_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp64x64_2) {
  ...
  gp64x64_2_opt(in_off_chip, gp64x64_2, 1);
}
#ifdef __VIVADO_SYNTH__
const int gp64x64_2_update_0_write_num_transfers = 4096;
const int in_update_0_read_num_transfers = 540280;
...
static void write_gp64x64_2_update_0_write(hw_uint<16>* output, HWStream<hw_uint<16> >& v, const int size) {
  hw_uint<16> burst_reg;
  int num_transfers = gp64x64_2_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void gp64x64_2_opt_accel(hw_uint<32>* in_update_0_read, hw_uint<16>* gp64x64_2_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp64x64_2_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = gp64x64_2_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<32> > in_update_0_read_channel;
  static HWStream<hw_uint<16> > gp64x64_2_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  gp64x64_2_opt(in_update_0_read_channel, gp64x64_2_update_0_write_channel, size);

  write_gp64x64_2_update_0_write(gp64x64_2_update_0_write, gp64x64_2_update_0_write_channel, size);
}
