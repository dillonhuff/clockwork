...
// compute file: gp64x64_2_opt_compute_units.h
#include "gp64x64_2_opt_compute_units.h"
...
struct in_in_update_0_write0_merged_banks_6_cache {
	...
	// Capacity: 1042
	// # of read delays: 6
  // 0, 1, 520, 521, 1040, 1041
	hw_uint<16> f0;
	hw_uint<16> f2;
	fifo<hw_uint<16>, 518> f3;
	hw_uint<16> f4;
	hw_uint<16> f6;
	fifo<hw_uint<16>, 518> f7;
	hw_uint<16> f8;
	hw_uint<16> f10;
...
struct in_in_update_0_write1_merged_banks_3_cache {
  ...
  // 0, 1, 521, 1041
	hw_uint<16> f0;
	hw_uint<16> f2;
	fifo<hw_uint<16>, 519> f3;
	hw_uint<16> f4;
	fifo<hw_uint<16>, 519> f5;
	hw_uint<16> f6;
...
inline hw_uint<16> level_0_rd0_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_1041();
...
inline hw_uint<16> level_0_rd1_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_521();
  return value_in_in_update_0_write0;
  return 0;
}
...
inline hw_uint<16> level_0_rd3_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_3.peek_1041();
...
inline hw_uint<16> level_0_rd4_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_3.peek_521();
  return value_in_in_update_0_write1;
  return 0;
}
...
inline hw_uint<16> level_0_rd6_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_1040();
  return value_in_in_update_0_write0;
  return 0;
}
...
inline hw_uint<16> level_0_rd7_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_6.peek_520();
  return value_in_in_update_0_write0;
  return 0;
}
...
inline hw_uint<16> level_1_rd0_select(level_0_cache& level_0, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 258 and 0 <= d1 <= 258 }
  // Write schedule: { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
...
inline hw_uint<16> level_2_rd0_select(level_1_cache& level_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 128 and 0 <= d1 <= 128 }
  // Write schedule: { level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 258 and 0 <= d1 <= 258 }
...
inline hw_uint<16> level_3_rd0_select(level_2_cache& level_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
  // Write schedule: { level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 128 and 0 <= d1 <= 128 }
...
struct level_3_level_3_update_0_write0_to_gp64x64_2_rd0_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct level_3_cache {
  // # of banks: 1
  level_3_level_3_update_0_write0_to_gp64x64_2_rd0_cache level_3_level_3_update_0_write0_to_gp64x64_2_rd0;
};
...
inline void level_3_level_3_update_0_write0_write(hw_uint<16>& level_3_level_3_update_0_write0, level_3_cache& level_3, int d0, int d1, int dynamic_address) {
  level_3.level_3_level_3_update_0_write0_to_gp64x64_2_rd0.push(level_3_level_3_update_0_write0);
}

inline hw_uint<16> gp64x64_2_rd0_select(level_3_cache& level_3, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp64x64_2_rd0 read pattern: { gp64x64_2_update_0[d0, d1] -> level_3[d0, d1] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
  // Read schedule : { gp64x64_2_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 6] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
  // Write schedule: { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
  auto value_level_3_level_3_update_0_write0 = level_3.level_3_level_3_update_0_write0_to_gp64x64_2_rd0.peek(/* one reader or all rams */ 0);
  return value_level_3_level_3_update_0_write0;
  return 0;
}

// # of bundles = 2
// gp64x64_2_update_0_read
//	gp64x64_2_rd0
inline hw_uint<16> level_3_gp64x64_2_update_0_read_bundle_read(level_3_cache& level_3, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // gp64x64_2_rd0

	hw_uint<16> result;
	hw_uint<16> gp64x64_2_rd0_res = gp64x64_2_rd0_select(level_3, d0, d1, dynamic_address);
	set_at<0, 16>(result, gp64x64_2_rd0_res);
	return result;
}
...
// Total re-use buffer capacity: 62432 bits
...
inline void gp64x64_2_update_0(level_3_cache& level_3, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */gp64x64_2, int d0, int d1) {
  // Dynamic address computation

	// Consume: level_3
	auto level_3_0_c__0_value = level_3_gp64x64_2_update_0_read_bundle_read(level_3/* source_delay */, d0, d1, 0);
	...
	// Produce: gp64x64_2
	gp64x64_2.write(compute_result);
...
// Driver function
void gp64x64_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp64x64_2) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("gp64x64_2_opt_debug.csv");
...
// schedule: { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 63 and 0 <= d1 <= 63; level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518; gp64x64_2_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 6] : 0 <= d0 <= 63 and 0 <= d1 <= 63; level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 128 and 0 <= d1 <= 128; in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038; level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 258 and 0 <= d1 <= 258 }
//   { level_3_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 5] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
// Condition for level_3_update_0(((-2 - i0 + 16*floord(2 + i0, 16) == 0) && (-1 - i1 + 8*floord(1 + i1, 8) == 0) && (-5 + i2 == 0) && (-15 + i1 >= 0) && (519 - i1 >= 0) && (-30 + i0 >= 0) && (1038 - i0 >= 0)))
//   { level_0_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 2] : 0 <= d0 <= 518 and 0 <= d1 <= 518 }
// Condition for level_0_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-2 + i2 == 0) && (-1 + i1 >= 0) && (519 - i1 >= 0) && (-2 + i0 >= 0) && (1038 - i0 >= 0)))
//   { gp64x64_2_update_0[d0, d1] -> [30 + 16d1, 15 + 8d0, 6] : 0 <= d0 <= 63 and 0 <= d1 <= 63 }
// Condition for gp64x64_2_update_0(((-2 - i0 + 16*floord(2 + i0, 16) == 0) && (-1 - i1 + 8*floord(1 + i1, 8) == 0) && (-6 + i2 == 0) && (-15 + i1 >= 0) && (519 - i1 >= 0) && (-30 + i0 >= 0) && (1038 - i0 >= 0)))
//   { level_2_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 4] : 0 <= d0 <= 128 and 0 <= d1 <= 128 }
// Condition for level_2_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-1 - i1 + 4*floord(1 + i1, 4) == 0) && (-4 + i2 == 0) && (-7 + i1 >= 0) && (519 - i1 >= 0) && (-14 + i0 >= 0) && (1038 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 519 and 0 <= d1 <= 1038 }
// Condition for in_update_0(((-1 + i2 == 0) && (i1 >= 0) && (519 - i1 >= 0) && (i0 >= 0) && (1038 - i0 >= 0)))
//   { level_1_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 3] : 0 <= d0 <= 258 and 0 <= d1 <= 258 }
// Condition for level_1_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-1 - i1 + 2*floord(1 + i1, 2) == 0) && (-3 + i2 == 0) && (-3 + i1 >= 0) && (519 - i1 >= 0) && (-6 + i0 >= 0) && (1038 - i0 >= 0)))

  /*
  // Schedules...
    // gp64x64_2_update_0 -> [1*d1*1*16 + 1*30,1*d0*1*8 + 1*15,1*6]
...
for (int c0 = 0; c0 <= 1038; c0++) {
  for (int c1 = 0; c1 <= 519; c1++) {

#ifdef __VIVADO_SYNTH__
#pragma HLS pipeline II=1
#endif // __VIVADO_SYNTH__

    if ((0 <= c1 && c1 <= 519) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 1038) && ((c0 - 0) % 1 == 0)) {
      in_update_0((c1 - 0) / 1, (c0 - 0) / 1);
    }

    if ((1 <= c1 && c1 <= 519) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1038) && ((c0 - 2) % 2 == 0)) {
      level_0_update_0((c1 - 1) / 1, (c0 - 2) / 2);
    }

    if ((3 <= c1 && c1 <= 519) && ((c1 - 3) % 2 == 0) && (6 <= c0 && c0 <= 1038) && ((c0 - 6) % 4 == 0)) {
      level_1_update_0((c1 - 3) / 2, (c0 - 6) / 4);
    }

    if ((7 <= c1 && c1 <= 519) && ((c1 - 7) % 4 == 0) && (14 <= c0 && c0 <= 1038) && ((c0 - 14) % 8 == 0)) {
      level_2_update_0((c1 - 7) / 4, (c0 - 14) / 8);
    }

    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
      level_3_update_0((c1 - 15) / 8, (c0 - 30) / 16);
    }

    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
      gp64x64_2_update_0((c1 - 15) / 8, (c0 - 30) / 16);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((3 <= c1 && c1 <= 519) && ((c1 - 3) % 2 == 0) && (6 <= c0 && c0 <= 1038) && ((c0 - 6) % 4 == 0)) {
	      level_1_update_0(level_0 /* buf name */, level_1, (c1 - 3) / 2, (c0 - 6) / 4);
	    }
	
	    if ((7 <= c1 && c1 <= 519) && ((c1 - 7) % 4 == 0) && (14 <= c0 && c0 <= 1038) && ((c0 - 14) % 8 == 0)) {
	      level_2_update_0(level_1 /* buf name */, level_2, (c1 - 7) / 4, (c0 - 14) / 8);
	    }
	
	    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
	      level_3_update_0(level_2 /* buf name */, level_3, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
	
	    if ((15 <= c1 && c1 <= 519) && ((c1 - 15) % 8 == 0) && (30 <= c0 && c0 <= 1038) && ((c0 - 30) % 16 == 0)) {
	      gp64x64_2_update_0(level_3 /* buf name */, gp64x64_2, (c1 - 15) / 8, (c0 - 30) / 16);
	    }
...
void gp64x64_2_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp64x64_2, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    gp64x64_2_opt(in_off_chip, gp64x64_2);
  }
}
#ifdef __VIVADO_SYNTH__
  // { gp64x64_2_update_0[root = 0, gp64x64_2_0, gp64x64_2_1] -> gp64x64_2[0, 0] : 0 <= gp64x64_2_0 <= 63 and 0 <= gp64x64_2_1 <= 63 }
const int gp64x64_2_update_0_write_pipe0_num_transfers = 4096;
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : 0 <= in_0 <= 519 and 0 <= in_1 <= 1038 }
const int in_update_0_read_pipe0_num_transfers = 540280;


extern "C" {

void gp64x64_2_opt_accel(hw_uint<32>* in_update_0_read_pipe0, hw_uint<16>* gp64x64_2_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp64x64_2_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = gp64x64_2_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > gp64x64_2_update_0_write_pipe0_channel;

  burst_read<32>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  gp64x64_2_opt_wrapper(in_update_0_read_pipe0_channel, gp64x64_2_update_0_write_pipe0_channel, size);

  burst_write<16>(gp64x64_2_update_0_write_pipe0, gp64x64_2_update_0_write_pipe0_channel, gp64x64_2_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void gp64x64_2_opt_rdai(HWStream<hw_uint<32> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  gp64x64_2_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = gp64x64_2_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  gp64x64_2_opt(in_update_0_read_pipe0, gp64x64_2_update_0_write_pipe0);
