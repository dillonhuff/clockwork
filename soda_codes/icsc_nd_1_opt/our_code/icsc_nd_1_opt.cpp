...
// compute file: icsc_nd_1_opt_compute_units.h
#include "icsc_nd_1_opt_compute_units.h"
...
struct stg9_stg9_update_0_write0_to_icsc_nd_1_rd0_cache {
...
struct stg9_cache {
  // # of banks: 1
  stg9_stg9_update_0_write0_to_icsc_nd_1_rd0_cache stg9_stg9_update_0_write0_to_icsc_nd_1_rd0;
};
...
inline void stg9_stg9_update_0_write0_write(hw_uint<16>& stg9_stg9_update_0_write0, stg9_cache& stg9, int d0, int d1, int dynamic_address) {
  stg9.stg9_stg9_update_0_write0_to_icsc_nd_1_rd0.push(stg9_stg9_update_0_write0);
}

inline hw_uint<16> icsc_nd_1_rd0_select(stg9_cache& stg9, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // icsc_nd_1_rd0 read pattern: { icsc_nd_1_update_0[d0, d1] -> stg9[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { icsc_nd_1_update_0[d0, d1] -> [10 + d1, 10 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg9_stg9_update_0_write0 = stg9.stg9_stg9_update_0_write0_to_icsc_nd_1_rd0.peek(/* one reader or all rams */ 0);
  return value_stg9_stg9_update_0_write0;
  return 0;
}

// # of bundles = 2
// icsc_nd_1_update_0_read
//	icsc_nd_1_rd0
inline hw_uint<16> stg9_icsc_nd_1_update_0_read_bundle_read(stg9_cache& stg9, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // icsc_nd_1_rd0

	hw_uint<16> result;
	hw_uint<16> icsc_nd_1_rd0_res = icsc_nd_1_rd0_select(stg9, d0, d1, dynamic_address);
	set_at<0, 16>(result, icsc_nd_1_rd0_res);
	return result;
}
...
inline void icsc_nd_1_update_0(stg9_cache& stg9, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */icsc_nd_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg9
	auto stg9_0_c__0_value = stg9_icsc_nd_1_update_0_read_bundle_read(stg9/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = icsc_nd_1_generated_compute_unrolled_1(stg9_0_c__0_value);
	// Produce: icsc_nd_1
	icsc_nd_1.write(compute_result);
...
// Driver function
void icsc_nd_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */icsc_nd_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("icsc_nd_1_opt_debug.csv");
...
// schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081; stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080; stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083; stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085; icsc_nd_1_update_0[d0, d1] -> [10 + d1, 10 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086; stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082; stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084; stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088; stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087; in_update_0[d0, d1] -> [d1, d0, 1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
...
//   { icsc_nd_1_update_0[d0, d1] -> [10 + d1, 10 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for icsc_nd_1_update_0(((-12 + i2 == 0) && (-10 + i1 >= 0) && (1929 - i1 >= 0) && (-10 + i0 >= 0) && (1089 - i0 >= 0)))
...
// Condition for in_update_0(((-1 + i2 == 0) && (10 + i1 >= 0) && (1929 - i1 >= 0) && (i0 >= 0) && (1089 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // icsc_nd_1_update_0 -> [1*d1*1*1 + 1*10,1*d0*1*1 + 1*10,1*12]
...
#pragma HLS pipeline II=1
    ...
    if ((10 <= c1 && c1 <= 1929) && ((c1 - 10) % 1 == 0) && (10 <= c0 && c0 <= 1089) && ((c0 - 10) % 1 == 0)) {
      icsc_nd_1_update_0((c1 - 10) / 1, (c0 - 10) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((10 <= c1 && c1 <= 1929) && ((c1 - 10) % 1 == 0) && (10 <= c0 && c0 <= 1089) && ((c0 - 10) % 1 == 0)) {
	      icsc_nd_1_update_0(stg9 /* buf name */, icsc_nd_1, (c1 - 10) / 1, (c0 - 10) / 1);
	    }
...
void icsc_nd_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */icsc_nd_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    icsc_nd_1_opt(in_off_chip, icsc_nd_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { icsc_nd_1_update_0[root = 0, icsc_nd_1_0, icsc_nd_1_1] -> icsc_nd_1[0, 0] : 0 <= icsc_nd_1_0 <= 1919 and 0 <= icsc_nd_1_1 <= 1079 }
const int icsc_nd_1_update_0_write_pipe0_num_transfers = 2073600;
...
void icsc_nd_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* icsc_nd_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = icsc_nd_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = icsc_nd_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > icsc_nd_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  icsc_nd_1_opt_wrapper(in_update_0_read_pipe0_channel, icsc_nd_1_update_0_write_pipe0_channel, size);

  burst_write<16>(icsc_nd_1_update_0_write_pipe0, icsc_nd_1_update_0_write_pipe0_channel, icsc_nd_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void icsc_nd_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  icsc_nd_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = icsc_nd_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  icsc_nd_1_opt(in_update_0_read_pipe0, icsc_nd_1_update_0_write_pipe0);
