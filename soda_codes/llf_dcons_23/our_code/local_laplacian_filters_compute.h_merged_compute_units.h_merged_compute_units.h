...
hw_uint<96> color_out_float_ld1263_cu2601(hw_uint<32*3>& color_out_float) {
...
hw_uint<96> color_in_int_ld1258_cu2605(hw_uint<32*3>& color_in_int) {
  return color_in_int;
}

hw_uint<96> color_in_ld1253_cu2607(hw_uint<32*3>& color_in) {
  return color_in;
}

hw_uint<96> color_in_to_gp_01246_ld1884_cu2609(hw_uint<32*3>& color_in_to_gp_01246) {
...
hw_uint<96> color_in_to_gp_11251_ld1889_cu2613(hw_uint<32*3>& color_in_to_gp_11251) {
  return color_in_to_gp_11251;
}

hw_uint<96> color_out_float_to_gp_621261_ld1899_cu2615(hw_uint<32*3>& color_out_float_to_gp_621261) {
