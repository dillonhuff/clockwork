...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > sbl9_32_1_merged271_write_channel;
  // In lanes = 32
  ...
  sbl9_32_opt(img_1_merged262_read_channel, sbl9_32_1_merged271_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      auto packed_val = sbl9_32_1_merged271_write_channel.read();
  ...
  output.save_image("./images/sbl9_32_opt_bmp_out.bmp");
}
