...
#ifdef __VIVADO_SYNTH__
#include "sobel_16_unrolled_1_opt.h"
...
void sobel_16_unrolled_1_opt_accel(hw_uint<16>* img_update_0_read, hw_uint<16>* sobel_16_unrolled_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read offset = slave bundle = gmem
#pragma HLS INTERFACE m_axi port = sobel_16_unrolled_1_update_0_write offset = slave bundle = gmem

#pragma HLS INTERFACE s_axilite port = img_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = sobel_16_unrolled_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<16> > img_update_0_read_channel;
  static HWStream<hw_uint<16> > sobel_16_unrolled_1_update_0_write_channel;

  read_input(img_update_0_read, img_update_0_read_channel, size);

  sobel_16_unrolled_1_opt(img_update_0_read_channel, sobel_16_unrolled_1_update_0_write_channel);

  write_output(sobel_16_unrolled_1_update_0_write, sobel_16_unrolled_1_update_0_write_channel, size);
}
