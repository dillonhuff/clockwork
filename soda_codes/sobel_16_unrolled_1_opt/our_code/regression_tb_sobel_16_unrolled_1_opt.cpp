...
int main() {
  ofstream in_pix("input_pixels_regression_result_sobel_16_unrolled_1_opt.txt");
  ofstream fout("regression_result_sobel_16_unrolled_1_opt.txt");
  HWStream<hw_uint<16> > img_update_0_read;
  HWStream<hw_uint<16> > sobel_16_unrolled_1_update_0_write;
