...
int main(int argc, char **argv) {
  ...
  pyr_blnd2d500_2048(pw_math_in03_read_channel, pw_math_lp_in_on_chip_0_buf48_reconstruct_lp70_buf737982_write_channel);
  ...
  output.save_image("./images/pyr_blnd2d500_2048_bmp_out.bmp");
}
