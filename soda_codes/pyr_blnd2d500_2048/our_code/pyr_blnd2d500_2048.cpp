...
inline hw_uint<32>  lp_in_on_chip_1_buf40_FIFO_buf316_rc69_16_select(lp_in_on_chip_1_buf40_FIFO_buf316_cache& lp_in_on_chip_1_buf40_FIFO_buf316, int root, int lp_in_on_chip_1_buf40_reconstruct_lp6162, int lp_in_on_chip_1_buf40_reconstruct_lp6163, int dynamic_address) {
  ...
  // Write schedule: { load_to_lp_in_on_chip_1_buf40_FIFO_buf316319[d0 = 0, d1, d2] -> [0, 10 + 2d1, 14 + 2d2, 48] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
// schedule: { load_to_gp_in_on_chip_2_buf12_us36_FIFO_buf280283[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 38] : 0 <= d1 <= 31 and 0 <= d2 <= 31; load_to_lp_in_on_chip_1_buf40_to_gp_6228231[d0 = 0, d1, d2] -> [0, 10 + 2d1, 14 + 2d2, 43] : 0 <= d1 <= 31 and 0 <= d2 <= 31; load_to_gp_in_on_chip_1_buf4_FIFO_buf260263[d0 = 0, d1, d2] -> [0, 4 + 2d1, 4 + 2d2, 7] : 3 <= d1 <= 34 and 3 <= d2 <= 34; diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 40] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
// Condition for diff43(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-40 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, 43] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 14 <= i2 <= 76; [0, i1, i2, 40] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 38] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 7] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72 }
	// # sets: 1
	for (int i0 = 0; i0 <= 0; i0++) {
	  for (int i1 = 10; i1 <= 72; i1++) {
...
//   { load_to_lp_in_on_chip_1_buf40_FIFO_buf316319[d0 = 0, d1, d2] -> [0, 10 + 2d1, 14 + 2d2, 48] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for load_to_lp_in_on_chip_1_buf40_FIFO_buf316319(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-48 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((76 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, i3] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 14 <= i1 <= 76 and 14 <= i2 <= 76 and 50 <= i3 <= 52; [0, i1, i2, 48] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 14 <= i2 <= 76 }
	// # sets: 1
	for (int i0 = 0; i0 <= 0; i0++) {
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gp_in_on_chip_1_buf4_to_gp_5172.values depth=1532
#endif //__VIVADO_SYNTH__
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=lp_in_on_chip_0_buf48_to_gp_4220.values depth=890
#endif //__VIVADO_SYNTH__
