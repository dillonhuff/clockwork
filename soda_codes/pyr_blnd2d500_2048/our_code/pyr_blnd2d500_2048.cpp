...
inline hw_uint<32>  gp_in_on_chip_1_buf4_gp_in_on_chip_214_merged160_88_select(gp_in_on_chip_1_buf4_cache& gp_in_on_chip_1_buf4, int root, int gp_in_on_chip_213, int gp_in_on_chip_214, int dynamic_address) {
  ...
  // Read schedule : { gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_1_buf4_load_to_gp_in_on_chip_1_buf4_to_gp_5164167_74_select(gp_in_on_chip_1_buf4_cache& gp_in_on_chip_1_buf4, int root, int gp_in_on_chip_1_buf4_ld166, int gp_in_on_chip_1_buf4_ld165, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_1_buf4_to_gp_5164167[d0 = 0, d1, d2] -> [0, 4 + 2d1, 4 + 2d2, 4] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
  // Write schedule: { gp_in_on_chip_16_merged163[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 1] : 0 <= d1 <= 34 and 0 <= d2 <= 34 }
...
inline hw_uint<32>  gp_in_on_chip_1_buf4_us47_7_select(gp_in_on_chip_1_buf4_cache& gp_in_on_chip_1_buf4, int root, int us_gp_in_on_chip_1_buf445, int us_gp_in_on_chip_1_buf446, int dynamic_address) {
  ...
  // Read schedule : { us47[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 9] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { gp_in_on_chip_16_merged163[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 1] : 0 <= d1 <= 34 and 0 <= d2 <= 34 }
...
inline hw_uint<32>  gp_in_on_chip_1_buf4_FIFO_buf168_diff43_111_select(gp_in_on_chip_1_buf4_FIFO_buf168_cache& gp_in_on_chip_1_buf4_FIFO_buf168, int root, int lp_in_on_chip_141, int lp_in_on_chip_142, int dynamic_address) {
  ...
  // Read schedule : { diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 19] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  gp_in_on_chip_1_buf4_us44_load_to_gp_in_on_chip_1_buf4_us44_to_gp_3172175_70_select(gp_in_on_chip_1_buf4_us44_cache& gp_in_on_chip_1_buf4_us44, int root, int gp_in_on_chip_1_buf4_us44_ld174, int gp_in_on_chip_1_buf4_us44_ld173, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_1_buf4_us44_to_gp_3172175[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 10] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { us47[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 9] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_load_to_gp_in_on_chip_2_buf12_to_gp_2180183_64_select(gp_in_on_chip_2_buf12_cache& gp_in_on_chip_2_buf12, int root, int gp_in_on_chip_2_buf12_ld182, int gp_in_on_chip_2_buf12_ld181, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_2_buf12_to_gp_2180183[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 11] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
  // Write schedule: { gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_load_to_gp_in_on_chip_2_buf12_to_gp_7188191_62_select(gp_in_on_chip_2_buf12_cache& gp_in_on_chip_2_buf12, int root, int gp_in_on_chip_2_buf12_ld190, int gp_in_on_chip_2_buf12_ld189, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 3] : 0 < d1 <= 16 and 0 < d2 <= 16 }
  // Write schedule: { gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
  auto value_gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged160_87 = gp_in_on_chip_2_buf12.gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged160_87_to_gp_in_on_chip_2_buf12_load_to_gp_in_on_chip_2_buf12_to_gp_7188191_62.peek(/* one reader or all rams */ (15 - gp_in_on_chip_2_buf12_ld189 >= 0) ? (1) : 0);
  return value_gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged160_87;
  return 0;
}
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_us39_9_select(gp_in_on_chip_2_buf12_cache& gp_in_on_chip_2_buf12, int root, int us_gp_in_on_chip_2_buf1237, int us_gp_in_on_chip_2_buf1238, int dynamic_address) {
  ...
  // Read schedule : { us39[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 8] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
struct gp_in_on_chip_2_buf12_FIFO_buf184_cache {
  // Reader addrs...
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
    // { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // # of banks: 1
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 2 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 1 + 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[1 + 2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86_select(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86 read pattern: { gp_in_on_chip_322_merged157[root = 0, gp_in_on_chip_321, gp_in_on_chip_322] -> gp_in_on_chip_2_buf12_FIFO_buf184[2 + 2gp_in_on_chip_322, 2gp_in_on_chip_321] : 0 <= gp_in_on_chip_321 <= 7 and 0 <= gp_in_on_chip_322 <= 7 }
  // Read schedule : { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85
//	gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86
inline hw_uint<288> gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_read_bundle_read(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, int root, int gp_in_on_chip_321, int gp_in_on_chip_322, int dynamic_address) {
  // # of ports in bundle: 9
    // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78
    // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79
    // gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80
	...
	hw_uint<288> result;
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<0, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_78_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<32, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_79_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<64, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_80_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<96, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_81_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<128, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_82_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<160, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_83_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<192, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_84_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<224, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_85_res);
	hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86_res = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86_select(gp_in_on_chip_2_buf12_FIFO_buf184, root, gp_in_on_chip_321, gp_in_on_chip_322, dynamic_address);
	set_at<256, 288>(result, gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_86_res);
	return result;
}
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_FIFO_buf192_diff35_114_select(gp_in_on_chip_2_buf12_FIFO_buf192_cache& gp_in_on_chip_2_buf12_FIFO_buf192, int root, int lp_in_on_chip_233, int lp_in_on_chip_234, int dynamic_address) {
  ...
  // Write schedule: { load_to_gp_in_on_chip_2_buf12_FIFO_buf192195[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 7] : 0 < d1 <= 16 and 0 < d2 <= 16 }
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_us36_load_to_gp_in_on_chip_2_buf12_us36_to_gp_5196199_58_select(gp_in_on_chip_2_buf12_us36_cache& gp_in_on_chip_2_buf12_us36, int root, int gp_in_on_chip_2_buf12_us36_ld198, int gp_in_on_chip_2_buf12_us36_ld197, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_2_buf12_us36_to_gp_5196199[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 12] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { us39[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 8] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  gp_in_on_chip_3_buf20_us31_11_select(gp_in_on_chip_3_buf20_cache& gp_in_on_chip_3_buf20, int root, int us_gp_in_on_chip_3_buf2029, int us_gp_in_on_chip_3_buf2030, int dynamic_address) {
  ...
  // Write schedule: { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
...
inline hw_uint<32>  gp_in_on_chip_3_buf20_us59_5_select(gp_in_on_chip_3_buf20_cache& gp_in_on_chip_3_buf20, int root, int us_gp_in_on_chip_3_buf2057, int us_gp_in_on_chip_3_buf2058, int dynamic_address) {
  ...
  // Read schedule : { us59[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 24] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
  // Write schedule: { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
...
inline hw_uint<32>  gp_in_on_chip_3_buf20_us56_load_to_gp_in_on_chip_3_buf20_us56_to_gp_8212215_50_select(gp_in_on_chip_3_buf20_us56_cache& gp_in_on_chip_3_buf20_us56, int root, int gp_in_on_chip_3_buf20_us56_ld214, int gp_in_on_chip_3_buf20_us56_ld213, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_3_buf20_us56_to_gp_8212215[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 25] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
  // Write schedule: { us59[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 24] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
...
inline hw_uint<32>  gp_in_on_chip_3_buf20_us56_FIFO_buf216_rc60_20_select(gp_in_on_chip_3_buf20_us56_FIFO_buf216_cache& gp_in_on_chip_3_buf20_us56_FIFO_buf216, int root, int lp_in_on_chip_2_buf32_reconstruct_lp5253, int lp_in_on_chip_2_buf32_reconstruct_lp5254, int dynamic_address) {
  ...
  // Write schedule: { load_to_gp_in_on_chip_3_buf20_us56_FIFO_buf216219[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 26] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
...
inline hw_uint<32>  in_on_chip_load_to_in_on_chip_to_gp_3220223_46_select(in_on_chip_cache& in_on_chip, int root, int in_on_chip_ld222, int in_on_chip_ld221, int dynamic_address) {
  ...
  // Read schedule : { load_to_in_on_chip_to_gp_3220223[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 6] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
  // Write schedule: { pw_math_in03[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 70 and 0 <= d2 <= 70 }
...
inline hw_uint<32>  in_on_chip_FIFO_buf224_diff51_108_select(in_on_chip_FIFO_buf224_cache& in_on_chip_FIFO_buf224, int root, int lp_in_on_chip_049, int lp_in_on_chip_050, int dynamic_address) {
  ...
  // Read schedule : { diff51[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 17] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { load_to_in_on_chip_FIFO_buf224227[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 13] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
...
inline hw_uint<32>  lp_in_on_chip_0_buf48_load_to_lp_in_on_chip_0_buf48_to_gp_4228231_42_select(lp_in_on_chip_0_buf48_cache& lp_in_on_chip_0_buf48, int root, int lp_in_on_chip_0_buf48_ld230, int lp_in_on_chip_0_buf48_ld229, int dynamic_address) {
  ...
  // Read schedule : { load_to_lp_in_on_chip_0_buf48_to_gp_4228231[d0 = 0, d1, d2] -> [0, 8 + d1, 14 + d2, 21] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { diff51[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 17] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_lp_in_on_chip_0_buf48_diff51_107 = lp_in_on_chip_0_buf48.lp_in_on_chip_0_buf48_diff51_107_to_lp_in_on_chip_0_buf48_load_to_lp_in_on_chip_0_buf48_to_gp_4228231_42.peek(/* one reader or all rams */ (-58 + lp_in_on_chip_0_buf48_ld229 == 0) ? (5) : (57 - lp_in_on_chip_0_buf48_ld229 >= 0) ? (6) : (-59 + lp_in_on_chip_0_buf48_ld229 >= 0 && 62 - lp_in_on_chip_0_buf48_ld229 >= 0) ? ((63 - lp_in_on_chip_0_buf48_ld229)) : 0);
...
inline hw_uint<32>  lp_in_on_chip_1_buf40_load_to_lp_in_on_chip_1_buf40_to_gp_6236239_34_select(lp_in_on_chip_1_buf40_cache& lp_in_on_chip_1_buf40, int root, int lp_in_on_chip_1_buf40_ld238, int lp_in_on_chip_1_buf40_ld237, int dynamic_address) {
  ...
  // Read schedule : { load_to_lp_in_on_chip_1_buf40_to_gp_6236239[d0 = 0, d1, d2] -> [0, 14 + 2d1, 14 + 2d2, 20] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 19] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
inline hw_uint<32>  lp_in_on_chip_1_buf40_FIFO_buf240_rc69_16_select(lp_in_on_chip_1_buf40_FIFO_buf240_cache& lp_in_on_chip_1_buf40_FIFO_buf240, int root, int lp_in_on_chip_1_buf40_reconstruct_lp6162, int lp_in_on_chip_1_buf40_reconstruct_lp6163, int dynamic_address) {
  ...
  // Write schedule: { load_to_lp_in_on_chip_1_buf40_FIFO_buf240243[d0 = 0, d1, d2] -> [0, 14 + 2d1, 14 + 2d2, 23] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
// Total re-use buffer capacity: 17760 bits
// Operation logic
...
inline void gp_in_on_chip_322_merged157(gp_in_on_chip_2_buf12_FIFO_buf184_cache& gp_in_on_chip_2_buf12_FIFO_buf184, gp_in_on_chip_3_buf20_cache& gp_in_on_chip_3_buf20, int d0, int d1, int d2) {
  // Dynamic address computation

	// Consume: gp_in_on_chip_2_buf12_FIFO_buf184
	auto gp_in_on_chip_2_buf12_FIFO_buf184_2_m_gp_in_on_chip_322__p___m_1_p_1_c_____2_m_gp_in_on_chip_321__p__1_p_1_value = gp_in_on_chip_2_buf12_FIFO_buf184_gp_in_on_chip_322_merged157_read_bundle_read(gp_in_on_chip_2_buf12_FIFO_buf184/* source_delay */, d0, d1, d2, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = gp_in_on_chip_322_cu155(gp_in_on_chip_2_buf12_FIFO_buf184_2_m_gp_in_on_chip_322__p___m_1_p_1_c_____2_m_gp_in_on_chip_321__p__1_p_1_value);
...
// schedule: { us59[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 24] : 0 <= d1 <= 15 and 0 <= d2 <= 15; gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7; us31[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 22] : 0 <= d1 <= 15 and 0 <= d2 <= 15; load_to_gp_in_on_chip_3_buf20_us28_to_gp_7204207[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 27] : 0 <= d1 <= 15 and 0 <= d2 <= 15; load_to_gp_in_on_chip_3_buf20_us56_to_gp_8212215[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 25] : 0 <= d1 <= 15 and 0 <= d2 <= 15; load_to_gp_in_on_chip_2_buf12_FIFO_buf184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 14] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
//   { us59[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 24] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
// Condition for us59(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-24 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((74 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))
//   { gp_in_on_chip_322_merged157[d0 = 0, d1, d2] -> [0, 14 + 8d1, 14 + 8d2, 18] : 0 <= d1 <= 7 and 0 <= d2 <= 7 }
// Condition for gp_in_on_chip_322_merged157(((((-2 + -1*i1 + (8*(((2 + 1*i1)) >> 3)))) == 0) && (((-2 + -1*i2 + (8*(((2 + 1*i2)) >> 3)))) == 0) && (((-18 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
...
//   { load_to_gp_in_on_chip_3_buf20_us56_to_gp_8212215[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 25] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
// Condition for load_to_gp_in_on_chip_3_buf20_us56_to_gp_8212215(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-25 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((74 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))
...
// Condition for load_to_gp_in_on_chip_2_buf12_FIFO_buf184187(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-14 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-6 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-6 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, i3] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 14 <= i1 <= 74 and 14 <= i2 <= 74 and 24 <= i3 <= 25; [0, i1, i2, 27] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 14 <= i1 <= 74 and 14 <= i2 <= 74; [0, i1, i2, 22] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 14 <= i1 <= 74 and 14 <= i2 <= 74; [0, i1, i2, 18] : (2 + i1) mod 8 = 0 and (2 + i2) mod 8 = 0 and 14 <= i1 <= 70 and 14 <= i2 <= 70; [0, i1, i2, 14] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 6 <= i1 <= 70 and 6 <= i2 <= 70 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        if ((((((-2 + -1*i2 + (8*(((2 + 1*i2)) >> 3)))) == 0) && (((-2 + -1*i1 + (8*(((2 + 1*i1)) >> 3)))) == 0) && (((-14 + 1*i1)) >= 0) && (((-14 + 1*i2)) >= 0)))) {
	          gp_in_on_chip_322_merged157(gp_in_on_chip_2_buf12_FIFO_buf184 /* buf name */, gp_in_on_chip_3_buf20, 0, ((-2 + (1*(((2 + 1*i1)) >> 3)))), ((-2 + (1*(((2 + 1*i2)) >> 3)))));
	        }
...
//   { load_to_lp_in_on_chip_0_buf48_to_gp_4228231[d0 = 0, d1, d2] -> [0, 8 + d1, 14 + d2, 21] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for load_to_lp_in_on_chip_0_buf48_to_gp_4228231(((((-21 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((77 + -1*i2)) >= 0)))
...
//   { load_to_in_on_chip_FIFO_buf224227[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 13] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
// Condition for load_to_in_on_chip_FIFO_buf224227(((((-13 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, 21] : 8 <= i1 <= 71 and 14 <= i2 <= 77; [0, i1, i2, 17] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 15] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 13] : 8 <= i1 <= 71 and 8 <= i2 <= 71 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : i2 >= 14 }
	          // { [i0, i1, i2] : -14 + i2 >= 0 }
	        if ((((((-14 + 1*i2)) >= 0)))) {
	          load_to_lp_in_on_chip_0_buf48_to_gp_4228231(lp_in_on_chip_0_buf48 /* buf name */, lp_in_on_chip_0_buf48_to_gp_4228, 0, ((-8 + 1*i1)), ((-14 + 1*i2)));
	        }
	    }
	  }
...
// schedule: { load_to_lp_in_on_chip_1_buf40_to_gp_6236239[d0 = 0, d1, d2] -> [0, 14 + 2d1, 14 + 2d2, 20] : 0 <= d1 <= 31 and 0 <= d2 <= 31; load_to_gp_in_on_chip_1_buf4_FIFO_buf168171[d0 = 0, d1, d2] -> [0, 4 + 2d1, 4 + 2d2, 5] : 3 <= d1 <= 34 and 3 <= d2 <= 34; load_to_gp_in_on_chip_2_buf12_us36_FIFO_buf200203[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 16] : 0 <= d1 <= 31 and 0 <= d2 <= 31; diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 19] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
//   { load_to_lp_in_on_chip_1_buf40_to_gp_6236239[d0 = 0, d1, d2] -> [0, 14 + 2d1, 14 + 2d2, 20] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for load_to_lp_in_on_chip_1_buf40_to_gp_6236239(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-20 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((76 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((76 + -1*i2)) >= 0)))
...
//   { diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 19] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for diff43(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-19 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, 20] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 14 <= i1 <= 76 and 14 <= i2 <= 76; [0, i1, i2, 19] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 16] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 5] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72 }
	// # sets: 1
	int i0 = 0;
...
//   { load_to_lp_in_on_chip_1_buf40_FIFO_buf240243[d0 = 0, d1, d2] -> [0, 14 + 2d1, 14 + 2d2, 23] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for load_to_lp_in_on_chip_1_buf40_FIFO_buf240243(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-23 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((76 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((76 + -1*i2)) >= 0)))
...
// Condition for load_to_lp_in_on_chip_2_buf32_reconstruct_lp52_buf55_us65_FIFO_buf264267(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-36 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((76 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((76 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, i3] : 14 <= i1 <= 77 and 14 <= i2 <= 77 and 36 <= i3 <= 39 and (i3 >= 38 or ((i1) mod 2 = 0 and (i2) mod 2 = 0 and i1 <= 76 and i2 <= 76 and i3 <= 37)); [0, i1, i2, 23] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 14 <= i1 <= 76 and 14 <= i2 <= 76 }
	// # sets: 1
	int i0 = 0;
	  for (int i1 = 14; i1 <= 77; i1++) {
	    for (int i2 = 14; i2 <= 77; i2++) {
...
//   { load_to_gp_in_on_chip_2_buf12_FIFO_buf192195[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 7] : 0 < d1 <= 16 and 0 < d2 <= 16 }
// Condition for load_to_gp_in_on_chip_2_buf12_FIFO_buf192195(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-7 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, i3] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 14 <= i1 <= 74 and 14 <= i2 <= 74 and 29 <= i3 <= 31; [0, i1, i2, 7] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 10 <= i1 <= 70 and 14 <= i2 <= 74 }
	// # sets: 1
	int i0 = 0;
...
//   { load_to_gp_in_on_chip_3_buf20_us56_FIFO_buf216219[d0 = 0, d1, d2] -> [0, 14 + 4d1, 14 + 4d2, 26] : 0 <= d1 <= 15 and 0 <= d2 <= 15 }
// Condition for load_to_gp_in_on_chip_3_buf20_us56_FIFO_buf216219(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-26 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-14 + 1*i1)) >= 0) && (((74 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))
...
// schedule: { load_to_gp_in_on_chip_1_buf4_to_gp_5164167[d0 = 0, d1, d2] -> [0, 4 + 2d1, 4 + 2d2, 4] : 3 <= d1 <= 34 and 3 <= d2 <= 34; load_to_gp_in_on_chip_1_buf4_us44_to_gp_3172175[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 10] : 0 <= d1 <= 63 and 0 <= d2 <= 63; us47[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 9] : 0 <= d1 <= 63 and 0 <= d2 <= 63; gp_in_on_chip_16_merged163[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 1] : 0 <= d1 <= 34 and 0 <= d2 <= 34; load_to_gp_in_on_chip_2_buf12_to_gp_2180183[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 11] : 0 <= d1 <= 16 and 0 <= d2 <= 16; load_to_in_on_chip_to_gp_3220223[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 6] : 7 <= d1 <= 70 and 7 <= d2 <= 70; load_to_gp_in_on_chip_2_buf12_us36_to_gp_5196199[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 12] : 0 <= d1 <= 31 and 0 <= d2 <= 31; pw_math_in03[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 70 and 0 <= d2 <= 70; load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 3] : 0 < d1 <= 16 and 0 < d2 <= 16; gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16; us39[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 8] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
//   { load_to_gp_in_on_chip_1_buf4_to_gp_5164167[d0 = 0, d1, d2] -> [0, 4 + 2d1, 4 + 2d2, 4] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
// Condition for load_to_gp_in_on_chip_1_buf4_to_gp_5164167(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-4 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))
//   { load_to_gp_in_on_chip_1_buf4_us44_to_gp_3172175[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 10] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for load_to_gp_in_on_chip_1_buf4_us44_to_gp_3172175(((((-10 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
//   { us47[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 9] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for us47(((((-9 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
...
//   { load_to_gp_in_on_chip_2_buf12_to_gp_2180183[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 11] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
// Condition for load_to_gp_in_on_chip_2_buf12_to_gp_2180183(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-11 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-6 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-6 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
//   { load_to_in_on_chip_to_gp_3220223[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 6] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
// Condition for load_to_in_on_chip_to_gp_3220223(((((-6 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
//   { load_to_gp_in_on_chip_2_buf12_us36_to_gp_5196199[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 12] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for load_to_gp_in_on_chip_2_buf12_us36_to_gp_5196199(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-12 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))
...
//   { load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 3] : 0 < d1 <= 16 and 0 < d2 <= 16 }
// Condition for load_to_gp_in_on_chip_2_buf12_to_gp_7188191(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-3 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))
//   { gp_in_on_chip_214_merged160[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 2] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
// Condition for gp_in_on_chip_214_merged160(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-2 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-6 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-6 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
//   { us39[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 8] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for us39(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-8 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, i3] : 8 <= i1 <= 71 and 8 <= i2 <= 71 and 9 <= i3 <= 10; [0, i1, i2, 12] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 11] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 6 <= i1 <= 70 and 6 <= i2 <= 70; [0, i1, i2, 8] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 6] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 4] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 3] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 10 <= i1 <= 70 and 14 <= i2 <= 74; [0, i1, i2, 2] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 6 <= i1 <= 70 and 6 <= i2 <= 70; [0, i1, i2, 1] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 2 <= i1 <= 70 and 2 <= i2 <= 70; [0, i1, i2, 0] : 0 <= i1 <= 70 and 0 <= i2 <= 70 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and i1 >= 10 and 10 <= i2 <= 72 }
	        // { [i0, i1, i2] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and i1 >= 10 and 10 <= i2 <= 72 }
	          // { [i0, i1, i2] : -i2 + 2*floor((i2)/2) = 0 }
	          // { [i0, i1, i2] : -i1 + 2*floor((i1)/2) = 0 }
	          // { [i0, i1, i2] : -10 + i1 >= 0 }
	          // { [i0, i1, i2] : -10 + i2 >= 0 }
	          // { [i0, i1, i2] : 72 - i2 >= 0 }
	        if ((((((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-10 + 1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))) {
...
// Bits to slack match lp_in_on_chip_2_buf32_to_gp_8252 = 16000
// Bits in internal re-use buffers               : 17760 bits
// Bits in channels needed to guarantee causality: 12288
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=lp_in_on_chip_0_buf48_to_gp_4228.values depth=884
#endif //__VIVADO_SYNTH__
