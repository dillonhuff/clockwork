...
inline hw_uint<32>  in_on_chip_FIFO_buf244_diff51_108_select(in_on_chip_FIFO_buf244_cache& in_on_chip_FIFO_buf244, int root, int lp_in_on_chip_049, int lp_in_on_chip_050, int dynamic_address) {
  ...
  // Read schedule : { diff51[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 31] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { load_to_in_on_chip_FIFO_buf244247[d0 = 0, d1, d2] -> [0, 1 + d1, d2, 23] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
  auto value_in_on_chip_FIFO_buf244_load_to_in_on_chip_FIFO_buf244247_47 = in_on_chip_FIFO_buf244.in_on_chip_FIFO_buf244_load_to_in_on_chip_FIFO_buf244247_47_to_in_on_chip_FIFO_buf244_diff51_108.peek(/* one reader or all rams */ (62 - lp_in_on_chip_050 >= 0) ? (1) : 0);
...
//   { load_to_in_on_chip_FIFO_buf244247[d0 = 0, d1, d2] -> [0, 1 + d1, d2, 23] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
// Condition for load_to_in_on_chip_FIFO_buf244247(((((-23 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-7 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
...
// Condition for load_to_gp_in_on_chip_1_buf4_us44_FIFO_buf220223(((((-30 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, i3] : 8 <= i1 <= 71 and 8 <= i2 <= 71 and 30 <= i3 <= 32; [0, i1, i2, 23] : 8 <= i1 <= 71 and 7 <= i2 <= 70 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : i2 <= 70 }
	          // { [i0, i1, i2] : 70 - i2 >= 0 }
	        if ((((((70 + -1*i2)) >= 0)))) {
	          load_to_in_on_chip_FIFO_buf244247(in_on_chip_to_gp_3192 /* buf name */, in_on_chip_FIFO_buf244, 0, ((-1 + 1*i1)), ((1*i2)));
	        }
	        // { [i0, i1, i2] : i2 >= 8 }
	        // { [i0, i1, i2] : i2 >= 8 }
	          // { [i0, i1, i2] : -8 + i2 >= 0 }
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=in_on_chip_to_gp_3192.values depth=96
#endif //__VIVADO_SYNTH__
