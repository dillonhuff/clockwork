...
inline hw_uint<32>  gp_in_on_chip_1_buf4_load_to_gp_in_on_chip_1_buf4_to_gp_5172175_102_select(gp_in_on_chip_1_buf4_cache& gp_in_on_chip_1_buf4, int root, int gp_in_on_chip_1_buf4_ld174, int gp_in_on_chip_1_buf4_ld173, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_1_buf4_to_gp_5172175[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 8] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
  // Write schedule: { gp_in_on_chip_16_merged160[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 5] : 0 <= d1 <= 34 and 0 <= d2 <= 34 }
  auto value_gp_in_on_chip_1_buf4_gp_in_on_chip_16_merged160_133 = gp_in_on_chip_1_buf4.gp_in_on_chip_1_buf4_gp_in_on_chip_16_merged160_133_to_gp_in_on_chip_1_buf4_load_to_gp_in_on_chip_1_buf4_to_gp_5172175_102.peek(/* one reader or all rams */ 0);
  return value_gp_in_on_chip_1_buf4_gp_in_on_chip_16_merged160_133;
  return 0;
}
...
inline hw_uint<32>  gp_in_on_chip_1_buf4_FIFO_buf260_diff43_147_select(gp_in_on_chip_1_buf4_FIFO_buf260_cache& gp_in_on_chip_1_buf4_FIFO_buf260, int root, int lp_in_on_chip_141, int lp_in_on_chip_142, int dynamic_address) {
  ...
  // Write schedule: { load_to_gp_in_on_chip_1_buf4_FIFO_buf260263[d0 = 0, d1, d2] -> [0, 2 + 2d1, 4 + 2d2, 9] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
  auto value_gp_in_on_chip_1_buf4_FIFO_buf260_load_to_gp_in_on_chip_1_buf4_FIFO_buf260263_107 = gp_in_on_chip_1_buf4_FIFO_buf260.gp_in_on_chip_1_buf4_FIFO_buf260_load_to_gp_in_on_chip_1_buf4_FIFO_buf260263_107_to_gp_in_on_chip_1_buf4_FIFO_buf260_diff43_147.peek(/* one reader or all rams */ (30 - lp_in_on_chip_142 >= 0 && 30 - lp_in_on_chip_141 >= 0) ? (32) : (-31 + lp_in_on_chip_142 == 0 && 30 - lp_in_on_chip_141 >= 0) ? (32) : (-31 + lp_in_on_chip_141 == 0 && 30 - lp_in_on_chip_142 >= 0) ? ((31 - lp_in_on_chip_142)) : 0);
...
inline hw_uint<32>  gp_in_on_chip_2_buf12_load_to_gp_in_on_chip_2_buf12_to_gp_7188191_86_select(gp_in_on_chip_2_buf12_cache& gp_in_on_chip_2_buf12, int root, int gp_in_on_chip_2_buf12_ld190, int gp_in_on_chip_2_buf12_ld189, int dynamic_address) {
  ...
  // Read schedule : { load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 14] : 0 < d1 <= 16 and 0 < d2 <= 16 }
  // Write schedule: { gp_in_on_chip_214_merged157[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 12] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
  auto value_gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged157_123 = gp_in_on_chip_2_buf12.gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged157_123_to_gp_in_on_chip_2_buf12_load_to_gp_in_on_chip_2_buf12_to_gp_7188191_86.peek(/* one reader or all rams */ (15 - gp_in_on_chip_2_buf12_ld189 >= 0) ? (1) : 0);
  return value_gp_in_on_chip_2_buf12_gp_in_on_chip_214_merged157_123;
  return 0;
}
...
inline hw_uint<32>  lp_in_on_chip_0_buf48_load_to_lp_in_on_chip_0_buf48_to_gp_4220223_50_select(lp_in_on_chip_0_buf48_cache& lp_in_on_chip_0_buf48, int root, int lp_in_on_chip_0_buf48_ld222, int lp_in_on_chip_0_buf48_ld221, int dynamic_address) {
  ...
  // Read schedule : { load_to_lp_in_on_chip_0_buf48_to_gp_4220223[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 26] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { diff51[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 23] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_lp_in_on_chip_0_buf48_diff51_143 = lp_in_on_chip_0_buf48.lp_in_on_chip_0_buf48_diff51_143_to_lp_in_on_chip_0_buf48_load_to_lp_in_on_chip_0_buf48_to_gp_4220223_50.peek(/* one reader or all rams */ 0);
...
//   { load_to_gp_in_on_chip_1_buf4_to_gp_5172175[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 8] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
// Condition for load_to_gp_in_on_chip_1_buf4_to_gp_5172175(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-8 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, 8] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 8 <= i1 <= 70 and 8 <= i2 <= 70; [0, i1, i2, 7] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 2 <= i1 <= 70 and 2 <= i2 <= 70; [0, i1, i2, 6] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 8 <= i1 <= 70 and 8 <= i2 <= 70; [0, i1, i2, 5] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 2 <= i1 <= 70 and 2 <= i2 <= 70; [0, i1, i2, 3] : 0 <= i1 <= 70 and 0 <= i2 <= 70 }
	// # sets: 1
	int i0 = 0;
...
// schedule: { load_to_gp_in_on_chip_1_buf4_FIFO_buf252255[d0 = 0, d1, d2] -> [0, 2 + 2d1, 2 + 2d2, 11] : 0 <= d1 <= 34 and 0 <= d2 <= 34; load_to_gp_in_on_chip_2_buf12_to_gp_12180183[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 16] : 0 < d1 <= 16 and 0 < d2 <= 16; load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 14] : 0 < d1 <= 16 and 0 < d2 <= 16; load_to_gp_in_on_chip_2_buf12_to_gp_2184187[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 19] : 0 <= d1 <= 16 and 0 <= d2 <= 16; gp_in_on_chip_214_merged157[d0 = 0, d1, d2] -> [0, 6 + 4d1, 6 + 4d2, 12] : 0 <= d1 <= 16 and 0 <= d2 <= 16 }
...
//   { load_to_gp_in_on_chip_2_buf12_to_gp_7188191[d0 = 0, d1, d2] -> [0, 6 + 4d1, 10 + 4d2, 14] : 0 < d1 <= 16 and 0 < d2 <= 16 }
// Condition for load_to_gp_in_on_chip_2_buf12_to_gp_7188191(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-14 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((74 + -1*i2)) >= 0)))
...
// Condition for gp_in_on_chip_214_merged157(((((-2 + -1*i1 + (4*(((2 + 1*i1)) >> 2)))) == 0) && (((-2 + -1*i2 + (4*(((2 + 1*i2)) >> 2)))) == 0) && (((-12 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-6 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-6 + 1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, 19] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 6 <= i1 <= 70 and 6 <= i2 <= 70; [0, i1, i2, 16] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 10 <= i1 <= 70 and 10 <= i2 <= 70; [0, i1, i2, 14] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 10 <= i1 <= 70 and 14 <= i2 <= 74; [0, i1, i2, 12] : (2 + i1) mod 4 = 0 and (2 + i2) mod 4 = 0 and 6 <= i1 <= 70 and 6 <= i2 <= 70; [0, i1, i2, 11] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 2 <= i1 <= 70 and 2 <= i2 <= 70 }
	// # sets: 1
	int i0 = 0;
...
//   { load_to_lp_in_on_chip_0_buf48_to_gp_4220223[d0 = 0, d1, d2] -> [0, 8 + d1, 8 + d2, 26] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for load_to_lp_in_on_chip_0_buf48_to_gp_4220223(((((-26 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
...
// Condition for load_to_in_on_chip_FIFO_buf304307(((((-4 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, 26] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 23] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 17] : 8 <= i1 <= 71 and 8 <= i2 <= 71; [0, i1, i2, 4] : 8 <= i1 <= 71 and 8 <= i2 <= 71 }
	// # sets: 1
	int i0 = 0;
	  for (int i1 = 8; i1 <= 71; i1++) {
	    for (int i2 = 8; i2 <= 71; i2++) {
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] :  }
	        if ((true)) {
	          load_to_lp_in_on_chip_0_buf48_to_gp_4220223(lp_in_on_chip_0_buf48 /* buf name */, lp_in_on_chip_0_buf48_to_gp_4220, 0, ((-8 + 1*i1)), ((-8 + 1*i2)));
	        }
	    }
	  }
...
// schedule: { load_to_gp_in_on_chip_2_buf12_us36_FIFO_buf280283[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 33] : 0 <= d1 <= 31 and 0 <= d2 <= 31; load_to_lp_in_on_chip_1_buf40_to_gp_6228231[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 40] : 0 <= d1 <= 31 and 0 <= d2 <= 31; load_to_gp_in_on_chip_1_buf4_FIFO_buf260263[d0 = 0, d1, d2] -> [0, 2 + 2d1, 4 + 2d2, 9] : 3 <= d1 <= 34 and 3 <= d2 <= 34; diff43[d0 = 0, d1, d2] -> [0, 10 + 2d1, 10 + 2d2, 38] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
...
//   { load_to_gp_in_on_chip_1_buf4_FIFO_buf260263[d0 = 0, d1, d2] -> [0, 2 + 2d1, 4 + 2d2, 9] : 3 <= d1 <= 34 and 3 <= d2 <= 34 }
// Condition for load_to_gp_in_on_chip_1_buf4_FIFO_buf260263(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-9 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))
...
// Condition for diff43(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-38 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-10 + 1*i2)) >= 0) && (((72 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, 40] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 38] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 33] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 10 <= i2 <= 72; [0, i1, i2, 9] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 8 <= i1 <= 70 and 10 <= i2 <= 72 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        if ((((((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((70 + -1*i1)) >= 0)))) {
	          load_to_gp_in_on_chip_1_buf4_FIFO_buf260263(gp_in_on_chip_1_buf4_to_gp_5172 /* buf name */, gp_in_on_chip_1_buf4_FIFO_buf260, 0, ((-1 + (1*(((1*i1)) >> 1)))), ((-2 + (1*(((1*i2)) >> 1)))));
	        }
...
//   { load_to_lp_in_on_chip_1_buf40_FIFO_buf316319[d0 = 0, d1, d2] -> [0, 10 + 2d1, 14 + 2d2, 42] : 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for load_to_lp_in_on_chip_1_buf40_FIFO_buf316319(((((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-42 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-10 + 1*i1)) >= 0) && (((72 + -1*i1)) >= 0) && (((-14 + 1*i2)) >= 0) && (((76 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, i3] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 14 <= i1 <= 76 and 14 <= i2 <= 76 and 50 <= i3 <= 52; [0, i1, i2, 42] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and 10 <= i1 <= 72 and 14 <= i2 <= 76 }
	// # sets: 1
	int i0 = 0;
	  for (int i1 = 10; i1 <= 76; i1++) {
	    for (int i2 = 14; i2 <= 76; i2++) {
	#pragma HLS pipeline II=1
	        // { [i0, i1, i2] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and i1 <= 72 }
	        // { [i0, i1, i2] : (i1) mod 2 = 0 and (i2) mod 2 = 0 and i1 <= 72 }
	          // { [i0, i1, i2] : -i2 + 2*floor((i2)/2) = 0 }
	          // { [i0, i1, i2] : -i1 + 2*floor((i1)/2) = 0 }
	          // { [i0, i1, i2] : 72 - i1 >= 0 }
	        if ((((((-1*i2 + (2*(((1*i2)) >> 1)))) == 0) && (((-1*i1 + (2*(((1*i1)) >> 1)))) == 0) && (((72 + -1*i1)) >= 0)))) {
...
// schedule: { pw_math_in03[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 70 and 0 <= d2 <= 70; load_to_in_on_chip_to_gp_3216219[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 2] : 7 <= d1 <= 70 and 7 <= d2 <= 70; load_to_in_on_chip_to_gp_0212215[d0 = 0, d1, d2] -> [0, d1, d2, 1] : 0 <= d1 <= 70 and 0 <= d2 <= 70 }
...
//   { load_to_in_on_chip_to_gp_3216219[d0 = 0, d1, d2] -> [0, 1 + d1, 1 + d2, 2] : 7 <= d1 <= 70 and 7 <= d2 <= 70 }
// Condition for load_to_in_on_chip_to_gp_3216219(((((-2 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-8 + 1*i1)) >= 0) && (((71 + -1*i1)) >= 0) && (((-8 + 1*i2)) >= 0) && (((71 + -1*i2)) >= 0)))
...
// Condition for load_to_in_on_chip_to_gp_0212215(((((-1 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((70 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((70 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, i3] : 0 <= i1 <= 70 and 0 <= i2 <= 70 and 0 <= i3 <= 1; [0, i1, i2, 2] : 8 <= i1 <= 71 and 8 <= i2 <= 71 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        if ((((((-8 + 1*i1)) >= 0) && (((-8 + 1*i2)) >= 0)))) {
	          load_to_in_on_chip_to_gp_3216219(in_on_chip /* buf name */, in_on_chip_to_gp_3216, 0, ((-1 + 1*i1)), ((-1 + 1*i2)));
	        }
	    }
	  }
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gp_in_on_chip_1_buf4_to_gp_5172.values depth=33
#endif //__VIVADO_SYNTH__
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gp_in_on_chip_2_buf12_to_gp_7188.values depth=48
#endif //__VIVADO_SYNTH__
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=in_on_chip_to_gp_3216.values depth=32
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > lp_in_on_chip_0_buf48_to_gp_4220;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=lp_in_on_chip_0_buf48_to_gp_4220.values depth=422
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > lp_in_on_chip_1_buf40_to_gp_6228;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=lp_in_on_chip_1_buf40_to_gp_6228.values depth=34
#endif //__VIVADO_SYNTH__
