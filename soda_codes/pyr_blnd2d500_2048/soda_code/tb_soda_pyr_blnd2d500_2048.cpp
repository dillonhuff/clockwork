// AUTO GEN SODA TB
#include "pyr_blnd2d500_2048_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  pyr_blnd2d500_2048_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_pyr_blnd2d500_2048_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
