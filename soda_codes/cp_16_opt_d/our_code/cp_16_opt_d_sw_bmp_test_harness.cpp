...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > cp_16_1_merged1209_write_channel;
  // In lanes = 16
  ...
  cp_16_opt_d(raw_1_merged1179_read_channel, cp_16_1_merged1209_write_channel);
  bitmap_image output(1088, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1088 / 16; cl++) {
      auto packed_val = cp_16_1_merged1209_write_channel.read();
  ...
  output.save_image("./images/cp_16_opt_d_bmp_out.bmp");
}
