...
int main(int argc, char **argv) {
  ...
  OCL_CHECK(err, cl::Buffer diff_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, diff_write_size_bytes, diff_write.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(0, diff_write_pipe0_ocl_buf));
