...
inline hw_uint<32>  gray_load_to_gray_to_gp_1232_5_select(gray_cache& gray, int root, int gray_ld1, int gray_ld0, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_load_to_gray_to_gp_1232_5 read pattern: { load_to_gray_to_gp_1232[root = 0, gray_ld1, gray_ld0] -> gray[gray_ld0, gray_ld1] : 0 <= gray_ld1 <= 63 and 0 <= gray_ld0 <= 63 }
  auto value_gray_oc_load_in03_0 = gray.gray_all_inputs_to_all_outputs.read(gray_ld0 - 0, gray_ld1 - 0);
  return value_gray_oc_load_in03_0;
  return 0;
}

inline hw_uint<32>  gray_load_to_gray_to_gp_2245_3_select(gray_cache& gray, int root, int gray_ld4, int gray_ld3, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_load_to_gray_to_gp_2245_3 read pattern: { load_to_gray_to_gp_2245[root = 0, gray_ld4, gray_ld3] -> gray[gray_ld3, gray_ld4] : 0 <= gray_ld4 <= 65 and 0 <= gray_ld3 <= 65 }
  auto value_gray_oc_load_in03_0 = gray.gray_all_inputs_to_all_outputs.read(gray_ld3 - 0, gray_ld4 - 0);
  return value_gray_oc_load_in03_0;
  return 0;
}

// # of bundles = 3
// load_to_gray_to_gp_1232_read
//	gray_load_to_gray_to_gp_1232_5
inline hw_uint<32> gray_load_to_gray_to_gp_1232_read_bundle_read(gray_cache& gray, int root, int gray_ld1, int gray_ld0, int dynamic_address) {
  // # of ports in bundle: 1
    // gray_load_to_gray_to_gp_1232_5

	hw_uint<32> result;
	hw_uint<32>  gray_load_to_gray_to_gp_1232_5_res = gray_load_to_gray_to_gp_1232_5_select(gray, root, gray_ld1, gray_ld0, dynamic_address);
	set_at<0, 32>(result, gray_load_to_gray_to_gp_1232_5_res);
	return result;
}

// load_to_gray_to_gp_2245_read
//	gray_load_to_gray_to_gp_2245_3
inline hw_uint<32> gray_load_to_gray_to_gp_2245_read_bundle_read(gray_cache& gray, int root, int gray_ld4, int gray_ld3, int dynamic_address) {
  // # of ports in bundle: 1
    // gray_load_to_gray_to_gp_2245_3

	hw_uint<32> result;
	hw_uint<32>  gray_load_to_gray_to_gp_2245_3_res = gray_load_to_gray_to_gp_2245_3_select(gray, root, gray_ld4, gray_ld3, dynamic_address);
	set_at<0, 32>(result, gray_load_to_gray_to_gp_2245_3_res);
	return result;
}
...
// Operation logic
inline void load_to_gray_to_gp_2245(gray_cache& gray, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */gray_to_gp_224, int root, int gray_ld4, int gray_ld3) {
  // Dynamic address computation

	// Consume: gray
	auto gray_gray_ld3_c__gray_ld4_value = gray_load_to_gray_to_gp_2245_read_bundle_read(gray/* source_delay */, root, gray_ld4, gray_ld3, 0);
...
inline void load_to_gray_to_gp_1232(gray_cache& gray, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */gray_to_gp_123, int root, int gray_ld1, int gray_ld0) {
  // Dynamic address computation

	// Consume: gray
	auto gray_gray_ld0_c__gray_ld1_value = gray_load_to_gray_to_gp_1232_read_bundle_read(gray/* source_delay */, root, gray_ld1, gray_ld0, 0);
...
// schedule: { load_to_gray_to_gp_1232[root = 0, gray_ld1, gray_ld0] -> [gray_ld1, gray_ld0, 1] : 0 <= gray_ld1 <= 63 and 0 <= gray_ld0 <= 63; oc_load_in03[root = 0, oc_load_in01, oc_load_in02] -> [oc_load_in01, oc_load_in02, 0] : 0 <= oc_load_in01 <= 65 and 0 <= oc_load_in02 <= 65; load_to_gray_to_gp_2245[root = 0, gray_ld4, gray_ld3] -> [gray_ld4, gray_ld3, 2] : 0 <= gray_ld4 <= 65 and 0 <= gray_ld3 <= 65 }
//   { load_to_gray_to_gp_1232[root = 0, gray_ld1, gray_ld0] -> [gray_ld1, gray_ld0, 1] : 0 <= gray_ld1 <= 63 and 0 <= gray_ld0 <= 63 }
// Condition for load_to_gray_to_gp_1232(((-1 + i2 == 0) && (i0 >= 0) && (63 - i0 >= 0) && (i1 >= 0) && (63 - i1 >= 0)))
...
//   { load_to_gray_to_gp_2245[root = 0, gray_ld4, gray_ld3] -> [gray_ld4, gray_ld3, 2] : 0 <= gray_ld4 <= 65 and 0 <= gray_ld3 <= 65 }
// Condition for load_to_gray_to_gp_2245(((-2 + i2 == 0) && (i0 >= 0) && (65 - i0 >= 0) && (i1 >= 0) && (65 - i1 >= 0)))
...
for (int c0 = 0; c0 <= 65; c0 += 1)
  for (int c1 = 0; c1 <= 65; c1 += 1) {
    ...
    if (c0 <= 63 && c1 <= 63)
      load_to_gray_to_gp_1232(0, c0, c1);
    load_to_gray_to_gp_2245(0, c0, c1);
  }
  ...
  */
	for (int c0 = 0; c0 <= 65; c0 += 1)
	  for (int c1 = 0; c1 <= 65; c1 += 1) {
	    ...
	    if (c0 <= 63 && c1 <= 63)
	      load_to_gray_to_gp_1232(gray /* buf name */, gray_to_gp_123, 0, c0, c1);
	    load_to_gray_to_gp_2245(gray /* buf name */, gray_to_gp_224, 0, c0, c1);
	  }
...
inline hw_uint<32>  gray_FIFO_buf17_pw_math_gray1215_1_select(gray_FIFO_buf17_cache& gray_FIFO_buf17, int root, int pw_math_gray1213, int pw_math_gray1214, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_FIFO_buf17_pw_math_gray1215_1 read pattern: { pw_math_gray1215[root = 0, pw_math_gray1213, pw_math_gray1214] -> gray_FIFO_buf17[pw_math_gray1214, pw_math_gray1213] : 0 <= pw_math_gray1213 <= 63 and 0 <= pw_math_gray1214 <= 63 }
...
//	gray_FIFO_buf17_pw_math_gray1215_1
inline hw_uint<32> gray_FIFO_buf17_pw_math_gray1215_read_bundle_read(gray_FIFO_buf17_cache& gray_FIFO_buf17, int root, int pw_math_gray1213, int pw_math_gray1214, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<32> result;
	hw_uint<32>  gray_FIFO_buf17_pw_math_gray1215_1_res = gray_FIFO_buf17_pw_math_gray1215_1_select(gray_FIFO_buf17, root, pw_math_gray1213, pw_math_gray1214, dynamic_address);
	set_at<0, 32>(result, gray_FIFO_buf17_pw_math_gray1215_1_res);
	return result;
}
...
inline hw_uint<32>  gray_diff_load_to_gray_diff_to_gp_4275_3_select(gray_diff_cache& gray_diff, int root, int gray_diff_ld4, int gray_diff_ld3, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_diff_load_to_gray_diff_to_gp_4275_3 read pattern: { load_to_gray_diff_to_gp_4275[root = 0, gray_diff_ld4, gray_diff_ld3] -> gray_diff[gray_diff_ld3, gray_diff_ld4] : 0 <= gray_diff_ld4 <= 63 and 0 <= gray_diff_ld3 <= 63 }
  auto value_gray_diff_pw_math_gray1215_0 = gray_diff.gray_diff_all_inputs_to_all_outputs.read(gray_diff_ld3 - 0, gray_diff_ld4 - 0);
  return value_gray_diff_pw_math_gray1215_0;
  return 0;
}

// # of bundles = 2
// load_to_gray_diff_to_gp_4275_read
//	gray_diff_load_to_gray_diff_to_gp_4275_3
inline hw_uint<32> gray_diff_load_to_gray_diff_to_gp_4275_read_bundle_read(gray_diff_cache& gray_diff, int root, int gray_diff_ld4, int gray_diff_ld3, int dynamic_address) {
  // # of ports in bundle: 1
    // gray_diff_load_to_gray_diff_to_gp_4275_3

	hw_uint<32> result;
	hw_uint<32>  gray_diff_load_to_gray_diff_to_gp_4275_3_res = gray_diff_load_to_gray_diff_to_gp_4275_3_select(gray_diff, root, gray_diff_ld4, gray_diff_ld3, dynamic_address);
	set_at<0, 32>(result, gray_diff_load_to_gray_diff_to_gp_4275_3_res);
	return result;
}
...
// Operation logic
inline void load_to_gray_diff_to_gp_4275(gray_diff_cache& gray_diff, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */gray_diff_to_gp_427, int root, int gray_diff_ld4, int gray_diff_ld3) {
  // Dynamic address computation

	// Consume: gray_diff
	auto gray_diff_gray_diff_ld3_c__gray_diff_ld4_value = gray_diff_load_to_gray_diff_to_gp_4275_read_bundle_read(gray_diff/* source_delay */, root, gray_diff_ld4, gray_diff_ld3, 0);
...
//   { load_to_gray_diff_to_gp_4275[root = 0, gray_diff_ld4, gray_diff_ld3] -> [gray_diff_ld4, gray_diff_ld3, 2] : 0 <= gray_diff_ld4 <= 63 and 0 <= gray_diff_ld3 <= 63 }
// Condition for load_to_gray_diff_to_gp_4275(((-2 + i2 == 0) && (i0 >= 0) && (63 - i0 >= 0) && (i1 >= 0) && (63 - i1 >= 0)))
...
for (int c0 = 0; c0 <= 63; c0 += 1)
  for (int c1 = 0; c1 <= 63; c1 += 1) {
    ...
    load_to_gray_diff_to_gp_4275(0, c0, c1);
  }
  ...
  */
	for (int c0 = 0; c0 <= 63; c0 += 1)
	  for (int c1 = 0; c1 <= 63; c1 += 1) {
	    ...
	    load_to_gray_diff_to_gp_4275(gray_diff /* buf name */, gray_diff_to_gp_427, 0, c0, c1);
	  }
...
inline hw_uint<32>  gray_FIFO_buf18_pw_math_gray47_1_select(gray_FIFO_buf18_cache& gray_FIFO_buf18, int root, int pw_math_gray45, int pw_math_gray46, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_FIFO_buf18_pw_math_gray47_1 read pattern: { pw_math_gray47[root = 0, pw_math_gray45, pw_math_gray46] -> gray_FIFO_buf18[pw_math_gray46, pw_math_gray45] : 0 <= pw_math_gray45 <= 65 and 0 <= pw_math_gray46 <= 65 }
...
// pw_math_gray47_read
//	gray_FIFO_buf18_pw_math_gray47_1
inline hw_uint<32> gray_FIFO_buf18_pw_math_gray47_read_bundle_read(gray_FIFO_buf18_cache& gray_FIFO_buf18, int root, int pw_math_gray45, int pw_math_gray46, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<32> result;
	hw_uint<32>  gray_FIFO_buf18_pw_math_gray47_1_res = gray_FIFO_buf18_pw_math_gray47_1_select(gray_FIFO_buf18, root, pw_math_gray45, pw_math_gray46, dynamic_address);
	set_at<0, 32>(result, gray_FIFO_buf18_pw_math_gray47_1_res);
	return result;
}
...
inline hw_uint<32>  gray_blur_load_to_gray_blur_to_gp_3255_3_select(gray_blur_cache& gray_blur, int root, int gray_blur_ld4, int gray_blur_ld3, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_blur_load_to_gray_blur_to_gp_3255_3 read pattern: { load_to_gray_blur_to_gp_3255[root = 0, gray_blur_ld4, gray_blur_ld3] -> gray_blur[gray_blur_ld3, gray_blur_ld4] : 0 <= gray_blur_ld4 <= 65 and 0 <= gray_blur_ld3 <= 65 }
  auto value_gray_blur_pw_math_gray47_0 = gray_blur.gray_blur_all_inputs_to_all_outputs.read(gray_blur_ld3 - 0, gray_blur_ld4 - 0);
  return value_gray_blur_pw_math_gray47_0;
  return 0;
}

// # of bundles = 2
// load_to_gray_blur_to_gp_3255_read
//	gray_blur_load_to_gray_blur_to_gp_3255_3
inline hw_uint<32> gray_blur_load_to_gray_blur_to_gp_3255_read_bundle_read(gray_blur_cache& gray_blur, int root, int gray_blur_ld4, int gray_blur_ld3, int dynamic_address) {
  // # of ports in bundle: 1
    // gray_blur_load_to_gray_blur_to_gp_3255_3

	hw_uint<32> result;
	hw_uint<32>  gray_blur_load_to_gray_blur_to_gp_3255_3_res = gray_blur_load_to_gray_blur_to_gp_3255_3_select(gray_blur, root, gray_blur_ld4, gray_blur_ld3, dynamic_address);
	set_at<0, 32>(result, gray_blur_load_to_gray_blur_to_gp_3255_3_res);
	return result;
}
...
inline void load_to_gray_blur_to_gp_3255(gray_blur_cache& gray_blur, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */gray_blur_to_gp_325, int root, int gray_blur_ld4, int gray_blur_ld3) {
  // Dynamic address computation

	// Consume: gray_blur
	auto gray_blur_gray_blur_ld3_c__gray_blur_ld4_value = gray_blur_load_to_gray_blur_to_gp_3255_read_bundle_read(gray_blur/* source_delay */, root, gray_blur_ld4, gray_blur_ld3, 0);
...
// schedule: { load_to_gray_FIFO_buf182[root = 0, gray_ld1, gray_ld0] -> [gray_ld1, gray_ld0, 0] : 0 <= gray_ld1 <= 65 and 0 <= gray_ld0 <= 65; pw_math_gray47[root = 0, pw_math_gray45, pw_math_gray46] -> [pw_math_gray45, pw_math_gray46, 1] : 0 <= pw_math_gray45 <= 65 and 0 <= pw_math_gray46 <= 65; load_to_gray_blur_to_gp_3255[root = 0, gray_blur_ld4, gray_blur_ld3] -> [gray_blur_ld4, gray_blur_ld3, 2] : 0 <= gray_blur_ld4 <= 65 and 0 <= gray_blur_ld3 <= 65 }
...
//   { load_to_gray_blur_to_gp_3255[root = 0, gray_blur_ld4, gray_blur_ld3] -> [gray_blur_ld4, gray_blur_ld3, 2] : 0 <= gray_blur_ld4 <= 65 and 0 <= gray_blur_ld3 <= 65 }
// Condition for load_to_gray_blur_to_gp_3255(((-2 + i2 == 0) && (i0 >= 0) && (65 - i0 >= 0) && (i1 >= 0) && (65 - i1 >= 0)))
...
for (int c0 = 0; c0 <= 65; c0 += 1)
  for (int c1 = 0; c1 <= 65; c1 += 1) {
    ...
    load_to_gray_blur_to_gp_3255(0, c0, c1);
  }
  ...
  */
	for (int c0 = 0; c0 <= 65; c0 += 1)
	  for (int c1 = 0; c1 <= 65; c1 += 1) {
	    ...
	    load_to_gray_blur_to_gp_3255(gray_blur /* buf name */, gray_blur_to_gp_325, 0, c0, c1);
	  }
...
inline hw_uint<32>  gray_blur_FIFO_buf19_pw_math_gray_blur811_1_select(gray_blur_FIFO_buf19_cache& gray_blur_FIFO_buf19, int root, int pw_math_gray_blur89, int pw_math_gray_blur810, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_blur_FIFO_buf19_pw_math_gray_blur811_1 read pattern: { pw_math_gray_blur811[root = 0, pw_math_gray_blur89, pw_math_gray_blur810] -> gray_blur_FIFO_buf19[pw_math_gray_blur810, pw_math_gray_blur89] : 0 <= pw_math_gray_blur89 <= 65 and 0 <= pw_math_gray_blur810 <= 65 }
...
//	gray_blur_FIFO_buf19_pw_math_gray_blur811_1
inline hw_uint<32> gray_blur_FIFO_buf19_pw_math_gray_blur811_read_bundle_read(gray_blur_FIFO_buf19_cache& gray_blur_FIFO_buf19, int root, int pw_math_gray_blur89, int pw_math_gray_blur810, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<32> result;
	hw_uint<32>  gray_blur_FIFO_buf19_pw_math_gray_blur811_1_res = gray_blur_FIFO_buf19_pw_math_gray_blur811_1_select(gray_blur_FIFO_buf19, root, pw_math_gray_blur89, pw_math_gray_blur810, dynamic_address);
	set_at<0, 32>(result, gray_blur_FIFO_buf19_pw_math_gray_blur811_1_res);
	return result;
}
...
inline hw_uint<32>  gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3_select(gray_blur_cache_cache& gray_blur_cache, int root, int gray_blur_cache_ld4, int gray_blur_cache_ld3, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3 read pattern: { load_to_gray_blur_cache_to_gp_5265[root = 0, gray_blur_cache_ld4, gray_blur_cache_ld3] -> gray_blur_cache[gray_blur_cache_ld3, gray_blur_cache_ld4] : 0 <= gray_blur_cache_ld4 <= 65 and 0 <= gray_blur_cache_ld3 <= 65 }
  auto value_gray_blur_cache_pw_math_gray_blur811_0 = gray_blur_cache.gray_blur_cache_all_inputs_to_all_outputs.read(gray_blur_cache_ld3 - 0, gray_blur_cache_ld4 - 0);
  return value_gray_blur_cache_pw_math_gray_blur811_0;
  return 0;
}

// # of bundles = 2
// load_to_gray_blur_cache_to_gp_5265_read
//	gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3
inline hw_uint<32> gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_read_bundle_read(gray_blur_cache_cache& gray_blur_cache, int root, int gray_blur_cache_ld4, int gray_blur_cache_ld3, int dynamic_address) {
  // # of ports in bundle: 1
    // gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3

	hw_uint<32> result;
	hw_uint<32>  gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3_res = gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3_select(gray_blur_cache, root, gray_blur_cache_ld4, gray_blur_cache_ld3, dynamic_address);
	set_at<0, 32>(result, gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_3_res);
	return result;
}
...
// Operation logic
inline void load_to_gray_blur_cache_to_gp_5265(gray_blur_cache_cache& gray_blur_cache, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */gray_blur_cache_to_gp_526, int root, int gray_blur_cache_ld4, int gray_blur_cache_ld3) {
  // Dynamic address computation

	// Consume: gray_blur_cache
	auto gray_blur_cache_gray_blur_cache_ld3_c__gray_blur_cache_ld4_value = gray_blur_cache_load_to_gray_blur_cache_to_gp_5265_read_bundle_read(gray_blur_cache/* source_delay */, root, gray_blur_cache_ld4, gray_blur_cache_ld3, 0);
...
// schedule: { load_to_gray_blur_cache_to_gp_5265[root = 0, gray_blur_cache_ld4, gray_blur_cache_ld3] -> [gray_blur_cache_ld4, gray_blur_cache_ld3, 2] : 0 <= gray_blur_cache_ld4 <= 65 and 0 <= gray_blur_cache_ld3 <= 65; pw_math_gray_blur811[root = 0, pw_math_gray_blur89, pw_math_gray_blur810] -> [pw_math_gray_blur89, pw_math_gray_blur810, 1] : 0 <= pw_math_gray_blur89 <= 65 and 0 <= pw_math_gray_blur810 <= 65; load_to_gray_blur_FIFO_buf192[root = 0, gray_blur_ld1, gray_blur_ld0] -> [gray_blur_ld1, gray_blur_ld0, 0] : 0 <= gray_blur_ld1 <= 65 and 0 <= gray_blur_ld0 <= 65 }
//   { load_to_gray_blur_cache_to_gp_5265[root = 0, gray_blur_cache_ld4, gray_blur_cache_ld3] -> [gray_blur_cache_ld4, gray_blur_cache_ld3, 2] : 0 <= gray_blur_cache_ld4 <= 65 and 0 <= gray_blur_cache_ld3 <= 65 }
// Condition for load_to_gray_blur_cache_to_gp_5265(((-2 + i2 == 0) && (i0 >= 0) && (65 - i0 >= 0) && (i1 >= 0) && (65 - i1 >= 0)))
...
for (int c0 = 0; c0 <= 65; c0 += 1)
  for (int c1 = 0; c1 <= 65; c1 += 1) {
    ...
    load_to_gray_blur_cache_to_gp_5265(0, c0, c1);
  }
  ...
  */
	for (int c0 = 0; c0 <= 65; c0 += 1)
	  for (int c1 = 0; c1 <= 65; c1 += 1) {
	    ...
	    load_to_gray_blur_cache_to_gp_5265(gray_blur_cache /* buf name */, gray_blur_cache_to_gp_526, 0, c0, c1);
	  }
...
inline hw_uint<32>  blurred_load_to_blurred_to_gp_4225_3_select(blurred_cache& blurred, int root, int blurred_ld3, int blurred_ld4, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blurred_load_to_blurred_to_gp_4225_3 read pattern: { load_to_blurred_to_gp_4225[root = 0, blurred_ld3, blurred_ld4] -> blurred[blurred_ld3, blurred_ld4] : 0 <= blurred_ld3 <= 63 and 0 <= blurred_ld4 <= 63 }
...
// load_to_blurred_to_gp_4225_read
//	blurred_load_to_blurred_to_gp_4225_3
inline hw_uint<32> blurred_load_to_blurred_to_gp_4225_read_bundle_read(blurred_cache& blurred, int root, int blurred_ld3, int blurred_ld4, int dynamic_address) {
  // # of ports in bundle: 1
    // blurred_load_to_blurred_to_gp_4225_3

	hw_uint<32> result;
	hw_uint<32>  blurred_load_to_blurred_to_gp_4225_3_res = blurred_load_to_blurred_to_gp_4225_3_select(blurred, root, blurred_ld3, blurred_ld4, dynamic_address);
	set_at<0, 32>(result, blurred_load_to_blurred_to_gp_4225_3_res);
	return result;
}
...
inline void gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0_write(hw_uint<32> & gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0, gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int gray_blur_cache_ld1, int gray_blur_cache_ld0, int dynamic_address) {
  gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.write(gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0, gray_blur_cache_ld0 - 0, gray_blur_cache_ld1 - 0);
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_10_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(1 + xb - 0, 2 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_11_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(2 + xb - 0, yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_12_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(2 + xb - 0, 1 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_13_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(2 + xb - 0, 2 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_5_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(xb - 0, yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_6_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(xb - 0, 1 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_7_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(xb - 0, 2 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_8_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(1 + xb - 0, yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
inline hw_uint<32>  gray_blur_cache_FIFO_buf20_blur_9_select(gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int xb, int yb, int dynamic_address) {
  ...
  auto value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0 = gray_blur_cache_FIFO_buf20.gray_blur_cache_FIFO_buf20_all_inputs_to_all_outputs.read(1 + xb - 0, 1 + yb - 0);
  return value_gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0;
  return 0;
}
...
//	gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0
inline void gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_write_bundle_write(hw_uint<32>& load_to_gray_blur_cache_FIFO_buf202_write, gray_blur_cache_FIFO_buf20_cache& gray_blur_cache_FIFO_buf20, int root, int gray_blur_cache_ld1, int gray_blur_cache_ld0, int dynamic_address) {
	hw_uint<32>  gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0_res = load_to_gray_blur_cache_FIFO_buf202_write.extract<0, 31>();
	gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0_write(gray_blur_cache_FIFO_buf20_load_to_gray_blur_cache_FIFO_buf202_0_res, gray_blur_cache_FIFO_buf20, root, gray_blur_cache_ld1, gray_blur_cache_ld0, dynamic_address);
}
...
// Operation logic
inline void load_to_blurred_to_gp_4225(blurred_cache& blurred, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */blurred_to_gp_422, int root, int blurred_ld3, int blurred_ld4) {
  // Dynamic address computation

	// Consume: blurred
	auto blurred_blurred_ld3_c__blurred_ld4_value = blurred_load_to_blurred_to_gp_4225_read_bundle_read(blurred/* source_delay */, root, blurred_ld3, blurred_ld4, 0);
...
// schedule: { load_to_blurred_to_gp_4225[root = 0, blurred_ld3, blurred_ld4] -> [65 + blurred_ld3, blurred_ld4, 2] : 0 <= blurred_ld3 <= 63 and 0 <= blurred_ld4 <= 63; blur[root = 0, xb, yb] -> [65 + xb, yb, 1] : 0 <= xb <= 63 and 0 <= yb <= 63; load_to_gray_blur_cache_FIFO_buf202[root = 0, gray_blur_cache_ld1, gray_blur_cache_ld0] -> [gray_blur_cache_ld1, 61 + gray_blur_cache_ld0, 0] : 0 <= gray_blur_cache_ld1 <= 65 and 0 <= gray_blur_cache_ld0 <= 65 }
//   { load_to_blurred_to_gp_4225[root = 0, blurred_ld3, blurred_ld4] -> [65 + blurred_ld3, blurred_ld4, 2] : 0 <= blurred_ld3 <= 63 and 0 <= blurred_ld4 <= 63 }
// Condition for load_to_blurred_to_gp_4225(((-2 + i2 == 0) && (-65 + i0 >= 0) && (128 - i0 >= 0) && (i1 >= 0) && (63 - i1 >= 0)))
...
for (int c0 = 0; c0 <= 128; c0 += 1)
  for (int c1 = 0; c1 <= 126; c1 += 1) {
    ...
    if (c0 >= 65 && c1 <= 63) {
      blur(0, c0 - 65, c1);
      load_to_blurred_to_gp_4225(0, c0 - 65, c1);
    }
  }
	...
	for (int c0 = 0; c0 <= 128; c0 += 1)
	  for (int c1 = 0; c1 <= 126; c1 += 1) {
	    ...
	    if (c0 >= 65 && c1 <= 63) {
	      ...
	      load_to_blurred_to_gp_4225(blurred /* buf name */, blurred_to_gp_422, 0, c0 - 65, c1);
	    }
	  }
