...
inline void blur_stencil_op_hcompute_blur_stencil_14_write(hw_uint<16>& blur_stencil_op_hcompute_blur_stencil_14, blur_stencil_cache& blur_stencil, int root, int blur_s0_y, int blur_s0_x, int dynamic_address) {
  blur_stencil.blur_stencil_op_hcompute_blur_stencil_14_to_blur_stencil_op_hcompute_hw_output_stencil_17.push(blur_stencil_op_hcompute_blur_stencil_14);
}
...
inline hw_uint<16> blur_stencil_op_hcompute_hw_output_stencil_17_select(blur_stencil_cache& blur_stencil, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  ...
  auto value_blur_stencil_op_hcompute_blur_stencil_14 = blur_stencil.blur_stencil_op_hcompute_blur_stencil_14_to_blur_stencil_op_hcompute_hw_output_stencil_17.peek(/* one reader or all rams */ 0);
...
inline void blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3_write(hw_uint<16>& blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3, blur_unnormalized_stencil_cache& blur_unnormalized_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  blur_unnormalized_stencil.blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3_to_blur_unnormalized_stencil_op_hcompute_blur_stencil_15.push(blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3);
}
...
inline hw_uint<16> blur_unnormalized_stencil_op_hcompute_blur_stencil_15_select(blur_unnormalized_stencil_cache& blur_unnormalized_stencil, int root, int blur_s0_y, int blur_s0_x, int dynamic_address) {
  ...
  auto value_blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3 = blur_unnormalized_stencil.blur_unnormalized_stencil_op_hcompute_blur_unnormalized_stencil_1_3_to_blur_unnormalized_stencil_op_hcompute_blur_stencil_15.peek(/* one reader or all rams */ 0);
...
struct blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_to_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct blur_unnormalized_stencil_clkwrk_dsa0_cache {
  // # of banks: 1
  blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_to_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4_cache blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_to_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4;
};
...
inline void blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_write(hw_uint<16>& blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2, blur_unnormalized_stencil_clkwrk_dsa0_cache& blur_unnormalized_stencil_clkwrk_dsa0, int root, int blur_unnormalized_s0_y, int blur_unnormalized_s0_x, int dynamic_address) {
  blur_unnormalized_stencil_clkwrk_dsa0.blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_to_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4.push(blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2);
}
...
inline hw_uint<16> blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4_select(blur_unnormalized_stencil_clkwrk_dsa0_cache& blur_unnormalized_stencil_clkwrk_dsa0, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  auto value_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2 = blur_unnormalized_stencil_clkwrk_dsa0.blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_2_to_blur_unnormalized_stencil_clkwrk_dsa0_op_hcompute_blur_unnormalized_stencil_1_4.peek(/* one reader or all rams */ 0);
...
struct hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 131
	// # of read delays: 9
...
struct hw_input_stencil_cache {
  // # of banks: 1
  hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9_cache hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9;
};
...
inline void hw_input_stencil_op_hcompute_hw_input_stencil_0_write(hw_uint<16>& hw_input_stencil_op_hcompute_hw_input_stencil_0, hw_input_stencil_cache& hw_input_stencil, int root, int hw_input_s0_y, int hw_input_s0_x, int dynamic_address) {
  hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.push(hw_input_stencil_op_hcompute_hw_input_stencil_0);
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_10_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_64();
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_11_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_2();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_12_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_0();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_13_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_1();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_5_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_130();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_6_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_129();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_7_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_128();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_8_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_66();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
inline hw_uint<16> hw_input_stencil_op_hcompute_blur_unnormalized_stencil_1_9_select(hw_input_stencil_cache& hw_input_stencil, int root, int blur_unnormalized_s1_y, int blur_unnormalized_s1_x, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_blur_unnormalized_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_hw_input_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_hw_input_stencil_op_hcompute_hw_input_stencil_0 = hw_input_stencil.hw_input_stencil_op_hcompute_hw_input_stencil_0_merged_banks_9.peek_65();
  return value_hw_input_stencil_op_hcompute_hw_input_stencil_0;
  return 0;
}
...
// Driver function
void gaussian(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */input_copy_stencil, HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_output_stencil) {
...
for (int c1 = 0; c1 <= 63; c1 += 1)
  for (int c2 = 0; c2 <= 63; c2 += 1) {
    ...
    if (c1 >= 2 && c2 >= 2) {
      op_hcompute_blur_unnormalized_stencil(0, c1 - 2, c2 - 2);
      op_hcompute_blur_unnormalized_stencil_1(0, c1 - 2, c2 - 2);
      op_hcompute_blur_stencil(0, c1 - 2, c2 - 2);
      op_hcompute_hw_output_stencil(0, c1 - 2, c2 - 2);
    }
  }
...
#pragma HLS pipeline II=1
	    ...
	    if (c1 >= 2 && c2 >= 2) {
	      ...
	      op_hcompute_blur_unnormalized_stencil_1(blur_unnormalized_stencil_clkwrk_dsa0 /* buf name */, hw_input_stencil /* buf name */, blur_unnormalized_stencil, 0, c1 - 2, c2 - 2);
...
void gaussian_wrapper(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */input_copy_stencil, HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_output_stencil, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    gaussian(input_copy_stencil, hw_output_stencil);
  }
}
#ifdef __VIVADO_SYNTH__
...
void gaussian_accel(hw_uint<16>* op_hcompute_hw_input_stencil_read_pipe0, hw_uint<16>* op_hcompute_hw_output_stencil_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  gaussian_wrapper(op_hcompute_hw_input_stencil_read_pipe0_channel, op_hcompute_hw_output_stencil_write_pipe0_channel, size);
...
void gaussian_rdai(HWStream<hw_uint<16> >& op_hcompute_hw_input_stencil_read_pipe0, HWStream<hw_uint<16> >&  op_hcompute_hw_output_stencil_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  gaussian(op_hcompute_hw_input_stencil_read_pipe0, op_hcompute_hw_output_stencil_write_pipe0);
