...
// compute file: ic20_300MHz_1_opt_compute_units.h
#include "ic20_300MHz_1_opt_compute_units.h"
...
struct stg19_stg19_update_0_write0_to_ic20_300MHz_1_rd0_cache {
...
struct stg19_cache {
  // # of banks: 1
  stg19_stg19_update_0_write0_to_ic20_300MHz_1_rd0_cache stg19_stg19_update_0_write0_to_ic20_300MHz_1_rd0;
};
...
inline void stg19_stg19_update_0_write0_write(hw_uint<16>& stg19_stg19_update_0_write0, stg19_cache& stg19, int d0, int d1, int dynamic_address) {
  stg19.stg19_stg19_update_0_write0_to_ic20_300MHz_1_rd0.push(stg19_stg19_update_0_write0);
}

inline hw_uint<16> ic20_300MHz_1_rd0_select(stg19_cache& stg19, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ic20_300MHz_1_rd0 read pattern: { ic20_300MHz_1_update_0[d0, d1] -> stg19[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ic20_300MHz_1_update_0[d0, d1] -> [20 + d1, 20 + d0, 22] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg19_update_0[d0, d1] -> [20 + d1, 20 + d0, 21] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg19_stg19_update_0_write0 = stg19.stg19_stg19_update_0_write0_to_ic20_300MHz_1_rd0.peek(/* one reader or all rams */ 0);
  return value_stg19_stg19_update_0_write0;
  return 0;
}

// # of bundles = 2
// ic20_300MHz_1_update_0_read
//	ic20_300MHz_1_rd0
inline hw_uint<16> stg19_ic20_300MHz_1_update_0_read_bundle_read(stg19_cache& stg19, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ic20_300MHz_1_rd0

	hw_uint<16> result;
	hw_uint<16> ic20_300MHz_1_rd0_res = ic20_300MHz_1_rd0_select(stg19, d0, d1, dynamic_address);
	set_at<0, 16>(result, ic20_300MHz_1_rd0_res);
	return result;
}
...
inline void ic20_300MHz_1_update_0(stg19_cache& stg19, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ic20_300MHz_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg19
	auto stg19_0_c__0_value = stg19_ic20_300MHz_1_update_0_read_bundle_read(stg19/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = ic20_300MHz_1_generated_compute_unrolled_1(stg19_0_c__0_value);
	// Produce: ic20_300MHz_1
	ic20_300MHz_1.write(compute_result);
...
#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ic20_300MHz_1_opt_debug.csv");
...
//   { ic20_300MHz_1_update_0[d0, d1] -> [20 + d1, 20 + d0, 22] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ic20_300MHz_1_update_0(((-22 + i2 == 0) && (-20 + i1 >= 0) && (1939 - i1 >= 0) && (-20 + i0 >= 0) && (1099 - i0 >= 0)))
...
// Condition for stg16_update_0(((-18 + i2 == 0) && (-14 + i1 >= 0) && (1939 - i1 >= 0) && (-17 + i0 >= 0) && (1099 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // ic20_300MHz_1_update_0 -> [1*d1*1*1 + 1*20,1*d0*1*1 + 1*20,1*22]
...
#pragma HLS pipeline II=1
    ...
    if ((20 <= c1 && c1 <= 1939) && ((c1 - 20) % 1 == 0) && (20 <= c0 && c0 <= 1099) && ((c0 - 20) % 1 == 0)) {
      ic20_300MHz_1_update_0((c1 - 20) / 1, (c0 - 20) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((20 <= c1 && c1 <= 1939) && ((c1 - 20) % 1 == 0) && (20 <= c0 && c0 <= 1099) && ((c0 - 20) % 1 == 0)) {
	      ic20_300MHz_1_update_0(stg19 /* buf name */, ic20_300MHz_1, (c1 - 20) / 1, (c0 - 20) / 1);
	    }
...
void ic20_300MHz_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ic20_300MHz_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ic20_300MHz_1_opt(in_off_chip, ic20_300MHz_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ic20_300MHz_1_update_0[root = 0, ic20_300MHz_1_0, ic20_300MHz_1_1] -> ic20_300MHz_1[0, 0] : 0 <= ic20_300MHz_1_0 <= 1919 and 0 <= ic20_300MHz_1_1 <= 1079 }
const int ic20_300MHz_1_update_0_write_pipe0_num_transfers = 2073600;
...
void ic20_300MHz_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ic20_300MHz_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ic20_300MHz_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ic20_300MHz_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ic20_300MHz_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ic20_300MHz_1_opt_wrapper(in_update_0_read_pipe0_channel, ic20_300MHz_1_update_0_write_pipe0_channel, size);

  burst_write<16>(ic20_300MHz_1_update_0_write_pipe0, ic20_300MHz_1_update_0_write_pipe0_channel, ic20_300MHz_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ic20_300MHz_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ic20_300MHz_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ic20_300MHz_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ic20_300MHz_1_opt(in_update_0_read_pipe0, ic20_300MHz_1_update_0_write_pipe0);
