...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_to_gp_120.values depth=2
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_to_gp_224;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_to_gp_224.values depth=494
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_diff_to_gp_436;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_diff_to_gp_436.values depth=1498
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_blur_to_gp_328;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_blur_to_gp_328.values depth=2
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_blur_cache_to_gp_532;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_blur_cache_to_gp_532.values depth=2
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > blurred_to_gp_416;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=blurred_to_gp_416.values depth=2
#endif //__VIVADO_SYNTH__
