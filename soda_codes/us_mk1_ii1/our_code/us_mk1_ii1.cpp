...
inline hw_uint<32>  gray_FIFO_buf44_pw_math_gray1215_5_select(gray_FIFO_buf44_cache& gray_FIFO_buf44, int root, int pw_math_gray1213, int pw_math_gray1214, int dynamic_address) {
  ...
  // Read schedule : { pw_math_gray1215[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 4] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { load_to_gray_FIFO_buf4447[d0 = 0, d1, d2] -> [0, d1, d2, 3] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_gray_FIFO_buf44_load_to_gray_FIFO_buf4447_26 = gray_FIFO_buf44.gray_FIFO_buf44_load_to_gray_FIFO_buf4447_26_to_gray_FIFO_buf44_pw_math_gray1215_5.peek(/* one reader or all rams */ (-62 + pw_math_gray1214 == 0) ? (1) : (61 - pw_math_gray1214 >= 0) ? (2) : 0);
...
inline hw_uint<32>  gray_diff_load_to_gray_diff_to_gp_43639_13_select(gray_diff_cache& gray_diff, int root, int gray_diff_ld38, int gray_diff_ld37, int dynamic_address) {
  ...
  // Write schedule: { pw_math_gray1215[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 4] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  auto value_gray_diff_pw_math_gray1215_4 = gray_diff.gray_diff_pw_math_gray1215_4_to_gray_diff_load_to_gray_diff_to_gp_43639_13.peek(/* one reader or all rams */ (-63 + gray_diff_ld37 == 0 && -62 + gray_diff_ld38 == 0) ? (64) : (62 - gray_diff_ld37 >= 0 && 61 - gray_diff_ld38 >= 0) ? (128) : (-63 + gray_diff_ld38 == 0 && 62 - gray_diff_ld37 >= 0) ? ((63 - gray_diff_ld37)) : (-63 + gray_diff_ld37 == 0 && 61 - gray_diff_ld38 >= 0) ? (128) : (-62 + gray_diff_ld38 == 0 && 62 - gray_diff_ld37 >= 0) ? ((127 - gray_diff_ld37)) : 0);
...
// schedule: { load_to_gray_FIFO_buf4447[d0 = 0, d1, d2] -> [0, d1, d2, 3] : 0 <= d1 <= 63 and 0 <= d2 <= 63; load_to_gray_diff_to_gp_43639[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 63 and 0 <= d2 <= 63; pw_math_gray1215[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 4] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
//   { pw_math_gray1215[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 4] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for pw_math_gray1215(((((-4 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((65 + -1*i2)) >= 0)))

	// time range: { [0, i1, i2, 6] : 2 <= i1 <= 65 and 2 <= i2 <= 65; [0, i1, i2, 4] : 0 <= i1 <= 63 and 2 <= i2 <= 65; [0, i1, i2, 3] : 0 <= i1 <= 63 and 0 <= i2 <= 63 }
	// # sets: 1
	for (int i0 = 0; i0 <= 0; i0++) {
	  for (int i1 = 0; i1 <= 65; i1++) {
	    for (int i2 = 0; i2 <= 65; i2++) {
	#pragma HLS pipeline II=1
	        ...
	        if ((((((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0)))) {
	          pw_math_gray1215(gray_FIFO_buf44 /* buf name */, gray_diff, 0, ((1*i1)), ((-2 + 1*i2)));
	        }
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_to_gp_120.values depth=100
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_to_gp_224;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_to_gp_224.values depth=100
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_diff_to_gp_436;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_diff_to_gp_436.values depth=100
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_blur_to_gp_328;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_blur_to_gp_328.values depth=100
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > gray_blur_cache_to_gp_532;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_blur_cache_to_gp_532.values depth=100
#endif //__VIVADO_SYNTH__
  HWStream< hw_uint<32> > blurred_to_gp_416;
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=blurred_to_gp_416.values depth=100
#endif //__VIVADO_SYNTH__
