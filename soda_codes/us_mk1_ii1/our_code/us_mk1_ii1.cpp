...
inline hw_uint<32>  gray_diff_load_to_gray_diff_to_gp_43639_13_select(gray_diff_cache& gray_diff, int root, int gray_diff_ld38, int gray_diff_ld37, int dynamic_address) {
  ...
  // Read schedule : { load_to_gray_diff_to_gp_43639[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 6] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
// schedule: { load_to_gray_FIFO_buf4447[d0 = 0, d1, d2] -> [0, d1, d2, 3] : 0 <= d1 <= 63 and 0 <= d2 <= 63; load_to_gray_diff_to_gp_43639[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 6] : 0 <= d1 <= 63 and 0 <= d2 <= 63; pw_math_gray1215[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 4] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
//   { load_to_gray_diff_to_gp_43639[d0 = 0, d1, d2] -> [0, d1, 2 + d2, 6] : 0 <= d1 <= 63 and 0 <= d2 <= 63 }
// Condition for load_to_gray_diff_to_gp_43639(((((-6 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((65 + -1*i2)) >= 0)))
...
// Condition for pw_math_gray1215(((((-4 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((65 + -1*i2)) >= 0)))
	...
	// time range: { [0, i1, i2, 6] : 0 <= i1 <= 63 and 2 <= i2 <= 65; [0, i1, i2, 4] : 0 <= i1 <= 63 and 2 <= i2 <= 65; [0, i1, i2, 3] : 0 <= i1 <= 63 and 0 <= i2 <= 63 }
	// # sets: 1
	int i0 = 0;
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : i2 >= 2 }
	          // { [i0, i1, i2] : -2 + i2 >= 0 }
	        if ((((((-2 + 1*i2)) >= 0)))) {
	          load_to_gray_diff_to_gp_43639(gray_diff /* buf name */, gray_diff_to_gp_436, 0, ((1*i1)), ((-2 + 1*i2)));
	        }
	    }
	  }
...
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=gray_diff_to_gp_436.values depth=160
#endif //__VIVADO_SYNTH__
