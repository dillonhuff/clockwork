...
int main() {
  ...
  us_mk1_ii1_kernel(out, in, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_us_mk1_ii1_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in);
  free(out);
}
