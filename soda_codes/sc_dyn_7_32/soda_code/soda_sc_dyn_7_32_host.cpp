...
int main(int argc, char **argv) {
  ...
  OCL_CHECK(err, cl::Buffer pw_math_in47_write_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, pw_math_in47_write_size_bytes, pw_math_in47_write.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(0, pw_math_in47_write_ocl_buf));
