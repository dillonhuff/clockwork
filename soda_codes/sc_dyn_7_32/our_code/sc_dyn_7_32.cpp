...
// Condition for pw_math_in47(((-3 + i3 == 0) && (i0 == 0) && (i1 >= 0) && (127 - i1 >= 0) && (i2 >= 0) && (127 - i2 >= 0)))
//   { load_to_in_FIFO_buf1215[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 127 and 0 <= d2 <= 127 }
// Condition for load_to_in_FIFO_buf1215(((-2 + i3 == 0) && (i0 == 0) && (i1 >= 0) && (127 - i1 >= 0) && (i2 >= 0) && (127 - i2 >= 0)))

  /*
for (int c1 = 0; c1 <= 127; c1 += 1)
  for (int c2 = 0; c2 <= 127; c2 += 1) {
    load_to_in_FIFO_buf1215(0, c1, c2);
    pw_math_in47(0, c1, c2);
  }
...
// Condition for load_to_in_to_gp_0811(((-1 + i3 == 0) && (i0 == 0) && (i1 >= 0) && (127 - i1 >= 0) && (i2 >= 0) && (127 - i2 >= 0)))
//   { pw_math_in_oc03[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 127 and 0 <= d2 <= 127 }
// Condition for pw_math_in_oc03(((i3 == 0) && (i0 == 0) && (i1 >= 0) && (127 - i1 >= 0) && (i2 >= 0) && (127 - i2 >= 0)))

  /*
for (int c1 = 0; c1 <= 127; c1 += 1)
  for (int c2 = 0; c2 <= 127; c2 += 1) {
    pw_math_in_oc03(0, c1, c2);
    load_to_in_to_gp_0811(0, c1, c2);
  }
