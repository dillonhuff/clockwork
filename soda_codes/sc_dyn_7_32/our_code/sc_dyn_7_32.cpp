...
inline hw_uint<32>  in_load_to_in_to_gp_0811_5_select(in_cache& in, int root, int in_ld10, int in_ld9, int dynamic_address) {
  ...
  // Read schedule : { load_to_in_to_gp_0811[root = 0, in_ld10, in_ld9] -> [in_ld10, in_ld9, 1] : 0 <= in_ld10 <= 127 and 0 <= in_ld9 <= 127 }
...
inline hw_uint<32>  in_FIFO_buf12_pw_math_in47_3_select(in_FIFO_buf12_cache& in_FIFO_buf12, int root, int pw_math_in45, int pw_math_in46, int dynamic_address) {
  ...
  // Read schedule : { pw_math_in47[root = 0, pw_math_in45, pw_math_in46] -> [pw_math_in45, pw_math_in46, 3] : 0 <= pw_math_in45 <= 127 and 0 <= pw_math_in46 <= 127 }
  // Write schedule: { load_to_in_FIFO_buf1215[root = 0, in_to_gp_08_ld14, in_to_gp_08_ld13] -> [in_to_gp_08_ld14, in_to_gp_08_ld13, 2] : 0 <= in_to_gp_08_ld14 <= 127 and 0 <= in_to_gp_08_ld13 <= 127 }
...
inline void pw_math_in47(in_FIFO_buf12_cache& in_FIFO_buf12, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */out, int root, int pw_math_in45, int pw_math_in46) {
  // Dynamic address computation
	...
	auto in_FIFO_buf12_pw_math_in46_c__pw_math_in45_value = in_FIFO_buf12_pw_math_in47_read_bundle_read(in_FIFO_buf12/* source_delay */, root, pw_math_in45, pw_math_in46, 0);
...
inline void load_to_in_to_gp_0811(in_cache& in, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */in_to_gp_08, int root, int in_ld10, int in_ld9) {
  // Dynamic address computation

	// Consume: in
	auto in_in_ld9_c__in_ld10_value = in_load_to_in_to_gp_0811_read_bundle_read(in/* source_delay */, root, in_ld10, in_ld9, 0);
...
#pragma HLS dataflow
  ...
  HWStream< hw_uint<32> > in_to_gp_08("in_to_gp_08");
#ifdef __VIVADO_SYNTH__
#pragma HLS stream variable=in_to_gp_08.values depth=2048
#endif //__VIVADO_SYNTH__
