...
hw_uint<32> h3_300MHz_1_generated_compute(hw_uint<32*1> h3_9) {
...
hw_uint<32>  h3_300MHz_1_generated_compute_unrolled_1(hw_uint<32>& h3_9) {
  hw_uint<32> whole_result;

  hw_uint<32> lane_0_h3_9;
  set_at<0, 32, 32>(lane_0_h3_9, h3_9.extract<0, 31>());
  auto result_0 = h3_300MHz_1_generated_compute(lane_0_h3_9);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
