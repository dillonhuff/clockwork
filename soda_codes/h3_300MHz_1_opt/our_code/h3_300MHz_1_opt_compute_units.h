...
hw_uint<32> h3_300MHz_1_generated_compute(hw_uint<32*5> in_cc) {
...
hw_uint<32>  h3_300MHz_1_generated_compute_unrolled_1(hw_uint<160>& in_cc) {
  hw_uint<32> whole_result;

  hw_uint<160> lane_0_in_cc;
  set_at<0, 160, 160>(lane_0_in_cc, in_cc.extract<0, 159>());
  auto result_0 = h3_300MHz_1_generated_compute(lane_0_in_cc);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
