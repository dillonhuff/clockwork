...
hw_uint<32> gp_gray_16_cu72(hw_uint<32*9>& gray) {
...
auto res_avg11 = avg_9_float(res_update10_gp_gray_18_128_gp_gray_17__m_136_pack);
  ...
  set_at<0, 32, 32>(return_value73, res_avg11);
  return return_value73;

}

hw_uint<32> gp_gray_214_cu75(hw_uint<32*9>& gp_gray_1_buf4) {
  hw_uint<32> gp_gray_1_buf4_lane_0 = gp_gray_1_buf4.extract<0, 31>();
  hw_uint<32> gp_gray_1_buf4_lane_1 = gp_gray_1_buf4.extract<32, 63>();
  hw_uint<32> gp_gray_1_buf4_lane_2 = gp_gray_1_buf4.extract<64, 95>();
  hw_uint<32> gp_gray_1_buf4_lane_3 = gp_gray_1_buf4.extract<96, 127>();
  hw_uint<32> gp_gray_1_buf4_lane_4 = gp_gray_1_buf4.extract<128, 159>();
  hw_uint<32> gp_gray_1_buf4_lane_5 = gp_gray_1_buf4.extract<160, 191>();
  hw_uint<32> gp_gray_1_buf4_lane_6 = gp_gray_1_buf4.extract<192, 223>();
  hw_uint<32> gp_gray_1_buf4_lane_7 = gp_gray_1_buf4.extract<224, 255>();
  hw_uint<32> gp_gray_1_buf4_lane_8 = gp_gray_1_buf4.extract<256, 287>();
...
auto res_avg19 = avg_9_float(res_update18_gp_gray_216_134_gp_gray_215__m_154_pack);
  ...
  set_at<0, 32, 32>(return_value76, res_avg19);
