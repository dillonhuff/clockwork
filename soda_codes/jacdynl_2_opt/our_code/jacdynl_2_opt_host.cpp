...
int main(int argc, char **argv) {
  ...
  const int jacdynl_2_update_0_write_pipe0_DATA_SIZE = num_epochs*2073600;
  const int jacdynl_2_update_0_write_pipe0_BYTES_PER_PIXEL = 16 / 8;
  size_t jacdynl_2_update_0_write_pipe0_size_bytes = jacdynl_2_update_0_write_pipe0_BYTES_PER_PIXEL * jacdynl_2_update_0_write_pipe0_DATA_SIZE;

  total_size_bytes += jacdynl_2_update_0_write_pipe0_size_bytes;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > jacdynl_2_update_0_write_pipe0(jacdynl_2_update_0_write_pipe0_size_bytes);
  ...
  OCL_CHECK(err, cl::Buffer jacdynl_2_update_0_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, jacdynl_2_update_0_write_pipe0_size_bytes, jacdynl_2_update_0_write_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, jacdynl_2_update_0_write_pipe0_ocl_buf));
...
{
    std::ofstream regression_result("jacdynl_2_update_0_write_pipe0_accel_result.csv");
    for (int i = 0; i < jacdynl_2_update_0_write_pipe0_DATA_SIZE; i++) {
