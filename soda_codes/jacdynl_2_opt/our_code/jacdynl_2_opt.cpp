...
// compute file: jacdynl_2_opt_compute_units.h
...
struct in_cache {
  // Reader addrs...
    // { stg0_update_0[d0, d1] -> in[-1 + d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
    // { stg0_update_0[d0, d1] -> in[d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
    // { stg0_update_0[d0, d1] -> in[d0, 1 + d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
    // { stg0_update_0[d0, d1] -> in[1 + d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd0 read pattern: { stg0_update_0[d0, d1] -> in[-1 + d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1952();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd1 read pattern: { stg0_update_0[d0, d1] -> in[d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1951();
  return value_in_in_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd2 read pattern: { stg0_update_0[d0, d1] -> in[d0, 1 + d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg0_rd3 read pattern: { stg0_update_0[d0, d1] -> in[1 + d0, d1] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Read schedule : { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_4.peek_1950();
  return value_in_in_update_0_write0;
  return 0;
}
...
struct stg0_cache {
  // Reader addrs...
    // { stg1_update_0[d0, d1] -> stg0[-1 + d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
    // { stg1_update_0[d0, d1] -> stg0[d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
    // { stg1_update_0[d0, d1] -> stg0[d0, 1 + d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
    // { stg1_update_0[d0, d1] -> stg0[1 + d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd0 read pattern: { stg1_update_0[d0, d1] -> stg0[-1 + d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1950();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd1 read pattern: { stg1_update_0[d0, d1] -> stg0[d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1949();
  return value_stg0_stg0_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd2 read pattern: { stg1_update_0[d0, d1] -> stg0[d0, 1 + d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg1_rd3 read pattern: { stg1_update_0[d0, d1] -> stg0[1 + d0, d1] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Read schedule : { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  // Write schedule: { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
  auto value_stg0_stg0_update_0_write0 = stg0.stg0_stg0_update_0_write0_merged_banks_4.peek_1948();
  return value_stg0_stg0_update_0_write0;
  return 0;
}
...
struct stg1_cache {
  // Reader addrs...
    // { stg2_update_0[d0, d1] -> stg1[-1 + d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
    // { stg2_update_0[d0, d1] -> stg1[d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
    // { stg2_update_0[d0, d1] -> stg1[d0, 1 + d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
    // { stg2_update_0[d0, d1] -> stg1[1 + d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd0 read pattern: { stg2_update_0[d0, d1] -> stg1[-1 + d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1948();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd1 read pattern: { stg2_update_0[d0, d1] -> stg1[d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1947();
  return value_stg1_stg1_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd2 read pattern: { stg2_update_0[d0, d1] -> stg1[d0, 1 + d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg2_rd3 read pattern: { stg2_update_0[d0, d1] -> stg1[1 + d0, d1] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Read schedule : { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  // Write schedule: { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
  auto value_stg1_stg1_update_0_write0 = stg1.stg1_stg1_update_0_write0_merged_banks_4.peek_1946();
  return value_stg1_stg1_update_0_write0;
  return 0;
}
...
struct stg10_cache {
  // Reader addrs...
    // { stg11_update_0[d0, d1] -> stg10[-1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
    // { stg11_update_0[d0, d1] -> stg10[d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
    // { stg11_update_0[d0, d1] -> stg10[d0, 1 + d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
    // { stg11_update_0[d0, d1] -> stg10[1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg11_rd0 read pattern: { stg11_update_0[d0, d1] -> stg10[-1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg10_stg10_update_0_write0 = stg10.stg10_stg10_update_0_write0_merged_banks_4.peek_1930();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg11_rd1 read pattern: { stg11_update_0[d0, d1] -> stg10[d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg10_stg10_update_0_write0 = stg10.stg10_stg10_update_0_write0_merged_banks_4.peek_1929();
  return value_stg10_stg10_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg11_rd2 read pattern: { stg11_update_0[d0, d1] -> stg10[d0, 1 + d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg11_rd3 read pattern: { stg11_update_0[d0, d1] -> stg10[1 + d0, d1] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Read schedule : { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  // Write schedule: { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  auto value_stg10_stg10_update_0_write0 = stg10.stg10_stg10_update_0_write0_merged_banks_4.peek_1928();
  return value_stg10_stg10_update_0_write0;
  return 0;
}
...
struct stg11_cache {
  // Reader addrs...
    // { stg12_update_0[d0, d1] -> stg11[-1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
    // { stg12_update_0[d0, d1] -> stg11[d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
    // { stg12_update_0[d0, d1] -> stg11[d0, 1 + d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
    // { stg12_update_0[d0, d1] -> stg11[1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg12_rd0 read pattern: { stg12_update_0[d0, d1] -> stg11[-1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg11_stg11_update_0_write0 = stg11.stg11_stg11_update_0_write0_merged_banks_4.peek_1928();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg12_rd1 read pattern: { stg12_update_0[d0, d1] -> stg11[d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg11_stg11_update_0_write0 = stg11.stg11_stg11_update_0_write0_merged_banks_4.peek_1927();
  return value_stg11_stg11_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg12_rd2 read pattern: { stg12_update_0[d0, d1] -> stg11[d0, 1 + d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg12_rd3 read pattern: { stg12_update_0[d0, d1] -> stg11[1 + d0, d1] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
  auto value_stg11_stg11_update_0_write0 = stg11.stg11_stg11_update_0_write0_merged_banks_4.peek_1926();
  return value_stg11_stg11_update_0_write0;
  return 0;
}
...
struct stg12_cache {
  // Reader addrs...
    // { stg13_update_0[d0, d1] -> stg12[-1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
    // { stg13_update_0[d0, d1] -> stg12[d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
    // { stg13_update_0[d0, d1] -> stg12[d0, 1 + d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
    // { stg13_update_0[d0, d1] -> stg12[1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg13_rd0 read pattern: { stg13_update_0[d0, d1] -> stg12[-1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg12_stg12_update_0_write0 = stg12.stg12_stg12_update_0_write0_merged_banks_4.peek_1926();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg13_rd1 read pattern: { stg13_update_0[d0, d1] -> stg12[d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg12_stg12_update_0_write0 = stg12.stg12_stg12_update_0_write0_merged_banks_4.peek_1925();
  return value_stg12_stg12_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg13_rd2 read pattern: { stg13_update_0[d0, d1] -> stg12[d0, 1 + d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg13_rd3 read pattern: { stg13_update_0[d0, d1] -> stg12[1 + d0, d1] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Read schedule : { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  // Write schedule: { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_stg12_stg12_update_0_write0 = stg12.stg12_stg12_update_0_write0_merged_banks_4.peek_1924();
  return value_stg12_stg12_update_0_write0;
  return 0;
}
...
struct stg13_cache {
  // Reader addrs...
    // { stg14_update_0[d0, d1] -> stg13[-1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
    // { stg14_update_0[d0, d1] -> stg13[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
    // { stg14_update_0[d0, d1] -> stg13[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
    // { stg14_update_0[d0, d1] -> stg13[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg14_rd0 read pattern: { stg14_update_0[d0, d1] -> stg13[-1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg13_stg13_update_0_write0 = stg13.stg13_stg13_update_0_write0_merged_banks_4.peek_1924();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg14_rd1 read pattern: { stg14_update_0[d0, d1] -> stg13[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg13_stg13_update_0_write0 = stg13.stg13_stg13_update_0_write0_merged_banks_4.peek_1923();
  return value_stg13_stg13_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg14_rd2 read pattern: { stg14_update_0[d0, d1] -> stg13[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg14_rd3 read pattern: { stg14_update_0[d0, d1] -> stg13[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
  auto value_stg13_stg13_update_0_write0 = stg13.stg13_stg13_update_0_write0_merged_banks_4.peek_1922();
  return value_stg13_stg13_update_0_write0;
  return 0;
}
...
struct stg14_stg14_update_0_write0_to_jacdynl_2_rd0_cache {
...
struct stg14_cache {
  // Reader addrs...
    // { jacdynl_2_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // # of banks: 1
  stg14_stg14_update_0_write0_to_jacdynl_2_rd0_cache stg14_stg14_update_0_write0_to_jacdynl_2_rd0;
};
...
inline void stg14_stg14_update_0_write0_write(hw_uint<16>& stg14_stg14_update_0_write0, stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  stg14.stg14_stg14_update_0_write0_to_jacdynl_2_rd0.push(stg14_stg14_update_0_write0);
}

inline hw_uint<16> jacdynl_2_rd0_select(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // jacdynl_2_rd0 read pattern: { jacdynl_2_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { jacdynl_2_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_stg14_stg14_update_0_write0 = stg14.stg14_stg14_update_0_write0_to_jacdynl_2_rd0.peek(/* one reader or all rams */ 0);
  return value_stg14_stg14_update_0_write0;
  return 0;
}

// # of bundles = 2
// jacdynl_2_update_0_read
//	jacdynl_2_rd0
inline hw_uint<16> stg14_jacdynl_2_update_0_read_bundle_read(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // jacdynl_2_rd0

	hw_uint<16> result;
	hw_uint<16> jacdynl_2_rd0_res = jacdynl_2_rd0_select(stg14, d0, d1, dynamic_address);
	set_at<0, 16>(result, jacdynl_2_rd0_res);
	return result;
}
...
struct stg2_cache {
  // Reader addrs...
    // { stg3_update_0[d0, d1] -> stg2[-1 + d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
    // { stg3_update_0[d0, d1] -> stg2[d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
    // { stg3_update_0[d0, d1] -> stg2[d0, 1 + d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
    // { stg3_update_0[d0, d1] -> stg2[1 + d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd0 read pattern: { stg3_update_0[d0, d1] -> stg2[-1 + d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1946();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd1 read pattern: { stg3_update_0[d0, d1] -> stg2[d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1945();
  return value_stg2_stg2_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd2 read pattern: { stg3_update_0[d0, d1] -> stg2[d0, 1 + d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg3_rd3 read pattern: { stg3_update_0[d0, d1] -> stg2[1 + d0, d1] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Read schedule : { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  // Write schedule: { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
  auto value_stg2_stg2_update_0_write0 = stg2.stg2_stg2_update_0_write0_merged_banks_4.peek_1944();
  return value_stg2_stg2_update_0_write0;
  return 0;
}
...
struct stg3_cache {
  // Reader addrs...
    // { stg4_update_0[d0, d1] -> stg3[-1 + d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
    // { stg4_update_0[d0, d1] -> stg3[d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
    // { stg4_update_0[d0, d1] -> stg3[d0, 1 + d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
    // { stg4_update_0[d0, d1] -> stg3[1 + d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd0 read pattern: { stg4_update_0[d0, d1] -> stg3[-1 + d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1944();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd1 read pattern: { stg4_update_0[d0, d1] -> stg3[d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1943();
  return value_stg3_stg3_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd2 read pattern: { stg4_update_0[d0, d1] -> stg3[d0, 1 + d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg4_rd3 read pattern: { stg4_update_0[d0, d1] -> stg3[1 + d0, d1] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Read schedule : { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  // Write schedule: { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
  auto value_stg3_stg3_update_0_write0 = stg3.stg3_stg3_update_0_write0_merged_banks_4.peek_1942();
  return value_stg3_stg3_update_0_write0;
  return 0;
}
...
struct stg4_cache {
  // Reader addrs...
    // { stg5_update_0[d0, d1] -> stg4[-1 + d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
    // { stg5_update_0[d0, d1] -> stg4[d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
    // { stg5_update_0[d0, d1] -> stg4[d0, 1 + d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
    // { stg5_update_0[d0, d1] -> stg4[1 + d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd0 read pattern: { stg5_update_0[d0, d1] -> stg4[-1 + d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1942();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd1 read pattern: { stg5_update_0[d0, d1] -> stg4[d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1941();
  return value_stg4_stg4_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd2 read pattern: { stg5_update_0[d0, d1] -> stg4[d0, 1 + d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg5_rd3 read pattern: { stg5_update_0[d0, d1] -> stg4[1 + d0, d1] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Read schedule : { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  // Write schedule: { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
  auto value_stg4_stg4_update_0_write0 = stg4.stg4_stg4_update_0_write0_merged_banks_4.peek_1940();
  return value_stg4_stg4_update_0_write0;
  return 0;
}
...
struct stg5_cache {
  // Reader addrs...
    // { stg6_update_0[d0, d1] -> stg5[-1 + d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
    // { stg6_update_0[d0, d1] -> stg5[d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
    // { stg6_update_0[d0, d1] -> stg5[d0, 1 + d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
    // { stg6_update_0[d0, d1] -> stg5[1 + d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd0 read pattern: { stg6_update_0[d0, d1] -> stg5[-1 + d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1940();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd1 read pattern: { stg6_update_0[d0, d1] -> stg5[d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1939();
  return value_stg5_stg5_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd2 read pattern: { stg6_update_0[d0, d1] -> stg5[d0, 1 + d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg6_rd3 read pattern: { stg6_update_0[d0, d1] -> stg5[1 + d0, d1] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Read schedule : { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  // Write schedule: { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
  auto value_stg5_stg5_update_0_write0 = stg5.stg5_stg5_update_0_write0_merged_banks_4.peek_1938();
  return value_stg5_stg5_update_0_write0;
  return 0;
}
...
struct stg6_cache {
  // Reader addrs...
    // { stg7_update_0[d0, d1] -> stg6[-1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
    // { stg7_update_0[d0, d1] -> stg6[d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
    // { stg7_update_0[d0, d1] -> stg6[d0, 1 + d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
    // { stg7_update_0[d0, d1] -> stg6[1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd0 read pattern: { stg7_update_0[d0, d1] -> stg6[-1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1938();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd1 read pattern: { stg7_update_0[d0, d1] -> stg6[d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1937();
  return value_stg6_stg6_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd2 read pattern: { stg7_update_0[d0, d1] -> stg6[d0, 1 + d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg7_rd3 read pattern: { stg7_update_0[d0, d1] -> stg6[1 + d0, d1] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Read schedule : { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  // Write schedule: { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
  auto value_stg6_stg6_update_0_write0 = stg6.stg6_stg6_update_0_write0_merged_banks_4.peek_1936();
  return value_stg6_stg6_update_0_write0;
  return 0;
}
...
struct stg7_cache {
  // Reader addrs...
    // { stg8_update_0[d0, d1] -> stg7[-1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
    // { stg8_update_0[d0, d1] -> stg7[d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
    // { stg8_update_0[d0, d1] -> stg7[d0, 1 + d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
    // { stg8_update_0[d0, d1] -> stg7[1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg8_rd0 read pattern: { stg8_update_0[d0, d1] -> stg7[-1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg7_stg7_update_0_write0 = stg7.stg7_stg7_update_0_write0_merged_banks_4.peek_1936();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg8_rd1 read pattern: { stg8_update_0[d0, d1] -> stg7[d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg7_stg7_update_0_write0 = stg7.stg7_stg7_update_0_write0_merged_banks_4.peek_1935();
  return value_stg7_stg7_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg8_rd2 read pattern: { stg8_update_0[d0, d1] -> stg7[d0, 1 + d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg8_rd3 read pattern: { stg8_update_0[d0, d1] -> stg7[1 + d0, d1] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Read schedule : { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  // Write schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
  auto value_stg7_stg7_update_0_write0 = stg7.stg7_stg7_update_0_write0_merged_banks_4.peek_1934();
  return value_stg7_stg7_update_0_write0;
  return 0;
}
...
struct stg8_cache {
  // Reader addrs...
    // { stg9_update_0[d0, d1] -> stg8[-1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
    // { stg9_update_0[d0, d1] -> stg8[d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
    // { stg9_update_0[d0, d1] -> stg8[d0, 1 + d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
    // { stg9_update_0[d0, d1] -> stg8[1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg9_rd0 read pattern: { stg9_update_0[d0, d1] -> stg8[-1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg8_stg8_update_0_write0 = stg8.stg8_stg8_update_0_write0_merged_banks_4.peek_1934();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg9_rd1 read pattern: { stg9_update_0[d0, d1] -> stg8[d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg8_stg8_update_0_write0 = stg8.stg8_stg8_update_0_write0_merged_banks_4.peek_1933();
  return value_stg8_stg8_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg9_rd2 read pattern: { stg9_update_0[d0, d1] -> stg8[d0, 1 + d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg9_rd3 read pattern: { stg9_update_0[d0, d1] -> stg8[1 + d0, d1] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Read schedule : { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  // Write schedule: { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
  auto value_stg8_stg8_update_0_write0 = stg8.stg8_stg8_update_0_write0_merged_banks_4.peek_1932();
  return value_stg8_stg8_update_0_write0;
  return 0;
}
...
struct stg9_cache {
  // Reader addrs...
    // { stg10_update_0[d0, d1] -> stg9[-1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
    // { stg10_update_0[d0, d1] -> stg9[d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
    // { stg10_update_0[d0, d1] -> stg9[d0, 1 + d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
    // { stg10_update_0[d0, d1] -> stg9[1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg10_rd0 read pattern: { stg10_update_0[d0, d1] -> stg9[-1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg9_stg9_update_0_write0 = stg9.stg9_stg9_update_0_write0_merged_banks_4.peek_1932();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg10_rd1 read pattern: { stg10_update_0[d0, d1] -> stg9[d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg9_stg9_update_0_write0 = stg9.stg9_stg9_update_0_write0_merged_banks_4.peek_1931();
  return value_stg9_stg9_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg10_rd2 read pattern: { stg10_update_0[d0, d1] -> stg9[d0, 1 + d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // stg10_rd3 read pattern: { stg10_update_0[d0, d1] -> stg9[1 + d0, d1] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Read schedule : { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // Write schedule: { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
  auto value_stg9_stg9_update_0_write0 = stg9.stg9_stg9_update_0_write0_merged_banks_4.peek_1930();
  return value_stg9_stg9_update_0_write0;
  return 0;
}
...
inline void jacdynl_2_update_0(stg14_cache& stg14, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */jacdynl_2, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg14
	auto stg14_1_m_jacdynl_2_1__p__0_c__1_m_jacdynl_2_0__p__0_value = stg14_jacdynl_2_update_0_read_bundle_read(stg14/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = jacdynl_2_generated_compute_unrolled_1(stg14_1_m_jacdynl_2_1__p__0_c__1_m_jacdynl_2_0__p__0_value);
	// Produce: jacdynl_2
...
// Driver function
void jacdynl_2_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */jacdynl_2) {
...
// schedule: { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086; stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085; stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082; stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080; stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088; jacdynl_2_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079; stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084; stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090; stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091; stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087; stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083; stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089; stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093; stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081; stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092; in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094; stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
//   { stg7_update_0[d0, d1] -> [8 + d1, 8 + d0, 9] : -7 <= d0 <= 1926 and 0 <= d1 <= 1086 }
// Condition for stg7_update_0(((((-9 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-8 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg8_update_0[d0, d1] -> [9 + d1, 9 + d0, 10] : -6 <= d0 <= 1925 and 0 <= d1 <= 1085 }
// Condition for stg8_update_0(((((-10 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-9 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg11_update_0[d0, d1] -> [12 + d1, 12 + d0, 13] : -3 <= d0 <= 1922 and 0 <= d1 <= 1082 }
// Condition for stg11_update_0(((((-13 + 1*i2)) == 0) && (((-9 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-12 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg13_update_0[d0, d1] -> [14 + d1, 14 + d0, 15] : -1 <= d0 <= 1920 and 0 <= d1 <= 1080 }
// Condition for stg13_update_0(((((-15 + 1*i2)) == 0) && (((-13 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-14 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg5_update_0[d0, d1] -> [6 + d1, 6 + d0, 7] : -9 <= d0 <= 1928 and 0 <= d1 <= 1088 }
// Condition for stg5_update_0(((((-7 + 1*i2)) == 0) && (((3 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-6 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { jacdynl_2_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for jacdynl_2_update_0(((((-17 + 1*i2)) == 0) && (((-15 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-15 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg9_update_0[d0, d1] -> [10 + d1, 10 + d0, 11] : -5 <= d0 <= 1924 and 0 <= d1 <= 1084 }
// Condition for stg9_update_0(((((-11 + 1*i2)) == 0) && (((-5 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-10 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg3_update_0[d0, d1] -> [4 + d1, 4 + d0, 5] : -11 <= d0 <= 1930 and 0 <= d1 <= 1090 }
// Condition for stg3_update_0(((((-5 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-4 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg2_update_0[d0, d1] -> [3 + d1, 3 + d0, 4] : -12 <= d0 <= 1931 and 0 <= d1 <= 1091 }
// Condition for stg2_update_0(((((-4 + 1*i2)) == 0) && (((9 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg6_update_0[d0, d1] -> [7 + d1, 7 + d0, 8] : -8 <= d0 <= 1927 and 0 <= d1 <= 1087 }
// Condition for stg6_update_0(((((-8 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg10_update_0[d0, d1] -> [11 + d1, 11 + d0, 12] : -4 <= d0 <= 1923 and 0 <= d1 <= 1083 }
// Condition for stg10_update_0(((((-12 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-11 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg4_update_0[d0, d1] -> [5 + d1, 5 + d0, 6] : -10 <= d0 <= 1929 and 0 <= d1 <= 1089 }
// Condition for stg4_update_0(((((-6 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-5 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg0_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -14 <= d0 <= 1933 and 0 <= d1 <= 1093 }
// Condition for stg0_update_0(((((-2 + 1*i2)) == 0) && (((13 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg12_update_0[d0, d1] -> [13 + d1, 13 + d0, 14] : -2 <= d0 <= 1921 and 0 <= d1 <= 1081 }
// Condition for stg12_update_0(((((-14 + 1*i2)) == 0) && (((-11 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-13 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg1_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : -13 <= d0 <= 1932 and 0 <= d1 <= 1092 }
// Condition for stg1_update_0(((((-3 + 1*i2)) == 0) && (((11 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-2 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : -15 <= d0 <= 1934 and 0 <= d1 <= 1094 }
// Condition for in_update_0(((((-1 + 1*i2)) == 0) && (((15 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
//   { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for stg14_update_0(((((-16 + 1*i2)) == 0) && (((-15 + 1*i1)) >= 0) && (((1934 + -1*i1)) >= 0) && (((-15 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))

	  // Schedules...
	    // in_off_chip_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*0]
	    // in_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*1]
	    // jacdynl_2_update_0 -> [1*d1*1*1 + 1*15,1*d0*1*1 + 1*15,1*17]
	...
	for (int c0 = 0; c0 <= 1094; c0++) {
	  for (int c1 = -15; c1 <= 1934; c1++) {
	
	#ifdef __VIVADO_SYNTH__
	#pragma HLS pipeline II=1
	#endif // __VIVADO_SYNTH__
	
	    if ((-15 <= c1 && c1 <= 1934) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 1094) && ((c0 - 0) % 1 == 0)) {
	      in_update_0(in_off_chip /* buf name */, in, (c1 - 0) / 1, (c0 - 0) / 1);
	    }
	
	    if ((-13 <= c1 && c1 <= 1934) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1094) && ((c0 - 1) % 1 == 0)) {
	      stg0_update_0(in /* buf name */, stg0, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
	
	    if ((-11 <= c1 && c1 <= 1934) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1094) && ((c0 - 2) % 1 == 0)) {
	      stg1_update_0(stg0 /* buf name */, stg1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	
	    if ((-9 <= c1 && c1 <= 1934) && ((c1 - 3) % 1 == 0) && (3 <= c0 && c0 <= 1094) && ((c0 - 3) % 1 == 0)) {
	      stg2_update_0(stg1 /* buf name */, stg2, (c1 - 3) / 1, (c0 - 3) / 1);
	    }
	
	    if ((-7 <= c1 && c1 <= 1934) && ((c1 - 4) % 1 == 0) && (4 <= c0 && c0 <= 1094) && ((c0 - 4) % 1 == 0)) {
	      stg3_update_0(stg2 /* buf name */, stg3, (c1 - 4) / 1, (c0 - 4) / 1);
	    }
	
	    if ((-5 <= c1 && c1 <= 1934) && ((c1 - 5) % 1 == 0) && (5 <= c0 && c0 <= 1094) && ((c0 - 5) % 1 == 0)) {
	      stg4_update_0(stg3 /* buf name */, stg4, (c1 - 5) / 1, (c0 - 5) / 1);
	    }
	
	    if ((-3 <= c1 && c1 <= 1934) && ((c1 - 6) % 1 == 0) && (6 <= c0 && c0 <= 1094) && ((c0 - 6) % 1 == 0)) {
	      stg5_update_0(stg4 /* buf name */, stg5, (c1 - 6) / 1, (c0 - 6) / 1);
	    }
	
	    if ((-1 <= c1 && c1 <= 1934) && ((c1 - 7) % 1 == 0) && (7 <= c0 && c0 <= 1094) && ((c0 - 7) % 1 == 0)) {
	      stg6_update_0(stg5 /* buf name */, stg6, (c1 - 7) / 1, (c0 - 7) / 1);
	    }
	
	    if ((1 <= c1 && c1 <= 1934) && ((c1 - 8) % 1 == 0) && (8 <= c0 && c0 <= 1094) && ((c0 - 8) % 1 == 0)) {
	      stg7_update_0(stg6 /* buf name */, stg7, (c1 - 8) / 1, (c0 - 8) / 1);
	    }
	
	    if ((3 <= c1 && c1 <= 1934) && ((c1 - 9) % 1 == 0) && (9 <= c0 && c0 <= 1094) && ((c0 - 9) % 1 == 0)) {
	      stg8_update_0(stg7 /* buf name */, stg8, (c1 - 9) / 1, (c0 - 9) / 1);
	    }
	
	    if ((5 <= c1 && c1 <= 1934) && ((c1 - 10) % 1 == 0) && (10 <= c0 && c0 <= 1094) && ((c0 - 10) % 1 == 0)) {
	      stg9_update_0(stg8 /* buf name */, stg9, (c1 - 10) / 1, (c0 - 10) / 1);
	    }
	
	    if ((7 <= c1 && c1 <= 1934) && ((c1 - 11) % 1 == 0) && (11 <= c0 && c0 <= 1094) && ((c0 - 11) % 1 == 0)) {
	      stg10_update_0(stg9 /* buf name */, stg10, (c1 - 11) / 1, (c0 - 11) / 1);
	    }
	
	    if ((9 <= c1 && c1 <= 1934) && ((c1 - 12) % 1 == 0) && (12 <= c0 && c0 <= 1094) && ((c0 - 12) % 1 == 0)) {
	      stg11_update_0(stg10 /* buf name */, stg11, (c1 - 12) / 1, (c0 - 12) / 1);
	    }
	
	    if ((11 <= c1 && c1 <= 1934) && ((c1 - 13) % 1 == 0) && (13 <= c0 && c0 <= 1094) && ((c0 - 13) % 1 == 0)) {
	      stg12_update_0(stg11 /* buf name */, stg12, (c1 - 13) / 1, (c0 - 13) / 1);
	    }
	
	    if ((13 <= c1 && c1 <= 1934) && ((c1 - 14) % 1 == 0) && (14 <= c0 && c0 <= 1094) && ((c0 - 14) % 1 == 0)) {
	      stg13_update_0(stg12 /* buf name */, stg13, (c1 - 14) / 1, (c0 - 14) / 1);
	    }
	
	    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
	      stg14_update_0(stg13 /* buf name */, stg14, (c1 - 15) / 1, (c0 - 15) / 1);
	    }
	
	    if ((15 <= c1 && c1 <= 1934) && ((c1 - 15) % 1 == 0) && (15 <= c0 && c0 <= 1094) && ((c0 - 15) % 1 == 0)) {
	      jacdynl_2_update_0(stg14 /* buf name */, jacdynl_2, (c1 - 15) / 1, (c0 - 15) / 1);
	    }
...
void jacdynl_2_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */jacdynl_2, const int num_epochs) {
...
#ifdef __VIVADO_SYNTH__
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[in_1, in_0] : -15 <= in_0 <= 1934 and 0 <= in_1 <= 1094 }
const int in_update_0_read_pipe0_num_transfers = 2135250;
  // { jacdynl_2_update_0[root = 0, jacdynl_2_0, jacdynl_2_1] -> jacdynl_2[jacdynl_2_1, jacdynl_2_0] : 0 <= jacdynl_2_0 <= 1919 and 0 <= jacdynl_2_1 <= 1079 }
const int jacdynl_2_update_0_write_pipe0_num_transfers = 2073600;


extern "C" {

void jacdynl_2_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* jacdynl_2_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = jacdynl_2_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = jacdynl_2_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > jacdynl_2_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  jacdynl_2_opt_wrapper(in_update_0_read_pipe0_channel, jacdynl_2_update_0_write_pipe0_channel, size);

  burst_write<16>(jacdynl_2_update_0_write_pipe0, jacdynl_2_update_0_write_pipe0_channel, jacdynl_2_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void jacdynl_2_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  jacdynl_2_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = jacdynl_2_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  jacdynl_2_opt(in_update_0_read_pipe0, jacdynl_2_update_0_write_pipe0);
