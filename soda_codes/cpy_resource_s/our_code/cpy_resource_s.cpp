...
// Driver function
void cpy_resource_s(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("cpy_resource_s_debug.csv");
  global_debug_handle = &debug_file;
#endif //__VIVADO_SYNTH__
...
void cpy_resource_s_wrapper(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out, const int num_epochs) {
...
void cpy_resource_s_accel(hw_uint<32>* pw_math_in03_read_pipe0, hw_uint<32>* pw_math_Bc1619_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cpy_resource_s_wrapper(pw_math_in03_read_pipe0_channel, pw_math_Bc1619_write_pipe0_channel, size);
...
void cpy_resource_s_rdai(HWStream<hw_uint<32> >& pw_math_in03_read_pipe0, HWStream<hw_uint<32> >&  pw_math_Bc1619_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  cpy_resource_s(pw_math_in03_read_pipe0, pw_math_Bc1619_write_pipe0);
