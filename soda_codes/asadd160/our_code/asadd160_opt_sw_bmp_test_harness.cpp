...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > asadd160_update_0_write_channel;
  // In lanes = 16
  for (int r = 0; r < 540; r++) {
  ...
  asadd160_opt(in_off_chip0_update_0_read_channel, asadd160_update_0_write_channel);
  bitmap_image output(1920, 540);
  for (int r = 0; r < 540; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      hw_uint<256> packed;
      auto packed_val = asadd160_update_0_write_channel.read();
  ...
  output.save_image("./images/asadd160_opt_bmp_out.bmp");
}
