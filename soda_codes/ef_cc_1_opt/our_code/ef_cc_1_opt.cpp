...
// compute file: ef_cc_1_opt_compute_units.h
#include "ef_cc_1_opt_compute_units.h"
...
struct final_merged_0_final_merged_0_update_0_write0_to_ef_cc_1_rd0_cache {
	// RAM Box: {[0, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_cache {
  // # of banks: 1
  final_merged_0_final_merged_0_update_0_write0_to_ef_cc_1_rd0_cache final_merged_0_final_merged_0_update_0_write0_to_ef_cc_1_rd0;
};
...
inline void final_merged_0_final_merged_0_update_0_write0_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write0, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_cc_1_rd0.push(final_merged_0_final_merged_0_update_0_write0);
}

inline hw_uint<16> ef_cc_1_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_cc_1_rd0 read pattern: { ef_cc_1_update_0[d0, d1] -> final_merged_0[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_cc_1_update_0[d0, d1] -> [14 + d1, 14 + d0, 52] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 14 + d0, 51] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write0 = final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_cc_1_rd0.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write0;
  return 0;
}

// # of bundles = 2
// ef_cc_1_update_0_read
//	ef_cc_1_rd0
inline hw_uint<16> final_merged_0_ef_cc_1_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // ef_cc_1_rd0

	hw_uint<16> result;
	hw_uint<16> ef_cc_1_rd0_res = ef_cc_1_rd0_select(final_merged_0, d0, d1, dynamic_address);
	set_at<0, 16>(result, ef_cc_1_rd0_res);
	return result;
}
...
inline void ef_cc_1_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */ef_cc_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_ef_cc_1_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1, 0);
...
// Driver function
void ef_cc_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_cc_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ef_cc_1_opt_debug.csv");
...
//   { ef_cc_1_update_0[d0, d1] -> [14 + d1, 14 + d0, 52] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
// Condition for ef_cc_1_update_0(((-52 + i2 == 0) && (-14 + i1 >= 0) && (1933 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
...
// Condition for dark_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-2 - i1 + 4*floord(2 + i1, 4) == 0) && (-32 + i2 == 0) && (-14 + i1 >= 0) && (1930 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
  ...
  /*
  // Schedules...
    // bright_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*10]
    // bright_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*16]
    // bright_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*24]
    // bright_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*2 + 1*2,1*15]
    // bright_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*4 + 1*6,1*23]
    // bright_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*8 + 1*14,1*30]
    // bright_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*44]
    // bright_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*43]
    // bright_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*42]
    // bright_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*41]
    // bright_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*40]
    // bright_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*39]
    // bright_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*3]
    // bright_weights_normed_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*14]
    // bright_weights_normed_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*22]
    // bright_weights_normed_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*29]
    // bright_weights_normed_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*2 + 1*2,1*21]
    // bright_weights_normed_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*4 + 1*6,1*28]
    // bright_weights_normed_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*8 + 1*14,1*38]
    // bright_weights_normed_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*9]
    // bright_weights_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*5]
    // dark_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*8]
    // dark_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*13]
    // dark_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*20]
    // dark_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*2 + 1*2,1*12]
    // dark_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*4 + 1*6,1*19]
    // dark_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*8 + 1*14,1*27]
    // dark_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*37]
    // dark_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*36]
    // dark_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*35]
    // dark_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*34]
    // dark_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*33]
    // dark_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*32]
    // dark_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*2]
    // dark_weights_normed_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*11]
    // dark_weights_normed_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*18]
    // dark_weights_normed_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*26]
    // dark_weights_normed_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*2 + 1*2,1*17]
    // dark_weights_normed_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*4 + 1*6,1*25]
    // dark_weights_normed_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*8 + 1*14,1*31]
    // dark_weights_normed_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*7]
    // dark_weights_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*4]
    // ef_cc_1_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*14,1*52]
    // final_merged_0_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*14,1*51]
    // final_merged_1_update_0 -> [1*d1*1*2 + 1*14,1*d0*1*2 + 1*14,1*50]
    // final_merged_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*49]
    // fused_level_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*48]
    // fused_level_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*2 + 1*6,1*47]
    // fused_level_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*4 + 1*14,1*46]
    // fused_level_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*8 + 1*14,1*45]
...
#pragma HLS pipeline II=1
    ...
    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
      dark_laplace_us_1_update_0((c1 - 6) / 2, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      dark_laplace_us_0_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
    ...
    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
      dark_laplace_diff_1_update_0((c1 - 6) / 2, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      dark_laplace_diff_0_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
    ...
    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
      bright_laplace_us_1_update_0((c1 - 6) / 2, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      bright_laplace_us_0_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
    ...
    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
      bright_laplace_diff_1_update_0((c1 - 6) / 2, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      bright_laplace_diff_0_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
    ...
    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
      fused_level_1_update_0((c1 - 6) / 2, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
      fused_level_0_update_0((c1 - 2) / 1, (c0 - 2) / 1);
    }
    ...
    if ((14 <= c1 && c1 <= 1933) && ((c1 - 14) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
      ef_cc_1_update_0((c1 - 14) / 1, (c0 - 14) / 1);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 1 == 0)) {
	      dark_gauss_blur_1_update_0(dark /* buf name */, dark_gauss_blur_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 1 == 0)) {
	      bright_gauss_blur_1_update_0(bright /* buf name */, bright_gauss_blur_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 1 == 0)) {
	      dark_weights_normed_gauss_blur_1_update_0(dark_weights_normed /* buf name */, dark_weights_normed_gauss_blur_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 2 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 2 == 0)) {
	      dark_gauss_ds_1_update_0(dark_gauss_blur_1 /* buf name */, dark_gauss_ds_1, (c1 - 2) / 2, (c0 - 2) / 2);
	    }
	
	    if ((6 <= c1 && c1 <= 1926) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 2 == 0)) {
	      dark_gauss_blur_2_update_0(dark_gauss_ds_1 /* buf name */, dark_gauss_blur_2, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 1 == 0)) {
	      bright_weights_normed_gauss_blur_1_update_0(bright_weights_normed /* buf name */, bright_weights_normed_gauss_blur_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 2 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 2 == 0)) {
	      bright_gauss_ds_1_update_0(bright_gauss_blur_1 /* buf name */, bright_gauss_ds_1, (c1 - 2) / 2, (c0 - 2) / 2);
	    }
	
	    if ((6 <= c1 && c1 <= 1926) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 2 == 0)) {
	      bright_gauss_blur_2_update_0(bright_gauss_ds_1 /* buf name */, bright_gauss_blur_2, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 2 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 2 == 0)) {
	      dark_weights_normed_gauss_ds_1_update_0(dark_weights_normed_gauss_blur_1 /* buf name */, dark_weights_normed_gauss_ds_1, (c1 - 2) / 2, (c0 - 2) / 2);
	    }
	
	    if ((6 <= c1 && c1 <= 1926) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 2 == 0)) {
	      dark_weights_normed_gauss_blur_2_update_0(dark_weights_normed_gauss_ds_1 /* buf name */, dark_weights_normed_gauss_blur_2, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	    ...
	    if ((2 <= c1 && c1 <= 1926) && ((c1 - 2) % 2 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 2 == 0)) {
	      bright_weights_normed_gauss_ds_1_update_0(bright_weights_normed_gauss_blur_1 /* buf name */, bright_weights_normed_gauss_ds_1, (c1 - 2) / 2, (c0 - 2) / 2);
	    }
	
	    if ((6 <= c1 && c1 <= 1926) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 2 == 0)) {
	      bright_weights_normed_gauss_blur_2_update_0(bright_weights_normed_gauss_ds_1 /* buf name */, bright_weights_normed_gauss_blur_2, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	    ...
	    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	      dark_laplace_us_1_update_0(dark_gauss_ds_2 /* buf name */, dark_laplace_us_1, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      dark_laplace_us_0_update_0(dark_gauss_ds_1 /* buf name */, dark_laplace_us_0, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	      dark_laplace_diff_1_update_0(dark_gauss_ds_1 /* buf name */, dark_laplace_us_1 /* buf name */, dark_laplace_diff_1, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      dark_laplace_diff_0_update_0(dark /* buf name */, dark_laplace_us_0 /* buf name */, dark_laplace_diff_0, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	      bright_laplace_us_1_update_0(bright_gauss_ds_2 /* buf name */, bright_laplace_us_1, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      bright_laplace_us_0_update_0(bright_gauss_ds_1 /* buf name */, bright_laplace_us_0, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	      bright_laplace_diff_1_update_0(bright_gauss_ds_1 /* buf name */, bright_laplace_us_1 /* buf name */, bright_laplace_diff_1, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      bright_laplace_diff_0_update_0(bright /* buf name */, bright_laplace_us_0 /* buf name */, bright_laplace_diff_0, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((6 <= c1 && c1 <= 1924) && ((c1 - 6) % 2 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	      fused_level_1_update_0(bright_laplace_diff_1 /* buf name */, dark_laplace_diff_1 /* buf name */, bright_weights_normed_gauss_ds_1 /* buf name */, dark_weights_normed_gauss_ds_1 /* buf name */, fused_level_1, (c1 - 6) / 2, (c0 - 6) / 2);
	    }
	
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	      fused_level_0_update_0(bright_laplace_diff_0 /* buf name */, dark_laplace_diff_0 /* buf name */, bright_weights_normed /* buf name */, dark_weights_normed /* buf name */, fused_level_0, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
	    ...
	    if ((14 <= c1 && c1 <= 1932) && ((c1 - 14) % 2 == 0) && (14 <= c0 && c0 <= 1092) && ((c0 - 14) % 2 == 0)) {
	      final_merged_1_update_0(final_merged_2 /* buf name */, fused_level_1 /* buf name */, final_merged_1, (c1 - 14) / 2, (c0 - 14) / 2);
	    }
	
	    if ((14 <= c1 && c1 <= 1933) && ((c1 - 14) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
	      final_merged_0_update_0(final_merged_1 /* buf name */, fused_level_0 /* buf name */, final_merged_0, (c1 - 14) / 1, (c0 - 14) / 1);
	    }
	
	    if ((14 <= c1 && c1 <= 1933) && ((c1 - 14) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
	      ef_cc_1_update_0(final_merged_0 /* buf name */, ef_cc_1, (c1 - 14) / 1, (c0 - 14) / 1);
	    }
...
void ef_cc_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_cc_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ef_cc_1_opt(in_off_chip, ef_cc_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ef_cc_1_update_0[root = 0, ef_cc_1_0, ef_cc_1_1] -> ef_cc_1[0, 0] : 0 <= ef_cc_1_0 <= 1919 and 0 <= ef_cc_1_1 <= 1079 }
const int ef_cc_1_update_0_write_pipe0_num_transfers = 2073600;
...
void ef_cc_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* ef_cc_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ef_cc_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ef_cc_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > ef_cc_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ef_cc_1_opt_wrapper(in_update_0_read_pipe0_channel, ef_cc_1_update_0_write_pipe0_channel, size);

  burst_write<16>(ef_cc_1_update_0_write_pipe0, ef_cc_1_update_0_write_pipe0_channel, ef_cc_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void ef_cc_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  ef_cc_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = ef_cc_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  ef_cc_1_opt(in_update_0_read_pipe0, ef_cc_1_update_0_write_pipe0);
