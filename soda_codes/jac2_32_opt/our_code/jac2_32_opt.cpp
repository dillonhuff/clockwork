...
// compute file: jac2_32_opt_compute_units.h
#include "jac2_32_opt_compute_units.h"
...
struct stg14_stg14_update_0_write0_to_jac2_32_rd0_cache {
...
struct stg14_cache {
  // Reader addrs...
    // { jac2_32_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
  stg14_stg14_update_0_write0_to_jac2_32_rd0_cache stg14_stg14_update_0_write0_to_jac2_32_rd0;
};
...
inline void stg14_stg14_update_0_write0_write(hw_uint<16>& stg14_stg14_update_0_write0, stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  stg14.stg14_stg14_update_0_write0_to_jac2_32_rd0.push(stg14_stg14_update_0_write0);
}

inline hw_uint<16> jac2_32_rd0_select(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // jac2_32_rd0 read pattern: { jac2_32_update_0[d0, d1] -> stg14[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { jac2_32_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { stg14_update_0[d0, d1] -> [15 + d1, 15 + d0, 16] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  auto value_stg14_stg14_update_0_write0 = stg14.stg14_stg14_update_0_write0_to_jac2_32_rd0.peek(/* one reader or all rams */ 0);
  return value_stg14_stg14_update_0_write0;
  return 0;
}

// # of bundles = 2
// jac2_32_update_0_read
//	jac2_32_rd0
inline hw_uint<16> stg14_jac2_32_update_0_read_bundle_read(stg14_cache& stg14, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // jac2_32_rd0

	hw_uint<16> result;
	hw_uint<16> jac2_32_rd0_res = jac2_32_rd0_select(stg14, d0, d1, dynamic_address);
	set_at<0, 16>(result, jac2_32_rd0_res);
	return result;
}
...
inline void stg0_update_0(in_cache& in, stg0_cache& stg0, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: in
	auto in_1_m_stg0_1__p___m_1_c__1_m_stg0_0__p__0_value = in_stg0_update_0_read_bundle_read(in/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg0_generated_compute_unrolled_1(in_1_m_stg0_1__p___m_1_c__1_m_stg0_0__p__0_value);
	// Produce: stg0
...
inline void stg1_update_0(stg0_cache& stg0, stg1_cache& stg1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg0
	auto stg0_1_m_stg1_1__p___m_1_c__1_m_stg1_0__p__0_value = stg0_stg1_update_0_read_bundle_read(stg0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg1_generated_compute_unrolled_1(stg0_1_m_stg1_1__p___m_1_c__1_m_stg1_0__p__0_value);
	// Produce: stg1
...
inline void stg2_update_0(stg1_cache& stg1, stg2_cache& stg2, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg1
	auto stg1_1_m_stg2_1__p___m_1_c__1_m_stg2_0__p__0_value = stg1_stg2_update_0_read_bundle_read(stg1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg2_generated_compute_unrolled_1(stg1_1_m_stg2_1__p___m_1_c__1_m_stg2_0__p__0_value);
	// Produce: stg2
...
inline void stg3_update_0(stg2_cache& stg2, stg3_cache& stg3, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg2
	auto stg2_1_m_stg3_1__p___m_1_c__1_m_stg3_0__p__0_value = stg2_stg3_update_0_read_bundle_read(stg2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg3_generated_compute_unrolled_1(stg2_1_m_stg3_1__p___m_1_c__1_m_stg3_0__p__0_value);
	// Produce: stg3
...
inline void stg4_update_0(stg3_cache& stg3, stg4_cache& stg4, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg3
	auto stg3_1_m_stg4_1__p___m_1_c__1_m_stg4_0__p__0_value = stg3_stg4_update_0_read_bundle_read(stg3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg4_generated_compute_unrolled_1(stg3_1_m_stg4_1__p___m_1_c__1_m_stg4_0__p__0_value);
	// Produce: stg4
...
inline void stg5_update_0(stg4_cache& stg4, stg5_cache& stg5, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg4
	auto stg4_1_m_stg5_1__p___m_1_c__1_m_stg5_0__p__0_value = stg4_stg5_update_0_read_bundle_read(stg4/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg5_generated_compute_unrolled_1(stg4_1_m_stg5_1__p___m_1_c__1_m_stg5_0__p__0_value);
	// Produce: stg5
...
inline void stg6_update_0(stg5_cache& stg5, stg6_cache& stg6, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg5
	auto stg5_1_m_stg6_1__p___m_1_c__1_m_stg6_0__p__0_value = stg5_stg6_update_0_read_bundle_read(stg5/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg6_generated_compute_unrolled_1(stg5_1_m_stg6_1__p___m_1_c__1_m_stg6_0__p__0_value);
	// Produce: stg6
...
inline void stg7_update_0(stg6_cache& stg6, stg7_cache& stg7, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg6
	auto stg6_1_m_stg7_1__p___m_1_c__1_m_stg7_0__p__0_value = stg6_stg7_update_0_read_bundle_read(stg6/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg7_generated_compute_unrolled_1(stg6_1_m_stg7_1__p___m_1_c__1_m_stg7_0__p__0_value);
	// Produce: stg7
...
inline void stg8_update_0(stg7_cache& stg7, stg8_cache& stg8, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg7
	auto stg7_1_m_stg8_1__p___m_1_c__1_m_stg8_0__p__0_value = stg7_stg8_update_0_read_bundle_read(stg7/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg8_generated_compute_unrolled_1(stg7_1_m_stg8_1__p___m_1_c__1_m_stg8_0__p__0_value);
	// Produce: stg8
...
inline void stg9_update_0(stg8_cache& stg8, stg9_cache& stg9, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg8
	auto stg8_1_m_stg9_1__p___m_1_c__1_m_stg9_0__p__0_value = stg8_stg9_update_0_read_bundle_read(stg8/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg9_generated_compute_unrolled_1(stg8_1_m_stg9_1__p___m_1_c__1_m_stg9_0__p__0_value);
	// Produce: stg9
...
inline void stg10_update_0(stg9_cache& stg9, stg10_cache& stg10, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg9
	auto stg9_1_m_stg10_1__p___m_1_c__1_m_stg10_0__p__0_value = stg9_stg10_update_0_read_bundle_read(stg9/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg10_generated_compute_unrolled_1(stg9_1_m_stg10_1__p___m_1_c__1_m_stg10_0__p__0_value);
	// Produce: stg10
...
inline void stg11_update_0(stg10_cache& stg10, stg11_cache& stg11, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg10
	auto stg10_1_m_stg11_1__p___m_1_c__1_m_stg11_0__p__0_value = stg10_stg11_update_0_read_bundle_read(stg10/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg11_generated_compute_unrolled_1(stg10_1_m_stg11_1__p___m_1_c__1_m_stg11_0__p__0_value);
	// Produce: stg11
...
inline void stg12_update_0(stg11_cache& stg11, stg12_cache& stg12, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg11
	auto stg11_1_m_stg12_1__p___m_1_c__1_m_stg12_0__p__0_value = stg11_stg12_update_0_read_bundle_read(stg11/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg12_generated_compute_unrolled_1(stg11_1_m_stg12_1__p___m_1_c__1_m_stg12_0__p__0_value);
	// Produce: stg12
...
inline void stg13_update_0(stg12_cache& stg12, stg13_cache& stg13, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg12
	auto stg12_1_m_stg13_1__p___m_1_c__1_m_stg13_0__p__0_value = stg12_stg13_update_0_read_bundle_read(stg12/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg13_generated_compute_unrolled_1(stg12_1_m_stg13_1__p___m_1_c__1_m_stg13_0__p__0_value);
	// Produce: stg13
...
inline void stg14_update_0(stg13_cache& stg13, stg14_cache& stg14, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: stg13
	auto stg13_1_m_stg14_1__p___m_1_c__1_m_stg14_0__p__0_value = stg13_stg14_update_0_read_bundle_read(stg13/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = stg14_generated_compute_unrolled_1(stg13_1_m_stg14_1__p___m_1_c__1_m_stg14_0__p__0_value);
	// Produce: stg14
...
inline void jac2_32_update_0(stg14_cache& stg14, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */jac2_32, int d0, int d1) {
  // Dynamic address computation

	// Consume: stg14
	auto stg14_1_m_jac2_32_1__p__0_c__1_m_jac2_32_0__p__0_value = stg14_jac2_32_update_0_read_bundle_read(stg14/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = jac2_32_generated_compute_unrolled_1(stg14_1_m_jac2_32_1__p__0_c__1_m_jac2_32_0__p__0_value);
	// Produce: jac2_32
	jac2_32.write(compute_result);
...
// Driver function
void jac2_32_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */jac2_32) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("jac2_32_opt_debug.csv");
...
//   { jac2_32_update_0[d0, d1] -> [15 + d1, 15 + d0, 17] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for jac2_32_update_0(((((-17 + 1*i2)) == 0) && (((-15 + 1*i1)) >= 0) && (((1094 + -1*i1)) >= 0) && (((-15 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
...
// Condition for stg14_update_0(((((-16 + 1*i2)) == 0) && (((-15 + 1*i1)) >= 0) && (((1094 + -1*i1)) >= 0) && (((-15 + 1*i0)) >= 0) && (((1094 + -1*i0)) >= 0)))
	...
	// time range: { [i0, i1, i2] : 15 <= i0 <= 1094 and 15 <= i1 <= 1094 and 16 <= i2 <= 17; [i0, i1, 15] : 14 <= i0 <= 1094 and 13 <= i1 <= 1094; [i0, i1, 14] : 13 <= i0 <= 1094 and 11 <= i1 <= 1094; [i0, i1, 13] : 12 <= i0 <= 1094 and 9 <= i1 <= 1094; [i0, i1, 12] : 11 <= i0 <= 1094 and 7 <= i1 <= 1094; [i0, i1, 11] : 10 <= i0 <= 1094 and 5 <= i1 <= 1094; [i0, i1, 10] : 9 <= i0 <= 1094 and 3 <= i1 <= 1094; [i0, i1, 9] : 8 <= i0 <= 1094 and 0 < i1 <= 1094; [i0, i1, 8] : 7 <= i0 <= 1094 and -1 <= i1 <= 1094; [i0, i1, 7] : 6 <= i0 <= 1094 and -3 <= i1 <= 1094; [i0, i1, 6] : 5 <= i0 <= 1094 and -5 <= i1 <= 1094; [i0, i1, 5] : 4 <= i0 <= 1094 and -7 <= i1 <= 1094; [i0, i1, 4] : 3 <= i0 <= 1094 and -9 <= i1 <= 1094; [i0, i1, 3] : 2 <= i0 <= 1094 and -11 <= i1 <= 1094; [i0, i1, 2] : 0 < i0 <= 1094 and -13 <= i1 <= 1094; [i0, i1, 1] : 0 <= i0 <= 1094 and -15 <= i1 <= 1094 }
	// # sets: 1
	for (int i0 = 0; i0 <= 1094; i0++) {
	...
	#pragma HLS pipeline II=1
	      ...
	      // { [i0, i1] : i0 > 0 and i1 >= -13 }
	      // { [i0, i1] : i0 > 0 and i1 >= -13 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        // { [i0, i1] : 13 + i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((13 + 1*i1)) >= 0)))) {
	        stg0_update_0(in /* buf name */, stg0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 2 and i1 >= -11 }
	      // { [i0, i1] : i0 >= 2 and i1 >= -11 }
	        // { [i0, i1] : -2 + i0 >= 0 }
	        // { [i0, i1] : 11 + i1 >= 0 }
	      if ((((((-2 + 1*i0)) >= 0) && (((11 + 1*i1)) >= 0)))) {
	        stg1_update_0(stg0 /* buf name */, stg1, ((-2 + 1*i1)), ((-2 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 3 and i1 >= -9 }
	      // { [i0, i1] : i0 >= 3 and i1 >= -9 }
	        // { [i0, i1] : -3 + i0 >= 0 }
	        // { [i0, i1] : 9 + i1 >= 0 }
	      if ((((((-3 + 1*i0)) >= 0) && (((9 + 1*i1)) >= 0)))) {
	        stg2_update_0(stg1 /* buf name */, stg2, ((-3 + 1*i1)), ((-3 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 4 and i1 >= -7 }
	      // { [i0, i1] : i0 >= 4 and i1 >= -7 }
	        // { [i0, i1] : -4 + i0 >= 0 }
	        // { [i0, i1] : 7 + i1 >= 0 }
	      if ((((((-4 + 1*i0)) >= 0) && (((7 + 1*i1)) >= 0)))) {
	        stg3_update_0(stg2 /* buf name */, stg3, ((-4 + 1*i1)), ((-4 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 5 and i1 >= -5 }
	      // { [i0, i1] : i0 >= 5 and i1 >= -5 }
	        // { [i0, i1] : -5 + i0 >= 0 }
	      ...
	      if ((((((-5 + 1*i0)) >= 0) && (((5 + 1*i1)) >= 0)))) {
	        stg4_update_0(stg3 /* buf name */, stg4, ((-5 + 1*i1)), ((-5 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 6 and i1 >= -3 }
	      // { [i0, i1] : i0 >= 6 and i1 >= -3 }
	        // { [i0, i1] : -6 + i0 >= 0 }
	        // { [i0, i1] : 3 + i1 >= 0 }
	      if ((((((-6 + 1*i0)) >= 0) && (((3 + 1*i1)) >= 0)))) {
	        stg5_update_0(stg4 /* buf name */, stg5, ((-6 + 1*i1)), ((-6 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 7 and i1 >= -1 }
	      // { [i0, i1] : i0 >= 7 and i1 >= -1 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : 1 + i1 >= 0 }
	      if ((((((-7 + 1*i0)) >= 0) && (((1 + 1*i1)) >= 0)))) {
	        stg6_update_0(stg5 /* buf name */, stg6, ((-7 + 1*i1)), ((-7 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 8 and i1 > 0 }
	      // { [i0, i1] : i0 >= 8 and i1 > 0 }
	        // { [i0, i1] : -8 + i0 >= 0 }
	        // { [i0, i1] : -1 + i1 >= 0 }
	      if ((((((-8 + 1*i0)) >= 0) && (((-1 + 1*i1)) >= 0)))) {
	        stg7_update_0(stg6 /* buf name */, stg7, ((-8 + 1*i1)), ((-8 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 9 and i1 >= 3 }
	      // { [i0, i1] : i0 >= 9 and i1 >= 3 }
	        // { [i0, i1] : -9 + i0 >= 0 }
	        // { [i0, i1] : -3 + i1 >= 0 }
	      if ((((((-9 + 1*i0)) >= 0) && (((-3 + 1*i1)) >= 0)))) {
	        stg8_update_0(stg7 /* buf name */, stg8, ((-9 + 1*i1)), ((-9 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 10 and i1 >= 5 }
	      // { [i0, i1] : i0 >= 10 and i1 >= 5 }
	        // { [i0, i1] : -10 + i0 >= 0 }
	        // { [i0, i1] : -5 + i1 >= 0 }
	      if ((((((-10 + 1*i0)) >= 0) && (((-5 + 1*i1)) >= 0)))) {
	        stg9_update_0(stg8 /* buf name */, stg9, ((-10 + 1*i1)), ((-10 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 11 and i1 >= 7 }
	      // { [i0, i1] : i0 >= 11 and i1 >= 7 }
	        // { [i0, i1] : -11 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-11 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        stg10_update_0(stg9 /* buf name */, stg10, ((-11 + 1*i1)), ((-11 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 12 and i1 >= 9 }
	      // { [i0, i1] : i0 >= 12 and i1 >= 9 }
	        // { [i0, i1] : -12 + i0 >= 0 }
	        // { [i0, i1] : -9 + i1 >= 0 }
	      if ((((((-12 + 1*i0)) >= 0) && (((-9 + 1*i1)) >= 0)))) {
	        stg11_update_0(stg10 /* buf name */, stg11, ((-12 + 1*i1)), ((-12 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 13 and i1 >= 11 }
	      // { [i0, i1] : i0 >= 13 and i1 >= 11 }
	        // { [i0, i1] : -13 + i0 >= 0 }
	        // { [i0, i1] : -11 + i1 >= 0 }
	      if ((((((-13 + 1*i0)) >= 0) && (((-11 + 1*i1)) >= 0)))) {
	        stg12_update_0(stg11 /* buf name */, stg12, ((-13 + 1*i1)), ((-13 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 14 and i1 >= 13 }
	      // { [i0, i1] : i0 >= 14 and i1 >= 13 }
	        // { [i0, i1] : -14 + i0 >= 0 }
	        // { [i0, i1] : -13 + i1 >= 0 }
	      if ((((((-14 + 1*i0)) >= 0) && (((-13 + 1*i1)) >= 0)))) {
	        stg13_update_0(stg12 /* buf name */, stg13, ((-14 + 1*i1)), ((-14 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 15 and i1 >= 15 }
	      // { [i0, i1] : i0 >= 15 and i1 >= 15 }
	        // { [i0, i1] : -15 + i0 >= 0 }
	        // { [i0, i1] : -15 + i1 >= 0 }
	      if ((((((-15 + 1*i0)) >= 0) && (((-15 + 1*i1)) >= 0)))) {
	        stg14_update_0(stg13 /* buf name */, stg14, ((-15 + 1*i1)), ((-15 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 15 and i1 >= 15 }
	      // { [i0, i1] : i0 >= 15 and i1 >= 15 }
	        // { [i0, i1] : -15 + i0 >= 0 }
	        // { [i0, i1] : -15 + i1 >= 0 }
	      if ((((((-15 + 1*i0)) >= 0) && (((-15 + 1*i1)) >= 0)))) {
	        jac2_32_update_0(stg14 /* buf name */, jac2_32, ((-15 + 1*i1)), ((-15 + 1*i0)));
	      }
	    }
	  }
...
void jac2_32_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */jac2_32, const int num_epochs) {
...
#ifdef __VIVADO_SYNTH__
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[in_1, in_0] : 0 <= in_0 <= 1094 and -15 <= in_1 <= 1094 }
const int in_update_0_read_pipe0_num_transfers = 1215450;
  // { jac2_32_update_0[root = 0, jac2_32_0, jac2_32_1] -> jac2_32[jac2_32_1, jac2_32_0] : 0 <= jac2_32_0 <= 1079 and 0 <= jac2_32_1 <= 1079 }
const int jac2_32_update_0_write_pipe0_num_transfers = 1166400;


extern "C" {

void jac2_32_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* jac2_32_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = jac2_32_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = jac2_32_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > jac2_32_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  jac2_32_opt_wrapper(in_update_0_read_pipe0_channel, jac2_32_update_0_write_pipe0_channel, size);

  burst_write<16>(jac2_32_update_0_write_pipe0, jac2_32_update_0_write_pipe0_channel, jac2_32_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void jac2_32_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  jac2_32_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = jac2_32_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  jac2_32_opt(in_update_0_read_pipe0, jac2_32_update_0_write_pipe0);
