#include <fstream>
#include "jac2_32_opt.h"

int main() {
  srand(234);
  ofstream fout("regression_result_jac2_32_opt.txt");
  HWStream<hw_uint<16 > > in_off_chip;
  HWStream<hw_uint<16 > > jac2_32;
