...
hw_uint<16> icsc_500MHz_1_generated_compute(hw_uint<16*1> stg9) {
...
hw_uint<16>  stg9_generated_compute_unrolled_1(hw_uint<64>& stg8) {
  ...
  // icsc_500MHz_1_update_0 unroll factor: 1
hw_uint<16>  icsc_500MHz_1_generated_compute_unrolled_1(hw_uint<16>& stg9) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_stg9;
  set_at<0, 16, 16>(lane_0_stg9, stg9.extract<0, 15>());
  auto result_0 = icsc_500MHz_1_generated_compute(lane_0_stg9);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
