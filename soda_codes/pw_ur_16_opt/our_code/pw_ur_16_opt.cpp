...
#include "pw_ur_16_opt_compute_units.h"
...
inline void pw_ur_16_update_0(input_cache& input, HWStream<hw_uint<256> >& /* buffer_args num ports = 16 */pw_ur_16, int d0, int d1) {
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "pw_ur_16_update_0_input," << d0<< "," << d1<< "," <<  input_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = pw_ur_16_generated_compute_unrolled_16(input_0_c__0_value);
	// Produce: pw_ur_16
  ...
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 3) << ", " << d1<< "," <<  debug_compute_result_lane_3 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 4) << ", " << d1<< "," <<  debug_compute_result_lane_4 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 5) << ", " << d1<< "," <<  debug_compute_result_lane_5 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 6) << ", " << d1<< "," <<  debug_compute_result_lane_6 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 7) << ", " << d1<< "," <<  debug_compute_result_lane_7 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 8) << ", " << d1<< "," <<  debug_compute_result_lane_8 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 9) << ", " << d1<< "," <<  debug_compute_result_lane_9 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 10) << ", " << d1<< "," <<  debug_compute_result_lane_10 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 11) << ", " << d1<< "," <<  debug_compute_result_lane_11 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 12) << ", " << d1<< "," <<  debug_compute_result_lane_12 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 13) << ", " << d1<< "," <<  debug_compute_result_lane_13 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 14) << ", " << d1<< "," <<  debug_compute_result_lane_14 << endl;
  *global_debug_handle << "pw_ur_16_update_0," << (16*d0 + 15) << ", " << d1<< "," <<  debug_compute_result_lane_15 << endl;
#endif //__VIVADO_SYNTH__
...
#pragma HLS INTERFACE s_axilite port = pw_ur_16_update_0_write bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  pw_ur_16_opt(input_update_0_read_channel, pw_ur_16_update_0_write_channel);

  write_output(pw_ur_16_update_0_write, pw_ur_16_update_0_write_channel, size);
}
