...
#include "ef_cartoon_naive_compute_units.h"
...
inline hw_uint<16> bright_gauss_blur_1_rd0_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 18] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // Write schedule: { bright_update_0[i0, i1] -> [i1, i0, 4] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 61] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_update_0[i0, i1] -> [i1, i0, 4] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> bright_weights_rd0_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_update_0[i0, i1] -> [i1, i0, 5] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { bright_update_0[i0, i1] -> [i1, i0, 4] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
  auto value_bright_bright_update_0_write0 = bright.bright_bright_update_0_write0_merged_banks_11.peek_0();
  return value_bright_bright_update_0_write0;
...
inline hw_uint<16> bright_gauss_ds_1_rd0_select(bright_gauss_blur_1_cache& bright_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 19] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
  // Write schedule: { bright_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 18] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_ds_2_rd0_select(bright_gauss_blur_2_cache& bright_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 21] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
  // Write schedule: { bright_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 20] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_ds_3_rd0_select(bright_gauss_blur_3_cache& bright_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 23] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // Write schedule: { bright_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 22] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_blur_2_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 20] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // Write schedule: { bright_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 19] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 52] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 19] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_laplace_us_0_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 60] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 19] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_gauss_blur_3_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 22] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // Write schedule: { bright_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 21] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 25] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 21] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_laplace_us_1_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 51] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 21] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_laplace_us_2_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 24] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 23] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
...
inline hw_uint<16> fused_level_3_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { fused_level_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 42] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // Write schedule: { bright_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 23] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_0_rd0_select(bright_laplace_diff_0_cache& bright_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 63] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 61] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(bright_laplace_diff_1_cache& bright_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 57] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 52] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(bright_laplace_diff_2_cache& bright_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 41] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 25] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_laplace_us_0_cache& bright_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 61] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 60] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_laplace_us_1_cache& bright_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 52] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 51] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_laplace_us_2_cache& bright_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 25] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 24] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_rd0_select(bright_weights_cache& bright_weights, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_update_0[i0, i1] -> [i1, i0, 6] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { bright_weights_update_0[i0, i1] -> [i1, i0, 5] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_rd0_select(bright_weights_cache& bright_weights, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_update_0[i0, i1] -> [i1, i0, 32] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { bright_weights_update_0[i0, i1] -> [i1, i0, 5] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
  auto value_bright_weights_bright_weights_update_0_write0 = bright_weights.bright_weights_bright_weights_update_0_write0_merged_banks_2.peek_0();
  return value_bright_weights_bright_weights_update_0_write0;
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd0_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 7] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // Write schedule: { bright_weights_normed_update_0[i0, i1] -> [i1, i0, 6] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_0_rd0_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 62] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_weights_normed_update_0[i0, i1] -> [i1, i0, 6] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_1_rd0_select(bright_weights_normed_gauss_blur_1_cache& bright_weights_normed_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 8] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
  // Write schedule: { bright_weights_normed_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 7] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_2_rd0_select(bright_weights_normed_gauss_blur_2_cache& bright_weights_normed_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 27] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
  // Write schedule: { bright_weights_normed_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 26] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_3_rd0_select(bright_weights_normed_gauss_blur_3_cache& bright_weights_normed_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 29] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // Write schedule: { bright_weights_normed_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 28] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_2_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 26] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 8] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_1_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 54] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 8] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_weights_normed_laplace_us_0_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 9] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 8] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_3_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 28] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 27] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_2_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 31] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 27] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_weights_normed_laplace_us_1_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 53] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 27] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> bright_weights_normed_laplace_us_2_rd0_select(bright_weights_normed_gauss_ds_3_cache& bright_weights_normed_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 30] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_weights_normed_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 29] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
...
inline hw_uint<16> fused_level_0_rd0_select(bright_weights_normed_laplace_diff_0_cache& bright_weights_normed_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 63] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 62] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(bright_weights_normed_laplace_diff_1_cache& bright_weights_normed_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 57] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 54] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(bright_weights_normed_laplace_diff_2_cache& bright_weights_normed_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 41] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 31] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_0_rd0_select(bright_weights_normed_laplace_us_0_cache& bright_weights_normed_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 62] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { bright_weights_normed_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 9] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_1_rd0_select(bright_weights_normed_laplace_us_1_cache& bright_weights_normed_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 54] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { bright_weights_normed_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 53] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_2_rd0_select(bright_weights_normed_laplace_us_2_cache& bright_weights_normed_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 31] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { bright_weights_normed_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 30] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_blur_1_rd0_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 10] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // Write schedule: { dark_update_0[i0, i1] -> [i1, i0, 2] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 59] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_update_0[i0, i1] -> [i1, i0, 2] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> dark_weights_rd0_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_update_0[i0, i1] -> [i1, i0, 3] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { dark_update_0[i0, i1] -> [i1, i0, 2] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
  auto value_dark_dark_update_0_write0 = dark.dark_dark_update_0_write0_merged_banks_11.peek_0();
  return value_dark_dark_update_0_write0;
...
inline hw_uint<16> dark_gauss_ds_1_rd0_select(dark_gauss_blur_1_cache& dark_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 11] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
  // Write schedule: { dark_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 10] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_ds_2_rd0_select(dark_gauss_blur_2_cache& dark_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 13] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
  // Write schedule: { dark_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 12] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_ds_3_rd0_select(dark_gauss_blur_3_cache& dark_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 15] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // Write schedule: { dark_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 14] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_blur_2_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 12] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // Write schedule: { dark_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 11] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 56] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 11] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_laplace_us_0_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 58] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 11] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_gauss_blur_3_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 14] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // Write schedule: { dark_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 13] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 17] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 13] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_laplace_us_1_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 55] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 13] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_laplace_us_2_rd0_select(dark_gauss_ds_3_cache& dark_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 16] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 15] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
...
inline hw_uint<16> fused_level_0_rd0_select(dark_laplace_diff_0_cache& dark_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 63] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 59] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(dark_laplace_diff_1_cache& dark_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 57] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 56] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(dark_laplace_diff_2_cache& dark_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 41] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 17] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_laplace_us_0_cache& dark_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 59] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 58] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_laplace_us_1_cache& dark_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 56] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 55] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_laplace_us_2_cache& dark_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 17] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 16] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_rd0_select(dark_weights_cache& dark_weights, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_update_0[i0, i1] -> [i1, i0, 6] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { dark_weights_update_0[i0, i1] -> [i1, i0, 3] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd0_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 33] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // Write schedule: { dark_weights_normed_update_0[i0, i1] -> [i1, i0, 32] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_0_rd0_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 48] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_weights_normed_update_0[i0, i1] -> [i1, i0, 32] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_1_rd0_select(dark_weights_normed_gauss_blur_1_cache& dark_weights_normed_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 34] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
  // Write schedule: { dark_weights_normed_gauss_blur_1_update_0[i0, i1] -> [2 + i1, 2 + i0, 33] : 0 <= i0 <= 204 and 0 <= i1 <= 204 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_2_rd0_select(dark_weights_normed_gauss_blur_2_cache& dark_weights_normed_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 36] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
  // Write schedule: { dark_weights_normed_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 35] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_3_rd0_select(dark_weights_normed_gauss_blur_3_cache& dark_weights_normed_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 38] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
  // Write schedule: { dark_weights_normed_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 37] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_2_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 35] : 0 <= i0 <= 100 and 0 <= i1 <= 100 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 34] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_1_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 50] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 34] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_weights_normed_laplace_us_0_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 47] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[i0, i1] -> [2 + 2i1, 2 + 2i0, 34] : 0 <= i0 <= 102 and 0 <= i1 <= 102 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_3_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 37] : 0 <= i0 <= 48 and 0 <= i1 <= 48 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 36] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_2_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 40] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 36] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_weights_normed_laplace_us_1_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 49] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[i0, i1] -> [6 + 4i1, 6 + 4i0, 36] : 0 <= i0 <= 50 and 0 <= i1 <= 50 }
...
inline hw_uint<16> dark_weights_normed_laplace_us_2_rd0_select(dark_weights_normed_gauss_ds_3_cache& dark_weights_normed_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 39] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_weights_normed_gauss_ds_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 38] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
...
inline hw_uint<16> fused_level_0_rd0_select(dark_weights_normed_laplace_diff_0_cache& dark_weights_normed_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 63] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 48] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(dark_weights_normed_laplace_diff_1_cache& dark_weights_normed_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 57] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 50] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(dark_weights_normed_laplace_diff_2_cache& dark_weights_normed_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 41] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 40] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_0_rd0_select(dark_weights_normed_laplace_us_0_cache& dark_weights_normed_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 48] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { dark_weights_normed_laplace_us_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 47] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_1_rd0_select(dark_weights_normed_laplace_us_1_cache& dark_weights_normed_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 50] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { dark_weights_normed_laplace_us_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 49] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_2_rd0_select(dark_weights_normed_laplace_us_2_cache& dark_weights_normed_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 40] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { dark_weights_normed_laplace_us_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 39] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> ef_cartoon_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
  ...
  // Read schedule : { ef_cartoon_update_0[i0, i1] -> [14 + i1, 14 + i0, 46] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { final_merged_0_update_0[i0, i1] -> [14 + i1, 14 + i0, 45] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: {  }
...
inline hw_uint<16> final_merged_0_rd0_select(final_merged_1_cache& final_merged_1, int d0, int d1) {
  ...
  // Read schedule : { final_merged_0_update_0[i0, i1] -> [14 + i1, 14 + i0, 45] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { final_merged_1_update_0[i0, i1] -> [14 + 2i1, 14 + 2i0, 44] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
...
inline hw_uint<16> final_merged_1_rd0_select(final_merged_2_cache& final_merged_2, int d0, int d1) {
  ...
  // Read schedule : { final_merged_1_update_0[i0, i1] -> [14 + 2i1, 14 + 2i0, 44] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { final_merged_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 43] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
...
inline hw_uint<16> final_merged_0_rd0_select(fused_level_0_cache& fused_level_0, int d0, int d1) {
  ...
  // Read schedule : { final_merged_0_update_0[i0, i1] -> [14 + i1, 14 + i0, 45] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // Write schedule: { fused_level_0_update_0[i0, i1] -> [2 + i1, 2 + i0, 63] : 0 <= i0 <= 199 and 0 <= i1 <= 199 }
  // DD fold: { final_merged_0_update_0[d0, d1] -> ((39999 - d0) - 200 * d1) : 0 <= d0 <= 198 and 189 <= d1 <= 198; final_merged_0_update_0[d0, d1] -> (39800 - 200 * d1) : d0 = 199 and 189 <= d1 <= 198; final_merged_0_update_0[d0, d1] -> (2599 - d0) : 189 <= d0 <= 198 and 0 <= d1 <= 187; final_merged_0_update_0[d0, d1] -> 2400 : d0 = 199 and 0 <= d1 <= 187; final_merged_0_update_0[d0, d1] -> 2411 : 0 <= d0 <= 188 and 0 <= d1 <= 187; final_merged_0_update_0[d0, d1] -> (2399 - d0) : d1 = 188 and 0 <= d0 <= 198 and (d0 <= 188 or d0 >= 189); final_merged_0_update_0[d0, d1] -> 2200 : d0 = 199 and d1 = 188; final_merged_0_update_0[d0, d1] -> (199 - d0) : d1 = 199 and 0 <= d0 <= 198 }
...
struct fused_level_1_fused_level_1_update_0_write0_to_final_merged_1_rd0_cache {
	...
	// Capacity: 404
	// # of read delays: 404
	fifo<hw_uint<16>, 404> f;
	inline hw_uint<16> peek(const int offset) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
    return f.peek(403 - offset);
  }
...
inline hw_uint<16> final_merged_1_rd0_select(fused_level_1_cache& fused_level_1, int d0, int d1) {
  ...
  // Read schedule : { final_merged_1_update_0[i0, i1] -> [14 + 2i1, 14 + 2i0, 44] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // Write schedule: { fused_level_1_update_0[i0, i1] -> [6 + 2i1, 6 + 2i0, 57] : 0 <= i0 <= 99 and 0 <= i1 <= 99 }
  // DD fold: { final_merged_1_update_0[d0, d1] -> ((9999 - d0) - 100 * d1) : 0 <= d0 <= 98 and 97 <= d1 <= 98; final_merged_1_update_0[d0, d1] -> (9900 - 100 * d1) : d0 = 99 and 97 <= d1 <= 98; final_merged_1_update_0[d0, d1] -> (499 - d0) : 97 <= d0 <= 98 and 0 <= d1 <= 95; final_merged_1_update_0[d0, d1] -> 400 : d0 = 99 and 0 <= d1 <= 95; final_merged_1_update_0[d0, d1] -> 403 : 0 <= d0 <= 96 and 0 <= d1 <= 95; final_merged_1_update_0[d0, d1] -> (399 - d0) : d1 = 96 and 0 <= d0 <= 98 and (d0 <= 96 or d0 >= 97); final_merged_1_update_0[d0, d1] -> 300 : d0 = 99 and d1 = 96; final_merged_1_update_0[d0, d1] -> (99 - d0) : d1 = 99 and 0 <= d0 <= 98 }
  auto value_fused_level_1_fused_level_1_update_0_write0 = fused_level_1.fused_level_1_fused_level_1_update_0_write0_to_final_merged_1_rd0.peek(/* one reader or all rams */ (-96 + d1 == 0 && -99 + d0 == 0) ? (300) : (-99 + d0 == 0 && 95 - d1 >= 0) ? (400) : (95 - d1 >= 0 && 96 - d0 >= 0) ? (403) : (-99 + d1 == 0 && 98 - d0 >= 0) ? ((99 - d0)) : (-96 + d1 == 0 && 98 - d0 >= 0) ? ((399 - d0)) : (-97 + d0 >= 0 && 98 - d0 >= 0 && 95 - d1 >= 0) ? ((499 - d0)) : (-99 + d0 == 0 && -97 + d1 >= 0 && 98 - d1 >= 0) ? ((9900 - 100 * d1)) : (98 - d1 >= 0 && 98 - d0 >= 0 && -97 + d1 >= 0) ? (((9999 - d0) - 100 * d1)) : 0);
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_2_cache& fused_level_2, int d0, int d1) {
  ...
  // Read schedule : { final_merged_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 43] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { fused_level_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 41] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // DD fold: {  }
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_3_cache& fused_level_3, int d0, int d1) {
  ...
  // Read schedule : { final_merged_2_update_0[i0, i1] -> [14 + 4i1, 14 + 4i0, 43] : 0 <= i0 <= 49 and 0 <= i1 <= 49 }
  // Write schedule: { fused_level_3_update_0[i0, i1] -> [14 + 8i1, 14 + 8i0, 42] : 0 <= i0 <= 24 and 0 <= i1 <= 24 }
...
inline hw_uint<16> bright_rd0_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { bright_update_0[i0, i1] -> [i1, i0, 4] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { in_update_0[i0, i1] -> [i1, i0, 1] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
...
inline hw_uint<16> dark_rd0_select(in_cache& in, int d0, int d1) {
  ...
  // Read schedule : { dark_update_0[i0, i1] -> [i1, i0, 2] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // Write schedule: { in_update_0[i0, i1] -> [i1, i0, 1] : 0 <= i0 <= 206 and 0 <= i1 <= 206 }
  // DD fold: {  }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_2.peek_0();
  return value_in_in_update_0_write0;
...
// Driver function
void ef_cartoon_naive(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_cartoon, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ef_cartoon_naive_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	for (int c0 = 0; c0 <= 213; c0 += 1) {
	  if (c0 >= 207) {
	    for (int c1 = 14; c1 <= 213; c1 += 1) {
	      if (c0 == 210 && (c1 + 2) % 4 == 0) {
	dark_laplace_us_2_update_0(dark_gauss_ds_3, dark_laplace_us_2, (c1 - 14) / 4, 49);
	dark_laplace_diff_2_update_0(dark_gauss_ds_2, dark_laplace_us_2, dark_laplace_diff_2, (c1 - 14) / 4, 49);
	bright_laplace_us_2_update_0(bright_gauss_ds_3, bright_laplace_us_2, (c1 - 14) / 4, 49);
	bright_laplace_diff_2_update_0(bright_gauss_ds_2, bright_laplace_us_2, bright_laplace_diff_2, (c1 - 14) / 4, 49);
	bright_weights_normed_laplace_us_2_update_0(bright_weights_normed_gauss_ds_3, bright_weights_normed_laplace_us_2, (c1 - 14) / 4, 49);
	bright_weights_normed_laplace_diff_2_update_0(bright_weights_normed_gauss_ds_2, bright_weights_normed_laplace_us_2, bright_weights_normed_laplace_diff_2, (c1 - 14) / 4, 49);
	dark_weights_normed_laplace_us_2_update_0(dark_weights_normed_gauss_ds_3, dark_weights_normed_laplace_us_2, (c1 - 14) / 4, 49);
	dark_weights_normed_laplace_diff_2_update_0(dark_weights_normed_gauss_ds_2, dark_weights_normed_laplace_us_2, dark_weights_normed_laplace_diff_2, (c1 - 14) / 4, 49);
	fused_level_2_update_0(bright_laplace_diff_2, dark_laplace_diff_2, bright_weights_normed_laplace_diff_2, dark_weights_normed_laplace_diff_2, fused_level_2, (c1 - 14) / 4, 49);
	final_merged_2_update_0(fused_level_3, fused_level_2, final_merged_2, (c1 - 14) / 4, 49);
	      }
	      if (c0 % 2 == 0 && c1 % 2 == 0)
	...
	ef_cartoon_update_0(final_merged_0, ef_cartoon, c1 - 14, c0 - 14);
	    }
	  } else {
	...
	dark_weights_normed_laplace_diff_0_update_0(dark_weights_normed, dark_weights_normed_laplace_us_0, dark_weights_normed_laplace_diff_0, c1 - 2, c0 - 2);
	        ...
	        if (c0 >= 6 && c0 <= 204 && c1 >= 6 && c1 <= 204 && c0 % 2 == 0 && c1 % 2 == 0) {
	...
	fused_level_0_update_0(bright_laplace_diff_0, dark_laplace_diff_0, bright_weights_normed_laplace_diff_0, dark_weights_normed_laplace_diff_0, fused_level_0, c1 - 2, c0 - 2);
	    ...
	    if (c0 >= 14)
	      for (int c1 = 207; c1 <= 213; c1 += 1) {
	        if (c1 == 210 && (c0 + 2) % 4 == 0) {
	dark_laplace_us_2_update_0(dark_gauss_ds_3, dark_laplace_us_2, 49, (c0 - 14) / 4);
	dark_laplace_diff_2_update_0(dark_gauss_ds_2, dark_laplace_us_2, dark_laplace_diff_2, 49, (c0 - 14) / 4);
	bright_laplace_us_2_update_0(bright_gauss_ds_3, bright_laplace_us_2, 49, (c0 - 14) / 4);
	bright_laplace_diff_2_update_0(bright_gauss_ds_2, bright_laplace_us_2, bright_laplace_diff_2, 49, (c0 - 14) / 4);
	bright_weights_normed_laplace_us_2_update_0(bright_weights_normed_gauss_ds_3, bright_weights_normed_laplace_us_2, 49, (c0 - 14) / 4);
	bright_weights_normed_laplace_diff_2_update_0(bright_weights_normed_gauss_ds_2, bright_weights_normed_laplace_us_2, bright_weights_normed_laplace_diff_2, 49, (c0 - 14) / 4);
	dark_weights_normed_laplace_us_2_update_0(dark_weights_normed_gauss_ds_3, dark_weights_normed_laplace_us_2, 49, (c0 - 14) / 4);
	dark_weights_normed_laplace_diff_2_update_0(dark_weights_normed_gauss_ds_2, dark_weights_normed_laplace_us_2, dark_weights_normed_laplace_diff_2, 49, (c0 - 14) / 4);
	fused_level_2_update_0(bright_laplace_diff_2, dark_laplace_diff_2, bright_weights_normed_laplace_diff_2, dark_weights_normed_laplace_diff_2, fused_level_2, 49, (c0 - 14) / 4);
	final_merged_2_update_0(fused_level_3, fused_level_2, final_merged_2, 49, (c0 - 14) / 4);
	        }
	        if (c0 % 2 == 0 && c1 % 2 == 0)
	final_merged_1_update_0(final_merged_2, fused_level_1, final_merged_1, (c1 / 2) - 7, (c0 / 2) - 7);
	final_merged_0_update_0(final_merged_1, fused_level_0, final_merged_0, c1 - 14, c0 - 14);
...
void ef_cartoon_naive(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */ef_cartoon) {

  ef_cartoon_naive(in_off_chip, ef_cartoon, 1);
}
#ifdef __VIVADO_SYNTH__
#include "ef_cartoon_naive.h"
...
void ef_cartoon_naive_accel(hw_uint<16>* in_update_0_read, hw_uint<16>* ef_cartoon_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  ef_cartoon_naive(in_update_0_read_channel, ef_cartoon_update_0_write_channel, size);
