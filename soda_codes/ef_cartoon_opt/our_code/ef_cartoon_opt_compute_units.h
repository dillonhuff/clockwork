...
hw_uint<16>  psef_normalize_weights_unrolled_1(hw_uint<16>& dark_weights, hw_uint<16>& bright_weights) {
  hw_uint<16> whole_result;
  ...
  auto result_0 = psef_normalize_weights(lane_0_dark_weights, lane_0_bright_weights);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
