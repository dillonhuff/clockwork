...
inline hw_uint<16> bxy_ur_8_rd0_select(blurx_cache& blurx, int d0, int d1) {
  ...
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write0 = blurx.blurx_blurx_update_0_write0_merged_banks_2.peek(/* Needs general delay string */ (d0 == 0) ? (1) : 0);
...
inline hw_uint<16> bxy_ur_8_rd1_select(blurx_cache& blurx, int d0, int d1) {
  ...
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write1 = blurx.blurx_blurx_update_0_write1_merged_banks_2.peek(/* Needs general delay string */ (d0 == 0) ? (1) : 0);
...
inline hw_uint<16> bxy_ur_8_rd2_select(blurx_cache& blurx, int d0, int d1) {
  ...
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write2 = blurx.blurx_blurx_update_0_write2_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd3 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[3 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write3 = blurx.blurx_blurx_update_0_write3_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd4 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[4 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write4 = blurx.blurx_blurx_update_0_write4_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd5 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[5 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write5 = blurx.blurx_blurx_update_0_write5_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd6 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[6 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write6 = blurx.blurx_blurx_update_0_write6_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd7 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[7 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: { bxy_ur_8_update_0[d0, d1] -> 1 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_blurx_blurx_update_0_write7 = blurx.blurx_blurx_update_0_write7_merged_banks_1.peek(/* one reader or all rams */ (d0 == 0) ? (1) : 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd8 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[8 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bxy_ur_8_rd9 read pattern: { bxy_ur_8_update_0[d0, d1] -> blurx[9 + 8d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Read schedule : { bxy_ur_8_update_0[d0, d1] -> [2 + d1, 5 + d0, 3] : 0 <= d0 <= 239 and 0 <= d1 <= 1079 }
  // Write schedule: { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
//	bxy_ur_8_rd8
//	bxy_ur_8_rd9
inline hw_uint<160> blurx_bxy_ur_8_update_0_read_bundle_read(blurx_cache& blurx, int d0, int d1) {
...
struct input_input_update_0_write0_to_blurx_rd0_cache {
	...
	// Capacity: 675
	// # of read delays: 194
	fifo<hw_uint<16>, 675> f;
	inline hw_uint<16> peek(const int offset) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
    return f.peek(674 - offset);
  }
...
struct input_input_update_0_write0_to_blurx_rd1_cache {
	...
	// Capacity: 434
	// # of read delays: 194
	fifo<hw_uint<16>, 434> f;
	inline hw_uint<16> peek(const int offset) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
    return f.peek(433 - offset);
  }
...
struct input_input_update_0_write0_to_blurx_rd2_cache {
	...
	// Capacity: 193
	// # of read delays: 193
	fifo<hw_uint<16>, 193> f;
	inline hw_uint<16> peek(const int offset) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
    return f.peek(192 - offset);
  }
...
struct input_input_update_0_write4_to_blurx_rd12_cache {
...
struct input_input_update_0_write4_to_blurx_rd13_cache {
	// RAM Box: {[4, 1924], [0, 1081]}
	// Capacity: 434
	// # of read delays: 194
	fifo<hw_uint<16>, 434> f;
...
struct input_input_update_0_write4_to_blurx_rd14_cache {
	// RAM Box: {[4, 1924], [0, 1081]}
	// Capacity: 193
	// # of read delays: 193
	fifo<hw_uint<16>, 193> f;
...
struct input_input_update_0_write5_to_blurx_rd15_cache {
...
struct input_input_update_0_write5_to_blurx_rd16_cache {
	// RAM Box: {[5, 1925], [0, 1081]}
	// Capacity: 434
	// # of read delays: 194
	fifo<hw_uint<16>, 434> f;
...
struct input_input_update_0_write5_to_blurx_rd17_cache {
	// RAM Box: {[5, 1925], [0, 1081]}
	// Capacity: 193
	// # of read delays: 193
	fifo<hw_uint<16>, 193> f;
...
struct input_input_update_0_write6_to_blurx_rd18_cache {
...
struct input_input_update_0_write6_to_blurx_rd19_cache {
	// RAM Box: {[6, 1926], [0, 1081]}
	// Capacity: 434
	// # of read delays: 194
	fifo<hw_uint<16>, 434> f;
...
struct input_input_update_0_write6_to_blurx_rd20_cache {
	// RAM Box: {[6, 1926], [0, 1081]}
	// Capacity: 193
	// # of read delays: 193
	fifo<hw_uint<16>, 193> f;
...
struct input_input_update_0_write7_to_blurx_rd21_cache {
...
struct input_input_update_0_write7_to_blurx_rd22_cache {
	// RAM Box: {[7, 1927], [0, 1081]}
	// Capacity: 434
	// # of read delays: 194
	fifo<hw_uint<16>, 434> f;
...
struct input_input_update_0_write7_to_blurx_rd23_cache {
	// RAM Box: {[7, 1927], [0, 1081]}
	// Capacity: 193
	// # of read delays: 193
	fifo<hw_uint<16>, 193> f;
...
struct input_cache {
  ...
  input_input_update_0_write4_to_blurx_rd12_cache input_input_update_0_write4_to_blurx_rd12;
  input_input_update_0_write4_to_blurx_rd13_cache input_input_update_0_write4_to_blurx_rd13;
  input_input_update_0_write4_to_blurx_rd14_cache input_input_update_0_write4_to_blurx_rd14;
  input_input_update_0_write5_to_blurx_rd15_cache input_input_update_0_write5_to_blurx_rd15;
  input_input_update_0_write5_to_blurx_rd16_cache input_input_update_0_write5_to_blurx_rd16;
  input_input_update_0_write5_to_blurx_rd17_cache input_input_update_0_write5_to_blurx_rd17;
  input_input_update_0_write6_to_blurx_rd18_cache input_input_update_0_write6_to_blurx_rd18;
  input_input_update_0_write6_to_blurx_rd19_cache input_input_update_0_write6_to_blurx_rd19;
  input_input_update_0_write6_to_blurx_rd20_cache input_input_update_0_write6_to_blurx_rd20;
  input_input_update_0_write7_to_blurx_rd21_cache input_input_update_0_write7_to_blurx_rd21;
  input_input_update_0_write7_to_blurx_rd22_cache input_input_update_0_write7_to_blurx_rd22;
  input_input_update_0_write7_to_blurx_rd23_cache input_input_update_0_write7_to_blurx_rd23;
};
...
inline void input_input_update_0_write4_write(hw_uint<16>& input_input_update_0_write4, input_cache& input, int d0, int d1) {
  input.input_input_update_0_write4_to_blurx_rd12.push(input_input_update_0_write4);
  input.input_input_update_0_write4_to_blurx_rd13.push(input_input_update_0_write4);
  input.input_input_update_0_write4_to_blurx_rd14.push(input_input_update_0_write4);
}

inline void input_input_update_0_write5_write(hw_uint<16>& input_input_update_0_write5, input_cache& input, int d0, int d1) {
  input.input_input_update_0_write5_to_blurx_rd15.push(input_input_update_0_write5);
  input.input_input_update_0_write5_to_blurx_rd16.push(input_input_update_0_write5);
  input.input_input_update_0_write5_to_blurx_rd17.push(input_input_update_0_write5);
}

inline void input_input_update_0_write6_write(hw_uint<16>& input_input_update_0_write6, input_cache& input, int d0, int d1) {
  input.input_input_update_0_write6_to_blurx_rd18.push(input_input_update_0_write6);
  input.input_input_update_0_write6_to_blurx_rd19.push(input_input_update_0_write6);
  input.input_input_update_0_write6_to_blurx_rd20.push(input_input_update_0_write6);
}

inline void input_input_update_0_write7_write(hw_uint<16>& input_input_update_0_write7, input_cache& input, int d0, int d1) {
  input.input_input_update_0_write7_to_blurx_rd21.push(input_input_update_0_write7);
  input.input_input_update_0_write7_to_blurx_rd22.push(input_input_update_0_write7);
  input.input_input_update_0_write7_to_blurx_rd23.push(input_input_update_0_write7);
}
...
inline hw_uint<16> blurx_rd0_select(input_cache& input, int d0, int d1) {
  ...
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write0 = input.input_input_update_0_write0_to_blurx_rd0.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd1_select(input_cache& input, int d0, int d1) {
  ...
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write0 = input.input_input_update_0_write0_to_blurx_rd1.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd10_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write3 = input.input_input_update_0_write3_to_blurx_rd10.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
...
inline hw_uint<16> blurx_rd11_select(input_cache& input, int d0, int d1) {
  ...
  // Read schedule : { blurx_update_0[d0, d1] -> [2 + d1, 5d0, 2] : 0 <= d0 <= 240 and 0 <= d1 <= 1079 }
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write3 = input.input_input_update_0_write3_to_blurx_rd11.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd12_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write4 = input.input_input_update_0_write4_to_blurx_rd12.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd13_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write4 = input.input_input_update_0_write4_to_blurx_rd13.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd14_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write4 = input.input_input_update_0_write4_to_blurx_rd14.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd15_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write5 = input.input_input_update_0_write5_to_blurx_rd15.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd16_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write5 = input.input_input_update_0_write5_to_blurx_rd16.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd17_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write5 = input.input_input_update_0_write5_to_blurx_rd17.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd18_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write6 = input.input_input_update_0_write6_to_blurx_rd18.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd19_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write6 = input.input_input_update_0_write6_to_blurx_rd19.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd2_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write0 = input.input_input_update_0_write0_to_blurx_rd2.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd20_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write6 = input.input_input_update_0_write6_to_blurx_rd20.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write6;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd21_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write7 = input.input_input_update_0_write7_to_blurx_rd21.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd22_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write7 = input.input_input_update_0_write7_to_blurx_rd22.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write7;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd23_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write7 = input.input_input_update_0_write7_to_blurx_rd23.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write7;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd3_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write1 = input.input_input_update_0_write1_to_blurx_rd3.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd4_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write1 = input.input_input_update_0_write1_to_blurx_rd4.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd5_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write1 = input.input_input_update_0_write1_to_blurx_rd5.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd6_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write2 = input.input_input_update_0_write2_to_blurx_rd6.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
...
inline hw_uint<16> blurx_rd7_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (481 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (241 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 241 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write2 = input.input_input_update_0_write2_to_blurx_rd7.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (241) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((241 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((481 - d0)) : 0);
  return value_input_input_update_0_write2;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd8_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (240 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 4 * d0 : 0 < d0 <= 48 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write2 = input.input_input_update_0_write2_to_blurx_rd8.peek(/* one reader or all rams */ (-1 + d0 >= 0 && 48 - d0 >= 0) ? (4 * d0) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((240 - d0)) : 0);
  return value_input_input_update_0_write2;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<16> blurx_rd9_select(input_cache& input, int d0, int d1) {
  ...
  // Write schedule: { input_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 240 and 0 <= d1 <= 1081 }
  // DD fold: { blurx_update_0[d0, d1] -> (722 - d0) : 49 <= d0 <= 239 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 240 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> (482 + 4 * d0) : 0 < d0 <= 48 and 0 <= d1 <= 1079; blurx_update_0[d0, d1] -> 482 : d0 = 0 and 0 <= d1 <= 1079 }
  auto value_input_input_update_0_write3 = input.input_input_update_0_write3_to_blurx_rd9.peek(/* one reader or all rams */ ((-240 + d0 == 0) || (d0 == 0)) ? (482) : (-1 + d0 >= 0 && 48 - d0 >= 0) ? ((482 + 4 * d0)) : (-49 + d0 >= 0 && 239 - d0 >= 0) ? ((722 - d0)) : 0);
  return value_input_input_update_0_write3;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
void bxy_ur_8_opt(HWStream<hw_uint<128> >& /* get_args num ports = 8 */input_arg, HWStream<hw_uint<128> >& /* get_args num ports = 8 */bxy_ur_8) {
  ...
  input_cache input;
	...
	input_update_0(input_arg, input, (c1 - 0) / 1, (c0 - 0) / 1);
	    ...
	    if ((0 <= c1 && c1 <= 1200) && ((c1 - 0) % 5 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	blurx_update_0(input, blurx, (c1 - 0) / 5, (c0 - 2) / 1);
	    }
	
	    if ((5 <= c1 && c1 <= 244) && ((c1 - 5) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	bxy_ur_8_update_0(blurx, bxy_ur_8, (c1 - 5) / 1, (c0 - 2) / 1);
	    }
...
#pragma HLS INTERFACE m_axi port = bxy_ur_8_update_0_write offset = slave bundle = gmem
