...
int main(int argc, char **argv) {
  ...
  const int bxy_ur_8_update_0_write_DATA_SIZE = 2073600;
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, bxy_ur_8_update_0_write_ocl_buf));

  int bxy_ur_8_update_0_write_size = bxy_ur_8_update_0_write_DATA_SIZE;
  OCL_CHECK(err, err = krnl_vector_add.setArg(2, bxy_ur_8_update_0_write_size));
