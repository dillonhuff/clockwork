...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > jac9_16_1_merged611_write_channel;
  // In lanes = 16
  ...
  jac9_16_opt(in_1_merged563_read_channel, jac9_16_1_merged611_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = jac9_16_1_merged611_write_channel.read();
  ...
  output.save_image("./images/jac9_16_opt_bmp_out.bmp");
}
