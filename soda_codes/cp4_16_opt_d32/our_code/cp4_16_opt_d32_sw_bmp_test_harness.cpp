...
#include <fstream>
#include <vector>
#include "cp4_16_opt_d32.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<256> > raw_1_merged1211_read_channel;
  ...
  for (int r = 0; r < 1088; r++) {
    for (int cl = 0; cl < 1968 / 16; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        raw_1_merged1211_read_channel.write(packed);
    }
  }
  cp4_16_opt_d32(raw_1_merged1211_read_channel, cp4_16_1_merged1253_write_channel);
  ...
  output.save_image("./images/cp4_16_opt_d32_bmp_out.bmp");
}
