...
#include <fstream>
#include <vector>
#include "one_pipe40_opt.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<64> > in_off_chip0_update_0_read_channel;
  HWStream<hw_uint<64> > one_pipe40_update_0_write_channel;
  // In lanes = 4
  ...
  one_pipe40_opt(in_off_chip0_update_0_read_channel, one_pipe40_update_0_write_channel);
