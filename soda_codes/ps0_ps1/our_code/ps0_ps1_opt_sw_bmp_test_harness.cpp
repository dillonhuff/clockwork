...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > ps0_update_0_write_channel;
  HWStream<hw_uint<512> > ps1_update_0_write_channel;
  // In lanes = 32
  ...
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 960 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = ps0_update_0_write_channel.read();
  ...
  output.save_image("./images/ps0_ps1_opt_bmp_out.bmp");
}
