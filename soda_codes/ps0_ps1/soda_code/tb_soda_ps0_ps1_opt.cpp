...
int main() {
  ...
  ap_uint<BURST_WIDTH>* ps0 = (ap_uint<BURST_WIDTH>*) malloc(sizeof(ap_uint<BURST_WIDTH>)*num_transfers);
  ap_uint<BURST_WIDTH>* ps1 = (ap_uint<BURST_WIDTH>*) malloc(sizeof(ap_uint<BURST_WIDTH>)*num_transfers);
  ...
  ps0_ps1_opt_kernel(ps0, ps1, in_off_chip0_oc, in_off_chip1_oc, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_ps0_ps1_opt_regression_result.csv", ps0, nrows, ncols, transfer_cols);
  write_results_decimal<bits_per_pixel>("soda_ps0_ps1_opt_regression_result.csv", ps1, nrows, ncols, transfer_cols);
