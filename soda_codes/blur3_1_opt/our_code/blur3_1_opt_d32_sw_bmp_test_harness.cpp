...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<16> > input_update_0_sm16_023_sm42_044_read_channel;
  HWStream<hw_uint<16> > blur3_1_update_0_sm18_027_sm38_050_write_channel;
  // In lanes = 1
  for (int r = 0; r < 1082; r++) {
    for (int cl = 0; cl < 1082 / 1; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        input_update_0_sm16_023_sm42_044_read_channel.write(packed);
    }
  }
  blur3_1_opt_d32(input_update_0_sm16_023_sm42_044_read_channel, blur3_1_update_0_sm18_027_sm38_050_write_channel);
  bitmap_image output(1080, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1080 / 1; cl++) {
      auto packed_val = blur3_1_update_0_sm18_027_sm38_050_write_channel.read();
