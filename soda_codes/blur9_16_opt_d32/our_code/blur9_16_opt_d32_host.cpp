...
int main(int argc, char **argv) {
  ...
  const int blur9_16_1_merged252_write_pipe0_DATA_SIZE = num_epochs*2073600;
  const int blur9_16_1_merged252_write_pipe0_BYTES_PER_PIXEL = 16 / 8;
  size_t blur9_16_1_merged252_write_pipe0_size_bytes = blur9_16_1_merged252_write_pipe0_BYTES_PER_PIXEL * blur9_16_1_merged252_write_pipe0_DATA_SIZE;

  total_size_bytes += blur9_16_1_merged252_write_pipe0_size_bytes;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > blur9_16_1_merged252_write_pipe0(blur9_16_1_merged252_write_pipe0_size_bytes);
  ...
  for (unsigned int i = 0; i < devices.size(); i++) {
    ...
    if (err != CL_SUCCESS) {
      ...
      OCL_CHECK(err, krnl_vector_add = cl::Kernel(program, "blur9_16_opt_d32_accel", &err));
      valid_device++;
      break;
    }
  }
  ...
  OCL_CHECK(err, cl::Buffer blur9_16_1_merged252_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, blur9_16_1_merged252_write_pipe0_size_bytes, blur9_16_1_merged252_write_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, blur9_16_1_merged252_write_pipe0_ocl_buf));
...
{
    std::ofstream regression_result("blur9_16_1_merged252_write_pipe0_accel_result.csv");
    for (int i = 0; i < blur9_16_1_merged252_write_pipe0_DATA_SIZE; i++) {
