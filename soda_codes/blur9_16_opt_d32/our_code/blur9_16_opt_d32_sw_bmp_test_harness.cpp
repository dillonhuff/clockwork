...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > blur9_16_1_merged252_write_channel;
  // In lanes = 16
  ...
  blur9_16_opt_d32(input_1_merged255_read_channel, blur9_16_1_merged252_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = blur9_16_1_merged252_write_channel.read();
  ...
  output.save_image("./images/blur9_16_opt_d32_bmp_out.bmp");
}
