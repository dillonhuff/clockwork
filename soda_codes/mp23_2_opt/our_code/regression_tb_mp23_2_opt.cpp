...
int main() {
  ofstream in_pix("input_pixels_regression_result_mp23_2_opt.txt");
  ofstream fout("regression_result_mp23_2_opt.txt");
  HWStream<hw_uint<64> > in_update_0_read;
  HWStream<hw_uint<32> > mp23_2_update_0_write;
  ...
  mp23_2_opt(in_update_0_read, mp23_2_update_0_write);

  for (int i = 0; i < 262144; i++) {
    hw_uint<32> actual = mp23_2_update_0_write.read();
