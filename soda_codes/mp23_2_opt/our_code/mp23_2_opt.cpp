...
#include "mp23_2_opt_compute_units.h"
...
inline hw_uint<32>  mp23_2_rd0_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_2_rd0 read pattern: { mp23_2_update_0[d0, d1, d2] -> in[2d0, 2d1, d2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_2_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 63 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_2_update_0[d0, d1, d2] -> 64 : 0 < d0 <= 62 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_2_update_0[d0, d1, d2] -> (1 + d0) : d0 = 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_2_update_0[d0, d1, d2] -> 64 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_2_rd1_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_2_rd1 read pattern: { mp23_2_update_0[d0, d1, d2] -> in[2d0, 1 + 2d1, d2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_2_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 63 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
inline hw_uint<32>  mp23_2_rd2_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_2_rd2 read pattern: { mp23_2_update_0[d0, d1, d2] -> in[1 + 2d0, 2d1, d2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_2_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 63 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: { mp23_2_update_0[d0, d1, d2] -> 64 : 0 < d0 <= 62 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_2_update_0[d0, d1, d2] -> (1 + d0) : d0 = 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63; mp23_2_update_0[d0, d1, d2] -> 64 : d0 = 0 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
...
inline hw_uint<32>  mp23_2_rd3_select(in_cache& in, int d0, int d1, int d2) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // mp23_2_rd3 read pattern: { mp23_2_update_0[d0, d1, d2] -> in[1 + 2d0, 1 + 2d1, d2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Read schedule : { mp23_2_update_0[d0, d1, d2] -> [d2, 1 + 2d1, d0, 2] : 0 <= d0 <= 63 and 0 <= d1 <= 63 and 0 <= d2 <= 63 }
  // Write schedule: { in_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : 0 <= d0 <= 63 and 0 <= d1 <= 127 and 0 <= d2 <= 63 }
  // DD fold: {  }
...
// mp23_2_update_0_read
//	mp23_2_rd0
//	mp23_2_rd1
//	mp23_2_rd2
//	mp23_2_rd3
inline hw_uint<128> in_mp23_2_update_0_read_bundle_read(in_cache& in, int d0, int d1, int d2) {
  // # of ports in bundle: 4
	...
	hw_uint<128> result;
	hw_uint<32>  mp23_2_rd0_res = mp23_2_rd0_select(in, d0, d1, d2);
	set_at<0, 128>(result, mp23_2_rd0_res);
	hw_uint<32>  mp23_2_rd1_res = mp23_2_rd1_select(in, d0, d1, d2);
	set_at<32, 128>(result, mp23_2_rd1_res);
	hw_uint<32>  mp23_2_rd2_res = mp23_2_rd2_select(in, d0, d1, d2);
	set_at<64, 128>(result, mp23_2_rd2_res);
	hw_uint<32>  mp23_2_rd3_res = mp23_2_rd3_select(in, d0, d1, d2);
	set_at<96, 128>(result, mp23_2_rd3_res);
	return result;
}
...
inline void mp23_2_update_0(in_cache& in, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */mp23_2, int d0, int d1, int d2) {
	// Consume: in
	auto in_0_c__0_value = in_mp23_2_update_0_read_bundle_read(in/* source_delay */, d0, d1, d2);
...
// Driver function
void mp23_2_opt(HWStream<hw_uint<64> >& /* get_args num ports = 2 */in_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */mp23_2, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("mp23_2_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // mp23_2_update_0 -> [1*d2*1*1 + 1*0,1*d1*1*2 + 1*1,1*d0*1*1 + 1*0,1*2]
	...
	mp23_2_update_0(in, mp23_2, (c2 - 0) / 1, (c1 - 1) / 2, (c0 - 0) / 1);
	      }
...
void mp23_2_opt(HWStream<hw_uint<64> >& /* get_args num ports = 2 */in_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */mp23_2) {

  mp23_2_opt(in_oc, mp23_2, 1);
}
#ifdef __VIVADO_SYNTH__
#include "mp23_2_opt.h"

const int in_update_0_read_num_transfers = 524288;
const int mp23_2_update_0_write_num_transfers = 262144;
...
static void write_mp23_2_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  int num_transfers = mp23_2_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void mp23_2_opt_accel(hw_uint<64>* in_update_0_read, hw_uint<32>* mp23_2_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = mp23_2_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = mp23_2_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<64> > in_update_0_read_channel;
  static HWStream<hw_uint<32> > mp23_2_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  mp23_2_opt(in_update_0_read_channel, mp23_2_update_0_write_channel, size);

  write_mp23_2_update_0_write(mp23_2_update_0_write, mp23_2_update_0_write_channel, size);
}
