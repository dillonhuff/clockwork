...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<1024> > in0_update_0_read_channel;
  HWStream<hw_uint<1024> > in1_update_0_read_channel;
  HWStream<hw_uint<1024> > blur_example_update_0_write_channel;
  // In lanes = 32
