...
hw_uint<16> bxy_ur_16_generated_compute(hw_uint<16*3> blurx) {
...
hw_uint<256>  blurx_generated_compute_unrolled_16(hw_uint<768>& input) {
  ...
  // bxy_ur_16_update_0 unroll factor: 16
hw_uint<256>  bxy_ur_16_generated_compute_unrolled_16(hw_uint<288>& blurx) {
  hw_uint<256> whole_result;
  ...
  auto result_0 = bxy_ur_16_generated_compute(lane_0_blurx);
  set_at<0, 256, 16>(whole_result, result_0);
  ...
  auto result_1 = bxy_ur_16_generated_compute(lane_1_blurx);
  set_at<16, 256, 16>(whole_result, result_1);
  ...
  auto result_2 = bxy_ur_16_generated_compute(lane_2_blurx);
  set_at<32, 256, 16>(whole_result, result_2);
  ...
  auto result_3 = bxy_ur_16_generated_compute(lane_3_blurx);
  set_at<48, 256, 16>(whole_result, result_3);
  ...
  auto result_4 = bxy_ur_16_generated_compute(lane_4_blurx);
  set_at<64, 256, 16>(whole_result, result_4);
  ...
  auto result_5 = bxy_ur_16_generated_compute(lane_5_blurx);
  set_at<80, 256, 16>(whole_result, result_5);
  ...
  auto result_6 = bxy_ur_16_generated_compute(lane_6_blurx);
  set_at<96, 256, 16>(whole_result, result_6);
  ...
  auto result_7 = bxy_ur_16_generated_compute(lane_7_blurx);
  set_at<112, 256, 16>(whole_result, result_7);
  ...
  auto result_8 = bxy_ur_16_generated_compute(lane_8_blurx);
  set_at<128, 256, 16>(whole_result, result_8);
  ...
  auto result_9 = bxy_ur_16_generated_compute(lane_9_blurx);
  set_at<144, 256, 16>(whole_result, result_9);
  ...
  auto result_10 = bxy_ur_16_generated_compute(lane_10_blurx);
  set_at<160, 256, 16>(whole_result, result_10);
  ...
  auto result_11 = bxy_ur_16_generated_compute(lane_11_blurx);
  set_at<176, 256, 16>(whole_result, result_11);
  ...
  auto result_12 = bxy_ur_16_generated_compute(lane_12_blurx);
  set_at<192, 256, 16>(whole_result, result_12);
  ...
  auto result_13 = bxy_ur_16_generated_compute(lane_13_blurx);
  set_at<208, 256, 16>(whole_result, result_13);
  ...
  auto result_14 = bxy_ur_16_generated_compute(lane_14_blurx);
  set_at<224, 256, 16>(whole_result, result_14);
  ...
  auto result_15 = bxy_ur_16_generated_compute(lane_15_blurx);
  set_at<240, 256, 16>(whole_result, result_15);
  return whole_result;
}
