...
hw_uint<16> jac9_32_generated_compute(hw_uint<16*1> stg14) {
...
hw_uint<16>  stg14_generated_compute_unrolled_1(hw_uint<64>& stg13) {
  ...
  // jac9_32_update_0 unroll factor: 1
hw_uint<16>  jac9_32_generated_compute_unrolled_1(hw_uint<16>& stg14) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_stg14;
  set_at<0, 16, 16>(lane_0_stg14, stg14.extract<0, 15>());
  auto result_0 = jac9_32_generated_compute(lane_0_stg14);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
