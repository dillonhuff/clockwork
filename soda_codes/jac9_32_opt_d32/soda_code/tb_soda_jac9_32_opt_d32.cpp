// AUTO GEN SODA TB
#include "jac9_32_opt_d32_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  jac9_32_opt_d32_kernel(jac9_32, in_off_chip, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_jac9_32_opt_d32_regression_result.csv", jac9_32, nrows, ncols, transfer_cols);
  free(in_off_chip);
  free(jac9_32);
}
