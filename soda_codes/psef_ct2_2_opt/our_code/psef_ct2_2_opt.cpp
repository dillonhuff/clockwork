...
#include "psef_ct2_2_opt_compute_units.h"
...
inline hw_uint<16> bright_gauss_blur_1_rd0_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_gauss_blur_1_update_0[d0, d1] -> 1929 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_gauss_blur_1_rd1_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_gauss_blur_1_update_0[d0, d1] -> 965 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_gauss_blur_1_rd11_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_gauss_blur_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_gauss_blur_1_rd12_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_gauss_blur_1_update_0[d0, d1] -> 1928 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; bright_gauss_blur_1_update_0[d0, d1] -> (966 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_gauss_blur_1_rd13_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_gauss_blur_1_update_0[d0, d1] -> 964 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; bright_gauss_blur_1_update_0[d0, d1] -> (2 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_cache& bright, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 55] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_bright_bright_update_0_write0 = bright.bright_bright_update_0_write0_merged_banks_11.peek_1929();
  return value_bright_bright_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
inline hw_uint<16> bright_gauss_ds_1_rd0_select(bright_gauss_blur_1_cache& bright_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 18] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_ds_2_rd0_select(bright_gauss_blur_2_cache& bright_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 26] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 19] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_ds_3_rd0_select(bright_gauss_blur_3_cache& bright_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 31] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 27] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // DD fold: {  }
...
inline hw_uint<16> bright_gauss_blur_2_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 19] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 18] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 54] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 18] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_laplace_us_0_rd0_select(bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 18] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { bright_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
...
inline hw_uint<16> bright_gauss_blur_3_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 27] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 26] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 53] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 26] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_us_1_rd0_select(bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 51] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 26] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_laplace_us_2_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 50] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 31] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> fused_level_3_rd0_select(bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 56] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 31] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_0_rd0_select(bright_laplace_diff_0_cache& bright_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 55] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(bright_laplace_diff_1_cache& bright_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 58] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 54] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(bright_laplace_diff_2_cache& bright_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 57] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 53] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_0_rd0_select(bright_laplace_us_0_cache& bright_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 55] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_1_rd0_select(bright_laplace_us_1_cache& bright_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 54] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 51] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> bright_laplace_diff_2_rd0_select(bright_laplace_us_2_cache& bright_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 53] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 50] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_rd0_select(bright_weights_cache& bright_weights, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd0_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1929 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd1_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> 965 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd11_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd12_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1928 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> (966 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_1_rd13_select(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> 964 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> (2 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_diff_0_rd0 read pattern: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> bright_weights_normed[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_bright_weights_normed_bright_weights_normed_update_0_write0 = bright_weights_normed.bright_weights_normed_bright_weights_normed_update_0_write0_merged_banks_10.peek_1929();
  return value_bright_weights_normed_bright_weights_normed_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_diff_0_rd1 read pattern: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> bright_weights_normed[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_bright_weights_normed_bright_weights_normed_update_0_write1 = bright_weights_normed.bright_weights_normed_bright_weights_normed_update_0_write1_merged_banks_10.peek_1929();
...
inline hw_uint<32> bright_weights_normed_bright_weights_normed_laplace_diff_0_update_0_read_bundle_read(bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  // # of ports in bundle: 2
    // bright_weights_normed_laplace_diff_0_rd0
    // bright_weights_normed_laplace_diff_0_rd1
	...
	set_at<0, 32>(result, bright_weights_normed_laplace_diff_0_rd0_res);
	...
	set_at<16, 32>(result, bright_weights_normed_laplace_diff_0_rd1_res);
	return result;
}
...
inline hw_uint<16> bright_weights_normed_gauss_ds_1_rd0_select(bright_weights_normed_gauss_blur_1_cache& bright_weights_normed_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_2_rd0_select(bright_weights_normed_gauss_blur_2_cache& bright_weights_normed_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_ds_3_rd0_select(bright_weights_normed_gauss_blur_3_cache& bright_weights_normed_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_gauss_blur_2_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 17] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_1_rd0_select(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 48] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_us_0_rd0 read pattern: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, o1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
  auto value_bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0 = bright_weights_normed_gauss_ds_1.bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0_to_bright_weights_normed_laplace_us_0_rd0.peek(/* one reader or all rams */ ((-1 - d1) % 2 == 0) ? ((962 - d0)) : 0);
  return value_bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_us_0_rd1 read pattern: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, o1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 16] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
  auto value_bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0 = bright_weights_normed_gauss_ds_1.bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0_to_bright_weights_normed_laplace_us_0_rd1.peek(/* one reader or all rams */ ((-1 - d1) % 2 == 0) ? ((962 - d0)) : 0);
  return value_bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_ds_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<32> bright_weights_normed_gauss_ds_1_bright_weights_normed_laplace_us_0_update_0_read_bundle_read(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  // # of ports in bundle: 2
    // bright_weights_normed_laplace_us_0_rd0
    // bright_weights_normed_laplace_us_0_rd1
	...
	set_at<0, 32>(result, bright_weights_normed_laplace_us_0_rd0_res);
	...
	set_at<16, 32>(result, bright_weights_normed_laplace_us_0_rd1_res);
	return result;
}
...
inline hw_uint<16> bright_weights_normed_gauss_blur_3_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 25] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_2_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 47] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_weights_normed_laplace_us_1_rd0_select(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 45] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 24] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> bright_weights_normed_laplace_us_2_rd0_select(bright_weights_normed_gauss_ds_3_cache& bright_weights_normed_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 44] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> bright_weights_normed_laplace_diff_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd1 read pattern: { fused_level_0_update_0[d0, d1] -> bright_weights_normed_laplace_diff_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline void bright_weights_normed_laplace_diff_0_bright_weights_normed_laplace_diff_0_update_0_write_bundle_write(hw_uint<32>& bright_weights_normed_laplace_diff_0_update_0_write, bright_weights_normed_laplace_diff_0_cache& bright_weights_normed_laplace_diff_0, int d0, int d1) {
...
//	fused_level_0_rd0
//	fused_level_0_rd1
inline hw_uint<32> bright_weights_normed_laplace_diff_0_fused_level_0_update_0_read_bundle_read(bright_weights_normed_laplace_diff_0_cache& bright_weights_normed_laplace_diff_0, int d0, int d1) {
  // # of ports in bundle: 2
    // fused_level_0_rd0
    // fused_level_0_rd1
...
inline hw_uint<16> fused_level_1_rd0_select(bright_weights_normed_laplace_diff_1_cache& bright_weights_normed_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 58] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 48] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(bright_weights_normed_laplace_diff_2_cache& bright_weights_normed_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 57] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 47] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_diff_0_rd0 read pattern: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> bright_weights_normed_laplace_us_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_laplace_diff_0_rd1 read pattern: { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> bright_weights_normed_laplace_us_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 49] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 46] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
//	bright_weights_normed_laplace_diff_0_rd0
//	bright_weights_normed_laplace_diff_0_rd1
inline hw_uint<32> bright_weights_normed_laplace_us_0_bright_weights_normed_laplace_diff_0_update_0_read_bundle_read(bright_weights_normed_laplace_us_0_cache& bright_weights_normed_laplace_us_0, int d0, int d1) {
  // # of ports in bundle: 2
    // bright_weights_normed_laplace_diff_0_rd0
    // bright_weights_normed_laplace_diff_0_rd1
...
inline void bright_weights_normed_laplace_us_0_bright_weights_normed_laplace_us_0_update_0_write_bundle_write(hw_uint<32>& bright_weights_normed_laplace_us_0_update_0_write, bright_weights_normed_laplace_us_0_cache& bright_weights_normed_laplace_us_0, int d0, int d1) {
...
inline hw_uint<16> bright_weights_normed_laplace_diff_1_rd0_select(bright_weights_normed_laplace_us_1_cache& bright_weights_normed_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 48] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { bright_weights_normed_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 45] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> bright_weights_normed_laplace_diff_2_rd0_select(bright_weights_normed_laplace_us_2_cache& bright_weights_normed_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { bright_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 47] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { bright_weights_normed_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 44] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_blur_1_rd0_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_gauss_blur_1_update_0[d0, d1] -> 1929 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_gauss_blur_1_rd1_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_gauss_blur_1_update_0[d0, d1] -> 965 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_gauss_blur_1_rd11_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_gauss_blur_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_gauss_blur_1_rd12_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_gauss_blur_1_update_0[d0, d1] -> 1928 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; dark_gauss_blur_1_update_0[d0, d1] -> (966 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_gauss_blur_1_rd13_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_gauss_blur_1_update_0[d0, d1] -> 964 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; dark_gauss_blur_1_update_0[d0, d1] -> (2 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_cache& dark, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 43] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_dark_dark_update_0_write0 = dark.dark_dark_update_0_write0_merged_banks_11.peek_1929();
  return value_dark_dark_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
inline hw_uint<16> dark_gauss_ds_1_rd0_select(dark_gauss_blur_1_cache& dark_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 9] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_ds_2_rd0_select(dark_gauss_blur_2_cache& dark_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_ds_3_rd0_select(dark_gauss_blur_3_cache& dark_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // DD fold: {  }
...
inline hw_uint<16> dark_gauss_blur_2_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 15] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_laplace_us_0_rd0_select(dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 40] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 14] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { dark_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
...
inline hw_uint<16> dark_gauss_blur_3_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 23] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_us_1_rd0_select(dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_laplace_us_2_rd0_select(dark_gauss_ds_3_cache& dark_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 29] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline hw_uint<16> fused_level_0_rd0_select(dark_laplace_diff_0_cache& dark_laplace_diff_0, int d0, int d1) {
  ...
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 43] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_1_rd0_select(dark_laplace_diff_1_cache& dark_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 58] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(dark_laplace_diff_2_cache& dark_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 57] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_0_rd0_select(dark_laplace_us_0_cache& dark_laplace_us_0, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 43] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 40] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_1_rd0_select(dark_laplace_us_1_cache& dark_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 42] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 39] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> dark_laplace_diff_2_rd0_select(dark_laplace_us_2_cache& dark_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 38] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_rd0_select(dark_weights_cache& dark_weights, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd0_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1929 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd1_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> 965 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd11_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1 : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd12_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> 1928 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> (966 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_1_rd13_select(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> 964 : 0 <= d0 <= 961 and 0 <= d1 <= 1084; dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> (2 + d0) : d0 = 962 and 0 <= d1 <= 1084 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_diff_0_rd0 read pattern: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> dark_weights_normed[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_dark_weights_normed_dark_weights_normed_update_0_write0 = dark_weights_normed.dark_weights_normed_dark_weights_normed_update_0_write0_merged_banks_10.peek_1929();
  return value_dark_weights_normed_dark_weights_normed_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_diff_0_rd1 read pattern: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> dark_weights_normed[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 963 and 0 <= d1 <= 1086 }
  // DD fold: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> 1929 : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  auto value_dark_weights_normed_dark_weights_normed_update_0_write1 = dark_weights_normed.dark_weights_normed_dark_weights_normed_update_0_write1_merged_banks_10.peek_1929();
...
inline hw_uint<32> dark_weights_normed_dark_weights_normed_laplace_diff_0_update_0_read_bundle_read(dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  // # of ports in bundle: 2
    // dark_weights_normed_laplace_diff_0_rd0
    // dark_weights_normed_laplace_diff_0_rd1
	...
	set_at<0, 32>(result, dark_weights_normed_laplace_diff_0_rd0_res);
	...
	set_at<16, 32>(result, dark_weights_normed_laplace_diff_0_rd1_res);
	return result;
}
...
inline hw_uint<16> dark_weights_normed_gauss_ds_1_rd0_select(dark_weights_normed_gauss_blur_1_cache& dark_weights_normed_gauss_blur_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // Write schedule: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 962 and 0 <= d1 <= 1084 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_2_rd0_select(dark_weights_normed_gauss_blur_2_cache& dark_weights_normed_gauss_blur_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 20] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
  // Write schedule: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 13] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_ds_3_rd0_select(dark_weights_normed_gauss_blur_3_cache& dark_weights_normed_gauss_blur_3, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 28] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 21] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_gauss_blur_2_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 13] : 0 <= d0 <= 960 and 0 <= d1 <= 540 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_1_rd0_select(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 36] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_us_0_rd0 read pattern: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, o1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
  auto value_dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0 = dark_weights_normed_gauss_ds_1.dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0_to_dark_weights_normed_laplace_us_0_rd0.peek(/* one reader or all rams */ ((-1 - d1) % 2 == 0) ? ((962 - d0)) : 0);
  return value_dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_us_0_rd1 read pattern: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, o1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 962 and 0 <= d1 <= 542 }
  // DD fold: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> (962 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 959 and 0 < d1 <= 1079 }
  auto value_dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0 = dark_weights_normed_gauss_ds_1.dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0_to_dark_weights_normed_laplace_us_0_rd1.peek(/* one reader or all rams */ ((-1 - d1) % 2 == 0) ? ((962 - d0)) : 0);
  return value_dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_ds_1_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
inline hw_uint<32> dark_weights_normed_gauss_ds_1_dark_weights_normed_laplace_us_0_update_0_read_bundle_read(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  // # of ports in bundle: 2
    // dark_weights_normed_laplace_us_0_rd0
    // dark_weights_normed_laplace_us_0_rd1
	...
	set_at<0, 32>(result, dark_weights_normed_laplace_us_0_rd0_res);
	...
	set_at<16, 32>(result, dark_weights_normed_laplace_us_0_rd1_res);
	return result;
}
...
inline hw_uint<16> dark_weights_normed_gauss_blur_3_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 21] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 20] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_2_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 35] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 20] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_weights_normed_laplace_us_1_rd0_select(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 33] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 3 + 2d0, 20] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
...
inline hw_uint<16> dark_weights_normed_laplace_us_2_rd0_select(dark_weights_normed_gauss_ds_3_cache& dark_weights_normed_gauss_ds_3, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 32] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 28] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> dark_weights_normed_laplace_diff_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd1 read pattern: { fused_level_0_update_0[d0, d1] -> dark_weights_normed_laplace_diff_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline void dark_weights_normed_laplace_diff_0_dark_weights_normed_laplace_diff_0_update_0_write_bundle_write(hw_uint<32>& dark_weights_normed_laplace_diff_0_update_0_write, dark_weights_normed_laplace_diff_0_cache& dark_weights_normed_laplace_diff_0, int d0, int d1) {
...
//	fused_level_0_rd0
//	fused_level_0_rd1
inline hw_uint<32> dark_weights_normed_laplace_diff_0_fused_level_0_update_0_read_bundle_read(dark_weights_normed_laplace_diff_0_cache& dark_weights_normed_laplace_diff_0, int d0, int d1) {
  // # of ports in bundle: 2
    // fused_level_0_rd0
    // fused_level_0_rd1
...
inline hw_uint<16> fused_level_1_rd0_select(dark_weights_normed_laplace_diff_1_cache& dark_weights_normed_laplace_diff_1, int d0, int d1) {
  ...
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 58] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 36] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> fused_level_2_rd0_select(dark_weights_normed_laplace_diff_2_cache& dark_weights_normed_laplace_diff_2, int d0, int d1) {
  ...
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 57] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 35] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_diff_0_rd0 read pattern: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> dark_weights_normed_laplace_us_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_laplace_diff_0_rd1 read pattern: { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> dark_weights_normed_laplace_us_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_weights_normed_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
//	dark_weights_normed_laplace_diff_0_rd0
//	dark_weights_normed_laplace_diff_0_rd1
inline hw_uint<32> dark_weights_normed_laplace_us_0_dark_weights_normed_laplace_diff_0_update_0_read_bundle_read(dark_weights_normed_laplace_us_0_cache& dark_weights_normed_laplace_us_0, int d0, int d1) {
  // # of ports in bundle: 2
    // dark_weights_normed_laplace_diff_0_rd0
    // dark_weights_normed_laplace_diff_0_rd1
...
inline void dark_weights_normed_laplace_us_0_dark_weights_normed_laplace_us_0_update_0_write_bundle_write(hw_uint<32>& dark_weights_normed_laplace_us_0_update_0_write, dark_weights_normed_laplace_us_0_cache& dark_weights_normed_laplace_us_0, int d0, int d1) {
...
inline hw_uint<16> dark_weights_normed_laplace_diff_1_rd0_select(dark_weights_normed_laplace_us_1_cache& dark_weights_normed_laplace_us_1, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 36] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 33] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: {  }
...
inline hw_uint<16> dark_weights_normed_laplace_diff_2_rd0_select(dark_weights_normed_laplace_us_2_cache& dark_weights_normed_laplace_us_2, int d0, int d1) {
  ...
  // Read schedule : { dark_weights_normed_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 35] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 32] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> psef_ct2_2_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef_ct2_2_rd0 read pattern: { psef_ct2_2_update_0[d0, d1] -> final_merged_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { psef_ct2_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 63] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 7 + d0, 62] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> psef_ct2_2_rd1_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef_ct2_2_rd1 read pattern: { psef_ct2_2_update_0[d0, d1] -> final_merged_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { psef_ct2_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 63] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 7 + d0, 62] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// psef_ct2_2_update_0_read
//	psef_ct2_2_rd0
//	psef_ct2_2_rd1
inline hw_uint<32> final_merged_0_psef_ct2_2_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1) {
  // # of ports in bundle: 2
    // psef_ct2_2_rd0
    // psef_ct2_2_rd1

	hw_uint<32> result;
	hw_uint<16> psef_ct2_2_rd0_res = psef_ct2_2_rd0_select(final_merged_0, d0, d1);
	set_at<0, 32>(result, psef_ct2_2_rd0_res);
	hw_uint<16> psef_ct2_2_rd1_res = psef_ct2_2_rd1_select(final_merged_0, d0, d1);
	set_at<16, 32>(result, psef_ct2_2_rd1_res);
	return result;
}
...
inline hw_uint<16> final_merged_0_rd0_select(final_merged_1_cache& final_merged_1, int d0, int d1) {
  ...
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [14 + d1, 7 + d0, 62] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 7 + d0, 61] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // DD fold: { final_merged_0_update_0[d0, d1] -> (959 - d0) : (1 + d1) mod 2 = 0 and 0 <= d0 <= 958 and 0 < d1 <= 1079 }
...
inline hw_uint<16> final_merged_1_rd0_select(final_merged_2_cache& final_merged_2, int d0, int d1) {
  ...
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 7 + d0, 61] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 60] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
...
inline hw_uint<16> final_merged_0_rd0_select(fused_level_0_cache& fused_level_0, int d0, int d1) {
  ...
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [14 + d1, 7 + d0, 62] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 59] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: { final_merged_0_update_0[d0, d1] -> ((1036799 - d0) - 960 * d1) : 0 <= d0 <= 958 and 1069 <= d1 <= 1078; final_merged_0_update_0[d0, d1] -> (1035840 - 960 * d1) : d0 = 959 and 1069 <= d1 <= 1078; final_merged_0_update_0[d0, d1] -> (12479 - d0) : 955 <= d0 <= 958 and 0 <= d1 <= 1067; final_merged_0_update_0[d0, d1] -> 11520 : d0 = 959 and 0 <= d1 <= 1067; final_merged_0_update_0[d0, d1] -> 11526 : 0 <= d0 <= 953 and 0 <= d1 <= 1067; final_merged_0_update_0[d0, d1] -> 11525 : d0 = 954 and 0 <= d1 <= 1067; final_merged_0_update_0[d0, d1] -> (11519 - d0) : d1 = 1068 and 0 <= d0 <= 958 and (d0 >= 955 or d0 <= 954); final_merged_0_update_0[d0, d1] -> 10560 : d0 = 959 and d1 = 1068; final_merged_0_update_0[d0, d1] -> (959 - d0) : d1 = 1079 and 0 <= d0 <= 958 }
...
inline hw_uint<16> final_merged_1_rd0_select(fused_level_1_cache& fused_level_1, int d0, int d1) {
  ...
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 7 + d0, 61] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
  // Write schedule: { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 3 + d0, 58] : 0 <= d0 <= 959 and 0 <= d1 <= 539 }
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_2_cache& fused_level_2, int d0, int d1) {
  ...
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 60] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 57] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // DD fold: {  }
...
inline hw_uint<16> final_merged_2_rd0_select(fused_level_3_cache& fused_level_3, int d0, int d1) {
  ...
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 7 + 2d0, 60] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 7 + 4d0, 56] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
inline void dark_weights_normed_laplace_us_0_update_0(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, dark_weights_normed_laplace_us_0_cache& dark_weights_normed_laplace_us_0, int d0, int d1) {
	...
	auto compute_result = id_unrolled_2(dark_weights_normed_gauss_ds_1_0_c__0_value);
...
inline void dark_weights_normed_laplace_diff_0_update_0(dark_weights_normed_cache& dark_weights_normed, dark_weights_normed_laplace_us_0_cache& dark_weights_normed_laplace_us_0, dark_weights_normed_laplace_diff_0_cache& dark_weights_normed_laplace_diff_0, int d0, int d1) {
	...
	auto compute_result = diff_unrolled_2(dark_weights_normed_0_c__0_value, dark_weights_normed_laplace_us_0_0_c__0_value);
...
inline void bright_weights_normed_laplace_us_0_update_0(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, bright_weights_normed_laplace_us_0_cache& bright_weights_normed_laplace_us_0, int d0, int d1) {
	...
	auto compute_result = id_unrolled_2(bright_weights_normed_gauss_ds_1_0_c__0_value);
...
inline void bright_weights_normed_laplace_diff_0_update_0(bright_weights_normed_cache& bright_weights_normed, bright_weights_normed_laplace_us_0_cache& bright_weights_normed_laplace_us_0, bright_weights_normed_laplace_diff_0_cache& bright_weights_normed_laplace_diff_0, int d0, int d1) {
	...
	auto compute_result = diff_unrolled_2(bright_weights_normed_0_c__0_value, bright_weights_normed_laplace_us_0_0_c__0_value);
...
inline void fused_level_0_update_0(bright_laplace_diff_0_cache& bright_laplace_diff_0, dark_laplace_diff_0_cache& dark_laplace_diff_0, bright_weights_normed_laplace_diff_0_cache& bright_weights_normed_laplace_diff_0, dark_weights_normed_laplace_diff_0_cache& dark_weights_normed_laplace_diff_0, fused_level_0_cache& fused_level_0, int d0, int d1) {
	...
	auto compute_result = psef_weighted_merge_unrolled_2(bright_laplace_diff_0_0_c__0_value, dark_laplace_diff_0_0_c__0_value, bright_weights_normed_laplace_diff_0_0_c__0_value, dark_weights_normed_laplace_diff_0_0_c__0_value);
...
inline void final_merged_0_update_0(final_merged_1_cache& final_merged_1, fused_level_0_cache& fused_level_0, final_merged_0_cache& final_merged_0, int d0, int d1) {
	...
	auto compute_result = average_unrolled_2(final_merged_1_0_c__0_value, fused_level_0_0_c__0_value);
...
inline void psef_ct2_2_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */psef_ct2_2, int d0, int d1) {
	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_psef_ct2_2_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1);
	...
	// Produce: psef_ct2_2
	psef_ct2_2.write(compute_result);
...
// Driver function
void psef_ct2_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */psef_ct2_2, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("psef_ct2_2_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // bright_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*19]
	    // bright_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*27]
	    // bright_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*1 + 1*1,1*18]
	    // bright_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*2 + 1*3,1*26]
	    // bright_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*4 + 1*7,1*31]
	    // bright_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*55]
	    // bright_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*54]
	    // bright_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*53]
	    // bright_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*52]
	    // bright_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*51]
	    // bright_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*50]
	    // bright_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*3]
	    // bright_weights_normed_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*10]
	    // bright_weights_normed_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*17]
	    // bright_weights_normed_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*25]
	    // bright_weights_normed_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*1 + 1*1,1*16]
	    // bright_weights_normed_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*2 + 1*3,1*24]
	    // bright_weights_normed_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*4 + 1*7,1*30]
	    // bright_weights_normed_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*49]
	    // bright_weights_normed_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*48]
	    // bright_weights_normed_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*47]
	    // bright_weights_normed_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*46]
	    // bright_weights_normed_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*45]
	    // bright_weights_normed_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*44]
	    ...
	    // dark_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*15]
	    // dark_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*23]
	    // dark_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*1 + 1*1,1*14]
	    // dark_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*2 + 1*3,1*22]
	    // dark_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*4 + 1*7,1*29]
	    // dark_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*43]
	    // dark_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*42]
	    // dark_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*41]
	    // dark_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*40]
	    // dark_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*39]
	    // dark_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*38]
	    // dark_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*2]
	    // dark_weights_normed_gauss_blur_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*8]
	    // dark_weights_normed_gauss_blur_2_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*13]
	    // dark_weights_normed_gauss_blur_3_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*21]
	    // dark_weights_normed_gauss_ds_1_update_0 -> [1*d1*1*2 + 1*2,1*d0*1*1 + 1*1,1*12]
	    // dark_weights_normed_gauss_ds_2_update_0 -> [1*d1*1*4 + 1*6,1*d0*1*2 + 1*3,1*20]
	    // dark_weights_normed_gauss_ds_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*4 + 1*7,1*28]
	    // dark_weights_normed_laplace_diff_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*37]
	    // dark_weights_normed_laplace_diff_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*36]
	    // dark_weights_normed_laplace_diff_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*35]
	    // dark_weights_normed_laplace_us_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*34]
	    // dark_weights_normed_laplace_us_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*33]
	    // dark_weights_normed_laplace_us_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*32]
	    // dark_weights_normed_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*6]
	    // dark_weights_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*4]
	    // final_merged_0_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*7,1*62]
	    // final_merged_1_update_0 -> [1*d1*1*2 + 1*14,1*d0*1*1 + 1*7,1*61]
	    // final_merged_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*60]
	    // fused_level_0_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*1,1*59]
	    // fused_level_1_update_0 -> [1*d1*1*2 + 1*6,1*d0*1*1 + 1*3,1*58]
	    // fused_level_2_update_0 -> [1*d1*1*4 + 1*14,1*d0*1*2 + 1*7,1*57]
	    // fused_level_3_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*4 + 1*7,1*56]
	    // in_off_chip_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*0]
	    // in_update_0 -> [1*d1*1*1 + 1*0,1*d0*1*1 + 1*0,1*1]
	    // psef_ct2_2_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*7,1*63]
	...
	dark_weights_normed_laplace_us_2_update_0(dark_weights_normed_gauss_ds_3, dark_weights_normed_laplace_us_2, (c1 - 7) / 2, (c0 - 14) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 962) && ((c1 - 3) % 1 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	dark_weights_normed_laplace_us_1_update_0(dark_weights_normed_gauss_ds_2, dark_weights_normed_laplace_us_1, (c1 - 3) / 1, (c0 - 6) / 2);
	    }
	...
	dark_weights_normed_laplace_us_0_update_0(dark_weights_normed_gauss_ds_1, dark_weights_normed_laplace_us_0, (c1 - 1) / 1, (c0 - 2) / 1);
	    ...
	    if ((7 <= c1 && c1 <= 965) && ((c1 - 7) % 2 == 0) && (14 <= c0 && c0 <= 1090) && ((c0 - 14) % 4 == 0)) {
	dark_weights_normed_laplace_diff_2_update_0(dark_weights_normed_gauss_ds_2, dark_weights_normed_laplace_us_2, dark_weights_normed_laplace_diff_2, (c1 - 7) / 2, (c0 - 14) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 962) && ((c1 - 3) % 1 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	dark_weights_normed_laplace_diff_1_update_0(dark_weights_normed_gauss_ds_1, dark_weights_normed_laplace_us_1, dark_weights_normed_laplace_diff_1, (c1 - 3) / 1, (c0 - 6) / 2);
	    }
	...
	dark_laplace_diff_0_update_0(dark, dark_laplace_us_0, dark_laplace_diff_0, (c1 - 1) / 1, (c0 - 2) / 1);
	    ...
	    if ((7 <= c1 && c1 <= 965) && ((c1 - 7) % 2 == 0) && (14 <= c0 && c0 <= 1090) && ((c0 - 14) % 4 == 0)) {
	bright_weights_normed_laplace_us_2_update_0(bright_weights_normed_gauss_ds_3, bright_weights_normed_laplace_us_2, (c1 - 7) / 2, (c0 - 14) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 962) && ((c1 - 3) % 1 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	bright_weights_normed_laplace_us_1_update_0(bright_weights_normed_gauss_ds_2, bright_weights_normed_laplace_us_1, (c1 - 3) / 1, (c0 - 6) / 2);
	    }
	...
	bright_weights_normed_laplace_us_0_update_0(bright_weights_normed_gauss_ds_1, bright_weights_normed_laplace_us_0, (c1 - 1) / 1, (c0 - 2) / 1);
	    ...
	    if ((7 <= c1 && c1 <= 965) && ((c1 - 7) % 2 == 0) && (14 <= c0 && c0 <= 1090) && ((c0 - 14) % 4 == 0)) {
	bright_weights_normed_laplace_diff_2_update_0(bright_weights_normed_gauss_ds_2, bright_weights_normed_laplace_us_2, bright_weights_normed_laplace_diff_2, (c1 - 7) / 2, (c0 - 14) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 962) && ((c1 - 3) % 1 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	bright_weights_normed_laplace_diff_1_update_0(bright_weights_normed_gauss_ds_1, bright_weights_normed_laplace_us_1, bright_weights_normed_laplace_diff_1, (c1 - 3) / 1, (c0 - 6) / 2);
	    }
	...
	fused_level_3_update_0(bright_gauss_ds_3, dark_gauss_ds_3, bright_weights_normed_gauss_ds_3, dark_weights_normed_gauss_ds_3, fused_level_3, (c1 - 7) / 4, (c0 - 14) / 8);
	    ...
	    if ((7 <= c1 && c1 <= 965) && ((c1 - 7) % 2 == 0) && (14 <= c0 && c0 <= 1090) && ((c0 - 14) % 4 == 0)) {
	fused_level_2_update_0(bright_laplace_diff_2, dark_laplace_diff_2, bright_weights_normed_laplace_diff_2, dark_weights_normed_laplace_diff_2, fused_level_2, (c1 - 7) / 2, (c0 - 14) / 4);
	    }
	
	    if ((3 <= c1 && c1 <= 962) && ((c1 - 3) % 1 == 0) && (6 <= c0 && c0 <= 1084) && ((c0 - 6) % 2 == 0)) {
	fused_level_1_update_0(bright_laplace_diff_1, dark_laplace_diff_1, bright_weights_normed_laplace_diff_1, dark_weights_normed_laplace_diff_1, fused_level_1, (c1 - 3) / 1, (c0 - 6) / 2);
	    }
	...
	final_merged_0_update_0(final_merged_1, fused_level_0, final_merged_0, (c1 - 7) / 1, (c0 - 14) / 1);
	    ...
	    if ((7 <= c1 && c1 <= 966) && ((c1 - 7) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
	psef_ct2_2_update_0(final_merged_0, psef_ct2_2, (c1 - 7) / 1, (c0 - 14) / 1);
	    }
...
void psef_ct2_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */psef_ct2_2) {

  psef_ct2_2_opt(in_off_chip, psef_ct2_2, 1);
}
#ifdef __VIVADO_SYNTH__
const int in_update_0_read_num_transfers = 1047868;
const int psef_ct2_2_update_0_write_num_transfers = 1036800;
...
static void write_psef_ct2_2_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  int num_transfers = psef_ct2_2_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void psef_ct2_2_opt_accel(hw_uint<32>* in_update_0_read, hw_uint<32>* psef_ct2_2_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = psef_ct2_2_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = psef_ct2_2_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<32> > in_update_0_read_channel;
  static HWStream<hw_uint<32> > psef_ct2_2_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  psef_ct2_2_opt(in_update_0_read_channel, psef_ct2_2_update_0_write_channel, size);

  write_psef_ct2_2_update_0_write(psef_ct2_2_update_0_write, psef_ct2_2_update_0_write_channel, size);
}
