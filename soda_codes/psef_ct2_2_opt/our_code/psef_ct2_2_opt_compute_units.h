...
hw_uint<32>  psef_normalize_weights_unrolled_2(hw_uint<32>& dark_weights) {
  ...
  // dark_weights_normed_gauss_blur_1_update_0 unroll factor: 2
hw_uint<32>  reduce_gauss_unrolled_2(hw_uint<288>& dark_weights_normed) {
  hw_uint<32> whole_result;
  ...
  // dark_weights_normed_gauss_ds_1_update_0 unroll factor: 1
hw_uint<16>  id_unrolled_1(hw_uint<16>& dark_weights_normed_gauss_blur_1) {
  ...
  // dark_weights_normed_gauss_blur_2_update_0 unroll factor: 1
hw_uint<16>  reduce_gauss_unrolled_1(hw_uint<144>& dark_weights_normed_gauss_ds_1) {
  hw_uint<16> whole_result;
  ...
  // dark_weights_normed_laplace_diff_2_update_0 unroll factor: 1
hw_uint<16>  diff_unrolled_1(hw_uint<16>& dark_weights_normed_gauss_ds_2, hw_uint<16>& dark_weights_normed_laplace_us_2) {
  hw_uint<16> whole_result;
  ...
  // dark_weights_normed_laplace_diff_0_update_0 unroll factor: 2
hw_uint<32>  diff_unrolled_2(hw_uint<32>& dark_weights_normed, hw_uint<32>& dark_weights_normed_laplace_us_0) {
  hw_uint<32> whole_result;
...
hw_uint<32>  psef_weighted_merge_unrolled_2(hw_uint<32>& bright_laplace_diff_0, hw_uint<32>& dark_laplace_diff_0, hw_uint<32>& bright_weights_normed_laplace_diff_0, hw_uint<32>& dark_weights_normed_laplace_diff_0) {
  hw_uint<32> whole_result;
...
hw_uint<16>  average_unrolled_1(hw_uint<16>& fused_level_3, hw_uint<16>& fused_level_2) {
  hw_uint<16> whole_result;
...
hw_uint<32>  average_unrolled_2(hw_uint<32>& final_merged_1, hw_uint<32>& fused_level_0) {
  hw_uint<32> whole_result;
