...
int main(int argc, char **argv) {
  ...
  const int blur4_1_update_0_sm18_033_write_pipe0_DATA_SIZE = num_epochs*2079604;
  const int blur4_1_update_0_sm18_033_write_BYTES_PER_PIXEL = 16 / 8;
  size_t blur4_1_update_0_sm18_033_write_size_bytes = blur4_1_update_0_sm18_033_write_BYTES_PER_PIXEL * blur4_1_update_0_sm18_033_write_pipe0_DATA_SIZE;

  total_size_bytes += blur4_1_update_0_sm18_033_write_size_bytes;
  total_size_bytes_written += blur4_1_update_0_sm18_033_write_size_bytes;
  const int input_update_0_sm16_023_read_pipe0_DATA_SIZE = num_epochs*2079604;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > blur4_1_update_0_sm18_033_write_pipe0(blur4_1_update_0_sm18_033_write_size_bytes);
  ...
  for (int i = 0; i < blur4_1_update_0_sm18_033_write_pipe0_DATA_SIZE; i++) {
#ifdef __FLOAT_OUTPUT__
    ((uint16_t*) (blur4_1_update_0_sm18_033_write_pipe0.data()))[i] = 0;
#else // __FLOAT_OUTPUT__
    ((uint16_t*) (blur4_1_update_0_sm18_033_write_pipe0.data()))[i] = 0;
#endif // __FLOAT_OUTPUT__
  }
  ...
  for (unsigned int i = 0; i < devices.size(); i++) {
    ...
    if (err != CL_SUCCESS) {
      ...
      OCL_CHECK(err, krnl_vector_add = cl::Kernel(program, "blur4_1_opt_dis_kernel", &err));
      valid_device++;
      break;
    }
  }
  ...
  OCL_CHECK(err, cl::Buffer blur4_1_update_0_sm18_033_write_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, blur4_1_update_0_sm18_033_write_size_bytes, blur4_1_update_0_sm18_033_write_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(0, blur4_1_update_0_sm18_033_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = q.enqueueMigrateMemObjects({blur4_1_update_0_sm18_033_write_pipe0_ocl_buf}, CL_MIGRATE_MEM_OBJECT_HOST));
  ...
  std::ofstream regression_result("blur4_1_update_0_sm18_033_write_accel_result.csv");
  for (int i = 0; i < blur4_1_update_0_sm18_033_write_pipe0_DATA_SIZE; i++) {
#ifdef __FLOAT_OUTPUT__
    regression_result << bitcast<float, uint16_t>(((uint16_t*) (blur4_1_update_0_sm18_033_write_pipe0.data()))[i]) << std::endl;
#else // __FLOAT_OUTPUT__
    regression_result << ((uint16_t*) (blur4_1_update_0_sm18_033_write_pipe0.data()))[i] << std::endl;
#endif // __FLOAT_OUTPUT__
  }
