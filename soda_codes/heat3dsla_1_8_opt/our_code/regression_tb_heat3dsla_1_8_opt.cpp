...
int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_heat3dsla_1_8_opt.txt");
  ofstream fout("regression_result_heat3dsla_1_8_opt.txt");
  HWStream<hw_uint<256> > in_cc_update_0_read;
  HWStream<hw_uint<256> > heat3dsla_1_8_update_0_write;


  // Loading input data
  // cmap    : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] -> in[0, 0] : -1 <= in_cc_0 <= 4 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 4 }
  // read map: { in[0, 0] -> in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -1 <= in_cc_0 <= 4 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 4 }
  // rng     : { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] : -1 <= in_cc_0 <= 4 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 4 }
  for (int i = 0; i < 1224; i++) {
    hw_uint<256> in_val;
#ifdef __INT_OUTPUT__
    set_at<0*32, 256, 32>(in_val, (8*i + 0));
#elif defined(__FLOAT_OUTPUT__)
    set_at<0*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<1*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<1*32, 256, 32>(in_val, (8*i + 1));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<2*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<2*32, 256, 32>(in_val, (8*i + 2));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<3*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<3*32, 256, 32>(in_val, (8*i + 3));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<4*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<4*32, 256, 32>(in_val, (8*i + 4));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<5*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<5*32, 256, 32>(in_val, (8*i + 5));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<6*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<6*32, 256, 32>(in_val, (8*i + 6));
#endif
#ifdef __INT_OUTPUT__
...
#elif defined(__FLOAT_OUTPUT__)
    set_at<7*32, 256, 32>(in_val, (to_bits((float)static_cast <float> (rand()) / static_cast <float> (RAND_MAX))));
#else // No specified output type
    set_at<7*32, 256, 32>(in_val, (8*i + 7));
#endif
#ifdef __INT_OUTPUT__
  ...
  heat3dsla_1_8_opt(in_cc_update_0_read, heat3dsla_1_8_update_0_write);

  for (int i = 0; i < 512; i++) {
    hw_uint<256> actual = heat3dsla_1_8_update_0_write.read();
