...
#include "psef23_2_opt_compute_units.h"
...
inline hw_uint<16> psef23_2_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef23_2_rd0 read pattern: { psef23_2_update_0[d0, d1] -> final_merged_0[2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { psef23_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
...
inline hw_uint<16> psef23_2_rd1_select(final_merged_0_cache& final_merged_0, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // psef23_2_rd1 read pattern: { psef23_2_update_0[d0, d1] -> final_merged_0[1 + 2d0, d1] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Read schedule : { psef23_2_update_0[d0, d1] -> [14 + d1, 7 + d0, 52] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 7 + d0, 51] : 0 <= d0 <= 959 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// psef23_2_update_0_read
//	psef23_2_rd0
//	psef23_2_rd1
inline hw_uint<32> final_merged_0_psef23_2_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1) {
  // # of ports in bundle: 2
    // psef23_2_rd0
    // psef23_2_rd1

	hw_uint<32> result;
	hw_uint<16> psef23_2_rd0_res = psef23_2_rd0_select(final_merged_0, d0, d1);
	set_at<0, 32>(result, psef23_2_rd0_res);
	hw_uint<16> psef23_2_rd1_res = psef23_2_rd1_select(final_merged_0, d0, d1);
	set_at<16, 32>(result, psef23_2_rd1_res);
	return result;
}
...
inline void psef23_2_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<32> >& /* buffer_args num ports = 2 */psef23_2, int d0, int d1) {
	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_psef23_2_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1);
...
// Driver function
void psef23_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */psef23_2, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("psef23_2_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // psef23_2_update_0 -> [1*d1*1*1 + 1*14,1*d0*1*1 + 1*7,1*52]
	...
	final_merged_0_update_0(final_merged_1, fused_level_0, final_merged_0, (c1 - 7) / 1, (c0 - 14) / 1);
	    ...
	    if ((7 <= c1 && c1 <= 966) && ((c1 - 7) % 1 == 0) && (14 <= c0 && c0 <= 1093) && ((c0 - 14) % 1 == 0)) {
	psef23_2_update_0(final_merged_0, psef23_2, (c1 - 7) / 1, (c0 - 14) / 1);
	    }
...
void psef23_2_opt(HWStream<hw_uint<32> >& /* get_args num ports = 2 */in_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 2 */psef23_2) {

  psef23_2_opt(in_off_chip, psef23_2, 1);
}
#ifdef __VIVADO_SYNTH__
#include "psef23_2_opt.h"

const int in_update_0_read_num_transfers = 1047868;
const int psef23_2_update_0_write_num_transfers = 1036800;
...
static void write_psef23_2_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  int num_transfers = psef23_2_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void psef23_2_opt_accel(hw_uint<32>* in_update_0_read, hw_uint<32>* psef23_2_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = psef23_2_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = psef23_2_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<32> > in_update_0_read_channel;
  static HWStream<hw_uint<32> > psef23_2_update_0_write_channel;

  read_in_update_0_read(in_update_0_read, in_update_0_read_channel, size);

  psef23_2_opt(in_update_0_read_channel, psef23_2_update_0_write_channel, size);

  write_psef23_2_update_0_write(psef23_2_update_0_write, psef23_2_update_0_write_channel, size);
}
