...
hw_uint<32> two_input_mag_generated_compute(hw_uint<32*1> diff_sums, hw_uint<32*5> f) {
  return uint32_t(((uint32_t(diff_sums.get<32, 0>()) + (uint32_t(f.get<32, 2>()) + uint32_t(f.get<32, 0>()))) + (uint32_t(f.get<32, 4>()) + (uint32_t(f.get<32, 1>()) + uint32_t(f.get<32, 3>())))));
}
...
hw_uint<32>  two_input_mag_generated_compute_unrolled_1(hw_uint<32>& diff_sums, hw_uint<160>& f) {
  ...
  set_at<0, 160, 160>(lane_0_f, f.extract<0, 159>());
