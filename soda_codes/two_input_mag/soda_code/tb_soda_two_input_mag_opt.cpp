#include "soda_two_input_mag_opt.h"
#include <cstdlib>
#include <cstring>
#include "hw_classes.h"
#include <iostream>
#include "ap_int.h"
#include "soda_two_input_mag_opt_kernel.h"
#include <fstream>
...
int main() {
  ...
  ap_uint<32>* blur_y =
    (ap_uint<32>*)malloc(sizeof(ap_uint<32>)*img_size);
  two_input_mag_opt_kernel(blur_y, buf, img_size);
  ofstream soda_regression_out("regression_result_soda_two_input_mag_opt.txt");
  for (int i = 0; i < img_size; i++) {
