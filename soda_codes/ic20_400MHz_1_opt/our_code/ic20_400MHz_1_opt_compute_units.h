...
hw_uint<16> ic20_400MHz_1_generated_compute(hw_uint<16*1> stg19) {
...
hw_uint<16>  stg14_generated_compute_unrolled_1(hw_uint<64>& stg13) {
  ...
  // stg15_update_0 unroll factor: 1
hw_uint<16>  stg15_generated_compute_unrolled_1(hw_uint<64>& stg14) {
  hw_uint<16> whole_result;
  ...
  // stg16_update_0 unroll factor: 1
hw_uint<16>  stg16_generated_compute_unrolled_1(hw_uint<64>& stg15) {
  hw_uint<16> whole_result;
  ...
  // stg17_update_0 unroll factor: 1
hw_uint<16>  stg17_generated_compute_unrolled_1(hw_uint<64>& stg16) {
  hw_uint<16> whole_result;
  ...
  // stg18_update_0 unroll factor: 1
hw_uint<16>  stg18_generated_compute_unrolled_1(hw_uint<64>& stg17) {
  hw_uint<16> whole_result;
  ...
  // stg19_update_0 unroll factor: 1
hw_uint<16>  stg19_generated_compute_unrolled_1(hw_uint<64>& stg18) {
  hw_uint<16> whole_result;
  ...
  // ic20_400MHz_1_update_0 unroll factor: 1
hw_uint<16>  ic20_400MHz_1_generated_compute_unrolled_1(hw_uint<16>& stg19) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_stg19;
  set_at<0, 16, 16>(lane_0_stg19, stg19.extract<0, 15>());
  auto result_0 = ic20_400MHz_1_generated_compute(lane_0_stg19);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
