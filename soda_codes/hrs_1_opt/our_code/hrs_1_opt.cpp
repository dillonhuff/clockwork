...
inline hw_uint<16> hrs_1_rd0_select(det_cache& det, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hrs_1_rd0 read pattern: { hrs_1_update_0[d0, d1] -> det[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { hrs_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// hrs_1_update_0_read
//	hrs_1_rd0
inline hw_uint<16> det_hrs_1_update_0_read_bundle_read(det_cache& det, int d0, int d1) {
  // # of ports in bundle: 1
    // hrs_1_rd0

	hw_uint<16> result;
	hw_uint<16> hrs_1_rd0_res = hrs_1_rd0_select(det, d0, d1);
...
inline hw_uint<16> hrs_1_rd0_select(trace_cache& trace, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hrs_1_rd0 read pattern: { hrs_1_update_0[d0, d1] -> trace[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { hrs_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// hrs_1_update_0_read
//	hrs_1_rd0
inline hw_uint<16> trace_hrs_1_update_0_read_bundle_read(trace_cache& trace, int d0, int d1) {
  // # of ports in bundle: 1
    // hrs_1_rd0

	hw_uint<16> result;
	hw_uint<16> hrs_1_rd0_res = hrs_1_rd0_select(trace, d0, d1);
	set_at<0, 16>(result, hrs_1_rd0_res);
	return result;
}
...
inline void hrs_1_update_0(det_cache& det, trace_cache& trace, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */hrs_1, int d0, int d1) {
	// Consume: det
	auto det_0_c__0_value = det_hrs_1_update_0_read_bundle_read(det/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "hrs_1_update_0_det," << d0<< "," << d1<< "," <<  det_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	// Consume: trace
	auto trace_0_c__0_value = trace_hrs_1_update_0_read_bundle_read(trace/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "hrs_1_update_0_trace," << d0<< "," << d1<< "," <<  trace_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = hrs_1_generated_compute_unrolled_1(det_0_c__0_value, trace_0_c__0_value);
	// Produce: hrs_1
...
// Driver function
void hrs_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */hrs_1, uint64_t num_epochs) {
...
#pragma HLS inline recursive
  ...
  for (uint64_t epoch = 0; epoch < num_epochs; epoch++) {
	...
	trace_update_0(lgxx8, lgyy8, trace, (c1 - 2) / 1, (c0 - 2) / 1);
	    ...
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	hrs_1_update_0(det, trace, hrs_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  hrs_1_opt(img_update_0_read_channel, hrs_1_update_0_write_channel);

  write_output(hrs_1_update_0_write, hrs_1_update_0_write_channel, size);
}
