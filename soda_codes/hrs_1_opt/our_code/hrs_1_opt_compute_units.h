...
hw_uint<16> hrs_1_generated_compute(hw_uint<16*1> det, hw_uint<16*1> trace) {
...
hw_uint<16>  trace_generated_compute_unrolled_1(hw_uint<16>& lgxx8, hw_uint<16>& lgyy8) {
  ...
  // hrs_1_update_0 unroll factor: 1
hw_uint<16>  hrs_1_generated_compute_unrolled_1(hw_uint<16>& det, hw_uint<16>& trace) {
  hw_uint<16> whole_result;
  ...
  auto result_0 = hrs_1_generated_compute(lane_0_det, lane_0_trace);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
