...
hw_uint<16> hrs_1_generated_compute(hw_uint<16*1> img) {
...
hw_uint<16>  hrs_1_generated_compute_unrolled_1(hw_uint<16>& img) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_img;
  set_at<0, 16, 16>(lane_0_img, img.extract<0, 15>());
  auto result_0 = hrs_1_generated_compute(lane_0_img);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
