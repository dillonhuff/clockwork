...
// compute file: heat3ds_1_1_opt_compute_units.h
#include "heat3ds_1_1_opt_compute_units.h"

struct h3_0_h3_0_update_0_write0_to_heat3ds_1_1_rd0_cache {
...
struct h3_0_cache {
  // # of banks: 1
  h3_0_h3_0_update_0_write0_to_heat3ds_1_1_rd0_cache h3_0_h3_0_update_0_write0_to_heat3ds_1_1_rd0;
};
...
inline void h3_0_h3_0_update_0_write0_write(hw_uint<32> & h3_0_h3_0_update_0_write0, h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  h3_0.h3_0_h3_0_update_0_write0_to_heat3ds_1_1_rd0.push(h3_0_h3_0_update_0_write0);
}

inline hw_uint<32>  heat3ds_1_1_rd0_select(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // heat3ds_1_1_rd0 read pattern: { heat3ds_1_1_update_0[d0, d1, d2] -> h3_0[d0, d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { heat3ds_1_1_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  auto value_h3_0_h3_0_update_0_write0 = h3_0.h3_0_h3_0_update_0_write0_to_heat3ds_1_1_rd0.peek(/* one reader or all rams */ 0);
...
// heat3ds_1_1_update_0_read
//	heat3ds_1_1_rd0
inline hw_uint<32> h3_0_heat3ds_1_1_update_0_read_bundle_read(h3_0_cache& h3_0, int d0, int d1, int d2, int dynamic_address) {
  // # of ports in bundle: 1
    // heat3ds_1_1_rd0

	hw_uint<32> result;
	hw_uint<32>  heat3ds_1_1_rd0_res = heat3ds_1_1_rd0_select(h3_0, d0, d1, d2, dynamic_address);
	set_at<0, 32>(result, heat3ds_1_1_rd0_res);
	return result;
}

struct in_cc_in_cc_update_0_write0_merged_banks_7_cache {
	// RAM Box: {[-1, 32], [0, 31], [0, 31]}
	// Capacity: 2348
	// # of read delays: 8
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd0 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[-1 + d0, d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd1 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[d0, -1 + d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd2 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[d0, d1, -1 + d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd3 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[d0, d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd4 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[d0, d1, 1 + d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd5 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[d0, 1 + d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // h3_0_rd6 read pattern: { h3_0_update_0[d0, d1, d2] -> in_cc[1 + d0, d1, d2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Read schedule : { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
  // Write schedule: { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
...
// Operation logic
inline void heat3ds_1_1_update_0(h3_0_cache& h3_0, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */heat3ds_1_1, int d0, int d1, int d2) {
  // Dynamic address computation

	// Consume: h3_0
	auto h3_0_0_c__0_value = h3_0_heat3ds_1_1_update_0_read_bundle_read(h3_0/* source_delay */, d0, d1, d2, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = heat3ds_1_1_generated_compute_unrolled_1(h3_0_0_c__0_value);
	// Produce: heat3ds_1_1
	heat3ds_1_1.write(compute_result);
...
// Driver function
void heat3ds_1_1_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* get_args num ports = 1 */heat3ds_1_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("heat3ds_1_1_opt_debug.csv");
...
// schedule: { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31; in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32; heat3ds_1_1_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
//   { h3_0_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 2] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for h3_0_update_0(((-2 + i3 == 0) && (-1 + i2 >= 0) && (32 - i2 >= 0) && (-1 + i1 >= 0) && (32 - i1 >= 0) && (-1 + i0 >= 0) && (32 - i0 >= 0)))
//   { in_cc_update_0[d0, d1, d2] -> [d2, d1, d0, 1] : -1 <= d0 <= 32 and -1 <= d1 <= 32 and -1 <= d2 <= 32 }
// Condition for in_cc_update_0(((-1 + i3 == 0) && (1 + i2 >= 0) && (32 - i2 >= 0) && (1 + i1 >= 0) && (32 - i1 >= 0) && (1 + i0 >= 0) && (32 - i0 >= 0)))
//   { heat3ds_1_1_update_0[d0, d1, d2] -> [1 + d2, 1 + d1, 1 + d0, 3] : 0 <= d0 <= 31 and 0 <= d1 <= 31 and 0 <= d2 <= 31 }
// Condition for heat3ds_1_1_update_0(((-3 + i3 == 0) && (-1 + i2 >= 0) && (32 - i2 >= 0) && (-1 + i1 >= 0) && (32 - i1 >= 0) && (-1 + i0 >= 0) && (32 - i0 >= 0)))

  /*
  // Schedules...
    // h3_0_update_0 -> [1*d2*1*1 + 1*1,1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*2]
    // heat3ds_1_1_update_0 -> [1*d2*1*1 + 1*1,1*d1*1*1 + 1*1,1*d0*1*1 + 1*1,1*3]
...
#pragma HLS pipeline II=1
      ...
      if ((-1 <= c2 && c2 <= 32) && ((c2 - 0) % 1 == 0) && (-1 <= c1 && c1 <= 32) && ((c1 - 0) % 1 == 0) && (-1 <= c0 && c0 <= 32) && ((c0 - 0) % 1 == 0)) {
        in_cc_update_0((c2 - 0) / 1, (c1 - 0) / 1, (c0 - 0) / 1);
      }

      if ((1 <= c2 && c2 <= 32) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
        h3_0_update_0((c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
      }

      if ((1 <= c2 && c2 <= 32) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
        heat3ds_1_1_update_0((c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
      }
  ...
  */
	...
	#pragma HLS pipeline II=1
	      ...
	      if ((1 <= c2 && c2 <= 32) && ((c2 - 1) % 1 == 0) && (1 <= c1 && c1 <= 32) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 32) && ((c0 - 1) % 1 == 0)) {
	        heat3ds_1_1_update_0(h3_0 /* buf name */, heat3ds_1_1, (c2 - 1) / 1, (c1 - 1) / 1, (c0 - 1) / 1);
	      }
...
void heat3ds_1_1_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* get_args num ports = 1 */heat3ds_1_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    heat3ds_1_1_opt(in, heat3ds_1_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { heat3ds_1_1_update_0[root = 0, heat3ds_1_1_0, heat3ds_1_1_1, heat3ds_1_1_2] -> heat3ds_1_1[0, 0] : 0 <= heat3ds_1_1_0 <= 31 and 0 <= heat3ds_1_1_1 <= 31 and 0 <= heat3ds_1_1_2 <= 31 }
const int heat3ds_1_1_update_0_write_pipe0_num_transfers = 32768;
  // { in_cc_update_0[root = 0, in_cc_0, in_cc_1, in_cc_2] -> in[0, 0] : -1 <= in_cc_0 <= 32 and -1 <= in_cc_1 <= 32 and -1 <= in_cc_2 <= 32 }
const int in_cc_update_0_read_pipe0_num_transfers = 39304;


extern "C" {

void heat3ds_1_1_opt_accel(hw_uint<32>* in_cc_update_0_read_pipe0, hw_uint<32>* heat3ds_1_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_cc_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = heat3ds_1_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_cc_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = heat3ds_1_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<32> > heat3ds_1_1_update_0_write_pipe0_channel;

  burst_read<32>(in_cc_update_0_read_pipe0, in_cc_update_0_read_pipe0_channel, in_cc_update_0_read_pipe0_num_transfers*size);

  heat3ds_1_1_opt_wrapper(in_cc_update_0_read_pipe0_channel, heat3ds_1_1_update_0_write_pipe0_channel, size);

  burst_write<32>(heat3ds_1_1_update_0_write_pipe0, heat3ds_1_1_update_0_write_pipe0_channel, heat3ds_1_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void heat3ds_1_1_opt_rdai(HWStream<hw_uint<32> >& in_cc_update_0_read_pipe0, HWStream<hw_uint<32> >&  heat3ds_1_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_cc_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = heat3ds_1_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  heat3ds_1_1_opt(in_cc_update_0_read_pipe0, heat3ds_1_1_update_0_write_pipe0);
