...
int main() {
  ofstream in_pix("input_pixels_regression_result_inc_1_opt.txt");
  ofstream fout("regression_result_inc_1_opt.txt");
  HWStream<hw_uint<16> > in_update_0_read;
  HWStream<hw_uint<16> > inc_1_update_0_write;
  ...
  inc_1_opt(in_update_0_read, inc_1_update_0_write);
