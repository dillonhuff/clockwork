...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<16> > one_pipe10_update_0_write_channel;
  // In lanes = 1
  ...
  one_pipe10_opt(in_off_chip0_update_0_read_channel, one_pipe10_update_0_write_channel);
