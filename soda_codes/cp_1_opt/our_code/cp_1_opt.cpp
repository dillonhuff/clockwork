...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_bx_rd0 read pattern: { blue_bx_update_0[d0, d1] -> blue[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { blue_bx_update_0[d0, d1] -> 2 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_bx_rd1 read pattern: { blue_bx_update_0[d0, d1] -> blue[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { blue_bx_update_0[d0, d1] -> 1 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_bx_rd2 read pattern: { blue_bx_update_0[d0, d1] -> blue[2 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_diff_rd0 read pattern: { blue_diff_update_0[d0, d1] -> blue[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blue_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { blue_diff_update_0[d0, d1] -> 3846 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_by_rd0 read pattern: { blue_by_update_0[d0, d1] -> blue_bx[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blue_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 8] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { blue_by_update_0[d0, d1] -> 3840 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; blue_by_update_0[d0, d1] -> (1921 + d0) : d0 = 1919 and 0 <= d1 <= 1079; blue_by_update_0[d0, d1] -> 3840 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_by_rd1 read pattern: { blue_by_update_0[d0, d1] -> blue_bx[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blue_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 8] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { blue_by_update_0[d0, d1] -> 1920 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; blue_by_update_0[d0, d1] -> (1 + d0) : d0 = 1919 and 0 <= d1 <= 1079; blue_by_update_0[d0, d1] -> 1920 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_by_rd2 read pattern: { blue_by_update_0[d0, d1] -> blue_bx[d0, 2 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blue_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 8] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 5] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_diff_rd0 read pattern: { blue_diff_update_0[d0, d1] -> blue_by[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { blue_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 8] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> cp_1_rd0_select(blue_diff_cache& blue_diff, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // cp_1_rd0 read pattern: { cp_1_update_0[d0, d1] -> blue_diff[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { cp_1_update_0[d0, d1] -> [4 + d1, 4 + d0, 14] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { blue_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 11] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// cp_1_update_0_read
//	cp_1_rd0
inline hw_uint<16> blue_diff_cp_1_update_0_read_bundle_read(blue_diff_cache& blue_diff, int d0, int d1) {
  // # of ports in bundle: 1
    // cp_1_rd0

	hw_uint<16> result;
	hw_uint<16> cp_1_rd0_res = cp_1_rd0_select(blue_diff, d0, d1);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_bx_rd0 read pattern: { green_bx_update_0[d0, d1] -> green[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { green_bx_update_0[d0, d1] -> 2 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_bx_rd1 read pattern: { green_bx_update_0[d0, d1] -> green[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { green_bx_update_0[d0, d1] -> 1 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_bx_rd2 read pattern: { green_bx_update_0[d0, d1] -> green[2 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_diff_rd0 read pattern: { green_diff_update_0[d0, d1] -> green[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { green_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 13] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { green_diff_update_0[d0, d1] -> 3846 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_by_rd0 read pattern: { green_by_update_0[d0, d1] -> green_bx[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { green_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { green_by_update_0[d0, d1] -> 3840 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; green_by_update_0[d0, d1] -> (1921 + d0) : d0 = 1919 and 0 <= d1 <= 1079; green_by_update_0[d0, d1] -> 3840 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_by_rd1 read pattern: { green_by_update_0[d0, d1] -> green_bx[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { green_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { green_by_update_0[d0, d1] -> 1920 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; green_by_update_0[d0, d1] -> (1 + d0) : d0 = 1919 and 0 <= d1 <= 1079; green_by_update_0[d0, d1] -> 1920 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_by_rd2 read pattern: { green_by_update_0[d0, d1] -> green_bx[d0, 2 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { green_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 7] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_diff_rd0 read pattern: { green_diff_update_0[d0, d1] -> green_by[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { green_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 13] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 10] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> cp_1_rd0_select(green_diff_cache& green_diff, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // cp_1_rd0 read pattern: { cp_1_update_0[d0, d1] -> green_diff[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { cp_1_update_0[d0, d1] -> [4 + d1, 4 + d0, 14] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { green_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 13] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// cp_1_update_0_read
//	cp_1_rd0
inline hw_uint<16> green_diff_cp_1_update_0_read_bundle_read(green_diff_cache& green_diff, int d0, int d1) {
  // # of ports in bundle: 1
    // cp_1_rd0

	hw_uint<16> result;
	hw_uint<16> cp_1_rd0_res = cp_1_rd0_select(green_diff, d0, d1);
	set_at<0, 16>(result, cp_1_rd0_res);
	return result;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd0 read pattern: { blue_update_0[d0, d1] -> raw[d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 3850 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd1 read pattern: { blue_update_0[d0, d1] -> raw[d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 1926 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd2 read pattern: { blue_update_0[d0, d1] -> raw[d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 2 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd3 read pattern: { blue_update_0[d0, d1] -> raw[1 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 3849 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd4 read pattern: { blue_update_0[d0, d1] -> raw[1 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 1925 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd5 read pattern: { blue_update_0[d0, d1] -> raw[1 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 1 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd6 read pattern: { blue_update_0[d0, d1] -> raw[2 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 3848 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; blue_update_0[d0, d1] -> (1927 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd7 read pattern: { blue_update_0[d0, d1] -> raw[2 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { blue_update_0[d0, d1] -> 1924 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; blue_update_0[d0, d1] -> (3 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blue_rd8 read pattern: { blue_update_0[d0, d1] -> raw[2 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { blue_update_0[d0, d1] -> [2 + d1, 2 + d0, 2] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd0 read pattern: { green_update_0[d0, d1] -> raw[d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 3850 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3850();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd1 read pattern: { green_update_0[d0, d1] -> raw[d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 1926 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1926();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd2 read pattern: { green_update_0[d0, d1] -> raw[d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 2 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_2();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd3 read pattern: { green_update_0[d0, d1] -> raw[1 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 3849 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3849();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd4 read pattern: { green_update_0[d0, d1] -> raw[1 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 1925 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1925();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd5 read pattern: { green_update_0[d0, d1] -> raw[1 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 1 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd6 read pattern: { green_update_0[d0, d1] -> raw[2 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 3848 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; green_update_0[d0, d1] -> (1927 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3848();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd7 read pattern: { green_update_0[d0, d1] -> raw[2 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { green_update_0[d0, d1] -> 1924 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; green_update_0[d0, d1] -> (3 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1924();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // green_rd8 read pattern: { green_update_0[d0, d1] -> raw[2 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { green_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: {  }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_0();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd0 read pattern: { red_update_0[d0, d1] -> raw[d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 3850 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3850();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd1 read pattern: { red_update_0[d0, d1] -> raw[d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 1926 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1926();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd2 read pattern: { red_update_0[d0, d1] -> raw[d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 2 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_2();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd3 read pattern: { red_update_0[d0, d1] -> raw[1 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 3849 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3849();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd4 read pattern: { red_update_0[d0, d1] -> raw[1 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 1925 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1925();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd5 read pattern: { red_update_0[d0, d1] -> raw[1 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 1 : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd6 read pattern: { red_update_0[d0, d1] -> raw[2 + d0, d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 3848 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; red_update_0[d0, d1] -> (1927 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_3848();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd7 read pattern: { red_update_0[d0, d1] -> raw[2 + d0, 1 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: { red_update_0[d0, d1] -> 1924 : 0 <= d0 <= 1920 and 0 <= d1 <= 1081; red_update_0[d0, d1] -> (3 + d0) : d0 = 1921 and 0 <= d1 <= 1081 }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_1924();
  return value_raw_raw_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_rd8 read pattern: { red_update_0[d0, d1] -> raw[2 + d0, 2 + d1] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Read schedule : { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // Write schedule: { raw_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 1923 and 0 <= d1 <= 1083 }
  // DD fold: {  }
  auto value_raw_raw_update_0_write0 = raw.raw_raw_update_0_write0_merged_banks_27.peek_0();
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_bx_rd0 read pattern: { red_bx_update_0[d0, d1] -> red[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { red_bx_update_0[d0, d1] -> 2 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_bx_rd1 read pattern: { red_bx_update_0[d0, d1] -> red[1 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { red_bx_update_0[d0, d1] -> 1 : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_bx_rd2 read pattern: { red_bx_update_0[d0, d1] -> red[2 + d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Read schedule : { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // Write schedule: { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_diff_rd0 read pattern: { red_diff_update_0[d0, d1] -> red[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { red_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_update_0[d0, d1] -> [2 + d1, 2 + d0, 3] : 0 <= d0 <= 1921 and 0 <= d1 <= 1081 }
  // DD fold: { red_diff_update_0[d0, d1] -> 3846 : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_by_rd0 read pattern: { red_by_update_0[d0, d1] -> red_bx[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { red_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { red_by_update_0[d0, d1] -> 3840 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; red_by_update_0[d0, d1] -> (1921 + d0) : d0 = 1919 and 0 <= d1 <= 1079; red_by_update_0[d0, d1] -> 3840 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_by_rd1 read pattern: { red_by_update_0[d0, d1] -> red_bx[d0, 1 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { red_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: { red_by_update_0[d0, d1] -> 1920 : 0 < d0 <= 1918 and 0 <= d1 <= 1079; red_by_update_0[d0, d1] -> (1 + d0) : d0 = 1919 and 0 <= d1 <= 1079; red_by_update_0[d0, d1] -> 1920 : d0 = 0 and 0 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_by_rd2 read pattern: { red_by_update_0[d0, d1] -> red_bx[d0, 2 + d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { red_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_bx_update_0[d0, d1] -> [2 + d1, 4 + d0, 6] : 0 <= d0 <= 1919 and 0 <= d1 <= 1081 }
  // DD fold: {  }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // red_diff_rd0 read pattern: { red_diff_update_0[d0, d1] -> red_by[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { red_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_by_update_0[d0, d1] -> [4 + d1, 4 + d0, 9] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
inline hw_uint<16> cp_1_rd0_select(red_diff_cache& red_diff, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // cp_1_rd0 read pattern: { cp_1_update_0[d0, d1] -> red_diff[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { cp_1_update_0[d0, d1] -> [4 + d1, 4 + d0, 14] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Write schedule: { red_diff_update_0[d0, d1] -> [4 + d1, 4 + d0, 12] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // DD fold: {  }
...
// cp_1_update_0_read
//	cp_1_rd0
inline hw_uint<16> red_diff_cp_1_update_0_read_bundle_read(red_diff_cache& red_diff, int d0, int d1) {
  // # of ports in bundle: 1
    // cp_1_rd0

	hw_uint<16> result;
	hw_uint<16> cp_1_rd0_res = cp_1_rd0_select(red_diff, d0, d1);
	set_at<0, 16>(result, cp_1_rd0_res);
	return result;
}
...
inline void blue_bx_update_0(blue_cache& blue, blue_bx_cache& blue_bx, int d0, int d1) {
  ...
  *global_debug_handle << "blue_bx_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void red_bx_update_0(red_cache& red, red_bx_cache& red_bx, int d0, int d1) {
  ...
  *global_debug_handle << "red_bx_update_0_red," << d0<< "," << d1<< "," <<  red_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "red_bx_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void green_bx_update_0(green_cache& green, green_bx_cache& green_bx, int d0, int d1) {
  ...
  *global_debug_handle << "green_bx_update_0_green," << d0<< "," << d1<< "," <<  green_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "green_bx_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void blue_by_update_0(blue_bx_cache& blue_bx, blue_by_cache& blue_by, int d0, int d1) {
  ...
  *global_debug_handle << "blue_by_update_0_blue_bx," << d0<< "," << d1<< "," <<  blue_bx_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "blue_by_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void red_by_update_0(red_bx_cache& red_bx, red_by_cache& red_by, int d0, int d1) {
  ...
  *global_debug_handle << "red_by_update_0_red_bx," << d0<< "," << d1<< "," <<  red_bx_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "red_by_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void green_by_update_0(green_bx_cache& green_bx, green_by_cache& green_by, int d0, int d1) {
  ...
  *global_debug_handle << "green_by_update_0_green_bx," << d0<< "," << d1<< "," <<  green_bx_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "green_by_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void blue_diff_update_0(blue_cache& blue, blue_by_cache& blue_by, blue_diff_cache& blue_diff, int d0, int d1) {
  ...
  *global_debug_handle << "blue_diff_update_0_blue_by," << d0<< "," << d1<< "," <<  blue_by_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "blue_diff_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void red_diff_update_0(red_cache& red, red_by_cache& red_by, red_diff_cache& red_diff, int d0, int d1) {
  ...
  *global_debug_handle << "red_diff_update_0_red_by," << d0<< "," << d1<< "," <<  red_by_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "red_diff_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void green_diff_update_0(green_cache& green, green_by_cache& green_by, green_diff_cache& green_diff, int d0, int d1) {
  ...
  *global_debug_handle << "green_diff_update_0_green_by," << d0<< "," << d1<< "," <<  green_by_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "green_diff_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__

}

inline void cp_1_update_0(blue_diff_cache& blue_diff, green_diff_cache& green_diff, red_diff_cache& red_diff, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */cp_1, int d0, int d1) {
	// Consume: blue_diff
	auto blue_diff_0_c__0_value = blue_diff_cp_1_update_0_read_bundle_read(blue_diff/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "cp_1_update_0_blue_diff," << d0<< "," << d1<< "," <<  blue_diff_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	// Consume: green_diff
	auto green_diff_0_c__0_value = green_diff_cp_1_update_0_read_bundle_read(green_diff/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "cp_1_update_0_green_diff," << d0<< "," << d1<< "," <<  green_diff_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	// Consume: red_diff
	auto red_diff_0_c__0_value = red_diff_cp_1_update_0_read_bundle_read(red_diff/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "cp_1_update_0_red_diff," << d0<< "," << d1<< "," <<  red_diff_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = cp_1_generated_compute_unrolled_1(blue_diff_0_c__0_value, green_diff_0_c__0_value, red_diff_0_c__0_value);
	// Produce: cp_1
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "cp_1_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void red_update_0(raw_cache& raw, red_cache& red, int d0, int d1) {
  ...
  *global_debug_handle << "red_update_0_raw," << d0<< "," << d1<< "," <<  raw_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "red_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void raw_update_0(HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */raw_oc, raw_cache& raw, int d0, int d1) {
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "raw_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void blue_update_0(raw_cache& raw, blue_cache& blue, int d0, int d1) {
  ...
  *global_debug_handle << "blue_update_0_raw," << d0<< "," << d1<< "," <<  raw_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "blue_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
inline void green_update_0(raw_cache& raw, green_cache& green, int d0, int d1) {
  ...
  *global_debug_handle << "green_update_0_raw," << d0<< "," << d1<< "," <<  raw_0_c__0_value << endl;
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "green_update_0," << (1*d0 + 0) << "," << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__

}

// Driver function
void cp_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_1, int num_epochs) {
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // cp_1_update_0 -> [1*d1*1*1 + 1*4,1*d0*1*1 + 1*4,1*14]
	...
	green_update_0(raw, green, (c1 - 2) / 1, (c0 - 2) / 1);
	    ...
	    if ((4 <= c1 && c1 <= 1923) && ((c1 - 4) % 1 == 0) && (2 <= c0 && c0 <= 1083) && ((c0 - 2) % 1 == 0)) {
	...
	green_diff_update_0(green, green_by, green_diff, (c1 - 4) / 1, (c0 - 4) / 1);
	    ...
	    if ((4 <= c1 && c1 <= 1923) && ((c1 - 4) % 1 == 0) && (4 <= c0 && c0 <= 1083) && ((c0 - 4) % 1 == 0)) {
	cp_1_update_0(blue_diff, green_diff, red_diff, cp_1, (c1 - 4) / 1, (c0 - 4) / 1);
	    }
...
void cp_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */raw_oc, HWStream<hw_uint<16> >& /* get_args num ports = 1 */cp_1) {
  ...
  cp_1_opt(raw_oc, cp_1, 1);
}
#ifdef __VIVADO_SYNTH__
#include "cp_1_opt.h"

const int cp_1_update_0_write_num_transfers = 2073600;
const int raw_update_0_read_num_transfers = 2085616;
...
static void write_cp_1_update_0_write(hw_uint<16>* output, HWStream<hw_uint<16> >& v, const int size) {
  hw_uint<16> burst_reg;
  int num_transfers = cp_1_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void cp_1_opt_accel(hw_uint<16>* raw_update_0_read, hw_uint<16>* cp_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = raw_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = cp_1_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = raw_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = cp_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<16> > raw_update_0_read_channel;
  static HWStream<hw_uint<16> > cp_1_update_0_write_channel;

  read_raw_update_0_read(raw_update_0_read, raw_update_0_read_channel, size);

  cp_1_opt(raw_update_0_read_channel, cp_1_update_0_write_channel, size);

  write_cp_1_update_0_write(cp_1_update_0_write, cp_1_update_0_write_channel, size);
}
