...
#include <fstream>
#include <vector>
#include "sc_dyn_15_32.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<512> > pw_math_in_oc02_merged1830_read_channel;
  HWStream<hw_uint<512> > pw_math_stencil_147981_merged1878_write_channel;
  // In lanes = 16
  for (int r = 0; r < 1110; r++) {
    for (int cl = 0; cl < 2160 / 16; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        pw_math_in_oc02_merged1830_read_channel.write(packed);
    }
  }
  sc_dyn_15_32(pw_math_in_oc02_merged1830_read_channel, pw_math_stencil_147981_merged1878_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = pw_math_stencil_147981_merged1878_write_channel.read();
  ...
  output.save_image("./images/sc_dyn_15_32_bmp_out.bmp");
}
