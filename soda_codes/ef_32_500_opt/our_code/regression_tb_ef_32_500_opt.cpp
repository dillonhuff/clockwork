...
int main() {
  srand(234);
  ofstream in_pix("input_pixels_regression_result_ef_32_500_opt.txt");
  ofstream fout("regression_result_ef_32_500_opt.txt");
  HWStream<hw_uint<512> > in_update_0_read;
  HWStream<hw_uint<512> > ef_32_500_update_0_write;
  ...
  ef_32_500_opt(in_update_0_read, ef_32_500_update_0_write);

  for (int i = 0; i < 65280; i++) {
    hw_uint<512> actual = ef_32_500_update_0_write.read();
