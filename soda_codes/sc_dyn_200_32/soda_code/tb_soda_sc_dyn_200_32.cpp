// AUTO GEN SODA TB
#include "sc_dyn_200_32_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  sc_dyn_200_32_kernel(out, in_oc, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_sc_dyn_200_32_regression_result.csv", out, nrows, ncols, transfer_cols);
  free(in_oc);
  free(out);
}
