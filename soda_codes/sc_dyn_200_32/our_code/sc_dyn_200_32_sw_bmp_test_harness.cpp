...
#include <fstream>
#include <vector>
#include "sc_dyn_200_32.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<512> > pw_math_in_oc02_merged22974_read_channel;
  HWStream<hw_uint<512> > pw_math_stencil_19910041006_merged23436_write_channel;
  // In lanes = 16
  for (int r = 0; r < 1480; r++) {
    for (int cl = 0; cl < 5120 / 16; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        pw_math_in_oc02_merged22974_read_channel.write(packed);
    }
  }
  sc_dyn_200_32(pw_math_in_oc02_merged22974_read_channel, pw_math_stencil_19910041006_merged23436_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = pw_math_stencil_19910041006_merged23436_write_channel.read();
  ...
  output.save_image("./images/sc_dyn_200_32_bmp_out.bmp");
}
