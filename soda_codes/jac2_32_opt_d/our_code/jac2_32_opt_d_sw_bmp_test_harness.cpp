...
#include <fstream>
#include <vector>
#include "jac2_32_opt_d.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<512> > in_1_merged3339_read_channel;
  HWStream<hw_uint<512> > jac2_32_1_merged3363_write_channel;
  // In lanes = 32
  for (int r = 0; r < 1095; r++) {
    for (int cl = 0; cl < 1568 / 32; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        in_1_merged3339_read_channel.write(packed);
    }
  }
  jac2_32_opt_d(in_1_merged3339_read_channel, jac2_32_1_merged3363_write_channel);
  bitmap_image output(1088, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1088 / 32; cl++) {
      auto packed_val = jac2_32_1_merged3363_write_channel.read();
  ...
  output.save_image("./images/jac2_32_opt_d_bmp_out.bmp");
}
