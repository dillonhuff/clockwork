...
hw_uint<32>  merge_exposures_unrolled_2(hw_uint<32>& bright_gauss_ds_3, hw_uint<32>& dark_gauss_ds_3, hw_uint<32>& bright_weights_normed_gauss_ds_3, hw_uint<32>& dark_weights_normed_gauss_ds_3) {
  hw_uint<32> whole_result;
