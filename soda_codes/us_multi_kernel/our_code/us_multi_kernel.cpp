...
// Driver function
void us_multi_kernel(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("us_multi_kernel_debug.csv");
  global_debug_handle = &debug_file;
#endif //__VIVADO_SYNTH__
...
void us_multi_kernel_wrapper(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out, const int num_epochs) {
...
void us_multi_kernel_accel(hw_uint<32>* oc_load_in03_read_pipe0, hw_uint<32>* diff_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  us_multi_kernel_wrapper(oc_load_in03_read_pipe0_channel, diff_write_pipe0_channel, size);
...
void us_multi_kernel_rdai(HWStream<hw_uint<32> >& oc_load_in03_read_pipe0, HWStream<hw_uint<32> >&  diff_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  us_multi_kernel(oc_load_in03_read_pipe0, diff_write_pipe0);
