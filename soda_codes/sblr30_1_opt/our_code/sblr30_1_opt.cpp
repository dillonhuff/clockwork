...
#include "sblr30_1_opt_compute_units.h"
...
inline hw_uint<16> sblr30_1_rd0_select(mag_x_cache& mag_x, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sblr30_1_rd0 read pattern: { sblr30_1_update_0[d0, d1] -> mag_x[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sblr30_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// sblr30_1_update_0_read
//	sblr30_1_rd0
inline hw_uint<16> mag_x_sblr30_1_update_0_read_bundle_read(mag_x_cache& mag_x, int d0, int d1) {
  // # of ports in bundle: 1
    // sblr30_1_rd0

	hw_uint<16> result;
	hw_uint<16> sblr30_1_rd0_res = sblr30_1_rd0_select(mag_x, d0, d1);
	set_at<0, 16>(result, sblr30_1_rd0_res);
	return result;
}
...
inline hw_uint<16> sblr30_1_rd0_select(mag_y_cache& mag_y, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sblr30_1_rd0 read pattern: { sblr30_1_update_0[d0, d1] -> mag_y[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { sblr30_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 4] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// sblr30_1_update_0_read
//	sblr30_1_rd0
inline hw_uint<16> mag_y_sblr30_1_update_0_read_bundle_read(mag_y_cache& mag_y, int d0, int d1) {
  // # of ports in bundle: 1
    // sblr30_1_rd0

	hw_uint<16> result;
	hw_uint<16> sblr30_1_rd0_res = sblr30_1_rd0_select(mag_y, d0, d1);
	set_at<0, 16>(result, sblr30_1_rd0_res);
	return result;
}
...
#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sblr30_1_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < 30; epoch++) {
	...
	mag_x_update_0(img, mag_x, (c1 - 1) / 1, (c0 - 1) / 1);
	    ...
	    if ((1 <= c1 && c1 <= 1920) && ((c1 - 1) % 1 == 0) && (1 <= c0 && c0 <= 1080) && ((c0 - 1) % 1 == 0)) {
	sblr30_1_update_0(mag_x, mag_y, sblr30_1, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void sblr30_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sblr30_1) {

  sblr30_1_opt(off_chip_img, sblr30_1, 1);
}
#ifdef __VIVADO_SYNTH__
#include "sblr30_1_opt.h"

const int img_update_0_read_num_transfers = 2079604;
const int sblr30_1_update_0_write_num_transfers = 2073600;
...
static void write_sblr30_1_update_0_write(hw_uint<16>* output, HWStream<hw_uint<16> >& v, const int size) {
  hw_uint<16> burst_reg;
  int num_transfers = sblr30_1_update_0_write_num_transfers*30;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void sblr30_1_opt_accel(hw_uint<16>* img_update_0_read, hw_uint<16>* sblr30_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sblr30_1_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = sblr30_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<16> > img_update_0_read_channel;
  static HWStream<hw_uint<16> > sblr30_1_update_0_write_channel;

  read_img_update_0_read(img_update_0_read, img_update_0_read_channel, size);

  sblr30_1_opt(img_update_0_read_channel, sblr30_1_update_0_write_channel, size);

  write_sblr30_1_update_0_write(sblr30_1_update_0_write, sblr30_1_update_0_write_channel, size);
}
