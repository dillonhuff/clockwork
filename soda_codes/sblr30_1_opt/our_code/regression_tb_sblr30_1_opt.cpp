...
int main() {
  ofstream in_pix("input_pixels_regression_result_sblr30_1_opt.txt");
  ofstream fout("regression_result_sblr30_1_opt.txt");
  HWStream<hw_uint<16> > img_update_0_read;
  HWStream<hw_uint<16> > sblr30_1_update_0_write;
  ...
  sblr30_1_opt(img_update_0_read, sblr30_1_update_0_write);

  for (int i = 0; i < 2073600; i++) {
    hw_uint<16> actual = sblr30_1_update_0_write.read();
