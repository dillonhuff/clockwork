...
#pragma HLS dependence variable=u inter false
  ...
  // Read schedule : { denoise2d_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // Write schedule: { u_update_0[d0, d1] -> [d1, d0, 3] : -2 <= d0 <= 31 and -1 <= d1 <= 31 }
  // DD fold: { denoise2d_update_0[d0, d1] -> 71 : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_71();
...
#pragma HLS dependence variable=u inter false
  ...
  // Read schedule : { denoise2d_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  // Write schedule: { u_update_0[d0, d1] -> [d1, d0, 3] : -2 <= d0 <= 31 and -1 <= d1 <= 31 }
  // DD fold: { denoise2d_update_0[d0, d1] -> 104 : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_104();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_70();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_69();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_35();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_1();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_36();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
#pragma HLS dependence variable=u inter false
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_11.peek_34();
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << endl;
	assert(false);
...
// Driver function
void denoise2d_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */diff_qwe, HWStream<hw_uint<32> >& /* get_args num ports = 1 */f_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */u_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */denoise2d) {
