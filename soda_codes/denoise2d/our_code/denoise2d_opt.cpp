...
// Driver function
void denoise2d_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */f_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */u_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */denoise2d, int num_epochs) {
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	...
	r1_update_0(r0, r1, (c1 - 2) / 1, (c0 - 2) / 1);
	    ...
	    if ((0 <= c1 && c1 <= 31) && ((c1 - 1) % 1 == 0) && (0 <= c0 && c0 <= 31) && ((c0 - 1) % 1 == 0)) {
	g_update_0(diff_d, diff_l, diff_qwe, diff_r, g, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
...
void denoise2d_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */f_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */u_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */denoise2d) {
  ...
  denoise2d_opt(f_off_chip, u_off_chip, denoise2d, 1);
}
#ifdef __VIVADO_SYNTH__
...
void denoise2d_opt_accel(hw_uint<32>* f_update_0_read, hw_uint<32>* u_update_0_read, hw_uint<32>* denoise2d_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  denoise2d_opt(f_update_0_read_channel, u_update_0_read_channel, denoise2d_update_0_write_channel, size);
