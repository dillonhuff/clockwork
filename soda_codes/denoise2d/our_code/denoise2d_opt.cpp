...
// compute file: denoise2d_opt_compute_units.h
...
inline hw_uint<32>  denoise2d_rd0_select(r1_cache& r1, int d0, int d1, int dynamic_address) {
  ...
  auto value_r1_r1_update_0_write0 = r1.r1_r1_update_0_write0_to_denoise2d_rd0.peek(/* one reader or all rams */ 0);
...
// schedule: { diff_l_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -1 <= d0 <= 30 and -1 <= d1 <= 30; diff_d_update_0[d0, d1] -> [1 + d1, 1 + d0, 8] : -1 <= d0 <= 30 and -1 <= d1 <= 30; diff_qwe_update_0[d0, d1] -> [1 + d1, 1 + d0, 6] : -1 <= d0 <= 30 and -1 <= d1 <= 30; g_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -1 <= d0 <= 30 and -1 <= d1 <= 30; diff_r_update_0[d0, d1] -> [1 + d1, 1 + d0, 5] : -1 <= d0 <= 30 and -1 <= d1 <= 30; r0_update_0[d0, d1] -> [2 + d1, 2 + d0, 4] : 0 <= d0 <= 29 and 0 <= d1 <= 29; r1_update_0[d0, d1] -> [2 + d1, 2 + d0, 9] : 0 <= d0 <= 29 and 0 <= d1 <= 29; u_update_0[d0, d1] -> [d1, d0, 3] : -2 <= d0 <= 31 and -2 <= d1 <= 31; denoise2d_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 29 and 0 <= d1 <= 29; f_update_0[d0, d1] -> [2 + d1, 2 + d0, 1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
...
//   { denoise2d_update_0[d0, d1] -> [2 + d1, 2 + d0, 11] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
// Condition for denoise2d_update_0(((-11 + i2 == 0) && (-2 + i1 >= 0) && (31 - i1 >= 0) && (-2 + i0 >= 0) && (31 - i0 >= 0)))
//   { f_update_0[d0, d1] -> [2 + d1, 2 + d0, 1] : 0 <= d0 <= 29 and 0 <= d1 <= 29 }
// Condition for f_update_0(((-1 + i2 == 0) && (-2 + i1 >= 0) && (31 - i1 >= 0) && (-2 + i0 >= 0) && (31 - i0 >= 0)))

  /*
  // Schedules...
    // denoise2d_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*11]
...
#pragma HLS pipeline II=1
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((0 <= c1 && c1 <= 31) && ((c1 - 1) % 1 == 0) && (0 <= c0 && c0 <= 31) && ((c0 - 1) % 1 == 0)) {
	      g_update_0(diff_d /* buf name */, diff_l /* buf name */, diff_qwe /* buf name */, diff_r /* buf name */, g, (c1 - 1) / 1, (c0 - 1) / 1);
	    }
	
	    if ((2 <= c1 && c1 <= 31) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 31) && ((c0 - 2) % 1 == 0)) {
	      denoise2d_update_0(r1 /* buf name */, f /* buf name */, u /* buf name */, g /* buf name */, denoise2d, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
...
void denoise2d_opt_wrapper(HWStream<hw_uint<32> >& /* get_args num ports = 1 */f_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */u_off_chip, HWStream<hw_uint<32> >& /* get_args num ports = 1 */denoise2d, const int num_epochs) {
...
void denoise2d_opt_accel(hw_uint<32>* f_update_0_read_pipe0, hw_uint<32>* u_update_0_read_pipe0, hw_uint<32>* denoise2d_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  denoise2d_opt_wrapper(f_update_0_read_pipe0_channel, u_update_0_read_pipe0_channel, denoise2d_update_0_write_pipe0_channel, size);
...
void denoise2d_opt_rdai(HWStream<hw_uint<32> >& f_update_0_read_pipe0, HWStream<hw_uint<32> >& u_update_0_read_pipe0, HWStream<hw_uint<32> >&  denoise2d_update_0_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  denoise2d_opt(f_update_0_read_pipe0, u_update_0_read_pipe0, denoise2d_update_0_write_pipe0);
