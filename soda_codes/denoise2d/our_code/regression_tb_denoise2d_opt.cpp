...
int main() {
  ofstream in_pix("input_pixels_regression_result_denoise2d_opt.txt");
  ...
  denoise2d_opt(g_update_0_read, f_update_0_read, u_update_0_read, denoise2d_update_0_write);
