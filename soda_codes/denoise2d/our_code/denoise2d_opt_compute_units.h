...
hw_uint<32>  mag_dn2d_unrolled_1(hw_uint<32>& diff_qwe, hw_uint<32>& diff_d, hw_uint<32>& diff_l, hw_uint<32>& diff_r) {
  hw_uint<32> whole_result;
  ...
  auto result_0 = mag_dn2d(lane_0_diff_qwe, lane_0_diff_d, lane_0_diff_l, lane_0_diff_r);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
...
hw_uint<32>  out_comp_dn2d_unrolled_1(hw_uint<32>& r1, hw_uint<32>& f, hw_uint<128>& u, hw_uint<128>& g) {
  ...
  // Need offset: -1, 0
  set_at<0, 128, 32>(lane_0_u, u.extract<0, 31>());
  // Need offset: 0, -1
  set_at<32, 128, 32>(lane_0_u, u.extract<32, 63>());
  // Need offset: 0, 0
  set_at<64, 128, 32>(lane_0_u, u.extract<64, 95>());
  // Need offset: 1, 0
  set_at<96, 128, 32>(lane_0_u, u.extract<96, 127>());
  hw_uint<128> lane_0_g;
  // Need offset: -1, 0
  set_at<0, 128, 32>(lane_0_g, g.extract<0, 31>());
  // Need offset: 0, -1
  set_at<32, 128, 32>(lane_0_g, g.extract<32, 63>());
  // Need offset: 0, 1
  set_at<64, 128, 32>(lane_0_g, g.extract<64, 95>());
  // Need offset: 1, 0
  set_at<96, 128, 32>(lane_0_g, g.extract<96, 127>());
