...
void denoise2d_opt_accel(int* g_update_0_read_arg, int* f_update_0_read_arg, int* u_update_0_read_arg, int* denoise2d_update_0_write_arg, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = g_update_0_read offset = slave bundle = gmem
...
#pragma HLS INTERFACE s_axilite port = g_update_0_read bundle = control
