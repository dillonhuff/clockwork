...
void denoise2d_opt_accel(int* f_update_0_read_arg, int* u_update_0_read_arg, int* denoise2d_update_0_write_arg, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  denoise2d_opt(f_off_chip, u_off_chip, denoise2d);
