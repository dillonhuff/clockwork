...
hw_uint<16> ic15_300MHz_16_generated_compute(hw_uint<16*1> stg14) {
...
hw_uint<256>  stg14_generated_compute_unrolled_16(hw_uint<1024>& stg13) {
  ...
  // ic15_300MHz_16_update_0 unroll factor: 16
hw_uint<256>  ic15_300MHz_16_generated_compute_unrolled_16(hw_uint<256>& stg14) {
  hw_uint<256> whole_result;

  hw_uint<16> lane_0_stg14;
  set_at<0, 16, 16>(lane_0_stg14, stg14.extract<0, 15>());
  auto result_0 = ic15_300MHz_16_generated_compute(lane_0_stg14);
  set_at<0, 256, 16>(whole_result, result_0);

  hw_uint<16> lane_1_stg14;
  set_at<0, 16, 16>(lane_1_stg14, stg14.extract<16, 31>());
  auto result_1 = ic15_300MHz_16_generated_compute(lane_1_stg14);
  set_at<16, 256, 16>(whole_result, result_1);

  hw_uint<16> lane_2_stg14;
  set_at<0, 16, 16>(lane_2_stg14, stg14.extract<32, 47>());
  auto result_2 = ic15_300MHz_16_generated_compute(lane_2_stg14);
  set_at<32, 256, 16>(whole_result, result_2);

  hw_uint<16> lane_3_stg14;
  set_at<0, 16, 16>(lane_3_stg14, stg14.extract<48, 63>());
  auto result_3 = ic15_300MHz_16_generated_compute(lane_3_stg14);
  set_at<48, 256, 16>(whole_result, result_3);

  hw_uint<16> lane_4_stg14;
  set_at<0, 16, 16>(lane_4_stg14, stg14.extract<64, 79>());
  auto result_4 = ic15_300MHz_16_generated_compute(lane_4_stg14);
  set_at<64, 256, 16>(whole_result, result_4);

  hw_uint<16> lane_5_stg14;
  set_at<0, 16, 16>(lane_5_stg14, stg14.extract<80, 95>());
  auto result_5 = ic15_300MHz_16_generated_compute(lane_5_stg14);
  set_at<80, 256, 16>(whole_result, result_5);

  hw_uint<16> lane_6_stg14;
  set_at<0, 16, 16>(lane_6_stg14, stg14.extract<96, 111>());
  auto result_6 = ic15_300MHz_16_generated_compute(lane_6_stg14);
  set_at<96, 256, 16>(whole_result, result_6);

  hw_uint<16> lane_7_stg14;
  set_at<0, 16, 16>(lane_7_stg14, stg14.extract<112, 127>());
  auto result_7 = ic15_300MHz_16_generated_compute(lane_7_stg14);
  set_at<112, 256, 16>(whole_result, result_7);

  hw_uint<16> lane_8_stg14;
  set_at<0, 16, 16>(lane_8_stg14, stg14.extract<128, 143>());
  auto result_8 = ic15_300MHz_16_generated_compute(lane_8_stg14);
  set_at<128, 256, 16>(whole_result, result_8);

  hw_uint<16> lane_9_stg14;
  set_at<0, 16, 16>(lane_9_stg14, stg14.extract<144, 159>());
  auto result_9 = ic15_300MHz_16_generated_compute(lane_9_stg14);
  set_at<144, 256, 16>(whole_result, result_9);

  hw_uint<16> lane_10_stg14;
  set_at<0, 16, 16>(lane_10_stg14, stg14.extract<160, 175>());
  auto result_10 = ic15_300MHz_16_generated_compute(lane_10_stg14);
  set_at<160, 256, 16>(whole_result, result_10);

  hw_uint<16> lane_11_stg14;
  set_at<0, 16, 16>(lane_11_stg14, stg14.extract<176, 191>());
  auto result_11 = ic15_300MHz_16_generated_compute(lane_11_stg14);
  set_at<176, 256, 16>(whole_result, result_11);

  hw_uint<16> lane_12_stg14;
  set_at<0, 16, 16>(lane_12_stg14, stg14.extract<192, 207>());
  auto result_12 = ic15_300MHz_16_generated_compute(lane_12_stg14);
  set_at<192, 256, 16>(whole_result, result_12);

  hw_uint<16> lane_13_stg14;
  set_at<0, 16, 16>(lane_13_stg14, stg14.extract<208, 223>());
  auto result_13 = ic15_300MHz_16_generated_compute(lane_13_stg14);
  set_at<208, 256, 16>(whole_result, result_13);

  hw_uint<16> lane_14_stg14;
  set_at<0, 16, 16>(lane_14_stg14, stg14.extract<224, 239>());
  auto result_14 = ic15_300MHz_16_generated_compute(lane_14_stg14);
  set_at<224, 256, 16>(whole_result, result_14);

  hw_uint<16> lane_15_stg14;
  set_at<0, 16, 16>(lane_15_stg14, stg14.extract<240, 255>());
  auto result_15 = ic15_300MHz_16_generated_compute(lane_15_stg14);
  set_at<240, 256, 16>(whole_result, result_15);
  return whole_result;
}
