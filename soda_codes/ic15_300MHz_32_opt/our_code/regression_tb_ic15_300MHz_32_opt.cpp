#include <fstream>
#include "ic15_300MHz_32_opt.h"
#include "clockwork_standard_compute_units.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_ic15_300MHz_32_opt.txt");
  ofstream fout("regression_result_ic15_300MHz_32_opt.txt");
  HWStream<hw_uint<512> > in_update_0_read;
  HWStream<hw_uint<512> > ic15_300MHz_32_update_0_write;


  // Loading input data
  // cmap    : { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : -15 <= in_0 <= 74 and 0 <= in_1 <= 1094 }
  // read map: { in_off_chip[0, 0] -> in_update_0[root = 0, in_0, in_1] : -15 <= in_0 <= 74 and 0 <= in_1 <= 1094 }
  // rng     : { in_update_0[root = 0, in_0, in_1] : -15 <= in_0 <= 74 and 0 <= in_1 <= 1094 }
  for (int i = 0; i < 98550; i++) {
    hw_uint<512> in_val;
  ...
  ic15_300MHz_32_opt(in_update_0_read, ic15_300MHz_32_update_0_write);

  for (int i = 0; i < 64800; i++) {
    hw_uint<512> actual = ic15_300MHz_32_update_0_write.read();
