...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<128> > one_pipe80_update_0_write_channel;
  // In lanes = 8
  ...
  one_pipe80_opt(in_off_chip0_update_0_read_channel, one_pipe80_update_0_write_channel);
