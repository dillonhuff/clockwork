...
int main() {
  ...
  cp9_16_opt_kernel(cp9_16, raw_oc, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_cp9_16_opt_regression_result.csv", cp9_16, nrows, ncols, transfer_cols);
  free(raw_oc);
  free(cp9_16);
}
