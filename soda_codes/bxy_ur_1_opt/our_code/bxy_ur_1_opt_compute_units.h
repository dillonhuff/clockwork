...
hw_uint<16> bxy_ur_1_generated_compute(hw_uint<16*3> blurx) {
...
hw_uint<16>  blurx_generated_compute_unrolled_1(hw_uint<48>& input) {
  ...
  // bxy_ur_1_update_0 unroll factor: 1
hw_uint<16>  bxy_ur_1_generated_compute_unrolled_1(hw_uint<48>& blurx) {
  hw_uint<16> whole_result;

  hw_uint<48> lane_0_blurx;
  set_at<0, 48, 48>(lane_0_blurx, blurx.extract<0, 47>());
  auto result_0 = bxy_ur_1_generated_compute(lane_0_blurx);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
