...
int main() {
  ofstream in_pix("input_pixels_regression_result_hr18_1_opt.txt");
  ofstream fout("regression_result_hr18_1_opt.txt");
  HWStream<hw_uint<16> > img_update_0_read;
  HWStream<hw_uint<16> > hr18_1_update_0_write;
  ...
  hr18_1_opt(img_update_0_read, hr18_1_update_0_write);

  for (int i = 0; i < 2073600; i++) {
    hw_uint<16> actual = hr18_1_update_0_write.read();
