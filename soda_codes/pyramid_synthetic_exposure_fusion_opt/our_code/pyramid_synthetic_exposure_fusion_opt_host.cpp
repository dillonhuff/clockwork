...
int main(int argc, char **argv) {
  ...
  const int pyramid_synthetic_exposure_fusion_update_0_write_DATA_SIZE = 1562500;
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(1, pyramid_synthetic_exposure_fusion_update_0_write_ocl_buf));

  int pyramid_synthetic_exposure_fusion_update_0_write_size = pyramid_synthetic_exposure_fusion_update_0_write_DATA_SIZE;
  OCL_CHECK(err, err = krnl_vector_add.setArg(2, pyramid_synthetic_exposure_fusion_update_0_write_size));
