...
// compute file: ef_tc_4_opt_compute_units.h
#include "ef_tc_4_opt_compute_units.h"
...
struct final_merged_0_final_merged_0_update_0_write0_to_ef_tc_4_rd0_cache {
	// RAM Box: {[0, 1916], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_final_merged_0_update_0_write1_to_ef_tc_4_rd1_cache {
	// RAM Box: {[1, 1917], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_final_merged_0_update_0_write2_to_ef_tc_4_rd2_cache {
	// RAM Box: {[2, 1918], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_final_merged_0_update_0_write3_to_ef_tc_4_rd3_cache {
	// RAM Box: {[3, 1919], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_cache {
  // # of banks: 4
  final_merged_0_final_merged_0_update_0_write0_to_ef_tc_4_rd0_cache final_merged_0_final_merged_0_update_0_write0_to_ef_tc_4_rd0;
  final_merged_0_final_merged_0_update_0_write1_to_ef_tc_4_rd1_cache final_merged_0_final_merged_0_update_0_write1_to_ef_tc_4_rd1;
  final_merged_0_final_merged_0_update_0_write2_to_ef_tc_4_rd2_cache final_merged_0_final_merged_0_update_0_write2_to_ef_tc_4_rd2;
  final_merged_0_final_merged_0_update_0_write3_to_ef_tc_4_rd3_cache final_merged_0_final_merged_0_update_0_write3_to_ef_tc_4_rd3;
};
...
inline void final_merged_0_final_merged_0_update_0_write0_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write0, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_tc_4_rd0.push(final_merged_0_final_merged_0_update_0_write0);
}
...
inline void final_merged_0_final_merged_0_update_0_write1_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write1, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write1_to_ef_tc_4_rd1.push(final_merged_0_final_merged_0_update_0_write1);
}
...
inline void final_merged_0_final_merged_0_update_0_write2_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write2, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write2_to_ef_tc_4_rd2.push(final_merged_0_final_merged_0_update_0_write2);
}
...
inline void final_merged_0_final_merged_0_update_0_write3_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write3, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write3_to_ef_tc_4_rd3.push(final_merged_0_final_merged_0_update_0_write3);
}

inline hw_uint<16> ef_tc_4_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_tc_4_rd0 read pattern: { ef_tc_4_update_0[d0, d1] -> final_merged_0[4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write0 = final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_ef_tc_4_rd0.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write0;
  return 0;
}

inline hw_uint<16> ef_tc_4_rd1_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_tc_4_rd1 read pattern: { ef_tc_4_update_0[d0, d1] -> final_merged_0[1 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write1 = final_merged_0.final_merged_0_final_merged_0_update_0_write1_to_ef_tc_4_rd1.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write1;
  return 0;
}

inline hw_uint<16> ef_tc_4_rd2_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_tc_4_rd2 read pattern: { ef_tc_4_update_0[d0, d1] -> final_merged_0[2 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write2 = final_merged_0.final_merged_0_final_merged_0_update_0_write2_to_ef_tc_4_rd2.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write2;
  return 0;
}

inline hw_uint<16> ef_tc_4_rd3_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // ef_tc_4_rd3 read pattern: { ef_tc_4_update_0[d0, d1] -> final_merged_0[3 + 4d0, d1] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Read schedule : { ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write3 = final_merged_0.final_merged_0_final_merged_0_update_0_write3_to_ef_tc_4_rd3.peek(/* one reader or all rams */ 0);
  return value_final_merged_0_final_merged_0_update_0_write3;
  return 0;
}

// # of bundles = 2
// ef_tc_4_update_0_read
//	ef_tc_4_rd0
//	ef_tc_4_rd1
//	ef_tc_4_rd2
//	ef_tc_4_rd3
inline hw_uint<64> final_merged_0_ef_tc_4_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 4
    // ef_tc_4_rd0
    // ef_tc_4_rd1
    // ef_tc_4_rd2
	...
	hw_uint<64> result;
	hw_uint<16> ef_tc_4_rd0_res = ef_tc_4_rd0_select(final_merged_0, d0, d1, dynamic_address);
	set_at<0, 64>(result, ef_tc_4_rd0_res);
	hw_uint<16> ef_tc_4_rd1_res = ef_tc_4_rd1_select(final_merged_0, d0, d1, dynamic_address);
	set_at<16, 64>(result, ef_tc_4_rd1_res);
	hw_uint<16> ef_tc_4_rd2_res = ef_tc_4_rd2_select(final_merged_0, d0, d1, dynamic_address);
	set_at<32, 64>(result, ef_tc_4_rd2_res);
	hw_uint<16> ef_tc_4_rd3_res = ef_tc_4_rd3_select(final_merged_0, d0, d1, dynamic_address);
	set_at<48, 64>(result, ef_tc_4_rd3_res);
	return result;
}
...
inline void ef_tc_4_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<64> >& /* buffer_args num ports = 4 */ef_tc_4, int d0, int d1) {
  // Dynamic address computation

	// Consume: final_merged_0
	auto final_merged_0_0_c__0_value = final_merged_0_ef_tc_4_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1, 0);
...
// Driver function
void ef_tc_4_opt(HWStream<hw_uint<64> >& /* get_args num ports = 4 */in_off_chip, HWStream<hw_uint<64> >& /* get_args num ports = 4 */ef_tc_4) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("ef_tc_4_opt_debug.csv");
...
// schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 36] : 0 <= d0 <= 479 and 0 <= d1 <= 539; dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 17] : 0 <= d0 <= 481 and 0 <= d1 <= 542; bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 16] : 0 <= d0 <= 480 and 0 <= d1 <= 540; bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 21] : 0 <= d0 <= 481 and 0 <= d1 <= 542; in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 27] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 24] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 29] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 44] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 13] : 0 <= d0 <= 480 and 0 <= d1 <= 540; bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 39] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 40] : 0 <= d0 <= 479 and 0 <= d1 <= 539; bright_weights_update_0[d0, d1] -> [d1, d0, 5] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 19] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 481 and 0 <= d1 <= 1084; dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 481 and 0 <= d1 <= 1084; dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 26] : 0 <= d0 <= 478 and 0 <= d1 <= 268; final_merged_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 49] : 0 <= d0 <= 479 and 0 <= d1 <= 269; dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 33] : 0 <= d0 <= 479 and 0 <= d1 <= 539; final_merged_1_update_0[d0, d1] -> [14 + 2d1, 4 + d0, 50] : 0 <= d0 <= 479 and 0 <= d1 <= 539; dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 20] : 0 <= d0 <= 478 and 0 <= d1 <= 268; bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 28] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_weights_update_0[d0, d1] -> [d1, d0, 4] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; weight_sums_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 540; dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 31] : 0 <= d0 <= 239 and 0 <= d1 <= 134; bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 15] : 0 <= d0 <= 481 and 0 <= d1 <= 542; bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 540; bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 14] : 0 <= d0 <= 481 and 0 <= d1 <= 1084; dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 481 and 0 <= d1 <= 1084; bright_weights_normed_update_0[d0, d1] -> [d1, d0, 9] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 42] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 38] : 0 <= d0 <= 239 and 0 <= d1 <= 134; fused_level_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 45] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 25] : 0 <= d0 <= 480 and 0 <= d1 <= 270; final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079; bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 43] : 0 <= d0 <= 479 and 0 <= d1 <= 539; bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134; dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 481 and 0 <= d1 <= 542; fused_level_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 46] : 0 <= d0 <= 479 and 0 <= d1 <= 269; bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 482 and 0 <= d1 <= 1086; dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 35] : 0 <= d0 <= 479 and 0 <= d1 <= 269; fused_level_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 47] : 0 <= d0 <= 479 and 0 <= d1 <= 539; bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 23] : 0 <= d0 <= 480 and 0 <= d1 <= 270; dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 32] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
//   { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 7] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for dark_weights_normed_update_0(((-7 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 36] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for dark_laplace_diff_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-36 + i2 == 0) && (-2 + i1 >= 0) && (481 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 17] : 0 <= d0 <= 481 and 0 <= d1 <= 542 }
// Condition for dark_weights_normed_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-17 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 16] : 0 <= d0 <= 480 and 0 <= d1 <= 540 }
// Condition for bright_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-16 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 21] : 0 <= d0 <= 481 and 0 <= d1 <= 542 }
// Condition for bright_weights_normed_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-21 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for in_update_0(((-1 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 27] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for dark_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-27 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 34] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_us_0_update_0(((-34 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { ef_tc_4_update_0[d0, d1] -> [14 + d1, 4 + d0, 52] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for ef_tc_4_update_0(((-52 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
//   { fused_level_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 48] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for fused_level_0_update_0(((-48 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { bright_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 24] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for bright_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-24 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 29] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for bright_weights_normed_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-29 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 44] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_diff_0_update_0(((-44 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { dark_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 13] : 0 <= d0 <= 480 and 0 <= d1 <= 540 }
// Condition for dark_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-13 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 39] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for bright_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-39 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_laplace_us_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 41] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_us_0_update_0(((-41 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { dark_laplace_diff_0_update_0[d0, d1] -> [2 + d1, 1 + d0, 37] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_diff_0_update_0(((-37 + i2 == 0) && (-1 + i1 >= 0) && (480 - i1 >= 0) && (-2 + i0 >= 0) && (1081 - i0 >= 0)))
//   { bright_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 40] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for bright_laplace_us_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-40 + i2 == 0) && (-2 + i1 >= 0) && (481 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { bright_weights_update_0[d0, d1] -> [d1, d0, 5] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for bright_weights_update_0(((-5 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 19] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for dark_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-19 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 11] : 0 <= d0 <= 481 and 0 <= d1 <= 1084 }
// Condition for dark_weights_normed_gauss_blur_1_update_0(((-11 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 8] : 0 <= d0 <= 481 and 0 <= d1 <= 1084 }
// Condition for dark_gauss_blur_1_update_0(((-8 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 26] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for dark_weights_normed_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-26 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { final_merged_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 49] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for final_merged_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-49 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { dark_laplace_us_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 33] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for dark_laplace_us_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-33 + i2 == 0) && (-2 + i1 >= 0) && (481 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { final_merged_1_update_0[d0, d1] -> [14 + 2d1, 4 + d0, 50] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for final_merged_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-50 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1092 - i0 >= 0)))
//   { dark_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 20] : 0 <= d0 <= 478 and 0 <= d1 <= 268 }
// Condition for dark_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-20 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 28] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for bright_weights_normed_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-28 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_update_0[d0, d1] -> [d1, d0, 4] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for dark_weights_update_0(((-4 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { weight_sums_update_0[d0, d1] -> [d1, d0, 6] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for weight_sums_update_0(((-6 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 18] : 0 <= d0 <= 480 and 0 <= d1 <= 540 }
// Condition for dark_weights_normed_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-18 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 31] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for dark_weights_normed_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-31 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 15] : 0 <= d0 <= 481 and 0 <= d1 <= 542 }
// Condition for bright_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-15 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 22] : 0 <= d0 <= 480 and 0 <= d1 <= 540 }
// Condition for bright_weights_normed_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-22 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 14] : 0 <= d0 <= 481 and 0 <= d1 <= 1084 }
// Condition for bright_weights_normed_gauss_blur_1_update_0(((-14 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_update_0[d0, d1] -> [d1, d0, 2] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for dark_update_0(((-2 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 10] : 0 <= d0 <= 481 and 0 <= d1 <= 1084 }
// Condition for bright_gauss_blur_1_update_0(((-10 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 9] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for bright_weights_normed_update_0(((-9 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { bright_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 42] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for bright_laplace_diff_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-42 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 38] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for bright_weights_normed_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-38 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { fused_level_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 45] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for fused_level_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-45 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 25] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for dark_weights_normed_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-25 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { final_merged_0_update_0[d0, d1] -> [14 + d1, 4 + d0, 51] : 0 <= d0 <= 479 and 0 <= d1 <= 1079 }
// Condition for final_merged_0_update_0(((-51 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1093 - i0 >= 0)))
//   { bright_laplace_diff_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 43] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for bright_laplace_diff_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-43 + i2 == 0) && (-2 + i1 >= 0) && (481 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { bright_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 4 + 2d0, 30] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for bright_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-i1 + 2*floord(i1, 2) == 0) && (-30 + i2 == 0) && (-4 + i1 >= 0) && (482 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 12] : 0 <= d0 <= 481 and 0 <= d1 <= 542 }
// Condition for dark_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-12 + i2 == 0) && (-1 + i1 >= 0) && (482 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { fused_level_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 46] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for fused_level_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-46 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { bright_update_0[d0, d1] -> [d1, d0, 3] : 0 <= d0 <= 482 and 0 <= d1 <= 1086 }
// Condition for bright_update_0(((-3 + i2 == 0) && (i1 >= 0) && (482 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_diff_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 35] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for dark_laplace_diff_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-35 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))
//   { fused_level_1_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 47] : 0 <= d0 <= 479 and 0 <= d1 <= 539 }
// Condition for fused_level_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-47 + i2 == 0) && (-2 + i1 >= 0) && (481 - i1 >= 0) && (-6 + i0 >= 0) && (1084 - i0 >= 0)))
//   { bright_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 23] : 0 <= d0 <= 480 and 0 <= d1 <= 270 }
// Condition for bright_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-23 + i2 == 0) && (-2 + i1 >= 0) && (482 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { dark_laplace_us_2_update_0[d0, d1] -> [14 + 4d1, 4 + d0, 32] : 0 <= d0 <= 479 and 0 <= d1 <= 269 }
// Condition for dark_laplace_us_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-32 + i2 == 0) && (-4 + i1 >= 0) && (483 - i1 >= 0) && (-14 + i0 >= 0) && (1090 - i0 >= 0)))

  /*
for (int c0 = 0; c0 <= 1093; c0 += 1)
  for (int c1 = 0; c1 <= 483; c1 += 1) {
    if (c0 <= 1086 && c1 <= 482) {
      in_update_0(c1, c0);
      dark_update_0(c1, c0);
        ...
        if (c0 % 2 == 0) {
          ...
          if (c0 >= 6 && c1 >= 2) {
            ...
            if ((c0 + 2) % 4 == 0) {
              ...
              if (c0 >= 14 && c1 >= 4)
                dark_gauss_blur_3_update_0(c1 - 4, (c0 - 14) / 4);
            }
          }
          ...
          if (c0 >= 6 && c1 >= 2) {
            ...
            if ((c0 + 2) % 4 == 0) {
              ...
              if (c0 >= 14 && c1 >= 4)
                bright_gauss_blur_3_update_0(c1 - 4, (c0 - 14) / 4);
              dark_weights_normed_gauss_ds_2_update_0(c1 - 2, (c0 - 6) / 4);
              if (c0 >= 14 && c1 >= 4) {
                dark_weights_normed_gauss_blur_3_update_0(c1 - 4, (c0 - 14) / 4);
                if ((c0 + 2) % 8 == 0 && c1 % 2 == 0)
                  dark_gauss_ds_3_update_0((c1 / 2) - 2, (c0 - 14) / 8);
              }
              bright_weights_normed_gauss_ds_2_update_0(c1 - 2, (c0 - 6) / 4);
              if (c0 >= 14 && c1 >= 4) {
                bright_weights_normed_gauss_blur_3_update_0(c1 - 4, (c0 - 14) / 4);
                if ((c0 + 2) % 8 == 0 && c1 % 2 == 0) {
                  bright_gauss_ds_3_update_0((c1 / 2) - 2, (c0 - 14) / 8);
                  dark_weights_normed_gauss_ds_3_update_0((c1 / 2) - 2, (c0 - 14) / 8);
                }
              }
            }
          }
    ...
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      dark_laplace_us_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
      dark_laplace_us_1_update_0(c1 - 2, (c0 / 2) - 3);
    if (c0 >= 2 && c0 <= 1081 && c1 >= 1 && c1 <= 480)
      dark_laplace_us_0_update_0(c1 - 1, c0 - 2);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      dark_laplace_diff_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
      dark_laplace_diff_1_update_0(c1 - 2, (c0 / 2) - 3);
    if (c0 >= 2 && c0 <= 1081 && c1 >= 1 && c1 <= 480)
      dark_laplace_diff_0_update_0(c1 - 1, c0 - 2);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 8 == 0 && c1 % 2 == 0)
      bright_weights_normed_gauss_ds_3_update_0((c1 / 2) - 2, (c0 - 14) / 8);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      bright_laplace_us_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
      bright_laplace_us_1_update_0(c1 - 2, (c0 / 2) - 3);
    if (c0 >= 2 && c0 <= 1081 && c1 >= 1 && c1 <= 480)
      bright_laplace_us_0_update_0(c1 - 1, c0 - 2);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      bright_laplace_diff_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
      bright_laplace_diff_1_update_0(c1 - 2, (c0 / 2) - 3);
    if (c0 >= 2 && c0 <= 1081 && c1 >= 1 && c1 <= 480)
      bright_laplace_diff_0_update_0(c1 - 1, c0 - 2);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 8 == 0 && c1 % 2 == 0)
      fused_level_3_update_0((c1 / 2) - 2, (c0 - 14) / 8);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      fused_level_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
      fused_level_1_update_0(c1 - 2, (c0 / 2) - 3);
    if (c0 >= 2 && c0 <= 1081 && c1 >= 1 && c1 <= 480)
      fused_level_0_update_0(c1 - 1, c0 - 2);
    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
      final_merged_2_update_0(c1 - 4, (c0 - 14) / 4);
    if (c0 >= 14 && c1 >= 4 && c0 % 2 == 0)
      final_merged_1_update_0(c1 - 4, (c0 / 2) - 7);
    if (c0 >= 14 && c1 >= 4) {
      final_merged_0_update_0(c1 - 4, c0 - 14);
      ef_tc_4_update_0(c1 - 4, c0 - 14);
    }
  }
  ...
  */
	for (int c0 = 0; c0 <= 1093; c0 += 1)
	  for (int c1 = 0; c1 <= 483; c1 += 1) {
	        ...
	        if (c0 % 2 == 0) {
	          ...
	          if (c0 >= 6 && c1 >= 2) {
	            ...
	            if ((c0 + 2) % 4 == 0) {
	              ...
	              if (c0 >= 14 && c1 >= 4)
	                dark_gauss_blur_3_update_0(dark_gauss_ds_2 /* buf name */, dark_gauss_blur_3, c1 - 4, (c0 - 14) / 4);
	            }
	          }
	          ...
	          if (c0 >= 6 && c1 >= 2) {
	            ...
	            if ((c0 + 2) % 4 == 0) {
	              ...
	              if (c0 >= 14 && c1 >= 4)
	                bright_gauss_blur_3_update_0(bright_gauss_ds_2 /* buf name */, bright_gauss_blur_3, c1 - 4, (c0 - 14) / 4);
	              ...
	              if (c0 >= 14 && c1 >= 4) {
	                dark_weights_normed_gauss_blur_3_update_0(dark_weights_normed_gauss_ds_2 /* buf name */, dark_weights_normed_gauss_blur_3, c1 - 4, (c0 - 14) / 4);
	                if ((c0 + 2) % 8 == 0 && c1 % 2 == 0)
	                  dark_gauss_ds_3_update_0(dark_gauss_blur_3 /* buf name */, dark_gauss_ds_3, (c1 / 2) - 2, (c0 - 14) / 8);
	              }
	              ...
	              if (c0 >= 14 && c1 >= 4) {
	                bright_weights_normed_gauss_blur_3_update_0(bright_weights_normed_gauss_ds_2 /* buf name */, bright_weights_normed_gauss_blur_3, c1 - 4, (c0 - 14) / 4);
	                if ((c0 + 2) % 8 == 0 && c1 % 2 == 0) {
	                  bright_gauss_ds_3_update_0(bright_gauss_blur_3 /* buf name */, bright_gauss_ds_3, (c1 / 2) - 2, (c0 - 14) / 8);
	                  dark_weights_normed_gauss_ds_3_update_0(dark_weights_normed_gauss_blur_3 /* buf name */, dark_weights_normed_gauss_ds_3, (c1 / 2) - 2, (c0 - 14) / 8);
	                }
	              }
	            }
	          }
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      dark_laplace_us_2_update_0(dark_gauss_ds_3 /* buf name */, dark_laplace_us_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      dark_laplace_diff_2_update_0(dark_gauss_ds_2 /* buf name */, dark_laplace_us_2 /* buf name */, dark_laplace_diff_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 8 == 0 && c1 % 2 == 0)
	      bright_weights_normed_gauss_ds_3_update_0(bright_weights_normed_gauss_blur_3 /* buf name */, bright_weights_normed_gauss_ds_3, (c1 / 2) - 2, (c0 - 14) / 8);
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      bright_laplace_us_2_update_0(bright_gauss_ds_3 /* buf name */, bright_laplace_us_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      bright_laplace_diff_2_update_0(bright_gauss_ds_2 /* buf name */, bright_laplace_us_2 /* buf name */, bright_laplace_diff_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 8 == 0 && c1 % 2 == 0)
	      fused_level_3_update_0(bright_gauss_ds_3 /* buf name */, dark_gauss_ds_3 /* buf name */, bright_weights_normed_gauss_ds_3 /* buf name */, dark_weights_normed_gauss_ds_3 /* buf name */, fused_level_3, (c1 / 2) - 2, (c0 - 14) / 8);
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      fused_level_2_update_0(bright_laplace_diff_2 /* buf name */, dark_laplace_diff_2 /* buf name */, bright_weights_normed_gauss_ds_2 /* buf name */, dark_weights_normed_gauss_ds_2 /* buf name */, fused_level_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 6 && c0 <= 1084 && c1 >= 2 && c1 <= 481 && c0 % 2 == 0)
	    ...
	    if (c0 >= 14 && c1 >= 4 && (c0 + 2) % 4 == 0)
	      final_merged_2_update_0(fused_level_3 /* buf name */, fused_level_2 /* buf name */, final_merged_2, c1 - 4, (c0 - 14) / 4);
	    if (c0 >= 14 && c1 >= 4 && c0 % 2 == 0)
	      final_merged_1_update_0(final_merged_2 /* buf name */, fused_level_1 /* buf name */, final_merged_1, c1 - 4, (c0 / 2) - 7);
	    if (c0 >= 14 && c1 >= 4) {
	      final_merged_0_update_0(final_merged_1 /* buf name */, fused_level_0 /* buf name */, final_merged_0, c1 - 4, c0 - 14);
	      ef_tc_4_update_0(final_merged_0 /* buf name */, ef_tc_4, c1 - 4, c0 - 14);
	    }
	  }
...
void ef_tc_4_opt_wrapper(HWStream<hw_uint<64> >& /* get_args num ports = 4 */in_off_chip, HWStream<hw_uint<64> >& /* get_args num ports = 4 */ef_tc_4, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    ef_tc_4_opt(in_off_chip, ef_tc_4);
  }
}
#ifdef __VIVADO_SYNTH__
  // { ef_tc_4_update_0[root = 0, ef_tc_4_0, ef_tc_4_1] -> ef_tc_4[0, 0] : 0 <= ef_tc_4_0 <= 479 and 0 <= ef_tc_4_1 <= 1079 }
const int ef_tc_4_update_0_write_pipe0_num_transfers = 518400;
...
void ef_tc_4_opt_accel(hw_uint<64>* in_update_0_read_pipe0, hw_uint<64>* ef_tc_4_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = ef_tc_4_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = ef_tc_4_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<64> > ef_tc_4_update_0_write_pipe0_channel;

  burst_read<64>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  ef_tc_4_opt_wrapper(in_update_0_read_pipe0_channel, ef_tc_4_update_0_write_pipe0_channel, size);

  burst_write<64>(ef_tc_4_update_0_write_pipe0, ef_tc_4_update_0_write_pipe0_channel, ef_tc_4_update_0_write_pipe0_num_transfers*size);
}
