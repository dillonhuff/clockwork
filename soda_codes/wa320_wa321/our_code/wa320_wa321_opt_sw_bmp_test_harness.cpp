...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > wa320_update_0_write_channel;
  HWStream<hw_uint<512> > wa321_update_0_write_channel;
  // In lanes = 32
  ...
  wa320_wa321_opt(in_off_chip0_update_0_read_channel, in_off_chip1_update_0_read_channel, wa320_update_0_write_channel, wa321_update_0_write_channel);
  bitmap_image output(960, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 960 / 32; cl++) {
      hw_uint<512> packed;
      auto packed_val = wa320_update_0_write_channel.read();
  ...
  output.save_image("./images/wa320_wa321_opt_bmp_out.bmp");
}
