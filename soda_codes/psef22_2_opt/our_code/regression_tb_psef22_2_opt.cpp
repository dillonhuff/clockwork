...
int main() {
  ofstream in_pix("input_pixels_regression_result_psef22_2_opt.txt");
  ofstream fout("regression_result_psef22_2_opt.txt");
  HWStream<hw_uint<32> > in_update_0_read;
  HWStream<hw_uint<32> > psef22_2_update_0_write;
  ...
  psef22_2_opt(in_update_0_read, psef22_2_update_0_write);

  for (int i = 0; i < 781250; i++) {
    hw_uint<32> actual = psef22_2_update_0_write.read();
