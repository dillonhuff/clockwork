...
struct blurx_blurx_update_0_sm16_025_10_to_blurx_load_to_blurx_to_gp_003_sm19_029_5_cache {
...
struct blurx_cache {
  // Reader addrs...
    // { load_to_blurx_to_gp_003_sm19_029[root = 0, blurx_ld2, blurx_ld1] -> blurx[blurx_ld1, blurx_ld2] : 0 <= blurx_ld2 <= 1919 and 0 <= blurx_ld1 <= 1921 }
  // # of banks: 1
  blurx_blurx_update_0_sm16_025_10_to_blurx_load_to_blurx_to_gp_003_sm19_029_5_cache blurx_blurx_update_0_sm16_025_10_to_blurx_load_to_blurx_to_gp_003_sm19_029_5;
};



inline void blurx_blurx_update_0_sm16_025_10_write(hw_uint<16>& blurx_blurx_update_0_sm16_025_10, blurx_cache& blurx, int root, int blurx_0, int blurx_1, int dynamic_address) {
  blurx.blurx_blurx_update_0_sm16_025_10_to_blurx_load_to_blurx_to_gp_003_sm19_029_5.push(blurx_blurx_update_0_sm16_025_10);
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blurx_load_to_blurx_to_gp_003_sm19_029_5 read pattern: { load_to_blurx_to_gp_003_sm19_029[root = 0, blurx_ld2, blurx_ld1] -> blurx[blurx_ld1, blurx_ld2] : 0 <= blurx_ld2 <= 1919 and 0 <= blurx_ld1 <= 1921 }
  // Read schedule : { load_to_blurx_to_gp_003_sm19_029[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 4] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
  // Write schedule: { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
  auto value_blurx_blurx_update_0_sm16_025_10 = blurx.blurx_blurx_update_0_sm16_025_10_to_blurx_load_to_blurx_to_gp_003_sm19_029_5.peek(/* one reader or all rams */ 0);
  return value_blurx_blurx_update_0_sm16_025_10;
  return 0;
}

// # of bundles = 2
// blurx_update_0_sm16_025_write
//	blurx_blurx_update_0_sm16_025_10
inline void blurx_blurx_update_0_sm16_025_write_bundle_write(hw_uint<16>& blurx_update_0_sm16_025_write, blurx_cache& blurx, int root, int blurx_0, int blurx_1, int dynamic_address) {
	hw_uint<16> blurx_blurx_update_0_sm16_025_10_res = blurx_update_0_sm16_025_write.extract<0, 15>();
	blurx_blurx_update_0_sm16_025_10_write(blurx_blurx_update_0_sm16_025_10_res, blurx, root, blurx_0, blurx_1, dynamic_address);
}
...
struct blurx_FIFO_buf8_cache {
  // Reader addrs...
    // { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
    // { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[1 + blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
    // { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[2 + blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
  // # of banks: 3
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blurx_FIFO_buf8_blur4_1_update_0_sm18_027_15 read pattern: { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
  // Read schedule : { blur4_1_update_0_sm18_027[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 1919 and 0 <= d2 <= 1919 }
  // Write schedule: { load_to_blurx_FIFO_buf811_sm21_033[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 5] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blurx_FIFO_buf8_blur4_1_update_0_sm18_027_16 read pattern: { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[1 + blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
  // Read schedule : { blur4_1_update_0_sm18_027[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 1919 and 0 <= d2 <= 1919 }
  // Write schedule: { load_to_blurx_FIFO_buf811_sm21_033[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 5] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // blurx_FIFO_buf8_blur4_1_update_0_sm18_027_17 read pattern: { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blurx_FIFO_buf8[2 + blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
  // Read schedule : { blur4_1_update_0_sm18_027[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 1919 and 0 <= d2 <= 1919 }
  // Write schedule: { load_to_blurx_FIFO_buf811_sm21_033[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 5] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
...
struct input_input_update_0_sm17_023_8_to_input_load_to_input_to_gp_147_sm20_031_1_cache {
...
struct input_cache {
  // Reader addrs...
    // { load_to_input_to_gp_147_sm20_031[root = 0, input_ld6, input_ld5] -> input[input_ld5, input_ld6] : 0 <= input_ld6 <= 1921 and 0 <= input_ld5 <= 1921 }
  // # of banks: 1
  input_input_update_0_sm17_023_8_to_input_load_to_input_to_gp_147_sm20_031_1_cache input_input_update_0_sm17_023_8_to_input_load_to_input_to_gp_147_sm20_031_1;
};



inline void input_input_update_0_sm17_023_8_write(hw_uint<16>& input_input_update_0_sm17_023_8, input_cache& input, int root, int input_0, int input_1, int dynamic_address) {
  input.input_input_update_0_sm17_023_8_to_input_load_to_input_to_gp_147_sm20_031_1.push(input_input_update_0_sm17_023_8);
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // input_load_to_input_to_gp_147_sm20_031_1 read pattern: { load_to_input_to_gp_147_sm20_031[root = 0, input_ld6, input_ld5] -> input[input_ld5, input_ld6] : 0 <= input_ld6 <= 1921 and 0 <= input_ld5 <= 1921 }
  // Read schedule : { load_to_input_to_gp_147_sm20_031[d0 = 0, d1, d2] -> [0, d1, d2, 1] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
  // Write schedule: { input_update_0_sm17_023[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
  auto value_input_input_update_0_sm17_023_8 = input.input_input_update_0_sm17_023_8_to_input_load_to_input_to_gp_147_sm20_031_1.peek(/* one reader or all rams */ 0);
  return value_input_input_update_0_sm17_023_8;
  return 0;
}

// # of bundles = 2
// input_update_0_sm17_023_write
//	input_input_update_0_sm17_023_8
inline void input_input_update_0_sm17_023_write_bundle_write(hw_uint<16>& input_update_0_sm17_023_write, input_cache& input, int root, int input_0, int input_1, int dynamic_address) {
	hw_uint<16> input_input_update_0_sm17_023_8_res = input_update_0_sm17_023_write.extract<0, 15>();
	input_input_update_0_sm17_023_8_write(input_input_update_0_sm17_023_8_res, input, root, input_0, input_1, dynamic_address);
}
...
struct input_FIFO_buf12_cache {
  // Reader addrs...
    // { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
    // { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, 1 + blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
    // { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, 2 + blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
  // # of banks: 1
...
inline hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_11_select(input_FIFO_buf12_cache& input_FIFO_buf12, int root, int blurx_0, int blurx_1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // input_FIFO_buf12_blurx_update_0_sm16_025_11 read pattern: { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
  // Read schedule : { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
  // Write schedule: { load_to_input_FIFO_buf1215_sm22_035[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
...
inline hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_12_select(input_FIFO_buf12_cache& input_FIFO_buf12, int root, int blurx_0, int blurx_1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // input_FIFO_buf12_blurx_update_0_sm16_025_12 read pattern: { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, 1 + blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
  // Read schedule : { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
  // Write schedule: { load_to_input_FIFO_buf1215_sm22_035[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
...
inline hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_13_select(input_FIFO_buf12_cache& input_FIFO_buf12, int root, int blurx_0, int blurx_1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // input_FIFO_buf12_blurx_update_0_sm16_025_13 read pattern: { blurx_update_0_sm16_025[root = 0, blurx_0, blurx_1] -> input_FIFO_buf12[blurx_1, 2 + blurx_0] : 0 <= blurx_0 <= 1919 and 0 <= blurx_1 <= 1921 }
  // Read schedule : { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
  // Write schedule: { load_to_input_FIFO_buf1215_sm22_035[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
...
// # of bundles = 2
// blurx_update_0_sm16_025_read
//	input_FIFO_buf12_blurx_update_0_sm16_025_11
//	input_FIFO_buf12_blurx_update_0_sm16_025_12
//	input_FIFO_buf12_blurx_update_0_sm16_025_13
inline hw_uint<48> input_FIFO_buf12_blurx_update_0_sm16_025_read_bundle_read(input_FIFO_buf12_cache& input_FIFO_buf12, int root, int blurx_0, int blurx_1, int dynamic_address) {
  // # of ports in bundle: 3
    // input_FIFO_buf12_blurx_update_0_sm16_025_11
    // input_FIFO_buf12_blurx_update_0_sm16_025_12
    // input_FIFO_buf12_blurx_update_0_sm16_025_13
	...
	hw_uint<48> result;
	hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_11_res = input_FIFO_buf12_blurx_update_0_sm16_025_11_select(input_FIFO_buf12, root, blurx_0, blurx_1, dynamic_address);
	set_at<0, 48>(result, input_FIFO_buf12_blurx_update_0_sm16_025_11_res);
	hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_12_res = input_FIFO_buf12_blurx_update_0_sm16_025_12_select(input_FIFO_buf12, root, blurx_0, blurx_1, dynamic_address);
	set_at<16, 48>(result, input_FIFO_buf12_blurx_update_0_sm16_025_12_res);
	hw_uint<16> input_FIFO_buf12_blurx_update_0_sm16_025_13_res = input_FIFO_buf12_blurx_update_0_sm16_025_13_select(input_FIFO_buf12, root, blurx_0, blurx_1, dynamic_address);
	set_at<32, 48>(result, input_FIFO_buf12_blurx_update_0_sm16_025_13_res);
	return result;
}
...
// schedule: { blur4_1_update_0_sm18_027[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 1919 and 0 <= d2 <= 1919; load_to_blurx_FIFO_buf811_sm21_033[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 5] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
//   { blur4_1_update_0_sm18_027[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 6] : 0 <= d1 <= 1919 and 0 <= d2 <= 1919 }
// Condition for blur4_1_update_0_sm18_027(((((-6 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
//   { load_to_blurx_FIFO_buf811_sm21_033[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 5] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
// Condition for load_to_blurx_FIFO_buf811_sm21_033(((((-5 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
...
inline void blurx_update_0_sm16_025(input_FIFO_buf12_cache& input_FIFO_buf12, blurx_cache& blurx, int d0, int d1, int d2) {
  // Dynamic address computation

	// Consume: input_FIFO_buf12
	auto input_FIFO_buf12_1_m__lp_1_m_blurx_1__p__0_rp___p__0_p_0_c_____1_m_blurx_0__p__0_p_0_value = input_FIFO_buf12_blurx_update_0_sm16_025_read_bundle_read(input_FIFO_buf12/* source_delay */, d0, d1, d2, 0);
	...
	// Produce: blurx
	blurx_blurx_update_0_sm16_025_write_bundle_write(/* arg names */compute_result, blurx, d0, d1, d2, 0);
...
// schedule: { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921; load_to_blurx_to_gp_003_sm19_029[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 4] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921; load_to_input_FIFO_buf1215_sm22_035[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
//   { blurx_update_0_sm16_025[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 3] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
// Condition for blurx_update_0_sm16_025(((((-3 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
//   { load_to_blurx_to_gp_003_sm19_029[d0 = 0, d1, d2] -> [0, 2 + d1, d2, 4] : 0 <= d1 <= 1919 and 0 <= d2 <= 1921 }
// Condition for load_to_blurx_to_gp_003_sm19_029(((((-4 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
//   { load_to_input_FIFO_buf1215_sm22_035[d0 = 0, d1, d2] -> [0, d1, d2, 2] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
// Condition for load_to_input_FIFO_buf1215_sm22_035(((((-2 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] : i1 >= 2 }
	          // { [i0, i1, i2] : -2 + i1 >= 0 }
	        if ((((((-2 + 1*i1)) >= 0)))) {
	          blurx_update_0_sm16_025(input_FIFO_buf12 /* buf name */, blurx, 0, ((-2 + 1*i1)), ((1*i2)));
	        }
	        // { [i0, i1, i2] : i1 >= 2 }
	        // { [i0, i1, i2] : i1 >= 2 }
	          // { [i0, i1, i2] : -2 + i1 >= 0 }
...
// Operation logic
inline void input_update_0_sm17_023(HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */input_arg, input_cache& input, int d0, int d1, int d2) {
  // Dynamic address computation
	...
	// Produce: input
	input_input_update_0_sm17_023_write_bundle_write(/* arg names */compute_result, input, d0, d1, d2, 0);
...
// schedule: { input_update_0_sm17_023[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921; load_to_input_to_gp_147_sm20_031[d0 = 0, d1, d2] -> [0, d1, d2, 1] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
//   { input_update_0_sm17_023[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
// Condition for input_update_0_sm17_023(((((1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
//   { load_to_input_to_gp_147_sm20_031[d0 = 0, d1, d2] -> [0, d1, d2, 1] : 0 <= d1 <= 1921 and 0 <= d2 <= 1921 }
// Condition for load_to_input_to_gp_147_sm20_031(((((-1 + 1*i3)) == 0) && (((1*i0)) == 0) && (((1*i1)) >= 0) && (((1921 + -1*i1)) >= 0) && (((1*i2)) >= 0) && (((1921 + -1*i2)) >= 0)))
	...
	#pragma HLS pipeline II=1
	        ...
	        // { [i0, i1, i2] :  }
	        if ((true)) {
	          input_update_0_sm17_023(input_arg /* buf name */, input, 0, ((1*i1)), ((1*i2)));
	        }
	        // { [i0, i1, i2] }
	        // { [i0, i1, i2] :  }
	        if ((true)) {
...
// Driver function
void blur4_1_opt_dis(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */input_arg, HWStream<hw_uint<16> >& /* get_args num ports = 1 */blur4_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("blur4_1_opt_dis_debug.csv");
  global_debug_handle = &debug_file;
#endif //__VIVADO_SYNTH__
...
void blur4_1_opt_dis_wrapper(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */input_arg, HWStream<hw_uint<16> >& /* get_args num ports = 1 */blur4_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    blur4_1_opt_dis(input_arg, blur4_1);
  }
}
#ifdef __VIVADO_SYNTH__
  // { blur4_1_update_0_sm18_027[root = 0, blur4_1_0, blur4_1_1] -> blur4_1[blur4_1_1, blur4_1_0] : 0 <= blur4_1_0 <= 1919 and 0 <= blur4_1_1 <= 1919 }
const int blur4_1_update_0_sm18_027_write_pipe0_num_transfers = 3686400;
  // { input_update_0_sm17_023[root = 0, input_0, input_1] -> input_arg[input_1, input_0] : 0 <= input_0 <= 1921 and 0 <= input_1 <= 1921 }
const int input_update_0_sm17_023_read_pipe0_num_transfers = 3694084;


extern "C" {

void blur4_1_opt_dis_accel(hw_uint<16>* input_update_0_sm17_023_read_pipe0, hw_uint<16>* blur4_1_update_0_sm18_027_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = input_update_0_sm17_023_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = blur4_1_update_0_sm18_027_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = input_update_0_sm17_023_read_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  // Pipeline # 0
  static HWStream<hw_uint<16> > input_update_0_sm17_023_read_pipe0_channel;
  static HWStream<hw_uint<16> > blur4_1_update_0_sm18_027_write_pipe0_channel;

  burst_read<16>(input_update_0_sm17_023_read_pipe0, input_update_0_sm17_023_read_pipe0_channel, input_update_0_sm17_023_read_pipe0_num_transfers*size);

  blur4_1_opt_dis_wrapper(input_update_0_sm17_023_read_pipe0_channel, blur4_1_update_0_sm18_027_write_pipe0_channel, size);
...
void blur4_1_opt_dis_rdai(HWStream<hw_uint<16> >& input_update_0_sm17_023_read_pipe0, HWStream<hw_uint<16> >&  blur4_1_update_0_sm18_027_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = input_update_0_sm17_023_read_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  blur4_1_opt_dis(input_update_0_sm17_023_read_pipe0, blur4_1_update_0_sm18_027_write_pipe0);
