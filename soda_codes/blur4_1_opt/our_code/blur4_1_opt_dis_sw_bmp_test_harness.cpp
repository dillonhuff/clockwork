...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<16> > input_update_0_sm17_023_read_channel;
  ...
  for (int r = 0; r < 1922; r++) {
    for (int cl = 0; cl < 1922 / 1; cl++) {
      ...
      if (r < input.height() && c < input.width()) {
        ...
        input_update_0_sm17_023_read_channel.write(packed);
    }
  }
  blur4_1_opt_dis(input_update_0_sm17_023_read_channel, blur4_1_update_0_sm18_027_write_channel);
