...
int main() {
  ...
  unsharp_kernel(hw_output_stencil, hw_input_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_unsharp_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
