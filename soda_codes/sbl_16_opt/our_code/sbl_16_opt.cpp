...
// Driver function
void sbl_16_opt(HWStream<hw_uint<256> >& /* get_args num ports = 16 */off_chip_img, HWStream<hw_uint<256> >& /* get_args num ports = 16 */sbl_16, int num_epochs) {
...
void sbl_16_opt_accel(hw_uint<256>* img_update_0_read, hw_uint<256>* sbl_16_update_0_write, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  write_sbl_16_update_0_write(sbl_16_update_0_write, sbl_16_update_0_write_channel, size);
}
