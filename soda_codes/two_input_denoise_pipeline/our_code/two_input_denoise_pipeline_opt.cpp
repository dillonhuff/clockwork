...
#pragma HLS dependence variable=u inter false
	...
	r0_update_0(f, u, r0, c1 - 1, c0 - 1);
	diff_u_update_0(u, diff_u, c1 - 1, c0 - 1);
	diff_sums_update_0(diff_d, diff_l, diff_r, diff_u, diff_sums, c1 - 1, c0 - 1);
	r1_update_0(r0, r1, c1 - 1, c0 - 1);
	g_update_0(diff_sums, f, g, c1 - 1, c0 - 1);
	two_input_denoise_pipeline_update_0(f, g, r1, u, two_input_denoise_pipeline, c1 - 1, c0 - 1);
	    }
	  }
