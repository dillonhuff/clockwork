...
int main(int argc, char **argv) {
  ...
  two_in_blnd_nb(pw_math_in0_oc03_read_channel, pw_math_in1_oc47_read_channel, pw_math_merged_0_reconstruct_lp138_buf141147150_write_channel);
  ...
  output.save_image("./images/two_in_blnd_nb_bmp_out.bmp");
}
