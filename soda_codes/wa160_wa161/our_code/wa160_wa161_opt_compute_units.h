...
hw_uint<256>  id_unrolled_16(hw_uint<256>& in_off_chip0_oc) {
  ...
  // in_off_chip0_oc_in_off_chip1_oc_update_0 unroll factor: 32
hw_uint<512>  interleave_unrolled_32(hw_uint<512>& in_off_chip0, hw_uint<512>& in_off_chip1, int d0) {
...
hw_uint<512>  id_unrolled_32(hw_uint<512>& in_off_chip0_oc_in_off_chip1_oc) {
  hw_uint<512> whole_result;
...
hw_uint<512>  merge_exposures_unrolled_32(hw_uint<512>& bright, hw_uint<512>& dark, hw_uint<512>& bright_weights_normed, hw_uint<512>& dark_weights_normed) {
  hw_uint<512> whole_result;
