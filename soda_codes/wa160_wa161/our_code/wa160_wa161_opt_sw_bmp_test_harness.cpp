...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<256> > wa160_update_0_write_channel;
  HWStream<hw_uint<256> > wa161_update_0_write_channel;
  // In lanes = 16
  ...
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 960 / 16; cl++) {
      hw_uint<256> packed;
      auto packed_val = wa160_update_0_write_channel.read();
  ...
  output.save_image("./images/wa160_wa161_opt_bmp_out.bmp");
}
