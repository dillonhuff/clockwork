...
// compute file: sefss_1_opt_compute_units.h
...
struct bright_cache {
  // Reader addrs...
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_laplace_diff_0_update_0[d0, d1] -> bright[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
    // { bright_weights_update_0[d0, d1] -> bright[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd0 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd1 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd2 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd3 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd4 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd5 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd6 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd7 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_1_rd8 read pattern: { bright_gauss_blur_1_update_0[d0, d1] -> bright[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_0_rd0 read pattern: { bright_laplace_diff_0_update_0[d0, d1] -> bright[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 43] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_bright_bright_update_0_write0 = bright.bright_bright_update_0_write0_to_bright_laplace_diff_0_rd0.peek(/* one reader or all rams */ (1078 - d1 >= 0 && 1078 - d0 >= 0) ? (1088) : (-1079 + d0 == 0 && 1078 - d1 >= 0) ? (1087) : (-1079 + d1 == 0 && 1078 - d0 >= 0) ? ((1079 - d0)) : 0);
  return value_bright_bright_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_rd0 read pattern: { bright_weights_update_0[d0, d1] -> bright[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { bright_weights_update_0[d0, d1] -> [d1, d0, 5] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_bright_bright_update_0_write0 = bright.bright_bright_update_0_write0_merged_banks_10.peek_0();
  return value_bright_bright_update_0_write0;
  return 0;
...
struct bright_gauss_blur_1_cache {
  // Reader addrs...
    // { bright_gauss_ds_1_update_0[d0, d1] -> bright_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_ds_1_rd0 read pattern: { bright_gauss_ds_1_update_0[d0, d1] -> bright_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Read schedule : { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Write schedule: { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
...
struct bright_gauss_blur_2_cache {
  // Reader addrs...
    // { bright_gauss_ds_2_update_0[d0, d1] -> bright_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_ds_2_rd0 read pattern: { bright_gauss_ds_2_update_0[d0, d1] -> bright_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Read schedule : { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Write schedule: { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
...
struct bright_gauss_blur_3_cache {
  // Reader addrs...
    // { bright_gauss_ds_3_update_0[d0, d1] -> bright_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_ds_3_rd0 read pattern: { bright_gauss_ds_3_update_0[d0, d1] -> bright_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { bright_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 29] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
...
struct bright_gauss_ds_1_cache {
  // Reader addrs...
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_laplace_diff_1_update_0[d0, d1] -> bright_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
    // { bright_laplace_us_0_update_0[d0, d1] -> bright_gauss_ds_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 3
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd0 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd1 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd2 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd3 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd4 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd5 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd6 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd7 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_2_rd8 read pattern: { bright_gauss_blur_2_update_0[d0, d1] -> bright_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_1_rd0 read pattern: { bright_laplace_diff_1_update_0[d0, d1] -> bright_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 42] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  auto value_bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0 = bright_gauss_ds_1.bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0_to_bright_laplace_diff_1_rd0.peek(/* one reader or all rams */ (538 - d1 >= 0 && 538 - d0 >= 0) ? (544) : (-539 + d0 == 0 && 538 - d1 >= 0) ? (543) : (-539 + d1 == 0 && 538 - d0 >= 0) ? ((539 - d0)) : 0);
  return value_bright_gauss_ds_1_bright_gauss_ds_1_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_us_0_rd0 read pattern: { bright_laplace_us_0_update_0[d0, d1] -> bright_gauss_ds_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { bright_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 40] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
struct bright_gauss_ds_2_cache {
  // Reader addrs...
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_laplace_diff_2_update_0[d0, d1] -> bright_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
    // { bright_laplace_us_1_update_0[d0, d1] -> bright_gauss_ds_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 3
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd0 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd1 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd2 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd3 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd4 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd5 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd6 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd7 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_gauss_blur_3_rd8 read pattern: { bright_gauss_blur_3_update_0[d0, d1] -> bright_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_2_rd0 read pattern: { bright_laplace_diff_2_update_0[d0, d1] -> bright_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 41] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  auto value_bright_gauss_ds_2_bright_gauss_ds_2_update_0_write0 = bright_gauss_ds_2.bright_gauss_ds_2_bright_gauss_ds_2_update_0_write0_to_bright_laplace_diff_2_rd0.peek(/* one reader or all rams */ (268 - d1 >= 0 && 268 - d0 >= 0) ? (272) : (-269 + d0 == 0 && 268 - d1 >= 0) ? (271) : (-269 + d1 == 0 && 268 - d0 >= 0) ? ((269 - d0)) : 0);
  return value_bright_gauss_ds_2_bright_gauss_ds_2_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_us_1_rd0 read pattern: { bright_laplace_us_1_update_0[d0, d1] -> bright_gauss_ds_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { bright_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 39] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
struct bright_gauss_ds_3_cache {
  // Reader addrs...
    // { bright_laplace_us_2_update_0[d0, d1] -> bright_gauss_ds_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
    // { fused_level_3_update_0[d0, d1] -> bright_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_us_2_rd0 read pattern: { bright_laplace_us_2_update_0[d0, d1] -> bright_gauss_ds_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { bright_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 38] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 29] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_3_rd0 read pattern: { fused_level_3_update_0[d0, d1] -> bright_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { bright_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 29] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
struct bright_laplace_diff_0_cache {
  // Reader addrs...
    // { fused_level_0_update_0[d0, d1] -> bright_laplace_diff_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> bright_laplace_diff_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 43] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
...
struct bright_laplace_diff_1_cache {
  // Reader addrs...
    // { fused_level_1_update_0[d0, d1] -> bright_laplace_diff_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_1_rd0 read pattern: { fused_level_1_update_0[d0, d1] -> bright_laplace_diff_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 42] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
...
struct bright_laplace_diff_2_cache {
  // Reader addrs...
    // { fused_level_2_update_0[d0, d1] -> bright_laplace_diff_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_2_rd0 read pattern: { fused_level_2_update_0[d0, d1] -> bright_laplace_diff_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 41] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct bright_laplace_us_0_cache {
  // Reader addrs...
    // { bright_laplace_diff_0_update_0[d0, d1] -> bright_laplace_us_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_0_rd0 read pattern: { bright_laplace_diff_0_update_0[d0, d1] -> bright_laplace_us_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { bright_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 43] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 40] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
...
struct bright_laplace_us_1_cache {
  // Reader addrs...
    // { bright_laplace_diff_1_update_0[d0, d1] -> bright_laplace_us_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_1_rd0 read pattern: { bright_laplace_diff_1_update_0[d0, d1] -> bright_laplace_us_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { bright_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 42] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { bright_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 39] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
...
struct bright_laplace_us_2_cache {
  // Reader addrs...
    // { bright_laplace_diff_2_update_0[d0, d1] -> bright_laplace_us_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_laplace_diff_2_rd0 read pattern: { bright_laplace_diff_2_update_0[d0, d1] -> bright_laplace_us_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { bright_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 41] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { bright_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 38] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct bright_weights_cache {
  // Reader addrs...
    // { bright_weights_normed_update_0[d0, d1] -> bright_weights[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_rd0 read pattern: { bright_weights_normed_update_0[d0, d1] -> bright_weights[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { bright_weights_update_0[d0, d1] -> [d1, d0, 5] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
struct bright_weights_normed_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { fused_level_0_update_0[d0, d1] -> bright_weights_normed[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd0 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd1 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd2 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd3 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd4 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd5 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd6 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd7 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_1_rd8 read pattern: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> bright_weights_normed[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> bright_weights_normed[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_bright_weights_normed_bright_weights_normed_update_0_write0 = bright_weights_normed.bright_weights_normed_bright_weights_normed_update_0_write0_to_fused_level_0_rd0.peek(/* one reader or all rams */ (1078 - d1 >= 0 && 1078 - d0 >= 0) ? (1088) : (-1079 + d0 == 0 && 1078 - d1 >= 0) ? (1087) : (-1079 + d1 == 0 && 1078 - d0 >= 0) ? ((1079 - d0)) : 0);
  return value_bright_weights_normed_bright_weights_normed_update_0_write0;
  return 0;
}
...
struct bright_weights_normed_gauss_blur_1_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> bright_weights_normed_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_ds_1_rd0 read pattern: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> bright_weights_normed_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Read schedule : { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Write schedule: { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
...
struct bright_weights_normed_gauss_blur_2_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> bright_weights_normed_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_ds_2_rd0 read pattern: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> bright_weights_normed_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Read schedule : { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Write schedule: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
...
struct bright_weights_normed_gauss_blur_3_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> bright_weights_normed_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_ds_3_rd0 read pattern: { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> bright_weights_normed_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 37] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
...
struct bright_weights_normed_gauss_ds_1_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { fused_level_1_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd0 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd1 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd2 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd3 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd4 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd5 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd6 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd7 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_2_rd8 read pattern: { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
struct bright_weights_normed_gauss_ds_2_cache {
  // Reader addrs...
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { fused_level_2_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd0 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd1 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd2 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd3 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd4 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd5 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd6 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd7 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_weights_normed_gauss_blur_3_rd8 read pattern: { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
struct bright_weights_normed_gauss_ds_3_cache {
  // Reader addrs...
    // { fused_level_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_3_rd0 read pattern: { fused_level_3_update_0[d0, d1] -> bright_weights_normed_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 37] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
struct dark_cache {
  // Reader addrs...
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_laplace_diff_0_update_0[d0, d1] -> dark[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
    // { dark_weights_update_0[d0, d1] -> dark[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd0 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd1 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd2 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd3 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd4 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd5 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd6 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd7 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_1_rd8 read pattern: { dark_gauss_blur_1_update_0[d0, d1] -> dark[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_0_rd0 read pattern: { dark_laplace_diff_0_update_0[d0, d1] -> dark[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 36] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_dark_dark_update_0_write0 = dark.dark_dark_update_0_write0_to_dark_laplace_diff_0_rd0.peek(/* one reader or all rams */ (1078 - d1 >= 0 && 1078 - d0 >= 0) ? (1088) : (-1079 + d0 == 0 && 1078 - d1 >= 0) ? (1087) : (-1079 + d1 == 0 && 1078 - d0 >= 0) ? ((1079 - d0)) : 0);
  return value_dark_dark_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_rd0 read pattern: { dark_weights_update_0[d0, d1] -> dark[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { dark_weights_update_0[d0, d1] -> [d1, d0, 4] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_dark_dark_update_0_write0 = dark.dark_dark_update_0_write0_merged_banks_10.peek_0();
  return value_dark_dark_update_0_write0;
  return 0;
...
struct dark_gauss_blur_1_cache {
  // Reader addrs...
    // { dark_gauss_ds_1_update_0[d0, d1] -> dark_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_ds_1_rd0 read pattern: { dark_gauss_ds_1_update_0[d0, d1] -> dark_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Read schedule : { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Write schedule: { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
...
struct dark_gauss_blur_2_cache {
  // Reader addrs...
    // { dark_gauss_ds_2_update_0[d0, d1] -> dark_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_ds_2_rd0 read pattern: { dark_gauss_ds_2_update_0[d0, d1] -> dark_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Read schedule : { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Write schedule: { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
...
struct dark_gauss_blur_3_cache {
  // Reader addrs...
    // { dark_gauss_ds_3_update_0[d0, d1] -> dark_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_ds_3_rd0 read pattern: { dark_gauss_ds_3_update_0[d0, d1] -> dark_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { dark_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 26] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
...
struct dark_gauss_ds_1_cache {
  // Reader addrs...
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_laplace_diff_1_update_0[d0, d1] -> dark_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
    // { dark_laplace_us_0_update_0[d0, d1] -> dark_gauss_ds_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 3
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd0 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd1 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd2 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd3 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd4 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd5 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd6 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd7 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_2_rd8 read pattern: { dark_gauss_blur_2_update_0[d0, d1] -> dark_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_1_rd0 read pattern: { dark_laplace_diff_1_update_0[d0, d1] -> dark_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 35] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  auto value_dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0 = dark_gauss_ds_1.dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0_to_dark_laplace_diff_1_rd0.peek(/* one reader or all rams */ (538 - d1 >= 0 && 538 - d0 >= 0) ? (544) : (-539 + d0 == 0 && 538 - d1 >= 0) ? (543) : (-539 + d1 == 0 && 538 - d0 >= 0) ? ((539 - d0)) : 0);
  return value_dark_gauss_ds_1_dark_gauss_ds_1_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_us_0_rd0 read pattern: { dark_laplace_us_0_update_0[d0, d1] -> dark_gauss_ds_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { dark_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 33] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
struct dark_gauss_ds_2_cache {
  // Reader addrs...
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_laplace_diff_2_update_0[d0, d1] -> dark_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
    // { dark_laplace_us_1_update_0[d0, d1] -> dark_gauss_ds_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 3
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd0 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd1 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd2 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd3 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd4 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd5 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd6 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd7 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_gauss_blur_3_rd8 read pattern: { dark_gauss_blur_3_update_0[d0, d1] -> dark_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_2_rd0 read pattern: { dark_laplace_diff_2_update_0[d0, d1] -> dark_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 34] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  auto value_dark_gauss_ds_2_dark_gauss_ds_2_update_0_write0 = dark_gauss_ds_2.dark_gauss_ds_2_dark_gauss_ds_2_update_0_write0_to_dark_laplace_diff_2_rd0.peek(/* one reader or all rams */ (268 - d1 >= 0 && 268 - d0 >= 0) ? (272) : (-269 + d0 == 0 && 268 - d1 >= 0) ? (271) : (-269 + d1 == 0 && 268 - d0 >= 0) ? ((269 - d0)) : 0);
  return value_dark_gauss_ds_2_dark_gauss_ds_2_update_0_write0;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_us_1_rd0 read pattern: { dark_laplace_us_1_update_0[d0, d1] -> dark_gauss_ds_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { dark_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 32] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
struct dark_gauss_ds_3_cache {
  // Reader addrs...
    // { dark_laplace_us_2_update_0[d0, d1] -> dark_gauss_ds_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
    // { fused_level_3_update_0[d0, d1] -> dark_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_us_2_rd0 read pattern: { dark_laplace_us_2_update_0[d0, d1] -> dark_gauss_ds_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { dark_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 31] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { dark_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 26] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_3_rd0 read pattern: { fused_level_3_update_0[d0, d1] -> dark_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { dark_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 26] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
struct dark_laplace_diff_0_cache {
  // Reader addrs...
    // { fused_level_0_update_0[d0, d1] -> dark_laplace_diff_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> dark_laplace_diff_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 36] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
...
struct dark_laplace_diff_1_cache {
  // Reader addrs...
    // { fused_level_1_update_0[d0, d1] -> dark_laplace_diff_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_1_rd0 read pattern: { fused_level_1_update_0[d0, d1] -> dark_laplace_diff_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 35] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
...
struct dark_laplace_diff_2_cache {
  // Reader addrs...
    // { fused_level_2_update_0[d0, d1] -> dark_laplace_diff_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_2_rd0 read pattern: { fused_level_2_update_0[d0, d1] -> dark_laplace_diff_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 34] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct dark_laplace_us_0_cache {
  // Reader addrs...
    // { dark_laplace_diff_0_update_0[d0, d1] -> dark_laplace_us_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_0_rd0 read pattern: { dark_laplace_diff_0_update_0[d0, d1] -> dark_laplace_us_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { dark_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 36] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 33] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
...
struct dark_laplace_us_1_cache {
  // Reader addrs...
    // { dark_laplace_diff_1_update_0[d0, d1] -> dark_laplace_us_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_1_rd0 read pattern: { dark_laplace_diff_1_update_0[d0, d1] -> dark_laplace_us_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { dark_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 35] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { dark_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 32] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
...
struct dark_laplace_us_2_cache {
  // Reader addrs...
    // { dark_laplace_diff_2_update_0[d0, d1] -> dark_laplace_us_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_laplace_diff_2_rd0 read pattern: { dark_laplace_diff_2_update_0[d0, d1] -> dark_laplace_us_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { dark_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 34] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { dark_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 31] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct dark_weights_cache {
  // Reader addrs...
    // { dark_weights_normed_update_0[d0, d1] -> dark_weights[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_rd0 read pattern: { dark_weights_normed_update_0[d0, d1] -> dark_weights[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { dark_weights_update_0[d0, d1] -> [d1, d0, 4] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
struct dark_weights_normed_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
    // { fused_level_0_update_0[d0, d1] -> dark_weights_normed[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd0 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd1 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd2 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[-1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd3 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd4 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd5 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd6 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, -1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd7 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_1_rd8 read pattern: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> dark_weights_normed[1 + d0, 1 + d1] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Read schedule : { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_0_rd0 read pattern: { fused_level_0_update_0[d0, d1] -> dark_weights_normed[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_dark_weights_normed_dark_weights_normed_update_0_write0 = dark_weights_normed.dark_weights_normed_dark_weights_normed_update_0_write0_to_fused_level_0_rd0.peek(/* one reader or all rams */ (1078 - d1 >= 0 && 1078 - d0 >= 0) ? (1088) : (-1079 + d0 == 0 && 1078 - d1 >= 0) ? (1087) : (-1079 + d1 == 0 && 1078 - d0 >= 0) ? ((1079 - d0)) : 0);
  return value_dark_weights_normed_dark_weights_normed_update_0_write0;
  return 0;
}
...
struct dark_weights_normed_gauss_blur_1_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> dark_weights_normed_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_ds_1_rd0 read pattern: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> dark_weights_normed_gauss_blur_1[2d0, 2d1] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Read schedule : { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
...
struct dark_weights_normed_gauss_blur_2_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> dark_weights_normed_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_ds_2_rd0 read pattern: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> dark_weights_normed_gauss_blur_2[2d0, 2d1] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Read schedule : { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
...
struct dark_weights_normed_gauss_blur_3_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> dark_weights_normed_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_ds_3_rd0 read pattern: { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> dark_weights_normed_gauss_blur_3[2d0, 2d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 30] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
...
struct dark_weights_normed_gauss_ds_1_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
    // { fused_level_1_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd0 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd1 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd2 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[-1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd3 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd4 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd5 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd6 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, -1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd7 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_2_rd8 read pattern: { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[1 + d0, 1 + d1] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Read schedule : { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_1_rd0 read pattern: { fused_level_1_update_0[d0, d1] -> dark_weights_normed_gauss_ds_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
...
struct dark_weights_normed_gauss_ds_2_cache {
  // Reader addrs...
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
    // { fused_level_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 2
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd0 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd1 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd2 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[-1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd3 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd4 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd5 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd6 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, -1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd7 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_weights_normed_gauss_blur_3_rd8 read pattern: { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[1 + d0, 1 + d1] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Read schedule : { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_2_rd0 read pattern: { fused_level_2_update_0[d0, d1] -> dark_weights_normed_gauss_ds_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
...
struct dark_weights_normed_gauss_ds_3_cache {
  // Reader addrs...
    // { fused_level_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // fused_level_3_rd0 read pattern: { fused_level_3_update_0[d0, d1] -> dark_weights_normed_gauss_ds_3[d0, d1] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Read schedule : { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
  // Write schedule: { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 30] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
struct final_merged_0_final_merged_0_update_0_write0_to_sefss_1_rd0_cache {
	// RAM Box: {[0, 1079], [0, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct final_merged_0_cache {
  // Reader addrs...
    // { sefss_1_update_0[d0, d1] -> final_merged_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
  final_merged_0_final_merged_0_update_0_write0_to_sefss_1_rd0_cache final_merged_0_final_merged_0_update_0_write0_to_sefss_1_rd0;
};
...
inline void final_merged_0_final_merged_0_update_0_write0_write(hw_uint<16>& final_merged_0_final_merged_0_update_0_write0, final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_sefss_1_rd0.push(final_merged_0_final_merged_0_update_0_write0);
}

inline hw_uint<16> sefss_1_rd0_select(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // sefss_1_rd0 read pattern: { sefss_1_update_0[d0, d1] -> final_merged_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { sefss_1_update_0[d0, d1] -> [7 + d1, 7 + d0, 51] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 50] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  auto value_final_merged_0_final_merged_0_update_0_write0 = final_merged_0.final_merged_0_final_merged_0_update_0_write0_to_sefss_1_rd0.peek(/* one reader or all rams */ 0);
...
// sefss_1_update_0_read
//	sefss_1_rd0
inline hw_uint<16> final_merged_0_sefss_1_update_0_read_bundle_read(final_merged_0_cache& final_merged_0, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // sefss_1_rd0

	hw_uint<16> result;
	hw_uint<16> sefss_1_rd0_res = sefss_1_rd0_select(final_merged_0, d0, d1, dynamic_address);
	set_at<0, 16>(result, sefss_1_rd0_res);
	return result;
}
...
struct final_merged_1_cache {
  // Reader addrs...
    // { final_merged_0_update_0[d0, d1] -> final_merged_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_0_rd0 read pattern: { final_merged_0_update_0[d0, d1] -> final_merged_1[o0, o1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 50] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { final_merged_1_update_0[d0, d1] -> [7 + 2d1, 7 + 2d0, 49] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
...
struct final_merged_2_cache {
  // Reader addrs...
    // { final_merged_1_update_0[d0, d1] -> final_merged_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_1_rd0 read pattern: { final_merged_1_update_0[d0, d1] -> final_merged_2[o0, o1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [7 + 2d1, 7 + 2d0, 49] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { final_merged_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 48] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct fused_level_0_cache {
  // Reader addrs...
    // { final_merged_0_update_0[d0, d1] -> fused_level_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_0_rd0 read pattern: { final_merged_0_update_0[d0, d1] -> fused_level_0[d0, d1] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Read schedule : { final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 50] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  // Write schedule: { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
  auto value_fused_level_0_fused_level_0_update_0_write0 = fused_level_0.fused_level_0_fused_level_0_update_0_write0_to_final_merged_0_rd0.peek(/* one reader or all rams */ (-1074 + d1 == 0 && -1079 + d0 == 0) ? (5400) : (-1079 + d0 == 0 && 1073 - d1 >= 0) ? (6480) : (-1074 + d0 == 0 && 1073 - d1 >= 0) ? (6485) : (1073 - d1 >= 0 && 1073 - d0 >= 0) ? (6486) : (-1079 + d1 == 0 && 1078 - d0 >= 0) ? ((1079 - d0)) : (-1074 + d1 == 0 && 1078 - d0 >= 0) ? ((6479 - d0)) : (-1075 + d0 >= 0 && 1078 - d0 >= 0 && 1073 - d1 >= 0) ? ((7559 - d0)) : (-1079 + d0 == 0 && -1075 + d1 >= 0 && 1078 - d1 >= 0) ? ((1165320 - 1080 * d1)) : (1078 - d1 >= 0 && 1078 - d0 >= 0 && -1075 + d1 >= 0) ? (((1166399 - d0) - 1080 * d1)) : 0);
...
struct fused_level_1_cache {
  // Reader addrs...
    // { final_merged_1_update_0[d0, d1] -> fused_level_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_1_rd0 read pattern: { final_merged_1_update_0[d0, d1] -> fused_level_1[d0, d1] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Read schedule : { final_merged_1_update_0[d0, d1] -> [7 + 2d1, 7 + 2d0, 49] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  // Write schedule: { fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
  auto value_fused_level_1_fused_level_1_update_0_write0 = fused_level_1.fused_level_1_fused_level_1_update_0_write0_to_final_merged_1_rd0.peek(/* one reader or all rams */ (-538 + d1 == 0 && -539 + d0 == 0) ? (540) : (-539 + d0 == 0 && 537 - d1 >= 0) ? (1080) : (-538 + d0 == 0 && 537 - d1 >= 0) ? (1081) : (537 - d1 >= 0 && 537 - d0 >= 0) ? (1082) : (-539 + d1 == 0 && 538 - d0 >= 0) ? ((539 - d0)) : (-538 + d1 == 0 && 538 - d0 >= 0) ? ((1079 - d0)) : 0);
...
struct fused_level_2_cache {
  // Reader addrs...
    // { final_merged_2_update_0[d0, d1] -> fused_level_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_2_rd0 read pattern: { final_merged_2_update_0[d0, d1] -> fused_level_2[d0, d1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 48] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
...
struct fused_level_3_cache {
  // Reader addrs...
    // { final_merged_2_update_0[d0, d1] -> fused_level_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // # of banks: 1
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // final_merged_2_rd0 read pattern: { final_merged_2_update_0[d0, d1] -> fused_level_3[o0, o1] : 0 <= d0 <= 269 and 0 <= d1 <= 269 and -1 + d0 <= 2o0 <= d0 and -1 + d1 <= 2o1 <= d1 }
  // Read schedule : { final_merged_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 48] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
  // Write schedule: { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
...
struct in_in_update_0_write0_to_bright_rd0_cache {
	// RAM Box: {[-7, 1079], [-7, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct in_in_update_0_write0_to_dark_rd0_cache {
	// RAM Box: {[-7, 1079], [-7, 1079]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct in_cache {
  // Reader addrs...
    // { bright_update_0[d0, d1] -> in[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
    // { dark_update_0[d0, d1] -> in[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // # of banks: 2
  in_in_update_0_write0_to_bright_rd0_cache in_in_update_0_write0_to_bright_rd0;
  in_in_update_0_write0_to_dark_rd0_cache in_in_update_0_write0_to_dark_rd0;
};



inline void in_in_update_0_write0_write(hw_uint<16>& in_in_update_0_write0, in_cache& in, int d0, int d1, int dynamic_address) {
  in.in_in_update_0_write0_to_bright_rd0.push(in_in_update_0_write0);
  in.in_in_update_0_write0_to_dark_rd0.push(in_in_update_0_write0);
}

inline hw_uint<16> bright_rd0_select(in_cache& in, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // bright_rd0 read pattern: { bright_update_0[d0, d1] -> in[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_to_bright_rd0.peek(/* one reader or all rams */ 0);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // dark_rd0 read pattern: { dark_update_0[d0, d1] -> in[d0, d1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Read schedule : { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_to_dark_rd0.peek(/* one reader or all rams */ 0);
  return value_in_in_update_0_write0;
  return 0;
}
...
inline void dark_update_0(in_cache& in, dark_cache& dark, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: in
	auto in_1_m_dark_1__p__0_c__1_m_dark_0__p__0_value = in_dark_update_0_read_bundle_read(in/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = scale_exposure_unrolled_1(in_1_m_dark_1__p__0_c__1_m_dark_0__p__0_value);
	// Produce: dark
...
inline void bright_update_0(in_cache& in, bright_cache& bright, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: in
	auto in_1_m_bright_1__p__0_c__1_m_bright_0__p__0_value = in_bright_update_0_read_bundle_read(in/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(in_1_m_bright_1__p__0_c__1_m_bright_0__p__0_value);
	// Produce: bright
...
inline void dark_weights_update_0(dark_cache& dark, dark_weights_cache& dark_weights, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark
	auto dark_1_m_dark_weights_1__p__0_c__1_m_dark_weights_0__p__0_value = dark_dark_weights_update_0_read_bundle_read(dark/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weight_unrolled_1(dark_1_m_dark_weights_1__p__0_c__1_m_dark_weights_0__p__0_value);
...
inline void bright_weights_update_0(bright_cache& bright, bright_weights_cache& bright_weights, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright
	auto bright_1_m_bright_weights_1__p__0_c__1_m_bright_weights_0__p__0_value = bright_bright_weights_update_0_read_bundle_read(bright/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weight_unrolled_1(bright_1_m_bright_weights_1__p__0_c__1_m_bright_weights_0__p__0_value);
...
inline void dark_weights_normed_update_0(dark_weights_cache& dark_weights, dark_weights_normed_cache& dark_weights_normed, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_1_m_dark_weights_normed_1__p__0_c__1_m_dark_weights_normed_0__p__0_value = dark_weights_dark_weights_normed_update_0_read_bundle_read(dark_weights/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_normalize_weights_unrolled_1(dark_weights_1_m_dark_weights_normed_1__p__0_c__1_m_dark_weights_normed_0__p__0_value);
...
inline void dark_gauss_blur_1_update_0(dark_cache& dark, dark_gauss_blur_1_cache& dark_gauss_blur_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark
	auto dark_1_m_dark_gauss_blur_1_1__p___m_1_c__1_m_dark_gauss_blur_1_0__p___m_1_value = dark_dark_gauss_blur_1_update_0_read_bundle_read(dark/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_1_m_dark_gauss_blur_1_1__p___m_1_c__1_m_dark_gauss_blur_1_0__p___m_1_value);
...
inline void bright_weights_normed_update_0(bright_weights_cache& bright_weights, bright_weights_normed_cache& bright_weights_normed, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_1_m_bright_weights_normed_1__p__0_c__1_m_bright_weights_normed_0__p__0_value = bright_weights_bright_weights_normed_update_0_read_bundle_read(bright_weights/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_normalize_weights_unrolled_1(bright_weights_1_m_bright_weights_normed_1__p__0_c__1_m_bright_weights_normed_0__p__0_value);
...
inline void bright_gauss_blur_1_update_0(bright_cache& bright, bright_gauss_blur_1_cache& bright_gauss_blur_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright
	auto bright_1_m_bright_gauss_blur_1_1__p___m_1_c__1_m_bright_gauss_blur_1_0__p___m_1_value = bright_bright_gauss_blur_1_update_0_read_bundle_read(bright/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_1_m_bright_gauss_blur_1_1__p___m_1_c__1_m_bright_gauss_blur_1_0__p___m_1_value);
...
inline void dark_weights_normed_gauss_blur_1_update_0(dark_weights_normed_cache& dark_weights_normed, dark_weights_normed_gauss_blur_1_cache& dark_weights_normed_gauss_blur_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_1_m_dark_weights_normed_gauss_blur_1_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_1_0__p___m_1_value = dark_weights_normed_dark_weights_normed_gauss_blur_1_update_0_read_bundle_read(dark_weights_normed/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_weights_normed_1_m_dark_weights_normed_gauss_blur_1_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_1_0__p___m_1_value);
...
inline void dark_gauss_ds_1_update_0(dark_gauss_blur_1_cache& dark_gauss_blur_1, dark_gauss_ds_1_cache& dark_gauss_ds_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_blur_1_2_m_dark_gauss_ds_1_1__p__0_c__2_m_dark_gauss_ds_1_0__p__0_value = dark_gauss_blur_1_dark_gauss_ds_1_update_0_read_bundle_read(dark_gauss_blur_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_blur_1_2_m_dark_gauss_ds_1_1__p__0_c__2_m_dark_gauss_ds_1_0__p__0_value);
...
inline void dark_gauss_blur_2_update_0(dark_gauss_ds_1_cache& dark_gauss_ds_1, dark_gauss_blur_2_cache& dark_gauss_blur_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_ds_1_1_m_dark_gauss_blur_2_1__p___m_1_c__1_m_dark_gauss_blur_2_0__p___m_1_value = dark_gauss_ds_1_dark_gauss_blur_2_update_0_read_bundle_read(dark_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_gauss_ds_1_1_m_dark_gauss_blur_2_1__p___m_1_c__1_m_dark_gauss_blur_2_0__p___m_1_value);
...
inline void bright_weights_normed_gauss_blur_1_update_0(bright_weights_normed_cache& bright_weights_normed, bright_weights_normed_gauss_blur_1_cache& bright_weights_normed_gauss_blur_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_1_m_bright_weights_normed_gauss_blur_1_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_1_0__p___m_1_value = bright_weights_normed_bright_weights_normed_gauss_blur_1_update_0_read_bundle_read(bright_weights_normed/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_weights_normed_1_m_bright_weights_normed_gauss_blur_1_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_1_0__p___m_1_value);
...
inline void bright_gauss_ds_1_update_0(bright_gauss_blur_1_cache& bright_gauss_blur_1, bright_gauss_ds_1_cache& bright_gauss_ds_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_blur_1_2_m_bright_gauss_ds_1_1__p__0_c__2_m_bright_gauss_ds_1_0__p__0_value = bright_gauss_blur_1_bright_gauss_ds_1_update_0_read_bundle_read(bright_gauss_blur_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_blur_1_2_m_bright_gauss_ds_1_1__p__0_c__2_m_bright_gauss_ds_1_0__p__0_value);
...
inline void bright_gauss_blur_2_update_0(bright_gauss_ds_1_cache& bright_gauss_ds_1, bright_gauss_blur_2_cache& bright_gauss_blur_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_ds_1_1_m_bright_gauss_blur_2_1__p___m_1_c__1_m_bright_gauss_blur_2_0__p___m_1_value = bright_gauss_ds_1_bright_gauss_blur_2_update_0_read_bundle_read(bright_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_gauss_ds_1_1_m_bright_gauss_blur_2_1__p___m_1_c__1_m_bright_gauss_blur_2_0__p___m_1_value);
...
inline void dark_weights_normed_gauss_ds_1_update_0(dark_weights_normed_gauss_blur_1_cache& dark_weights_normed_gauss_blur_1, dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_gauss_blur_1_2_m_dark_weights_normed_gauss_ds_1_1__p__0_c__2_m_dark_weights_normed_gauss_ds_1_0__p__0_value = dark_weights_normed_gauss_blur_1_dark_weights_normed_gauss_ds_1_update_0_read_bundle_read(dark_weights_normed_gauss_blur_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_weights_normed_gauss_blur_1_2_m_dark_weights_normed_gauss_ds_1_1__p__0_c__2_m_dark_weights_normed_gauss_ds_1_0__p__0_value);
...
inline void dark_weights_normed_gauss_blur_2_update_0(dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, dark_weights_normed_gauss_blur_2_cache& dark_weights_normed_gauss_blur_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_gauss_ds_1_1_m_dark_weights_normed_gauss_blur_2_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_2_0__p___m_1_value = dark_weights_normed_gauss_ds_1_dark_weights_normed_gauss_blur_2_update_0_read_bundle_read(dark_weights_normed_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_weights_normed_gauss_ds_1_1_m_dark_weights_normed_gauss_blur_2_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_2_0__p___m_1_value);
...
inline void dark_gauss_ds_2_update_0(dark_gauss_blur_2_cache& dark_gauss_blur_2, dark_gauss_ds_2_cache& dark_gauss_ds_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_blur_2_2_m_dark_gauss_ds_2_1__p__0_c__2_m_dark_gauss_ds_2_0__p__0_value = dark_gauss_blur_2_dark_gauss_ds_2_update_0_read_bundle_read(dark_gauss_blur_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_blur_2_2_m_dark_gauss_ds_2_1__p__0_c__2_m_dark_gauss_ds_2_0__p__0_value);
...
inline void dark_gauss_blur_3_update_0(dark_gauss_ds_2_cache& dark_gauss_ds_2, dark_gauss_blur_3_cache& dark_gauss_blur_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_ds_2_1_m_dark_gauss_blur_3_1__p___m_1_c__1_m_dark_gauss_blur_3_0__p___m_1_value = dark_gauss_ds_2_dark_gauss_blur_3_update_0_read_bundle_read(dark_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_gauss_ds_2_1_m_dark_gauss_blur_3_1__p___m_1_c__1_m_dark_gauss_blur_3_0__p___m_1_value);
...
inline void bright_weights_normed_gauss_ds_1_update_0(bright_weights_normed_gauss_blur_1_cache& bright_weights_normed_gauss_blur_1, bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_gauss_blur_1_2_m_bright_weights_normed_gauss_ds_1_1__p__0_c__2_m_bright_weights_normed_gauss_ds_1_0__p__0_value = bright_weights_normed_gauss_blur_1_bright_weights_normed_gauss_ds_1_update_0_read_bundle_read(bright_weights_normed_gauss_blur_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_weights_normed_gauss_blur_1_2_m_bright_weights_normed_gauss_ds_1_1__p__0_c__2_m_bright_weights_normed_gauss_ds_1_0__p__0_value);
...
inline void bright_weights_normed_gauss_blur_2_update_0(bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, bright_weights_normed_gauss_blur_2_cache& bright_weights_normed_gauss_blur_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_gauss_ds_1_1_m_bright_weights_normed_gauss_blur_2_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_2_0__p___m_1_value = bright_weights_normed_gauss_ds_1_bright_weights_normed_gauss_blur_2_update_0_read_bundle_read(bright_weights_normed_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_weights_normed_gauss_ds_1_1_m_bright_weights_normed_gauss_blur_2_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_2_0__p___m_1_value);
...
inline void bright_gauss_ds_2_update_0(bright_gauss_blur_2_cache& bright_gauss_blur_2, bright_gauss_ds_2_cache& bright_gauss_ds_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_blur_2_2_m_bright_gauss_ds_2_1__p__0_c__2_m_bright_gauss_ds_2_0__p__0_value = bright_gauss_blur_2_bright_gauss_ds_2_update_0_read_bundle_read(bright_gauss_blur_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_blur_2_2_m_bright_gauss_ds_2_1__p__0_c__2_m_bright_gauss_ds_2_0__p__0_value);
...
inline void bright_gauss_blur_3_update_0(bright_gauss_ds_2_cache& bright_gauss_ds_2, bright_gauss_blur_3_cache& bright_gauss_blur_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_ds_2_1_m_bright_gauss_blur_3_1__p___m_1_c__1_m_bright_gauss_blur_3_0__p___m_1_value = bright_gauss_ds_2_bright_gauss_blur_3_update_0_read_bundle_read(bright_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_gauss_ds_2_1_m_bright_gauss_blur_3_1__p___m_1_c__1_m_bright_gauss_blur_3_0__p___m_1_value);
...
inline void dark_weights_normed_gauss_ds_2_update_0(dark_weights_normed_gauss_blur_2_cache& dark_weights_normed_gauss_blur_2, dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_gauss_blur_2_2_m_dark_weights_normed_gauss_ds_2_1__p__0_c__2_m_dark_weights_normed_gauss_ds_2_0__p__0_value = dark_weights_normed_gauss_blur_2_dark_weights_normed_gauss_ds_2_update_0_read_bundle_read(dark_weights_normed_gauss_blur_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_weights_normed_gauss_blur_2_2_m_dark_weights_normed_gauss_ds_2_1__p__0_c__2_m_dark_weights_normed_gauss_ds_2_0__p__0_value);
...
inline void dark_weights_normed_gauss_blur_3_update_0(dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, dark_weights_normed_gauss_blur_3_cache& dark_weights_normed_gauss_blur_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_gauss_ds_2_1_m_dark_weights_normed_gauss_blur_3_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_3_0__p___m_1_value = dark_weights_normed_gauss_ds_2_dark_weights_normed_gauss_blur_3_update_0_read_bundle_read(dark_weights_normed_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(dark_weights_normed_gauss_ds_2_1_m_dark_weights_normed_gauss_blur_3_1__p___m_1_c__1_m_dark_weights_normed_gauss_blur_3_0__p___m_1_value);
...
inline void dark_gauss_ds_3_update_0(dark_gauss_blur_3_cache& dark_gauss_blur_3, dark_gauss_ds_3_cache& dark_gauss_ds_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_blur_3_2_m_dark_gauss_ds_3_1__p__0_c__2_m_dark_gauss_ds_3_0__p__0_value = dark_gauss_blur_3_dark_gauss_ds_3_update_0_read_bundle_read(dark_gauss_blur_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_blur_3_2_m_dark_gauss_ds_3_1__p__0_c__2_m_dark_gauss_ds_3_0__p__0_value);
...
inline void bright_weights_normed_gauss_ds_2_update_0(bright_weights_normed_gauss_blur_2_cache& bright_weights_normed_gauss_blur_2, bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_gauss_blur_2_2_m_bright_weights_normed_gauss_ds_2_1__p__0_c__2_m_bright_weights_normed_gauss_ds_2_0__p__0_value = bright_weights_normed_gauss_blur_2_bright_weights_normed_gauss_ds_2_update_0_read_bundle_read(bright_weights_normed_gauss_blur_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_weights_normed_gauss_blur_2_2_m_bright_weights_normed_gauss_ds_2_1__p__0_c__2_m_bright_weights_normed_gauss_ds_2_0__p__0_value);
...
inline void bright_weights_normed_gauss_blur_3_update_0(bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, bright_weights_normed_gauss_blur_3_cache& bright_weights_normed_gauss_blur_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_gauss_ds_2_1_m_bright_weights_normed_gauss_blur_3_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_3_0__p___m_1_value = bright_weights_normed_gauss_ds_2_bright_weights_normed_gauss_blur_3_update_0_read_bundle_read(bright_weights_normed_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = reduce_gauss_unrolled_1(bright_weights_normed_gauss_ds_2_1_m_bright_weights_normed_gauss_blur_3_1__p___m_1_c__1_m_bright_weights_normed_gauss_blur_3_0__p___m_1_value);
...
inline void bright_gauss_ds_3_update_0(bright_gauss_blur_3_cache& bright_gauss_blur_3, bright_gauss_ds_3_cache& bright_gauss_ds_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_blur_3_2_m_bright_gauss_ds_3_1__p__0_c__2_m_bright_gauss_ds_3_0__p__0_value = bright_gauss_blur_3_bright_gauss_ds_3_update_0_read_bundle_read(bright_gauss_blur_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_blur_3_2_m_bright_gauss_ds_3_1__p__0_c__2_m_bright_gauss_ds_3_0__p__0_value);
...
inline void dark_weights_normed_gauss_ds_3_update_0(dark_weights_normed_gauss_blur_3_cache& dark_weights_normed_gauss_blur_3, dark_weights_normed_gauss_ds_3_cache& dark_weights_normed_gauss_ds_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_weights_normed_gauss_blur_3_2_m_dark_weights_normed_gauss_ds_3_1__p__0_c__2_m_dark_weights_normed_gauss_ds_3_0__p__0_value = dark_weights_normed_gauss_blur_3_dark_weights_normed_gauss_ds_3_update_0_read_bundle_read(dark_weights_normed_gauss_blur_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_weights_normed_gauss_blur_3_2_m_dark_weights_normed_gauss_ds_3_1__p__0_c__2_m_dark_weights_normed_gauss_ds_3_0__p__0_value);
...
inline void dark_laplace_us_2_update_0(dark_gauss_ds_3_cache& dark_gauss_ds_3, dark_laplace_us_2_cache& dark_laplace_us_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto dark_gauss_ds_3_floor_lp__lp_1_m_dark_laplace_us_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_2_0_rp__div_2_rp___p__0_value = dark_gauss_ds_3_dark_laplace_us_2_update_0_read_bundle_read(dark_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_ds_3_floor_lp__lp_1_m_dark_laplace_us_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_2_0_rp__div_2_rp___p__0_value);
...
inline void dark_laplace_us_1_update_0(dark_gauss_ds_2_cache& dark_gauss_ds_2, dark_laplace_us_1_cache& dark_laplace_us_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark_gauss_ds_2
	auto dark_gauss_ds_2_floor_lp__lp_1_m_dark_laplace_us_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_1_0_rp__div_2_rp___p__0_value = dark_gauss_ds_2_dark_laplace_us_1_update_0_read_bundle_read(dark_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_ds_2_floor_lp__lp_1_m_dark_laplace_us_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_1_0_rp__div_2_rp___p__0_value);
...
inline void dark_laplace_us_0_update_0(dark_gauss_ds_1_cache& dark_gauss_ds_1, dark_laplace_us_0_cache& dark_laplace_us_0, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark_gauss_ds_1
	auto dark_gauss_ds_1_floor_lp__lp_1_m_dark_laplace_us_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_0_0_rp__div_2_rp___p__0_value = dark_gauss_ds_1_dark_laplace_us_0_update_0_read_bundle_read(dark_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(dark_gauss_ds_1_floor_lp__lp_1_m_dark_laplace_us_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_dark_laplace_us_0_0_rp__div_2_rp___p__0_value);
...
inline void dark_laplace_diff_2_update_0(dark_gauss_ds_2_cache& dark_gauss_ds_2, dark_laplace_us_2_cache& dark_laplace_us_2, dark_laplace_diff_2_cache& dark_laplace_diff_2, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark_gauss_ds_2
	auto dark_gauss_ds_2_1_m_dark_laplace_diff_2_1__p__0_c__1_m_dark_laplace_diff_2_0__p__0_value = dark_gauss_ds_2_dark_laplace_diff_2_update_0_read_bundle_read(dark_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_us_2
	auto dark_laplace_us_2_1_m_dark_laplace_diff_2_1__p__0_c__1_m_dark_laplace_diff_2_0__p__0_value = dark_laplace_us_2_dark_laplace_diff_2_update_0_read_bundle_read(dark_laplace_us_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(dark_gauss_ds_2_1_m_dark_laplace_diff_2_1__p__0_c__1_m_dark_laplace_diff_2_0__p__0_value, dark_laplace_us_2_1_m_dark_laplace_diff_2_1__p__0_c__1_m_dark_laplace_diff_2_0__p__0_value);
...
inline void dark_laplace_diff_1_update_0(dark_gauss_ds_1_cache& dark_gauss_ds_1, dark_laplace_us_1_cache& dark_laplace_us_1, dark_laplace_diff_1_cache& dark_laplace_diff_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark_gauss_ds_1
	auto dark_gauss_ds_1_1_m_dark_laplace_diff_1_1__p__0_c__1_m_dark_laplace_diff_1_0__p__0_value = dark_gauss_ds_1_dark_laplace_diff_1_update_0_read_bundle_read(dark_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_us_1
	auto dark_laplace_us_1_1_m_dark_laplace_diff_1_1__p__0_c__1_m_dark_laplace_diff_1_0__p__0_value = dark_laplace_us_1_dark_laplace_diff_1_update_0_read_bundle_read(dark_laplace_us_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(dark_gauss_ds_1_1_m_dark_laplace_diff_1_1__p__0_c__1_m_dark_laplace_diff_1_0__p__0_value, dark_laplace_us_1_1_m_dark_laplace_diff_1_1__p__0_c__1_m_dark_laplace_diff_1_0__p__0_value);
...
inline void dark_laplace_diff_0_update_0(dark_cache& dark, dark_laplace_us_0_cache& dark_laplace_us_0, dark_laplace_diff_0_cache& dark_laplace_diff_0, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: dark
	auto dark_1_m_dark_laplace_diff_0_1__p__0_c__1_m_dark_laplace_diff_0_0__p__0_value = dark_dark_laplace_diff_0_update_0_read_bundle_read(dark/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_us_0
	auto dark_laplace_us_0_1_m_dark_laplace_diff_0_1__p__0_c__1_m_dark_laplace_diff_0_0__p__0_value = dark_laplace_us_0_dark_laplace_diff_0_update_0_read_bundle_read(dark_laplace_us_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(dark_1_m_dark_laplace_diff_0_1__p__0_c__1_m_dark_laplace_diff_0_0__p__0_value, dark_laplace_us_0_1_m_dark_laplace_diff_0_1__p__0_c__1_m_dark_laplace_diff_0_0__p__0_value);
...
inline void bright_weights_normed_gauss_ds_3_update_0(bright_weights_normed_gauss_blur_3_cache& bright_weights_normed_gauss_blur_3, bright_weights_normed_gauss_ds_3_cache& bright_weights_normed_gauss_ds_3, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_weights_normed_gauss_blur_3_2_m_bright_weights_normed_gauss_ds_3_1__p__0_c__2_m_bright_weights_normed_gauss_ds_3_0__p__0_value = bright_weights_normed_gauss_blur_3_bright_weights_normed_gauss_ds_3_update_0_read_bundle_read(bright_weights_normed_gauss_blur_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_weights_normed_gauss_blur_3_2_m_bright_weights_normed_gauss_ds_3_1__p__0_c__2_m_bright_weights_normed_gauss_ds_3_0__p__0_value);
...
inline void bright_laplace_us_2_update_0(bright_gauss_ds_3_cache& bright_gauss_ds_3, bright_laplace_us_2_cache& bright_laplace_us_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_gauss_ds_3_floor_lp__lp_1_m_bright_laplace_us_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_2_0_rp__div_2_rp___p__0_value = bright_gauss_ds_3_bright_laplace_us_2_update_0_read_bundle_read(bright_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_ds_3_floor_lp__lp_1_m_bright_laplace_us_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_2_0_rp__div_2_rp___p__0_value);
...
inline void bright_laplace_us_1_update_0(bright_gauss_ds_2_cache& bright_gauss_ds_2, bright_laplace_us_1_cache& bright_laplace_us_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright_gauss_ds_2
	auto bright_gauss_ds_2_floor_lp__lp_1_m_bright_laplace_us_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_1_0_rp__div_2_rp___p__0_value = bright_gauss_ds_2_bright_laplace_us_1_update_0_read_bundle_read(bright_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_ds_2_floor_lp__lp_1_m_bright_laplace_us_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_1_0_rp__div_2_rp___p__0_value);
...
inline void bright_laplace_us_0_update_0(bright_gauss_ds_1_cache& bright_gauss_ds_1, bright_laplace_us_0_cache& bright_laplace_us_0, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright_gauss_ds_1
	auto bright_gauss_ds_1_floor_lp__lp_1_m_bright_laplace_us_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_0_0_rp__div_2_rp___p__0_value = bright_gauss_ds_1_bright_laplace_us_0_update_0_read_bundle_read(bright_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(bright_gauss_ds_1_floor_lp__lp_1_m_bright_laplace_us_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_bright_laplace_us_0_0_rp__div_2_rp___p__0_value);
...
inline void bright_laplace_diff_2_update_0(bright_gauss_ds_2_cache& bright_gauss_ds_2, bright_laplace_us_2_cache& bright_laplace_us_2, bright_laplace_diff_2_cache& bright_laplace_diff_2, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright_gauss_ds_2
	auto bright_gauss_ds_2_1_m_bright_laplace_diff_2_1__p__0_c__1_m_bright_laplace_diff_2_0__p__0_value = bright_gauss_ds_2_bright_laplace_diff_2_update_0_read_bundle_read(bright_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_laplace_us_2
	auto bright_laplace_us_2_1_m_bright_laplace_diff_2_1__p__0_c__1_m_bright_laplace_diff_2_0__p__0_value = bright_laplace_us_2_bright_laplace_diff_2_update_0_read_bundle_read(bright_laplace_us_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(bright_gauss_ds_2_1_m_bright_laplace_diff_2_1__p__0_c__1_m_bright_laplace_diff_2_0__p__0_value, bright_laplace_us_2_1_m_bright_laplace_diff_2_1__p__0_c__1_m_bright_laplace_diff_2_0__p__0_value);
...
inline void bright_laplace_diff_1_update_0(bright_gauss_ds_1_cache& bright_gauss_ds_1, bright_laplace_us_1_cache& bright_laplace_us_1, bright_laplace_diff_1_cache& bright_laplace_diff_1, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright_gauss_ds_1
	auto bright_gauss_ds_1_1_m_bright_laplace_diff_1_1__p__0_c__1_m_bright_laplace_diff_1_0__p__0_value = bright_gauss_ds_1_bright_laplace_diff_1_update_0_read_bundle_read(bright_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_laplace_us_1
	auto bright_laplace_us_1_1_m_bright_laplace_diff_1_1__p__0_c__1_m_bright_laplace_diff_1_0__p__0_value = bright_laplace_us_1_bright_laplace_diff_1_update_0_read_bundle_read(bright_laplace_us_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(bright_gauss_ds_1_1_m_bright_laplace_diff_1_1__p__0_c__1_m_bright_laplace_diff_1_0__p__0_value, bright_laplace_us_1_1_m_bright_laplace_diff_1_1__p__0_c__1_m_bright_laplace_diff_1_0__p__0_value);
...
inline void bright_laplace_diff_0_update_0(bright_cache& bright, bright_laplace_us_0_cache& bright_laplace_us_0, bright_laplace_diff_0_cache& bright_laplace_diff_0, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright
	auto bright_1_m_bright_laplace_diff_0_1__p__0_c__1_m_bright_laplace_diff_0_0__p__0_value = bright_bright_laplace_diff_0_update_0_read_bundle_read(bright/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_laplace_us_0
	auto bright_laplace_us_0_1_m_bright_laplace_diff_0_1__p__0_c__1_m_bright_laplace_diff_0_0__p__0_value = bright_laplace_us_0_bright_laplace_diff_0_update_0_read_bundle_read(bright_laplace_us_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = diff_unrolled_1(bright_1_m_bright_laplace_diff_0_1__p__0_c__1_m_bright_laplace_diff_0_0__p__0_value, bright_laplace_us_0_1_m_bright_laplace_diff_0_1__p__0_c__1_m_bright_laplace_diff_0_0__p__0_value);
...
inline void fused_level_3_update_0(bright_gauss_ds_3_cache& bright_gauss_ds_3, dark_gauss_ds_3_cache& dark_gauss_ds_3, bright_weights_normed_gauss_ds_3_cache& bright_weights_normed_gauss_ds_3, dark_weights_normed_gauss_ds_3_cache& dark_weights_normed_gauss_ds_3, fused_level_3_cache& fused_level_3, int d0, int d1) {
  // Dynamic address computation
	...
	// Consume: bright_gauss_ds_3
	auto bright_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value = bright_gauss_ds_3_fused_level_3_update_0_read_bundle_read(bright_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_gauss_ds_3
	auto dark_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value = dark_gauss_ds_3_fused_level_3_update_0_read_bundle_read(dark_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_weights_normed_gauss_ds_3
	auto bright_weights_normed_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value = bright_weights_normed_gauss_ds_3_fused_level_3_update_0_read_bundle_read(bright_weights_normed_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_weights_normed_gauss_ds_3
	auto dark_weights_normed_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value = dark_weights_normed_gauss_ds_3_fused_level_3_update_0_read_bundle_read(dark_weights_normed_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weighted_merge_unrolled_1(bright_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value, dark_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value, bright_weights_normed_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value, dark_weights_normed_gauss_ds_3_1_m_fused_level_3_1__p__0_c__1_m_fused_level_3_0__p__0_value);
...
inline void fused_level_2_update_0(bright_laplace_diff_2_cache& bright_laplace_diff_2, dark_laplace_diff_2_cache& dark_laplace_diff_2, bright_weights_normed_gauss_ds_2_cache& bright_weights_normed_gauss_ds_2, dark_weights_normed_gauss_ds_2_cache& dark_weights_normed_gauss_ds_2, fused_level_2_cache& fused_level_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_laplace_diff_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value = bright_laplace_diff_2_fused_level_2_update_0_read_bundle_read(bright_laplace_diff_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_diff_2
	auto dark_laplace_diff_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value = dark_laplace_diff_2_fused_level_2_update_0_read_bundle_read(dark_laplace_diff_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_weights_normed_gauss_ds_2
	auto bright_weights_normed_gauss_ds_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value = bright_weights_normed_gauss_ds_2_fused_level_2_update_0_read_bundle_read(bright_weights_normed_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_weights_normed_gauss_ds_2
	auto dark_weights_normed_gauss_ds_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value = dark_weights_normed_gauss_ds_2_fused_level_2_update_0_read_bundle_read(dark_weights_normed_gauss_ds_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weighted_merge_unrolled_1(bright_laplace_diff_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value, dark_laplace_diff_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value, bright_weights_normed_gauss_ds_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value, dark_weights_normed_gauss_ds_2_1_m_fused_level_2_1__p__0_c__1_m_fused_level_2_0__p__0_value);
...
inline void fused_level_1_update_0(bright_laplace_diff_1_cache& bright_laplace_diff_1, dark_laplace_diff_1_cache& dark_laplace_diff_1, bright_weights_normed_gauss_ds_1_cache& bright_weights_normed_gauss_ds_1, dark_weights_normed_gauss_ds_1_cache& dark_weights_normed_gauss_ds_1, fused_level_1_cache& fused_level_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_laplace_diff_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value = bright_laplace_diff_1_fused_level_1_update_0_read_bundle_read(bright_laplace_diff_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_diff_1
	auto dark_laplace_diff_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value = dark_laplace_diff_1_fused_level_1_update_0_read_bundle_read(dark_laplace_diff_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_weights_normed_gauss_ds_1
	auto bright_weights_normed_gauss_ds_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value = bright_weights_normed_gauss_ds_1_fused_level_1_update_0_read_bundle_read(bright_weights_normed_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_weights_normed_gauss_ds_1
	auto dark_weights_normed_gauss_ds_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value = dark_weights_normed_gauss_ds_1_fused_level_1_update_0_read_bundle_read(dark_weights_normed_gauss_ds_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weighted_merge_unrolled_1(bright_laplace_diff_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value, dark_laplace_diff_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value, bright_weights_normed_gauss_ds_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value, dark_weights_normed_gauss_ds_1_1_m_fused_level_1_1__p__0_c__1_m_fused_level_1_0__p__0_value);
...
inline void fused_level_0_update_0(bright_laplace_diff_0_cache& bright_laplace_diff_0, dark_laplace_diff_0_cache& dark_laplace_diff_0, bright_weights_normed_cache& bright_weights_normed, dark_weights_normed_cache& dark_weights_normed, fused_level_0_cache& fused_level_0, int d0, int d1) {
  // Dynamic address computation
	...
	auto bright_laplace_diff_0_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value = bright_laplace_diff_0_fused_level_0_update_0_read_bundle_read(bright_laplace_diff_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_laplace_diff_0
	auto dark_laplace_diff_0_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value = dark_laplace_diff_0_fused_level_0_update_0_read_bundle_read(dark_laplace_diff_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: bright_weights_normed
	auto bright_weights_normed_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value = bright_weights_normed_fused_level_0_update_0_read_bundle_read(bright_weights_normed/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: dark_weights_normed
	auto dark_weights_normed_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value = dark_weights_normed_fused_level_0_update_0_read_bundle_read(dark_weights_normed/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = psef_weighted_merge_unrolled_1(bright_laplace_diff_0_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value, dark_laplace_diff_0_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value, bright_weights_normed_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value, dark_weights_normed_1_m_fused_level_0_1__p__0_c__1_m_fused_level_0_0__p__0_value);
...
inline void final_merged_2_update_0(fused_level_3_cache& fused_level_3, fused_level_2_cache& fused_level_2, final_merged_2_cache& final_merged_2, int d0, int d1) {
  // Dynamic address computation
	...
	auto fused_level_3_floor_lp__lp_1_m_final_merged_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_2_0_rp__div_2_rp___p__0_value = fused_level_3_final_merged_2_update_0_read_bundle_read(fused_level_3/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: fused_level_2
	auto fused_level_2_1_m_final_merged_2_1__p__0_c__1_m_final_merged_2_0__p__0_value = fused_level_2_final_merged_2_update_0_read_bundle_read(fused_level_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = add_unrolled_1(fused_level_3_floor_lp__lp_1_m_final_merged_2_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_2_0_rp__div_2_rp___p__0_value, fused_level_2_1_m_final_merged_2_1__p__0_c__1_m_final_merged_2_0__p__0_value);
...
inline void final_merged_1_update_0(final_merged_2_cache& final_merged_2, fused_level_1_cache& fused_level_1, final_merged_1_cache& final_merged_1, int d0, int d1) {
  // Dynamic address computation
	...
	auto final_merged_2_floor_lp__lp_1_m_final_merged_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_1_0_rp__div_2_rp___p__0_value = final_merged_2_final_merged_1_update_0_read_bundle_read(final_merged_2/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: fused_level_1
	auto fused_level_1_1_m_final_merged_1_1__p__0_c__1_m_final_merged_1_0__p__0_value = fused_level_1_final_merged_1_update_0_read_bundle_read(fused_level_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = add_unrolled_1(final_merged_2_floor_lp__lp_1_m_final_merged_1_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_1_0_rp__div_2_rp___p__0_value, fused_level_1_1_m_final_merged_1_1__p__0_c__1_m_final_merged_1_0__p__0_value);
...
inline void final_merged_0_update_0(final_merged_1_cache& final_merged_1, fused_level_0_cache& fused_level_0, final_merged_0_cache& final_merged_0, int d0, int d1) {
  // Dynamic address computation
	...
	auto final_merged_1_floor_lp__lp_1_m_final_merged_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_0_0_rp__div_2_rp___p__0_value = final_merged_1_final_merged_0_update_0_read_bundle_read(final_merged_1/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	// Consume: fused_level_0
	auto fused_level_0_1_m_final_merged_0_1__p__0_c__1_m_final_merged_0_0__p__0_value = fused_level_0_final_merged_0_update_0_read_bundle_read(fused_level_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = add_unrolled_1(final_merged_1_floor_lp__lp_1_m_final_merged_0_1_rp__div_2_rp___p__0_c__floor_lp__lp_1_m_final_merged_0_0_rp__div_2_rp___p__0_value, fused_level_0_1_m_final_merged_0_1__p__0_c__1_m_final_merged_0_0__p__0_value);
...
inline void sefss_1_update_0(final_merged_0_cache& final_merged_0, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */sefss_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: final_merged_0
	auto final_merged_0_1_m_sefss_1_1__p__0_c__1_m_sefss_1_0__p__0_value = final_merged_0_sefss_1_update_0_read_bundle_read(final_merged_0/* source_delay */, d0, d1, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = id_unrolled_1(final_merged_0_1_m_sefss_1_1__p__0_c__1_m_sefss_1_0__p__0_value);
	// Produce: sefss_1
	sefss_1.write(compute_result);
...
// Driver function
void sefss_1_opt(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sefss_1) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("sefss_1_opt_debug.csv");
...
// schedule: { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; dark_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 35] : 0 <= d0 <= 539 and 0 <= d1 <= 539; dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539; bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538; bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539; in_update_0[d0, d1] -> [d1, d0, 1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; dark_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 26] : 0 <= d0 <= 134 and 0 <= d1 <= 134; dark_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 33] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268; bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268; bright_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 43] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538; bright_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 38] : 0 <= d0 <= 269 and 0 <= d1 <= 269; bright_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 40] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; dark_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 36] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; bright_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 39] : 0 <= d0 <= 539 and 0 <= d1 <= 539; bright_weights_update_0[d0, d1] -> [d1, d0, 5] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269; dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078; dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078; dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268; final_merged_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 48] : 0 <= d0 <= 269 and 0 <= d1 <= 269; dark_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 32] : 0 <= d0 <= 539 and 0 <= d1 <= 539; final_merged_1_update_0[d0, d1] -> [7 + 2d1, 7 + 2d0, 49] : 0 <= d0 <= 539 and 0 <= d1 <= 539; dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268; bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269; dark_weights_update_0[d0, d1] -> [d1, d0, 4] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538; dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 30] : 0 <= d0 <= 134 and 0 <= d1 <= 134; bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539; bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538; bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078; dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078; bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; bright_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 41] : 0 <= d0 <= 269 and 0 <= d1 <= 269; bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 37] : 0 <= d0 <= 134 and 0 <= d1 <= 134; fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134; dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269; final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 50] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; bright_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 42] : 0 <= d0 <= 539 and 0 <= d1 <= 539; bright_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 29] : 0 <= d0 <= 134 and 0 <= d1 <= 134; dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539; sefss_1_update_0[d0, d1] -> [7 + d1, 7 + d0, 51] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079; fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269; bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079; dark_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 34] : 0 <= d0 <= 269 and 0 <= d1 <= 269; fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539; bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269; dark_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 31] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
//   { dark_weights_normed_update_0[d0, d1] -> [d1, d0, 6] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for dark_weights_normed_update_0(((((-6 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 35] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for dark_laplace_diff_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-35 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 16] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
// Condition for dark_weights_normed_gauss_ds_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-16 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 15] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
// Condition for bright_gauss_blur_2_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-15 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 20] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
// Condition for bright_weights_normed_gauss_ds_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-20 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for in_update_0(((((-1 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 26] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
// Condition for dark_gauss_ds_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-26 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 33] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_us_0_update_0(((((-33 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { fused_level_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 47] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for fused_level_0_update_0(((((-47 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { bright_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 23] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
// Condition for bright_gauss_blur_3_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-23 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 28] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
// Condition for bright_weights_normed_gauss_blur_3_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-28 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 43] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_diff_0_update_0(((((-43 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { dark_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 12] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
// Condition for dark_gauss_blur_2_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-12 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 38] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for bright_laplace_us_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-38 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))
//   { bright_laplace_us_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 40] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for bright_laplace_us_0_update_0(((((-40 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { dark_laplace_diff_0_update_0[d0, d1] -> [1 + d1, 1 + d0, 36] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for dark_laplace_diff_0_update_0(((((-36 + 1*i2)) == 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0) && (((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0)))
//   { bright_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 39] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for bright_laplace_us_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-39 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0)))
//   { bright_weights_update_0[d0, d1] -> [d1, d0, 5] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for bright_weights_update_0(((((-5 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 18] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
// Condition for dark_gauss_ds_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-18 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 10] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
// Condition for dark_weights_normed_gauss_blur_1_update_0(((((-10 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 7] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
// Condition for dark_gauss_blur_1_update_0(((((-7 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 25] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
// Condition for dark_weights_normed_gauss_blur_3_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-25 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { final_merged_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 48] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for final_merged_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-48 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))
//   { dark_laplace_us_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 32] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for dark_laplace_us_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-32 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0)))
//   { final_merged_1_update_0[d0, d1] -> [7 + 2d1, 7 + 2d0, 49] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for final_merged_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-49 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1085 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1085 + -1*i0)) >= 0)))
//   { dark_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 19] : 0 <= d0 <= 268 and 0 <= d1 <= 268 }
// Condition for dark_gauss_blur_3_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-19 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 27] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
// Condition for bright_weights_normed_gauss_ds_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-27 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_update_0[d0, d1] -> [d1, d0, 4] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for dark_weights_update_0(((((-4 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 17] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
// Condition for dark_weights_normed_gauss_blur_2_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-17 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 30] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
// Condition for dark_weights_normed_gauss_ds_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-30 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 14] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
// Condition for bright_gauss_ds_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-14 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 21] : -2 <= d0 <= 538 and -2 <= d1 <= 538 }
// Condition for bright_weights_normed_gauss_blur_2_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-21 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 13] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
// Condition for bright_weights_normed_gauss_blur_1_update_0(((((-13 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_update_0[d0, d1] -> [d1, d0, 2] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for dark_update_0(((((-2 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 9] : -6 <= d0 <= 1078 and -6 <= d1 <= 1078 }
// Condition for bright_gauss_blur_1_update_0(((((-9 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_weights_normed_update_0[d0, d1] -> [d1, d0, 8] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for bright_weights_normed_update_0(((((-8 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { bright_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 41] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for bright_laplace_diff_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-41 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))
//   { bright_weights_normed_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 37] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
// Condition for bright_weights_normed_gauss_ds_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-37 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { fused_level_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 44] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
// Condition for fused_level_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-44 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_weights_normed_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 24] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
// Condition for dark_weights_normed_gauss_ds_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-24 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { final_merged_0_update_0[d0, d1] -> [7 + d1, 7 + d0, 50] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for final_merged_0_update_0(((((-50 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1086 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1086 + -1*i0)) >= 0)))
//   { bright_laplace_diff_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 42] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for bright_laplace_diff_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-42 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0)))
//   { bright_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 29] : 0 <= d0 <= 134 and 0 <= d1 <= 134 }
// Condition for bright_gauss_ds_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-29 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 11] : -3 <= d0 <= 539 and -3 <= d1 <= 539 }
// Condition for dark_gauss_ds_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-11 + 1*i2)) == 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { sefss_1_update_0[d0, d1] -> [7 + d1, 7 + d0, 51] : 0 <= d0 <= 1079 and 0 <= d1 <= 1079 }
// Condition for sefss_1_update_0(((((-51 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1086 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1086 + -1*i0)) >= 0)))
//   { fused_level_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 45] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for fused_level_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-45 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))
//   { bright_update_0[d0, d1] -> [d1, d0, 3] : -7 <= d0 <= 1079 and -7 <= d1 <= 1079 }
// Condition for bright_update_0(((((-3 + 1*i2)) == 0) && (((7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_laplace_diff_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 34] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for dark_laplace_diff_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-34 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))
//   { fused_level_1_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 46] : 0 <= d0 <= 539 and 0 <= d1 <= 539 }
// Condition for fused_level_1_update_0(((((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-46 + 1*i2)) == 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0)))
//   { bright_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 22] : -1 <= d0 <= 269 and -1 <= d1 <= 269 }
// Condition for bright_gauss_ds_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-22 + 1*i2)) == 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
//   { dark_laplace_us_2_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 31] : 0 <= d0 <= 269 and 0 <= d1 <= 269 }
// Condition for dark_laplace_us_2_update_0(((((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-31 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1083 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1083 + -1*i0)) >= 0)))

	// time range: { [i0, i1, i2] : -7 <= i0 <= 1086 and i1 <= 1086 and ((i0 >= 7 and i2 <= 51 and 2*floor((1 + i0)/2) >= 50 + i0 - i2 and floor((1 + i1)/2) >= 4 and 2*floor((1 + i1)/2) >= 50 + i1 - i2) or (i0 <= 1079 and -7 <= i1 <= 1079 and 0 < i2 <= 6) or (-5 <= i0 <= 1079 and -5 <= i1 <= 1079 and i2 >= 13 and 2*floor((1 + i0)/2) >= -13 + i0 + i2 and 2*floor((1 + i1)/2) >= -13 + i1 + i2) or (-5 <= i0 <= 1079 and -5 <= i1 <= 1079 and i2 >= 9 and 2*floor((1 + i0)/2) >= -10 + i0 + i2 and 2*floor((1 + i1)/2) >= -10 + i1 + i2) or ((1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 and 29 <= i2 <= 30)); [i0, i1, 15] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 12] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 8] : -7 <= i0 <= 1079 and -7 <= i1 <= 1079; [i0, i1, 7] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079; [i0, i1, 48] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 47] : 0 < i0 <= 1080 and 0 < i1 <= 1080; [i0, i1, 46] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081; [i0, i1, 45] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 44] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 43] : 0 < i0 <= 1080 and 0 < i1 <= 1080; [i0, i1, 42] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081; [i0, i1, 41] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 40] : 0 < i0 <= 1080 and 0 < i1 <= 1080; [i0, i1, 39] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081; [i0, i1, 38] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 37] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 36] : 0 < i0 <= 1080 and 0 < i1 <= 1080; [i0, i1, 35] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081; [i0, i1, 34] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 33] : 0 < i0 <= 1080 and 0 < i1 <= 1080; [i0, i1, 32] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081; [i0, i1, 31] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1083 and 7 <= i1 <= 1083; [i0, i1, 28] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 27] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 26] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 25] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 24] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 23] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 22] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 21] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 20] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079; [i0, i1, 19] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079; [i0, i1, 18] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 17] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079; [i0, i1, 16] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	// # sets: 1
	for (int i0 = -7; i0 <= 1086; i0++) {
	  for (int i1 = -7; i1 <= 1086; i1++) {
	#pragma HLS pipeline II=1
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        in_update_0(in_off_chip /* buf name */, in, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_update_0(in /* buf name */, dark, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_update_0(in /* buf name */, bright, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_update_0(dark /* buf name */, dark_weights, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_update_0(bright /* buf name */, bright_weights, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_update_0(dark_weights /* buf name */, dark_weights_normed, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : 5 + i0 >= 0 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 5 + i1 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_gauss_blur_1_update_0(dark /* buf name */, dark_gauss_blur_1, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	      // { [i0, i1] : i0 <= 1079 and i1 <= 1079 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((1079 + -1*i0)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_update_0(bright_weights /* buf name */, bright_weights_normed, ((1*i1)), ((1*i0)));
	      }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : 5 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_gauss_blur_1_update_0(bright /* buf name */, bright_gauss_blur_1, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : 5 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_blur_1_update_0(dark_weights_normed /* buf name */, dark_weights_normed_gauss_blur_1, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        // { [i0, i1] : -1 - i0 + 2*floor((1 + i0)/2) = 0 }
	        // { [i0, i1] : 5 + i0 >= 0 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 5 + i1 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_gauss_ds_1_update_0(dark_gauss_blur_1 /* buf name */, dark_gauss_ds_1, ((-1 + (1*(((1 + 1*i1)) >> 1)))), ((-1 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        // { [i0, i1] : -1 - i0 + 2*floor((1 + i0)/2) = 0 }
	        // { [i0, i1] : 1 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1 + i1 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_gauss_blur_2_update_0(dark_gauss_ds_1 /* buf name */, dark_gauss_blur_2, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : 5 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_blur_1_update_0(bright_weights_normed /* buf name */, bright_weights_normed_gauss_blur_1, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_gauss_ds_1_update_0(bright_gauss_blur_1 /* buf name */, bright_gauss_ds_1, ((-1 + (1*(((1 + 1*i1)) >> 1)))), ((-1 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_gauss_blur_2_update_0(bright_gauss_ds_1 /* buf name */, bright_gauss_blur_2, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_ds_1_update_0(dark_weights_normed_gauss_blur_1 /* buf name */, dark_weights_normed_gauss_ds_1, ((-1 + (1*(((1 + 1*i1)) >> 1)))), ((-1 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_blur_2_update_0(dark_weights_normed_gauss_ds_1 /* buf name */, dark_weights_normed_gauss_blur_2, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        // { [i0, i1] : -1 - i0 + 4*floor((1 + i0)/4) = 0 }
	        // { [i0, i1] : 1 + i0 >= 0 }
	        // { [i0, i1] : 1079 - i0 >= 0 }
	        // { [i0, i1] : 1 + i1 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_gauss_ds_2_update_0(dark_gauss_blur_2 /* buf name */, dark_gauss_ds_2, ((-1 + (1*(((1 + 1*i1)) >> 2)))), ((-1 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        // { [i0, i1] : -1 - i0 + 4*floor((1 + i0)/4) = 0 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_gauss_blur_3_update_0(dark_gauss_ds_2 /* buf name */, dark_gauss_blur_3, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -5 <= i0 <= 1079 and -5 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((5 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((5 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_ds_1_update_0(bright_weights_normed_gauss_blur_1 /* buf name */, bright_weights_normed_gauss_ds_1, ((-1 + (1*(((1 + 1*i1)) >> 1)))), ((-1 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_blur_2_update_0(bright_weights_normed_gauss_ds_1 /* buf name */, bright_weights_normed_gauss_blur_2, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_gauss_ds_2_update_0(bright_gauss_blur_2 /* buf name */, bright_gauss_ds_2, ((-1 + (1*(((1 + 1*i1)) >> 2)))), ((-1 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_gauss_blur_3_update_0(bright_gauss_ds_2 /* buf name */, bright_gauss_blur_3, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_ds_2_update_0(dark_weights_normed_gauss_blur_2 /* buf name */, dark_weights_normed_gauss_ds_2, ((-1 + (1*(((1 + 1*i1)) >> 2)))), ((-1 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_blur_3_update_0(dark_weights_normed_gauss_ds_2 /* buf name */, dark_weights_normed_gauss_blur_3, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 8*floor((1 + i1)/8) = 0 }
	        // { [i0, i1] : -1 - i0 + 8*floor((1 + i0)/8) = 0 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        dark_gauss_ds_3_update_0(dark_gauss_blur_3 /* buf name */, dark_gauss_ds_3, ((-1 + (1*(((1 + 1*i1)) >> 3)))), ((-1 + (1*(((1 + 1*i0)) >> 3)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and -1 <= i0 <= 1079 and -1 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((1 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((1 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_ds_2_update_0(bright_weights_normed_gauss_blur_2 /* buf name */, bright_weights_normed_gauss_ds_2, ((-1 + (1*(((1 + 1*i1)) >> 2)))), ((-1 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and 7 <= i0 <= 1079 and 7 <= i1 <= 1079 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : 1079 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0) && (((-7 + 1*i1)) >= 0) && (((1079 + -1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_blur_3_update_0(bright_weights_normed_gauss_ds_2 /* buf name */, bright_weights_normed_gauss_blur_3, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 8*floor((1 + i1)/8) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        bright_gauss_ds_3_update_0(bright_gauss_blur_3 /* buf name */, bright_gauss_ds_3, ((-1 + (1*(((1 + 1*i1)) >> 3)))), ((-1 + (1*(((1 + 1*i0)) >> 3)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 8*floor((1 + i1)/8) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        dark_weights_normed_gauss_ds_3_update_0(dark_weights_normed_gauss_blur_3 /* buf name */, dark_weights_normed_gauss_ds_3, ((-1 + (1*(((1 + 1*i1)) >> 3)))), ((-1 + (1*(((1 + 1*i0)) >> 3)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        // { [i0, i1] : -1 - i0 + 4*floor((1 + i0)/4) = 0 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        dark_laplace_us_2_update_0(dark_gauss_ds_3 /* buf name */, dark_laplace_us_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        // { [i0, i1] : -1 - i0 + 2*floor((1 + i0)/2) = 0 }
	        // { [i0, i1] : -3 + i0 >= 0 }
	        ...
	        // { [i0, i1] : -3 + i1 >= 0 }
	        // { [i0, i1] : 1081 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0)))) {
	        dark_laplace_us_1_update_0(dark_gauss_ds_2 /* buf name */, dark_laplace_us_1, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        // { [i0, i1] : 1080 - i0 >= 0 }
	        // { [i0, i1] : -1 + i1 >= 0 }
	        // { [i0, i1] : 1080 - i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0)))) {
	        dark_laplace_us_0_update_0(dark_gauss_ds_1 /* buf name */, dark_laplace_us_0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        dark_laplace_diff_2_update_0(dark_gauss_ds_2 /* buf name */, dark_laplace_us_2 /* buf name */, dark_laplace_diff_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1081 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0)))) {
	        dark_laplace_diff_1_update_0(dark_gauss_ds_1 /* buf name */, dark_laplace_us_1 /* buf name */, dark_laplace_diff_1, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1080 - i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0)))) {
	        dark_laplace_diff_0_update_0(dark /* buf name */, dark_laplace_us_0 /* buf name */, dark_laplace_diff_0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 8*floor((1 + i1)/8) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        bright_weights_normed_gauss_ds_3_update_0(bright_weights_normed_gauss_blur_3 /* buf name */, bright_weights_normed_gauss_ds_3, ((-1 + (1*(((1 + 1*i1)) >> 3)))), ((-1 + (1*(((1 + 1*i0)) >> 3)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        bright_laplace_us_2_update_0(bright_gauss_ds_3 /* buf name */, bright_laplace_us_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1081 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0)))) {
	        bright_laplace_us_1_update_0(bright_gauss_ds_2 /* buf name */, bright_laplace_us_1, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1080 - i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0)))) {
	        bright_laplace_us_0_update_0(bright_gauss_ds_1 /* buf name */, bright_laplace_us_0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        bright_laplace_diff_2_update_0(bright_gauss_ds_2 /* buf name */, bright_laplace_us_2 /* buf name */, bright_laplace_diff_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1081 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0)))) {
	        bright_laplace_diff_1_update_0(bright_gauss_ds_1 /* buf name */, bright_laplace_us_1 /* buf name */, bright_laplace_diff_1, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1080 - i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0)))) {
	        bright_laplace_diff_0_update_0(bright /* buf name */, bright_laplace_us_0 /* buf name */, bright_laplace_diff_0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 8 = 0 and (1 + i1) mod 8 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 8*floor((1 + i1)/8) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        fused_level_3_update_0(bright_gauss_ds_3 /* buf name */, dark_gauss_ds_3 /* buf name */, bright_weights_normed_gauss_ds_3 /* buf name */, dark_weights_normed_gauss_ds_3 /* buf name */, fused_level_3, ((-1 + (1*(((1 + 1*i1)) >> 3)))), ((-1 + (1*(((1 + 1*i0)) >> 3)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        fused_level_2_update_0(bright_laplace_diff_2 /* buf name */, dark_laplace_diff_2 /* buf name */, bright_weights_normed_gauss_ds_2 /* buf name */, dark_weights_normed_gauss_ds_2 /* buf name */, fused_level_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and 3 <= i0 <= 1081 and 3 <= i1 <= 1081 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        ...
	        // { [i0, i1] : 1081 - i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-3 + 1*i0)) >= 0) && (((1081 + -1*i0)) >= 0) && (((-3 + 1*i1)) >= 0) && (((1081 + -1*i1)) >= 0)))) {
	        fused_level_1_update_0(bright_laplace_diff_1 /* buf name */, dark_laplace_diff_1 /* buf name */, bright_weights_normed_gauss_ds_1 /* buf name */, dark_weights_normed_gauss_ds_1 /* buf name */, fused_level_1, ((-2 + (1*(((1 + 1*i1)) >> 1)))), ((-2 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	      // { [i0, i1] : 0 < i0 <= 1080 and 0 < i1 <= 1080 }
	        // { [i0, i1] : -1 + i0 >= 0 }
	        ...
	        // { [i0, i1] : 1080 - i1 >= 0 }
	      if ((((((-1 + 1*i0)) >= 0) && (((1080 + -1*i0)) >= 0) && (((-1 + 1*i1)) >= 0) && (((1080 + -1*i1)) >= 0)))) {
	        fused_level_0_update_0(bright_laplace_diff_0 /* buf name */, dark_laplace_diff_0 /* buf name */, bright_weights_normed /* buf name */, dark_weights_normed /* buf name */, fused_level_0, ((-1 + 1*i1)), ((-1 + 1*i0)));
	      }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 4 = 0 and (1 + i1) mod 4 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 4*floor((1 + i1)/4) = 0 }
	        ...
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (4*(((1 + 1*i1)) >> 2)))) == 0) && (((-1 + -1*i0 + (4*(((1 + 1*i0)) >> 2)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        final_merged_2_update_0(fused_level_3 /* buf name */, fused_level_2 /* buf name */, final_merged_2, ((-2 + (1*(((1 + 1*i1)) >> 2)))), ((-2 + (1*(((1 + 1*i0)) >> 2)))));
	      }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : (1 + i0) mod 2 = 0 and (1 + i1) mod 2 = 0 and i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -1 - i1 + 2*floor((1 + i1)/2) = 0 }
	        // { [i0, i1] : -1 - i0 + 2*floor((1 + i0)/2) = 0 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-1 + -1*i1 + (2*(((1 + 1*i1)) >> 1)))) == 0) && (((-1 + -1*i0 + (2*(((1 + 1*i0)) >> 1)))) == 0) && (((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        final_merged_1_update_0(final_merged_2 /* buf name */, fused_level_1 /* buf name */, final_merged_1, ((-4 + (1*(((1 + 1*i1)) >> 1)))), ((-4 + (1*(((1 + 1*i0)) >> 1)))));
	      }
	      // { [i0, i1] : i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        final_merged_0_update_0(final_merged_1 /* buf name */, fused_level_0 /* buf name */, final_merged_0, ((-7 + 1*i1)), ((-7 + 1*i0)));
	      }
	      // { [i0, i1] : i0 >= 7 and i1 >= 7 }
	      // { [i0, i1] : i0 >= 7 and i1 >= 7 }
	        // { [i0, i1] : -7 + i0 >= 0 }
	        // { [i0, i1] : -7 + i1 >= 0 }
	      if ((((((-7 + 1*i0)) >= 0) && (((-7 + 1*i1)) >= 0)))) {
	        sefss_1_update_0(final_merged_0 /* buf name */, sefss_1, ((-7 + 1*i1)), ((-7 + 1*i0)));
	      }
	    }
	  }
...
void sefss_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */sefss_1, const int num_epochs) {
...
#ifdef __VIVADO_SYNTH__
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[in_1, in_0] : -7 <= in_0 <= 1079 and -7 <= in_1 <= 1079 }
const int in_update_0_read_pipe0_num_transfers = 1181569;
  // { sefss_1_update_0[root = 0, sefss_1_0, sefss_1_1] -> sefss_1[sefss_1_1, sefss_1_0] : 0 <= sefss_1_0 <= 1079 and 0 <= sefss_1_1 <= 1079 }
const int sefss_1_update_0_write_pipe0_num_transfers = 1166400;


extern "C" {

void sefss_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* sefss_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = sefss_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = sefss_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > sefss_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  sefss_1_opt_wrapper(in_update_0_read_pipe0_channel, sefss_1_update_0_write_pipe0_channel, size);

  burst_write<16>(sefss_1_update_0_write_pipe0, sefss_1_update_0_write_pipe0_channel, sefss_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void sefss_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  sefss_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = sefss_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  sefss_1_opt(in_update_0_read_pipe0, sefss_1_update_0_write_pipe0);
