...
int main(int argc, char **argv) {
  ...
  two_in_blnd(pw_math_in0_oc02_merged428_read_channel, pw_math_in1_oc46_merged431_read_channel, pw_math_merged_0_reconstruct_lp138_buf141147149_merged452_write_channel);
  ...
  output.save_image("./images/two_in_blnd_bmp_out.bmp");
}
