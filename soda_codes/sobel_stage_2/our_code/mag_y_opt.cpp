...
void mag_y_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */off_chip_img, HWStream<hw_uint<32> >& /* get_args num ports = 1 */mag_y) {
  ...
  mag_y_opt(off_chip_img, mag_y, 1);
}
#ifdef __VIVADO_SYNTH__
...
void mag_y_opt_accel(hw_uint<32>* img_update_0_read, hw_uint<32>* mag_y_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = mag_y_update_0_write offset = slave depth = 65536 bundle = gmem1
