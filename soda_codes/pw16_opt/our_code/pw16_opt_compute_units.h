...
hw_uint<16> pw16_generated_compute(hw_uint<16*1> input) {
...
hw_uint<16>  input_generated_compute_unrolled_1(hw_uint<16>& input_arg) {
  ...
  // pw16_update_0 unroll factor: 1
hw_uint<16>  pw16_generated_compute_unrolled_1(hw_uint<16>& input) {
  hw_uint<16> whole_result;

  hw_uint<16> lane_0_input;
  set_at<0, 16, 16>(lane_0_input, input.extract<0, 15>());
  auto result_0 = pw16_generated_compute(lane_0_input);
  set_at<0, 16, 16>(whole_result, result_0);
  return whole_result;
}
