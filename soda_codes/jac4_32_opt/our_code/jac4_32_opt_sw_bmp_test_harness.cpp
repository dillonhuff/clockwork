...
int main(int argc, char **argv) {
  ...
  HWStream<hw_uint<512> > jac4_32_1_merged1155_write_channel;
  // In lanes = 32
  ...
  jac4_32_opt(in_1_merged1107_read_channel, jac4_32_1_merged1155_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 32; cl++) {
      auto packed_val = jac4_32_1_merged1155_write_channel.read();
  ...
  output.save_image("./images/jac4_32_opt_bmp_out.bmp");
}
