...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_7_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  // Read schedule : { hcompute_hw_output_stencil[d0 = 0, d1] -> [0, d1, 3] : 0 <= d1 <= 61 }
  // Write schedule: { hcompute_conv_stencil_1[d0 = 0, d1] -> [0, d1, 2] : 0 <= d1 <= 61 }
...
inline void conv_stencil_init_hcompute_conv_stencil_2_write(hw_uint<16>& conv_stencil_init_hcompute_conv_stencil_2, conv_stencil_init_cache& conv_stencil_init, int root, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil_init.conv_stencil_init_hcompute_conv_stencil_2_to_conv_stencil_init_hcompute_conv_stencil_1_4.push(conv_stencil_init_hcompute_conv_stencil_2);
}
...
inline hw_uint<16> conv_stencil_init_hcompute_conv_stencil_1_4_select(conv_stencil_init_cache& conv_stencil_init, int root, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  // Read schedule : { hcompute_conv_stencil_1[d0 = 0, d1] -> [0, d1, 2] : 0 <= d1 <= 61 }
  // Write schedule: { hcompute_conv_stencil[d0 = 0, d1] -> [0, d1, 1] : 0 <= d1 <= 61 }
  auto value_conv_stencil_init_hcompute_conv_stencil_2 = conv_stencil_init.conv_stencil_init_hcompute_conv_stencil_2_to_conv_stencil_init_hcompute_conv_stencil_1_4.peek(/* one reader or all rams */ 0);
...
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_5_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  // Read schedule : { hcompute_conv_stencil_1[d0 = 0, d1] -> [0, d1, 2] : 0 <= d1 <= 61 }
  // Write schedule: { hcompute_hw_input_copy_stencil[d0 = 0, d1] -> [0, d1, 0] : 0 <= d1 <= 63 }
...
// Driver function
void mini_conv_halide_fixed(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_input_stencil, HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_output_stencil) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("mini_conv_halide_fixed_debug.csv");
...
// schedule: { hcompute_conv_stencil[d0 = 0, d1] -> [0, d1, 1] : 0 <= d1 <= 61; hcompute_conv_stencil_1[d0 = 0, d1] -> [0, d1, 2] : 0 <= d1 <= 61; hcompute_hw_output_stencil[d0 = 0, d1] -> [0, d1, 3] : 0 <= d1 <= 61; hcompute_hw_input_copy_stencil[d0 = 0, d1] -> [0, d1, 0] : 0 <= d1 <= 63 }
//   { hcompute_conv_stencil[d0 = 0, d1] -> [0, d1, 1] : 0 <= d1 <= 61 }
// Condition for hcompute_conv_stencil(((-1 + i2 == 0) && (i0 == 0) && (i1 >= 0) && (61 - i1 >= 0)))
//   { hcompute_conv_stencil_1[d0 = 0, d1] -> [0, d1, 2] : 0 <= d1 <= 61 }
// Condition for hcompute_conv_stencil_1(((-2 + i2 == 0) && (i0 == 0) && (i1 >= 0) && (61 - i1 >= 0)))
//   { hcompute_hw_output_stencil[d0 = 0, d1] -> [0, d1, 3] : 0 <= d1 <= 61 }
// Condition for hcompute_hw_output_stencil(((-3 + i2 == 0) && (i0 == 0) && (i1 >= 0) && (61 - i1 >= 0)))
//   { hcompute_hw_input_copy_stencil[d0 = 0, d1] -> [0, d1, 0] : 0 <= d1 <= 63 }
// Condition for hcompute_hw_input_copy_stencil(((i2 == 0) && (i0 == 0) && (i1 >= 0) && (63 - i1 >= 0)))

  /*
for (int c1 = 0; c1 <= 63; c1 += 1) {
  hcompute_hw_input_copy_stencil(0, c1);
  if (c1 <= 61) {
    hcompute_conv_stencil(0, c1);
    hcompute_conv_stencil_1(0, c1);
    hcompute_hw_output_stencil(0, c1);
  }
}

  */
	for (int c1 = 0; c1 <= 63; c1 += 1) {
	  hcompute_hw_input_copy_stencil(hw_input_stencil /* buf name */, hw_input_copy_stencil, 0, c1);
	  if (c1 <= 61) {
	    hcompute_conv_stencil(conv_stencil_init, 0, c1);
	    hcompute_conv_stencil_1(conv_stencil_init /* buf name */, hw_input_copy_stencil /* buf name */, conv_stencil, 0, c1);
	    hcompute_hw_output_stencil(conv_stencil /* buf name */, hw_output_stencil, 0, c1);
	  }
	}
...
void mini_conv_halide_fixed_wrapper(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_input_stencil, HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_output_stencil, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    mini_conv_halide_fixed(hw_input_stencil, hw_output_stencil);
  }
}
#ifdef __VIVADO_SYNTH__
...
void mini_conv_halide_fixed_accel(hw_uint<16>* hcompute_hw_input_copy_stencil_read_pipe0, hw_uint<16>* hcompute_hw_output_stencil_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  mini_conv_halide_fixed_wrapper(hcompute_hw_input_copy_stencil_read_pipe0_channel, hcompute_hw_output_stencil_write_pipe0_channel, size);
...
void mini_conv_halide_fixed_rdai(HWStream<hw_uint<16> >& hcompute_hw_input_copy_stencil_read_pipe0, HWStream<hw_uint<16> >&  hcompute_hw_output_stencil_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  mini_conv_halide_fixed(hcompute_hw_input_copy_stencil_read_pipe0, hcompute_hw_output_stencil_write_pipe0);
