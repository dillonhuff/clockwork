// AUTO GEN SODA TB
#include "mini_conv_halide_fixed_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  mini_conv_halide_fixed_kernel(hw_output_stencil, hw_input_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_mini_conv_halide_fixed_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
