...
hw_uint<32> hr_1_generated_compute(hw_uint<32*1> det, hw_uint<32*1> trace) {
...
hw_uint<32>  trace_generated_compute_unrolled_1(hw_uint<32>& lgxx8, hw_uint<32>& lgyy8) {
  ...
  // hr_1_update_0 unroll factor: 1
hw_uint<32>  hr_1_generated_compute_unrolled_1(hw_uint<32>& det, hw_uint<32>& trace) {
  hw_uint<32> whole_result;
  ...
  auto result_0 = hr_1_generated_compute(lane_0_det, lane_0_trace);
  set_at<0, 32, 32>(whole_result, result_0);
  return whole_result;
}
