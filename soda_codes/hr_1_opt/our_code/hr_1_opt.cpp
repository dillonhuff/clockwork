...
#include "hr_1_opt_compute_units.h"
...
inline hw_uint<32>  hr_1_rd0_select(det_cache& det, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hr_1_rd0 read pattern: { hr_1_update_0[d0, d1] -> det[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { hr_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// hr_1_update_0_read
//	hr_1_rd0
inline hw_uint<32> det_hr_1_update_0_read_bundle_read(det_cache& det, int d0, int d1) {
  // # of ports in bundle: 1
    // hr_1_rd0

	hw_uint<32> result;
	hw_uint<32>  hr_1_rd0_res = hr_1_rd0_select(det, d0, d1);
	set_at<0, 32>(result, hr_1_rd0_res);
	return result;
}
...
struct img_img_update_0_write0_merged_banks_12_cache {
	...
	hw_uint<32>  f2;
	hw_uint<32>  f4;
	fifo<hw_uint<32> , 1921> f5;
	hw_uint<32>  f6;
	hw_uint<32>  f7;
	hw_uint<32>  f8;
	fifo<hw_uint<32> , 1921> f9;
	hw_uint<32>  f10;
	hw_uint<32>  f12;
	hw_uint<32>  f14;
	...
	inline hw_uint<32>  peek_3847() {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
		return f9.back();
	}

	inline hw_uint<32>  peek_3848() {
		return f10;
	}

	inline hw_uint<32>  peek_3849() {
		return f12;
	}

	inline hw_uint<32>  peek_3850() {
		return f14;
	}
...
inline hw_uint<32>  hr_1_rd0_select(trace_cache& trace, int d0, int d1) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hr_1_rd0 read pattern: { hr_1_update_0[d0, d1] -> trace[d0, d1] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
  // Read schedule : { hr_1_update_0[d0, d1] -> [2 + d1, 2 + d0, 15] : 0 <= d0 <= 1919 and 0 <= d1 <= 1079 }
...
// hr_1_update_0_read
//	hr_1_rd0
inline hw_uint<32> trace_hr_1_update_0_read_bundle_read(trace_cache& trace, int d0, int d1) {
  // # of ports in bundle: 1
    // hr_1_rd0

	hw_uint<32> result;
	hw_uint<32>  hr_1_rd0_res = hr_1_rd0_select(trace, d0, d1);
	set_at<0, 32>(result, hr_1_rd0_res);
	return result;
}
...
inline void hr_1_update_0(det_cache& det, trace_cache& trace, HWStream<hw_uint<32> >& /* buffer_args num ports = 1 */hr_1, int d0, int d1) {
	// Consume: det
	auto det_0_c__0_value = det_hr_1_update_0_read_bundle_read(det/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "hr_1_update_0_det," << d0<< "," << d1<< "," <<  det_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	// Consume: trace
	auto trace_0_c__0_value = trace_hr_1_update_0_read_bundle_read(trace/* source_delay */, d0, d1);

#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "hr_1_update_0_trace," << d0<< "," << d1<< "," <<  trace_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__

	auto compute_result = hr_1_generated_compute_unrolled_1(det_0_c__0_value, trace_0_c__0_value);
	// Produce: hr_1
	hr_1.write(compute_result);

#ifndef __VIVADO_SYNTH__
  hw_uint<32> debug_compute_result(compute_result);
  hw_uint<32> debug_compute_result_lane_0;
  set_at<0, 32, 32>(debug_compute_result_lane_0, debug_compute_result.extract<0, 31>());
  *global_debug_handle << "hr_1_update_0," << (1*d0 + 0) << ", " << d1<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
...
// Driver function
void hr_1_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */hr_1, int num_epochs) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("hr_1_opt_debug.csv");
...
#pragma HLS inline recursive
  ...
  for (int epoch = 0; epoch < num_epochs; epoch++) {
	  // Schedules...
	    ...
	    // hr_1_update_0 -> [1*d1*1*1 + 1*2,1*d0*1*1 + 1*2,1*15]
	...
	trace_update_0(lgxx8, lgyy8, trace, (c1 - 2) / 1, (c0 - 2) / 1);
	    ...
	    if ((2 <= c1 && c1 <= 1921) && ((c1 - 2) % 1 == 0) && (2 <= c0 && c0 <= 1081) && ((c0 - 2) % 1 == 0)) {
	hr_1_update_0(det, trace, hr_1, (c1 - 2) / 1, (c0 - 2) / 1);
	    }
...
void hr_1_opt(HWStream<hw_uint<32> >& /* get_args num ports = 1 */img_oc, HWStream<hw_uint<32> >& /* get_args num ports = 1 */hr_1) {

  hr_1_opt(img_oc, hr_1, 1);
}
#ifdef __VIVADO_SYNTH__
#include "hr_1_opt.h"

const int hr_1_update_0_write_num_transfers = 2073600;
...
static void write_hr_1_update_0_write(hw_uint<32>* output, HWStream<hw_uint<32> >& v, const int size) {
  hw_uint<32> burst_reg;
  int num_transfers = hr_1_update_0_write_num_transfers*size;
  for (int i = 0; i < num_transfers; i++) {
    #pragma HLS pipeline II=1
    burst_reg = v.read();
    output[i] = burst_reg;
...
void hr_1_opt_accel(hw_uint<32>* img_update_0_read, hw_uint<32>* hr_1_update_0_write, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = img_update_0_read offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = hr_1_update_0_write offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = img_update_0_read bundle = control
#pragma HLS INTERFACE s_axilite port = hr_1_update_0_write bundle = control
#pragma HLS INTERFACE s_axilite port = size bundle = control
#pragma HLS INTERFACE s_axilite port = return bundle = control

  static HWStream<hw_uint<32> > img_update_0_read_channel;
  static HWStream<hw_uint<32> > hr_1_update_0_write_channel;

  read_img_update_0_read(img_update_0_read, img_update_0_read_channel, size);

  hr_1_opt(img_update_0_read_channel, hr_1_update_0_write_channel, size);

  write_hr_1_update_0_write(hr_1_update_0_write, hr_1_update_0_write_channel, size);
}
