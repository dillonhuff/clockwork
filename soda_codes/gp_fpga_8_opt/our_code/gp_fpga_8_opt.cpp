...
// compute file: gp_fpga_8_opt_compute_units.h
#include "gp_fpga_8_opt_compute_units.h"

#include "hw_classes.h"

struct in_in_update_0_write0_merged_banks_9_cache {
	// RAM Box: {[0, 1936], [0, 1086]}
	// Capacity: 488
	// # of read delays: 6
  // 0, 1, 243, 244, 486, 487
	hw_uint<16> f0;
...
inline hw_uint<16> in_gauss_blur_1_rd0_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd1_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_9.peek_244();
  return value_in_in_update_0_write0;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd10_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_9.peek_244();
...
inline hw_uint<16> in_gauss_blur_1_rd12_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd13_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write2 = in.in_in_update_0_write2_merged_banks_9.peek_244();
  return value_in_in_update_0_write2;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd16_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write3 = in.in_in_update_0_write3_merged_banks_9.peek_244();
  return value_in_in_update_0_write3;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd24_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd25_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write4 = in.in_in_update_0_write4_merged_banks_9.peek_244();
  return value_in_in_update_0_write4;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd3_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_9.peek_487();
  return value_in_in_update_0_write1;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd33_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write5 = in.in_in_update_0_write5_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd34_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write5 = in.in_in_update_0_write5_merged_banks_9.peek_244();
  return value_in_in_update_0_write5;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd42_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd43_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write6 = in.in_in_update_0_write6_merged_banks_9.peek_244();
  return value_in_in_update_0_write6;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd51_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write7 = in.in_in_update_0_write7_merged_banks_9.peek_487();
...
inline hw_uint<16> in_gauss_blur_1_rd52_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write7 = in.in_in_update_0_write7_merged_banks_9.peek_244();
  return value_in_in_update_0_write7;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd61_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write0 = in.in_in_update_0_write0_merged_banks_9.peek_243();
  return value_in_in_update_0_write0;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_1_rd70_select(in_cache& in, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
  // Write schedule: { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
  auto value_in_in_update_0_write1 = in.in_in_update_0_write1_merged_banks_9.peek_243();
  return value_in_in_update_0_write1;
  return 0;
}
...
inline hw_uint<16> in_gauss_ds_1_rd0_select(in_gauss_blur_1_cache& in_gauss_blur_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  // Write schedule: { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
...
inline hw_uint<16> in_gauss_ds_2_rd0_select(in_gauss_blur_2_cache& in_gauss_blur_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
  // Write schedule: { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
...
inline hw_uint<16> in_gauss_ds_3_rd0_select(in_gauss_blur_3_cache& in_gauss_blur_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
...
inline hw_uint<16> in_gauss_blur_2_rd0_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write0 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write0_merged_banks_9.peek_485();
...
inline hw_uint<16> in_gauss_blur_2_rd1_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write0 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write0_merged_banks_9.peek_243();
  return value_in_gauss_ds_1_in_gauss_ds_1_update_0_write0;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_2_rd10_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write1 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write1_merged_banks_9.peek_243();
...
inline hw_uint<16> in_gauss_blur_2_rd12_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write2 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write2_merged_banks_9.peek_485();
...
inline hw_uint<16> in_gauss_blur_2_rd13_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write2 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write2_merged_banks_9.peek_243();
  return value_in_gauss_ds_1_in_gauss_ds_1_update_0_write2;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_2_rd15_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write3 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write3_merged_banks_9.peek_485();
...
inline hw_uint<16> in_gauss_blur_2_rd16_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write3 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write3_merged_banks_9.peek_243();
  return value_in_gauss_ds_1_in_gauss_ds_1_update_0_write3;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_2_rd25_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write0 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write0_merged_banks_9.peek_242();
  return value_in_gauss_ds_1_in_gauss_ds_1_update_0_write0;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_2_rd34_select(in_gauss_ds_1_cache& in_gauss_ds_1, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
  // Write schedule: { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
  auto value_in_gauss_ds_1_in_gauss_ds_1_update_0_write1 = in_gauss_ds_1.in_gauss_ds_1_in_gauss_ds_1_update_0_write1_merged_banks_9.peek_242();
  return value_in_gauss_ds_1_in_gauss_ds_1_update_0_write1;
  return 0;
}
...
struct in_gauss_ds_2_in_gauss_ds_2_update_0_write0_merged_banks_9_cache {
  ...
  // 0, 1, 241, 242, 482, 483
	hw_uint<16> f0;
	hw_uint<16> f2;
	fifo<hw_uint<16>, 239> f3;
	hw_uint<16> f4;
	hw_uint<16> f6;
	fifo<hw_uint<16>, 239> f7;
	hw_uint<16> f8;
	hw_uint<16> f10;
...
inline hw_uint<16> in_gauss_blur_3_rd0_select(in_gauss_ds_2_cache& in_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
  // Write schedule: { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
...
inline hw_uint<16> in_gauss_blur_3_rd13_select(in_gauss_ds_2_cache& in_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
  // Write schedule: { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
  auto value_in_gauss_ds_2_in_gauss_ds_2_update_0_write0 = in_gauss_ds_2.in_gauss_ds_2_in_gauss_ds_2_update_0_write0_merged_banks_9.peek_241();
  return value_in_gauss_ds_2_in_gauss_ds_2_update_0_write0;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_3_rd15_select(in_gauss_ds_2_cache& in_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
  // Write schedule: { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
  auto value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1 = in_gauss_ds_2.in_gauss_ds_2_in_gauss_ds_2_update_0_write1_merged_banks_9.peek_482();
  return value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_3_rd16_select(in_gauss_ds_2_cache& in_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
  // Write schedule: { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
  auto value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1 = in_gauss_ds_2.in_gauss_ds_2_in_gauss_ds_2_update_0_write1_merged_banks_9.peek_241();
  return value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1;
  return 0;
}
...
inline hw_uint<16> in_gauss_blur_3_rd3_select(in_gauss_ds_2_cache& in_gauss_ds_2, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
  // Write schedule: { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
  auto value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1 = in_gauss_ds_2.in_gauss_ds_2_in_gauss_ds_2_update_0_write1_merged_banks_9.peek_483();
  return value_in_gauss_ds_2_in_gauss_ds_2_update_0_write1;
  return 0;
}
...
struct in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_8_rd0_cache {
	// RAM Box: {[0, 239], [0, 134]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct in_gauss_ds_3_cache {
  // # of banks: 1
  in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_8_rd0_cache in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_8_rd0;
};
...
inline void in_gauss_ds_3_in_gauss_ds_3_update_0_write0_write(hw_uint<16>& in_gauss_ds_3_in_gauss_ds_3_update_0_write0, in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
  in_gauss_ds_3.in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_8_rd0.push(in_gauss_ds_3_in_gauss_ds_3_update_0_write0);
}

inline hw_uint<16> gp_fpga_8_rd0_select(in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // gp_fpga_8_rd0 read pattern: { gp_fpga_8_update_0[d0, d1] -> in_gauss_ds_3[d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Read schedule : { gp_fpga_8_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { in_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  auto value_in_gauss_ds_3_in_gauss_ds_3_update_0_write0 = in_gauss_ds_3.in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_8_rd0.peek(/* one reader or all rams */ 0);
  return value_in_gauss_ds_3_in_gauss_ds_3_update_0_write0;
  return 0;
}

// # of bundles = 2
// gp_fpga_8_update_0_read
//	gp_fpga_8_rd0
inline hw_uint<16> in_gauss_ds_3_gp_fpga_8_update_0_read_bundle_read(in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // gp_fpga_8_rd0

	hw_uint<16> result;
	hw_uint<16> gp_fpga_8_rd0_res = gp_fpga_8_rd0_select(in_gauss_ds_3, d0, d1, dynamic_address);
	set_at<0, 16>(result, gp_fpga_8_rd0_res);
	return result;
}
...
// Total re-use buffer capacity: 108832 bits
...
inline void gp_fpga_8_update_0(in_gauss_ds_3_cache& in_gauss_ds_3, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */gp_fpga_8, int d0, int d1) {
  // Dynamic address computation

	// Consume: in_gauss_ds_3
	auto in_gauss_ds_3_0_c__0_value = in_gauss_ds_3_gp_fpga_8_update_0_read_bundle_read(in_gauss_ds_3/* source_delay */, d0, d1, 0);
	...
	// Produce: gp_fpga_8
	gp_fpga_8.write(compute_result);
...
// Driver function
void gp_fpga_8_opt(HWStream<hw_uint<128> >& /* get_args num ports = 8 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp_fpga_8) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("gp_fpga_8_opt_debug.csv");
...
// schedule: { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540; in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268; in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270; in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542; in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084; gp_fpga_8_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134; in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086; in_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
//   { in_gauss_blur_2_update_0[d0, d1] -> [6 + 2d1, 2 + d0, 4] : 0 <= d0 <= 240 and 0 <= d1 <= 540 }
// Condition for in_gauss_blur_2_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-4 + i2 == 0) && (-2 + i1 >= 0) && (242 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_gauss_blur_3_update_0[d0, d1] -> [14 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
// Condition for in_gauss_blur_3_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-6 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_gauss_ds_2_update_0[d0, d1] -> [6 + 4d1, 2 + d0, 5] : 0 <= d0 <= 240 and 0 <= d1 <= 270 }
// Condition for in_gauss_ds_2_update_0(((-2 - i0 + 4*floord(2 + i0, 4) == 0) && (-5 + i2 == 0) && (-2 + i1 >= 0) && (242 - i1 >= 0) && (-6 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_gauss_ds_1_update_0[d0, d1] -> [2 + 2d1, 1 + d0, 3] : 0 <= d0 <= 241 and 0 <= d1 <= 542 }
// Condition for in_gauss_ds_1_update_0(((-i0 + 2*floord(i0, 2) == 0) && (-3 + i2 == 0) && (-1 + i1 >= 0) && (242 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_gauss_blur_1_update_0[d0, d1] -> [2 + d1, 1 + d0, 2] : 0 <= d0 <= 241 and 0 <= d1 <= 1084 }
// Condition for in_gauss_blur_1_update_0(((-2 + i2 == 0) && (-1 + i1 >= 0) && (242 - i1 >= 0) && (-2 + i0 >= 0) && (1086 - i0 >= 0)))
//   { gp_fpga_8_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for gp_fpga_8_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-8 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : 0 <= d0 <= 242 and 0 <= d1 <= 1086 }
// Condition for in_update_0(((-1 + i2 == 0) && (i1 >= 0) && (242 - i1 >= 0) && (i0 >= 0) && (1086 - i0 >= 0)))
//   { in_gauss_ds_3_update_0[d0, d1] -> [14 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for in_gauss_ds_3_update_0(((-2 - i0 + 8*floord(2 + i0, 8) == 0) && (-7 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-14 + i0 >= 0) && (1086 - i0 >= 0)))

  /*
  // Schedules...
    // gp_fpga_8_update_0 -> [1*d1*1*8 + 1*14,1*d0*1*1 + 1*3,1*8]
...
for (int c0 = 0; c0 <= 1086; c0++) {
  for (int c1 = 0; c1 <= 242; c1++) {

#ifdef __VIVADO_SYNTH__
#pragma HLS pipeline II=1
#endif // __VIVADO_SYNTH__

    if ((0 <= c1 && c1 <= 242) && ((c1 - 0) % 1 == 0) && (0 <= c0 && c0 <= 1086) && ((c0 - 0) % 1 == 0)) {
      in_update_0((c1 - 0) / 1, (c0 - 0) / 1);
    }

    if ((1 <= c1 && c1 <= 242) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 1 == 0)) {
      in_gauss_blur_1_update_0((c1 - 1) / 1, (c0 - 2) / 1);
    }

    if ((1 <= c1 && c1 <= 242) && ((c1 - 1) % 1 == 0) && (2 <= c0 && c0 <= 1086) && ((c0 - 2) % 2 == 0)) {
      in_gauss_ds_1_update_0((c1 - 1) / 1, (c0 - 2) / 2);
    }

    if ((2 <= c1 && c1 <= 242) && ((c1 - 2) % 1 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 2 == 0)) {
      in_gauss_blur_2_update_0((c1 - 2) / 1, (c0 - 6) / 2);
    }

    if ((2 <= c1 && c1 <= 242) && ((c1 - 2) % 1 == 0) && (6 <= c0 && c0 <= 1086) && ((c0 - 6) % 4 == 0)) {
      in_gauss_ds_2_update_0((c1 - 2) / 1, (c0 - 6) / 4);
    }

    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (14 <= c0 && c0 <= 1086) && ((c0 - 14) % 4 == 0)) {
      in_gauss_blur_3_update_0((c1 - 3) / 1, (c0 - 14) / 4);
    }

    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (14 <= c0 && c0 <= 1086) && ((c0 - 14) % 8 == 0)) {
      in_gauss_ds_3_update_0((c1 - 3) / 1, (c0 - 14) / 8);
    }

    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (14 <= c0 && c0 <= 1086) && ((c0 - 14) % 8 == 0)) {
      gp_fpga_8_update_0((c1 - 3) / 1, (c0 - 14) / 8);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (14 <= c0 && c0 <= 1086) && ((c0 - 14) % 8 == 0)) {
	      gp_fpga_8_update_0(in_gauss_ds_3 /* buf name */, gp_fpga_8, (c1 - 3) / 1, (c0 - 14) / 8);
	    }
...
void gp_fpga_8_opt_wrapper(HWStream<hw_uint<128> >& /* get_args num ports = 8 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp_fpga_8, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    gp_fpga_8_opt(in_off_chip, gp_fpga_8);
  }
}
#ifdef __VIVADO_SYNTH__
  // { gp_fpga_8_update_0[root = 0, gp_fpga_8_0, gp_fpga_8_1] -> gp_fpga_8[0, 0] : 0 <= gp_fpga_8_0 <= 239 and 0 <= gp_fpga_8_1 <= 134 }
const int gp_fpga_8_update_0_write_pipe0_num_transfers = 32400;
...
void gp_fpga_8_opt_accel(hw_uint<128>* in_update_0_read_pipe0, hw_uint<16>* gp_fpga_8_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp_fpga_8_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = gp_fpga_8_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > gp_fpga_8_update_0_write_pipe0_channel;

  burst_read<128>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  gp_fpga_8_opt_wrapper(in_update_0_read_pipe0_channel, gp_fpga_8_update_0_write_pipe0_channel, size);

  burst_write<16>(gp_fpga_8_update_0_write_pipe0, gp_fpga_8_update_0_write_pipe0_channel, gp_fpga_8_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void gp_fpga_8_opt_rdai(HWStream<hw_uint<128> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  gp_fpga_8_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = gp_fpga_8_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  gp_fpga_8_opt(in_update_0_read_pipe0, gp_fpga_8_update_0_write_pipe0);
