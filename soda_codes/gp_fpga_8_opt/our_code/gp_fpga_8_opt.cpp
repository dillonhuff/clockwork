...
inline hw_uint<16> gp_fpga_8_rd0_select(in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
  ...
  // Read schedule : { gp_fpga_8_update_0[d0, d1] -> [7 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
// schedule: { in_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 2 + d0, 4] : -1 <= d0 <= 240 and -2 <= d1 <= 538; in_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268; in_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 2 + d0, 5] : -1 <= d0 <= 240 and -1 <= d1 <= 269; in_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + d0, 3] : -2 <= d0 <= 241 and -3 <= d1 <= 539; in_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -2 <= d0 <= 241 and -6 <= d1 <= 1078; gp_fpga_8_update_0[d0, d1] -> [7 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134; in_update_0[d0, d1] -> [d1, d0, 1] : -3 <= d0 <= 242 and -7 <= d1 <= 1079; in_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
//   { in_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 2 + d0, 4] : -1 <= d0 <= 240 and -2 <= d1 <= 538 }
// Condition for in_gauss_blur_2_update_0(((-1 - i0 + 2*floord(1 + i0, 2) == 0) && (-4 + i2 == 0) && (-1 + i1 >= 0) && (242 - i1 >= 0) && (1 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 3 + d0, 6] : 0 <= d0 <= 239 and 0 <= d1 <= 268 }
// Condition for in_gauss_blur_3_update_0(((-1 - i0 + 4*floord(1 + i0, 4) == 0) && (-6 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-7 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 2 + d0, 5] : -1 <= d0 <= 240 and -1 <= d1 <= 269 }
// Condition for in_gauss_ds_2_update_0(((-1 - i0 + 4*floord(1 + i0, 4) == 0) && (-5 + i2 == 0) && (-1 + i1 >= 0) && (242 - i1 >= 0) && (1 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + d0, 3] : -2 <= d0 <= 241 and -3 <= d1 <= 539 }
// Condition for in_gauss_ds_1_update_0(((-1 - i0 + 2*floord(1 + i0, 2) == 0) && (-3 + i2 == 0) && (1 + i1 >= 0) && (242 - i1 >= 0) && (5 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -2 <= d0 <= 241 and -6 <= d1 <= 1078 }
// Condition for in_gauss_blur_1_update_0(((-2 + i2 == 0) && (1 + i1 >= 0) && (242 - i1 >= 0) && (5 + i0 >= 0) && (1079 - i0 >= 0)))
//   { gp_fpga_8_update_0[d0, d1] -> [7 + 8d1, 3 + d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for gp_fpga_8_update_0(((-1 - i0 + 8*floord(1 + i0, 8) == 0) && (-8 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-7 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_update_0[d0, d1] -> [d1, d0, 1] : -3 <= d0 <= 242 and -7 <= d1 <= 1079 }
// Condition for in_update_0(((-1 + i2 == 0) && (3 + i1 >= 0) && (242 - i1 >= 0) && (7 + i0 >= 0) && (1079 - i0 >= 0)))
//   { in_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 3 + d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for in_gauss_ds_3_update_0(((-1 - i0 + 8*floord(1 + i0, 8) == 0) && (-7 + i2 == 0) && (-3 + i1 >= 0) && (242 - i1 >= 0) && (-7 + i0 >= 0) && (1079 - i0 >= 0)))

  /*
  // Schedules...
    // gp_fpga_8_update_0 -> [1*d1*1*8 + 1*7,1*d0*1*1 + 1*3,1*8]
...
#pragma HLS pipeline II=1
    ...
    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (7 <= c0 && c0 <= 1079) && ((c0 - 7) % 8 == 0)) {
      gp_fpga_8_update_0((c1 - 3) / 1, (c0 - 7) / 8);
    }
  ...
  */
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((3 <= c1 && c1 <= 242) && ((c1 - 3) % 1 == 0) && (7 <= c0 && c0 <= 1079) && ((c0 - 7) % 8 == 0)) {
	      gp_fpga_8_update_0(in_gauss_ds_3 /* buf name */, gp_fpga_8, (c1 - 3) / 1, (c0 - 7) / 8);
	    }
...
const int gp_fpga_8_update_0_write_pipe0_num_transfers = 32400;
  // { in_update_0[root = 0, in_0, in_1] -> in_off_chip[0, 0] : -3 <= in_0 <= 242 and -7 <= in_1 <= 1079 }
