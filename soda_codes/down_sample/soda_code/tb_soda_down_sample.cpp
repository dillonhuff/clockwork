...
int main() {
  ...
  down_sample_kernel(hw_output_stencil, input_copy_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_down_sample_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
