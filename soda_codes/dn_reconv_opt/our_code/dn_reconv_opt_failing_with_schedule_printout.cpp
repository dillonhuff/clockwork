...
struct u_u_update_0_write0_merged_banks_6_cache {
	...
	// Capacity: 145
	// # of read delays: 4
	fifo<hw_uint<16>, 145> f;
	inline hw_uint<16> peek(const int offset) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
    return f.peek(144 - offset);
  }
...
inline hw_uint<16> diff_i_rd0_select(u_cache& u, int d0, int d1, int d2) {
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_6.peek(/* one reader or all rams */ (7 - d0 >= 0) ? (144) : (-8 + d0 == 0 && 6 - d1 >= 0) ? (144) : (-7 + d1 == 0 && -8 + d0 == 0) ? (144) : 0);
...
inline hw_uint<16> diff_i_rd1_select(u_cache& u, int d0, int d1, int d2) {
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_6.peek(/* one reader or all rams */ (7 - d0 >= 0) ? (72) : (-8 + d0 == 0 && 6 - d1 >= 0) ? (72) : (-7 + d1 == 0 && -8 + d0 == 0) ? (72) : 0);
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << " d2 = " << d2  << endl;
	assert(false);
...
inline hw_uint<16> diff_o_rd1_select(u_cache& u, int d0, int d1, int d2) {
  ...
  // Write schedule: { u_update_0[d0, d1, d2] -> [d2, d1, d0, 3] : 0 <= d0 <= 8 and 0 <= d1 <= 7 and -1 <= d2 <= 8 }
  // DD fold: {  }
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_6.peek(/* one reader or all rams */ 0);
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << " d2 = " << d2  << endl;
	assert(false);
...
inline hw_uint<16> dn_reconv_rd0_select(u_cache& u, int d0, int d1, int d2) {
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_6.peek(/* one reader or all rams */ 73);
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << " d2 = " << d2  << endl;
	assert(false);
...
inline hw_uint<16> r0_rd0_select(u_cache& u, int d0, int d1, int d2) {
  ...
  auto value_u_u_update_0_write0 = u.u_u_update_0_write0_merged_banks_6.peek(/* one reader or all rams */ 72);
  return value_u_u_update_0_write0;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " d0 = " << d0  << " d1 = " << d1  << " d2 = " << d2  << endl;
	assert(false);
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "dn_reconv_update_0_g," << d0<< "," << d1<< "," << d2<< "," <<  g_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "dn_reconv_update_0_r1," << d0<< "," << d1<< "," << d2<< "," <<  r1_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
...
#ifndef __VIVADO_SYNTH__
  *global_debug_handle << "dn_reconv_update_0_u," << d0<< "," << d1<< "," << d2<< "," <<  u_0_c__0_value << endl;
#endif //__VIVADO_SYNTH__
  ...
  hw_uint<16> debug_compute_result_lane_0;
  set_at<0, 16, 16>(debug_compute_result_lane_0, debug_compute_result.extract<0, 15>());
  *global_debug_handle << "dn_reconv_update_0," << (1*d0 + 0) << ", " << d1<< "," << d2<< "," <<  debug_compute_result_lane_0 << endl;
#endif //__VIVADO_SYNTH__
