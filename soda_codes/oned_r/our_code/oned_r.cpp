...
// Driver function
void oned_r(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out) {

#ifndef __VIVADO_SYNTH__
  ofstream debug_file("oned_r_debug.csv");
...
void oned_r_wrapper(HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */in, HWStream<hw_uint<32> >& /* no bundle get_args num ports = 1 */out, const int num_epochs) {
...
void oned_r_accel(hw_uint<32>* pw_math_in02_read_pipe0, hw_uint<32>* s1_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  oned_r_wrapper(pw_math_in02_read_pipe0_channel, s1_write_pipe0_channel, size);
...
void oned_r_rdai(HWStream<hw_uint<32> >& pw_math_in02_read_pipe0, HWStream<hw_uint<32> >&  s1_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  oned_r(pw_math_in02_read_pipe0, s1_write_pipe0);
