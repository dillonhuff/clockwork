#include <fstream>
#include "mp23_8_opt.h"

int main() {
  ofstream in_pix("input_pixels_regression_result_mp23_8_opt.txt");
  ofstream fout("regression_result_mp23_8_opt.txt");
  HWStream<hw_uint<256> > in_update_0_read;
  HWStream<hw_uint<128> > mp23_8_update_0_write;
  ...
  mp23_8_opt(in_update_0_read, mp23_8_update_0_write);

  for (int i = 0; i < 65536; i++) {
    hw_uint<128> actual = mp23_8_update_0_write.read();
