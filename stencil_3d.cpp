...
// I_id0_write
//	I_I_id0_28
inline void I_I_id0_write_bundle_write(hw_uint<16>& I_id0_write, I_I_id0_28_cache& I_I_id0_28_delay) {
	hw_uint<16> I_I_id0_28_res = I_id0_write.extract<0, 15>();
	I_I_id0_28_write(I_I_id0_28_res, I_I_id0_28_delay);
}
...
// Operation logic
inline void out_blur_270(I_I_id0_28_cache& I_I_id0_28, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */out, int root, int xr, int xc, int xb) {
	// Consume: I
...
inline void I_id0(HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */in, I_I_id0_28_cache& I_I_id0_28, int root, int ir, int ic, int ib) {
	// Consume: in
	auto in_ir_c__ic_c__ib_value = in.read();
	auto compute_result = id(in_ir_c__ic_c__ib_value);
	// Produce: I
	I_I_id0_write_bundle_write(compute_result, I_I_id0_28);
}
