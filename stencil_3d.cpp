...
// Operation logic
inline void out_blur_270(I_I_id0_28_cache& I_I_id0_28, HWStream<hw_uint<16> >& /* num ports = 1 */out, int root, int xr, int xc, int xb) {
	// Consume: I
...
inline void I_id0(HWStream<hw_uint<16> >& /* num ports = 1 */in, I_I_id0_28_cache& I_I_id0_28, int root, int ir, int ic, int ib) {
	// Consume: in
