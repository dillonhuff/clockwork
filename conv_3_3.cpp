...
struct conv_stencil_op_hcompute_conv_stencil_1_4_to_conv_stencil_op_hcompute_hw_output_stencil_1_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct conv_stencil_cache {
  ...
  // # of banks: 1
  conv_stencil_op_hcompute_conv_stencil_1_4_to_conv_stencil_op_hcompute_hw_output_stencil_1_cache conv_stencil_op_hcompute_conv_stencil_1_4_to_conv_stencil_op_hcompute_hw_output_stencil_1;
};
...
inline void conv_stencil_op_hcompute_conv_stencil_1_4_write(hw_uint<16>& conv_stencil_op_hcompute_conv_stencil_1_4, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  conv_stencil.conv_stencil_op_hcompute_conv_stencil_1_4_to_conv_stencil_op_hcompute_hw_output_stencil_1.push(conv_stencil_op_hcompute_conv_stencil_1_4);
}
...
inline hw_uint<16> conv_stencil_op_hcompute_hw_output_stencil_1_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_hw_output_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_conv_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  auto value_conv_stencil_op_hcompute_conv_stencil_1_4 = conv_stencil.conv_stencil_op_hcompute_conv_stencil_1_4_to_conv_stencil_op_hcompute_hw_output_stencil_1.peek(/* one reader or all rams */ 0);
...
struct conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_to_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct conv_stencil_clkwrk_dsa0_cache {
  ...
  // # of banks: 1
  conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_to_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5_cache conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_to_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5;
};
...
inline void conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_write(hw_uint<16>& conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15, conv_stencil_clkwrk_dsa0_cache& conv_stencil_clkwrk_dsa0, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  conv_stencil_clkwrk_dsa0.conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_to_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5.push(conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15);
}
...
inline hw_uint<16> conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5_select(conv_stencil_clkwrk_dsa0_cache& conv_stencil_clkwrk_dsa0, int root, int hw_output_s0_y_yi, int hw_output_s0_x_xi, int dynamic_address) {
  ...
  // Read schedule : { op_hcompute_conv_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  // Write schedule: { op_hcompute_conv_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 1] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
  auto value_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15 = conv_stencil_clkwrk_dsa0.conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_15_to_conv_stencil_clkwrk_dsa0_op_hcompute_conv_stencil_1_5.peek(/* one reader or all rams */ 0);
...
// schedule: { op_hcompute_hw_input_global_wrapper_stencil[d0 = 0, d1, d2] -> [0, d1, d2, 0] : 0 <= d1 <= 63 and 0 <= d2 <= 63; op_hcompute_conv_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 1] : 0 <= d1 <= 61 and 0 <= d2 <= 61; op_hcompute_conv_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61; op_hcompute_hw_output_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
...
//   { op_hcompute_conv_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 1] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
// Condition for op_hcompute_conv_stencil(((((-1 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((63 + -1*i2)) >= 0)))
//   { op_hcompute_conv_stencil_1[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 2] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
// Condition for op_hcompute_conv_stencil_1(((((-2 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((63 + -1*i2)) >= 0)))
//   { op_hcompute_hw_output_stencil[d0 = 0, d1, d2] -> [0, 2 + d1, 2 + d2, 3] : 0 <= d1 <= 61 and 0 <= d2 <= 61 }
// Condition for op_hcompute_hw_output_stencil(((((-3 + 1*i3)) == 0) && (((1*i0)) == 0) && (((-2 + 1*i1)) >= 0) && (((63 + -1*i1)) >= 0) && (((-2 + 1*i2)) >= 0) && (((63 + -1*i2)) >= 0)))

	for (int c1 = 0; c1 <= 63; c1 += 1)
	  for (int c2 = 0; c2 <= 63; c2 += 1) {
	    op_hcompute_hw_input_global_wrapper_stencil(hw_input_stencil /* buf name */, hw_input_global_wrapper_stencil, 0, c1, c2);
	    if (c1 >= 2 && c2 >= 2) {
	      op_hcompute_conv_stencil(conv_stencil_clkwrk_dsa0, 0, c1 - 2, c2 - 2);
	      op_hcompute_conv_stencil_1(conv_stencil_clkwrk_dsa0 /* buf name */, hw_input_global_wrapper_stencil /* buf name */, conv_stencil, 0, c1 - 2, c2 - 2);
	      op_hcompute_hw_output_stencil(conv_stencil /* buf name */, hw_output_stencil, 0, c1 - 2, c2 - 2);
	    }
	  }
...
void conv_3_3_wrapper(HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_input_stencil, HWStream<hw_uint<16> >& /* no bundle get_args num ports = 1 */hw_output_stencil, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    conv_3_3(hw_input_stencil, hw_output_stencil);
  }
}
#ifdef __SYNTHESIS__
...
void conv_3_3_accel(hw_uint<16>* op_hcompute_hw_input_global_wrapper_stencil_read_pipe0, hw_uint<16>* op_hcompute_hw_output_stencil_write_pipe0, const int size) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  conv_3_3_wrapper(op_hcompute_hw_input_global_wrapper_stencil_read_pipe0_channel, op_hcompute_hw_output_stencil_write_pipe0_channel, size);
...
void conv_3_3_rdai(HWStream<hw_uint<16> >& op_hcompute_hw_input_global_wrapper_stencil_read_pipe0, HWStream<hw_uint<16> >&  op_hcompute_hw_output_stencil_write_pipe0) { 
#pragma HLS dataflow
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  conv_3_3(op_hcompute_hw_input_global_wrapper_stencil_read_pipe0, op_hcompute_hw_output_stencil_write_pipe0);
