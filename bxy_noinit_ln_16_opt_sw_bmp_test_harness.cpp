...
#include <fstream>
#include <vector>
#include "bxy_noinit_ln_16_opt.h"
#include "bitmap_image.hpp"
#include <cstdlib>

int main(int argc, char **argv) {
  bitmap_image input("./images/taxi_slice_256.bmp");
  HWStream<hw_uint<256> > input_update_0_read_channel;
  HWStream<hw_uint<256> > bxy_noinit_ln_16_update_0_write_channel;
  // In lanes = 16
  ...
  bxy_noinit_ln_16_opt(input_update_0_read_channel, bxy_noinit_ln_16_update_0_write_channel);
  bitmap_image output(1920, 1080);
  for (int r = 0; r < 1080; r++) {
    for (int cl = 0; cl < 1920 / 16; cl++) {
      auto packed_val = bxy_noinit_ln_16_update_0_write_channel.read();
  ...
  output.save_image("./images/bxy_noinit_ln_16_opt_bmp_out.bmp");
}
