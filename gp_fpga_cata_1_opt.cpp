...
#endif //__SYNTHESIS__
// compute file: gp_fpga_cata_1_opt_compute_units.h
#include "gp_fpga_cata_1_opt_compute_units.h"
...
struct in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_cata_1_rd0_cache {
	// RAM Box: {[0, 239], [0, 134]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct in_gauss_ds_3_cache {
  // Reader addrs...
    // { gp_fpga_cata_1_update_0[d0, d1] -> in_gauss_ds_3[d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // # of banks: 1
  in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_cata_1_rd0_cache in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_cata_1_rd0;
};
...
inline void in_gauss_ds_3_in_gauss_ds_3_update_0_write0_write(hw_uint<16>& in_gauss_ds_3_in_gauss_ds_3_update_0_write0, in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
  in_gauss_ds_3.in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_cata_1_rd0.push(in_gauss_ds_3_in_gauss_ds_3_update_0_write0);
}

inline hw_uint<16> gp_fpga_cata_1_rd0_select(in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
#ifdef __SYTHESIS__
#endif //__SYNTHESIS__
  // gp_fpga_cata_1_rd0 read pattern: { gp_fpga_cata_1_update_0[d0, d1] -> in_gauss_ds_3[d0, d1] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Read schedule : { gp_fpga_cata_1_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  // Write schedule: { in_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
  auto value_in_gauss_ds_3_in_gauss_ds_3_update_0_write0 = in_gauss_ds_3.in_gauss_ds_3_in_gauss_ds_3_update_0_write0_to_gp_fpga_cata_1_rd0.peek(/* one reader or all rams */ 0);
  return value_in_gauss_ds_3_in_gauss_ds_3_update_0_write0;
  return 0;
}

// # of bundles = 2
// gp_fpga_cata_1_update_0_read
//	gp_fpga_cata_1_rd0
inline hw_uint<16> in_gauss_ds_3_gp_fpga_cata_1_update_0_read_bundle_read(in_gauss_ds_3_cache& in_gauss_ds_3, int d0, int d1, int dynamic_address) {
  // # of ports in bundle: 1
    // gp_fpga_cata_1_rd0

	hw_uint<16> result;
	hw_uint<16> gp_fpga_cata_1_rd0_res = gp_fpga_cata_1_rd0_select(in_gauss_ds_3, d0, d1, dynamic_address);
	set_at<0, 16>(result, gp_fpga_cata_1_rd0_res);
	return result;
}
...
inline void gp_fpga_cata_1_update_0(in_gauss_ds_3_cache& in_gauss_ds_3, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */gp_fpga_cata_1, int d0, int d1) {
  // Dynamic address computation

	// Consume: in_gauss_ds_3
	auto in_gauss_ds_3_1_m_gp_fpga_cata_1_1__p__0_c__1_m_gp_fpga_cata_1_0__p__0_value = in_gauss_ds_3_gp_fpga_cata_1_update_0_read_bundle_read(in_gauss_ds_3/* source_delay */, d0, d1, 0);

#ifndef __SYNTHESIS__
#endif //__SYNTHESIS__

	auto compute_result = id_unrolled_1(in_gauss_ds_3_1_m_gp_fpga_cata_1_1__p__0_c__1_m_gp_fpga_cata_1_0__p__0_value);
	// Produce: gp_fpga_cata_1
	gp_fpga_cata_1.write(compute_result);
...
#ifndef __SYNTHESIS__
  ofstream debug_file("gp_fpga_cata_1_opt_debug.csv");
...
// schedule: { in_gauss_blur_2_update_0[d0, d1] -> [3 + 2d1, 3 + 2d0, 4] : -2 <= d0 <= 958 and -2 <= d1 <= 538; in_gauss_blur_3_update_0[d0, d1] -> [7 + 4d1, 7 + 4d0, 6] : 0 <= d0 <= 478 and 0 <= d1 <= 268; in_gauss_ds_2_update_0[d0, d1] -> [3 + 4d1, 3 + 4d0, 5] : -1 <= d0 <= 479 and -1 <= d1 <= 269; in_gauss_ds_1_update_0[d0, d1] -> [1 + 2d1, 1 + 2d0, 3] : -3 <= d0 <= 959 and -3 <= d1 <= 539; gp_fpga_cata_1_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134; in_gauss_blur_1_update_0[d0, d1] -> [1 + d1, 1 + d0, 2] : -6 <= d0 <= 1918 and -6 <= d1 <= 1078; in_update_0[d0, d1] -> [d1, d0, 1] : -7 <= d0 <= 1919 and -7 <= d1 <= 1079; in_gauss_ds_3_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 7] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
...
//   { gp_fpga_cata_1_update_0[d0, d1] -> [7 + 8d1, 7 + 8d0, 8] : 0 <= d0 <= 239 and 0 <= d1 <= 134 }
// Condition for gp_fpga_cata_1_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-8 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1919 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
...
// Condition for in_gauss_ds_3_update_0(((((-1 + -1*i0 + (8*(((1 + 1*i0)) >> 3)))) == 0) && (((-1 + -1*i1 + (8*(((1 + 1*i1)) >> 3)))) == 0) && (((-7 + 1*i2)) == 0) && (((-7 + 1*i1)) >= 0) && (((1919 + -1*i1)) >= 0) && (((-7 + 1*i0)) >= 0) && (((1079 + -1*i0)) >= 0)))
	  ...
	  // Schedules...
	    // gp_fpga_cata_1_update_0 -> [1*d1*1*8 + 1*7,1*d0*1*8 + 1*7,1*8]
	...
	#pragma HLS pipeline II=1
	    ...
	    if ((7 <= c1 && c1 <= 1919) && ((c1 - 7) % 8 == 0) && (7 <= c0 && c0 <= 1079) && ((c0 - 7) % 8 == 0)) {
	      gp_fpga_cata_1_update_0(in_gauss_ds_3 /* buf name */, gp_fpga_cata_1, (c1 - 7) / 8, (c0 - 7) / 8);
	    }
...
void gp_fpga_cata_1_opt_wrapper(HWStream<hw_uint<16> >& /* get_args num ports = 1 */in_off_chip, HWStream<hw_uint<16> >& /* get_args num ports = 1 */gp_fpga_cata_1, const int num_epochs) {

  for (int epoch = 0; epoch < num_epochs; epoch++) {
    gp_fpga_cata_1_opt(in_off_chip, gp_fpga_cata_1);
  }
}
#ifdef __SYNTHESIS__
  // { gp_fpga_cata_1_update_0[root = 0, gp_fpga_cata_1_0, gp_fpga_cata_1_1] -> gp_fpga_cata_1[gp_fpga_cata_1_1, gp_fpga_cata_1_0] : 0 <= gp_fpga_cata_1_0 <= 134 and 0 <= gp_fpga_cata_1_1 <= 239 }
const int gp_fpga_cata_1_update_0_write_pipe0_num_transfers = 32400;
...
void gp_fpga_cata_1_opt_accel(hw_uint<16>* in_update_0_read_pipe0, hw_uint<16>* gp_fpga_cata_1_update_0_write_pipe0, const int size) { 
#pragma HLS dataflow
#pragma HLS INTERFACE m_axi port = in_update_0_read_pipe0 offset = slave depth = 65536 bundle = gmem0
#pragma HLS INTERFACE m_axi port = gp_fpga_cata_1_update_0_write_pipe0 offset = slave depth = 65536 bundle = gmem1

#pragma HLS INTERFACE s_axilite port = in_update_0_read_pipe0 bundle = control
#pragma HLS INTERFACE s_axilite port = gp_fpga_cata_1_update_0_write_pipe0 bundle = control
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  static HWStream<hw_uint<16> > gp_fpga_cata_1_update_0_write_pipe0_channel;

  burst_read<16>(in_update_0_read_pipe0, in_update_0_read_pipe0_channel, in_update_0_read_pipe0_num_transfers*size);

  gp_fpga_cata_1_opt_wrapper(in_update_0_read_pipe0_channel, gp_fpga_cata_1_update_0_write_pipe0_channel, size);

  burst_write<16>(gp_fpga_cata_1_update_0_write_pipe0, gp_fpga_cata_1_update_0_write_pipe0_channel, gp_fpga_cata_1_update_0_write_pipe0_num_transfers*size);
}

}
extern "C" {

void gp_fpga_cata_1_opt_rdai(HWStream<hw_uint<16> >& in_update_0_read_pipe0, HWStream<hw_uint<16> >&  gp_fpga_cata_1_update_0_write_pipe0) { 
#pragma HLS dataflow
#pragma HLS INTERFACE axis register port = in_update_0_read_pipe0
#pragma HLS INTERFACE axis register port = gp_fpga_cata_1_update_0_write_pipe0
...
#pragma HLS INTERFACE ap_ctrl_none port = return
  ...
  gp_fpga_cata_1_opt(in_update_0_read_pipe0, gp_fpga_cata_1_update_0_write_pipe0);
