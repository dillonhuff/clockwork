...
// Stencil<uint16_t, 2, 30, 30> &hw_input_stencil = arg_0;
  prg.add_input("hw_input_stencil");
  prg.buffer_port_widths["hw_input_stencil"] = 16;
// Stencil<uint16_t, 2, 4, 3, 3> &hw_kernel_stencil = arg_1;
...
////producing hw_input_global_wrapper.stencil
  ...
  auto hw_input_global_wrapper_s0_z = hw_input_global_wrapper_s0_x->add_loop("hw_input_global_wrapper_s0_z", 0, 2);
...
////producing hw_kernel_global_wrapper.stencil
  ...
  auto hw_kernel_global_wrapper_s0_z = hw_kernel_global_wrapper_s0_w->add_loop("hw_kernel_global_wrapper_s0_z", 0, 2);
