...
// Stencil<uint8_t, 16, 16> &hw_output_stencil = arg_0;
  prg.add_output("hw_output_stencil");
  prg.buffer_port_widths["hw_output_stencil"] = 8;

  auto hw_output_s0_y_yi = prg.add_loop("hw_output_s0_y_yi", 0, 16);
////producing curvea0
  auto curve_s0_y = hw_output_s0_y_yi->add_loop("curve_s0_y", 0, 16);

//consuming curvea0
  auto hw_output_s0_x_xi = hw_output_s0_y_yi->add_loop("hw_output_s0_x_xi", 0, 16);

//store is: hw_output.stencil(hw_output_s0_x_xi, hw_output_s0_y_yi) = uint8(curvea0[((hw_output_s0_y_yi*16) + hw_output_s0_x_xi)])
  auto hcompute_hw_output_stencil = hw_output_s0_x_xi->add_op("op_hcompute_hw_output_stencil");
  hcompute_hw_output_stencil->add_function("hcompute_hw_output_stencil");
  hcompute_hw_output_stencil->add_store("hw_output_stencil", "hw_output_s0_y_yi", "hw_output_s0_x_xi");
  hcompute_hw_output_stencil->compute_unit_needs_index_variable("hw_output_s0_x_xi");
...
//store is: conv.stencil(conv_s1_x, conv_s1_y, 0) = ((((conv.stencil(conv_s1_x, conv_s1_y, 0) + int16((int32(hw_input_global_wrapper.stencil(0, conv_s1_x, conv_s1_y))*83))) + int16((int32(hw_input_global_wrapper.stencil(1, conv_s1_x, conv_s1_y))*86))) + int16((int32(hw_input_global_wrapper.stencil(2, conv_s1_x, conv_s1_y))*77))) + int16((int32(hw_input_global_wrapper.stencil(3, conv_s1_x, conv_s1_y))*15)))
  auto hcompute_conv_stencil_1 = conv_s1_x->add_op("op_hcompute_conv_stencil_1");
  hcompute_conv_stencil_1->add_function("hcompute_conv_stencil_1");
  hcompute_conv_stencil_1->add_load("conv_stencil", "0", "conv_s1_y", "conv_s1_x");
  hcompute_conv_stencil_1->add_load("hw_input_global_wrapper_stencil", "conv_s1_y", "conv_s1_x", "0");
...
//store is: conv.stencil(conv_s1_x_1, conv_s1_y_1, 1) = ((((conv.stencil(conv_s1_x_1, conv_s1_y_1, 1) + int16((int32(hw_input_global_wrapper.stencil(0, conv_s1_x_1, conv_s1_y_1))*93))) + int16((int32(hw_input_global_wrapper.stencil(1, conv_s1_x_1, conv_s1_y_1))*35))) + int16((int32(hw_input_global_wrapper.stencil(2, conv_s1_x_1, conv_s1_y_1))*86))) + int16((int32(hw_input_global_wrapper.stencil(3, conv_s1_x_1, conv_s1_y_1))*92)))
  auto hcompute_conv_stencil_2 = conv_s1_x_1->add_op("op_hcompute_conv_stencil_2");
  hcompute_conv_stencil_2->add_function("hcompute_conv_stencil_2");
  hcompute_conv_stencil_2->add_load("conv_stencil", "1", "conv_s1_y_1", "conv_s1_x_1");
  hcompute_conv_stencil_2->add_load("hw_input_global_wrapper_stencil", "conv_s1_y_1", "conv_s1_x_1", "0");
...
//store is: conv.stencil(conv_s1_x_2, conv_s1_y_2, 2) = ((((conv.stencil(conv_s1_x_2, conv_s1_y_2, 2) + int16((int32(hw_input_global_wrapper.stencil(0, conv_s1_x_2, conv_s1_y_2))*49))) + int16((int32(hw_input_global_wrapper.stencil(1, conv_s1_x_2, conv_s1_y_2))*21))) + int16((int32(hw_input_global_wrapper.stencil(2, conv_s1_x_2, conv_s1_y_2))*62))) + int16((int32(hw_input_global_wrapper.stencil(3, conv_s1_x_2, conv_s1_y_2))*27)))
  auto hcompute_conv_stencil_3 = conv_s1_x_2->add_op("op_hcompute_conv_stencil_3");
  hcompute_conv_stencil_3->add_function("hcompute_conv_stencil_3");
  hcompute_conv_stencil_3->add_load("conv_stencil", "2", "conv_s1_y_2", "conv_s1_x_2");
  hcompute_conv_stencil_3->add_load("hw_input_global_wrapper_stencil", "conv_s1_y_2", "conv_s1_x_2", "1");
...
//store is: conv.stencil(conv_s1_x_3, conv_s1_y_3, 3) = ((((conv.stencil(conv_s1_x_3, conv_s1_y_3, 3) + int16((int32(hw_input_global_wrapper.stencil(0, conv_s1_x_3, conv_s1_y_3))*90))) + int16((int32(hw_input_global_wrapper.stencil(1, conv_s1_x_3, conv_s1_y_3))*59))) + int16((int32(hw_input_global_wrapper.stencil(2, conv_s1_x_3, conv_s1_y_3))*63))) + int16((int32(hw_input_global_wrapper.stencil(3, conv_s1_x_3, conv_s1_y_3))*26)))
  auto hcompute_conv_stencil_4 = conv_s1_x_3->add_op("op_hcompute_conv_stencil_4");
  hcompute_conv_stencil_4->add_function("hcompute_conv_stencil_4");
  hcompute_conv_stencil_4->add_load("conv_stencil", "3", "conv_s1_y_3", "conv_s1_x_3");
  hcompute_conv_stencil_4->add_load("hw_input_global_wrapper_stencil", "conv_s1_y_3", "conv_s1_x_3", "0");
