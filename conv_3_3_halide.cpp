...
struct conv_stencil_hcompute_conv_stencil_1_3_to_conv_stencil_hcompute_hw_output_stencil_1_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct conv_stencil_cache {
  ...
  conv_stencil_hcompute_conv_stencil_1_3_to_conv_stencil_hcompute_hw_output_stencil_1_cache conv_stencil_hcompute_conv_stencil_1_3_to_conv_stencil_hcompute_hw_output_stencil_1;
};
...
inline void conv_stencil_hcompute_conv_stencil_1_3_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_1_3, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_1_3_to_conv_stencil_hcompute_hw_output_stencil_1.push(conv_stencil_hcompute_conv_stencil_1_3);
}
...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_1_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_conv_stencil_hcompute_conv_stencil_1_3 = conv_stencil.conv_stencil_hcompute_conv_stencil_1_3_to_conv_stencil_hcompute_hw_output_stencil_1.peek(/* one reader or all rams */ 0);
...
struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_to_hw_input_copy_stencil_hcompute_conv_stencil_1_5_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct hw_input_copy_stencil_cache {
  // # of banks: 1
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_to_hw_input_copy_stencil_hcompute_conv_stencil_1_5_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_to_hw_input_copy_stencil_hcompute_conv_stencil_1_5;
};
...
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_to_hw_input_copy_stencil_hcompute_conv_stencil_1_5.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6);
}
...
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_5_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_6_to_hw_input_copy_stencil_hcompute_conv_stencil_1_5.peek(/* one reader or all rams */ 0);
