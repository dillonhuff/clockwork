...
//#endif //__VIVADO_SYNTH__
  ...
  //// Get lexmax events: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_conv_stencil[root' = 0, hw_output_s0_y_yo' = hw_output_s0_y_yo, hw_output_s0_x_xo' = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Op overlap with conv_stencil_hcompute_conv_stencil_2: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Common write op with conv_stencil_hcompute_conv_stencil_2: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
...
//#endif //__VIVADO_SYNTH__
  ...
  //// Get lexmax events: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_conv_stencil_1[root' = 0, hw_output_s0_y_yo' = hw_output_s0_y_yo, hw_output_s0_x_xo' = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Op overlap with conv_stencil_hcompute_conv_stencil_1_3: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Common write op with conv_stencil_hcompute_conv_stencil_1_3: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
...
//#endif //__VIVADO_SYNTH__
  ...
  //// Get lexmax events: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_hw_input_copy_stencil[root' = 0, hw_input_copy_s0_y = hw_output_s0_y_yo, hw_input_copy_s0_x = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Op overlap with hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    //// Common write op with hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
...
>>>>>>> 32f8805bf63c864da66488240471a4e8d1185fb7
