...
struct conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_6_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct conv_stencil_hcompute_conv_stencil_1_5_to_conv_stencil_hcompute_hw_output_stencil_4_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct conv_stencil_cache {
  conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_6_cache conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_6;
  conv_stencil_hcompute_conv_stencil_1_5_to_conv_stencil_hcompute_hw_output_stencil_4_cache conv_stencil_hcompute_conv_stencil_1_5_to_conv_stencil_hcompute_hw_output_stencil_4;
};



inline void conv_stencil_hcompute_conv_stencil_0_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_0, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_6.push(conv_stencil_hcompute_conv_stencil_0);
}

inline void conv_stencil_hcompute_conv_stencil_1_5_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_1_5, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_1_5_to_conv_stencil_hcompute_hw_output_stencil_4.push(conv_stencil_hcompute_conv_stencil_1_5);
}

inline hw_uint<16> conv_stencil_hcompute_conv_stencil_1_6_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_hcompute_conv_stencil_1_6 read pattern: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> conv_stencil[hw_output_s0_x_xo, hw_output_s0_y_yo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  // Get lexmax events: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_conv_stencil[root' = 0, hw_output_s0_y_yo' = hw_output_s0_y_yo, hw_output_s0_x_xo' = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Op overlap with conv_stencil_hcompute_conv_stencil_0: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Common write op with conv_stencil_hcompute_conv_stencil_0: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Overlap with conv_stencil_hcompute_conv_stencil_0: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  // DD fold: {  }
  auto value_conv_stencil_hcompute_conv_stencil_0 = conv_stencil.conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_6.peek(/* one reader or all rams */ 0);
  return value_conv_stencil_hcompute_conv_stencil_0;
#ifndef __VIVADO_SYNTH__
...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_4_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  // Get lexmax events: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_conv_stencil_1[root' = 0, hw_output_s0_y_yo' = hw_output_s0_y_yo, hw_output_s0_x_xo' = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Op overlap with conv_stencil_hcompute_conv_stencil_1_5: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Common write op with conv_stencil_hcompute_conv_stencil_1_5: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Overlap with conv_stencil_hcompute_conv_stencil_1_5: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  // DD fold: {  }
  auto value_conv_stencil_hcompute_conv_stencil_1_5 = conv_stencil.conv_stencil_hcompute_conv_stencil_1_5_to_conv_stencil_hcompute_hw_output_stencil_4.peek(/* one reader or all rams */ 0);
  return value_conv_stencil_hcompute_conv_stencil_1_5;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " hw_output_s0_y_yo = " << hw_output_s0_y_yo  << " hw_output_s0_x_xo = " << hw_output_s0_x_xo  << endl;
	assert(false);
	return 0;
...
//	conv_stencil_hcompute_conv_stencil_1_6
inline hw_uint<16> conv_stencil_hcompute_conv_stencil_1_read_bundle_read(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> conv_stencil_hcompute_conv_stencil_1_6_res = conv_stencil_hcompute_conv_stencil_1_6_select(conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
	set_at<0, 16>(result, conv_stencil_hcompute_conv_stencil_1_6_res);
	return result;
}
...
inline void conv_stencil_hcompute_conv_stencil_1_write_bundle_write(hw_uint<16>& hcompute_conv_stencil_1_write, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
	hw_uint<16> conv_stencil_hcompute_conv_stencil_1_5_res = hcompute_conv_stencil_1_write.extract<0, 15>();
	conv_stencil_hcompute_conv_stencil_1_5_write(conv_stencil_hcompute_conv_stencil_1_5_res, conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
}

// hcompute_conv_stencil_write
//	conv_stencil_hcompute_conv_stencil_0
inline void conv_stencil_hcompute_conv_stencil_write_bundle_write(hw_uint<16>& hcompute_conv_stencil_write, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
	hw_uint<16> conv_stencil_hcompute_conv_stencil_0_res = hcompute_conv_stencil_write.extract<0, 15>();
	conv_stencil_hcompute_conv_stencil_0_write(conv_stencil_hcompute_conv_stencil_0_res, conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
}
...
struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_to_hw_input_copy_stencil_hcompute_conv_stencil_1_7_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct hw_input_copy_stencil_cache {
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_to_hw_input_copy_stencil_hcompute_conv_stencil_1_7_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_to_hw_input_copy_stencil_hcompute_conv_stencil_1_7;
};



inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_to_hw_input_copy_stencil_hcompute_conv_stencil_1_7.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1);
}

inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_7_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_copy_stencil_hcompute_conv_stencil_1_7 read pattern: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hw_input_copy_stencil[hw_output_s0_x_xo, hw_output_s0_y_yo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  // Get lexmax events: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hcompute_hw_input_copy_stencil[root' = 0, hw_input_copy_s0_y = hw_output_s0_y_yo, hw_input_copy_s0_x = hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Op overlap with hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Common write op with hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
    // Overlap with hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  // Read schedule : { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> [hw_output_s0_y_yo, hw_output_s0_x_xo, 2] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  // DD fold: {  }
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_to_hw_input_copy_stencil_hcompute_conv_stencil_1_7.peek(/* one reader or all rams */ 0);
  return value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " hw_output_s0_y_yo = " << hw_output_s0_y_yo  << " hw_output_s0_x_xo = " << hw_output_s0_x_xo  << endl;
	assert(false);
	return 0;
...
// # of bundles = 2
// hcompute_conv_stencil_1_read
//	hw_input_copy_stencil_hcompute_conv_stencil_1_7
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_read_bundle_read(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_7_res = hw_input_copy_stencil_hcompute_conv_stencil_1_7_select(hw_input_copy_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
	set_at<0, 16>(result, hw_input_copy_stencil_hcompute_conv_stencil_1_7_res);
	return result;
}

// hcompute_hw_input_copy_stencil_write
//	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_write_bundle_write(hw_uint<16>& hcompute_hw_input_copy_stencil_write, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
	hw_uint<16> hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_res = hcompute_hw_input_copy_stencil_write.extract<0, 15>();
	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_write(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_1_res, hw_input_copy_stencil, root, hw_input_copy_s0_y, hw_input_copy_s0_x, dynamic_address);
}
