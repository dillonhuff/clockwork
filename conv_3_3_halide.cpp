...
struct conv_stencil_hcompute_conv_stencil_1_0_to_conv_stencil_hcompute_hw_output_stencil_7_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct conv_stencil_cache {
  ...
  conv_stencil_hcompute_conv_stencil_1_0_to_conv_stencil_hcompute_hw_output_stencil_7_cache conv_stencil_hcompute_conv_stencil_1_0_to_conv_stencil_hcompute_hw_output_stencil_7;
};
...
inline void conv_stencil_hcompute_conv_stencil_1_0_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_1_0, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_1_0_to_conv_stencil_hcompute_hw_output_stencil_7.push(conv_stencil_hcompute_conv_stencil_1_0);
}
...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_7_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_conv_stencil_hcompute_conv_stencil_1_0 = conv_stencil.conv_stencil_hcompute_conv_stencil_1_0_to_conv_stencil_hcompute_hw_output_stencil_7.peek(/* one reader or all rams */ 0);
...
struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct hw_input_copy_stencil_cache {
  // # of banks: 1
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2;
};



inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3);
}
...
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_2_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2.peek(/* one reader or all rams */ 0);
  return value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3;
  return 0;
}
...
//	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_write_bundle_write(hw_uint<16>& hcompute_hw_input_copy_stencil_write, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
	hw_uint<16> hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_res = hcompute_hw_input_copy_stencil_write.extract<0, 15>();
	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_write(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_3_res, hw_input_copy_stencil, root, hw_input_copy_s0_y, hw_input_copy_s0_x, dynamic_address);
}
