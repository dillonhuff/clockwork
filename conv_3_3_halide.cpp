...
struct conv_stencil_hcompute_conv_stencil_7_to_conv_stencil_hcompute_conv_stencil_1_1_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct conv_stencil_cache {
  // # of banks: 2
  conv_stencil_hcompute_conv_stencil_7_to_conv_stencil_hcompute_conv_stencil_1_1_cache conv_stencil_hcompute_conv_stencil_7_to_conv_stencil_hcompute_conv_stencil_1_1;
...
inline void conv_stencil_hcompute_conv_stencil_7_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_7, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_7_to_conv_stencil_hcompute_conv_stencil_1_1.push(conv_stencil_hcompute_conv_stencil_7);
}
...
inline hw_uint<16> conv_stencil_hcompute_conv_stencil_1_1_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_conv_stencil_hcompute_conv_stencil_7 = conv_stencil.conv_stencil_hcompute_conv_stencil_7_to_conv_stencil_hcompute_conv_stencil_1_1.peek(/* one reader or all rams */ 0);
...
struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
  // 0, 0
...
struct hw_input_copy_stencil_cache {
  // # of banks: 1
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2;
};
...
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5);
}
...
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_2_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_5_to_hw_input_copy_stencil_hcompute_conv_stencil_1_2.peek(/* one reader or all rams */ 0);
