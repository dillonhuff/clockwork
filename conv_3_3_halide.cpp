...
struct conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_2_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct conv_stencil_hcompute_conv_stencil_1_1_to_conv_stencil_hcompute_hw_output_stencil_7_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct conv_stencil_cache {
  conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_2_cache conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_2;
  conv_stencil_hcompute_conv_stencil_1_1_to_conv_stencil_hcompute_hw_output_stencil_7_cache conv_stencil_hcompute_conv_stencil_1_1_to_conv_stencil_hcompute_hw_output_stencil_7;
};
...
inline void conv_stencil_hcompute_conv_stencil_0_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_0, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_2.push(conv_stencil_hcompute_conv_stencil_0);
}

inline void conv_stencil_hcompute_conv_stencil_1_1_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_1_1, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_1_1_to_conv_stencil_hcompute_hw_output_stencil_7.push(conv_stencil_hcompute_conv_stencil_1_1);
}

inline hw_uint<16> conv_stencil_hcompute_conv_stencil_1_2_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_hcompute_conv_stencil_1_2 read pattern: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> conv_stencil[hw_output_s0_x_xo, hw_output_s0_y_yo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  auto value_conv_stencil_hcompute_conv_stencil_0 = conv_stencil.conv_stencil_hcompute_conv_stencil_0_to_conv_stencil_hcompute_conv_stencil_1_2.peek(/* one reader or all rams */ 0);
...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_7_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_conv_stencil_hcompute_conv_stencil_1_1 = conv_stencil.conv_stencil_hcompute_conv_stencil_1_1_to_conv_stencil_hcompute_hw_output_stencil_7.peek(/* one reader or all rams */ 0);
  return value_conv_stencil_hcompute_conv_stencil_1_1;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " hw_output_s0_y_yo = " << hw_output_s0_y_yo  << " hw_output_s0_x_xo = " << hw_output_s0_x_xo  << endl;
	assert(false);
	return 0;
...
//	conv_stencil_hcompute_conv_stencil_1_2
inline hw_uint<16> conv_stencil_hcompute_conv_stencil_1_read_bundle_read(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> conv_stencil_hcompute_conv_stencil_1_2_res = conv_stencil_hcompute_conv_stencil_1_2_select(conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
	set_at<0, 16>(result, conv_stencil_hcompute_conv_stencil_1_2_res);
	return result;
}
...
inline void conv_stencil_hcompute_conv_stencil_1_write_bundle_write(hw_uint<16>& hcompute_conv_stencil_1_write, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
	hw_uint<16> conv_stencil_hcompute_conv_stencil_1_1_res = hcompute_conv_stencil_1_write.extract<0, 15>();
	conv_stencil_hcompute_conv_stencil_1_1_write(conv_stencil_hcompute_conv_stencil_1_1_res, conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
}
...
struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_to_hw_input_copy_stencil_hcompute_conv_stencil_1_3_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct hw_input_copy_stencil_cache {
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_to_hw_input_copy_stencil_hcompute_conv_stencil_1_3_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_to_hw_input_copy_stencil_hcompute_conv_stencil_1_3;
};



inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_to_hw_input_copy_stencil_hcompute_conv_stencil_1_3.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4);
}

inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_3_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_copy_stencil_hcompute_conv_stencil_1_3 read pattern: { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> hw_input_copy_stencil[hw_output_s0_x_xo, hw_output_s0_y_yo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  // Read schedule : { hcompute_conv_stencil_1[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> [hw_output_s0_y_yo, hw_output_s0_x_xo, 2] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_to_hw_input_copy_stencil_hcompute_conv_stencil_1_3.peek(/* one reader or all rams */ 0);
  return value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4;
#ifndef __VIVADO_SYNTH__
	cout << "Error: Unsupported offsets: " << " root = " << root  << " hw_output_s0_y_yo = " << hw_output_s0_y_yo  << " hw_output_s0_x_xo = " << hw_output_s0_x_xo  << endl;
	assert(false);
	return 0;
...
// # of bundles = 2
// hcompute_conv_stencil_1_read
//	hw_input_copy_stencil_hcompute_conv_stencil_1_3
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_read_bundle_read(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_3_res = hw_input_copy_stencil_hcompute_conv_stencil_1_3_select(hw_input_copy_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
	set_at<0, 16>(result, hw_input_copy_stencil_hcompute_conv_stencil_1_3_res);
	return result;
}

// hcompute_hw_input_copy_stencil_write
//	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_write_bundle_write(hw_uint<16>& hcompute_hw_input_copy_stencil_write, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
	hw_uint<16> hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_res = hcompute_hw_input_copy_stencil_write.extract<0, 15>();
	hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_write(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_4_res, hw_input_copy_stencil, root, hw_input_copy_s0_y, hw_input_copy_s0_x, dynamic_address);
}
