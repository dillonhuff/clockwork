...
struct conv_stencil_hcompute_conv_stencil_1_2_to_conv_stencil_hcompute_hw_output_stencil_6_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct conv_stencil_cache {
  ...
  conv_stencil_hcompute_conv_stencil_1_2_to_conv_stencil_hcompute_hw_output_stencil_6_cache conv_stencil_hcompute_conv_stencil_1_2_to_conv_stencil_hcompute_hw_output_stencil_6;
};
...
inline void conv_stencil_hcompute_conv_stencil_1_2_write(hw_uint<16>& conv_stencil_hcompute_conv_stencil_1_2, conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  conv_stencil.conv_stencil_hcompute_conv_stencil_1_2_to_conv_stencil_hcompute_hw_output_stencil_6.push(conv_stencil_hcompute_conv_stencil_1_2);
}
...
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_6_select(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv_stencil_hcompute_hw_output_stencil_6 read pattern: { hcompute_hw_output_stencil[root = 0, hw_output_s0_y_yo, hw_output_s0_x_xo] -> conv_stencil[hw_output_s0_x_xo, hw_output_s0_y_yo] : 0 <= hw_output_s0_y_yo <= 61 and 0 <= hw_output_s0_x_xo <= 61 }
  ...
  auto value_conv_stencil_hcompute_conv_stencil_1_2 = conv_stencil.conv_stencil_hcompute_conv_stencil_1_2_to_conv_stencil_hcompute_hw_output_stencil_6.peek(/* one reader or all rams */ 0);
...
//	conv_stencil_hcompute_hw_output_stencil_6
inline hw_uint<16> conv_stencil_hcompute_hw_output_stencil_read_bundle_read(conv_stencil_cache& conv_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  // # of ports in bundle: 1
	...
	hw_uint<16> result;
	hw_uint<16> conv_stencil_hcompute_hw_output_stencil_6_res = conv_stencil_hcompute_hw_output_stencil_6_select(conv_stencil, root, hw_output_s0_y_yo, hw_output_s0_x_xo, dynamic_address);
	set_at<0, 16>(result, conv_stencil_hcompute_hw_output_stencil_6_res);
	return result;
}

#include "hw_classes.h"

struct hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_to_hw_input_copy_stencil_hcompute_conv_stencil_1_4_cache {
	// RAM Box: {[0, 63], [0, 63]}
	// Capacity: 1
	// # of read delays: 2
	fifo<hw_uint<16>, 1> f;
...
struct hw_input_copy_stencil_cache {
  hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_to_hw_input_copy_stencil_hcompute_conv_stencil_1_4_cache hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_to_hw_input_copy_stencil_hcompute_conv_stencil_1_4;
};
...
inline void hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_write(hw_uint<16>& hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0, hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_input_copy_s0_y, int hw_input_copy_s0_x, int dynamic_address) {
  hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_to_hw_input_copy_stencil_hcompute_conv_stencil_1_4.push(hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0);
}
...
inline hw_uint<16> hw_input_copy_stencil_hcompute_conv_stencil_1_4_select(hw_input_copy_stencil_cache& hw_input_copy_stencil, int root, int hw_output_s0_y_yo, int hw_output_s0_x_xo, int dynamic_address) {
  ...
  auto value_hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0 = hw_input_copy_stencil.hw_input_copy_stencil_hcompute_hw_input_copy_stencil_0_to_hw_input_copy_stencil_hcompute_conv_stencil_1_4.peek(/* one reader or all rams */ 0);
